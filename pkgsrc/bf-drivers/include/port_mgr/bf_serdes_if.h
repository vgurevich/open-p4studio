 ...
 *                  hw_SERDES_SPICO_REFCLK
 *                  hw_SERDES_SPICO_PCIE_CORE_CLK
 *                  hw_SERDES_SPICO_TX_F10_CLK_FIXED
 *                  hw_SERDES_SPICO_TX_F40_CLK_FIXED
 *                  hw_SERDES_SPICO_REFCLK_DIV2
 *                  hw_SERDES_SPICO_PCIE_CORE_CLK_DIV2
 *                  hw_SERDES_SPICO_TX_F10_CLK_FIXED_DIV2
 *                  hw_SERDES_SPICO_TX_F40_CLK_FIXED_DIV2
 *
 * @return Status of the API call
 *
 */
 ...
 * @param[in]  dev_port : Port identifier
 * @param[in]  lane    : Logical lane (within port) 0-3, depending upon mode
 * @param[in]  clk     : hw_SERDES_SPICO_REFCLK
 *                : hw_SERDES_SPICO_PCIE_CORE_CLK
 *                : hw_SERDES_SPICO_TX_F10_CLK_FIXED
 *                : hw_SERDES_SPICO_TX_F40_CLK_FIXED
 *                : hw_SERDES_SPICO_REFCLK_DIV2
 ...
 *                : hw_SERDES_TX_DATA_SEL_CORE
 *                : hw_SERDES_TX_DATA_SEL_PRBS7
 *                : hw_SERDES_TX_DATA_SEL_PRBS9
 *                : hw_SERDES_TX_DATA_SEL_PRBS11
 *                : hw_SERDES_TX_DATA_SEL_PRBS15
 *                : hw_SERDES_TX_DATA_SEL_PRBS23
 *                : hw_SERDES_TX_DATA_SEL_PRBS31
 *                : hw_SERDES_TX_DATA_SEL_USER
 *                : hw_SERDES_TX_DATA_SEL_LOOPBACK
 *
 * @return Status of the API call
 *
 */
 ...
 * @param[in]  lane    : Logical lane (within port) 0-3, depending upon mode
 * @param[in] data_sel:
 *     hw_SERDES_TX_DATA_SEL_PRBS7    = 0, < PRBS7 (x^7+x^6+1) generator
 *     hw_SERDES_TX_DATA_SEL_PRBS9    = 1, < PRBS9 (x^9+x^5+1)
 *     hw_SERDES_TX_DATA_SEL_PRBS11   = 2, < PRBS11 (x^11+x^9+1)
 *     hw_SERDES_TX_DATA_SEL_PRBS15   = 3, < PRBS15 (x^15+x^14+1)
 *     hw_SERDES_TX_DATA_SEL_PRBS23   = 4, < PRBS23 (x^23+x^18+1)
 *     hw_SERDES_TX_DATA_SEL_PRBS31   = 5, < PRBS31 (x^31+x^28+1)
 *     hw_SERDES_TX_DATA_SEL_PRBS13   = 6, < PRBS13 (x^13+x^12+x^2+x^1+1)
 *     hw_SERDES_TX_DATA_SEL_USER     = 7, < User pattern generator
 *     hw_SERDES_TX_DATA_SEL_CORE     = 8, < External data
 *     hw_SERDES_TX_DATA_SEL_LOOPBACK = 9, < Parallel loopback from receiver
 *     hw_SERDES_TX_DATA_SEL_PMD      = 10,< PMD training data
 *     hw_SERDES_TX_DATA_SEL_AN       = 11 < Auto-negotiation data
 *
 * @return Status of the API call
 *
 */
 ...
 *                : hw_SERDES_RX_CMP_DATA_PRBS7
 *                : hw_SERDES_RX_CMP_DATA_PRBS9
 *                : hw_SERDES_RX_CMP_DATA_PRBS11
 *                : hw_SERDES_RX_CMP_DATA_PRBS15
 *                : hw_SERDES_RX_CMP_DATA_PRBS23
 *                : hw_SERDES_RX_CMP_DATA_PRBS31
 *                : hw_SERDES_RX_CMP_DATA_SELF_SEED
 *                : hw_SERDES_RX_CMP_DATA_OFF
 *
 * @return Status of the API call
 *
 */
 ...
 * @param[in]  dev_port : Port identifier
 * @param[in]  lane    : Logical lane (within port) 0-3, depending upon mode
 * @param[in] cmp_sel : hw_SERDES_RX_CMP_DATA_PRBS7
 *                : hw_SERDES_RX_CMP_DATA_PRBS9
 *                : hw_SERDES_RX_CMP_DATA_PRBS11
 *                : hw_SERDES_RX_CMP_DATA_PRBS15
 *                : hw_SERDES_RX_CMP_DATA_PRBS23
 ...
 *                : hw_SERDES_RX_CMP_MODE_OFF
 *                : hw_SERDES_RX_CMP_MODE_XOR
 *                : hw_SERDES_RX_CMP_MODE_TEST_PATGEN
 *                : hw_SERDES_RX_CMP_MODE_MAIN_PATGEN
 *
 * @return Status of the API call
 *
 */
 ...
 * @param[in]  dev_port : Port identifier
 * @param[in]  lane    : Logical lane (within port) 0-3, depending upon mode
 * @param[in] cmp_mode: hw_SERDES_RX_CMP_MODE_OFF
 *                : hw_SERDES_RX_CMP_MODE_XOR
 *                : hw_SERDES_RX_CMP_MODE_TEST_PATGEN
 *                : hw_SERDES_RX_CMP_MODE_MAIN_PATGEN
 *
 ...
 *              : hw_SERDES_RX_TERM_AGND
 *              : hw_SERDES_RX_TERM_AVDD
 *              : hw_SERDES_RX_TERM_FLOAT
 *
 * @return Status of the API call
 *
 */
 ...
 * @param[in]  dev_port : Port identifier
 * @param[in]  lane  : Logical lane (within port) 0-3, depending upon mode
 * @param[in]  term  : hw_SERDES_RX_TERM_AGND
 *              : hw_SERDES_RX_TERM_AVDD
 *              : hw_SERDES_RX_TERM_FLOAT
 *
 * @return Status of the API call
 ...
 * @param[in]  dev_port : Port identifier
 * @param[in]  lane  : Logical lane (within port) 0-3, depending upon mode
 * @param[in]  hcd   : Negotiated (hw) hcd value
 *
 * @return Status of the API call
 *
 */
 ...
 *         uses hw_serdes_get_signal_ok() which returns a latched
