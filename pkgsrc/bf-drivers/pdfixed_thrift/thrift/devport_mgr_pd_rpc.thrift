...
service devport_mgr {
    ...
    void devport_mgr_enable_port (1: i32 dev_id, 2: i32 port_id, 3: bool enable) throws (1:InvalidDevportMgrOperation ouch);
    ...
    void devport_mgr_set_copy_to_cpu (1: i32 dev_id, 2: i8 enable, 3: i16 pport) throws (1:InvalidDevportMgrOperation ouch);
