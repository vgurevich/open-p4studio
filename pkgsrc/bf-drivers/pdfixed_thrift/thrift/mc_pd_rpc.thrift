...
service mc {
    ...
    mc_ecmp_mbr     mc_ecmp_get_mbr_from_hash (1: res.SessionHandle_t sess_hdl, 2: i32 dev_id, 3: McHandle_t mgrp_hdl, 4: McHandle_t ecmp_hdl, 5: i16 level1_mcast_hash, 6: i16 pkt_xid) throws (1:InvalidMcOperation ouch);
    ...
    void            mc_associate_node (1: res.SessionHandle_t sess_hdl, 2: i32 dev_id, 3: McHandle_t grp_hdl, 4: McHandle_t l1_hdl, 5: i16 xid, 6: i8 xid_valid) throws (1:InvalidMcOperation ouch);
    ...
    void            mc_associate_ecmp (1: res.SessionHandle_t sess_hdl, 2: i32 dev_id, 3: McHandle_t grp_hdl, 4: McHandle_t ecmp_hdl, 5: i16 xid, 6: i8 xid_valid) throws (1:InvalidMcOperation ouch);
    ...
    void            mc_set_lag_membership(1: res.SessionHandle_t sess_hdl, 2: i32 dev_id, 3: i8 lag_index, 4: binary port_map) throws (1:InvalidMcOperation ouch);
    binary          mc_get_lag_membership(1: res.SessionHandle_t sess_hdl, 2: i32 dev_id, 3: i8 lag_index) throws (1:InvalidMcOperation ouch);
    mc_lag_mbr      mc_get_lag_member_from_hash(1: res.SessionHandle_t sess_hdl, 2: i32 dev_id, 3: McHandle_t l1_hdl, 4: i8 lag_index, 5: i16 level2_mcast_hash, 6: i16 pkt_xid, 7: i16 pkt_yid, 8: i16 pkt_rid) throws (1:InvalidMcOperation ouch);
    void            mc_set_remote_lag_member_count(1: res.SessionHandle_t sess_hdl, 2: i32 dev_id, 3: i8 lag_index, 4: i32 left, 5: i32 right) throws (1:InvalidMcOperation ouch);
    ...
    void            mc_set_port_mc_fwd_state (1: res.SessionHandle_t sess_hdl, 2: i32 dev_id, 3: i16 port, 4: i8 is_active) throws (1:InvalidMcOperation ouch);
