...
enum pal_port_serdes_mode_t {
  BF_SERDES_MODE_NONE = 0,
  BF_SERDES_MODE_56G = 1,
  BF_SERDES_MODE_112G = 2
}
...
service pal {
    ...
    pal_status_t pal_port_add_with_lanes(1:pal_device_t device, 2:pal_dev_port_t dev_port, 3:pal_port_speed_t ps, 4:i32 lanes, 5:pal_fec_type_t fec) throws (1:InvalidPalOperation ouch);
    ...
    i32 pal_port_get_serdes_lane_count_per_mac(1:pal_device_t dev, 2:pal_dev_port_t dev_port) throws (1:InvalidPalOperation ouch);
    pal_port_serdes_mode_t pal_port_serdes_mode_get(1:pal_device_t device, 2:pal_dev_port_t dev_port) throws (1:InvalidPalOperation ouch);
}
