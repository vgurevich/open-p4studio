...
static bf_status_t bf_pm_fsm_wait_rx_signal(bf_dev_id_t dev_id,
  ...
  for (ln = 0; ln < num_lanes; ln++) {
    ...
    // Lane is ready for Rx EQ. issue a lane reset to get DFE started
...
bf_pm_fsm_state_desc_t bf_pm_fsm_serdes_far_loopback[] = {
...
/************************************************************************
 * bf_pm_get_fsm_for_serdes_far_loopback
 ************************************************************************/
bf_pm_fsm_t bf_pm_get_fsm_for_serdes_far_loopback(void) {
  return bf_pm_fsm_serdes_far_loopback;
}
