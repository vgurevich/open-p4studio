...
class BfRtDevMgrImpl {
 public:
  ...
  static void bfRtDeviceConfigSet(bool pkt_mgr_skip,
                                  bool mc_mgr_skip,
                                  bool port_mgr_skip,
                                  bool traffic_mgr_skip) {
    pkt_mgr_skip_ = pkt_mgr_skip;
    mc_mgr_skip_ = mc_mgr_skip;
    port_mgr_skip_ = port_mgr_skip;
    traffic_mgr_skip_ = traffic_mgr_skip;
  }

  static void bfRtDeviceConfigGet(bool *pkt_mgr_skip,
                                  bool *mc_mgr_skip,
                                  bool *port_mgr_skip,
                                  bool *traffic_mgr_skip) {
    *pkt_mgr_skip = pkt_mgr_skip_;
    *mc_mgr_skip = mc_mgr_skip_;
    *port_mgr_skip = port_mgr_skip_;
    *traffic_mgr_skip = traffic_mgr_skip_;
  }
 ...
 private:
  ...
  static bool pkt_mgr_skip_;
  static bool mc_mgr_skip_;
  static bool port_mgr_skip_;
  static bool traffic_mgr_skip_;
