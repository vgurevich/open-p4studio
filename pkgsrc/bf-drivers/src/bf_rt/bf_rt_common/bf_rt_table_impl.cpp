...
#include <bf_rt_port/bf_rt_port_table_impl.hpp>
...
#include <bf_rt_tm/bf_rt_tm_table_impl_l1_node.hpp>
...
std::unique_ptr<BfRtTableObj> BfRtTableObj::make_table(
  ...
  switch (table_type) {
    ...
    case TableType::LPF:
      return std::unique_ptr<BfRtTableObj>(
          new BfRtLPFTable(prog_name, id, name, size, pipe_hdl));
    case TableType::WRED:
      return std::unique_ptr<BfRtTableObj>(
          new BfRtWREDTable(prog_name, id, name, size, pipe_hdl));
    case TableType::REGISTER:
      return std::unique_ptr<BfRtTableObj>(
          new BfRtRegisterTable(prog_name, id, name, size, pipe_hdl));
    case TableType::PVS:
      return std::unique_ptr<BfRtTableObj>(
          new BfRtPVSTable(prog_name, id, name, size, pipe_hdl));
    case TableType::PORT_METADATA:
      return std::unique_ptr<BfRtTableObj>(
          new BfRtPhase0Table(prog_name, id, name, size, pipe_hdl));
    case TableType::DYN_HASH_CFG:
      return std::unique_ptr<BfRtTableObj>(
          new BfRtDynHashCfgTable(prog_name, id, name, size, pipe_hdl));
    case TableType::DYN_HASH_ALGO:
      return std::unique_ptr<BfRtTableObj>(
          new BfRtDynHashAlgoTable(prog_name, id, name, size, pipe_hdl));
    case TableType::SNAPSHOT_CFG:
      return std::unique_ptr<BfRtTableObj>(
          new BfRtSnapshotConfigTable(prog_name, id, name, size, pipe_hdl));
    case TableType::SNAPSHOT_DATA:
      return std::unique_ptr<BfRtTableObj>(
          new BfRtSnapshotDataTable(prog_name, id, name, size, pipe_hdl));
    case TableType::SNAPSHOT_TRIG:
      return std::unique_ptr<BfRtTableObj>(
          new BfRtSnapshotTriggerTable(prog_name, id, name, size, pipe_hdl));
    case TableType::SNAPSHOT_LIVENESS:
      return std::unique_ptr<BfRtTableObj>(
          new BfRtSnapshotLivenessTable(prog_name, id, name, size, pipe_hdl));
    default:
      break;
  }
  return nullptr;
...
std::unique_ptr<BfRtTableObj> BfRtTableObj::make_table(
  ...
  switch (table_type) {
    ...
    case TableType::PORT_HDL_INFO:
      return std::unique_ptr<BfRtTableObj>(
          new BfRtPortHdlInfoTable(prog_name, id, name, size));
    case TableType::PORT_FRONT_PANEL_IDX_INFO:
      return std::unique_ptr<BfRtTableObj>(
          new BfRtPortFpIdxInfoTable(prog_name, id, name, size));
    case TableType::PORT_STR_INFO:
      return std::unique_ptr<BfRtTableObj>(
          new BfRtPortStrInfoTable(prog_name, id, name, size));
    case TableType::PKTGEN_PORT_CFG:
      return std::unique_ptr<BfRtTableObj>(
          new BfRtPktgenPortTable(prog_name, id, name, size));
    case TableType::PKTGEN_APP_CFG:
      return std::unique_ptr<BfRtTableObj>(
          new BfRtPktgenAppTable(prog_name, id, name, size));
    case TableType::PKTGEN_PKT_BUFF_CFG:
      return std::unique_ptr<BfRtTableObj>(
          new BfRtPktgenPktBufferTable(prog_name, id, name, size));
    case TableType::PKTGEN_PORT_MASK_CFG:
      return std::unique_ptr<BfRtTableObj>(
          new BfRtPktgenPortMaskTable(prog_name, id, name, size));
    case TableType::PKTGEN_PORT_DOWN_REPLAY_CFG:
      return std::unique_ptr<BfRtTableObj>(
          new BfRtPktgenPortDownReplayCfgTable(prog_name, id, name, size));
    case TableType::PRE_MGID:
      return std::unique_ptr<BfRtTableObj>(
          new BfRtPREMGIDTable(prog_name, id, name, size));
    case TableType::PRE_NODE:
      return std::unique_ptr<BfRtTableObj>(
          new BfRtPREMulticastNodeTable(prog_name, id, name, size));
    case TableType::PRE_ECMP:
      return std::unique_ptr<BfRtTableObj>(
          new BfRtPREECMPTable(prog_name, id, name, size));
    case TableType::PRE_LAG:
      return std::unique_ptr<BfRtTableObj>(
          new BfRtPRELAGTable(prog_name, id, name, size));
    case TableType::PRE_PRUNE:
      return std::unique_ptr<BfRtTableObj>(
          new BfRtPREMulticastPruneTable(prog_name, id, name, size));
    case TableType::MIRROR_CFG:
      return std::unique_ptr<BfRtTableObj>(
          new BfRtMirrorCfgTable(prog_name, id, name, size));
    case TableType::TM_QUEUE_CFG:
      return std::unique_ptr<BfRtTableObj>(
          new BfRtTMQueueCfgTable(prog_name, id, name, size));
    case TableType::TM_QUEUE_MAP:
      return std::unique_ptr<BfRtTableObj>(
          new BfRtTMQueueMapTable(prog_name, id, name, size));
    case TableType::TM_QUEUE_COLOR:
      return std::unique_ptr<BfRtTableObj>(
          new BfRtTMQueueColorTable(prog_name, id, name, size));
    case TableType::TM_QUEUE_BUFFER:
      return std::unique_ptr<BfRtTableObj>(
          new BfRtTMQueueBufferTable(prog_name, id, name, size));
    case TableType::TM_QUEUE_SCHED_CFG:
      return std::unique_ptr<BfRtTableObj>(
          new BfRtTMQueueSchedCfgTable(prog_name, id, name, size));
    case TableType::TM_QUEUE_SCHED_SHAPING:
      return std::unique_ptr<BfRtTableObj>(
          new BfRtTMQueueSchedShapingTable(prog_name, id, name, size));
    case TableType::TM_L1_NODE_SCHED_CFG:
      return std::unique_ptr<BfRtTableObj>(
          new BfRtTML1NodeSchedCfgTable(prog_name, id, name, size));
    case TableType::TM_L1_NODE_SCHED_SHAPING:
      return std::unique_ptr<BfRtTableObj>(
          new BfRtTML1NodeSchedShapingTable(prog_name, id, name, size));
    case TableType::TM_PIPE_CFG:
      return std::unique_ptr<BfRtTableObj>(
          new BfRtTMPipeCfgTable(prog_name, id, name, size));
    case TableType::TM_PIPE_SCHED_CFG:
      return std::unique_ptr<BfRtTableObj>(
          new BfRtTMPipeSchedCfgTable(prog_name, id, name, size));
    case TableType::TM_PORT_SCHED_CFG:
      return std::unique_ptr<BfRtTableObj>(
          new BfRtTMPortSchedCfgTable(prog_name, id, name, size));
    case TableType::TM_PORT_SCHED_SHAPING:
      return std::unique_ptr<BfRtTableObj>(
          new BfRtTMPortSchedShapingTable(prog_name, id, name, size));
    case TableType::TM_MIRROR_DPG:
      return std::unique_ptr<BfRtTableObj>(
          new BfRtTMMirrorDpgTable(prog_name, id, name, size));
    case TableType::TM_PORT_DPG:
      return std::unique_ptr<BfRtTableObj>(
          new BfRtTMPortDpgTable(prog_name, id, name, size));
    case TableType::TM_PPG_CFG:
      return std::unique_ptr<BfRtTableObj>(
          new BfRtTMPpgCfgTable(prog_name, id, name, size));
    case TableType::TM_PORT_CFG:
      return std::unique_ptr<BfRtTableObj>(
          new BfRtTMPortCfgTable(prog_name, id, name, size));
    case TableType::TM_PORT_BUFFER:
      return std::unique_ptr<BfRtTableObj>(
          new BfRtTMPortBufferTable(prog_name, id, name, size));
    case TableType::TM_PORT_FLOWCONTROL:
      return std::unique_ptr<BfRtTableObj>(
          new BfRtTMPortFlowCtrlTable(prog_name, id, name, size));
    case TableType::TM_PORT_GROUP_CFG:
      return std::unique_ptr<BfRtTableObj>(
          new BfRtTMPortGroupCfgTable(prog_name, id, name, size));
    case TableType::TM_PORT_GROUP:
      return std::unique_ptr<BfRtTableObj>(
          new BfRtTMPortGroupTable(prog_name, id, name, size));
    case TableType::PRE_PORT:
      return std::unique_ptr<BfRtTableObj>(
          new BfRtPREMulticastPortTable(prog_name, id, name, size));
    case TableType::TM_POOL_CFG:
      return std::unique_ptr<BfRtTableObj>(
          new BfRtTMPoolCfgTable(prog_name, id, name, size));
    case TableType::TM_POOL_SKID:
      return std::unique_ptr<BfRtTableObj>(
          new BfRtTMPoolSkidTable(prog_name, id, name, size));
    case TableType::SNAPSHOT_PHV:
      return std::unique_ptr<BfRtTableObj>(
          new BfRtSnapshotPhvTable(prog_name, id, name, size));
    case TableType::DEV_CFG:
      return std::unique_ptr<BfRtTableObj>(
          new BfRtDevTable(prog_name, id, name, size));
    case TableType::DEV_WARM_INIT:
      return std::unique_ptr<BfRtTableObj>(
          new BfRtDevWarmInitTable(prog_name, id, name, size));
    case TableType::TM_POOL_APP:
      return std::unique_ptr<BfRtTableObj>(
          new BfRtTMPoolAppTable(prog_name, id, name, size));
    case TableType::TM_POOL_COLOR:
      return std::unique_ptr<BfRtTableObj>(
          new BfRtTMPoolColorTable(prog_name, id, name, size));
    case TableType::TM_POOL_APP_PFC:
      return std::unique_ptr<BfRtTableObj>(
          new BfRtTMPoolAppPfcTable(prog_name, id, name, size));
    case TableType::TM_COUNTER_IG_PORT:
      return std::unique_ptr<BfRtTableObj>(
          new BfRtTMCounterIgPortTable(prog_name, id, name, size));
    case TableType::TM_COUNTER_EG_PORT:
      return std::unique_ptr<BfRtTableObj>(
          new BfRtTMCounterEgPortTable(prog_name, id, name, size));
    case TableType::TM_COUNTER_QUEUE:
      return std::unique_ptr<BfRtTableObj>(
          new BfRtTMCounterQueueTable(prog_name, id, name, size));
    case TableType::TM_COUNTER_POOL:
      return std::unique_ptr<BfRtTableObj>(
          new BfRtTMCounterPoolTable(prog_name, id, name, size));
    case TableType::DBG_CNT:
      return std::unique_ptr<BfRtTableObj>(
          new BfRtTblDbgCntTable(prog_name, id, name, size));
    case TableType::LOG_DBG_CNT:
      return std::unique_ptr<BfRtTableObj>(
          new BfRtLogDbgCntTable(prog_name, id, name, size));
    case TableType::TM_COUNTER_PIPE:
      return std::unique_ptr<BfRtTableObj>(
          new BfRtTMCounterPipeTable(prog_name, id, name, size));
    case TableType::TM_COUNTER_PORT_DPG:
      return std::unique_ptr<BfRtTableObj>(
          new BfRtTMCounterPortDpgTable(prog_name, id, name, size));
    case TableType::TM_COUNTER_MIRROR_PORT_DPG:
      return std::unique_ptr<BfRtTableObj>(
          new BfRtTMCounterMirrorPortDpgTable(prog_name, id, name, size));
    case TableType::TM_COUNTER_PPG:
      return std::unique_ptr<BfRtTableObj>(
          new BfRtTMCounterPpgTable(prog_name, id, name, size));
    case TableType::TM_CFG:
      return std::unique_ptr<BfRtTableObj>(
          new BfRtTMCfgTable(prog_name, id, name, size));
    case TableType::TM_PIPE_MULTICAST_FIFO:
      return std::unique_ptr<BfRtTableObj>(
          new BfRtTMPipeMulticastFifoTable(prog_name, id, name, size));
    case TableType::REG_PARAM:
      return std::unique_ptr<BfRtTableObj>(
          new BfRtRegisterParamTable(prog_name, id, name, size));
    case TableType::DYN_HASH_COMPUTE:
      return std::unique_ptr<BfRtTableObj>(
          new BfRtDynHashComputeTable(prog_name, id, name, size));
...
bf_status_t BfRtTableObj::tableEntryAddOrMod(const BfRtSession & /*session*/,
                                             const bf_rt_target_t & /*dev_tgt*/,
                                             const uint64_t & /*flags*/,
                                             const BfRtTableKey & /*key*/,
                                             const BfRtTableData & /*data*/,
                                             bool * /*is_added*/) const {
  LOG_ERROR("%s:%d %s ERROR : Table Entry AddOrMod not supported",
            __func__,
            __LINE__,
            table_name_get().c_str());
  return BF_NOT_SUPPORTED;
...
bf_status_t BfRtTableObj::tableEntryReset(const BfRtSession & /*session*/,
                                          const bf_rt_target_t & /*dev_tgt*/,
                                          const uint64_t & /*flags*/,
                                          const BfRtTableKey & /*key*/) const {
...
bf_status_t BfRtTableObj::keyFieldIdGet(const std::string &name,
  ...
  auto found = std::find_if(
      ...
      key_fields.end(),
      [&name](
          const std::pair<const bf_rt_id_t, std::unique_ptr<BfRtTableKeyField>>
...
bf_status_t BfRtTableObj::keyFieldMaskGet(const bf_rt_id_t &field_id,
  ...
  *mask = key_fields.at(field_id)->getMask();
  return BF_SUCCESS;
}
...
bf_status_t BfRtTableObj::actionIdGet(const std::string &name,
  ...
  auto action_found = std::find_if(
      ...
      [&name](const std::pair<const bf_rt_id_t,
                  ...
                  &action_map_pair) {
        if (action_map_pair.second->name == name) return true;
        // In order to find action by name without specifying all prefixes,
        // compare name ends including last dot
        return endsWith(action_map_pair.second->name, "." + name);
      });
...
// Table virt dev APIs
// Beginning of old flags wrapper section.
bf_status_t BfRtTableObj::registerMatUpdateCb(const BfRtSession &session,
                                              const bf_rt_target_t &dev_tgt,
...
bf_status_t BfRtTableObj::registerAdtUpdateCb(const BfRtSession &session,
                                              const bf_rt_target_t &dev_tgt,
                                              const pipe_adt_update_cb &cb,
                                              const void *cookie) const {
  return this->registerAdtUpdateCb(session, dev_tgt, 0, cb, cookie);
}
bf_status_t BfRtTableObj::registerSelUpdateCb(const BfRtSession &session,
                                              const bf_rt_target_t &dev_tgt,
...
bf_status_t BfRtTableObj::registerMatUpdateCb(
    const BfRtSession & /*session*/,
    const bf_rt_target_t & /*dev_tgt*/,
    const uint64_t & /*flags*/,
    const pipe_mat_update_cb & /*cb*/,
...
bf_status_t BfRtTableObj::registerAdtUpdateCb(
    const BfRtSession & /*session*/,
    const bf_rt_target_t & /*dev_tgt*/,
    const uint64_t & /*flags*/,
    const pipe_adt_update_cb & /*cb*/,
...
bf_status_t BfRtTableObj::registerSelUpdateCb(
    const BfRtSession & /*session*/,
    const bf_rt_target_t & /*dev_tgt*/,
    const uint64_t & /*flags*/,
    const pipe_sel_update_cb & /*cb*/,
...
bf_status_t BfRtTableObj::getKeyField(const bf_rt_id_t &field_id,
  ...
  auto it = key_fields.find(field_id);
...
bf_status_t BfRtTableObj::getDataField(
    ...
    const BfRtTableDataField **field) const {
  *field = nullptr;
  auto it = action_info_list.find(action_id);
  if (it != action_info_list.end()) {
    *field = this->getDataFieldHelper(
        field_id, container_id_vec, 0, it->second->data_fields);
...
bf_status_t BfRtTableObj::getDataField(
  ...
  *field = nullptr;
  ...
  if (it != action_info_list.end()) {
    *field = this->getDataFieldHelper(
        field_name, container_id_vec, 0, it->second->data_fields_names);
    if (*field) return BF_SUCCESS;
  }
  // We need to search the common data too
  *field = this->getDataFieldHelper(
