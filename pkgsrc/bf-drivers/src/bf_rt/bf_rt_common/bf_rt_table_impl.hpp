...
class BfRtTableObj : public BfRtTable {
 public:
  ...
  bf_status_t tableEntryModInc(
      ...
      const BfRtTable::BfRtTableModIncFlag &flag) const override final;
  ...
  bf_status_t tableClear(const BfRtSession &session,
                         const bf_rt_target_t &dev_tgt) const override final;
  ...
  bf_status_t tableEntryHandleGet(
      ...
      const bf_rt_target_t &dev_tgt,
      const BfRtTableKey &key,
      bf_rt_handle_t *entry_handle) const override final;
  ...
  bf_status_t tableNameGet(std::string *name) const override final;

  bf_status_t tableIdGet(bf_rt_id_t *id) const override final;

  bf_status_t tableSizeGet(const BfRtSession &session,
                           const bf_rt_target_t &dev_tgt,
                           size_t *size) const override final;

  bf_status_t tableTypeGet(TableType *type) const override final;
  ...
  bf_status_t tableHasConstDefaultAction(
      bool *has_const_default_action) const override final;

  bf_status_t tableIsConst(bool *is_const) const override final;

  bf_status_t tableAnnotationsGet(
      AnnotationSet *annotations) const override final;
  bf_status_t tableApiSupportedGet(TableApiSet *tableApis) const override final;
  ...
  bf_status_t keyFieldIdListGet(
      std::vector<bf_rt_id_t> *id_vec) const override final;

  bf_status_t keyFieldTypeGet(const bf_rt_id_t &field_id,
                              KeyFieldType *field_type) const override final;

  bf_status_t keyFieldDataTypeGet(const bf_rt_id_t &field_id,
                                  DataType *data_type) const override final;

  bf_status_t keyFieldIdGet(const std::string &name,
                            bf_rt_id_t *field_id) const override final;

  bf_status_t keyFieldSizeGet(const bf_rt_id_t &field_id,
                              size_t *size) const override final;

  bf_status_t keyFieldIsPtrGet(const bf_rt_id_t &field_id,
                               bool *is_ptr) const override final;

  bf_status_t keyFieldMaskGet(const bf_rt_id_t &field_id,
                              std::vector<uint8_t> *mask) const override final;
  ...
  bf_status_t dataFieldMandatoryGet(const bf_rt_id_t &field_id,
                                    bool *is_mandatory) const override final;
  ...
  bf_status_t dataFieldReadOnlyGet(const bf_rt_id_t &field_id,
                                   bool *is_read_only) const override final;
  ...
  bf_status_t dataFieldOneofSiblingsGet(
      const bf_rt_id_t &field_id,
      std::set<bf_rt_id_t> *oneof_siblings) const override final;
  ...
  bf_status_t actionIdGet(const std::string &name,
                          bf_rt_id_t *action_id) const override final;
  bf_status_t actionNameGet(const bf_rt_id_t &action_id,
                            std::string *name) const override final;
  bf_status_t actionIdListGet(
      std::vector<bf_rt_id_t> *action_id) const override final;
  ...
  bf_status_t tableAttributesGet(
      const BfRtSession &session,
      const bf_rt_target_t &dev_tgt,
      BfRtTableAttributes *tableAttributes) const override final;
  ...
  bf_status_t tableAttributesSupported(
      std::set<TableAttributesType> *type_set) const override final;

  // Table operations APIs
  bf_status_t tableOperationsSupported(
      std::set<TableOperationsType> *type_set) const override final;
  bf_status_t tableOperationsExecute(
      const BfRtTableOperations &tableOperations) const override final;
  ...
  bf_status_t registerMatUpdateCb(const BfRtSession &session,
                                  ...
                                  const void *cookie) const override final;
