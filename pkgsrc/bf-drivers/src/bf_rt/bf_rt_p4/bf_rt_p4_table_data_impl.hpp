...
class BfRtRegister {
 public:
  ...
  bf_status_t setData(const BfRtTableDataField &tableDataField,
                      const uint64_t value[2]);
  bf_status_t getData(const BfRtTableDataField &tableDataField,
...
class RegisterSpecData {
 public:
  ...
  bf_status_t populateStfulSpecFromData(
...
class CounterSpecData {
 public:
  ...
  bf_status_t setCounterDataFromValue(const DataFieldType &field_type,
                                      const uint64_t &count);

  bf_status_t getCounterData(const DataFieldType &field_type,
...
class MeterSpecData {
 public:
  ...
  bf_status_t setMeterDataFromValue(const DataFieldType &type,
                                    const uint64_t &value);
  bf_status_t setMeterDataFromMeterSpec(const pipe_meter_spec_t &mspec);

  bf_status_t getMeterDataFromValue(const DataFieldType &type,
...
class LPFSpecData {
 public:
  ...
  bf_status_t setLPFDataFromLPFSpec(const pipe_lpf_spec_t *lpf_spec);
...
class WREDSpecData {
 public:
  ...
  bf_status_t setWREDDataFromWREDSpec(const pipe_wred_spec_t *wred_spec);
...
class PipeActionSpec {
 public:
  ...
  bf_status_t getValueRegisterSpec(
...
class BfRtMatchActionTableData : public BfRtTableDataObj {
 public:
  ...
  bf_status_t getValue(const bf_rt_id_t &field_id,
                       std::vector<std::vector<uint8_t>> *value) const override;
...
class BfRtSelectorTableData : public BfRtTableDataObj {
 public:
  ...
  uint32_t get_adt_offset() const { return adt_offset_; }
  ...
  void setAdtOffset(const uint32_t &adt_offset) { adt_offset_ = adt_offset; }
 ...
 private:
  ...
  uint32_t adt_offset_{0xdeadbeef};
};
