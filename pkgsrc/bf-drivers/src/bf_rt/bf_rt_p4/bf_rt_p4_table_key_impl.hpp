...
class BfRtSnapshotConfigTableKey : public BfRtTableKeyObj {
 public:
  BfRtSnapshotConfigTableKey(const BfRtTableObj *tbl_obj)
      : BfRtTableKeyObj(tbl_obj) {}

  ~BfRtSnapshotConfigTableKey() = default;
...
class BfRtSnapshotDataTableKey : public BfRtTableKeyObj {
 public:
  BfRtSnapshotDataTableKey(const BfRtTableObj *tbl_obj)
      : BfRtTableKeyObj(tbl_obj) {}
  ~BfRtSnapshotDataTableKey() = default;
  ...
  bf_status_t get_stage_id(uint32_t *stage) const;
  bf_status_t set_stage_id(const uint32_t stage);

 private:
  std::map<bf_rt_id_t, uint32_t> uint32_fields;
};

class BfRtSnapshotTriggerTableKey : public BfRtTableKeyObj {
 public:
  BfRtSnapshotTriggerTableKey(const BfRtTableObj *tbl_obj)
      : BfRtTableKeyObj(tbl_obj) {}
  ~BfRtSnapshotTriggerTableKey() = default;
...
class BfRtSnapshotLivenessTableKey : public BfRtTableKeyObj {
 public:
  BfRtSnapshotLivenessTableKey(const BfRtTableObj *tbl_obj)
      : BfRtTableKeyObj(tbl_obj){};
  ~BfRtSnapshotLivenessTableKey() = default;
  ...
  bf_status_t getFieldName(std::string *value) const;

 private:
  std::string field_name;
};

class BfRtSnapshotPhvTableKey : public BfRtTableKeyObj {
 public:
  BfRtSnapshotPhvTableKey(const BfRtTableObj *tbl_obj)
      : BfRtTableKeyObj(tbl_obj), stage_id(0){};
  ~BfRtSnapshotPhvTableKey() = default;
...
class BfRtDynHashCfgTableKey : public BfRtTableKeyObj {
 public:
  BfRtDynHashCfgTableKey(const BfRtTableObj *tbl_obj)
      : BfRtTableKeyObj(tbl_obj){};
  ~BfRtDynHashCfgTableKey() = default;
};

class BfRtDynHashAlgoTableKey : public BfRtTableKeyObj {
 public:
  BfRtDynHashAlgoTableKey(const BfRtTableObj *tbl_obj)
      : BfRtTableKeyObj(tbl_obj){};
  ~BfRtDynHashAlgoTableKey() = default;
};
