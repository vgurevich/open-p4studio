...
class BfRtStateTableAttributesAging {
 public:
  BfRtStateTableAttributesAging()
      : enabled_(false),
        idle_cb_c_((bf_rt_idle_tmo_expiry_cb) nullptr),
        activate_cb_c_((bf_rt_idle_tmo_active_cb) nullptr),
        table_(nullptr),
        cookie_(nullptr){};
  BfRtStateTableAttributesAging(bool enable,
                                BfRtIdleTmoExpiryCb idle_cb_cpp,
                                BfRtIdleTmoExpiryCb activate_cb_cpp,
                                bf_rt_idle_tmo_expiry_cb idle_cb_c,
                                bf_rt_idle_tmo_active_cb activate_cb_c,
                                const BfRtTableObj *table,
                                void *cookie)
      : enabled_(enable),
        idle_cb_cpp_(idle_cb_cpp),
        activate_cb_cpp_(activate_cb_cpp),
        idle_cb_c_(idle_cb_c),
        activate_cb_c_(activate_cb_c),
        table_(table),
        cookie_(cookie){};
 ...
 private:
  bool enabled_;
  BfRtIdleTmoExpiryCb idle_cb_cpp_;
  BfRtIdleTmoActiveCb activate_cb_cpp_;
  bf_rt_idle_tmo_expiry_cb idle_cb_c_;
  bf_rt_idle_tmo_active_cb activate_cb_c_;
