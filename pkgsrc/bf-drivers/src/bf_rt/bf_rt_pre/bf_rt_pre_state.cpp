...
bf_status_t BfRtPREStateObj::statePREIdAdd(const PREStateIdType &id_type,
                                           const bf_rt_id_t &id,
                                           const bf_rt_id_t &hdl) {
...
bf_status_t BfRtPREStateObj::statePREIdDel(const PREStateIdType &id_type,
                                           const bf_rt_id_t &id) {
  std::lock_guard<std::mutex> lock(state_lock);
  ...
  switch (id_type) {
    case PREStateIdType::MULTICAST_MGID: {
      ...
      BF_RT_ASSERT(it_hdl_to_mgid != mgid_hdl_to_mgid_map.end());
    ...
    case PREStateIdType::MULTICAST_NODE_ID: {
      ...
      BF_RT_ASSERT(it_node_hdl_to_id != node_hdl_to_id_map.end());
    ...
    case PREStateIdType::MULTICAST_ECMP_ID: {
      ...
      BF_RT_ASSERT(it_ecmp_hdl_to_id != ecmp_hdl_to_id_map.end());
...
bool BfRtPREStateObj::statePREIdExists(const PREStateIdType &id_type,
                                       const bf_rt_id_t &id) const {
  std::lock_guard<std::mutex> lock(state_lock);
...
bool BfRtPREStateObj::statePREHdlExists(const PREStateIdType &id_type,
                                        const bf_rt_id_t &hdl) const {
  std::lock_guard<std::mutex> lock(state_lock);
...
bf_status_t BfRtPREStateObj::statePREIdGet(const PREStateIdType &id_type,
                                           const bf_rt_id_t &hdl,
                                           bf_rt_id_t *id) const {
  std::lock_guard<std::mutex> lock(state_lock);
...
bf_status_t BfRtPREStateObj::statePREHdlGet(const PREStateIdType &id_type,
                                            const bf_rt_id_t &id,
                                            bf_rt_id_t *hdl) const {
  std::lock_guard<std::mutex> lock(state_lock);
...
bf_status_t BfRtPREStateObj::statePREIdGetFirst(const PREStateIdType &id_type,
                                                bf_rt_id_t *first_id,
                                                bf_rt_id_t *first_hdl) const {
  std::lock_guard<std::mutex> lock(state_lock);
...
bf_status_t BfRtPREStateObj::statePREIdGetNext(const PREStateIdType &id_type,
                                               const bf_rt_id_t &id,
                                               bf_rt_id_t *next_id,
                                               bf_rt_id_t *next_hdl) const {
  std::lock_guard<std::mutex> lock(state_lock);
