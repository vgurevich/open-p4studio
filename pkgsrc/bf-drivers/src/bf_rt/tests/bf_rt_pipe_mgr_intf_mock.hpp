...
#ifndef _BF_RT_PIPE_MGR_INTERFACE_MOCK_HPP
#define _BF_RT_PIPE_MGR_INTERFACE_MOCK_HPP
...
class MockIPipeMgrIntfHelper {
 public:
  pipe_status_t pipeMgrGetNextEntries(pipe_sess_hdl_t sess_hdl,
    ...
    auto it = entry_database.find(entry_hdl);
    int i = 0;
    pipe_status_t sts;
    it = std::next(it, 1);
    while (it != entry_database.end() && i < n) {
      sts = pipeMgrGetEntry(sess_hdl,
                            tbl_hdl,
                            dev_tgt,
                            it->first,
                            &pipe_match_specs[i],
  ...
  pipe_status_t pipeMgrResourceReadHelper(pipe_mat_tbl_hdl_t mat_tbl_hdl,
    ...
    const BfRtTable *table = entry_database[mat_ent_hdl]->table;
    ...
    // BfRtTable is : "<<resource_tbl_hdl<<" for resource type :
  ...
  pipe_status_t pipeMgrGetSelGrpMbrCount(pipe_sess_hdl_t sess_hdl,
    ...
    BF_RT_ASSERT(sel_entry.adt_ent_hdls.size() ==
  ...
  pipe_status_t pipeMgrSelGrpMbrsGet(pipe_sess_hdl_t sess_hdl,
    ...
    BF_RT_ASSERT(sel_entry.adt_ent_hdls.size() ==
                 sel_entry.adt_ent_hdl_sts.size());
    BF_RT_ASSERT(mbrs_size == sel_entry.adt_ent_hdls.size());
    *mbrs_populated = 0;
...
class MockIPipeMgrIntf : public IPipeMgrIntf {
 public:
  static MockIPipeMgrIntf *getInstance(const BfRtSession &session) {
  ...
  MOCK_METHOD10(pipeMgrMatEntAddOrMod,
                pipe_status_t(pipe_sess_hdl_t sess_hdl,
                              dev_target_t dev_tgt,
                              pipe_mat_tbl_hdl_t mat_tbl_hdl,
                              pipe_tbl_match_spec_t *match_spec,
  ...
  MOCK_METHOD3(pipeMgrTblIsTern,
               pipe_status_t(bf_dev_id_t device_id,
  ...
  MOCK_METHOD8(pipeMgrSelGrpMbrsSet,
               pipe_status_t(pipe_sess_hdl_t sess_hdl,
                             ...
                             bool *enable,
                             uint32_t pipe_api_flags));
  MOCK_METHOD9(pipeMgrSelGrpMbrsGet,
               pipe_status_t(pipe_sess_hdl_t sess_hdl,
                             bf_dev_id_t device_id,
                             pipe_sel_tbl_hdl_t sel_tbl_hdl,
                             pipe_sel_grp_hdl_t sel_grp_hdl,
  ...
  MOCK_METHOD2(pipeMgrFlowLrnTimeoutGet,
               pipe_status_t(bf_dev_id_t device_id, uint32_t *usecs));
  ...
  MOCK_METHOD3(pipeMgrFlowLrnIntrModeGet,
               pipe_status_t(pipe_sess_hdl_t sess_hdl,
                             bf_dev_id_t device_id,
                             bool *en));
  MOCK_METHOD3(pipeMgrInactiveNodeDeleteSet,
               pipe_status_t(pipe_sess_hdl_t sess_hdl,
                             bf_dev_id_t device_id,
                             bool en));
  MOCK_METHOD3(pipeMgrInactiveNodeDeleteGet,
               pipe_status_t(pipe_sess_hdl_t sess_hdl,
                             bf_dev_id_t device_id,
                             bool *en));
  MOCK_METHOD3(pipeMgrSelectorMbrOrderSet,
               pipe_status_t(pipe_sess_hdl_t sess_hdl,
                             bf_dev_id_t device_id,
                             bool en));
  MOCK_METHOD3(pipeMgrSelectorMbrOrderGet,
               pipe_status_t(pipe_sess_hdl_t sess_hdl,
                             bf_dev_id_t device_id,
                             bool *en));
  MOCK_METHOD2(pipeMgrFlowLrnSetNetworkOrderDigest,
               pipe_status_t(bf_dev_id_t device_id, bool network_order));
  ...
  MOCK_METHOD5(pipeMgrGetSelGrpMbrCount,
               pipe_status_t(pipe_sess_hdl_t sess_hdl,
                             ...
                             pipe_sel_grp_hdl_t sel_grp_hdl,
                             uint32_t *count));
  MOCK_METHOD6(pipeMgrAdtEntHdlGet,
               pipe_status_t(pipe_sess_hdl_t sess_hdl,
                             dev_target_t dev_tgt,
                             pipe_adt_tbl_hdl_t adt_tbl_hdl,
                             pipe_adt_mbr_id_t mbr_id,
  ...
  MOCK_METHOD5(pipeMgrSelGrpHdlGet,
               pipe_status_t(pipe_sess_hdl_t sess_hdl,
                             ...
                             pipe_sel_grp_id_t sel_grp_id,
                             pipe_sel_grp_hdl_t *sel_grp_hdl));
  MOCK_METHOD6(pipeMgrSelGrpParamsGet,
               pipe_status_t(pipe_sess_hdl_t sess_hdl,
                             bf_dev_id_t dev_id,
                             pipe_sel_tbl_hdl_t tbl_hdl,
                             pipe_sel_grp_hdl_t sel_grp_hdl,
  ...
  MOCK_METHOD4(pipeMgrGetReservedEntryCount,
               pipe_status_t(pipe_sess_hdl_t sess_hdl,
                             ...
                             pipe_mat_tbl_hdl_t tbl_hdl,
                             size_t *count));
  MOCK_METHOD4(pipeMgrGetTotalHwEntryCount,
               pipe_status_t(pipe_sess_hdl_t sess_hdl,
                             dev_target_t dev_tgt,
                             pipe_mat_tbl_hdl_t tbl_hdl,
                             size_t *count));
  ...
  MOCK_METHOD1(bfSnapshotDoPolling, bf_status_t(bf_dev_id_t dev));
  ...
  MOCK_METHOD1(bfSnapshotDelete, bf_status_t(pipe_snapshot_hdl_t hdl));
  MOCK_METHOD1(bfSnapshotClear, bf_status_t(bf_dev_id_t dev));
  MOCK_METHOD3(bfSnapshotCaptureTriggerSet,
               bf_status_t(pipe_snapshot_hdl_t hdl,
                           void *trig_spec,
                           void *trig_mask));
  ...
  MOCK_METHOD2(bfSnapshotTotalPhvCountGet,
               bf_status_t(bf_dev_id_t dev_id, uint32_t *count));
  ...
  MOCK_METHOD2(bfSnapshotNumTrigFieldsGet,
               bf_status_t(pipe_snapshot_hdl_t hdl, int *count));

  MOCK_METHOD4(bfDbgCounterGet,
               bf_status_t(bf_dev_target_t dev_tgt,
                           char *tbl_name,
  ...
  MOCK_METHOD2(bfDbgCounterClear,
               bf_status_t(bf_dev_target_t dev_tgt, char *tbl_name));
  ...
  MOCK_CONST_METHOD5(pipeRegisterMatUpdateCb,
                     bf_status_t(pipe_sess_hdl_t sess_hdl,
                                 bf_dev_id_t device_id,
                                 pipe_mat_tbl_hdl_t tbl_hdl,
  ...
  MOCK_METHOD2(pipeMgrTcamScrubTimerSet,
               pipe_status_t(bf_dev_id_t dev, uint32_t msec_timer));
  MOCK_METHOD1(pipeMgrTcamScrubTimerGet, uint32_t(bf_dev_id_t dev));
  ...
  MOCK_CONST_METHOD2(pipeMgrGetNumPipelines,
                     pipe_status_t(bf_dev_id_t dev_id, uint32_t *num_pipes));

  MOCK_CONST_METHOD2(pipeMgrGetNumActiveStages,
                     pipe_status_t(bf_dev_id_t dev_id,
                                   uint8_t *num_active_stages));

  MOCK_METHOD2(pipeMgrLrtDrTimeoutSet,
               pipe_status_t(bf_dev_id_t dev_id, uint32_t timeout_ms));
  ...
  MOCK_METHOD2(pipeMgrPktgenClearPktBuffer,
               bf_status_t(pipe_sess_hdl_t sess_hdl, bf_dev_target_t dev_tgt));
  ...
  MOCK_CONST_METHOD1(pipeMgrPktgenAppCountGet, uint32_t(bf_dev_id_t dev));

  MOCK_CONST_METHOD1(pipeMgrPktgenPortGet, bf_dev_port_t(bf_dev_id_t dev_id));

  MOCK_CONST_METHOD2(pipeMgrPktgenPortGetNext,
                     bf_status_t(bf_dev_id_t dev_id, bf_dev_port_t *port));

  MOCK_CONST_METHOD1(pipeMgrPktgenMaxPortGet,
                     bf_dev_port_t(bf_dev_id_t dev_id));
  ...
  MOCK_CONST_METHOD3(pipeMgrPortRXPrsrPriThreshGet,
                     bf_status_t(bf_dev_id_t dev_id,
                                 bf_dev_port_t port_id,
                                 uint32_t *threshold));

  MOCK_METHOD3(pipeMgrPortRXPrsrPriThreshSet,
               bf_status_t(bf_dev_id_t dev_id,
                           bf_dev_port_t port_id,
                           uint32_t threshold));
...
#endif  // _BF_RT_PIPE_MGR_INTERFACE_MOCK_HPP
