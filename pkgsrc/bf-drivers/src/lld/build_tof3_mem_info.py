    ...
    with open(filename, "rb") as csv_file:
        ...
        for row in csv_reader:
            ...
            if row["Type"] in ["addressmap", "userdefined addressmap"] :
                ...
                if open_arg == 1:
                    print "};"
                    print ("cmd_arg_t " + "tof3_" + open_arg_name +
                           "_mem = { " + str(list_elts) + ", " + "tof3_" +
                           open_arg_name + "_mem_list };\n" )
                open_arg = 1
                open_arg_name = row["Identifier"]
                open_addr_map = row["Identifier"]
                print "cmd_arg_item_t " + "tof3_" + open_arg_name + "_mem_list[] = {"
                list_elts = 0
                ...
                if row["Type"] in csv_register_types:
                    if array_size == (1,):
                        print ( "{ \"" + identifier + "\"" +
                                ", NULL, " + hex(offset) + ", &" +
                                "tof3_" + open_arg_name + "__" + identifier + ", 0 }," )
                        list_elts = list_elts + 1
                    ...
                    if array_size == (1,):
                        print ( "{ \"" + identifier + "\"" +
                                ", NULL, " + hex(offset) + ", &" +
                                "tof3_" + open_arg_name + "__" + identifier + ", " +
                                hex(sz) + " }," )
                        list_elts = list_elts + 1
                    elif len(array_size) == 1:
                        print ( "{ \"" + identifier + "\"" +
        ...
        if open_arg == 1:
            print "};"
            print "cmd_arg_t " + "tof3_"+ open_arg_name + "_mem = { " + str(list_elts) + ", " + "tof3_" + open_arg_name + "_mem_list };\n"
        ...
        for row in csv_reader:
            ...
            if row["Type"] in ["endgroup"]:
                ...
                if active_reg_name != "":
                    ...
                    print "};"
                    print ("reg_decoder_t " + "tof3_" + active_reg_name +
                           " = { " + str(list_elts) + ", " + "tof3_" +
...
def build_reg_info(dir):
    full_csr_file = os.path.join(dir,"cb_mem.csv")
