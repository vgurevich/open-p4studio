...
lld_err_t lld_ind_write_tof2(bf_dev_id_t dev_id,
  ...
  uint32_t addr_reg_lo =
      tof2_reg_device_select_pcie_bar01_regs_cpu_ind_addr_low_address;
  uint32_t addr_reg_hi =
      tof2_reg_device_select_pcie_bar01_regs_cpu_ind_addr_high_address;
  uint32_t data_reg_lo =
      tof2_reg_device_select_pcie_bar01_regs_cpu_ind_data00_address;
  uint32_t data_reg_hi =
      tof2_reg_device_select_pcie_bar01_regs_cpu_ind_data11_address;
