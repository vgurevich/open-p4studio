...
#define TS_TOF3_MBC_MBUS_REG_OFFSET(reg) \
  (offsetof(tof3_reg, device_select.mbc.mbc_mbus.reg))
...
/**
 * @brief lld_tof3_ts_global_ts_state_set
...
bf_status_t lld_tof3_ts_global_ts_state_set(bf_dev_id_t dev_id, bool enable) {
  ...
  for (subdev = 0; subdev < num_subdev; subdev++) {
    address = TS_TOF3_MBC_MBUS_REG_OFFSET(ctrl);
    data = 0;
    if (lld_ts_reg_rd(dev_id, (bf_subdev_id_t)subdev, address, &data) !=
        BF_SUCCESS) {
      return BF_HW_COMM_FAIL;
    }
    setp_tof3_mbus_ctrl_ts_en(&data, enable);
    if (lld_ts_reg_wr(dev_id, (bf_subdev_id_t)subdev, address, data) !=
        BF_SUCCESS) {
      return BF_HW_COMM_FAIL;
    }
  }
...
/**
 * @brief lld_tof3_ts_global_ts_state_get
...
bf_status_t lld_tof3_ts_global_ts_state_get(bf_dev_id_t dev_id, bool *enable) {
  ...
  if (lld_ts_reg_rd(dev_id, (bf_subdev_id_t)0, address, &data) != BF_SUCCESS) {
    return BF_HW_COMM_FAIL;
  }
  data = getp_tof3_mbus_ctrl_ts_en(&data);
  *enable = (data ? true : false);
  return BF_SUCCESS;
}

/**
 * @brief lld_tof3_ts_global_ts_value_set
...
bf_status_t lld_tof3_ts_global_ts_value_set(bf_dev_id_t dev_id,
  ...
  for (subdev = 0; subdev < num_subdev; subdev++) {
    data = 0;
    address = TS_TOF3_MBC_MBUS_REG_OFFSET(global_ts_set.global_ts_set_0_2);
    setp_tof3_mbus_global_ts_set_global_ts_set_0_2_count_31_0(
    ...
    address = TS_TOF3_MBC_MBUS_REG_OFFSET(global_ts_set.global_ts_set_1_2);
    setp_tof3_mbus_global_ts_set_global_ts_set_1_2_count_47_32(
...
/**
 * @brief lld_tof3_ts_global_ts_value_get
...
bf_status_t lld_tof3_ts_global_ts_value_get(bf_dev_id_t dev_id,
  ...
  for (subdev = 0; subdev < num_subdev; subdev++) {
    ...
    address = TS_TOF3_MBC_MBUS_REG_OFFSET(ts_capture);
    data = 0;

    setp_tof3_mbus_ts_capture_capture(&data, 1);
    if (lld_ts_reg_wr(dev_id, (bf_subdev_id_t)subdev, address, data) !=
        BF_SUCCESS) {
      return BF_HW_COMM_FAIL;
    }
    ...
    data = getp_tof3_mbus_global_ts_set_global_ts_set_0_2_count_31_0(&data);
    *global_ts_ns = (uint64_t)data & 0xFFFFFFFFULL;
    ...
    data = getp_tof3_mbus_global_ts_set_global_ts_set_1_2_count_47_32(&data);
...
/**
 * @brief lld_tof3_ts_global_ts_inc_value_set
...
bf_status_t lld_tof3_ts_global_ts_inc_value_set(bf_dev_id_t dev_id,
  ...
  for (subdev = 0; subdev < num_subdev; subdev++) {
    data = 0;
    address = TS_TOF3_MBC_MBUS_REG_OFFSET(global_ts_inc_value);
    setp_tof3_mbus_global_ts_inc_value_count(&data, global_inc_ns);
    if (lld_ts_reg_wr(dev_id, (bf_subdev_id_t)subdev, address, data) !=
        BF_SUCCESS) {
      return BF_HW_COMM_FAIL;
    }
...
/**
 * @brief lld_tof3_ts_global_ts_inc_value_get
...
bf_status_t lld_tof3_ts_global_ts_inc_value_get(bf_dev_id_t dev_id,
  ...
  *global_inc_ns = getp_tof3_mbus_global_ts_inc_value_count(&data);
  return BF_SUCCESS;
}

/**
 * @brief lld_tof3_ts_global_ts_increment_one_time_set
...
bf_status_t lld_tof3_ts_global_ts_increment_one_time_set(
  ...
  for (subdev = 0; subdev < num_subdev; subdev++) {
    data = 0;
    address = TS_TOF3_MBC_MBUS_REG_OFFSET(global_ts_inc.global_ts_inc_0_2);
    setp_tof3_mbus_global_ts_inc_global_ts_inc_0_2_count_31_0(
    ...
    address = TS_TOF3_MBC_MBUS_REG_OFFSET(global_ts_inc.global_ts_inc_1_2);
    setp_tof3_mbus_global_ts_inc_global_ts_inc_1_2_count_47_32(
...
/**
 * @brief lld_tof3_ts_global_ts_offset_set
...
bf_status_t lld_tof3_ts_global_ts_offset_set(bf_dev_id_t dev_id,
  ...
  for (subdev = 0; subdev < num_subdev; subdev++) {
    data = 0;
    address = TS_TOF3_MBC_MBUS_REG_OFFSET(
        global_ts_offset_value.global_ts_offset_value_0_2);
    setp_tof3_mbus_global_ts_offset_value_global_ts_offset_value_0_2_count_31_0(
    ...
    setp_tof3_mbus_global_ts_offset_value_global_ts_offset_value_1_2_count_47_32(
...
bf_status_t lld_tof3_ts_global_ts_offset_get(bf_dev_id_t dev_id,
  ...
  data =
      getp_tof3_mbus_global_ts_offset_value_global_ts_offset_value_0_2_count_31_0(
          &data);
  *global_ts_offset_ns = (uint64_t)data & 0xFFFFFFFFULL;
  ...
  data =
      getp_tof3_mbus_global_ts_offset_value_global_ts_offset_value_1_2_count_47_32(
          &data);
...
/**
 * @brief lld_tof3_ts_global_baresync_ts_get
...
bf_status_t lld_tof3_ts_global_baresync_ts_get(bf_dev_id_t dev_id,
  ...
  setp_tof3_mbus_ts_capture_capture(&data, 1);
  if (lld_ts_reg_wr(dev_id, (bf_subdev_id_t)0, address, data) != BF_SUCCESS) {
    return BF_HW_COMM_FAIL;
  }

  /* Read Global time stamp */
  address = TS_TOF3_MBC_MBUS_REG_OFFSET(global_ts_value.global_ts_value_0_2);

  if (lld_ts_reg_rd(dev_id, (bf_subdev_id_t)0, address, &data) != BF_SUCCESS) {
    return BF_HW_COMM_FAIL;
  }
  *global_ts_ns =
      getp_tof3_mbus_global_ts_value_global_ts_value_0_2_count_31_0(&data);

  address = TS_TOF3_MBC_MBUS_REG_OFFSET(global_ts_value.global_ts_value_1_2);
  if (lld_ts_reg_rd(dev_id, (bf_subdev_id_t)0, address, &data) != BF_SUCCESS) {
    return BF_HW_COMM_FAIL;
  }
  tmp = getp_tof3_mbus_global_ts_value_global_ts_value_1_2_count_47_32(&data);

  *global_ts_ns |= (uint64_t)(tmp << 32);

  /* Read Baresync time stamp */
  address =
      TS_TOF3_MBC_MBUS_REG_OFFSET(baresync_ts_value.baresync_ts_value_0_2);

  if (lld_ts_reg_rd(dev_id, (bf_subdev_id_t)0, address, &data) != BF_SUCCESS) {
    return BF_HW_COMM_FAIL;
  }
  *baresync_ts_ns =
      getp_tof3_mbus_baresync_ts_value_baresync_ts_value_0_2_count_31_0(&data);

  address =
      TS_TOF3_MBC_MBUS_REG_OFFSET(baresync_ts_value.baresync_ts_value_1_2);
  if (lld_ts_reg_rd(dev_id, (bf_subdev_id_t)0, address, &data) != BF_SUCCESS) {
    return BF_HW_COMM_FAIL;
  }
  tmp =
      getp_tof3_mbus_baresync_ts_value_baresync_ts_value_1_2_count_47_32(&data);
...
/**
 * @brief lld_tof3_ts_baresync_state_set
...
bf_status_t lld_tof3_ts_baresync_state_set(bf_dev_id_t dev_id,
  ...
  setp_tof3_mbus_ctrl_baresync_load_en(&data, enable);
  if (lld_ts_reg_wr(dev_id, address, data) != BF_SUCCESS) {
    return BF_HW_COMM_FAIL;
  }

  address = offsetof(tof3_reg, device_select.misc_regs.baresync_ctrl);
...
bf_status_t lld_tof3_ts_baresync_state_get(bf_dev_id_t dev_id,
  ...
  data = getp_tof3_mbus_ctrl_baresync_load_en(&data);
  *enable = (data ? true : false);
...
#endif
/**
 * @brief lld_tof3_ts_baresync_reset_value_set
...
bf_status_t lld_tof3_ts_baresync_reset_value_set(bf_dev_id_t dev_id,
  ...
  for (subdev = 0; subdev < num_subdev; subdev++) {
    ...
    setp_tof3_mbus_baresync_ts_set_value_baresync_ts_set_value_0_2_count_31_0(
    ...
    setp_tof3_mbus_baresync_ts_set_value_baresync_ts_set_value_1_2_count_47_32(
...
/**
 * @brief lld_tof3_ts_baresync_reset_value_get
...
bf_status_t lld_tof3_ts_baresync_reset_value_get(bf_dev_id_t dev_id,
  ...
  data =
      getp_tof3_mbus_baresync_ts_set_value_baresync_ts_set_value_0_2_count_31_0(
          &data);
  ...
  *baresync_time_ns = ((uint64_t)data & 0xFFFFFFFFUL);
  ...
  data =
      getp_tof3_mbus_baresync_ts_set_value_baresync_ts_set_value_1_2_count_47_32(
          &data);
...
/**
 * @brief lld_tof3_ts_baresync_increment_set
...
bf_status_t lld_tof3_ts_baresync_increment_set(
  ...
  for (subdev = 0; subdev < num_subdev; subdev++) {
    setp_tof3_mbus_baresync_ts_inc_inc_ns(inc_0_3, baresync_inc_time_ns);
    setp_tof3_mbus_baresync_ts_inc_fr_den(inc_0_3, baresync_inc_time_fract_den);
    setp_tof3_mbus_baresync_ts_inc_fr_num(inc_0_3, baresync_inc_time_fract_ns);

    address = TS_TOF3_MBC_MBUS_REG_OFFSET(baresync_ts_inc.baresync_ts_inc_0_3);
    if (lld_ts_reg_wr(dev_id, (bf_subdev_id_t)subdev, address, inc_0_3[0]) !=
        BF_SUCCESS) {
      return BF_HW_COMM_FAIL;
    }

    address = TS_TOF3_MBC_MBUS_REG_OFFSET(baresync_ts_inc.baresync_ts_inc_1_3);
    if (lld_ts_reg_wr(dev_id, (bf_subdev_id_t)subdev, address, inc_0_3[1]) !=
        BF_SUCCESS) {
      return BF_HW_COMM_FAIL;
    }

    address = TS_TOF3_MBC_MBUS_REG_OFFSET(baresync_ts_inc.baresync_ts_inc_2_3);
    if (lld_ts_reg_wr(dev_id, (bf_subdev_id_t)subdev, address, inc_0_3[2]) !=
        BF_SUCCESS) {
      return BF_HW_COMM_FAIL;
    }
  }
...
/**
 * @brief lld_tof3_ts_baresync_increment_get
...
bf_status_t lld_tof3_ts_baresync_increment_get(
  ...
  address = TS_TOF3_MBC_MBUS_REG_OFFSET(baresync_ts_inc.baresync_ts_inc_0_3);
  if (lld_ts_reg_rd(dev_id, (bf_subdev_id_t)0, address, &inc_0_3[0]) !=
      BF_SUCCESS) {
    return BF_HW_COMM_FAIL;
  }

  address = TS_TOF3_MBC_MBUS_REG_OFFSET(baresync_ts_inc.baresync_ts_inc_1_3);
  if (lld_ts_reg_rd(dev_id, (bf_subdev_id_t)0, address, &inc_0_3[1]) !=
      BF_SUCCESS) {
    return BF_HW_COMM_FAIL;
  }

  address = TS_TOF3_MBC_MBUS_REG_OFFSET(baresync_ts_inc.baresync_ts_inc_2_3);
  if (lld_ts_reg_rd(dev_id, (bf_subdev_id_t)0, address, &inc_0_3[2]) !=
      BF_SUCCESS) {
    return BF_HW_COMM_FAIL;
  }

  *baresync_inc_time_ns = getp_tof3_mbus_baresync_ts_inc_inc_ns(inc_0_3);
  *baresync_inc_time_fract_den = getp_tof3_mbus_baresync_ts_inc_fr_den(inc_0_3);
  *baresync_inc_time_fract_ns = getp_tof3_mbus_baresync_ts_inc_fr_num(inc_0_3);
  return BF_SUCCESS;
}
