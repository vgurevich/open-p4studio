...
/* Suffix S : start bit, Suffix W : bit width */
/* Node Type T */
#define MC_MGR_RDM_NODE_TYPE_S 0
#define MC_MGR_RDM_NODE_TYPE_W 4

/* INVALID: a value used to indicate invalid entry */
#define MC_MGR_RDM_NODE_INVALID_TYPE 10

/* L1_RID : default to xor variant*/
#define MC_MGR_RDM_NODE_L1RID_TYPE 1
...
/* L1_RID_XID :default to xor variant*/
#define MC_MGR_RDM_NODE_L1RIDXID_TYPE 3
...
/* L1_RID_NO_NEXT_XOR :default to xor variant*/
#define MC_MGR_RDM_NODE_L1RIDEND_TYPE 5
...
/* L1_ECMP_POINTER */
#define MC_MGR_RDM_NODE_PTR_TYPE 6
...
/* L1_ECMP_POINTER_XID */
#define MC_MGR_RDM_NODE_PTRXID_TYPE 7
...
/* L1_ECMP_VECTOR */
#define MC_MGR_RDM_NODE_VEC_TYPE 8
...
/* L2_LAG */
#define MC_MGR_RDM_NODE_L2LAG_TYPE 9
...
/* L2_PORT_18 */
/* Chip ID bit 0 is encoded inside the 'type', so for Chip 0 it will be 12
   for Chip 1 it will be 14 */
#define MC_MGR_RDM_NODE_L2PORT18_CHIP0_TYPE 12
#define MC_MGR_RDM_NODE_L2PORT18_CHIP1_TYPE 14
#define MC_MGR_RDM_NODE_L2PORT18_CHIP_0_S 1
#define MC_MGR_RDM_NODE_L2PORT18_CHIP_0_W 1
#define MC_MGR_RDM_NODE_L2PORT18_CHIP_1_S 4
#define MC_MGR_RDM_NODE_L2PORT18_CHIP_1_W 1
#define MC_MGR_RDM_NODE_L2PORT18_PIPE_S 5
#define MC_MGR_RDM_NODE_L2PORT18_PIPE_W 2
#define MC_MGR_RDM_NODE_L2PORT18_LAST_S 7
#define MC_MGR_RDM_NODE_L2PORT18_LAST_W 1
#define MC_MGR_RDM_NODE_L2PORT18_VEC_S 8
#define MC_MGR_RDM_NODE_L2PORT18_VEC_W 18
/* L1_PORT_72 */
/* Chip ID bit 0 is encoded inside the 'type', so for Chip 0 it will be 13
   for Chip 1 it will be 15 */
#define MC_MGR_RDM_NODE_L2PORT72_CHIP0_TYPE 13
#define MC_MGR_RDM_NODE_L2PORT72_CHIP1_TYPE 15
#define MC_MGR_RDM_NODE_L2PORT72_CHIP_0_S 1
#define MC_MGR_RDM_NODE_L2PORT72_CHIP_0_W 1
#define MC_MGR_RDM_NODE_L2PORT72_CHIP_1_S 4
#define MC_MGR_RDM_NODE_L2PORT72_CHIP_1_W 1
#define MC_MGR_RDM_NODE_L2PORT72_PIPE_S 5
...
#define MC_MGR_RDM_NODE_L2PORT72_PVEC_HI_S 72
#define MC_MGR_RDM_NODE_L2PORT72_PVEC_HI_W 8
...
bf_status_t tof3_mc_mgr_rdm_decode_line(mc_mgr_rdm_line_t *line) {
  ...
  switch (type) {
    case MC_MGR_RDM_NODE_INVALID_TYPE:
      line->type[0] = mc_mgr_rdm_node_type_invalid;
      upper_valid = true;
      break;
    ...
    case MC_MGR_RDM_NODE_VEC_TYPE:
      ...
      break;
    case MC_MGR_RDM_NODE_L2PORT18_CHIP0_TYPE:
    case MC_MGR_RDM_NODE_L2PORT18_CHIP1_TYPE:
      line->type[0] = mc_mgr_rdm_node_type_port18;
      upper_valid = true;
      die_id = bf_bs_get_word(&x,
                              MC_MGR_RDM_NODE_L2PORT18_CHIP_0_S,
                              MC_MGR_RDM_NODE_L2PORT18_CHIP_0_W);
      line->u.port18[0].pipe = (die_id * BF_SUBDEV_PIPE_COUNT) +
                               bf_bs_get_word(&x,
      ...
      line->u.port18[0].ports = bf_bs_get_word(
          &x, MC_MGR_RDM_NODE_L2PORT18_VEC_S, MC_MGR_RDM_NODE_L2PORT18_VEC_W);
      break;
    case MC_MGR_RDM_NODE_L2PORT72_CHIP0_TYPE:
    case MC_MGR_RDM_NODE_L2PORT72_CHIP1_TYPE:
      line->type[0] = mc_mgr_rdm_node_type_port72;
      die_id = bf_bs_get_word(&x,
                              MC_MGR_RDM_NODE_L2PORT72_CHIP_0_S,
                              MC_MGR_RDM_NODE_L2PORT72_CHIP_0_W);
      line->u.port72.pipe = (die_id * BF_SUBDEV_PIPE_COUNT) +
                            bf_bs_get_word(&x,
  ...
  if (upper_valid) {
    ...
    switch (type) {
      ...
      case MC_MGR_RDM_NODE_L2PORT18_CHIP1_TYPE:
        ...
        die_id = bf_bs_get_word(&x,
                                MC_MGR_RDM_NODE_L2PORT18_CHIP_0_S + 40,
                                MC_MGR_RDM_NODE_L2PORT18_CHIP_0_W);
        line->u.port18[1].pipe =
            (die_id * BF_SUBDEV_PIPE_COUNT) +
            bf_bs_get_word(&x,
        ...
        line->u.port18[1].ports =
            bf_bs_get_word(&x,
                           MC_MGR_RDM_NODE_L2PORT18_VEC_S + 40,
                           MC_MGR_RDM_NODE_L2PORT18_VEC_W);
        break;
      case MC_MGR_RDM_NODE_L2LAG_TYPE:
  ...
  switch (line->type[0]) {
    ...
    case mc_mgr_rdm_node_type_port18:
      ...
      bf_bs_set_word(&x,
                     MC_MGR_RDM_NODE_TYPE_S,
                     MC_MGR_RDM_NODE_TYPE_W,
                     MC_MGR_RDM_NODE_L2PORT18_CHIP0_TYPE);
      die_id = line->u.port18[0].pipe / BF_SUBDEV_PIPE_COUNT;
      bf_bs_set_word(&x,
                     MC_MGR_RDM_NODE_L2PORT18_CHIP_0_S,
                     MC_MGR_RDM_NODE_L2PORT18_CHIP_0_W,
                     die_id & 0x1);
      bf_bs_set_word(&x,
                     MC_MGR_RDM_NODE_L2PORT18_PIPE_S,
                     MC_MGR_RDM_NODE_L2PORT18_PIPE_W,
                     line->u.port18[0].pipe % BF_SUBDEV_PIPE_COUNT);
      bf_bs_set_word(&x,
                     MC_MGR_RDM_NODE_L2PORT18_LAST_S,
                     MC_MGR_RDM_NODE_L2PORT18_LAST_W,
                     line->u.port18[0].last);
      bf_bs_set_word(&x,
                     MC_MGR_RDM_NODE_L2PORT18_VEC_S,
                     MC_MGR_RDM_NODE_L2PORT18_VEC_W,
    ...
    case mc_mgr_rdm_node_type_port72:
      bf_bs_set_word(&x,
                     MC_MGR_RDM_NODE_TYPE_S,
                     MC_MGR_RDM_NODE_TYPE_W,
                     MC_MGR_RDM_NODE_L2PORT72_CHIP0_TYPE);
      die_id = line->u.port72.pipe / BF_SUBDEV_PIPE_COUNT;
      bf_bs_set_word(&x,
                     MC_MGR_RDM_NODE_L2PORT72_CHIP_0_S,
                     MC_MGR_RDM_NODE_L2PORT72_CHIP_0_W,
                     die_id & 0x1);
      bf_bs_set_word(&x,
                     MC_MGR_RDM_NODE_L2PORT72_PIPE_S,
                     MC_MGR_RDM_NODE_L2PORT72_PIPE_W,
                     line->u.port72.pipe % BF_SUBDEV_PIPE_COUNT);
      bf_bs_set_word(&x,
    ...
    switch (line->type[1]) {
      ...
      case mc_mgr_rdm_node_type_port18:
        bf_bs_set_word(&x,
                       ...
                       MC_MGR_RDM_NODE_TYPE_W,
                       MC_MGR_RDM_NODE_L2PORT18_CHIP0_TYPE);
        die_id = line->u.port18[1].pipe / BF_SUBDEV_PIPE_COUNT;
        bf_bs_set_word(&x,
                       MC_MGR_RDM_NODE_L2PORT18_CHIP_0_S + 40,
                       MC_MGR_RDM_NODE_L2PORT18_CHIP_0_W,
                       die_id & 0x1);
        bf_bs_set_word(&x,
                       MC_MGR_RDM_NODE_L2PORT18_PIPE_S + 40,
                       MC_MGR_RDM_NODE_L2PORT18_PIPE_W,
                       line->u.port18[1].pipe % BF_SUBDEV_PIPE_COUNT);
        bf_bs_set_word(&x,
                       MC_MGR_RDM_NODE_L2PORT18_LAST_S + 40,
                       MC_MGR_RDM_NODE_L2PORT18_LAST_W,
                       line->u.port18[1].last);
