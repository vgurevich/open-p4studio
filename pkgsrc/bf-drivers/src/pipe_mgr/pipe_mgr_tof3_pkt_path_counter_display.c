...
#define pipe_mgr_tof3_ipb_pktcnt_size 7  // ipb
...
#define PIPE_MGR_IPB_SP_CNT_SUB(_pipe, _pgport, _pgport1, _pgport2)           \
  {                                                                           \
      ...
      {offsetof(tof3_reg,                                                     \
                pipes[_pipe]                                                  \
                    .pardereg.pgstnreg.ipbprsr4reg[_pgport1]                  \
                    .ipbreg.chan##_pgport2##_group.chnl_parser_send_err_pkt   \
                    .chnl_parser_send_err_pkt_0_2),                           \
       2,                                                                     \
       BF_PACKETPATH_COUNTER_TYPE_PACKETCOUNT,                                \
       "chnl_parser_send_err_pkt",                                            \
       "IPB: err pkt counter"},                                               \
      {offsetof(tof3_reg,                                                     \
                pipes[_pipe]                                                  \
                    .pardereg.pgstnreg.ipbprsr4reg[_pgport1]                  \
      ...
      {offsetof(tof3_reg,                                                     \
                pipes[_pipe]                                                  \
                    .pardereg.pgstnreg.ipbprsr4reg[_pgport1]                  \
                    .ipbreg.chan##_pgport2##_group.chnl_deparser_send_err_pkt \
                    .chnl_deparser_send_err_pkt_0_2),                         \
       2,                                                                     \
       BF_PACKETPATH_COUNTER_TYPE_PACKETCOUNT,                                \
       "chnl_deparser_send_err_pkt",                                          \
       "IPB: deparser err pkt counter"},                                      \
      {offsetof(tof3_reg,                                                     \
                pipes[_pipe]                                                  \
                    .pardereg.pgstnreg.ipbprsr4reg[_pgport1]                  \
      ...
      {offsetof(tof3_reg,                                                     \
                pipes[_pipe]                                                  \
                    .pardereg.pgstnreg.ipbprsr4reg[_pgport1]                  \
                    .ipbreg.chan##_pgport2##_group.chnl_macs_received_err_pkt \
                    .chnl_macs_received_err_pkt_0_2),                         \
       2,                                                                     \
       BF_PACKETPATH_COUNTER_TYPE_PACKETCOUNT,                                \
       "chnl_macs_received_err_pkt",                                          \
       "IPB: MAC receive err pkt counter"},                                   \
  },

#define pipe_mgr_tof3_ipb_sp_pktcnt_size 6  // ipb special
...
#define pipe_mgr_tof3_iprsr_pktcnt_size 14  // iprsr pipe0-3, mac0-8, chnl0-7
...
#define PIPE_MGR_EPB_CNT_SUB(_pipe, _pgport, _pgport1, _pgport2)              \
  {                                                                           \
      ...
      {offsetof(tof3_reg,                                                     \
                pipes[_pipe]                                                  \
                    .pardereg.pgstnreg.epbprsr4reg[_pgport1]                  \
                    .epbreg.chan##_pgport2##_group.chnl_parser_send_err_pkt   \
                    .chnl_parser_send_err_pkt_0_2),                           \
       2,                                                                     \
       BF_PACKETPATH_COUNTER_TYPE_PACKETCOUNT,                                \
       "chnl_parser_send_err_pkt",                                            \
      ...
      {offsetof(tof3_reg,                                                     \
                pipes[_pipe]                                                  \
                    .pardereg.pgstnreg.epbprsr4reg[_pgport1]                  \
                    .epbreg.chan##_pgport2##_group.chnl_deparser_send_err_pkt \
                    .chnl_deparser_send_err_pkt_0_2),                         \
       2,                                                                     \
       BF_PACKETPATH_COUNTER_TYPE_PACKETCOUNT,                                \
       "chnl_deparser_send_err_pkt",                                          \
      ...
      {offsetof(tof3_reg,                                                     \
                pipes[_pipe]                                                  \
                    .pardereg.pgstnreg.epbprsr4reg[_pgport1]                  \
                    .epbreg.chan##_pgport2##_group.chnl_warp_send_err_pkt     \
                    .chnl_warp_send_err_pkt_0_2),                             \
       2,                                                                     \
       BF_PACKETPATH_COUNTER_TYPE_PACKETCOUNT,                                \
       "chnl_warp_send_err_pkt",                                              \
       "EPB: WARP Error packet count"},                                       \
      {offsetof(tof3_reg,                                                     \
                pipes[_pipe]                                                  \
                    .pardereg.pgstnreg.epbprsr4reg[_pgport1]                  \
      ...
      {offsetof(tof3_reg,                                                     \
                pipes[_pipe]                                                  \
                    .pardereg.pgstnreg.epbprsr4reg[_pgport1]                  \
                    .epbreg.chan##_pgport2##_group.chnl_p2s_received_err_pkt  \
                    .chnl_p2s_received_err_pkt_0_2),                          \
       2,                                                                     \
       BF_PACKETPATH_COUNTER_TYPE_PACKETCOUNT,                                \
       "chnl_p2s_received_err_pkt",                                           \
       "EPB: P2S error packet count"},                                        \
  },
#define pipe_mgr_tof3_epb_pktcnt_size 8  // epb
...
#define pipe_mgr_tof3_eprsr_pktcnt_size 14  // eprsr

#define pipe_mgr_tof3_pmarb_pktcnt_size 8
pipe_mgr_pktcnt_disp_t
    pipe_mgr_tof3_pmarb_pktcnt[4][pipe_mgr_tof3_pmarb_pktcnt_size] = {
        {
            {offsetof(tof3_reg,
                      pipes[0]
                          .pardereg.pgstnreg.parbreg.left.i_phv_count
                          .i_phv_count_0_2),
             2,
             BF_PACKETPATH_COUNTER_TYPE_INTERNALCOUNT,
             "i_phv_count",
            ...
            {offsetof(tof3_reg,
                      pipes[0]
                          .pardereg.pgstnreg.parbreg.left.i_eop_count
                          .i_phv_count_0_2),
             2,
             BF_PACKETPATH_COUNTER_TYPE_INTERNALCOUNT,
             "i_eop_count",
            ...
            {offsetof(tof3_reg,
                      pipes[0]
                          .pardereg.pgstnreg.parbreg.right.e_phv_count
                          .i_phv_count_0_2),
             1,
             BF_PACKETPATH_COUNTER_TYPE_INTERNALCOUNT,
             "e_phv_count",
            ...
            {offsetof(tof3_reg,
                      pipes[0]
                          .pardereg.pgstnreg.parbreg.right.e_eop_count
                          .i_phv_count_0_2),
             1,
             BF_PACKETPATH_COUNTER_TYPE_INTERNALCOUNT,
             "e_eop_count",
...
#define TOF3_IDPRSR_PERF_CNTR(slice, idx, chan)          \
  {offsetof(tof3_reg,                                    \
            pipes[0]                                     \
...
pipe_mgr_pktcnt_disp_t pipe_mgr_tof3_idprsr_pktcnt[] = {
    {offsetof(tof3_reg,
              pipes[0]
     ...
     "IDeparser: PHV count"},
    {offsetof(tof3_reg, pipes[0].pardereg.dprsrreg.dprsrreg.inp.icr.cfg48[0]),
     2,
     BF_PACKETPATH_COUNTER_TYPE_PACKETDROP,
     "inp.icr.cfg48[0]",
     "IDeparser: Drops"},
    {offsetof(tof3_reg, pipes[0].pardereg.dprsrreg.dprsrreg.inp.icr.cfg48[1]),
     2,
     BF_PACKETPATH_COUNTER_TYPE_PACKETCOUNT,
     "inp.icr.cfg48[1]",
     "IDeparser: Resubmit"},
    {offsetof(tof3_reg, pipes[0].pardereg.dprsrreg.dprsrreg.inp.icr.cfg48[2]),
     2,
     BF_PACKETPATH_COUNTER_TYPE_PACKETCOUNT,
     "inp.icr.cfg48[2]",
     "IDeparser: Forward"},
    ...
    TOF3_IDPRSR_PERF_CNTR(0, 16, " 0"),
    TOF3_IDPRSR_PERF_CNTR(0, 17, " 1"),
    TOF3_IDPRSR_PERF_CNTR(1, 16, " 2"),
    TOF3_IDPRSR_PERF_CNTR(1, 17, " 3"),
    TOF3_IDPRSR_PERF_CNTR(2, 16, " 4"),
    TOF3_IDPRSR_PERF_CNTR(2, 17, " 5"),
    TOF3_IDPRSR_PERF_CNTR(3, 16, " 6"),
    TOF3_IDPRSR_PERF_CNTR(3, 17, " 7"),
    TOF3_IDPRSR_PERF_CNTR(0, 0, " 8"),
    TOF3_IDPRSR_PERF_CNTR(0, 1, " 9"),
    TOF3_IDPRSR_PERF_CNTR(0, 2, "10"),
    TOF3_IDPRSR_PERF_CNTR(0, 3, "11"),
    TOF3_IDPRSR_PERF_CNTR(0, 4, "12"),
    TOF3_IDPRSR_PERF_CNTR(0, 5, "13"),
    TOF3_IDPRSR_PERF_CNTR(0, 6, "14"),
    TOF3_IDPRSR_PERF_CNTR(0, 7, "15"),
    TOF3_IDPRSR_PERF_CNTR(0, 8, "16"),
    TOF3_IDPRSR_PERF_CNTR(0, 9, "17"),
    TOF3_IDPRSR_PERF_CNTR(0, 10, "18"),
    TOF3_IDPRSR_PERF_CNTR(0, 11, "19"),
    TOF3_IDPRSR_PERF_CNTR(0, 12, "20"),
    TOF3_IDPRSR_PERF_CNTR(0, 13, "21"),
    TOF3_IDPRSR_PERF_CNTR(0, 14, "22"),
    TOF3_IDPRSR_PERF_CNTR(0, 15, "23"),
    TOF3_IDPRSR_PERF_CNTR(1, 0, "24"),
    TOF3_IDPRSR_PERF_CNTR(1, 1, "25"),
    TOF3_IDPRSR_PERF_CNTR(1, 2, "26"),
    TOF3_IDPRSR_PERF_CNTR(1, 3, "27"),
    TOF3_IDPRSR_PERF_CNTR(1, 4, "28"),
    TOF3_IDPRSR_PERF_CNTR(1, 5, "29"),
    TOF3_IDPRSR_PERF_CNTR(1, 6, "30"),
    TOF3_IDPRSR_PERF_CNTR(1, 7, "31"),
    TOF3_IDPRSR_PERF_CNTR(1, 8, "32"),
    TOF3_IDPRSR_PERF_CNTR(1, 9, "33"),
    TOF3_IDPRSR_PERF_CNTR(1, 10, "34"),
    TOF3_IDPRSR_PERF_CNTR(1, 11, "35"),
    TOF3_IDPRSR_PERF_CNTR(1, 12, "36"),
    TOF3_IDPRSR_PERF_CNTR(1, 13, "37"),
    TOF3_IDPRSR_PERF_CNTR(1, 14, "38"),
    TOF3_IDPRSR_PERF_CNTR(1, 15, "39"),
    TOF3_IDPRSR_PERF_CNTR(2, 0, "40"),
    TOF3_IDPRSR_PERF_CNTR(2, 1, "41"),
    TOF3_IDPRSR_PERF_CNTR(2, 2, "42"),
    TOF3_IDPRSR_PERF_CNTR(2, 3, "43"),
    TOF3_IDPRSR_PERF_CNTR(2, 4, "44"),
    TOF3_IDPRSR_PERF_CNTR(2, 5, "45"),
    TOF3_IDPRSR_PERF_CNTR(2, 6, "46"),
    TOF3_IDPRSR_PERF_CNTR(2, 7, "47"),
    TOF3_IDPRSR_PERF_CNTR(2, 8, "48"),
    TOF3_IDPRSR_PERF_CNTR(2, 9, "49"),
    TOF3_IDPRSR_PERF_CNTR(2, 10, "50"),
    TOF3_IDPRSR_PERF_CNTR(2, 11, "51"),
    TOF3_IDPRSR_PERF_CNTR(2, 12, "52"),
    TOF3_IDPRSR_PERF_CNTR(2, 13, "53"),
    TOF3_IDPRSR_PERF_CNTR(2, 14, "54"),
    TOF3_IDPRSR_PERF_CNTR(2, 15, "55"),
    TOF3_IDPRSR_PERF_CNTR(3, 0, "56"),
    TOF3_IDPRSR_PERF_CNTR(3, 1, "57"),
    TOF3_IDPRSR_PERF_CNTR(3, 2, "58"),
    TOF3_IDPRSR_PERF_CNTR(3, 3, "59"),
    TOF3_IDPRSR_PERF_CNTR(3, 4, "60"),
    TOF3_IDPRSR_PERF_CNTR(3, 5, "61"),
    TOF3_IDPRSR_PERF_CNTR(3, 6, "62"),
    TOF3_IDPRSR_PERF_CNTR(3, 7, "63"),
    TOF3_IDPRSR_PERF_CNTR(3, 8, "64"),
    TOF3_IDPRSR_PERF_CNTR(3, 9, "65"),
    TOF3_IDPRSR_PERF_CNTR(3, 10, "66"),
    TOF3_IDPRSR_PERF_CNTR(3, 11, "67"),
    TOF3_IDPRSR_PERF_CNTR(3, 12, "68"),
    TOF3_IDPRSR_PERF_CNTR(3, 13, "69"),
    TOF3_IDPRSR_PERF_CNTR(3, 14, "70"),
    TOF3_IDPRSR_PERF_CNTR(3, 15, "71"),
};

#define TOF3_EDPRSR_PERF_CNTR(slice, idx, chan)          \
  {offsetof(tof3_reg,                                    \
            pipes[0]                                     \
...
pipe_mgr_pktcnt_disp_t gpipe_mgr_tof3_edprsr_pktcnt[] = {
    {offsetof(tof3_reg,
              pipes[0]
    ...
    {offsetof(tof3_reg, pipes[0].pardereg.dprsrreg.dprsrreg.inp.icr.cfg48[3]),
     2,
     BF_PACKETPATH_COUNTER_TYPE_PACKETDROP,
     "inp.icr.cfg48[3]",
    ...
    TOF3_EDPRSR_PERF_CNTR(0, 16, " 0"),
    TOF3_EDPRSR_PERF_CNTR(0, 17, " 1"),
    TOF3_EDPRSR_PERF_CNTR(1, 16, " 2"),
    TOF3_EDPRSR_PERF_CNTR(1, 17, " 3"),
    TOF3_EDPRSR_PERF_CNTR(2, 16, " 4"),
    TOF3_EDPRSR_PERF_CNTR(2, 17, " 5"),
    TOF3_EDPRSR_PERF_CNTR(3, 16, " 6"),
    TOF3_EDPRSR_PERF_CNTR(3, 17, " 7"),
    TOF3_EDPRSR_PERF_CNTR(0, 0, " 8"),
    TOF3_EDPRSR_PERF_CNTR(0, 1, " 9"),
    TOF3_EDPRSR_PERF_CNTR(0, 2, "10"),
    TOF3_EDPRSR_PERF_CNTR(0, 3, "11"),
    TOF3_EDPRSR_PERF_CNTR(0, 4, "12"),
    TOF3_EDPRSR_PERF_CNTR(0, 5, "13"),
    TOF3_EDPRSR_PERF_CNTR(0, 6, "14"),
    TOF3_EDPRSR_PERF_CNTR(0, 7, "15"),
    TOF3_EDPRSR_PERF_CNTR(0, 8, "16"),
    TOF3_EDPRSR_PERF_CNTR(0, 9, "17"),
    TOF3_EDPRSR_PERF_CNTR(0, 10, "18"),
    TOF3_EDPRSR_PERF_CNTR(0, 11, "19"),
    TOF3_EDPRSR_PERF_CNTR(0, 12, "20"),
    TOF3_EDPRSR_PERF_CNTR(0, 13, "21"),
    TOF3_EDPRSR_PERF_CNTR(0, 14, "22"),
    TOF3_EDPRSR_PERF_CNTR(0, 15, "23"),
    TOF3_EDPRSR_PERF_CNTR(1, 0, "24"),
    TOF3_EDPRSR_PERF_CNTR(1, 1, "25"),
    TOF3_EDPRSR_PERF_CNTR(1, 2, "26"),
    TOF3_EDPRSR_PERF_CNTR(1, 3, "27"),
    TOF3_EDPRSR_PERF_CNTR(1, 4, "28"),
    TOF3_EDPRSR_PERF_CNTR(1, 5, "29"),
    TOF3_EDPRSR_PERF_CNTR(1, 6, "30"),
    TOF3_EDPRSR_PERF_CNTR(1, 7, "31"),
    TOF3_EDPRSR_PERF_CNTR(1, 8, "32"),
    TOF3_EDPRSR_PERF_CNTR(1, 9, "33"),
    TOF3_EDPRSR_PERF_CNTR(1, 10, "34"),
    TOF3_EDPRSR_PERF_CNTR(1, 11, "35"),
    TOF3_EDPRSR_PERF_CNTR(1, 12, "36"),
    TOF3_EDPRSR_PERF_CNTR(1, 13, "37"),
    TOF3_EDPRSR_PERF_CNTR(1, 14, "38"),
    TOF3_EDPRSR_PERF_CNTR(1, 15, "39"),
    TOF3_EDPRSR_PERF_CNTR(2, 0, "40"),
    TOF3_EDPRSR_PERF_CNTR(2, 1, "41"),
    TOF3_EDPRSR_PERF_CNTR(2, 2, "42"),
    TOF3_EDPRSR_PERF_CNTR(2, 3, "43"),
    TOF3_EDPRSR_PERF_CNTR(2, 4, "44"),
    TOF3_EDPRSR_PERF_CNTR(2, 5, "45"),
    TOF3_EDPRSR_PERF_CNTR(2, 6, "46"),
    TOF3_EDPRSR_PERF_CNTR(2, 7, "47"),
    TOF3_EDPRSR_PERF_CNTR(2, 8, "48"),
    TOF3_EDPRSR_PERF_CNTR(2, 9, "49"),
    TOF3_EDPRSR_PERF_CNTR(2, 10, "50"),
    TOF3_EDPRSR_PERF_CNTR(2, 11, "51"),
    TOF3_EDPRSR_PERF_CNTR(2, 12, "52"),
    TOF3_EDPRSR_PERF_CNTR(2, 13, "53"),
    TOF3_EDPRSR_PERF_CNTR(2, 14, "54"),
    TOF3_EDPRSR_PERF_CNTR(2, 15, "55"),
    TOF3_EDPRSR_PERF_CNTR(3, 0, "56"),
    TOF3_EDPRSR_PERF_CNTR(3, 1, "57"),
    TOF3_EDPRSR_PERF_CNTR(3, 2, "58"),
    TOF3_EDPRSR_PERF_CNTR(3, 3, "59"),
    TOF3_EDPRSR_PERF_CNTR(3, 4, "60"),
    TOF3_EDPRSR_PERF_CNTR(3, 5, "61"),
    TOF3_EDPRSR_PERF_CNTR(3, 6, "62"),
    TOF3_EDPRSR_PERF_CNTR(3, 7, "63"),
    TOF3_EDPRSR_PERF_CNTR(3, 8, "64"),
    TOF3_EDPRSR_PERF_CNTR(3, 9, "65"),
    TOF3_EDPRSR_PERF_CNTR(3, 10, "66"),
    TOF3_EDPRSR_PERF_CNTR(3, 11, "67"),
    TOF3_EDPRSR_PERF_CNTR(3, 12, "68"),
    TOF3_EDPRSR_PERF_CNTR(3, 13, "69"),
    TOF3_EDPRSR_PERF_CNTR(3, 14, "70"),
    TOF3_EDPRSR_PERF_CNTR(3, 15, "71"),
};
  ...
  {                                                                           \
      {offsetof(tof3_reg,                                                     \
                pipes[_pipe]                                                  \
                    ...
                    .chnl_pktnum_dprsr_rcv.chnl_pktnum_dprsr_rcv_0_2),        \
       2,                                                                     \
       BF_PACKETPATH_COUNTER_TYPE_PACKETCOUNT,                                \
       "chnl_pktnum",                                                         \
       "Ebuf: dprsr rcv pkt"},                                                \
      {offsetof(tof3_reg,                                                     \
                pipes[_pipe]                                                  \
                    ...
                    .ebuf400reg[(_pgport - 8) / 8 - 2 * ((_pgport - 8) / 16)] \
                    .chan_group[_pgport % 8]                                  \
                    .chnl_pktnum_dprsr_err.chnl_pktnum_dprsr_err_0_2),        \
       2,                                                                     \
       BF_PACKETPATH_COUNTER_TYPE_PACKETERROR,                                \
       "chnl_pktnum",                                                         \
       "Ebuf: dprsr err pkt"},                                                \
      {offsetof(tof3_reg,                                                     \
                pipes[_pipe]                                                  \
                    ...
                    .ebuf400reg[(_pgport - 8) / 8 - 2 * ((_pgport - 8) / 16)] \
                    .chan_group[_pgport % 8]                                  \
                    .chnl_pktnum_dprsr_runt.chnl_pktnum_dprsr_runt_0_2),      \
       2,                                                                     \
       BF_PACKETPATH_COUNTER_TYPE_PACKETCOUNT,                                \
       "chnl_pktnum",                                                         \
       "Ebuf: dprsr runt pkt"},                                               \
      {offsetof(tof3_reg,                                                     \
                pipes[_pipe]                                                  \
                    ...
                    .ebuf400reg[(_pgport - 8) / 8 - 2 * ((_pgport - 8) / 16)] \
                    .chan_group[_pgport % 8]                                  \
                    .chnl_pktnum_warp_rcv.chnl_pktnum_warp_rcv_0_2),          \
       2,                                                                     \
       BF_PACKETPATH_COUNTER_TYPE_PACKETCOUNT,                                \
       "chnl_pktnum",                                                         \
       "Ebuf: warp rcv pkt"},                                                 \
      {offsetof(tof3_reg,                                                     \
                pipes[_pipe]                                                  \
                    ...
                    .ebuf400reg[(_pgport - 8) / 8 - 2 * ((_pgport - 8) / 16)] \
                    .chan_group[_pgport % 8]                                  \
                    .chnl_pktnum_warp_err.chnl_pktnum_warp_err_0_2),          \
       2,                                                                     \
       BF_PACKETPATH_COUNTER_TYPE_PACKETERROR,                                \
       "chnl_pktnum",                                                         \
       "Ebuf: warp err pkt"},                                                 \
      {offsetof(tof3_reg,                                                     \
                pipes[_pipe]                                                  \
                    ...
                    .ebuf400reg[(_pgport - 8) / 8 - 2 * ((_pgport - 8) / 16)] \
                    .chan_group[_pgport % 8]                                  \
                    .chnl_pktnum_warp_runt.chnl_pktnum_warp_runt_0_2),        \
       2,                                                                     \
       BF_PACKETPATH_COUNTER_TYPE_PACKETCOUNT,                                \
       "chnl_pktnum",                                                         \
       "Ebuf: warp runt pkt"},                                                \
      {offsetof(tof3_reg,                                                     \
                pipes[_pipe]                                                  \
                    ...
                    .ebuf400reg[(_pgport - 8) / 8 - 2 * ((_pgport - 8) / 16)] \
                    .chan_group[_pgport % 8]                                  \
                    .chnl_pktnum_mac_xmt.chnl_pktnum_mac_xmt_0_2),            \
       2,                                                                     \
       BF_PACKETPATH_COUNTER_TYPE_PACKETCOUNT,                                \
       "chnl_pktnum",                                                         \
       "Ebuf: mac xmt pkt"},                                                  \
      {offsetof(tof3_reg,                                                     \
                pipes[_pipe]                                                  \
                    ...
                    .ebuf400reg[(_pgport - 8) / 8 - 2 * ((_pgport - 8) / 16)] \
                    .chan_group[_pgport % 8]                                  \
                    .chnl_pktnum_mac_err.chnl_pktnum_mac_err_0_2),            \
       2,                                                                     \
       BF_PACKETPATH_COUNTER_TYPE_PACKETERROR,                                \
       "chnl_pktnum",                                                         \
       "Ebuf: mac err pkt"},                                                  \
...
#define pipe_mgr_tof3_ebuf_pktcnt_size 11

#define PIPE_MGR_S2P_CNT_SUB(_pipe, _pgport)                                   \
  {                                                                            \
      {offsetof(tof3_reg,                                                      \
                pipes[_pipe].pardereg.pgstnreg.s2preg.reg_1.pkt_ctr[_pgport]), \
       1,                                                                      \
       BF_PACKETPATH_COUNTER_TYPE_PACKETCOUNT,                                 \
       "pkt_ctr",                                                              \
       "S2P: Packet counter"},                                                 \
      {offsetof(tof3_reg,                                                      \
                pipes[_pipe]                                                   \
                    .pardereg.pgstnreg.s2preg.reg_1.byte_ctr[_pgport]          \
                    .byte_ctr_0_2),                                            \
       2,                                                                      \
       BF_PACKETPATH_COUNTER_TYPE_PACKETCOUNT,                                 \
       "byte_ctr",                                                             \
...
#define pipe_mgr_tof3_s2p_pktcnt_size 2

#define PIPE_MGR_P2S_CNT_SUB(_pipe, _pgport)                                   \
  {                                                                            \
      {offsetof(tof3_reg,                                                      \
                pipes[_pipe].pardereg.pgstnreg.p2sreg.reg_0.pkt_ctr[_pgport]), \
       1,                                                                      \
       BF_PACKETPATH_COUNTER_TYPE_PACKETCOUNT,                                 \
       "pkt_ctr",                                                              \
       "P2S: Packet counter"},                                                 \
      {offsetof(tof3_reg,                                                      \
                pipes[_pipe]                                                   \
                    .pardereg.pgstnreg.p2sreg.reg_0.byte_ctr[_pgport]          \
                    .byte_ctr_0_2),                                            \
       2,                                                                      \
       BF_PACKETPATH_COUNTER_TYPE_PACKETCOUNT,                                 \
       "byte_ctr",                                                             \
...
#define pipe_mgr_tof3_p2s_pktcnt_size 2
...
#define PIPE_MGR_P2S_CNT                                                    \
  pipe_mgr_pktcnt_disp_t                                                    \
      pipe_mgr_tof3_p2s_pktcnt[TOF3_NUM_PIPELINES][TOF3_NUM_PORTS_PER_PIPE] \
                              [pipe_mgr_tof3_p2s_pktcnt_size] = {           \
                                  DUP(P2S)};  // p2s

#define PIPE_MGR_S2P_CNT                                                     \
  pipe_mgr_pktcnt_disp_t                                                     \
      gpipe_mgr_tof3_s2p_pktcnt[TOF3_NUM_PIPELINES][TOF3_NUM_PORTS_PER_PIPE] \
                               [pipe_mgr_tof3_s2p_pktcnt_size] = {           \
                                   DUP(S2P)};  // s2p

#define PIPE_MGR_IPRSR_CNT                                                    \
  pipe_mgr_pktcnt_disp_t                                                      \
      pipe_mgr_tof3_iprsr_pktcnt[TOF3_NUM_PIPELINES][TOF3_NUM_PORTS_PER_PIPE] \
                                [pipe_mgr_tof3_iprsr_pktcnt_size] = {         \
                                    DUP(IPRSR)};  // iprsr

#define PIPE_MGR_EPRSR_CNT                                                    \
  pipe_mgr_pktcnt_disp_t                                                      \
      pipe_mgr_tof3_eprsr_pktcnt[TOF3_NUM_PIPELINES][TOF3_NUM_PORTS_PER_PIPE] \
                                [pipe_mgr_tof3_eprsr_pktcnt_size] = {         \
                                    DUP(EPRSR)};  // eprsr
...
#define PIPE_MGR_EBUF_CNT                                                    \
  pipe_mgr_pktcnt_disp_t                                                     \
      pipe_mgr_tof3_ebuf_pktcnt[TOF3_NUM_PIPELINES][TOF3_NUM_PORTS_PER_PIPE] \
                               [pipe_mgr_tof3_ebuf_pktcnt_size] = {          \
                                   DUP_EBUF(EBUF)};  // ebuf
...
#define PIPE_MGR_IPB_CNT                                                    \
  pipe_mgr_pktcnt_disp_t                                                    \
      pipe_mgr_tof3_ipb_pktcnt[TOF3_NUM_PIPELINES][TOF3_NUM_PORTS_PER_PIPE] \
                              [pipe_mgr_tof3_ipb_pktcnt_size] = {           \
                                  DUP_SP(IPB)};  // ipb
#define PIPE_MGR_IPB_SP_CNT                                                    \
  pipe_mgr_pktcnt_disp_t                                                       \
      pipe_mgr_tof3_ipb_sp_pktcnt[TOF3_NUM_PIPELINES][TOF3_NUM_PORTS_PER_PIPE] \
                                 [pipe_mgr_tof3_ipb_sp_pktcnt_size] = {        \
                                     DUP_SP(IPB_SP)};  // ipb special

#define PIPE_MGR_EPB_CNT                                                    \
  pipe_mgr_pktcnt_disp_t                                                    \
      pipe_mgr_tof3_epb_pktcnt[TOF3_NUM_PIPELINES][TOF3_NUM_PORTS_PER_PIPE] \
                              [pipe_mgr_tof3_epb_pktcnt_size] = {           \
                                  DUP_SP(EPB)};  // epb
...
#define GET_STRUCT_SIZE(_name) pipe_mgr_tof3_##_name##_pktcnt_size
...
static void pipe_mgr_tof3_pkt_path_cnt_struct_walk(
    ucli_context_t *uc,
    int hex,
    bool non_zero,
    int devid,
  ...
  for (i = 0; i < cnt_size; i++) {
    lld_subdev_read_register(devid, subdev, cnt_p[i].pktcnt, &val);
    cnt = val;
    if (cnt_p[i].cnt_numb > 1) {
      lld_subdev_read_register(devid, subdev, (cnt_p[i].pktcnt + 0x4ul), &val);
      cnt_tmp = val;
      cnt = cnt + (cnt_tmp << 32);
    }
    if (non_zero && (cnt == 0)) {
...
static void pipe_mgr_tof3_pkt_path_cnt_struct_array_walk(
    ucli_context_t *uc,
    int hex,
    bool non_zero,
    int devid,
  ...
  for (i = 0; i < cnt_size; i++) {
    cnt = 0;
    for (j = 0; j < range; j++) {
      lld_subdev_read_register(devid, subdev, cnt_p[j][i].pktcnt, &val1);
      if (cnt_p[j][i].cnt_numb > 1) {
        lld_subdev_read_register(
            devid, subdev, (cnt_p[j][i].pktcnt + 0x4ul), &val2);
        cnt_tmp = val2;
...
static void pipe_mgr_tof3_ipb_sp_pkt_path_cnt_struct_array_walk(
    ucli_context_t *uc,
    int hex,
    bool non_zero,
    int devid,
...
void pipe_mgr_tof3_pkt_path_display_iprsr_counter(ucli_context_t *uc,
                                                  ...
                                                  int pg_port_end) {
  int cnt_size;
  int i, port_tmp = pg_port;
  int range = pg_port_end - pg_port;
  pipe_mgr_pktcnt_disp_t *cnt_p[8];
  if ((pipe >= BF_PIPE_COUNT) || (pg_port + range > TOF3_NUM_PORTS_PER_PIPE) ||
      (range > 8) || (range <= 0))
    return;
  cnt_size = GET_STRUCT_SIZE(iprsr);
  for (i = 0; i < range; i++) {
    cnt_p[i] =
        pipe_mgr_tof3_iprsr_pktcnt[pipe % BF_SUBDEV_PIPE_COUNT][port_tmp++];
  }
  aim_printf(
      &uc->pvs, "%-49s", "iprsr-counter                                ");
  pipe_mgr_tof3_pkt_path_cnt_struct_array_walk(uc,
                                               hex,
                                               non_zero,
                                               devid,
                                               pipe / BF_SUBDEV_PIPE_COUNT,
                                               cnt_size,
                                               cnt_p,
                                               range);
  aim_printf(&uc->pvs, "\n");
...
void pipe_mgr_tof3_pkt_path_display_eprsr_counter(ucli_context_t *uc,
  ...
  for (i = 0; i < range; i++) {
    cnt_p[i] =
        pipe_mgr_tof3_eprsr_pktcnt[pipe % BF_SUBDEV_PIPE_COUNT][port_tmp++];
  }
  aim_printf(
...
void pipe_mgr_tof3_pkt_path_display_ipb_counter(ucli_context_t *uc,
  ...
  if ((pipe >= BF_PIPE_COUNT) || (pg_port + range > TOF3_NUM_PORTS_PER_PIPE) ||
    ...
    return;
  for (i = 0; i < range; i++) {
    cnt_p[i] = pipe_mgr_tof3_ipb_pktcnt[pipe % BF_SUBDEV_PIPE_COUNT][port_tmp];
    cnt_p_sp[i] =
        pipe_mgr_tof3_ipb_sp_pktcnt[pipe % BF_SUBDEV_PIPE_COUNT][port_tmp];
    port_tmp++;
  }
  aim_printf(
  ...
  pipe_mgr_tof3_pkt_path_cnt_struct_array_walk(uc,
                                               ...
                                               cnt_p,
                                               range);
  pipe_mgr_tof3_ipb_sp_pkt_path_cnt_struct_array_walk(
      uc,
      hex,
      non_zero,
      devid,
      pipe / BF_SUBDEV_PIPE_COUNT,
      GET_STRUCT_SIZE(ipb_sp),
      cnt_p_sp,
      range);
  aim_printf(&uc->pvs, "\n");
  aim_printf(&uc->pvs, "\n");
...
void pipe_mgr_tof3_pkt_path_display_epb_counter(ucli_context_t *uc,
  ...
  for (i = 0; i < range; i++) {
    cnt_p[i] =
        pipe_mgr_tof3_epb_pktcnt[pipe % BF_SUBDEV_PIPE_COUNT][port_tmp++];
  }
  aim_printf(
...
void pipe_mgr_tof3_pkt_path_display_ebuf_counter(ucli_context_t *uc,
  ...
  for (i = 0; i < range; i++) {
    cnt_p[i] =
        pipe_mgr_tof3_ebuf_pktcnt[pipe % BF_SUBDEV_PIPE_COUNT][port_tmp++];
  }
  aim_printf(
...
void pipe_mgr_tof3_pkt_path_display_s2p_counter(ucli_context_t *uc,
  ...
  for (i = 0; i < range; i++) {
    cnt_p[i] =
        gpipe_mgr_tof3_s2p_pktcnt[pipe % BF_SUBDEV_PIPE_COUNT][port_tmp++];
  }
  ...
  lld_subdev_write_register(
      ...
      subdev,
      offsetof(tof3_reg,
               pipes[pipe % BF_SUBDEV_PIPE_COUNT]
                   .pardereg.pgstnreg.s2preg.reg_1.ctr_sample),
      1);

  aim_printf(
      &uc->pvs, "%-49s", "s2p-counter                                  ");
  pipe_mgr_tof3_pkt_path_cnt_struct_array_walk(
      uc, hex, non_zero, devid, subdev, cnt_size, cnt_p, range);
  aim_printf(&uc->pvs, "\n");
  aim_printf(&uc->pvs, "\n");
  aim_printf(&uc->pvs, "\n");
}
void pipe_mgr_tof3_pkt_path_display_p2s_counter(ucli_context_t *uc,
  ...
  for (i = 0; i < range; i++) {
    cnt_p[i] =
        pipe_mgr_tof3_p2s_pktcnt[pipe % BF_SUBDEV_PIPE_COUNT][port_tmp++];
  }
  bf_subdev_id_t subdev = pipe / BF_SUBDEV_PIPE_COUNT;
  ...
  lld_subdev_write_register(
      ...
      offsetof(tof3_reg,
               pipes[pipe % BF_SUBDEV_PIPE_COUNT]
                   .pardereg.pgstnreg.p2sreg.reg_0.ctr_sample),
      1);
...
void pipe_mgr_tof3_pkt_path_display_idprsr_counter(
  ...
  bf_packetpath_counter_t *r =
      pipe_mgr_tof3_pkt_path_idprsr_read_counter(dev_info, pipe, &count);
  if (!r) return;
  ...
  for (int i = 0; i < count; ++i) {
    ...
    aim_printf(&uc->pvs, "%-30s", pipe_mgr_tof3_idprsr_pktcnt[i].pktcnt_name);
    aim_printf(&uc->pvs, "\n");
  }
...
void pipe_mgr_tof3_pkt_path_display_edprsr_counter(
  ...
  int count = 0;
  bf_packetpath_counter_t *r =
      pipe_mgr_tof3_pkt_path_edprsr_read_counter(dev_info, pipe, &count);
  if (!r) return;
  ...
  for (int i = 0; i < count; ++i) {
    ...
    aim_printf(&uc->pvs, "%-30s", gpipe_mgr_tof3_edprsr_pktcnt[i].pktcnt_name);
    aim_printf(&uc->pvs, "\n");
  }
...
void pipe_mgr_tof3_pkt_path_display_pmarb_counter(
  ...
  pipe_mgr_pktcnt_disp_t *cnt_p =
      pipe_mgr_tof3_pmarb_pktcnt[pipe % BF_SUBDEV_PIPE_COUNT];
  aim_printf(
      &uc->pvs, "%-49s", "pmarb-counter                                ");
  pipe_mgr_tof3_pkt_path_cnt_struct_walk(
      uc, hex, non_zero, devid, pipe / BF_SUBDEV_PIPE_COUNT, cnt_size, cnt_p);
  aim_printf(&uc->pvs, "\n");
  aim_printf(&uc->pvs, "\n");
  aim_printf(&uc->pvs, "\n");
}
void pipe_mgr_tof3_pkt_path_display_pipe_counter(ucli_context_t *uc,
                                                 ...
                                                 int devid,
                                                 int pipe) {
  pipe_mgr_tof3_pkt_path_display_idprsr_counter(uc, hex, false, devid, pipe);
  pipe_mgr_tof3_pkt_path_display_edprsr_counter(uc, hex, false, devid, pipe);
  aim_printf(&uc->pvs, "\n");
  aim_printf(&uc->pvs, "\n");
  aim_printf(&uc->pvs, "\n");
}
...
void pipe_mgr_tof3_nonzero_pipe_counter_cli(ucli_context_t *uc,
                                            int devid,
                                            int pipe) {
  pipe_mgr_tof3_pkt_path_display_idprsr_counter(uc, true, true, devid, pipe);
  pipe_mgr_tof3_pkt_path_display_edprsr_counter(uc, true, true, devid, pipe);
  pipe_mgr_tof3_pkt_path_display_pmarb_counter(uc, true, true, devid, pipe);
}
void pipe_mgr_tof3_pipe_counter_cli(ucli_context_t *uc, int devid, int pipe) {
  pipe_mgr_tof3_pkt_path_display_idprsr_counter(uc, true, false, devid, pipe);
  pipe_mgr_tof3_pkt_path_display_edprsr_counter(uc, true, false, devid, pipe);
  pipe_mgr_tof3_pkt_path_display_pmarb_counter(uc, true, false, devid, pipe);
}
...
#endif
static void tof3_pkt_path_do_read(bf_dev_id_t dev_id,
                                  bf_subdev_id_t subdev,
                                  int count,
                                  uint32_t offset,
  ...
  for (int i = 0; i < count; ++i) {
    ...
    for (int j = 0; j < src[i].cnt_numb; ++j) {
      ...
      uint64_t y = 0;
      lld_subdev_read_register(
          dev_id, subdev, src[i].pktcnt + offset + 4 * j, &x);
      y = x;
      dst[i].value += y << (32 * j);
    }
  }
}
static void tof3_pkt_path_do_clear(bf_dev_id_t dev_id,
                                   int subdev,
                                   int count,
                                   uint32_t offset,
                                   pipe_mgr_pktcnt_disp_t *src) {
  for (int i = 0; i < count; ++i)
    for (int j = 0; j < src[i].cnt_numb; ++j)
      lld_subdev_write_register(
          dev_id, subdev, src[i].pktcnt + offset + 4 * j, 0);
}
static void pipe_mgr_tof3_pkt_path_clear_cnt_struct_walk(
    int devid, int subdev, int cnt_size, pipe_mgr_pktcnt_disp_t *cnt_p) {
  int i;
  for (i = 0; i < cnt_size; i++) {
    lld_subdev_write_register(devid, subdev, cnt_p[i].pktcnt, 0);
    if (cnt_p[i].cnt_numb > 1) {
      lld_subdev_write_register(devid, subdev, (cnt_p[i].pktcnt + 0x4ul), 0);
    }
  }
  return;
}
static void pipe_mgr_tof3_pkt_path_clear_cnt_struct_array_walk(
    int devid,
    int subdev,
    int cnt_size,
    pipe_mgr_pktcnt_disp_t **cnt_p,
  ...
  for (i = 0; i < cnt_size; i++) {
    for (j = 0; j < range; j++) {
      lld_subdev_write_register(devid, subdev, cnt_p[j][i].pktcnt, 0);
      if (cnt_p[j][i].cnt_numb > 1) {
        lld_subdev_write_register(
            devid, subdev, (cnt_p[j][i].pktcnt + 0x4ul), 0);
      }
    }
  }
  return;
}
static void pipe_mgr_tof3_ipb_sp_pkt_path_clear_cnt_struct_array_walk(
    int devid,
    int subdev,
    int cnt_size,
    pipe_mgr_pktcnt_disp_t **cnt_p,
  ...
  for (i = 0; i < cnt_size; (i = i + 2)) {
    for (j = 0; j < range; j++) {
      lld_subdev_write_register(devid, subdev, cnt_p[j][i].pktcnt, 0);
      lld_subdev_write_register(devid, subdev, (cnt_p[j][i].pktcnt + 0x4ul), 0);
      lld_subdev_write_register(devid, subdev, (cnt_p[j][i].pktcnt + 0x8ul), 0);
    }
  }
  return;
}
void pipe_mgr_tof3_pkt_path_clear_iprsr_counter(int devid,
  ...
  pipe_mgr_tof3_pkt_path_clear_cnt_struct_array_walk(
      devid, pipe / BF_SUBDEV_PIPE_COUNT, cnt_size, cnt_p, range);
}
...
void pipe_mgr_tof3_pkt_path_clear_ipb_counter(int devid,
  ...
  pipe_mgr_tof3_pkt_path_clear_cnt_struct_array_walk(
      devid, pipe / BF_SUBDEV_PIPE_COUNT, cnt_size, cnt_p, range);
  pipe_mgr_tof3_ipb_sp_pkt_path_clear_cnt_struct_array_walk(
      devid,
      pipe / BF_SUBDEV_PIPE_COUNT,
      GET_STRUCT_SIZE(ipb_sp),
      cnt_p_sp,
...
void pipe_mgr_tof3_pkt_path_clear_idprsr_counter(rmt_dev_info_t *dev_info,
                                                 int pipe) {
  uint32_t offset =
      dev_info->dev_cfg.dir_addr_set_pipe_id(0, pipe % BF_SUBDEV_PIPE_COUNT);
   ...
   * a smaller size. */
  int c = 28;
  tof3_pkt_path_do_clear(dev_info->dev_id,
                         pipe / BF_SUBDEV_PIPE_COUNT,
                         c,
                         offset,
                         pipe_mgr_tof3_idprsr_pktcnt);
}
void pipe_mgr_tof3_pkt_path_clear_edprsr_counter(rmt_dev_info_t *dev_info,
  ...
  tof3_pkt_path_do_clear(dev_info->dev_id,
                         ...
                         c,
                         offset,
                         gpipe_mgr_tof3_edprsr_pktcnt);
}
void pipe_mgr_tof3_pkt_path_clear_pmarb_counter(int devid, int pipe) {
  int cnt_size = GET_STRUCT_SIZE(pmarb);
  pipe_mgr_pktcnt_disp_t *cnt_p =
      pipe_mgr_tof3_pmarb_pktcnt[pipe % BF_SUBDEV_PIPE_COUNT];
  pipe_mgr_tof3_pkt_path_clear_cnt_struct_walk(
      devid, pipe / BF_SUBDEV_PIPE_COUNT, cnt_size, cnt_p);
}
...
void pipe_mgr_tof3_pkt_path_clear_all_counter(int devid, int pipe) {
  ...
  for (pg_port = 0; pg_port < 72; pg_port++) {
    pipe_mgr_tof3_pkt_path_clear_iprsr_counter(devid, pipe, pg_port, 0);
    pipe_mgr_tof3_pkt_path_clear_eprsr_counter(devid, pipe, pg_port, 0);
    pipe_mgr_tof3_pkt_path_clear_ipb_counter(devid, pipe, pg_port, 0);
    pipe_mgr_tof3_pkt_path_clear_epb_counter(devid, pipe, pg_port, 0);
    pipe_mgr_tof3_pkt_path_clear_ebuf_counter(devid, pipe, pg_port, 0);
    pipe_mgr_tof3_pkt_path_clear_s2p_counter(devid, pipe, pg_port, 0);
    pipe_mgr_tof3_pkt_path_clear_p2s_counter(devid, pipe, pg_port, 0);
  }
  pipe_mgr_tof3_pkt_path_clear_idprsr_counter(dev_info, pipe);
  pipe_mgr_tof3_pkt_path_clear_edprsr_counter(dev_info, pipe);
...
/*read*/
static void pipe_mgr_tof3_pkt_path_cnt_struct_read_walk(
    int devid,
    bf_subdev_id_t subdev,
    int cnt_size,
    pipe_mgr_pktcnt_disp_t *cnt_p,
...
static void pipe_mgr_tof3_ipb_sp_pkt_path_cnt_struct_read_walk(
    int devid,
    bf_subdev_id_t subdev,
    int cnt_size,
    pipe_mgr_pktcnt_disp_t *cnt_p,
  ...
  for (i = 0; i < cnt_size; (i = i + 2)) {
    lld_subdev_read_register(devid, subdev, cnt_p[i].pktcnt, &val1);
    lld_subdev_read_register(devid, subdev, (cnt_p[i].pktcnt + 0x4ul), &val2);
    lld_subdev_read_register(devid, subdev, (cnt_p[i].pktcnt + 0x8ul), &val3);
    cnt_tmp = val2;
...
bf_packetpath_counter_t *pipe_mgr_tof3_pkt_path_iprsr_read_counter(
    int devid, int pipe, int pg_port, int port_numb, int *count) {
  pipe_mgr_pktcnt_disp_t *cnt_p;
  ...
  *count = (cnt_size * port_numb);
  while (i < port_numb) {
    cnt_p =
        pipe_mgr_tof3_iprsr_pktcnt[pipe % BF_SUBDEV_PIPE_COUNT][pg_port + i];
    pipe_mgr_tof3_pkt_path_cnt_struct_read_walk(
        devid,
        pipe / BF_SUBDEV_PIPE_COUNT,
        cnt_size,
        cnt_p,
        (counter_head + (i * cnt_size)));
    i++;
  }
  return counter_head;
}
bf_packetpath_counter_t *pipe_mgr_tof3_pkt_path_idprsr_read_counter(
  ...
  int c = sizeof pipe_mgr_tof3_idprsr_pktcnt /
          sizeof pipe_mgr_tof3_idprsr_pktcnt[0];
  bf_packetpath_counter_t *r =
  ...
  uint32_t offset =
      dev_info->dev_cfg.dir_addr_set_pipe_id(0, pipe % BF_SUBDEV_PIPE_COUNT);
  tof3_pkt_path_do_read(dev_info->dev_id,
                        pipe / BF_SUBDEV_PIPE_COUNT,
                        c,
                        offset,
                        pipe_mgr_tof3_idprsr_pktcnt,
...
bf_packetpath_counter_t *pipe_mgr_tof3_pkt_path_epb_ebuf_read_counter(
  ...
  *count = (cnt_size_all * port_numb);
  while (i < port_numb) {
    cnt_p = pipe_mgr_tof3_ebuf_pktcnt[pipe % BF_SUBDEV_PIPE_COUNT][pg_port + i];
    pipe_mgr_tof3_pkt_path_cnt_struct_read_walk(
        devid,
        pipe / BF_SUBDEV_PIPE_COUNT,
        cnt_size,
        cnt_p,
        (counter_head + (i * cnt_size_all)));
    cnt_p = pipe_mgr_tof3_epb_pktcnt[pipe % BF_SUBDEV_PIPE_COUNT][pg_port + i];
    pipe_mgr_tof3_pkt_path_cnt_struct_read_walk(
        devid,
        pipe / BF_SUBDEV_PIPE_COUNT,
        cnt_size1,
...
bf_packetpath_counter_t *pipe_mgr_tof3_pkt_path_eprsr_read_counter(
  ...
  *count = (cnt_size * port_numb);
  while (i < port_numb) {
    cnt_p =
        pipe_mgr_tof3_eprsr_pktcnt[pipe % BF_SUBDEV_PIPE_COUNT][pg_port + i];
    pipe_mgr_tof3_pkt_path_cnt_struct_read_walk(
        devid,
        pipe / BF_SUBDEV_PIPE_COUNT,
        cnt_size,
...
bf_packetpath_counter_t *pipe_mgr_tof3_pkt_path_edprsr_read_counter(
    rmt_dev_info_t *dev_info, int pipe, int *count) {
  int c = sizeof gpipe_mgr_tof3_edprsr_pktcnt /
          sizeof gpipe_mgr_tof3_edprsr_pktcnt[0];
  bf_packetpath_counter_t *r =
      bf_sys_calloc(c, sizeof(bf_packetpath_counter_t));
  if (!r) return NULL;
...
bf_packetpath_counter_t *pipe_mgr_tof3_pkt_path_pmarb_read_counter(int devid,
  ...
  if (!counter_head) return NULL;
  pipe_mgr_tof3_pkt_path_cnt_struct_read_walk(
      devid, pipe / BF_SUBDEV_PIPE_COUNT, cnt_size, cnt_p, counter_head);
  *count = cnt_size;
  return counter_head;
}
bf_packetpath_counter_t *pipe_mgr_tof3_pkt_path_s2p_read_counter(
  ...
  *count = (cnt_size * port_numb);
  while (i < port_numb) {
    cnt_p = gpipe_mgr_tof3_s2p_pktcnt[pipe % BF_SUBDEV_PIPE_COUNT][pg_port + i];
    pipe_mgr_tof3_pkt_path_cnt_struct_read_walk(
        devid,
        pipe / BF_SUBDEV_PIPE_COUNT,
        cnt_size,
...
bf_packetpath_counter_t *pipe_mgr_tof3_pkt_path_p2s_read_counter(
  ...
  *count = (cnt_size * port_numb);
  while (i < port_numb) {
    pipe_mgr_pktcnt_disp_t *cnt_p =
        pipe_mgr_tof3_p2s_pktcnt[pipe % BF_SUBDEV_PIPE_COUNT][pg_port + i];
    pipe_mgr_tof3_pkt_path_cnt_struct_read_walk(
        devid,
        pipe / BF_SUBDEV_PIPE_COUNT,
        cnt_size,
...
bf_packetpath_counter_t *pipe_mgr_tof3_pkt_path_ipb_read_counter(
  ...
  *count = (cnt_size_all * port_numb);
  while (i < port_numb) {
    cnt_p = pipe_mgr_tof3_ipb_pktcnt[pipe % BF_SUBDEV_PIPE_COUNT][pg_port + i];
    pipe_mgr_tof3_pkt_path_cnt_struct_read_walk(
        devid,
        pipe / BF_SUBDEV_PIPE_COUNT,
        cnt_size,
        ...
        (counter_head + (i * cnt_size_all)));
    cnt_p =
        pipe_mgr_tof3_ipb_sp_pktcnt[pipe % BF_SUBDEV_PIPE_COUNT][pg_port + i];
    pipe_mgr_tof3_ipb_sp_pkt_path_cnt_struct_read_walk(
        devid,
        pipe / BF_SUBDEV_PIPE_COUNT,
        sp_cnt_size,
        cnt_p,
