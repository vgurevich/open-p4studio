...
/* clang-format off */
void eth400g_mac_rspec_scratch_bfportspeed_set(bf_dev_id_t dev_id,
                                               uint32_t umac,
                                               uint32_t ch,
                                               uint32_t *data_p,
                                               uint32_t val,
                                               bool hw);
void eth400g_mac_rspec_scratch_bfportspeed_get(bf_dev_id_t dev_id,
                                               uint32_t umac,
                                               uint32_t ch,
                                               uint32_t *data_p,
                                               uint32_t *val,
                                               bool hw);
void eth400g_mac_rspec_scratch_bfportspeed_rmw(bf_dev_id_t dev_id,
                                               uint32_t umac,
                                               uint32_t ch,
                                               uint32_t *data_p,
                                               uint32_t val);
