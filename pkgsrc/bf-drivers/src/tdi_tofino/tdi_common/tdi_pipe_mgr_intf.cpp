...
pipe_status_t PipeMgrIntf::pipeMgrAdtEntHdlGet(
  ...
  return pipe_mgr_adt_ent_hdl_get(
      sess_hdl, dev_tgt, adt_tbl_hdl, mbr_id, adt_ent_hdl, false);
}
...
pipe_status_t PipeMgrIntf::pipeMgrSelGrpAdd(pipe_sess_hdl_t sess_hdl,
                                            ...
                                            uint32_t pipe_api_flags) {
#define INVALID_ADT_OFFSET 0xDEADBEEF
...
tdi_status_t PipeMgrIntf::bfSnapshotMonitoringMode(
    tdi_dev_id_t dev_id,
...
tdi_status_t PipeMgrIntf::bfSnapshotDoPolling(tdi_dev_id_t dev) {
  return bf_snapshot_do_polling(dev);
}

tdi_status_t PipeMgrIntf::bfSnapshotCreate(tdi_dev_id_t dev,
                                           bf_dev_pipe_t pipe,
...
tdi_status_t PipeMgrIntf::bfSnapshotHandleGet(tdi_dev_id_t dev,
                                              bf_dev_pipe_t pipe,
                                              dev_stage_t start_stage,
                                              dev_stage_t end_stage,
                                              bf_snapshot_dir_t *dir,
...
tdi_status_t PipeMgrIntf::bfSnapshotNextEntryHandlesGet(
    tdi_dev_id_t dev_id,
    pipe_snapshot_hdl_t hdl,
    int n,
    int *next_entry_handles) {
...
tdi_status_t PipeMgrIntf::bfSnapshotDelete(pipe_snapshot_hdl_t hdl) {
  return bf_snapshot_delete(hdl);
}

tdi_status_t PipeMgrIntf::bfSnapshotClear(tdi_dev_id_t dev) {
  return bf_snapshot_clear(dev);
}

tdi_status_t PipeMgrIntf::bfSnapshotCaptureTriggerSet(pipe_snapshot_hdl_t hdl,
                                                      void *trig_spec,
                                                      void *trig_mask) {
  return bf_snapshot_capture_trigger_set(hdl, trig_spec, trig_mask);
}

tdi_status_t PipeMgrIntf::bfSnapshotCaptureTriggerFieldAdd(
...
tdi_status_t PipeMgrIntf::bfSnapshotCaptureTriggerFieldGet(
    pipe_snapshot_hdl_t hdl,
    char *field_name,
    uint64_t *value,
    uint64_t *mask) {
...
tdi_status_t PipeMgrIntf::bfSnapshotCaptureTriggerFieldsClr(
    pipe_snapshot_hdl_t hdl) {
  return bf_snapshot_capture_trigger_fields_clr(hdl);
}

tdi_status_t PipeMgrIntf::bfSnapshotCapturePhvFieldsDictSize(
...
tdi_status_t PipeMgrIntf::bfSnapshotFirstHandleGet(
    tdi_dev_id_t dev_id, bf_dev_pipe_t pipe, pipe_snapshot_hdl_t *entry_hdl) {
  return bf_snapshot_first_handle_get(dev_id, pipe, entry_hdl);
}

tdi_status_t PipeMgrIntf::bfSnapshotUsageGet(tdi_dev_id_t dev_id,
                                             bf_dev_pipe_t pipe,
                                             uint32_t *count) {
  return bf_snapshot_usage_get(dev_id, pipe, count);
}

tdi_status_t PipeMgrIntf::bfSnapshotTotalPhvCountGet(tdi_dev_id_t dev_id,
                                                     uint32_t *count) {
  return bf_snapshot_total_phv_count_get(dev_id, count);
}

tdi_status_t PipeMgrIntf::bfSnapshotStagesGet(tdi_dev_id_t dev_id,
                                              bf_dev_pipe_t pipe,
                                              uint32_t size,
                                              int *stages) {
...
tdi_status_t PipeMgrIntf::bfSnapshotRawCaptureGet(tdi_dev_id_t dev_id,
                                                  bf_dev_pipe_t pipe,
                                                  dev_stage_t stage,
                                                  uint32_t size,
                                                  uint32_t *fields,
...
tdi_status_t PipeMgrIntf::bfSnapshotCaptureGet(
    pipe_snapshot_hdl_t hdl,
    bf_dev_pipe_t pipe,
    uint8_t *capture,
...
tdi_status_t PipeMgrIntf::bfSnapshotCaptureDecodeFieldValue(
    pipe_snapshot_hdl_t hdl,
    bf_dev_pipe_t pipe,
    dev_stage_t stage,
    uint8_t *capture,
...
tdi_status_t PipeMgrIntf::bfSnapshotStateSet(pipe_snapshot_hdl_t hdl,
                                             bf_snapshot_state_t state,
                                             uint32_t usec) {
  return bf_snapshot_state_set(hdl, state, usec);
}

tdi_status_t PipeMgrIntf::bfSnapshotStateGet(
    pipe_snapshot_hdl_t hdl,
    uint32_t size,
...
tdi_status_t PipeMgrIntf::bfSnapshotCfgSet(pipe_snapshot_hdl_t hdl,
                                           bool timer_disable,
                                           bf_snapshot_ig_mode_t mode) {
  return bf_snapshot_cfg_set(hdl, timer_disable, mode);
}

tdi_status_t PipeMgrIntf::bfSnapshotCfgGet(pipe_snapshot_hdl_t hdl,
                                           bool *timer_enabled,
                                           uint32_t *usec,
                                           bf_snapshot_ig_mode_t *mode) {
...
tdi_status_t PipeMgrIntf::bfSnapshotThreadGet(pipe_snapshot_hdl_t hdl,
                                              uint32_t size,
                                              int *threads) {
  return bf_snapshot_capture_thread_get(hdl, size, threads);
}

tdi_status_t PipeMgrIntf::bfSnapshotFieldInScope(tdi_dev_id_t dev,
                                                 bf_dev_pipe_t pipe,
                                                 dev_stage_t stage,
                                                 bf_snapshot_dir_t dir,
                                                 char *field_name,
...
tdi_status_t PipeMgrIntf::bfSnapshotTriggerFieldInScope(tdi_dev_id_t dev,
                                                        bf_dev_pipe_t pipe,
                                                        dev_stage_t stage,
                                                        bf_snapshot_dir_t dir,
                                                        char *field_name,
...
tdi_status_t PipeMgrIntf::bfSnapshotEntryParamsGet(pipe_snapshot_hdl_t hdl,
                                                   tdi_dev_id_t *dev,
                                                   bf_dev_pipe_t *pipe,
                                                   dev_stage_t *s_stage,
                                                   dev_stage_t *e_stage,
                                                   bf_snapshot_dir_t *dir) {
  bf_dev_id_t bf_dev_id = static_cast<bf_dev_id_t>(*dev);
  return bf_snapshot_entry_params_get(
      hdl, &bf_dev_id, pipe, s_stage, e_stage, dir);
}

tdi_status_t PipeMgrIntf::bfSnapshotNumTrigFieldsGet(pipe_snapshot_hdl_t hdl,
                                                     int *count) {
...
tdi_status_t PipeMgrIntf::pipeRegisterMatUpdateCb(pipe_sess_hdl_t sess_hdl,
                                                  tdi_dev_id_t device_id,
                                                  pipe_mat_tbl_hdl_t tbl_hdl,
...
tdi_status_t PipeMgrIntf::pipeRegisterAdtUpdateCb(pipe_sess_hdl_t sess_hdl,
                                                  tdi_dev_id_t device_id,
                                                  pipe_adt_tbl_hdl_t tbl_hdl,
...
tdi_status_t PipeMgrIntf::pipeRegisterSelUpdateCb(pipe_sess_hdl_t sess_hdl,
                                                  tdi_dev_id_t device_id,
                                                  pipe_sel_tbl_hdl_t tbl_hdl,
...
pipe_status_t PipeMgrIntf::pipeMgrTcamScrubTimerSet(tdi_dev_id_t dev,
                                                    uint32_t msec_timer) {
  return pipe_mgr_tcam_scrub_timer_set(dev, msec_timer);
}

uint32_t PipeMgrIntf::pipeMgrTcamScrubTimerGet(tdi_dev_id_t dev) {
...
/*************** DVM APIs ***************/
pipe_status_t PipeMgrIntf::pipeMgrLrtDrTimeoutSet(tdi_dev_id_t dev_id,
                                                  uint32_t timeout_ms) {
  return bf_drv_lrt_dr_timeout_set(dev_id, timeout_ms);
}

pipe_status_t PipeMgrIntf::pipeMgrLrtDrTimeoutGet(tdi_dev_id_t dev_id,
                                                  uint32_t *timeout_ms) const {
  return bf_drv_lrt_dr_timeout_get(dev_id, timeout_ms);
}

/*************** Pktgen APIs ***************/
tdi_status_t PipeMgrIntf::pipeMgrRecirEnableSet(pipe_sess_hdl_t sess_hdl,
                                                tdi_dev_id_t dev_id,
...
tdi_status_t PipeMgrIntf::pipeMgrRecirEnableGet(tdi_dev_id_t dev_id,
                                                bf_dev_port_t dev_port,
                                                bool *enable) const {
  return (bf_recirculation_get(dev_id, dev_port, enable));
}

tdi_status_t PipeMgrIntf::pipeMgrPktgenEnableSet(pipe_sess_hdl_t sess_hdl,
                                                 tdi_dev_id_t dev_id,
                                                 bf_dev_port_t dev_port,
                                                 bool enable) {
...
tdi_status_t PipeMgrIntf::pipeMgrPktgenEnableGet(pipe_sess_hdl_t sess_hdl,
                                                 tdi_dev_id_t dev_id,
                                                 bf_dev_port_t dev_port,
                                                 bool *enable) const {
...
tdi_status_t PipeMgrIntf::pipeMgrPktgenRecirPatternMatchingEnableSet(
    pipe_sess_hdl_t sess_hdl,
    tdi_dev_id_t dev_id,
    bf_dev_port_t dev_port,
    bool enable) {
...
tdi_status_t PipeMgrIntf::pipeMgrPktgenRecirPatternMatchingEnableGet(
    pipe_sess_hdl_t sess_hdl,
    tdi_dev_id_t dev_id,
    bf_dev_port_t dev_port,
    bool *enable) const {
...
tdi_status_t PipeMgrIntf::pipeMgrPktgenClearPortDownSet(
    pipe_sess_hdl_t sess_hdl, tdi_dev_id_t dev_id, bf_dev_port_t dev_port) {
  return (bf_pktgen_clear_port_down(sess_hdl, dev_id, dev_port));
}

tdi_status_t PipeMgrIntf::pipeMgrPktgenClearPortDownGet(
    pipe_sess_hdl_t sess_hdl,
    tdi_dev_id_t dev_id,
    bf_dev_port_t dev_port,
    bool *cleared) {
...
tdi_status_t PipeMgrIntf::pipeMgrPktgenPortDownMaskSet(
    pipe_sess_hdl_t sess_hdl,
...
tdi_status_t PipeMgrIntf::pipeMgrPktgenPortDownMaskGet(
    bf_dev_target_t dev_tgt,
    uint32_t port_mask_sel,
...
tdi_status_t PipeMgrIntf::pipeMgrPktgenPortDownReplayModeSet(
    pipe_sess_hdl_t sess_hdl,
    bf_dev_target_t dev_tgt,
...
tdi_status_t PipeMgrIntf::pipeMgrPktgenPortDownReplayModeGet(
    pipe_sess_hdl_t sess_hdl,
    bf_dev_target_t dev_tgt,
...
tdi_status_t PipeMgrIntf::pipeMgrPktgenAppSet(pipe_sess_hdl_t sess_hdl,
                                              bf_dev_target_t dev_tgt,
                                              int app_id,
...
tdi_status_t PipeMgrIntf::pipeMgrPktgenAppGet(pipe_sess_hdl_t sess_hdl,
                                              bf_dev_target_t dev_tgt,
                                              int app_id,
...
tdi_status_t PipeMgrIntf::pipeMgrPktgenAppEnableSet(pipe_sess_hdl_t sess_hdl,
                                                    bf_dev_target_t dev_tgt,
                                                    int app_id,
                                                    bool enable) {
...
tdi_status_t PipeMgrIntf::pipeMgrPktgenAppEnableGet(pipe_sess_hdl_t sess_hdl,
                                                    bf_dev_target_t dev_tgt,
                                                    int app_id,
                                                    bool *enable) const {
...
tdi_status_t PipeMgrIntf::pipeMgrPktgenWritePktBuffer(
    pipe_sess_hdl_t sess_hdl,
    bf_dev_target_t dev_tgt,
...
tdi_status_t PipeMgrIntf::pipeMgrPktgenPktBufferGet(
    pipe_sess_hdl_t sess_hdl,
    bf_dev_target_t dev_tgt,
    uint32_t pktgen_byte_buf_offset,
    uint32_t size,
...
tdi_status_t PipeMgrIntf::pipeMgrPktgenBatchCntSet(pipe_sess_hdl_t sess_hdl,
                                                   bf_dev_target_t dev_tgt,
                                                   int app_id,
                                                   uint64_t batch_cnt) {
...
tdi_status_t PipeMgrIntf::pipeMgrPktgenPktCntSet(pipe_sess_hdl_t sess_hdl,
                                                 bf_dev_target_t dev_tgt,
                                                 int app_id,
                                                 uint64_t pkt_cnt) {
...
tdi_status_t PipeMgrIntf::pipeMgrPktgenTriggerCntSet(pipe_sess_hdl_t sess_hdl,
                                                     bf_dev_target_t dev_tgt,
                                                     int app_id,
...
tdi_status_t PipeMgrIntf::pipeMgrPktgenBatchCntGet(pipe_sess_hdl_t sess_hdl,
                                                   bf_dev_target_t dev_tgt,
                                                   int app_id,
...
tdi_status_t PipeMgrIntf::pipeMgrPktgenPktCntGet(pipe_sess_hdl_t sess_hdl,
                                                 bf_dev_target_t dev_tgt,
                                                 int app_id,
...
tdi_status_t PipeMgrIntf::pipeMgrPktgenTriggerCntGet(
    pipe_sess_hdl_t sess_hdl,
    bf_dev_target_t dev_tgt,
    int app_id,
...
uint32_t PipeMgrIntf::pipeMgrPktgenAppCountGet(tdi_dev_id_t dev_id) const {
  return bf_pktgen_get_app_count(dev_id);
}

bf_dev_port_t PipeMgrIntf::pipeMgrPktgenPortGet(tdi_dev_id_t dev_id) const {
  return bf_pktgen_port_get(dev_id);
}

tdi_status_t PipeMgrIntf::pipeMgrPktgenPortGetNext(tdi_dev_id_t dev_id,
                                                   bf_dev_port_t *port) const {
  return bf_pktgen_get_next_port(dev_id, port);
}

bf_dev_port_t PipeMgrIntf::pipeMgrPktgenMaxPortGet(tdi_dev_id_t dev_id) const {
  return bf_pktgen_max_port_get(dev_id);
}

// ***************** Mirror APIs ***************** //
tdi_status_t PipeMgrIntf::pipeMgrMirrorSessionSet(
    pipe_sess_hdl_t sess_hdl,
    dev_target_t dev_target,
    bf_mirror_id_t sid,
...
tdi_status_t PipeMgrIntf::pipeMgrMirrorSessionReset(pipe_sess_hdl_t sess_hdl,
                                                    dev_target_t dev_target,
                                                    bf_mirror_id_t sid) {
  return bf_mirror_session_reset(sess_hdl, dev_target, sid);
}

tdi_status_t PipeMgrIntf::pipeMgrMirrorSessionEnable(pipe_sess_hdl_t sess_hdl,
                                                     dev_target_t dev_target,
...
tdi_status_t PipeMgrIntf::pipeMgrMirrorSessionDisable(pipe_sess_hdl_t sess_hdl,
                                                      dev_target_t dev_target,
                                                      bf_mirror_direction_e dir,
                                                      bf_mirror_id_t sid) {
...
tdi_status_t PipeMgrIntf::pipeMgrMirrorSessionMetaFlagUpdate(
    pipe_sess_hdl_t sess_hdl,
    dev_target_t dev_target,
    bf_mirror_id_t sid,
...
tdi_status_t PipeMgrIntf::pipeMgrMirrorSessionMetaFlagGet(
    pipe_sess_hdl_t sess_hdl,
    dev_target_t dev_target,
    bf_mirror_id_t sid,
    bf_mirror_meta_flag_e mirror_flag,
...
tdi_status_t PipeMgrIntf::pipeMgrMirrorSessionPriorityUpdate(
    pipe_sess_hdl_t sess_hdl,
    dev_target_t dev_target,
    bf_mirror_id_t sid,
    bool value) {
...
tdi_status_t PipeMgrIntf::pipeMgrMirrorSessionPriorityGet(
    pipe_sess_hdl_t sess_hdl,
    dev_target_t dev_target,
    bf_mirror_id_t sid,
    bool *value) {
...
tdi_status_t PipeMgrIntf::pipeMgrMirrorSessionCoalModeUpdate(
    pipe_sess_hdl_t sess_hdl,
    dev_target_t dev_target,
    bf_mirror_id_t sid,
    bool value) {
...
tdi_status_t PipeMgrIntf::pipeMgrMirrorSessionCoalModeGet(
    pipe_sess_hdl_t sess_hdl,
    dev_target_t dev_target,
    bf_mirror_id_t sid,
    bool *value) {
...
tdi_status_t PipeMgrIntf::pipeMgrMirrorSessionGet(
    pipe_sess_hdl_t sess_hdl,
    dev_target_t dev_target,
    bf_mirror_id_t sid,
...
tdi_status_t PipeMgrIntf::pipeMgrMirrorSessionGetFirst(
    pipe_sess_hdl_t sess_hdl,
    dev_target_t dev_target,
    bf_mirror_session_info_t *s_info,
...
tdi_status_t PipeMgrIntf::pipeMgrMirrorSessionGetNext(
    pipe_sess_hdl_t sess_hdl,
    dev_target_t dev_target,
...
tdi_status_t PipeMgrIntf::pipeMgrMirrorSessionEnableGet(
    pipe_sess_hdl_t sess_hdl,
    dev_target_t dev_target,
    bf_mirror_id_t sid,
...
tdi_status_t PipeMgrIntf::pipeMgrMirrorSessionCountGet(pipe_sess_hdl_t sess_hdl,
                                                       dev_target_t dev_target,
                                                       uint32_t *count) const {
  return bf_mirror_session_get_count(sess_hdl, dev_target, count);
}

tdi_status_t PipeMgrIntf::pipeMgrPortRXPrsrPriThreshSet(tdi_dev_id_t dev_id,
                                                        bf_dev_port_t port_id,
                                                        uint32_t threshold) {
  return bf_pipe_mgr_port_iprsr_threshold_set(dev_id, port_id, threshold);
}

tdi_status_t PipeMgrIntf::pipeMgrPortRXPrsrPriThreshGet(
    tdi_dev_id_t dev_id, bf_dev_port_t port_id, uint32_t *threshold) const {
