...
class IPipeMgrIntf {
 public:
  ...
  virtual tdi_status_t bfSnapshotMonitoringMode(
      tdi_dev_id_t dev_id,
      bool interrupt_or_polling,
      bf_snapshot_triggered_cb trig_cb) = 0;

  virtual tdi_status_t bfSnapshotDoPolling(tdi_dev_id_t dev) = 0;

  virtual tdi_status_t bfSnapshotCreate(tdi_dev_id_t dev,
                                        bf_dev_pipe_t pipe,
  ...
  virtual tdi_status_t bfSnapshotHandleGet(tdi_dev_id_t dev,
                                           bf_dev_pipe_t pipe,
                                           dev_stage_t start_stage,
                                           dev_stage_t end_stage,
                                           bf_snapshot_dir_t *dir,
  ...
  virtual tdi_status_t bfSnapshotNextEntryHandlesGet(
      tdi_dev_id_t dev_id,
      pipe_snapshot_hdl_t hdl,
      int n,
      int *next_entry_handles) = 0;

  virtual tdi_status_t bfSnapshotDelete(pipe_snapshot_hdl_t hdl) = 0;

  virtual tdi_status_t bfSnapshotClear(tdi_dev_id_t dev) = 0;

  virtual tdi_status_t bfSnapshotCaptureTriggerSet(pipe_snapshot_hdl_t hdl,
                                                   void *trig_spec,
                                                   void *trig_mask) = 0;

  virtual tdi_status_t bfSnapshotCaptureTriggerFieldAdd(pipe_snapshot_hdl_t hdl,
                                                        char *field_name,
                                                        uint64_t value,
                                                        uint64_t mask) = 0;
  virtual tdi_status_t bfSnapshotCaptureTriggerFieldGet(pipe_snapshot_hdl_t hdl,
                                                        char *field_name,
                                                        uint64_t *value,
                                                        uint64_t *mask) = 0;

  virtual tdi_status_t bfSnapshotCaptureTriggerFieldsClr(
      pipe_snapshot_hdl_t hdl) = 0;

  virtual tdi_status_t bfSnapshotCapturePhvFieldsDictSize(
      pipe_snapshot_hdl_t hdl,
      uint32_t *total_size,
      uint32_t *per_stage_size) = 0;

  virtual tdi_status_t bfSnapshotCaptureGet(
      pipe_snapshot_hdl_t hdl,
      bf_dev_pipe_t pipe,
      uint8_t *capture,
  ...
  virtual tdi_status_t bfSnapshotCaptureDecodeFieldValue(
      pipe_snapshot_hdl_t hdl,
      bf_dev_pipe_t pipe,
      dev_stage_t stage,
      uint8_t *capture,
  ...
  virtual tdi_status_t bfSnapshotStateSet(pipe_snapshot_hdl_t hdl,
                                          bf_snapshot_state_t state,
                                          uint32_t usec) = 0;

  virtual tdi_status_t bfSnapshotStateGet(pipe_snapshot_hdl_t hdl,
                                          uint32_t size,
                                          pipe_snapshot_fsm_state_t *fsm_state,
                                          bool *state) = 0;
  virtual tdi_status_t bfSnapshotCfgSet(pipe_snapshot_hdl_t hdl,
                                        bool timer_disable,
                                        bf_snapshot_ig_mode_t mode) = 0;

  virtual tdi_status_t bfSnapshotCfgGet(pipe_snapshot_hdl_t hdl,
                                        bool *timer_enabled,
                                        uint32_t *usec,
                                        bf_snapshot_ig_mode_t *mode) = 0;

  virtual tdi_status_t bfSnapshotThreadGet(pipe_snapshot_hdl_t hdl,
                                           uint32_t size,
                                           int *threads) = 0;

  virtual tdi_status_t bfSnapshotFieldInScope(tdi_dev_id_t dev,
                                              bf_dev_pipe_t pipe,
                                              dev_stage_t stage,
                                              bf_snapshot_dir_t dir,
                                              char *field_name,
  ...
  virtual tdi_status_t bfSnapshotTriggerFieldInScope(tdi_dev_id_t dev,
                                                     bf_dev_pipe_t pipe,
                                                     dev_stage_t stage,
                                                     bf_snapshot_dir_t dir,
                                                     char *field_name,
  ...
  virtual tdi_status_t bfSnapshotEntryParamsGet(pipe_snapshot_hdl_t hdl,
                                                tdi_dev_id_t *dev,
                                                bf_dev_pipe_t *pipe,
                                                dev_stage_t *s_stage,
                                                dev_stage_t *e_stage,
  ...
  virtual tdi_status_t bfSnapshotFirstHandleGet(
      tdi_dev_id_t dev_id,
      bf_dev_pipe_t pipe,
      pipe_snapshot_hdl_t *entry_hdl) = 0;

  virtual tdi_status_t bfSnapshotUsageGet(tdi_dev_id_t dev_id,
                                          bf_dev_pipe_t pipe,
                                          uint32_t *count) = 0;

  virtual tdi_status_t bfSnapshotNumTrigFieldsGet(pipe_snapshot_hdl_t hdl,
                                                  int *count) = 0;

  virtual tdi_status_t bfSnapshotTotalPhvCountGet(tdi_dev_id_t dev_id,
                                                  uint32_t *count) = 0;

  virtual tdi_status_t bfSnapshotRawCaptureGet(tdi_dev_id_t dev_id,
                                               bf_dev_pipe_t pipe,
                                               dev_stage_t stage,
                                               uint32_t size,
                                               uint32_t *fields,
  ...
  virtual tdi_status_t bfSnapshotStagesGet(tdi_dev_id_t dev_id,
                                           bf_dev_pipe_t pipe,
                                           uint32_t size,
                                           int *stages) = 0;
  ...
  virtual tdi_status_t pipeRegisterMatUpdateCb(pipe_sess_hdl_t sess_hdl,
                                               tdi_dev_id_t device_id,
                                               pipe_mat_tbl_hdl_t tbl_hdl,
                                               pipe_mat_update_cb cb,
                                               void *cb_cookie) const = 0;
  virtual tdi_status_t pipeRegisterAdtUpdateCb(pipe_sess_hdl_t sess_hdl,
                                               tdi_dev_id_t device_id,
                                               pipe_adt_tbl_hdl_t tbl_hdl,
                                               pipe_adt_update_cb cb,
                                               void *cb_cookie) const = 0;
  virtual tdi_status_t pipeRegisterSelUpdateCb(pipe_sess_hdl_t sess_hdl,
                                               tdi_dev_id_t device_id,
                                               pipe_sel_tbl_hdl_t tbl_hdl,
  ...
  virtual pipe_status_t pipeMgrTcamScrubTimerSet(tdi_dev_id_t dev,
                                                 uint32_t msec_timer) = 0;
  virtual uint32_t pipeMgrTcamScrubTimerGet(tdi_dev_id_t dev) = 0;

  virtual tdi_status_t pipeMgrTblHdlPipeMaskGet(
      tdi_dev_id_t dev_id,
  ...
  /*************** DVM APIs ***************/
  virtual pipe_status_t pipeMgrLrtDrTimeoutSet(tdi_dev_id_t dev_id,
                                               uint32_t timeout_ms) = 0;

  virtual pipe_status_t pipeMgrLrtDrTimeoutGet(tdi_dev_id_t dev_id,
                                               uint32_t *timeout_ms) const = 0;

  /********* Pktgen APIs ************/
  virtual tdi_status_t pipeMgrRecirEnableSet(pipe_sess_hdl_t sess_hdl,
                                             tdi_dev_id_t dev_id,
                                             bf_dev_port_t dev_port,
                                             bool enable) = 0;

  virtual tdi_status_t pipeMgrRecirEnableGet(tdi_dev_id_t dev_id,
                                             bf_dev_port_t dev_port,
                                             bool *enable) const = 0;

  virtual tdi_status_t pipeMgrPktgenEnableSet(pipe_sess_hdl_t sess_hdl,
                                              tdi_dev_id_t dev_id,
                                              bf_dev_port_t dev_port,
                                              bool enable) = 0;
  virtual tdi_status_t pipeMgrPktgenEnableGet(pipe_sess_hdl_t sess_hdl,
                                              tdi_dev_id_t dev_id,
                                              bf_dev_port_t dev_port,
                                              bool *enable) const = 0;
  virtual tdi_status_t pipeMgrPktgenRecirPatternMatchingEnableSet(
      pipe_sess_hdl_t sess_hdl,
      tdi_dev_id_t dev_id,
      bf_dev_port_t dev_port,
      bool enable) = 0;

  virtual tdi_status_t pipeMgrPktgenRecirPatternMatchingEnableGet(
      pipe_sess_hdl_t sess_hdl,
      tdi_dev_id_t dev_id,
      bf_dev_port_t dev_port,
      bool *enable) const = 0;

  virtual tdi_status_t pipeMgrPktgenClearPortDownSet(
      pipe_sess_hdl_t sess_hdl,
      tdi_dev_id_t dev_id,
      bf_dev_port_t dev_port) = 0;

  virtual tdi_status_t pipeMgrPktgenClearPortDownGet(pipe_sess_hdl_t sess_hdl,
                                                     tdi_dev_id_t dev_id,
                                                     bf_dev_port_t dev_port,
                                                     bool *cleared) = 0;

  virtual tdi_status_t pipeMgrPktgenPortDownMaskSet(
      pipe_sess_hdl_t sess_hdl,
      bf_dev_target_t dev_tgt,
      uint32_t port_mask_sel,
      struct bf_tof2_port_down_sel *mask) = 0;

  virtual tdi_status_t pipeMgrPktgenPortDownMaskGet(
      bf_dev_target_t dev_tgt,
      uint32_t port_mask_sel,
      struct bf_tof2_port_down_sel *mask) const = 0;

  virtual tdi_status_t pipeMgrPktgenPortDownReplayModeSet(
      pipe_sess_hdl_t sess_hdl,
      bf_dev_target_t dev_tgt,
      bf_pktgen_port_down_mode_t mode) = 0;

  virtual tdi_status_t pipeMgrPktgenPortDownReplayModeGet(
      pipe_sess_hdl_t sess_hdl,
      bf_dev_target_t dev_tgt,
      bf_pktgen_port_down_mode_t *mode) const = 0;

  virtual tdi_status_t pipeMgrPktgenAppSet(pipe_sess_hdl_t sess_hdl,
                                           bf_dev_target_t dev_tgt,
                                           int app_id,
                                           bf_pktgen_app_cfg_t *cfg) = 0;

  virtual tdi_status_t pipeMgrPktgenAppGet(pipe_sess_hdl_t sess_hdl,
                                           bf_dev_target_t dev_tgt,
                                           int app_id,
                                           bf_pktgen_app_cfg_t *cfg) const = 0;
  virtual tdi_status_t pipeMgrPktgenAppEnableSet(pipe_sess_hdl_t sess_hdl,
                                                 bf_dev_target_t dev_tgt,
                                                 int app_id,
                                                 bool enable) = 0;
  virtual tdi_status_t pipeMgrPktgenAppEnableGet(pipe_sess_hdl_t sess_hdl,
                                                 bf_dev_target_t dev_tgt,
                                                 int app_id,
                                                 bool *enable) const = 0;
  virtual tdi_status_t pipeMgrPktgenWritePktBuffer(
      pipe_sess_hdl_t sess_hdl,
      bf_dev_target_t dev_tgt,
  ...
  virtual tdi_status_t pipeMgrPktgenPktBufferGet(
      pipe_sess_hdl_t sess_hdl,
      bf_dev_target_t dev_tgt,
      uint32_t pktgen_byte_buf_offset,
      uint32_t size,
  ...
  virtual tdi_status_t pipeMgrPktgenBatchCntSet(pipe_sess_hdl_t sess_hdl,
                                                bf_dev_target_t dev_tgt,
                                                int app_id,
                                                uint64_t batch_cnt) = 0;

  virtual tdi_status_t pipeMgrPktgenPktCntSet(pipe_sess_hdl_t sess_hdl,
                                              bf_dev_target_t dev_tgt,
                                              int app_id,
                                              uint64_t pkt_cnt) = 0;

  virtual tdi_status_t pipeMgrPktgenTriggerCntSet(pipe_sess_hdl_t sess_hdl,
                                                  bf_dev_target_t dev_tgt,
                                                  int app_id,
                                                  uint64_t trigger_cnt) = 0;

  virtual tdi_status_t pipeMgrPktgenBatchCntGet(pipe_sess_hdl_t sess_hdl,
                                                bf_dev_target_t dev_tgt,
                                                int app_id,
                                                uint64_t *batch_cnt) const = 0;

  virtual tdi_status_t pipeMgrPktgenPktCntGet(pipe_sess_hdl_t sess_hdl,
                                              bf_dev_target_t dev_tgt,
                                              int app_id,
                                              uint64_t *pkt_cnt) const = 0;

  virtual tdi_status_t pipeMgrPktgenTriggerCntGet(
      pipe_sess_hdl_t sess_hdl,
      bf_dev_target_t dev_tgt,
      int app_id,
      uint64_t *trigger_cnt) const = 0;

  virtual uint32_t pipeMgrPktgenAppCountGet(tdi_dev_id_t dev_id) const = 0;

  virtual bf_dev_port_t pipeMgrPktgenPortGet(tdi_dev_id_t dev_id) const = 0;

  virtual tdi_status_t pipeMgrPktgenPortGetNext(tdi_dev_id_t dev_id,
                                                bf_dev_port_t *port) const = 0;

  virtual bf_dev_port_t pipeMgrPktgenMaxPortGet(tdi_dev_id_t dev_id) const = 0;

  // ***************** Mirror APIs ***************** //
  virtual tdi_status_t pipeMgrMirrorSessionSet(pipe_sess_hdl_t sess_hdl,
                                               dev_target_t dev_target,
                                               bf_mirror_id_t sid,
                                               bf_mirror_session_info_t *s_info,
                                               bool enable) = 0;

  virtual tdi_status_t pipeMgrMirrorSessionReset(pipe_sess_hdl_t sess_hdl,
                                                 dev_target_t dev_target,
                                                 bf_mirror_id_t sid) = 0;

  virtual tdi_status_t pipeMgrMirrorSessionEnable(pipe_sess_hdl_t sess_hdl,
                                                  dev_target_t dev_target,
                                                  bf_mirror_direction_e dir,
                                                  bf_mirror_id_t sid) = 0;

  virtual tdi_status_t pipeMgrMirrorSessionDisable(pipe_sess_hdl_t sess_hdl,
                                                   dev_target_t dev_target,
                                                   bf_mirror_direction_e dir,
                                                   bf_mirror_id_t sid) = 0;

  virtual tdi_status_t pipeMgrMirrorSessionMetaFlagUpdate(
      pipe_sess_hdl_t sess_hdl,
      dev_target_t dev_target,
      bf_mirror_id_t sid,
  ...
  virtual tdi_status_t pipeMgrMirrorSessionMetaFlagGet(
      pipe_sess_hdl_t sess_hdl,
      dev_target_t dev_target,
      bf_mirror_id_t sid,
      bf_mirror_meta_flag_e mirror_flag,
  ...
  virtual tdi_status_t pipeMgrMirrorSessionPriorityUpdate(
      pipe_sess_hdl_t sess_hdl,
      dev_target_t dev_target,
      bf_mirror_id_t sid,
      bool value) = 0;

  virtual tdi_status_t pipeMgrMirrorSessionPriorityGet(pipe_sess_hdl_t sess_hdl,
                                                       dev_target_t dev_target,
                                                       bf_mirror_id_t sid,
                                                       bool *value) = 0;

  virtual tdi_status_t pipeMgrMirrorSessionCoalModeUpdate(
      pipe_sess_hdl_t sess_hdl,
      dev_target_t dev_target,
      bf_mirror_id_t sid,
      bool value) = 0;

  virtual tdi_status_t pipeMgrMirrorSessionCoalModeGet(pipe_sess_hdl_t sess_hdl,
                                                       dev_target_t dev_target,
                                                       bf_mirror_id_t sid,
                                                       bool *value) = 0;

  virtual tdi_status_t pipeMgrMirrorSessionGet(
      pipe_sess_hdl_t sess_hdl,
      dev_target_t dev_target,
      bf_mirror_id_t sid,
      bf_mirror_session_info_t *s_info) const = 0;

  virtual tdi_status_t pipeMgrMirrorSessionGetFirst(
      pipe_sess_hdl_t sess_hdl,
      dev_target_t dev_target,
      bf_mirror_session_info_t *s_info,
      bf_mirror_get_id_t *first) const = 0;

  virtual tdi_status_t pipeMgrMirrorSessionGetNext(
      pipe_sess_hdl_t sess_hdl,
      dev_target_t dev_target,
  ...
  virtual tdi_status_t pipeMgrMirrorSessionEnableGet(
      pipe_sess_hdl_t sess_hdl,
      dev_target_t dev_target,
      bf_mirror_id_t sid,
      bool *session_enable) const = 0;

  virtual tdi_status_t pipeMgrMirrorSessionCountGet(pipe_sess_hdl_t sess_hdl,
                                                    dev_target_t dev_target,
                                                    uint32_t *count) const = 0;

  virtual tdi_status_t pipeMgrPortRXPrsrPriThreshSet(tdi_dev_id_t dev_id,
                                                     bf_dev_port_t port_id,
                                                     uint32_t threshold) = 0;

  virtual tdi_status_t pipeMgrPortRXPrsrPriThreshGet(
      tdi_dev_id_t dev_id,
      bf_dev_port_t port_id,
      uint32_t *threshold) const = 0;
...
class PipeMgrIntf : public IPipeMgrIntf {
 public:
  ...
  static IPipeMgrIntf *getInstance(const tdi::Session &session) {
    ...
    const Session &sess =
        static_cast<const tdi::tna::tofino::Session &>(session);
    if (sess.isInBatch() && !sess.isInPipeBatch()) {
      auto status = pipe_mgr_intf->pipeMgrBeginBatch(sess.handleGet(
  ...
  tdi_status_t bfSnapshotMonitoringMode(tdi_dev_id_t dev_id,
                                        bool interrupt_or_polling,
                                        bf_snapshot_triggered_cb trig_cb);

  tdi_status_t bfSnapshotDoPolling(tdi_dev_id_t dev);

  tdi_status_t bfSnapshotCreate(tdi_dev_id_t dev,
                                bf_dev_pipe_t pipe,
                                dev_stage_t start_stage,
                                dev_stage_t end_stage,
                                bf_snapshot_dir_t dir,
  ...
  tdi_status_t bfSnapshotHandleGet(tdi_dev_id_t dev,
                                   bf_dev_pipe_t pipe,
                                   dev_stage_t start_stage,
                                   dev_stage_t end_stage,
                                   bf_snapshot_dir_t *dir,
  ...
  tdi_status_t bfSnapshotNextEntryHandlesGet(tdi_dev_id_t dev_id,
                                             pipe_snapshot_hdl_t hdl,
                                             int n,
                                             int *next_entry_handles);

  tdi_status_t bfSnapshotDelete(pipe_snapshot_hdl_t hdl);

  tdi_status_t bfSnapshotClear(tdi_dev_id_t dev);

  tdi_status_t bfSnapshotCaptureTriggerSet(pipe_snapshot_hdl_t hdl,
                                           void *trig_spec,
                                           void *trig_mask);

  tdi_status_t bfSnapshotCaptureTriggerFieldAdd(pipe_snapshot_hdl_t hdl,
                                                char *field_name,
                                                uint64_t value,
                                                uint64_t mask);

  tdi_status_t bfSnapshotCaptureTriggerFieldGet(pipe_snapshot_hdl_t hdl,
                                                char *field_name,
                                                uint64_t *value,
                                                uint64_t *mask);
  tdi_status_t bfSnapshotCaptureTriggerFieldsClr(pipe_snapshot_hdl_t hdl);

  tdi_status_t bfSnapshotCapturePhvFieldsDictSize(pipe_snapshot_hdl_t hdl,
                                                  uint32_t *total_size,
                                                  uint32_t *per_stage_size);

  tdi_status_t bfSnapshotCaptureGet(
      pipe_snapshot_hdl_t hdl,
      bf_dev_pipe_t pipe,
      uint8_t *capture,
      bf_snapshot_capture_ctrl_info_arr_t *ctrl_info_arr,
  ...
  tdi_status_t bfSnapshotCaptureDecodeFieldValue(pipe_snapshot_hdl_t hdl,
                                                 bf_dev_pipe_t pipe,
                                                 dev_stage_t stage,
                                                 uint8_t *capture,
                                                 int num_captures,
  ...
  tdi_status_t bfSnapshotStateSet(pipe_snapshot_hdl_t hdl,
                                  bf_snapshot_state_t state,
                                  uint32_t usec);

  tdi_status_t bfSnapshotStateGet(pipe_snapshot_hdl_t hdl,
                                  uint32_t size,
                                  pipe_snapshot_fsm_state_t *fsm_state,
                                  bool *state);

  tdi_status_t bfSnapshotCfgSet(pipe_snapshot_hdl_t hdl,
                                bool timer_disable,
                                bf_snapshot_ig_mode_t mode);

  tdi_status_t bfSnapshotCfgGet(pipe_snapshot_hdl_t hdl,
                                bool *timer_enabled,
                                uint32_t *usec,
                                bf_snapshot_ig_mode_t *mode);

  tdi_status_t bfSnapshotThreadGet(pipe_snapshot_hdl_t hdl,
                                   uint32_t size,
                                   int *threads);

  tdi_status_t bfSnapshotFieldInScope(tdi_dev_id_t dev,
                                      bf_dev_pipe_t pipe,
                                      dev_stage_t stage,
                                      bf_snapshot_dir_t dir,
                                      char *field_name,
  ...
  tdi_status_t bfSnapshotTriggerFieldInScope(tdi_dev_id_t dev,
                                             bf_dev_pipe_t pipe,
                                             dev_stage_t stage,
                                             bf_snapshot_dir_t dir,
                                             char *field_name,
  ...
  tdi_status_t bfSnapshotEntryParamsGet(pipe_snapshot_hdl_t hdl,
                                        tdi_dev_id_t *dev,
                                        bf_dev_pipe_t *pipe,
                                        dev_stage_t *s_stage,
                                        dev_stage_t *e_stage,
  ...
  tdi_status_t bfSnapshotFirstHandleGet(tdi_dev_id_t dev_id,
                                        bf_dev_pipe_t pipe,
                                        pipe_snapshot_hdl_t *entry_hdl);

  tdi_status_t bfSnapshotUsageGet(tdi_dev_id_t dev_id,
                                  bf_dev_pipe_t pipe,
                                  uint32_t *count);
  tdi_status_t bfSnapshotNumTrigFieldsGet(pipe_snapshot_hdl_t hdl, int *count);

  tdi_status_t bfSnapshotTotalPhvCountGet(tdi_dev_id_t dev_id, uint32_t *count);

  tdi_status_t bfSnapshotRawCaptureGet(tdi_dev_id_t dev_id,
                                       bf_dev_pipe_t pipe,
                                       dev_stage_t stage,
                                       uint32_t size,
                                       uint32_t *fields,
  ...
  tdi_status_t bfSnapshotStagesGet(tdi_dev_id_t dev_id,
                                   bf_dev_pipe_t pipe,
                                   uint32_t size,
                                   int *stages);
  ...
  /************ Virtual dev CB register functions APIs ************/
  tdi_status_t pipeRegisterMatUpdateCb(pipe_sess_hdl_t sess_hdl,
                                       tdi_dev_id_t device_id,
                                       pipe_mat_tbl_hdl_t tbl_hdl,
                                       pipe_mat_update_cb cb,
                                       void *cb_cookie) const;
  tdi_status_t pipeRegisterAdtUpdateCb(pipe_sess_hdl_t sess_hdl,
                                       tdi_dev_id_t device_id,
                                       pipe_adt_tbl_hdl_t tbl_hdl,
                                       pipe_adt_update_cb cb,
                                       void *cb_cookie) const;
  tdi_status_t pipeRegisterSelUpdateCb(pipe_sess_hdl_t sess_hdl,
                                       tdi_dev_id_t device_id,
                                       pipe_sel_tbl_hdl_t tbl_hdl,
                                       pipe_sel_update_cb cb,
                                       void *cb_cookie) const;
  ...
  pipe_status_t pipeMgrTcamScrubTimerSet(tdi_dev_id_t dev, uint32_t msec_timer);

  uint32_t pipeMgrTcamScrubTimerGet(tdi_dev_id_t dev);
  ...
  /*************** DVM APIs ***************/
  pipe_status_t pipeMgrLrtDrTimeoutSet(tdi_dev_id_t dev_id,
                                       uint32_t timeout_ms);

  pipe_status_t pipeMgrLrtDrTimeoutGet(tdi_dev_id_t dev_id,
                                       uint32_t *timeout_ms) const;

  /********* Pktgen APIs ************/
  tdi_status_t pipeMgrRecirEnableSet(pipe_sess_hdl_t sess_hdl,
                                     tdi_dev_id_t dev_id,
                                     bf_dev_port_t dev_port,
                                     bool enable);

  tdi_status_t pipeMgrRecirEnableGet(tdi_dev_id_t dev_id,
                                     bf_dev_port_t dev_port,
                                     bool *enable) const;

  tdi_status_t pipeMgrPktgenEnableSet(pipe_sess_hdl_t sess_hdl,
                                      tdi_dev_id_t dev_id,
                                      bf_dev_port_t dev_port,
                                      bool enable);

  tdi_status_t pipeMgrPktgenEnableGet(pipe_sess_hdl_t sess_hdl,
                                      tdi_dev_id_t dev_id,
                                      bf_dev_port_t dev_port,
                                      bool *enable) const;

  tdi_status_t pipeMgrPktgenRecirPatternMatchingEnableSet(
      pipe_sess_hdl_t sess_hdl,
      tdi_dev_id_t dev_id,
      bf_dev_port_t dev_port,
      bool enable);

  tdi_status_t pipeMgrPktgenRecirPatternMatchingEnableGet(
      pipe_sess_hdl_t sess_hdl,
      tdi_dev_id_t dev_id,
      bf_dev_port_t dev_port,
      bool *enable) const;

  tdi_status_t pipeMgrPktgenClearPortDownSet(pipe_sess_hdl_t sess_hdl,
                                             tdi_dev_id_t dev_id,
                                             bf_dev_port_t dev_port);

  tdi_status_t pipeMgrPktgenClearPortDownGet(pipe_sess_hdl_t sess_hdl,
                                             tdi_dev_id_t dev_id,
                                             bf_dev_port_t dev_port,
                                             bool *cleared);

  tdi_status_t pipeMgrPktgenPortDownMaskSet(pipe_sess_hdl_t sess_hdl,
                                            bf_dev_target_t dev_tgt,
                                            uint32_t port_mask_sel,
                                            struct bf_tof2_port_down_sel *mask);

  tdi_status_t pipeMgrPktgenPortDownMaskGet(
      bf_dev_target_t dev_tgt,
      uint32_t port_mask_sel,
      struct bf_tof2_port_down_sel *mask) const;

  tdi_status_t pipeMgrPktgenPortDownReplayModeSet(
      pipe_sess_hdl_t sess_hdl,
      bf_dev_target_t dev_tgt,
      bf_pktgen_port_down_mode_t mode);

  tdi_status_t pipeMgrPktgenPortDownReplayModeGet(
      pipe_sess_hdl_t sess_hdl,
      bf_dev_target_t dev_tgt,
      bf_pktgen_port_down_mode_t *mode) const;

  tdi_status_t pipeMgrPktgenAppSet(pipe_sess_hdl_t sess_hdl,
                                   bf_dev_target_t dev_tgt,
                                   int app_id,
                                   bf_pktgen_app_cfg_t *cfg);

  tdi_status_t pipeMgrPktgenAppGet(pipe_sess_hdl_t sess_hdl,
                                   bf_dev_target_t dev_tgt,
                                   int app_id,
                                   bf_pktgen_app_cfg_t *cfg) const;

  tdi_status_t pipeMgrPktgenAppEnableSet(pipe_sess_hdl_t sess_hdl,
                                         bf_dev_target_t dev_tgt,
                                         int app_id,
                                         bool enable);

  tdi_status_t pipeMgrPktgenAppEnableGet(pipe_sess_hdl_t sess_hdl,
                                         bf_dev_target_t dev_tgt,
                                         int app_id,
                                         bool *enable) const;

  tdi_status_t pipeMgrPktgenWritePktBuffer(pipe_sess_hdl_t sess_hdl,
                                           bf_dev_target_t dev_tgt,
                                           uint32_t pktgen_byte_buf_offset,
                                           uint32_t size,
                                           const uint8_t *buf);

  tdi_status_t pipeMgrPktgenPktBufferGet(pipe_sess_hdl_t sess_hdl,
                                         bf_dev_target_t dev_tgt,
                                         uint32_t pktgen_byte_buf_offset,
                                         uint32_t size,
                                         uint8_t *buf) const;

  tdi_status_t pipeMgrPktgenBatchCntSet(pipe_sess_hdl_t sess_hdl,
                                        bf_dev_target_t dev_tgt,
                                        int app_id,
                                        uint64_t batch_cnt);

  tdi_status_t pipeMgrPktgenPktCntSet(pipe_sess_hdl_t sess_hdl,
                                      bf_dev_target_t dev_tgt,
                                      int app_id,
                                      uint64_t pkt_cnt);

  tdi_status_t pipeMgrPktgenTriggerCntSet(pipe_sess_hdl_t sess_hdl,
                                          bf_dev_target_t dev_tgt,
                                          int app_id,
                                          uint64_t trigger_cnt);

  tdi_status_t pipeMgrPktgenBatchCntGet(pipe_sess_hdl_t sess_hdl,
                                        bf_dev_target_t dev_tgt,
                                        int app_id,
                                        uint64_t *batch_cnt) const;

  tdi_status_t pipeMgrPktgenPktCntGet(pipe_sess_hdl_t sess_hdl,
                                      bf_dev_target_t dev_tgt,
                                      int app_id,
                                      uint64_t *pkt_cnt) const;

  tdi_status_t pipeMgrPktgenTriggerCntGet(pipe_sess_hdl_t sess_hdl,
                                          bf_dev_target_t dev_tgt,
                                          int app_id,
                                          uint64_t *trigger_cnt) const;

  uint32_t pipeMgrPktgenAppCountGet(tdi_dev_id_t dev_id) const;

  bf_dev_port_t pipeMgrPktgenPortGet(tdi_dev_id_t dev_id) const;

  tdi_status_t pipeMgrPktgenPortGetNext(tdi_dev_id_t dev_id,
                                        bf_dev_port_t *port) const;

  bf_dev_port_t pipeMgrPktgenMaxPortGet(tdi_dev_id_t dev_id) const;

  // ***************** Mirror APIs ***************** //
  tdi_status_t pipeMgrMirrorSessionSet(pipe_sess_hdl_t sess_hdl,
                                       dev_target_t dev_target,
                                       bf_mirror_id_t sid,
                                       bf_mirror_session_info_t *s_info,
                                       bool enable);

  tdi_status_t pipeMgrMirrorSessionReset(pipe_sess_hdl_t sess_hdl,
                                         dev_target_t dev_target,
                                         bf_mirror_id_t sid);

  tdi_status_t pipeMgrMirrorSessionEnable(pipe_sess_hdl_t sess_hdl,
                                          dev_target_t dev_target,
                                          bf_mirror_direction_e dir,
                                          bf_mirror_id_t sid);

  tdi_status_t pipeMgrMirrorSessionDisable(pipe_sess_hdl_t sess_hdl,
                                           dev_target_t dev_target,
                                           bf_mirror_direction_e dir,
                                           bf_mirror_id_t sid);

  tdi_status_t pipeMgrMirrorSessionMetaFlagUpdate(
      pipe_sess_hdl_t sess_hdl,
      dev_target_t dev_target,
      bf_mirror_id_t sid,
      bf_mirror_meta_flag_e mirror_flag,
  ...
  tdi_status_t pipeMgrMirrorSessionMetaFlagGet(
      pipe_sess_hdl_t sess_hdl,
      dev_target_t dev_target,
      bf_mirror_id_t sid,
      bf_mirror_meta_flag_e mirror_flag,
  ...
  tdi_status_t pipeMgrMirrorSessionPriorityUpdate(pipe_sess_hdl_t sess_hdl,
                                                  dev_target_t dev_target,
                                                  bf_mirror_id_t sid,
                                                  bool value);

  tdi_status_t pipeMgrMirrorSessionPriorityGet(pipe_sess_hdl_t sess_hdl,
                                               dev_target_t dev_target,
                                               bf_mirror_id_t sid,
                                               bool *value);

  tdi_status_t pipeMgrMirrorSessionCoalModeUpdate(pipe_sess_hdl_t sess_hdl,
                                                  dev_target_t dev_target,
                                                  bf_mirror_id_t sid,
                                                  bool value);
  tdi_status_t pipeMgrMirrorSessionCoalModeGet(pipe_sess_hdl_t sess_hdl,
                                               dev_target_t dev_target,
                                               bf_mirror_id_t sid,
                                               bool *value);

  tdi_status_t pipeMgrMirrorSessionGet(pipe_sess_hdl_t sess_hdl,
                                       dev_target_t dev_target,
                                       bf_mirror_id_t sid,
                                       bf_mirror_session_info_t *s_info) const;

  tdi_status_t pipeMgrMirrorSessionGetFirst(pipe_sess_hdl_t sess_hdl,
                                            dev_target_t dev_target,
                                            bf_mirror_session_info_t *s_info,
                                            bf_mirror_get_id_t *first) const;

  tdi_status_t pipeMgrMirrorSessionGetNext(pipe_sess_hdl_t sess_hdl,
                                           dev_target_t dev_target,
                                           bf_mirror_get_id_t current,
                                           bf_mirror_session_info_t *next_info,
                                           bf_mirror_get_id_t *next) const;

  tdi_status_t pipeMgrMirrorSessionEnableGet(pipe_sess_hdl_t sess_hdl,
                                             dev_target_t dev_target,
                                             bf_mirror_id_t sid,
                                             bool *session_enable) const;

  tdi_status_t pipeMgrMirrorSessionCountGet(pipe_sess_hdl_t sess_hdl,
                                            dev_target_t dev_target,
                                            uint32_t *count) const;

  tdi_status_t pipeMgrPortRXPrsrPriThreshSet(tdi_dev_id_t dev_id,
                                             bf_dev_port_t port_id,
                                             uint32_t threshold);

  tdi_status_t pipeMgrPortRXPrsrPriThreshGet(tdi_dev_id_t dev_id,
                                             bf_dev_port_t port_id,
