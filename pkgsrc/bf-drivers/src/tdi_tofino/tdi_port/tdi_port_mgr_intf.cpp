...
std::mutex IPortMgrIntf::port_mgr_intf_mtx;

// Port configuration
tdi_status_t PortMgrIntf::portMgrPortStatusNotifReg(port_status_chg_cb cb_fn,
                                                    void *cookie) {
  return bf_pal_port_status_notif_reg(cb_fn, cookie);
}

tdi_status_t PortMgrIntf::portMgrPortGetFirst(bf_dev_id_t dev_id,
                                              bf_dev_port_t *dev_port) {
  return bf_pal_port_get_first(dev_id, dev_port);
}

tdi_status_t PortMgrIntf::portMgrPortGetFirstAdded(bf_dev_id_t dev_id,
                                                   bf_dev_port_t *dev_port) {
  return bf_pal_port_get_first_added(dev_id, dev_port);
}

tdi_status_t PortMgrIntf::portMgrPortGetNext(bf_dev_id_t dev_id,
                                             bf_dev_port_t curr_dev_port,
                                             bf_dev_port_t *next_dev_port) {
  return bf_pal_port_get_next(dev_id, curr_dev_port, next_dev_port);
}

tdi_status_t PortMgrIntf::portMgrPortGetNextAdded(
    bf_dev_id_t dev_id,
    bf_dev_port_t curr_dev_port,
    bf_dev_port_t *next_dev_port) {
...
tdi_status_t PortMgrIntf::portMgrPortAdd(bf_dev_id_t dev_id,
                                         bf_dev_port_t dev_port,
                                         bf_port_speed_t speed,
...
tdi_status_t PortMgrIntf::portMgrPortAddWithLanes(bf_dev_id_t dev_id,
                                                  bf_dev_port_t dev_port,
                                                  bf_port_speed_t speed,
                                                  uint32_t n_lanes,
                                                  bf_fec_type_t fec_type) {
...
tdi_status_t PortMgrIntf::portMgrPortSetLoopbackMode(bf_dev_id_t dev_id,
                                                     bf_dev_port_t dev_port,
                                                     bf_loopback_mode_e mode) {
  return bf_pal_port_loopback_mode_set(dev_id, dev_port, mode);
}

tdi_status_t PortMgrIntf::portMgrPortAnPolicySet(bf_dev_id_t dev_id,
                                                 bf_dev_port_t dev_port,
                                                 int an_policy) {
  return bf_pal_port_autoneg_policy_set(dev_id, dev_port, an_policy);
}

tdi_status_t PortMgrIntf::portMgrPortMtuSet(bf_dev_id_t dev_id,
                                            bf_dev_port_t dev_port,
                                            uint32_t tx_mtu,
                                            uint32_t rx_mtu) {
...
tdi_status_t PortMgrIntf::portMgrPortFlowControlPfcSet(bf_dev_id_t dev_id,
                                                       bf_dev_port_t dev_port,
                                                       uint32_t tx_en_map,
                                                       uint32_t rx_en_map) {
...
tdi_status_t PortMgrIntf::portMgrPortFlowControlPauseFrameSet(
...
tdi_status_t PortMgrIntf::portMgrPortFECSet(bf_dev_id_t dev_id,
                                            bf_dev_port_t dev_port,
                                            bf_fec_type_t fec_type) {
  return bf_pal_port_fec_set(dev_id, dev_port, fec_type);
}

tdi_status_t PortMgrIntf::portMgrPortCutThroughSet(bf_dev_id_t dev_id,
                                                   bf_dev_port_t dev_port,
                                                   bool ct_enable) {
  if (ct_enable) {
...
tdi_status_t PortMgrIntf::portMgrPortDirSet(bf_dev_id_t dev_id,
                                            bf_dev_port_t dev_port,
                                            bf_pm_port_dir_e port_dir) {
  return bf_pal_port_direction_set(dev_id, dev_port, port_dir);
}

tdi_status_t PortMgrIntf::portMgrPortMediaTypeSet(bf_dev_id_t dev_id,
                                                  bf_dev_port_t dev_port,
                                                  bf_media_type_t media_type) {
  return bf_pal_port_media_type_set(dev_id, dev_port, media_type);
}

tdi_status_t PortMgrIntf::portMgrPortSerdesParamsSet(
    bf_dev_id_t dev_id,
    bf_dev_port_t dev_port,
...
tdi_status_t PortMgrIntf::portMgrPortEnable(bf_dev_id_t dev_id,
                                            bf_dev_port_t dev_port,
                                            bool port_enable) {
  if (port_enable) {
...
tdi_status_t PortMgrIntf::portMgrPortOperStateGet(bf_dev_id_t dev_id,
                                                  bf_dev_port_t dev_port,
                                                  bool *state) {
  return bf_pal_port_oper_state_get(dev_id, dev_port, state);
}

tdi_status_t PortMgrIntf::portMgrPortMediaTypeGet(bf_dev_id_t dev_id,
                                                  bf_dev_port_t dev_port,
                                                  bf_media_type_t *media_type) {
  return bf_pal_port_media_type_get(dev_id, dev_port, media_type);
}

tdi_status_t PortMgrIntf::portMgrPortCutThroughGet(bf_dev_id_t dev_id,
                                                   bf_dev_port_t dev_port,
                                                   bool *ct_enabled) {
...
tdi_status_t PortMgrIntf::portMgrPortFrontPortGet(
    bf_dev_id_t dev_id,
    bf_dev_port_t dev_port,
...
tdi_status_t PortMgrIntf::portMgrPortIsInternalGet(bf_dev_id_t dev_id,
                                                   bf_dev_port_t dev_port,
                                                   bool *is_internal) {
  return bf_pal_is_port_internal(dev_id, dev_port, is_internal);
}

tdi_status_t PortMgrIntf::portMgrPortIsValidGet(bf_dev_id_t dev_id,
                                                bf_dev_port_t dev_port) {
  return bf_pal_port_is_valid(dev_id, dev_port);
}

tdi_status_t PortMgrIntf::portMgrPortDel(bf_dev_id_t dev_id,
                                         bf_dev_port_t dev_port) {
...
tdi_status_t PortMgrIntf::portMgrPortDelAll(bf_dev_id_t dev_id) {
  return bf_pal_port_del_all(dev_id);
}

tdi_status_t PortMgrIntf::portMgrPortStrGet(bf_dev_id_t dev_id,
                                            bf_dev_port_t dev_port,
                                            char *port_str) {
  return bf_pal_dev_port_to_port_str_map(dev_id, dev_port, port_str);
}

tdi_status_t PortMgrIntf::portMgrPortStatsPollIntvlGet(
    bf_dev_id_t dev_id, uint32_t *poll_intvl_ms) {
  return bf_pal_port_stats_poll_intvl_get(dev_id, poll_intvl_ms);
}

tdi_status_t PortMgrIntf::portMgrPortLoopbackModeGet(bf_dev_id_t dev_id,
                                                     bf_dev_port_t dev_port,
                                                     bf_loopback_mode_e *mode) {
  return bf_pal_port_loopback_mode_get(dev_id, dev_port, mode);
}

tdi_status_t PortMgrIntf::portMgrPortAnGet(
    bf_dev_id_t dev_id,
    bf_dev_port_t dev_port,
...
tdi_status_t PortMgrIntf::portMgrPortMtuGet(bf_dev_id_t dev_id,
                                            bf_dev_port_t dev_port,
                                            uint32_t *tx_mtu,
                                            uint32_t *rx_mtu) {
...
tdi_status_t PortMgrIntf::portMgrPortFlowControlPfcGet(bf_dev_id_t dev_id,
                                                       bf_dev_port_t dev_port,
                                                       uint32_t *tx_en_map,
                                                       uint32_t *rx_en_map) {
...
tdi_status_t PortMgrIntf::portMgrPortFlowContrlPauseGet(bf_dev_id_t dev_id,
                                                        bf_dev_port_t dev_port,
                                                        bool *tx_en,
                                                        bool *rx_en) {
...
tdi_status_t PortMgrIntf::portMgrPortFecGet(bf_dev_id_t dev_id,
                                            bf_dev_port_t dev_port,
                                            bf_fec_type_t *fec_type) {
...
// Port Stats
tdi_status_t PortMgrIntf::portMgrPortThisStatGet(bf_dev_id_t dev_id,
                                                 bf_dev_port_t dev_port,
...
tdi_status_t PortMgrIntf::portMgrPortPacketRateGet(bf_dev_id_t dev_id,
                                                   bf_dev_port_t dev_port,
                                                   bf_pkt_rate_t *pkt_rate) {
  return bf_pal_port_pkt_rate_get(dev_id, dev_port, pkt_rate);
}

tdi_status_t PortMgrIntf::portMgrPortThisStatClear(bf_dev_id_t dev_id,
                                                   bf_dev_port_t dev_port,
                                                   bf_rmon_counter_t ctr_type) {
  return bf_pal_port_this_stat_clear(dev_id, dev_port, ctr_type);
}

tdi_status_t PortMgrIntf::portMgrPortAllStatsGet(
    bf_dev_id_t dev_id,
    bf_dev_port_t dev_port,
...
tdi_status_t PortMgrIntf::portMgrPortThisStatGetWithTimestamp(
    bf_dev_id_t dev_id,
    bf_dev_port_t dev_port,
    bf_rmon_counter_t ctr_type,
    uint64_t *stat_val,
...
tdi_status_t PortMgrIntf::portMgrAllPureStatsGetWithTimestamp(
    bf_dev_id_t dev_id,
    bf_dev_port_t dev_port,
    uint64_t stats[BF_NUM_RMON_COUNTERS],
    int64_t *timestamp_s,
...
tdi_status_t PortMgrIntf::portMgrPortAllStatsClear(bf_dev_id_t dev_id,
                                                   bf_dev_port_t dev_port) {
  return bf_pal_port_all_stats_clear(dev_id, dev_port);
}

tdi_status_t PortMgrIntf::portMgrPortStatsPollIntvlSet(bf_dev_id_t dev_id,
                                                       uint32_t poll_intvl_ms) {
  return bf_pal_port_stats_poll_intvl_set(dev_id, poll_intvl_ms);
}

tdi_status_t PortMgrIntf::portMgrPortStatDirectGet(
    bf_dev_id_t dev_id,
    bf_dev_port_t dev_port,
...
tdi_status_t PortMgrIntf::portMgrFrontPortToDevPortGet(
    bf_dev_id_t dev_id,
    bf_pal_front_port_handle_t *port_hdl,
    bf_dev_port_t *dev_port) {
...
tdi_status_t PortMgrIntf::portMgrFpIdxToDevPortGet(bf_dev_id_t dev_id,
                                                   uint32_t fp_idx,
                                                   bf_dev_port_t *dev_port) {
  return bf_pal_fp_idx_to_dev_port_map(dev_id, fp_idx, dev_port);
}

tdi_status_t PortMgrIntf::portMgrPortStrToDevPortGet(bf_dev_id_t dev_id,
                                                     char *port_str,
                                                     bf_dev_port_t *dev_port) {
  return bf_pal_port_str_to_dev_port_map(dev_id, port_str, dev_port);
}

tdi_status_t PortMgrIntf::portMgrPortSpeedGet(bf_dev_id_t dev_id,
                                              bf_dev_port_t dev_port,
                                              bf_port_speed_t *speed) {
...
tdi_status_t PortMgrIntf::portMgrPortNumLanesGet(bf_dev_id_t dev_id,
                                                 bf_dev_port_t dev_port,
                                                 int *num_lanes) {
  return bf_pal_port_num_lanes_get(dev_id, dev_port, num_lanes);
}

tdi_status_t PortMgrIntf::portMgrPortIsEnabled(bf_dev_id_t dev_id,
                                               bf_dev_port_t dev_port,
                                               bool *is_enabled) {
  return bf_pal_port_is_enabled(dev_id, dev_port, is_enabled);
}
tdi_status_t PortMgrIntf::portMgrPortDirGet(bf_dev_id_t dev_id,
                                            bf_dev_port_t dev_port,
                                            bf_pm_port_dir_e *port_dir) {
  return bf_pal_port_direction_get(dev_id, dev_port, port_dir);
}
tdi_status_t PortMgrIntf::portMgrPortSerdesTxEqPreGet(bf_dev_id_t dev_id,
                                                      bf_dev_port_t dev_port,
                                                      int *tx_pre) {
  return bf_pal_port_serdes_tx_eq_pre_get(dev_id, dev_port, tx_pre);
}
tdi_status_t PortMgrIntf::portMgrPortSerdesTxEqPostGet(bf_dev_id_t dev_id,
                                                       bf_dev_port_t dev_port,
                                                       int *tx_post) {
  return bf_pal_port_serdes_tx_eq_post_get(dev_id, dev_port, tx_post);
}
tdi_status_t PortMgrIntf::portMgrPortSerdesTxEqPre2Get(bf_dev_id_t dev_id,
                                                       bf_dev_port_t dev_port,
                                                       int *tx_pre2) {
  return bf_pal_port_serdes_tx_eq_pre2_get(dev_id, dev_port, tx_pre2);
}
tdi_status_t PortMgrIntf::portMgrPortSerdesTxEqPost2Get(bf_dev_id_t dev_id,
                                                        bf_dev_port_t dev_port,
                                                        int *tx_post2) {
  return bf_pal_port_serdes_tx_eq_post2_get(dev_id, dev_port, tx_post2);
}
tdi_status_t PortMgrIntf::portMgrPortSerdesTxEqAttnGet(bf_dev_id_t dev_id,
                                                       bf_dev_port_t dev_port,
                                                       int *tx_attn) {
  return bf_pal_port_serdes_tx_eq_attn_get(dev_id, dev_port, tx_attn);
}
tdi_status_t PortMgrIntf::portMgrFpIdxGetFirst(bf_dev_id_t dev_id,
                                               uint32_t *fp_idx) {
  return bf_pal_fp_idx_get_first(dev_id, fp_idx);
}
tdi_status_t PortMgrIntf::portMgrFpIdxGetNext(bf_dev_id_t dev_id,
                                              uint32_t curr_idx,
                                              uint32_t *next_idx) {
  return bf_pal_fp_idx_get_next(dev_id, curr_idx, next_idx);
}
tdi_status_t PortMgrIntf::portMgrNumPipesGet(bf_dev_id_t dev_id,
                                             uint32_t *num_pipes) {
  return bf_pal_num_pipes_get(dev_id, num_pipes);
}
tdi_status_t PortMgrIntf::portMgrMaxPortsGet(bf_dev_id_t dev_id,
                                             uint32_t *ports) {
  return bf_pal_max_ports_get(dev_id, ports);
}
tdi_status_t PortMgrIntf::portMgrNumFrontPortsGet(bf_dev_id_t dev_id,
                                                  uint32_t *ports) {
  return bf_pal_num_front_ports_get(dev_id, ports);
}
tdi_status_t PortMgrIntf::portMgrIntrLinkMonitoringGet(bf_dev_id_t dev_id,
                                                       bool *is_enabled) {
  return bf_pal_interrupt_based_link_monitoring_get(dev_id, is_enabled);
}
tdi_status_t PortMgrIntf::portMgrRecircDevPortsGet(
    bf_dev_id_t dev_id, uint32_t *recirc_devport_list) {
  return bf_pal_recirc_devports_get(dev_id, recirc_devport_list);
}

tdi_status_t PortMgrIntf::portMgrPtpTxTimestampGet(bf_dev_id_t dev_id,
                                                   bf_dev_port_t dev_port,
                                                   uint64_t *ts,
                                                   bool *ts_valid,
                                                   int *ts_id) {
...
tdi_status_t PortMgrIntf::portMgrPtpTxDeltaGet(bf_dev_id_t dev_id,
                                               bf_dev_port_t dev_port,
                                               uint16_t *delta) {
  return bf_port_1588_timestamp_delta_tx_get(dev_id, dev_port, delta);
}
tdi_status_t PortMgrIntf::portMgrPtpTxDeltaSet(bf_dev_id_t dev_id,
                                               bf_dev_port_t dev_port,
                                               uint16_t delta) {
  return bf_port_1588_timestamp_delta_tx_set(dev_id, dev_port, delta);
}
tdi_status_t PortMgrIntf::portMgrPtpRxDeltaGet(bf_dev_id_t dev_id,
                                               bf_dev_port_t dev_port,
                                               uint16_t *delta) {
  return bf_port_1588_timestamp_delta_rx_get(dev_id, dev_port, delta);
}

tdi_status_t PortMgrIntf::portMgrPtpRxDeltaSet(bf_dev_id_t dev_id,
                                               bf_dev_port_t dev_port,
                                               uint16_t delta) {
  return bf_port_1588_timestamp_delta_rx_set(dev_id, dev_port, delta);
}

tdi_status_t PortMgrIntf::portMgrPortIsSpecialPort(bf_dev_id_t dev_id,
                                                   bf_dev_port_t dev_port) {
  return bf_pal_is_special_port(dev_id, dev_port);
}

tdi_status_t PortMgrIntf::portMgrNonMacPortInfoGet(bf_dev_id_t dev_id,
                                                   bf_dev_port_t dev_port,
                                                   bf_port_speed_t *speed,
                                                   uint32_t *n_lanes) {
  return bf_port_info_get(dev_id, dev_port, speed, n_lanes);
}

tdi_status_t PortMgrIntf::portMgrNonMacPortAdd(bf_dev_id_t dev_id,
                                               bf_dev_port_t dev_port,
                                               bf_port_speed_t speed) {
  ...
  bf_dev_port_t pcie_cpu = bf_pcie_cpu_port_get(dev_id);
  bf_dev_port_t pcie_cpu2 = bf_pcie_cpu_port2_get(dev_id);

  switch (dev_family) {
    case BF_DEV_FAMILY_TOFINO:
      status = bf_port_add(dev_id, dev_port, speed, BF_FEC_TYP_NONE);
      break;
    case BF_DEV_FAMILY_TOFINO2:
      if ((dev_port == pcie_cpu || dev_port == pcie_cpu2) &&
          speed != BF_SPEED_50G) {
        return TDI_INVALID_ARG;
      }
      lane_numb = (speed == BF_SPEED_50G) ? 1 : 2;
      status = bf_port_add_with_lane_numb(
          dev_id, dev_port, speed, lane_numb, BF_FEC_TYP_NONE);
      break;
    case BF_DEV_FAMILY_TOFINO3:
      status = bf_port_add_with_lane_numb(
          dev_id, dev_port, speed, 2, BF_FEC_TYP_NONE);
      break;
    default:
      return TDI_INVALID_ARG;
  }
...
tdi_status_t PortMgrIntf::portMgrNonMacPortRemove(bf_dev_id_t dev_id,
                                                  bf_dev_port_t dev_port) {
  return bf_port_remove(dev_id, dev_port);
}

tdi_status_t PortMgrIntf::portMgrPcieCpuPortAdd(bf_dev_id_t dev_id,
                                                bf_dev_port_t dev_port) {
  tdi_status_t status = TDI_SUCCESS;
  ;
  bf_dev_family_t dev_family =
  ...
  switch (dev_family) {
    case BF_DEV_FAMILY_TOFINO:
      status = bf_port_add(dev_id, dev_port, BF_SPEED_100G, BF_FEC_TYP_NONE);
      break;
    case BF_DEV_FAMILY_TOFINO2:
    case BF_DEV_FAMILY_TOFINO3:
      status = bf_port_add(dev_id, dev_port, BF_SPEED_25G, BF_FEC_TYP_NONE);
      break;
    default:
      return TDI_INVALID_ARG;
  }
