...
pkt_len = int(testutils.test_param_get('pkt_size'))
...
class DigestTest2(BfRuntimeTest):
    ...
    def runTest(self):
        ...
        md1 = 0xABCDEF
        md2 = 0x123456
        pkt1 = testutils.simple_tcp_packet(pktlen=pkt_len, eth_dst=dmac1)
        pkt2 = testutils.simple_tcp_packet(pktlen=pkt_len, eth_dst=dmac2)
