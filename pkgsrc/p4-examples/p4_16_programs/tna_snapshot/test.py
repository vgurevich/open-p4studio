...
class SnapshotTest(BfRuntimeTest):
    ...
    def runTest(self):
        ...
        target_0 = client.Target(device_id=0, pipe_id=ig_pipe, direction=0)
        ...
        for stage in range(end_stage + 1):
            ...
            for data, key in resp:
                ...
                assert table_hit if tbl_name == "pipe.SwitchIngress.forward" else not table_hit
                ...
                if stage == 0 and g_is_tofino:
                    expected_next_table_name = "pipe.SwitchIngress.bypass"
                elif stage == 1 and g_is_tofino:
                    expected_next_table_name = "pipe.SwitchIngress.ipRoute"
                else:
