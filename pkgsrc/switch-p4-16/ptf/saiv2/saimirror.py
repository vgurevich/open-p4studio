...
#        +------------+------------+-----------+-----------+
    ...
    def tearDown(self):
        ...
        sai_thrift_set_port_attribute(self.client, self.port31, port_vlan_id=0)
        sai_thrift_set_port_attribute(self.client, self.port30, port_vlan_id=0)
        sai_thrift_set_port_attribute(self.client, self.port29, port_vlan_id=0)
        sai_thrift_set_port_attribute(self.client, self.port28, port_vlan_id=0)
    ...
    def _mirrorSessionTrafficClassTest(self):
        ...
        try:
            ...
            self.assertTrue(pkt_cnt_after == pkt_cnt_before + 1)
    ...
    def _erspanVlanPortMirroringTest(self):
        ...
        # Exclude monitor port from VLAN40.
        sai_thrift_remove_vlan_member(self.client, self.vlan_member41)
        # Mirror session
        sai_thrift_remove_vlan_member(self.client, self.vlan_member41)
        encap_type = SAI_ERSPAN_ENCAPSULATION_TYPE_MIRROR_L3_GRE_TUNNEL
        ...
        try:
            ...
            sai_thrift_set_port_attribute(self.client,
                                          ...
                                          ingress_mirror_session=obj_list)
            sai_thrift_remove_mirror_session(self.client, erspan_id)
            # Restore monitor port to VLAN40.
            self.vlan_member41 = sai_thrift_create_vlan_member(
                self.client,
                vlan_id=self.vlan40,
                bridge_port_id=self.port24_bp,
...
class MirrorPolicingTestGroup(MirrorConfigData):
    ...
    def ingressMirrorPolicingTest(self):
        ...
        try:
            ...
            self.assertTrue(g_pkts1 + r_pkts1 == pkt_cnt)
    ...
    def egressMirrorPolicingTest(self):
        ...
        try:
            ...
            sai_thrift_clear_policer_stats(self.client, self.pol_id)
            stats = sai_thrift_get_policer_stats(self.client, self.pol_id)
            print("Policer statistics clear")
            print('SAI_POLICER_STAT_PACKETS:',
                  stats['SAI_POLICER_STAT_PACKETS'])
            print('SAI_POLICER_STAT_GREEN_PACKETS:',
                  stats['SAI_POLICER_STAT_GREEN_PACKETS'])
