...
class L2VlanTest(SaiHelper):
    ...
    def runTest(self):
        try:
            self.forwardingTest()
            self.forwardingWithIPFieldsTest()
            self.nativeVlanTest()
    ...
    def forwardingTest(self):
        ...
        """
        print("\nforwardingTest()")
        mac31 = '00:55:55:55:55:55'
        vlan10_member31 = sai_thrift_create_vlan_member(
            self.client,
            vlan_id=self.vlan10,
            bridge_port_id=self.port31_bp,
            vlan_tagging_mode=SAI_VLAN_TAGGING_MODE_PRIORITY_TAGGED)
        fdb_entry31 = sai_thrift_fdb_entry_t(
            switch_id=self.switch_id, mac_address=mac31, bv_id=self.vlan10)
        sai_thrift_create_fdb_entry(
            self.client,
            fdb_entry31,
            type=SAI_FDB_ENTRY_TYPE_STATIC,
        ...
        try:
            ...
            print("\tAccessToPriorityTaggedTest")
            print("Sending L2 packet - port 0 -> port 31 [prio vlan=0])")
            pkt = simple_tcp_packet(eth_dst='00:55:55:55:55:55',
                                    eth_src='00:11:11:11:11:11',
                                    ip_dst='172.16.0.1',
                                    ip_id=102,
                                    ip_ttl=64)
            exp_pkt = simple_tcp_packet(eth_dst='00:55:55:55:55:55',
                                        eth_src='00:11:11:11:11:11',
                                        ip_dst='172.16.0.1',
                                        dl_vlan_enable=True,
                                        vlan_vid=0,
            ...
            send_packet(self, self.dev_port0, pkt)
            verify_packet(self, exp_pkt, self.dev_port31)
            self.i_pkt_count += 1
            self.e_pkt_count += 1
            ...
            print("\tTrunkToPriorityTaggedTest")
            print("Sending L2 packet - port 1 -> port 31 [prio vlan=0])")
            pkt = simple_tcp_packet(eth_dst='00:55:55:55:55:55',
                                    eth_src='00:22:22:22:22:22',
                                    dl_vlan_enable=True,
                                    vlan_vid=10,
            ...
            print("\tPriorityTaggedToAccessTest")
            print("Sending L2 packet - port 31 -> port 0 [trunk vlan=10])")
            pkt = simple_tcp_packet(eth_dst='00:11:11:11:11:11',
            ...
            print("\tPriorityTaggedToTrunkTest")
            print("Sending L2 packet - port 31 -> port 25 [trunk vlan=10])")
            pkt = simple_tcp_packet(eth_dst='00:44:44:44:44:44',
                                    eth_src='00:55:55:55:55:55',
                                    dl_vlan_enable=True,
                                    vlan_vid=0,
            ...
            sai_thrift_set_port_attribute(
                self.client, self.port31, port_vlan_id=0)
            sai_thrift_remove_fdb_entry(self.client, fdb_entry31)
            sai_thrift_remove_vlan_member(self.client, vlan10_member31)
    ...
    def nativeVlanTest(self):
        ...
        try:
            ...
            sai_thrift_set_lag_attribute(
                self.client, self.lag2, port_vlan_id=0)
    ...
    def vlanFloodTest(self):
        ...
        try:
            ...
            sai_thrift_set_port_attribute(
                self.client, self.port26, port_vlan_id=0)
            sai_thrift_set_port_attribute(
                self.client, self.port27, port_vlan_id=0)
            sai_thrift_set_lag_attribute(
                self.client, self.lag10, port_vlan_id=0)
            sai_thrift_set_lag_attribute(
                self.client, self.lag11, port_vlan_id=0)
    ...
    def vlanFloodEnhancedTest(self):
        ...
        try:
            ...
            sai_thrift_set_port_attribute(
                self.client, self.port27, port_vlan_id=0)
            sai_thrift_set_port_attribute(
                self.client, self.port30, port_vlan_id=0)
            sai_thrift_set_lag_attribute(
                self.client, self.lag10, port_vlan_id=0)
            sai_thrift_set_lag_attribute(
                self.client, self.lag11, port_vlan_id=0)
    ...
    def vlanFloodDisableTest(self):
        ...
        try:
            ...
            sai_thrift_set_port_attribute(
                self.client, self.port24, port_vlan_id=0)
            sai_thrift_set_port_attribute(
                self.client, self.port25, port_vlan_id=0)
            sai_thrift_set_port_attribute(
                self.client, self.port26, port_vlan_id=0)
            sai_thrift_set_port_attribute(
                self.client, self.port27, port_vlan_id=0)
    ...
    def countersClearTest(self):
        ...
        self.assertTrue(in_packets == 0, 'vlan IN packets counter is not 0')
        self.assertTrue(in_ucast_packets == 0,
                        'vlan IN unicast packets counter is not 0')
        self.assertTrue(in_bytes == 0, 'vlan IN bytes counter is not 0')
        self.assertTrue(out_packets == 0,
                        'vlan OUT packets counter is not 0')
        self.assertTrue(out_ucast_packets == 0,
                        'vlan OUT unicast packets counter is not 0')
        self.assertTrue(out_bytes == 0, 'vlan OUT bytes counter is not 0')
    ...
    def vlanFloodPruneTest(self):
        ...
        try:
            ...
            sai_thrift_set_lag_attribute(self.client, lag, port_vlan_id=0)
            sai_thrift_set_lag_attribute(self.client, lag2, port_vlan_id=0)
    ...
    def vlanStatsTest(self):
        ...
        self.assertTrue((in_packets == self.i_pkt_count),
                        'vlan IN packets counter {} != {}'.format(
                            in_packets, self.i_pkt_count))
        self.assertTrue((in_ucast_packets == self.i_pkt_count),
                        'vlan IN unicast packets counter {} != {}'.format(
                            in_ucast_packets, self.i_pkt_count))
        self.assertTrue((in_bytes != 0), 'vlan IN bytes counter is 0')
        self.assertTrue((out_packets == self.e_pkt_count),
                        'vlan OUT packets counter {} != {}'.format(
                            out_packets, self.e_pkt_count))
        self.assertTrue((out_ucast_packets == self.e_pkt_count),
                        'vlan OUT unicast packets counter {} != {}'.format(
                            out_ucast_packets, self.e_pkt_count))
        self.assertTrue((out_bytes != 0), 'vlan OUT bytes counter is 0')
    ...
    def vlanMemberList(self):
        ...
        self.assertTrue(self.vlan10_member0 == vlan_members[0])
        self.assertTrue(self.vlan10_member1 == vlan_members[1])
        self.assertTrue(self.vlan10_member2 == vlan_members[2])
        self.assertTrue(self.vlan10_member3 == vlan_members[3])
        self.assertTrue(self.vlan10_member4 == vlan_members[4])
        ...
        self.assertTrue(self.vlan10_member3 == vlan_members[3])
        self.assertTrue(self.vlan10_member4 == vlan_members[4])
        self.assertTrue(vlan10_member5 == vlan_members[5])
        self.assertTrue(vlan10_member6 == vlan_members[6])
    ...
    def vlanNegativeTest(self):
        ...
        self.assertTrue(self.vlan10 != duplicate_vlan)
        self.assertTrue(duplicate_vlan == 0)
        ...
        self.assertTrue(sai_thrift_set_vlan_attribute(
            self.client,
            vlan_oid=11,
        ...
        self.assertTrue(sai_thrift_remove_vlan(self.client, vlan_oid=11) != 0)
        ...
        incorrect_member = sai_thrift_create_vlan_member(
            ...
            bridge_port_id=self.port27_bp,
            vlan_tagging_mode=SAI_VLAN_TAGGING_MODE_TAGGED)
        self.assertTrue(incorrect_member == 0)
        incorrect_member = sai_thrift_create_vlan_member(
            self.client,
            vlan_id=self.vlan10,
    ...
    def forwardingWithIPFieldsTest(self):
        """
        Forwarding b/w Vlans with wrong IP fields
        """
        print("\nforwardingWithIPFieldsTest()")
        try:
            print(
                "Sending L2 packet with DIP 0 - port 1 -> port 25")
            pkt = simple_tcp_packet(eth_dst='00:44:44:44:44:44',
                                    eth_src='00:22:22:22:22:22',
                                    dl_vlan_enable=True,
                                    vlan_vid=10,
            ...
            print(
                "Sending L2 packet with SIP 0 - port 1 -> port 25 ")
            pkt = simple_tcp_packet(eth_dst='00:44:44:44:44:44',
                                    eth_src='00:22:22:22:22:22',
                                    dl_vlan_enable=True,
                                    vlan_vid=10,
            ...
            print(
                "Sending L2 packet with DIP 127.0.0.1 - port 1 -> port 25")
            pkt = simple_tcp_packet(eth_dst='00:44:44:44:44:44',
                                    eth_src='00:22:22:22:22:22',
                                    dl_vlan_enable=True,
                                    vlan_vid=10,
            ...
            print(
                "Sending L2 packet with SIP 127.0.0.1 - port 1 -> port 25 ")
            pkt = simple_tcp_packet(eth_dst='00:44:44:44:44:44',
                                    eth_src='00:22:22:22:22:22',
                                    dl_vlan_enable=True,
                                    vlan_vid=10,
            ...
            print(
                "Sending L2 packet with TTL 0 - port 1 -> port 25")
            pkt = simple_tcp_packet(eth_dst='00:44:44:44:44:44',
                                    eth_src='00:22:22:22:22:22',
                                    dl_vlan_enable=True,
                                    vlan_vid=10,
...
class L2VlanConfigTest(SaiHelper):
    """
    The class runs VLAN config test cases
    """

    def setUp(self):
        super(L2VlanConfigTest, self).setUp()
        self.mac1 = '00:33:33:33:33:33:33'
        self.mac2 = '00:44:44:44:44:44:44'
    ...
    def tearDown(self):
        sai_thrift_remove_bridge_port(self.client, self.port24_bp)
        super(L2VlanConfigTest, self).tearDown()

    def runTest(self):
        try:
            self.vlanSetPortPVIDBeforeCreateVlanTest()
            self.vlanSetLagPVIDBeforeCreateVlanTest()
            self.vlanSetPortPVIDifPortIsLagMemberTest()
        finally:
            pass

    def vlanSetPortPVIDBeforeCreateVlanTest(self):
        """
        verify passing traffic if Port PVID is set on
        the port before the VLAN object is created.
        """
        print("\nvlanSetPortPVIDBeforeCreateVlanTest()")
        try:
            vlan_id = 50
            mac_action = SAI_PACKET_ACTION_FORWARD
            ...
            vlan = sai_thrift_create_vlan(self.client, vlan_id=vlan_id)

            vlan_member50_1 = sai_thrift_create_vlan_member(
                self.client,
                vlan_id=vlan,
                bridge_port_id=port25_bp,
                vlan_tagging_mode=SAI_VLAN_TAGGING_MODE_UNTAGGED)
            vlan_member50_2 = sai_thrift_create_vlan_member(
                self.client,
                vlan_id=vlan,
                bridge_port_id=self.port24_bp,
                vlan_tagging_mode=SAI_VLAN_TAGGING_MODE_TAGGED)

            fdb_entry24 = sai_thrift_fdb_entry_t(
                switch_id=self.switch_id, mac_address=self.mac2, bv_id=vlan)
            sai_thrift_create_fdb_entry(
                self.client,
                fdb_entry24,
                type=SAI_FDB_ENTRY_TYPE_STATIC,
            ...
            print("\tAccessToTrunkTest")
            print("Sending L2 packet - port 0 -> port 1 [trunk vlan=50])")
            pkt = simple_tcp_packet(eth_dst=self.mac2,
                                    eth_src=self.mac0,
                                    ip_dst=self.ip_dst,
                                    ip_id=102,
                                    ip_ttl=64)
            exp_pkt = simple_tcp_packet(eth_dst=self.mac2,
                                        eth_src=self.mac0,
                                        ip_dst=self.ip_dst,
                                        dl_vlan_enable=True,
                                        vlan_vid=50,
            ...
            sai_thrift_remove_vlan_member(self.client, vlan_member50_1)
            sai_thrift_remove_vlan_member(self.client, vlan_member50_2)
            sai_thrift_remove_vlan(self.client, vlan)
            sai_thrift_set_port_attribute(self.client, self.port25,
                                          port_vlan_id=0)
            sai_thrift_remove_bridge_port(self.client, port25_bp)

    def vlanSetLagPVIDBeforeCreateVlanTest(self):
        """
        verify passing traffic if Lag PVID is set on
        the lag before the VLAN object is created.
        """
        print("\nvlanSetLagPVIDBeforeCreateVlanTest")
        try:
            vlan_id = 50
            mac_action = SAI_PACKET_ACTION_FORWARD
            port_type = SAI_BRIDGE_PORT_TYPE_PORT
            ...
            sai_thrift_set_lag_attribute(self.client, lag10,
                                         port_vlan_id=vlan_id)
            vlan = sai_thrift_create_vlan(self.client, vlan_id=vlan_id)
            lag_mbr28 = sai_thrift_create_lag_member(
                self.client, lag_id=lag10, port_id=self.port28)
            ...
            sai_thrift_create_fdb_entry(
                ...
                packet_action=mac_action)
            print("\tAccessToTrunkTest")
            print("Sending L2 packet - lag -> port 1 [trunk vlan=50])")
            pkt = simple_tcp_packet(eth_dst=self.mac2,
                                    eth_src=self.mac0,
                                    ip_dst=self.ip_dst,
                                    ip_id=102,
            ...
            sai_thrift_remove_vlan_member(self.client, vlan_member50_1)
            sai_thrift_remove_vlan_member(self.client, vlan_member50_2)
            sai_thrift_remove_lag_member(self.client, lag_mbr28)
            sai_thrift_remove_bridge_port(self.client, lag10_bp)
            sai_thrift_remove_vlan(self.client, vlan)
            sai_thrift_remove_lag(self.client, lag10)

    def vlanSetPortPVIDifPortIsLagMemberTest(self):
        """
        Verify that the port PVID can't be changed
        when the port is a member of LAG.
        """
        print("\nvlanSetPortPVIDifPortIsLagMemberTest()")
        try:

            bridge = self.default_1q_bridge
            mac_action = SAI_PACKET_ACTION_FORWARD
            port_type = SAI_BRIDGE_PORT_TYPE_PORT
            ...
            pkt = simple_tcp_packet(eth_dst=self.mac2,
                                    ...
                                    ip_id=102,
                                    ip_ttl=64)
            exp_pkt_vlan_10 = simple_tcp_packet(eth_dst=self.mac2,
                                                eth_src=self.mac0,
                                                ip_dst=self.ip_dst,
                                                dl_vlan_enable=True,
                                                vlan_vid=10,
            ...
            exp_pkt_vlan_20 = simple_tcp_packet(eth_dst=self.mac2,
                                                eth_src=self.mac0,
                                                ip_dst=self.ip_dst,
                                                dl_vlan_enable=True,
                                                vlan_vid=20,
            ...
            print("Configure port 28 as VLAN 10 \
                   untagged member")

            sai_thrift_set_port_attribute(self.client, self.port28,
                                          port_vlan_id=10)
            port28_bp = sai_thrift_create_bridge_port(self.client,
                                                      bridge_id=bridge,
                                                      port_id=self.port28,
                                                      type=port_type,
                                                      admin_state=True)

            vlan_member10_2 = sai_thrift_create_vlan_member(
                self.client,
                vlan_id=self.vlan10,
                bridge_port_id=port28_bp,
                vlan_tagging_mode=SAI_VLAN_TAGGING_MODE_UNTAGGED)

            fdb_entry28 = sai_thrift_fdb_entry_t(
                switch_id=self.switch_id,
            ...
            sai_thrift_create_fdb_entry(
                ...
                bridge_port_id=port28_bp,
                packet_action=mac_action)
            print("Sending L2 packet - port 28 -> port 1 [trunk vlan=10])")
            send_packet(self, self.dev_port28, pkt)
            verify_packet(self, exp_pkt_vlan_10, self.dev_port1)

            sai_thrift_remove_bridge_port(self.client, port28_bp)

            print("Configure lag10 as VLAN 20 untagged member. \
                   Port 28 is lag10 member")

            lag10 = sai_thrift_create_lag(self.client)
            sai_thrift_set_lag_attribute(self.client, lag10,
                                         port_vlan_id=20)
            lag_mbr31 = sai_thrift_create_lag_member(
                self.client, lag_id=lag10, port_id=self.port28)
            lag10_bp = sai_thrift_create_bridge_port(
                self.client,
                bridge_id=bridge,
            ...
            vlan_member20_2 = sai_thrift_create_vlan_member(
                self.client,
                vlan_id=self.vlan20,
                bridge_port_id=lag10_bp,
                vlan_tagging_mode=SAI_VLAN_TAGGING_MODE_UNTAGGED)

            fdb_entry_lag_vlan20 = sai_thrift_fdb_entry_t(
                switch_id=self.switch_id,
                mac_address=self.mac1,
                bv_id=self.vlan20)
            sai_thrift_create_fdb_entry(
                self.client,
                fdb_entry_lag_vlan20,
                type=SAI_FDB_ENTRY_TYPE_STATIC,
                bridge_port_id=lag10_bp,
                packet_action=mac_action)

            print("Trying set another PVID for 28 port")
            sai_thrift_set_port_attribute(self.client, self.port28,
                                          port_vlan_id=1)

            print("Sending L2 packet - lag -> port 3 [trunk vlan=20])")
            send_packet(self, self.dev_port28, pkt)
            verify_packet(self, exp_pkt_vlan_20, self.dev_port3)

            print("Remove lag10 member")
            sai_thrift_remove_vlan_member(self.client, vlan_member20_2)
            sai_thrift_remove_lag_member(self.client, lag_mbr31)
            sai_thrift_remove_bridge_port(self.client, lag10_bp)
            ...
            print("Sending L2 packet - poer28 -> port 1 [trunk vlan=10])")
            send_packet(self, self.dev_port28, pkt)
            verify_packet(self, exp_pkt_vlan_10, self.dev_port1)
            ...
            sai_thrift_remove_vlan_member(self.client, vlan_member10_2)
            sai_thrift_remove_lag(self.client, lag10)
