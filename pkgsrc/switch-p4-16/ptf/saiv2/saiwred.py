...
class WredBaseTest(SaiHelper):
    ...
    def setUp(self):
        ...
        # self.port10_rif, self.port11_rif, self.port12_rif
        # and self.port13_rif router interfaces are already created
        # (ports 10, 11, 12, 13, default VRF)
        self.nexthops = []
        self.neighbors = []
        self.routes = []
    ...
    def _WredIPv4Test(self):
       ...
       """
        ...
        try:
            ...
            # ('SAI_QUEUE_STAT_BYTES', 2*PKT_LEN))
            ...
            # ('SAI_QUEUE_STAT_BYTES', 3*PKT_LEN))
    ...
    def _WredDropIPv4Test(self):
        ...
        try:
            ...
            self._verifyStats(
                ...
                # ('SAI_PORT_STAT_WRED_DROPPED_BYTES', PKT_LEN),
                ('SAI_PORT_STAT_GREEN_WRED_DROPPED_PACKETS', 1))
            # ('SAI_PORT_STAT_GREEN_WRED_DROPPED_BYTES', PKT_LEN))
            ...
            # ('SAI_QUEUE_STAT_BYTES', 5*PKT_LEN))
    ...
    def _WredStatsTest(self):
        ...
        try:
            ...
            self._verifyStats(
                ...
                # ('SAI_PORT_STAT_WRED_DROPPED_BYTES', 2*PKT_LEN),
                ('SAI_PORT_STAT_GREEN_WRED_DROPPED_PACKETS', 2))
            # ('SAI_PORT_STAT_GREEN_WRED_DROPPED_BYTES', 2*PKT_LEN))
...
class WredTest(WredBaseTest):
    ...
    def _WredAttributeCheckTest(self):
