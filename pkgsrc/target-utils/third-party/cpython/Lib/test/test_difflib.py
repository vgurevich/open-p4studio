...
patch914575_nonascii_from1 = """
   1. Beautiful is beTTer than ugly.
   2. Explicit is better than ?mpl?c?t.
   3. Simple is better than complex.
   4. Complex is better than complicated.
"""
...
patch914575_nonascii_to1 = """
   ...
   3.   S?mple is better than complex.
   4. Complicated is better than c?mplex.
   5. Flat is better than nested.
"""
...
class TestBytes(unittest.TestCase):
    ...
    def test_mixed_types_dates(self):
        ...
        dateb = '3 f?v'
        self._assert_type_error(
            "all arguments must be bytes, not str ('1 f?v')",
