...
class Test(TestEmailBase):
    ...
    def test_rfc2043_auto_decoded_and_emailmessage_used(self):
        m = message_from_string(textwrap.dedent("""\
            ...
            sample text
            """), policy=policy.default)
        self.assertEqual(m['subject'], "Ayons asperges pour le d?jeuner")
        self.assertEqual(m['from'], "Pep? Le Pew <pepe@example.com>")
...
class TestEmailMessage(TestEmailMessageBase, TestEmailBase):
    ...
    def test_str_defaults_to_utf8(self):
        m = EmailMessage()
        m['Subject'] = 'unic?de'
        self.assertEqual(str(m), 'Subject: unic?de\n\n')
    ...
    def test_folding_with_utf8_encoding_1(self):
        ...
        m = EmailMessage()
        m['Subject'] = 'Hello W?rld! Hello W?rld! '            \
                       'Hello W?rld! Hello W?rld!Hello W?rld!'
    ...
    def test_folding_with_utf8_encoding_2(self):
        ...
        m = EmailMessage()
        m['Subject'] = 'Hello W?rld! Hello W?rld! '                \
                       'Hello W?rlds123! Hello W?rld!Hello W?rld!'
        self.assertEqual(bytes(m),
                         b'Subject: Hello =?utf-8?q?W=C3=B6rld!_Hello_W'
    ...
    def test_folding_with_utf8_encoding_3(self):
        ...
        m = EmailMessage()
        m['Subject'] = 'Hello-W?rld!-Hello-W?rld!-Hello-W?rlds123! ' \
    ...
    def test_folding_with_utf8_encoding_4(self):
        ...
        m = EmailMessage()
        m['Subject'] = 'Hello-W?rld!-Hello-W?rld!-Hello-W?rlds123!-Hello' \
                       ' W?rld!Hello W?rld!'
        self.assertEqual(bytes(m),
                         b'Subject: =?utf-8?q?Hello-W=C3=B6rld!-Hello-W'
                         b'=C3=B6rld!-Hello-W=C3=B6rlds123!?=\n'
    ...
    def test_folding_with_utf8_encoding_5(self):
        ...
        m['Subject'] = '123456789 123456789 123456789 123456789 123456789' \
                       ' 123456789 123456789 Hello W?rld!'
        self.assertEqual(bytes(m),
    ...
    def test_folding_with_utf8_encoding_6(self):
        ...
        m = EmailMessage()
        m['Subject'] = '123456789 123456789 123456789 123456789 Hello W?rld!' \
    ...
    def test_folding_with_utf8_encoding_7(self):
        ...
        m = EmailMessage()
        m['Subject'] = '123456789 123456789 Hello W?rld! Hello W?rld! '       \
                       '123456789-123456789 123456789 Hello W?rld! 123456789' \
                       ' 123456789'
        self.assertEqual(bytes(m),
