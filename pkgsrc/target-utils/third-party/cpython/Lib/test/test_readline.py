...
class TestHistoryManipulation (unittest.TestCase):
    ...
    def test_nonascii_history(self):
        readline.clear_history()
        try:
            readline.add_history("entr?e 1")
        except UnicodeEncodeError as err:
            self.skipTest("Locale cannot encode test data: " + format(err))
        readline.add_history("entr?e 2")
        readline.replace_history_item(1, "entr?e 22")
        ...
        self.assertEqual(readline.get_history_item(1), "entr?e 1")
        self.assertEqual(readline.get_history_item(2), "entr?e 22")
