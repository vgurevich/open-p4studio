...
class BasicSocketTests(unittest.TestCase):
    ...
    def test_match_hostname(self):
        ...
        cert = {'subject': ((('commonName', idna),),)}
        fail(cert, 'www.pyth?n.org'.encode("idna").decode("ascii"))
        fail(cert, 'www1.pyth?n.org'.encode("idna").decode("ascii"))
...
class ThreadedTests(unittest.TestCase):
    ...
    def test_check_hostname_idn(self):
        ...
        idn_hostnames = [
            ...
            ('k?nigsg??chen.idna2003.pythontest.net',
            ...
            # ('k?nigsg??chen.idna2008.pythontest.net',
