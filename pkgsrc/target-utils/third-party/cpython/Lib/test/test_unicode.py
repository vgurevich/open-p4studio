...
class UnicodeTest(string_tests.CommonTest,
    ...
    def test_casefold(self):
        ...
        self.assertEqual('hELlo'.casefold(), 'hello')
        self.assertEqual('?'.casefold(), 'ss')
        self.assertEqual('?'.casefold(), 'fi')
    ...
    def test_capitalize(self):
        ...
        self.assertEqual('?nnish'.capitalize(), 'Finnish')
    ...
    def test_title(self):
        ...
        self.assertEqual('?NNISH'.title(), 'Finnish')
