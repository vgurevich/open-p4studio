...
#ifndef __REGISTER_INCLUDES_MIR_BUF_REGS_COAL_CTRL0_MUTABLE_H__
#define __REGISTER_INCLUDES_MIR_BUF_REGS_COAL_CTRL0_MUTABLE_H__
...
class MirBufRegsCoalCtrl0Mutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  MirBufRegsCoalCtrl0Mutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mir_buf_regs_coal_desc_grp), 4, true, write_callback, read_callback, std::string("MirBufRegsCoalCtrl0Mutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mir_buf_regs_coal_desc_grp))
    {
    }
  MirBufRegsCoalCtrl0Mutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "MirBufRegsCoalCtrl0Mutable")
    {
    }
public:
  ...
  void coal_ena(const uint8_t &v) { coal_ena_=v; }
  ...
  void coal_pkthdr_length(const uint8_t &v) { coal_pkthdr_length_=v; }
  ...
  void coal_timeout(const uint8_t &v) { coal_timeout_=v; }
  ...
  void coal_minpkt_size(const uint16_t &v) { coal_minpkt_size_=v; }
  ...
  void coal_vid(const uint8_t &v) { coal_vid_=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("MirBufRegsCoalCtrl0Mutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_MIR_BUF_REGS_COAL_CTRL0_MUTABLE_H__
