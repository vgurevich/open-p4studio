...
#ifndef __REGISTER_INCLUDES_ADR_DIST_IDLETIME_ADR_OXBAR_CTL_ARRAY_H__
#define __REGISTER_INCLUDES_ADR_DIST_IDLETIME_ADR_OXBAR_CTL_ARRAY_H__
...
class AdrDistIdletimeAdrOxbarCtlArray : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  AdrDistIdletimeAdrOxbarCtlArray(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap), 4 * ArraySize(index_pipe_addrmap, index_mau_addrmap, -1), false, write_callback, read_callback, std::string("AdrDistIdletimeAdrOxbarCtlArray")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap)),
...
public:
  uint32_t &adr_dist_idletime_adr_oxbar_ctl(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    return array[a0].adr_dist_idletime_adr_oxbar_ctl();
  }
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("AdrDistIdletimeAdrOxbarCtlArray") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
private:
  std::vector<AdrDistIdletimeAdrOxbarCtl> array;
  uint32_t size0_;
...
#endif // __REGISTER_INCLUDES_ADR_DIST_IDLETIME_ADR_OXBAR_CTL_ARRAY_H__
