...
#ifndef __REGISTER_INCLUDES_ADR_DIST_IDLETIME_ADR_OXBAR_CTL_ARRAY_MUTABLE_H__
#define __REGISTER_INCLUDES_ADR_DIST_IDLETIME_ADR_OXBAR_CTL_ARRAY_MUTABLE_H__
...
class AdrDistIdletimeAdrOxbarCtlArrayMutable : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  AdrDistIdletimeAdrOxbarCtlArrayMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap), 4 * ArraySize(index_pipe_addrmap, index_mau_addrmap, -1), true, write_callback, read_callback, std::string("AdrDistIdletimeAdrOxbarCtlArrayMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap)),
...
public:
  ...
  void adr_dist_idletime_adr_oxbar_ctl(uint32_t a0,const uint32_t &v) 
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    array[a0].adr_dist_idletime_adr_oxbar_ctl(v);
  }
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("AdrDistIdletimeAdrOxbarCtlArrayMutable") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
private:
  std::vector<AdrDistIdletimeAdrOxbarCtlMutable> array;
  uint32_t size0_;
...
#endif // __REGISTER_INCLUDES_ADR_DIST_IDLETIME_ADR_OXBAR_CTL_ARRAY_MUTABLE_H__
