...
#ifndef __REGISTER_INCLUDES_CAA_BANK_CTRL_R_ARRAY_H__
#define __REGISTER_INCLUDES_CAA_BANK_CTRL_R_ARRAY_H__
...
class CaaBankCtrlRArray : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  CaaBankCtrlRArray(
      int chipNumber, RegisterArrayCallback& write_callback = 0, RegisterArrayCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 4 * ArraySize(-1), false, write_callback, read_callback, std::string("CaaBankCtrlRArray")),
...
public:
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("CaaBankCtrlRArray") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
#endif // __REGISTER_INCLUDES_CAA_BANK_CTRL_R_ARRAY_H__
