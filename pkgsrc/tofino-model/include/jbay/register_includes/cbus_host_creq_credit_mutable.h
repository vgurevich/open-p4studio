...
#ifndef __REGISTER_INCLUDES_CBUS_HOST_CREQ_CREDIT_MUTABLE_H__
#define __REGISTER_INCLUDES_CBUS_HOST_CREQ_CREDIT_MUTABLE_H__
...
class CbusHostCreqCreditMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  CbusHostCreqCreditMutable(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 12, true, write_callback, read_callback, std::string("CbusHostCreqCreditMutable"))
    {
    }
  CbusHostCreqCreditMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "CbusHostCreqCreditMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("CbusHostCreqCreditMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_CBUS_HOST_CREQ_CREDIT_MUTABLE_H__
