...
#ifndef __REGISTER_INCLUDES_CBUS_INT_STAT0_MUTABLE_H__
#define __REGISTER_INCLUDES_CBUS_INT_STAT0_MUTABLE_H__
...
class CbusIntStat0Mutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  CbusIntStat0Mutable(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 4, true, write_callback, read_callback, std::string("CbusIntStat0Mutable"))
    {
    }
  CbusIntStat0Mutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "CbusIntStat0Mutable")
    {
    }
public:
  ...
  void wl0_tx_dr_empty(const uint8_t &v) { wl0_tx_dr_empty_=v; }
  ...
  void wl0_tx_dr_full(const uint8_t &v) { wl0_tx_dr_full_=v; }
  ...
  void wl0_cpl_dr_empty(const uint8_t &v) { wl0_cpl_dr_empty_=v; }
  ...
  void wl0_cpl_dr_full(const uint8_t &v) { wl0_cpl_dr_full_=v; }
  ...
  void wl1_tx_dr_empty(const uint8_t &v) { wl1_tx_dr_empty_=v; }
  ...
  void wl1_tx_dr_full(const uint8_t &v) { wl1_tx_dr_full_=v; }
  ...
  void wl1_cpl_dr_empty(const uint8_t &v) { wl1_cpl_dr_empty_=v; }
  ...
  void wl1_cpl_dr_full(const uint8_t &v) { wl1_cpl_dr_full_=v; }
  ...
  void rb0_tx_dr_empty(const uint8_t &v) { rb0_tx_dr_empty_=v; }
  ...
  void rb0_tx_dr_full(const uint8_t &v) { rb0_tx_dr_full_=v; }
  ...
  void rb0_cpl_dr_empty(const uint8_t &v) { rb0_cpl_dr_empty_=v; }
  ...
  void rb0_cpl_dr_full(const uint8_t &v) { rb0_cpl_dr_full_=v; }
  ...
  void rb1_tx_dr_empty(const uint8_t &v) { rb1_tx_dr_empty_=v; }
  ...
  void rb1_tx_dr_full(const uint8_t &v) { rb1_tx_dr_full_=v; }
  ...
  void rb1_cpl_dr_empty(const uint8_t &v) { rb1_cpl_dr_empty_=v; }
  ...
  void rb1_cpl_dr_full(const uint8_t &v) { rb1_cpl_dr_full_=v; }
  ...
  void wl0_tx_dr_rd_err(const uint8_t &v) { wl0_tx_dr_rd_err_=v; }
  ...
  void wl1_tx_dr_rd_err(const uint8_t &v) { wl1_tx_dr_rd_err_=v; }
  ...
  void rb0_tx_dr_rd_err(const uint8_t &v) { rb0_tx_dr_rd_err_=v; }
  ...
  void rb1_tx_dr_rd_err(const uint8_t &v) { rb1_tx_dr_rd_err_=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("CbusIntStat0Mutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_CBUS_INT_STAT0_MUTABLE_H__
