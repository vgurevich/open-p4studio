...
public:
  ChnlCtrlMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_ipb_prsr4_reg, selector_ipb_rspec), 8, true, write_callback, read_callback, std::string("ChnlCtrlMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_ipb_prsr4_reg) + "," + boost::lexical_cast<std::string>(selector_ipb_rspec))
    {
    }
  ChnlCtrlMutable(
...
public:
  ...
  void allow_tm_pfc(const uint8_t &v) { allow_tm_pfc_=v; }
  ...
  void allow_tm_xoff(const uint8_t &v) { allow_tm_xoff_=v; }
  ...
  void overwrite_meta1(const uint8_t &v) { overwrite_meta1_=v; }
  ...
  void en_clean_drop(const uint8_t &v) { en_clean_drop_=v; }
  ...
  void en_resubmit_prio_drop(const uint8_t &v) { en_resubmit_prio_drop_=v; }
  ...
  void init_dprsr_barrel_credit(const uint8_t &v) { init_dprsr_barrel_credit_=v; }
  ...
  void mchn_dprsr_port(const uint8_t &v) { mchn_dprsr_port_=v; }
