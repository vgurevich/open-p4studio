...
#ifndef __REGISTER_INCLUDES_CHNL_STAT_H__
#define __REGISTER_INCLUDES_CHNL_STAT_H__
...
class ChnlStat : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum IpbRspecEnum {
    kChan0Group,
    kChan1Group,
...
public:
  ChnlStat(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_ipb_prsr4_reg, selector_ipb_rspec), 4, false, write_callback, read_callback, std::string("ChnlStat")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_ipb_prsr4_reg) + "," + boost::lexical_cast<std::string>(selector_ipb_rspec))
    {
    }
  ChnlStat(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "ChnlStat")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("ChnlStat") + ":\n";
...
#endif // __REGISTER_INCLUDES_CHNL_STAT_H__
