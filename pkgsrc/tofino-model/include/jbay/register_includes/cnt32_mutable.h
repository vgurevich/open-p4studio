...
#ifndef __REGISTER_INCLUDES_CNT32_MUTABLE_H__
#define __REGISTER_INCLUDES_CNT32_MUTABLE_H__
...
class Cnt32Mutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum PipeRegEnum {
    kWacRegCtrCaaFull,
...
public:
  Cnt32Mutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_tm_wac_pipe_rspec, selector_pipe_reg), 4, true, write_callback, read_callback, std::string("Cnt32Mutable")+":"+boost::lexical_cast<std::string>(index_tm_wac_pipe_rspec) + "," + boost::lexical_cast<std::string>(selector_pipe_reg))
    {
    }
  Cnt32Mutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "Cnt32Mutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("Cnt32Mutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_CNT32_MUTABLE_H__
