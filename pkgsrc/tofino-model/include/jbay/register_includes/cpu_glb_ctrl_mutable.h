...
#ifndef __REGISTER_INCLUDES_CPU_GLB_CTRL_MUTABLE_H__
#define __REGISTER_INCLUDES_CPU_GLB_CTRL_MUTABLE_H__
...
class CpuGlbCtrlMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  CpuGlbCtrlMutable(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 4, true, write_callback, read_callback, std::string("CpuGlbCtrlMutable"))
    {
    }
  CpuGlbCtrlMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "CpuGlbCtrlMutable")
    {
    }
public:
  ...
  void cpu_max_dw(const uint16_t &v) { cpu_max_dw_=v; }
  ...
  void cpu_wr_inv_order(const uint8_t &v) { cpu_wr_inv_order_=v; }
  ...
  void cpu_rd_inv_order(const uint8_t &v) { cpu_rd_inv_order_=v; }
  ...
  void cpu_disable_mot(const uint8_t &v) { cpu_disable_mot_=v; }
  ...
  void ena_reord(const uint8_t &v) { ena_reord_=v; }
  ...
  void ena_pois(const uint8_t &v) { ena_pois_=v; }
  ...
  void data_pois(const uint8_t &v) { data_pois_=v; }
  ...
  void cpu_rsvd(const uint16_t &v) { cpu_rsvd_=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("CpuGlbCtrlMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    int offset=0;
    offset += 0x30; // to get to cpu_glb_ctrl
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_CPU_GLB_CTRL_MUTABLE_H__
