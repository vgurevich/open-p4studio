...
#ifndef __REGISTER_INCLUDES_DEF_METER_SBE_ERRLOG_ARRAY_MUTABLE_H__
#define __REGISTER_INCLUDES_DEF_METER_SBE_ERRLOG_ARRAY_MUTABLE_H__
...
class DefMeterSbeErrlogArrayMutable : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  DefMeterSbeErrlogArrayMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap), 4 * ArraySize(index_pipe_addrmap, index_mau_addrmap, -1), true, write_callback, read_callback, std::string("DefMeterSbeErrlogArrayMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap)),
...
public:
  ...
  uint8_t def_sbe_errlog_addr(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    return array[a0].def_sbe_errlog_addr();
  }
  void def_sbe_errlog_addr(uint32_t a0,const uint8_t &v) 
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    array[a0].def_sbe_errlog_addr(v);
  }
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("DefMeterSbeErrlogArrayMutable") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
private:
  std::vector<DefMeterSbeErrlogMutable> array;
  uint32_t size0_;
...
private:
  static int StartOffset(
    ...
    offset += 0x750; // to get to def_meter_sbe_errlog
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_DEF_METER_SBE_ERRLOG_ARRAY_MUTABLE_H__
