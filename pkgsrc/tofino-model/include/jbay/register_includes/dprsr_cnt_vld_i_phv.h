...
#ifndef __REGISTER_INCLUDES_DPRSR_CNT_VLD_I_PHV_H__
#define __REGISTER_INCLUDES_DPRSR_CNT_VLD_I_PHV_H__
...
class DprsrCntVldIPhv : public model_core::RegisterBlock<RegisterCallback> {
public:
...
public:
  DprsrCntVldIPhv(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, selector_dprsr_ipp_regs), 8, false, write_callback, read_callback, std::string("DprsrCntVldIPhv")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(selector_dprsr_ipp_regs))
    {
    }
  DprsrCntVldIPhv(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "DprsrCntVldIPhv")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("DprsrCntVldIPhv") + ":\n";
...
#endif // __REGISTER_INCLUDES_DPRSR_CNT_VLD_I_PHV_H__
