...
#ifndef __REGISTER_INCLUDES_DPRSR_HE_REGS_H_INTR_INJ_H__
#define __REGISTER_INCLUDES_DPRSR_HE_REGS_H_INTR_INJ_H__
...
class DprsrHeRegsHIntrInj : public model_core::RegisterBlock<RegisterCallback> {
public:
  DprsrHeRegsHIntrInj(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_dprsr_ho_e), 4, false, write_callback, read_callback, std::string("DprsrHeRegsHIntrInj")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_dprsr_ho_e))
    {
    }
  DprsrHeRegsHIntrInj(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "DprsrHeRegsHIntrInj")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("DprsrHeRegsHIntrInj") + ":\n";
...
#endif // __REGISTER_INCLUDES_DPRSR_HE_REGS_H_INTR_INJ_H__
