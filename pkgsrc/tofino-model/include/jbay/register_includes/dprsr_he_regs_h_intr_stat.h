...
#ifndef __REGISTER_INCLUDES_DPRSR_HE_REGS_H_INTR_STAT_H__
#define __REGISTER_INCLUDES_DPRSR_HE_REGS_H_INTR_STAT_H__
...
class DprsrHeRegsHIntrStat : public model_core::RegisterBlock<RegisterCallback> {
public:
  DprsrHeRegsHIntrStat(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_dprsr_ho_e), 4, false, write_callback, read_callback, std::string("DprsrHeRegsHIntrStat")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_dprsr_ho_e))
    {
    }
  DprsrHeRegsHIntrStat(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "DprsrHeRegsHIntrStat")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("DprsrHeRegsHIntrStat") + ":\n";
...
#endif // __REGISTER_INCLUDES_DPRSR_HE_REGS_H_INTR_STAT_H__
