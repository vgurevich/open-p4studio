...
#include "dprsr_h_fd_compress_map.h"
#include "dprsr_h_mirror_tbl_map.h"
...
public:
  DprsrHiMem(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, selector_dprsr_reg_rspec, index_dprsr_ho_e), 3072, false, write_callback, read_callback, std::string("DprsrHiMem")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(selector_dprsr_reg_rspec) + "," + boost::lexical_cast<std::string>(index_dprsr_ho_e))
    {
    }
  DprsrHiMem(
...
public:
  DprsrHFdCompressMap &fd_compress() { return fd_compress_; }
  DprsrHMirrorTblMap &mirr_hdr_tbl() { return mirr_hdr_tbl_; }
...
private:
  DprsrHFdCompressMap fd_compress_;
  DprsrHMirrorTblMap mirr_hdr_tbl_;
private:
