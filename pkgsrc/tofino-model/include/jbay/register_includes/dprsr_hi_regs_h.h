...
#ifndef __REGISTER_INCLUDES_DPRSR_HI_REGS_H_H__
#define __REGISTER_INCLUDES_DPRSR_HI_REGS_H_H__
...
#include "dprsr_hdr_cred_dbg_reload_r.h"
#include "dprsr_hdr_cred_max_cfg_r.h"
#include "dprsr_hdr_cred_sel_r.h"
#include "dprsr_hdr_cred_thresh_cfg_r.h"
#include "dprsr_hdr_creds_r.h"
#include "dprsr_hdr_status_r.h"
#include "dprsr_hdr_xbar_const_defs_r.h"
#include "dprsr_hi_regs_h_cfg48_data.h"
#include "dprsr_hi_regs_h_cfg48_mask.h"
#include "dprsr_hi_regs_h_intr.h"
#include "dprsr_hi_regs_h_ipkt_mac0_ecc_ctrl.h"
#include "dprsr_hi_regs_h_ipkt_mac0_mbe_err_log.h"
#include "dprsr_hi_regs_h_ipkt_mac0_sbe_err_log.h"
#include "dprsr_hi_regs_h_ipkt_mac1_ecc_ctrl.h"
#include "dprsr_hi_regs_h_ipkt_mac1_mbe_err_log.h"
#include "dprsr_hi_regs_h_ipkt_mac1_sbe_err_log.h"
#include "dprsr_hi_regs_h_ipkt_mac2_ecc_ctrl.h"
#include "dprsr_hi_regs_h_ipkt_mac2_mbe_err_log.h"
#include "dprsr_hi_regs_h_ipkt_mac2_sbe_err_log.h"
#include "dprsr_hi_regs_h_max_src_chunks.h"
#include "dprsr_hi_regs_h_mirrtbl_ecc_ctrl.h"
#include "dprsr_hi_regs_h_mirrtbl_mbe_err_log.h"
#include "dprsr_hi_regs_h_mirrtbl_sbe_err_log.h"
#include "dprsr_mirr_timeout_r.h"
#include "dprsr_slice_lat_ctrl_r.h"
...
class DprsrHiRegsH : public model_core::RegisterBlock<RegisterCallback> {
public:
  DprsrHiRegsH(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_dprsr_ho_i), 260, false, write_callback, read_callback, std::string("DprsrHiRegsH")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_dprsr_ho_i))
    {
    }
  DprsrHiRegsH(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "DprsrHiRegsH")
    {
    }
public:
  ...
  FdWordClotSelInfoR &h_compress_clot_sel(int j0) { return h_compress_clot_sel_[j0]; }





  DprsrHdrXbarConstDefsR &h_hdr_xbar_const() { return h_hdr_xbar_const_; }
  ...
  DprsrMirrTimeoutR &h_mirr_hdr_tbl() { return h_mirr_hdr_tbl_; }





  DprsrHdrCredThreshCfgR &h_cred_thresh() { return h_cred_thresh_; }
  ...
  DprsrHdrCredMaxCfgR &h_cred_max() { return h_cred_max_; }
  ...
  DprsrHdrCredSelR &h_cred_dbg_chan_sel() { return h_cred_dbg_chan_sel_; }
  ...
  DprsrHdrCredsR &h_cred_dbg_credits() { return h_cred_dbg_credits_; }
  ...
  DprsrHdrCredDbgReloadR &h_cred_dbg_reload() { return h_cred_dbg_reload_; }





  DprsrHiRegsHMirrtblSbeErrLog &h_mirrtbl_sbe_err_log() { return h_mirrtbl_sbe_err_log_; }





  DprsrHiRegsHMirrtblMbeErrLog &h_mirrtbl_mbe_err_log() { return h_mirrtbl_mbe_err_log_; }





  DprsrHiRegsHIpktMac0SbeErrLog &h_ipkt_mac0_sbe_err_log() { return h_ipkt_mac0_sbe_err_log_; }





  DprsrHiRegsHIpktMac0MbeErrLog &h_ipkt_mac0_mbe_err_log() { return h_ipkt_mac0_mbe_err_log_; }





  DprsrHiRegsHIpktMac1SbeErrLog &h_ipkt_mac1_sbe_err_log() { return h_ipkt_mac1_sbe_err_log_; }





  DprsrHiRegsHIpktMac1MbeErrLog &h_ipkt_mac1_mbe_err_log() { return h_ipkt_mac1_mbe_err_log_; }





  DprsrHiRegsHIpktMac2SbeErrLog &h_ipkt_mac2_sbe_err_log() { return h_ipkt_mac2_sbe_err_log_; }





  DprsrHiRegsHIpktMac2MbeErrLog &h_ipkt_mac2_mbe_err_log() { return h_ipkt_mac2_mbe_err_log_; }





  DprsrHiRegsHMirrtblEccCtrl &h_mirrtbl_ecc_ctrl() { return h_mirrtbl_ecc_ctrl_; }





  DprsrHiRegsHIpktMac0EccCtrl &h_ipkt_mac0_ecc_ctrl() { return h_ipkt_mac0_ecc_ctrl_; }





  DprsrHiRegsHIpktMac1EccCtrl &h_ipkt_mac1_ecc_ctrl() { return h_ipkt_mac1_ecc_ctrl_; }





  DprsrHiRegsHIpktMac2EccCtrl &h_ipkt_mac2_ecc_ctrl() { return h_ipkt_mac2_ecc_ctrl_; }
  ...
  DprsrHdrStatusR &h_hdr_status() { return h_hdr_status_; }
  ...
  DprsrSliceLatCtrlR &h_hdr_latency_ctrl() { return h_hdr_latency_ctrl_; }
  ...
  PpCtrCfg48R &h_cfg48(int j0) { return h_cfg48_[j0]; }
  ...
  DprsrHiRegsHCfg48Mask &h_cfg48_mask(int j0) { return h_cfg48_mask_[j0]; }
  ...
  DprsrHiRegsHCfg48Data &h_cfg48_data(int j0) { return h_cfg48_data_[j0]; }
  ...
  DprsrHiRegsHMaxSrcChunks &h_max_src_chunks() { return h_max_src_chunks_; }
  DprsrHiRegsHIntr &h_intr() { return h_intr_; }
...
private:
  std::array< FdWordClotSelInfoR, 16 > h_compress_clot_sel_;
  DprsrHdrXbarConstDefsR h_hdr_xbar_const_;
  DprsrMirrTimeoutR h_mirr_hdr_tbl_;
  DprsrHdrCredThreshCfgR h_cred_thresh_;
  DprsrHdrCredMaxCfgR h_cred_max_;
  DprsrHdrCredSelR h_cred_dbg_chan_sel_;
  DprsrHdrCredsR h_cred_dbg_credits_;
  DprsrHdrCredDbgReloadR h_cred_dbg_reload_;
  DprsrHiRegsHMirrtblSbeErrLog h_mirrtbl_sbe_err_log_;
  DprsrHiRegsHMirrtblMbeErrLog h_mirrtbl_mbe_err_log_;
  DprsrHiRegsHIpktMac0SbeErrLog h_ipkt_mac0_sbe_err_log_;
  DprsrHiRegsHIpktMac0MbeErrLog h_ipkt_mac0_mbe_err_log_;
  DprsrHiRegsHIpktMac1SbeErrLog h_ipkt_mac1_sbe_err_log_;
  DprsrHiRegsHIpktMac1MbeErrLog h_ipkt_mac1_mbe_err_log_;
  DprsrHiRegsHIpktMac2SbeErrLog h_ipkt_mac2_sbe_err_log_;
  DprsrHiRegsHIpktMac2MbeErrLog h_ipkt_mac2_mbe_err_log_;
  DprsrHiRegsHMirrtblEccCtrl h_mirrtbl_ecc_ctrl_;
  DprsrHiRegsHIpktMac0EccCtrl h_ipkt_mac0_ecc_ctrl_;
  DprsrHiRegsHIpktMac1EccCtrl h_ipkt_mac1_ecc_ctrl_;
  DprsrHiRegsHIpktMac2EccCtrl h_ipkt_mac2_ecc_ctrl_;
  DprsrHdrStatusR h_hdr_status_;
  DprsrSliceLatCtrlR h_hdr_latency_ctrl_;
  std::array< PpCtrCfg48R, 2 > h_cfg48_;
  std::array< DprsrHiRegsHCfg48Mask, 2 > h_cfg48_mask_;
  std::array< DprsrHiRegsHCfg48Data, 2 > h_cfg48_data_;
  DprsrHiRegsHMaxSrcChunks h_max_src_chunks_;
  DprsrHiRegsHIntr h_intr_;
private:
...
#endif // __REGISTER_INCLUDES_DPRSR_HI_REGS_H_H__
