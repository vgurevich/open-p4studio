...
#ifndef __REGISTER_INCLUDES_DPRSR_HI_REGS_H_INTR_EN0_H__
#define __REGISTER_INCLUDES_DPRSR_HI_REGS_H_INTR_EN0_H__
...
class DprsrHiRegsHIntrEn0 : public model_core::RegisterBlock<RegisterCallback> {
public:
  DprsrHiRegsHIntrEn0(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_dprsr_ho_i), 4, false, write_callback, read_callback, std::string("DprsrHiRegsHIntrEn0")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_dprsr_ho_i))
    {
    }
  DprsrHiRegsHIntrEn0(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "DprsrHiRegsHIntrEn0")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("DprsrHiRegsHIntrEn0") + ":\n";
...
#endif // __REGISTER_INCLUDES_DPRSR_HI_REGS_H_INTR_EN0_H__
