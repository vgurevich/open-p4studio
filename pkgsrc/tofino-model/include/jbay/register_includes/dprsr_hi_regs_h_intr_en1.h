...
#ifndef __REGISTER_INCLUDES_DPRSR_HI_REGS_H_INTR_EN1_H__
#define __REGISTER_INCLUDES_DPRSR_HI_REGS_H_INTR_EN1_H__
...
class DprsrHiRegsHIntrEn1 : public model_core::RegisterBlock<RegisterCallback> {
public:
  DprsrHiRegsHIntrEn1(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_dprsr_ho_i), 4, false, write_callback, read_callback, std::string("DprsrHiRegsHIntrEn1")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_dprsr_ho_i))
    {
    }
  DprsrHiRegsHIntrEn1(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "DprsrHiRegsHIntrEn1")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("DprsrHiRegsHIntrEn1") + ":\n";
...
#endif // __REGISTER_INCLUDES_DPRSR_HI_REGS_H_INTR_EN1_H__
