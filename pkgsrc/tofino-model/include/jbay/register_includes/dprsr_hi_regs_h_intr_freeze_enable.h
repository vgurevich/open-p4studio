...
#ifndef __REGISTER_INCLUDES_DPRSR_HI_REGS_H_INTR_FREEZE_ENABLE_H__
#define __REGISTER_INCLUDES_DPRSR_HI_REGS_H_INTR_FREEZE_ENABLE_H__
...
class DprsrHiRegsHIntrFreezeEnable : public model_core::RegisterBlock<RegisterCallback> {
public:
  DprsrHiRegsHIntrFreezeEnable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_dprsr_ho_i), 4, false, write_callback, read_callback, std::string("DprsrHiRegsHIntrFreezeEnable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_dprsr_ho_i))
    {
    }
  DprsrHiRegsHIntrFreezeEnable(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "DprsrHiRegsHIntrFreezeEnable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("DprsrHiRegsHIntrFreezeEnable") + ":\n";
...
#endif // __REGISTER_INCLUDES_DPRSR_HI_REGS_H_INTR_FREEZE_ENABLE_H__
