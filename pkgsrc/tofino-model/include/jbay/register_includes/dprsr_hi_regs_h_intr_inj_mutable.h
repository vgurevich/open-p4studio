...
#ifndef __REGISTER_INCLUDES_DPRSR_HI_REGS_H_INTR_INJ_MUTABLE_H__
#define __REGISTER_INCLUDES_DPRSR_HI_REGS_H_INTR_INJ_MUTABLE_H__
...
class DprsrHiRegsHIntrInjMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  DprsrHiRegsHIntrInjMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_dprsr_ho_i), 4, true, write_callback, read_callback, std::string("DprsrHiRegsHIntrInjMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_dprsr_ho_i))
    {
    }
  DprsrHiRegsHIntrInjMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "DprsrHiRegsHIntrInjMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("DprsrHiRegsHIntrInjMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x8c; // to get to h_intr_inj
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_DPRSR_HI_REGS_H_INTR_INJ_MUTABLE_H__
