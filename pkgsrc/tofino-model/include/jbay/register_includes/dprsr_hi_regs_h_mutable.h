...
#ifndef __REGISTER_INCLUDES_DPRSR_HI_REGS_H_MUTABLE_H__
#define __REGISTER_INCLUDES_DPRSR_HI_REGS_H_MUTABLE_H__
...
#include "dprsr_hi_regs_h_cfg48_data_mutable.h"
#include "dprsr_hi_regs_h_cfg48_mask_mutable.h"
#include "dprsr_hi_regs_h_intr_mutable.h"
#include "dprsr_hi_regs_h_ipkt_mac0_ecc_ctrl_mutable.h"
#include "dprsr_hi_regs_h_ipkt_mac0_mbe_err_log_mutable.h"
#include "dprsr_hi_regs_h_ipkt_mac0_sbe_err_log_mutable.h"
#include "dprsr_hi_regs_h_ipkt_mac1_ecc_ctrl_mutable.h"
#include "dprsr_hi_regs_h_ipkt_mac1_mbe_err_log_mutable.h"
#include "dprsr_hi_regs_h_ipkt_mac1_sbe_err_log_mutable.h"
#include "dprsr_hi_regs_h_ipkt_mac2_ecc_ctrl_mutable.h"
#include "dprsr_hi_regs_h_ipkt_mac2_mbe_err_log_mutable.h"
#include "dprsr_hi_regs_h_ipkt_mac2_sbe_err_log_mutable.h"
#include "dprsr_hi_regs_h_max_src_chunks_mutable.h"
#include "dprsr_hi_regs_h_mirrtbl_ecc_ctrl_mutable.h"
#include "dprsr_hi_regs_h_mirrtbl_mbe_err_log_mutable.h"
#include "dprsr_hi_regs_h_mirrtbl_sbe_err_log_mutable.h"
...
class DprsrHiRegsHMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  DprsrHiRegsHMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_dprsr_ho_i), 260, true, write_callback, read_callback, std::string("DprsrHiRegsHMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_dprsr_ho_i))
    {
    }
  DprsrHiRegsHMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "DprsrHiRegsHMutable")
    {
    }
public:
  ...
  DprsrHiRegsHMirrtblSbeErrLogMutable &h_mirrtbl_sbe_err_log() { return h_mirrtbl_sbe_err_log_; }





  DprsrHiRegsHMirrtblMbeErrLogMutable &h_mirrtbl_mbe_err_log() { return h_mirrtbl_mbe_err_log_; }





  DprsrHiRegsHIpktMac0SbeErrLogMutable &h_ipkt_mac0_sbe_err_log() { return h_ipkt_mac0_sbe_err_log_; }





  DprsrHiRegsHIpktMac0MbeErrLogMutable &h_ipkt_mac0_mbe_err_log() { return h_ipkt_mac0_mbe_err_log_; }





  DprsrHiRegsHIpktMac1SbeErrLogMutable &h_ipkt_mac1_sbe_err_log() { return h_ipkt_mac1_sbe_err_log_; }





  DprsrHiRegsHIpktMac1MbeErrLogMutable &h_ipkt_mac1_mbe_err_log() { return h_ipkt_mac1_mbe_err_log_; }





  DprsrHiRegsHIpktMac2SbeErrLogMutable &h_ipkt_mac2_sbe_err_log() { return h_ipkt_mac2_sbe_err_log_; }





  DprsrHiRegsHIpktMac2MbeErrLogMutable &h_ipkt_mac2_mbe_err_log() { return h_ipkt_mac2_mbe_err_log_; }





  DprsrHiRegsHMirrtblEccCtrlMutable &h_mirrtbl_ecc_ctrl() { return h_mirrtbl_ecc_ctrl_; }





  DprsrHiRegsHIpktMac0EccCtrlMutable &h_ipkt_mac0_ecc_ctrl() { return h_ipkt_mac0_ecc_ctrl_; }





  DprsrHiRegsHIpktMac1EccCtrlMutable &h_ipkt_mac1_ecc_ctrl() { return h_ipkt_mac1_ecc_ctrl_; }





  DprsrHiRegsHIpktMac2EccCtrlMutable &h_ipkt_mac2_ecc_ctrl() { return h_ipkt_mac2_ecc_ctrl_; }
  ...
  DprsrHiRegsHCfg48MaskMutable &h_cfg48_mask(int j0) { return h_cfg48_mask_[j0]; }
  ...
  DprsrHiRegsHCfg48DataMutable &h_cfg48_data(int j0) { return h_cfg48_data_[j0]; }
  ...
  DprsrHiRegsHMaxSrcChunksMutable &h_max_src_chunks() { return h_max_src_chunks_; }
  DprsrHiRegsHIntrMutable &h_intr() { return h_intr_; }
...
private:
  ...
  DprsrHiRegsHMirrtblSbeErrLogMutable h_mirrtbl_sbe_err_log_;
  DprsrHiRegsHMirrtblMbeErrLogMutable h_mirrtbl_mbe_err_log_;
  DprsrHiRegsHIpktMac0SbeErrLogMutable h_ipkt_mac0_sbe_err_log_;
  DprsrHiRegsHIpktMac0MbeErrLogMutable h_ipkt_mac0_mbe_err_log_;
  DprsrHiRegsHIpktMac1SbeErrLogMutable h_ipkt_mac1_sbe_err_log_;
  DprsrHiRegsHIpktMac1MbeErrLogMutable h_ipkt_mac1_mbe_err_log_;
  DprsrHiRegsHIpktMac2SbeErrLogMutable h_ipkt_mac2_sbe_err_log_;
  DprsrHiRegsHIpktMac2MbeErrLogMutable h_ipkt_mac2_mbe_err_log_;
  DprsrHiRegsHMirrtblEccCtrlMutable h_mirrtbl_ecc_ctrl_;
  DprsrHiRegsHIpktMac0EccCtrlMutable h_ipkt_mac0_ecc_ctrl_;
  DprsrHiRegsHIpktMac1EccCtrlMutable h_ipkt_mac1_ecc_ctrl_;
  DprsrHiRegsHIpktMac2EccCtrlMutable h_ipkt_mac2_ecc_ctrl_;
  DprsrHdrStatusRMutable h_hdr_status_;
  DprsrSliceLatCtrlRMutable h_hdr_latency_ctrl_;
  std::array< PpCtrCfg48RMutable, 2 > h_cfg48_;
  std::array< DprsrHiRegsHCfg48MaskMutable, 2 > h_cfg48_mask_;
  std::array< DprsrHiRegsHCfg48DataMutable, 2 > h_cfg48_data_;
  DprsrHiRegsHMaxSrcChunksMutable h_max_src_chunks_;
  DprsrHiRegsHIntrMutable h_intr_;
private:
...
#endif // __REGISTER_INCLUDES_DPRSR_HI_REGS_H_MUTABLE_H__
