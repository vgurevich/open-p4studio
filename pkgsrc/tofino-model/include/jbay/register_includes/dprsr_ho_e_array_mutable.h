...
#ifndef __REGISTER_INCLUDES_DPRSR_HO_E_ARRAY_MUTABLE_H__
#define __REGISTER_INCLUDES_DPRSR_HO_E_ARRAY_MUTABLE_H__
...
#include "dprsr_he_regs_mutable.h"
...
class DprsrHoEArrayMutable : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  DprsrHoEArrayMutable(
      int chipNumber, int index_pipe_addrmap, RegisterArrayCallback& write_callback = 0, RegisterArrayCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 8192 * ArraySize(index_pipe_addrmap, -1), true, write_callback, read_callback, std::string("DprsrHoEArrayMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap)),
...
public:
  DprsrHiMemMutable &hem(uint32_t a0)
  {
  ...
  DprsrHeRegsMutable &her(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    return array[a0].her();
  }
  ...
  DprsrOutEgrMutable &out_egr(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    return array[a0].out_egr();
  }
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("DprsrHoEArrayMutable") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
private:
  std::vector<DprsrHoEMutable> array;
  uint32_t size0_;
...
#endif // __REGISTER_INCLUDES_DPRSR_HO_E_ARRAY_MUTABLE_H__
