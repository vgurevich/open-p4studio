...
#ifndef __REGISTER_INCLUDES_DPRSR_IC_REGS_INTR_B_INJ_MUTABLE_H__
#define __REGISTER_INCLUDES_DPRSR_IC_REGS_INTR_B_INJ_MUTABLE_H__
...
class DprsrIcRegsIntrBInjMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  DprsrIcRegsIntrBInjMutable(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 4, true, write_callback, read_callback, std::string("DprsrIcRegsIntrBInjMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  DprsrIcRegsIntrBInjMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "DprsrIcRegsIntrBInjMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("DprsrIcRegsIntrBInjMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x2bec; // to get to intr_b_inj
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_DPRSR_IC_REGS_INTR_B_INJ_MUTABLE_H__
