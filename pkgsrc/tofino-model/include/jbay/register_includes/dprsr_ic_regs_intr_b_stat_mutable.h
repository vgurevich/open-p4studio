...
#ifndef __REGISTER_INCLUDES_DPRSR_IC_REGS_INTR_B_STAT_MUTABLE_H__
#define __REGISTER_INCLUDES_DPRSR_IC_REGS_INTR_B_STAT_MUTABLE_H__
...
class DprsrIcRegsIntrBStatMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  DprsrIcRegsIntrBStatMutable(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 4, true, write_callback, read_callback, std::string("DprsrIcRegsIntrBStatMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  DprsrIcRegsIntrBStatMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "DprsrIcRegsIntrBStatMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("DprsrIcRegsIntrBStatMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x2be0; // to get to intr_b_stat
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_DPRSR_IC_REGS_INTR_B_STAT_MUTABLE_H__
