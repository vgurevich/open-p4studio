...
#ifndef __REGISTER_INCLUDES_DPRSR_IC_REGS_INTR_EN1_MUTABLE_H__
#define __REGISTER_INCLUDES_DPRSR_IC_REGS_INTR_EN1_MUTABLE_H__
...
class DprsrIcRegsIntrEn1Mutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  DprsrIcRegsIntrEn1Mutable(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 4, true, write_callback, read_callback, std::string("DprsrIcRegsIntrEn1Mutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  DprsrIcRegsIntrEn1Mutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "DprsrIcRegsIntrEn1Mutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("DprsrIcRegsIntrEn1Mutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x2b88; // to get to intr_en1
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_DPRSR_IC_REGS_INTR_EN1_MUTABLE_H__
