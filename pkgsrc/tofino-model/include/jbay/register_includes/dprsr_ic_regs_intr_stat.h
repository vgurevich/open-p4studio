...
#ifndef __REGISTER_INCLUDES_DPRSR_IC_REGS_INTR_STAT_H__
#define __REGISTER_INCLUDES_DPRSR_IC_REGS_INTR_STAT_H__
...
class DprsrIcRegsIntrStat : public model_core::RegisterBlock<RegisterCallback> {
public:
  DprsrIcRegsIntrStat(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 4, false, write_callback, read_callback, std::string("DprsrIcRegsIntrStat")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  DprsrIcRegsIntrStat(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "DprsrIcRegsIntrStat")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("DprsrIcRegsIntrStat") + ":\n";
...
#endif // __REGISTER_INCLUDES_DPRSR_IC_REGS_INTR_STAT_H__
