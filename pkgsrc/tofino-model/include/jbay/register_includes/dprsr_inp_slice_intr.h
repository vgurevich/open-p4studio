...
#ifndef __REGISTER_INCLUDES_DPRSR_INP_SLICE_INTR_H__
#define __REGISTER_INCLUDES_DPRSR_INP_SLICE_INTR_H__
...
#include "dprsr_inp_slice_intr_en0.h"
#include "dprsr_inp_slice_intr_en1.h"
#include "dprsr_inp_slice_intr_freeze_enable.h"
#include "dprsr_inp_slice_intr_inj.h"
#include "dprsr_inp_slice_intr_stat.h"

namespace jbay {
  namespace register_classes {

class DprsrInpSliceIntr : public model_core::RegisterBlock<RegisterCallback> {
public:
  DprsrInpSliceIntr(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_dprsr_inp_slice), 20, false, write_callback, read_callback, std::string("DprsrInpSliceIntr")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_dprsr_inp_slice))
    {
    }
  DprsrInpSliceIntr(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "DprsrInpSliceIntr")
    {
    }
public:
  ...
  DprsrInpSliceIntrStat &intr_stat() { return intr_stat_; }
  ...
  DprsrInpSliceIntrEn0 &intr_en0() { return intr_en0_; }
  ...
  DprsrInpSliceIntrEn1 &intr_en1() { return intr_en1_; }
  ...
  DprsrInpSliceIntrInj &intr_inj() { return intr_inj_; }





  DprsrInpSliceIntrFreezeEnable &intr_freeze_enable() { return intr_freeze_enable_; }
...
private:
  DprsrInpSliceIntrStat intr_stat_;
  DprsrInpSliceIntrEn0 intr_en0_;
  DprsrInpSliceIntrEn1 intr_en1_;
  DprsrInpSliceIntrInj intr_inj_;
  DprsrInpSliceIntrFreezeEnable intr_freeze_enable_;
private:
...
#endif // __REGISTER_INCLUDES_DPRSR_INP_SLICE_INTR_H__
