...
#ifndef __REGISTER_INCLUDES_DPRSR_INP_SLICE_INTR_EN0_H__
#define __REGISTER_INCLUDES_DPRSR_INP_SLICE_INTR_EN0_H__
...
class DprsrInpSliceIntrEn0 : public model_core::RegisterBlock<RegisterCallback> {
public:
  DprsrInpSliceIntrEn0(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_dprsr_inp_slice), 4, false, write_callback, read_callback, std::string("DprsrInpSliceIntrEn0")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_dprsr_inp_slice))
    {
    }
  DprsrInpSliceIntrEn0(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "DprsrInpSliceIntrEn0")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("DprsrInpSliceIntrEn0") + ":\n";
...
#endif // __REGISTER_INCLUDES_DPRSR_INP_SLICE_INTR_EN0_H__
