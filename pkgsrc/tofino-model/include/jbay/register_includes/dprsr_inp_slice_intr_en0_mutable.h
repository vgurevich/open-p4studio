...
#ifndef __REGISTER_INCLUDES_DPRSR_INP_SLICE_INTR_EN0_MUTABLE_H__
#define __REGISTER_INCLUDES_DPRSR_INP_SLICE_INTR_EN0_MUTABLE_H__
...
class DprsrInpSliceIntrEn0Mutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  DprsrInpSliceIntrEn0Mutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_dprsr_inp_slice), 4, true, write_callback, read_callback, std::string("DprsrInpSliceIntrEn0Mutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_dprsr_inp_slice))
    {
    }
  DprsrInpSliceIntrEn0Mutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "DprsrInpSliceIntrEn0Mutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("DprsrInpSliceIntrEn0Mutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_DPRSR_INP_SLICE_INTR_EN0_MUTABLE_H__
