...
#ifndef __REGISTER_INCLUDES_DPRSR_INP_SLICE_INTR_STAT_MUTABLE_H__
#define __REGISTER_INCLUDES_DPRSR_INP_SLICE_INTR_STAT_MUTABLE_H__
...
class DprsrInpSliceIntrStatMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  DprsrInpSliceIntrStatMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_dprsr_inp_slice), 4, true, write_callback, read_callback, std::string("DprsrInpSliceIntrStatMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_dprsr_inp_slice))
    {
    }
  DprsrInpSliceIntrStatMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "DprsrInpSliceIntrStatMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("DprsrInpSliceIntrStatMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_DPRSR_INP_SLICE_INTR_STAT_MUTABLE_H__
