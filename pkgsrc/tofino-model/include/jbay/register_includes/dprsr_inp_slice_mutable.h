...
#ifndef __REGISTER_INCLUDES_DPRSR_INP_SLICE_MUTABLE_H__
#define __REGISTER_INCLUDES_DPRSR_INP_SLICE_MUTABLE_H__
...
class DprsrInpSliceMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  DprsrInpSliceMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_dprsr_inp_slice), 256, true, write_callback, read_callback, std::string("DprsrInpSliceMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_dprsr_inp_slice))
    {
    }
  DprsrInpSliceMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "DprsrInpSliceMutable")
    {
    }
public:
  ...
  DprsrInpSliceIMetaSbeErrLogMutable &i_meta_sbe_err_log() { return i_meta_sbe_err_log_; }





  DprsrInpSliceIMetaMbeErrLogMutable &i_meta_mbe_err_log() { return i_meta_mbe_err_log_; }





  DprsrInpSliceEMetaSbeErrLogMutable &e_meta_sbe_err_log() { return e_meta_sbe_err_log_; }





  DprsrInpSliceEMetaMbeErrLogMutable &e_meta_mbe_err_log() { return e_meta_mbe_err_log_; }





  DprsrInpSlicePhv32SbeErrLogMutable &phv32_sbe_err_log() { return phv32_sbe_err_log_; }





  DprsrInpSlicePhv32MbeErrLogMutable &phv32_mbe_err_log() { return phv32_mbe_err_log_; }





  DprsrInpSlicePhv16SbeErrLogMutable &phv16_sbe_err_log() { return phv16_sbe_err_log_; }





  DprsrInpSlicePhv16MbeErrLogMutable &phv16_mbe_err_log() { return phv16_mbe_err_log_; }





  DprsrInpSlicePhv8SbeErrLogMutable &phv8_sbe_err_log() { return phv8_sbe_err_log_; }





  DprsrInpSlicePhv8MbeErrLogMutable &phv8_mbe_err_log() { return phv8_mbe_err_log_; }





  DprsrInpSliceIVoltsSbeErrLogMutable &i_volts_sbe_err_log() { return i_volts_sbe_err_log_; }





  DprsrInpSliceIVoltsMbeErrLogMutable &i_volts_mbe_err_log() { return i_volts_mbe_err_log_; }





  DprsrInpSliceEVoltsSbeErrLogMutable &e_volts_sbe_err_log() { return e_volts_sbe_err_log_; }





  DprsrInpSliceEVoltsMbeErrLogMutable &e_volts_mbe_err_log() { return e_volts_mbe_err_log_; }





  DprsrInpSliceIFdinfoSbeErrLogMutable &i_fdinfo_sbe_err_log() { return i_fdinfo_sbe_err_log_; }





  DprsrInpSliceIFdinfoMbeErrLogMutable &i_fdinfo_mbe_err_log() { return i_fdinfo_mbe_err_log_; }





  DprsrInpSliceEFdinfoSbeErrLogMutable &e_fdinfo_sbe_err_log() { return e_fdinfo_sbe_err_log_; }





  DprsrInpSliceEFdinfoMbeErrLogMutable &e_fdinfo_mbe_err_log() { return e_fdinfo_mbe_err_log_; }





  DprsrInpSliceIMetaEccCtrlMutable &i_meta_ecc_ctrl() { return i_meta_ecc_ctrl_; }





  DprsrInpSliceEMetaEccCtrlMutable &e_meta_ecc_ctrl() { return e_meta_ecc_ctrl_; }





  DprsrInpSlicePhv32EccCtrlMutable &phv32_ecc_ctrl() { return phv32_ecc_ctrl_; }





  DprsrInpSlicePhv16EccCtrlMutable &phv16_ecc_ctrl() { return phv16_ecc_ctrl_; }





  DprsrInpSlicePhv8EccCtrlMutable &phv8_ecc_ctrl() { return phv8_ecc_ctrl_; }





  DprsrInpSliceIVoltsEccCtrlMutable &i_volts_ecc_ctrl() { return i_volts_ecc_ctrl_; }





  DprsrInpSliceEVoltsEccCtrlMutable &e_volts_ecc_ctrl() { return e_volts_ecc_ctrl_; }





  DprsrInpSliceIFdinfoEccCtrlMutable &i_fdinfo_ecc_ctrl() { return i_fdinfo_ecc_ctrl_; }





  DprsrInpSliceEFdinfoEccCtrlMutable &e_fdinfo_ecc_ctrl() { return e_fdinfo_ecc_ctrl_; }
  ...
  DprsrInpSliceCredFifoMutable &cred_fifo() { return cred_fifo_; }
  DprsrInpSliceIntrMutable &intr() { return intr_; }
...
private:
  DprsrInpSliceIMetaSbeErrLogMutable i_meta_sbe_err_log_;
  DprsrInpSliceIMetaMbeErrLogMutable i_meta_mbe_err_log_;
  DprsrInpSliceEMetaSbeErrLogMutable e_meta_sbe_err_log_;
  DprsrInpSliceEMetaMbeErrLogMutable e_meta_mbe_err_log_;
  DprsrInpSlicePhv32SbeErrLogMutable phv32_sbe_err_log_;
  DprsrInpSlicePhv32MbeErrLogMutable phv32_mbe_err_log_;
  DprsrInpSlicePhv16SbeErrLogMutable phv16_sbe_err_log_;
  DprsrInpSlicePhv16MbeErrLogMutable phv16_mbe_err_log_;
  DprsrInpSlicePhv8SbeErrLogMutable phv8_sbe_err_log_;
  DprsrInpSlicePhv8MbeErrLogMutable phv8_mbe_err_log_;
  DprsrInpSliceIVoltsSbeErrLogMutable i_volts_sbe_err_log_;
  DprsrInpSliceIVoltsMbeErrLogMutable i_volts_mbe_err_log_;
  DprsrInpSliceEVoltsSbeErrLogMutable e_volts_sbe_err_log_;
  DprsrInpSliceEVoltsMbeErrLogMutable e_volts_mbe_err_log_;
  DprsrInpSliceIFdinfoSbeErrLogMutable i_fdinfo_sbe_err_log_;
  DprsrInpSliceIFdinfoMbeErrLogMutable i_fdinfo_mbe_err_log_;
  DprsrInpSliceEFdinfoSbeErrLogMutable e_fdinfo_sbe_err_log_;
  DprsrInpSliceEFdinfoMbeErrLogMutable e_fdinfo_mbe_err_log_;
  DprsrInpSliceIMetaEccCtrlMutable i_meta_ecc_ctrl_;
  DprsrInpSliceEMetaEccCtrlMutable e_meta_ecc_ctrl_;
  DprsrInpSlicePhv32EccCtrlMutable phv32_ecc_ctrl_;
  DprsrInpSlicePhv16EccCtrlMutable phv16_ecc_ctrl_;
  DprsrInpSlicePhv8EccCtrlMutable phv8_ecc_ctrl_;
  DprsrInpSliceIVoltsEccCtrlMutable i_volts_ecc_ctrl_;
  DprsrInpSliceEVoltsEccCtrlMutable e_volts_ecc_ctrl_;
  DprsrInpSliceIFdinfoEccCtrlMutable i_fdinfo_ecc_ctrl_;
  DprsrInpSliceEFdinfoEccCtrlMutable e_fdinfo_ecc_ctrl_;
  DprsrInpSliceCredFifoMutable cred_fifo_;
  DprsrInpSliceIntrMutable intr_;
private:
...
#endif // __REGISTER_INCLUDES_DPRSR_INP_SLICE_MUTABLE_H__
