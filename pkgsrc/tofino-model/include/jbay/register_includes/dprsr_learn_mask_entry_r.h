...
#ifndef __REGISTER_INCLUDES_DPRSR_LEARN_MASK_ENTRY_R_H__
#define __REGISTER_INCLUDES_DPRSR_LEARN_MASK_ENTRY_R_H__
...
class DprsrLearnMaskEntryR : public model_core::RegisterBlock<RegisterCallback> {
public:
  DprsrLearnMaskEntryR(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_dprsr_learn_mask_entry_r), 48, false, write_callback, read_callback, std::string("DprsrLearnMaskEntryR")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_dprsr_learn_mask_entry_r))
    {
    }
  DprsrLearnMaskEntryR(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "DprsrLearnMaskEntryR")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("DprsrLearnMaskEntryR") + ":\n";
...
#endif // __REGISTER_INCLUDES_DPRSR_LEARN_MASK_ENTRY_R_H__
