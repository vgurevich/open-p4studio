...
#ifndef __REGISTER_INCLUDES_DPRSR_LEARN_MASK_ENTRY_R_ARRAY_MUTABLE_H__
#define __REGISTER_INCLUDES_DPRSR_LEARN_MASK_ENTRY_R_ARRAY_MUTABLE_H__
...
class DprsrLearnMaskEntryRArrayMutable : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  DprsrLearnMaskEntryRArrayMutable(
      int chipNumber, int index_pipe_addrmap, RegisterArrayCallback& write_callback = 0, RegisterArrayCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 48 * ArraySize(index_pipe_addrmap, -1), true, write_callback, read_callback, std::string("DprsrLearnMaskEntryRArrayMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap)),
...
public:
  ...
  uint32_t mask(uint32_t a0,int j0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    return array[a0].mask(j0);
  }
  void mask(uint32_t a0,int j0,const uint32_t &v) 
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    array[a0].mask(j0,v);
  }
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("DprsrLearnMaskEntryRArrayMutable") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
private:
  std::vector<DprsrLearnMaskEntryRMutable> array;
  uint32_t size0_;
...
#endif // __REGISTER_INCLUDES_DPRSR_LEARN_MASK_ENTRY_R_ARRAY_MUTABLE_H__
