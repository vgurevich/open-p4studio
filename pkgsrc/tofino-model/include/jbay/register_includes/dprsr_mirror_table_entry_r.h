...
public:
  DprsrMirrorTableEntryR(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, selector_dprsr_reg_rspec, index_dprsr_ho_e, index_dprsr_mirror_table_entry_r), 64, false, write_callback, read_callback, std::string("DprsrMirrorTableEntryR")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(selector_dprsr_reg_rspec) + "," + boost::lexical_cast<std::string>(index_dprsr_ho_e) + "," + boost::lexical_cast<std::string>(index_dprsr_mirror_table_entry_r))
    {
    }
  DprsrMirrorTableEntryR(
