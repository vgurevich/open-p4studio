...
#ifndef __REGISTER_INCLUDES_DPRSR_OUT_EGR_INTR_0_EN0_H__
#define __REGISTER_INCLUDES_DPRSR_OUT_EGR_INTR_0_EN0_H__
...
class DprsrOutEgrIntr_0En0 : public model_core::RegisterBlock<RegisterCallback> {
public:
  DprsrOutEgrIntr_0En0(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_dprsr_ho_e), 4, false, write_callback, read_callback, std::string("DprsrOutEgrIntr_0En0")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_dprsr_ho_e))
    {
    }
  DprsrOutEgrIntr_0En0(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "DprsrOutEgrIntr_0En0")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("DprsrOutEgrIntr_0En0") + ":\n";
...
#endif // __REGISTER_INCLUDES_DPRSR_OUT_EGR_INTR_0_EN0_H__
