...
#ifndef __REGISTER_INCLUDES_DPRSR_OUT_EGR_INTR_1_EN1_MUTABLE_H__
#define __REGISTER_INCLUDES_DPRSR_OUT_EGR_INTR_1_EN1_MUTABLE_H__
...
class DprsrOutEgrIntr_1En1Mutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  DprsrOutEgrIntr_1En1Mutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_dprsr_ho_e), 4, true, write_callback, read_callback, std::string("DprsrOutEgrIntr_1En1Mutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_dprsr_ho_e))
    {
    }
  DprsrOutEgrIntr_1En1Mutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "DprsrOutEgrIntr_1En1Mutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("DprsrOutEgrIntr_1En1Mutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x3c8; // to get to intr_1_en1
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_DPRSR_OUT_EGR_INTR_1_EN1_MUTABLE_H__
