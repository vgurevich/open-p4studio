...
#ifndef __REGISTER_INCLUDES_DPRSR_OUT_EGR_INTR_1_INJ_H__
#define __REGISTER_INCLUDES_DPRSR_OUT_EGR_INTR_1_INJ_H__
...
class DprsrOutEgrIntr_1Inj : public model_core::RegisterBlock<RegisterCallback> {
public:
  DprsrOutEgrIntr_1Inj(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_dprsr_ho_e), 4, false, write_callback, read_callback, std::string("DprsrOutEgrIntr_1Inj")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_dprsr_ho_e))
    {
    }
  DprsrOutEgrIntr_1Inj(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "DprsrOutEgrIntr_1Inj")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("DprsrOutEgrIntr_1Inj") + ":\n";
...
#endif // __REGISTER_INCLUDES_DPRSR_OUT_EGR_INTR_1_INJ_H__
