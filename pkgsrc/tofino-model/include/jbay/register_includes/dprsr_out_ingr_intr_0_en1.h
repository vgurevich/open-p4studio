...
#ifndef __REGISTER_INCLUDES_DPRSR_OUT_INGR_INTR_0_EN1_H__
#define __REGISTER_INCLUDES_DPRSR_OUT_INGR_INTR_0_EN1_H__
...
class DprsrOutIngrIntr_0En1 : public model_core::RegisterBlock<RegisterCallback> {
public:
  DprsrOutIngrIntr_0En1(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_dprsr_ho_i), 4, false, write_callback, read_callback, std::string("DprsrOutIngrIntr_0En1")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_dprsr_ho_i))
    {
    }
  DprsrOutIngrIntr_0En1(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "DprsrOutIngrIntr_0En1")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("DprsrOutIngrIntr_0En1") + ":\n";
...
#endif // __REGISTER_INCLUDES_DPRSR_OUT_INGR_INTR_0_EN1_H__
