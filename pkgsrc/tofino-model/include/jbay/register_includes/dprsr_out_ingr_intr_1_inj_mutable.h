...
#ifndef __REGISTER_INCLUDES_DPRSR_OUT_INGR_INTR_1_INJ_MUTABLE_H__
#define __REGISTER_INCLUDES_DPRSR_OUT_INGR_INTR_1_INJ_MUTABLE_H__
...
class DprsrOutIngrIntr_1InjMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  DprsrOutIngrIntr_1InjMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_dprsr_ho_i), 4, true, write_callback, read_callback, std::string("DprsrOutIngrIntr_1InjMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_dprsr_ho_i))
    {
    }
  DprsrOutIngrIntr_1InjMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "DprsrOutIngrIntr_1InjMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("DprsrOutIngrIntr_1InjMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x2cc; // to get to intr_1_inj
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_DPRSR_OUT_INGR_INTR_1_INJ_MUTABLE_H__
