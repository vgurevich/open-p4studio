...
public:
  DprsrPhvCsumCfgEntryGArray(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 2048 * ArraySize(index_pipe_addrmap, -1), false, write_callback, read_callback, std::string("DprsrPhvCsumCfgEntryGArray")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap)),
...
public:
  ...
  DprsrCsumRowEntry &engine_entry(uint32_t a0,int j0)
  {
