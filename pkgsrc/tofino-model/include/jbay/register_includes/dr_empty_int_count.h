...
#ifndef __REGISTER_INCLUDES_DR_EMPTY_INT_COUNT_H__
#define __REGISTER_INCLUDES_DR_EMPTY_INT_COUNT_H__
...
class DrEmptyIntCount : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum CbcRspecEnum {
    kCbcLqFmDr,
    kCbcLqRxDr,
...
public:
  DrEmptyIntCount(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_cbc_rspec), 4, false, write_callback, read_callback, std::string("DrEmptyIntCount")+":"+boost::lexical_cast<std::string>(selector_cbc_rspec))
    {
    }
  DrEmptyIntCount(
      int chipNumber, MbcRspecEnum selector_mbc_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(selector_mbc_rspec), 4, false, write_callback, read_callback, std::string("DrEmptyIntCount")+":"+boost::lexical_cast<std::string>(selector_mbc_rspec))
    {
    }
  DrEmptyIntCount(
      int chipNumber, PbcRspecEnum selector_pbc_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(selector_pbc_rspec), 4, false, write_callback, read_callback, std::string("DrEmptyIntCount")+":"+boost::lexical_cast<std::string>(selector_pbc_rspec))
    {
    }
  DrEmptyIntCount(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_pbc_rspec, index_dru_rspec), 4, false, write_callback, read_callback, std::string("DrEmptyIntCount")+":"+boost::lexical_cast<std::string>(selector_pbc_rspec) + "," + boost::lexical_cast<std::string>(index_dru_rspec))
    {
    }
  DrEmptyIntCount(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_tbc_rspec, index_dru_rspec), 4, false, write_callback, read_callback, std::string("DrEmptyIntCount")+":"+boost::lexical_cast<std::string>(selector_tbc_rspec) + "," + boost::lexical_cast<std::string>(index_dru_rspec))
    {
    }
  DrEmptyIntCount(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "DrEmptyIntCount")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("DrEmptyIntCount") + ":\n";
...
#endif // __REGISTER_INCLUDES_DR_EMPTY_INT_COUNT_H__
