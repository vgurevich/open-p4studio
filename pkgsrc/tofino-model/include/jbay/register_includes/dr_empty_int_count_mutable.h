...
#ifndef __REGISTER_INCLUDES_DR_EMPTY_INT_COUNT_MUTABLE_H__
#define __REGISTER_INCLUDES_DR_EMPTY_INT_COUNT_MUTABLE_H__
...
class DrEmptyIntCountMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum CbcRspecEnum {
    kCbcLqFmDr,
    kCbcLqRxDr,
...
public:
  DrEmptyIntCountMutable(
      int chipNumber, CbcRspecEnum selector_cbc_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(selector_cbc_rspec), 4, true, write_callback, read_callback, std::string("DrEmptyIntCountMutable")+":"+boost::lexical_cast<std::string>(selector_cbc_rspec))
    {
    }
  DrEmptyIntCountMutable(
      int chipNumber, MbcRspecEnum selector_mbc_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(selector_mbc_rspec), 4, true, write_callback, read_callback, std::string("DrEmptyIntCountMutable")+":"+boost::lexical_cast<std::string>(selector_mbc_rspec))
    {
    }
  DrEmptyIntCountMutable(
      int chipNumber, PbcRspecEnum selector_pbc_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(selector_pbc_rspec), 4, true, write_callback, read_callback, std::string("DrEmptyIntCountMutable")+":"+boost::lexical_cast<std::string>(selector_pbc_rspec))
    {
    }
  DrEmptyIntCountMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_pbc_rspec, index_dru_rspec), 4, true, write_callback, read_callback, std::string("DrEmptyIntCountMutable")+":"+boost::lexical_cast<std::string>(selector_pbc_rspec) + "," + boost::lexical_cast<std::string>(index_dru_rspec))
    {
    }
  DrEmptyIntCountMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_tbc_rspec, index_dru_rspec), 4, true, write_callback, read_callback, std::string("DrEmptyIntCountMutable")+":"+boost::lexical_cast<std::string>(selector_tbc_rspec) + "," + boost::lexical_cast<std::string>(index_dru_rspec))
    {
    }
  DrEmptyIntCountMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "DrEmptyIntCountMutable")
    {
    }
public:
  ...
  uint8_t count_value() { return count_value_; }
  void count_value(const uint8_t &v) { count_value_=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("DrEmptyIntCountMutable") + ":\n";
    r += indent_string + "  " + std::string("en") +  ": 0x" + boost::str( boost::format("%x") % static_cast<uint>(en_) ) + "\n";
    all_zeros &= (0 == en_);
    r += indent_string + "  " + std::string("count_value") +  ": 0x" + boost::str( boost::format("%x") % static_cast<uint>(count_value_) ) + "\n";
    all_zeros &= (0 == count_value_);
  ...
  static int StartOffset(
    ...
    switch (selector_cbc_rspec) {
      case kCbcLqFmDr:
        ...
        offset += 0x30; // to get to empty_int_count
        break;
      case kCbcLqRxDr:
...
#endif // __REGISTER_INCLUDES_DR_EMPTY_INT_COUNT_MUTABLE_H__
