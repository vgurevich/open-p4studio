...
#ifndef __REGISTER_INCLUDES_DR_LIMIT_ADDR_LOW_H__
#define __REGISTER_INCLUDES_DR_LIMIT_ADDR_LOW_H__
...
class DrLimitAddrLow : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum CbcRspecEnum {
    kCbcLqFmDr,
    kCbcLqRxDr,
...
public:
  DrLimitAddrLow(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_cbc_rspec), 4, false, write_callback, read_callback, std::string("DrLimitAddrLow")+":"+boost::lexical_cast<std::string>(selector_cbc_rspec))
    {
    }
  DrLimitAddrLow(
      int chipNumber, MbcRspecEnum selector_mbc_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(selector_mbc_rspec), 4, false, write_callback, read_callback, std::string("DrLimitAddrLow")+":"+boost::lexical_cast<std::string>(selector_mbc_rspec))
    {
    }
  DrLimitAddrLow(
      int chipNumber, PbcRspecEnum selector_pbc_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(selector_pbc_rspec), 4, false, write_callback, read_callback, std::string("DrLimitAddrLow")+":"+boost::lexical_cast<std::string>(selector_pbc_rspec))
    {
    }
  DrLimitAddrLow(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_pbc_rspec, index_dru_rspec), 4, false, write_callback, read_callback, std::string("DrLimitAddrLow")+":"+boost::lexical_cast<std::string>(selector_pbc_rspec) + "," + boost::lexical_cast<std::string>(index_dru_rspec))
    {
    }
  DrLimitAddrLow(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_tbc_rspec, index_dru_rspec), 4, false, write_callback, read_callback, std::string("DrLimitAddrLow")+":"+boost::lexical_cast<std::string>(selector_tbc_rspec) + "," + boost::lexical_cast<std::string>(index_dru_rspec))
    {
    }
  DrLimitAddrLow(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "DrLimitAddrLow")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("DrLimitAddrLow") + ":\n";
...
#endif // __REGISTER_INCLUDES_DR_LIMIT_ADDR_LOW_H__
