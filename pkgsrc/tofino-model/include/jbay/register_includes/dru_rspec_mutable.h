...
public:
  DruRspecMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_cbc_rspec), 52, true, write_callback, read_callback, std::string("DruRspecMutable")+":"+boost::lexical_cast<std::string>(selector_cbc_rspec))
    {
    }
  DruRspecMutable(
      int chipNumber, MbcRspecEnum selector_mbc_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(selector_mbc_rspec), 52, true, write_callback, read_callback, std::string("DruRspecMutable")+":"+boost::lexical_cast<std::string>(selector_mbc_rspec))
    {
    }
  DruRspecMutable(
      int chipNumber, PbcRspecEnum selector_pbc_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(selector_pbc_rspec), 52, true, write_callback, read_callback, std::string("DruRspecMutable")+":"+boost::lexical_cast<std::string>(selector_pbc_rspec))
    {
    }
  DruRspecMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_pbc_rspec, index_dru_rspec), 52, true, write_callback, read_callback, std::string("DruRspecMutable")+":"+boost::lexical_cast<std::string>(selector_pbc_rspec) + "," + boost::lexical_cast<std::string>(index_dru_rspec))
    {
    }
  DruRspecMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_tbc_rspec, index_dru_rspec), 52, true, write_callback, read_callback, std::string("DruRspecMutable")+":"+boost::lexical_cast<std::string>(selector_tbc_rspec) + "," + boost::lexical_cast<std::string>(index_dru_rspec))
    {
    }
  DruRspecMutable(
...
public:
  ...
  DrEmptyIntTimeMutable &empty_int_time() { return empty_int_time_; }




  DrEmptyIntCountMutable &empty_int_count() { return empty_int_count_; }
...
private:
  ...
  DrEmptyIntTimeMutable empty_int_time_;
  DrEmptyIntCountMutable empty_int_count_;
private:
