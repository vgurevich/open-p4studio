...
#ifndef __REGISTER_INCLUDES_EBUF100_CHNL_FIFO_CTRL_MUTABLE_H__
#define __REGISTER_INCLUDES_EBUF100_CHNL_FIFO_CTRL_MUTABLE_H__
...
class Ebuf100ChnlFifoCtrlMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  Ebuf100ChnlFifoCtrlMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_ebuf900_reg, index_ebuf100_chan_group), 8, true, write_callback, read_callback, std::string("Ebuf100ChnlFifoCtrlMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_ebuf900_reg) + "," + boost::lexical_cast<std::string>(index_ebuf100_chan_group))
    {
    }
  Ebuf100ChnlFifoCtrlMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "Ebuf100ChnlFifoCtrlMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("Ebuf100ChnlFifoCtrlMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_EBUF100_CHNL_FIFO_CTRL_MUTABLE_H__
