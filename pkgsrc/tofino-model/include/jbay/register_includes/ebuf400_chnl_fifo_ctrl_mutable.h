...
#ifndef __REGISTER_INCLUDES_EBUF400_CHNL_FIFO_CTRL_MUTABLE_H__
#define __REGISTER_INCLUDES_EBUF400_CHNL_FIFO_CTRL_MUTABLE_H__
...
class Ebuf400ChnlFifoCtrlMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  Ebuf400ChnlFifoCtrlMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_ebuf900_reg, index_ebuf400_rspec, index_ebuf400_chan_group), 8, true, write_callback, read_callback, std::string("Ebuf400ChnlFifoCtrlMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_ebuf900_reg) + "," + boost::lexical_cast<std::string>(index_ebuf400_rspec) + "," + boost::lexical_cast<std::string>(index_ebuf400_chan_group))
    {
    }
  Ebuf400ChnlFifoCtrlMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "Ebuf400ChnlFifoCtrlMutable")
    {
    }
public:
  ...
  void warp_fifo_begin(const uint8_t &v) { warp_fifo_begin_=v; }
  ...
  void warp_fifo_end(const uint8_t &v) { warp_fifo_end_=v; }
  ...
  void warp_fifo_size(const uint8_t &v) { warp_fifo_size_=v; }
  ...
  void dprsr_fifo_begin(const uint8_t &v) { dprsr_fifo_begin_=v; }
  ...
  void dprsr_fifo_end(const uint8_t &v) { dprsr_fifo_end_=v; }
  ...
  void dprsr_fifo_size(const uint8_t &v) { dprsr_fifo_size_=v; }
  ...
  void mac_fifo_begin(const uint8_t &v) { mac_fifo_begin_=v; }
  ...
  void mac_fifo_end(const uint8_t &v) { mac_fifo_end_=v; }
  ...
  void mac_fifo_size(const uint8_t &v) { mac_fifo_size_=v; }
  ...
  void clear_warp_fifo_max_occu(const uint8_t &v) { clear_warp_fifo_max_occu_=v; }
  ...
  void clear_dprsr_fifo_max_occu(const uint8_t &v) { clear_dprsr_fifo_max_occu_=v; }
  ...
  void clear_mac_fifo_max_occu(const uint8_t &v) { clear_mac_fifo_max_occu_=v; }
  ...
  void reset(
    ...
    warp_fifo_end_ = 0x1f;
    warp_fifo_size_ = 0x20;
    dprsr_fifo_begin_ = 0x0;
    dprsr_fifo_end_ = 0x17;
    dprsr_fifo_size_ = 0x18;
    mac_fifo_begin_ = 0x0;
    mac_fifo_end_ = 0x1f;
    mac_fifo_size_ = 0x20;
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("Ebuf400ChnlFifoCtrlMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x408; // to get to chan_group_chnl_fifo_ctrl
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_EBUF400_CHNL_FIFO_CTRL_MUTABLE_H__
