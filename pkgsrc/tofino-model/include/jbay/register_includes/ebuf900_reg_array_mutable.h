...
#ifndef __REGISTER_INCLUDES_EBUF900_REG_ARRAY_MUTABLE_H__
#define __REGISTER_INCLUDES_EBUF900_REG_ARRAY_MUTABLE_H__
...
class Ebuf900RegArrayMutable : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  Ebuf900RegArrayMutable(
      int chipNumber, int index_pipe_addrmap, RegisterArrayCallback& write_callback = 0, RegisterArrayCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 8192 * ArraySize(index_pipe_addrmap, -1), true, write_callback, read_callback, std::string("Ebuf900RegArrayMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap)),
...
public:
  ...
  Ebuf400RspecMutable &ebuf400reg(uint32_t a0,int j0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    return array[a0].ebuf400reg(j0);
  }
  ...
  Ebuf100RspecMutable &ebuf100reg(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    return array[a0].ebuf100reg();
  }
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("Ebuf900RegArrayMutable") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
private:
  std::vector<Ebuf900RegMutable> array;
  uint32_t size0_;
...
#endif // __REGISTER_INCLUDES_EBUF900_REG_ARRAY_MUTABLE_H__
