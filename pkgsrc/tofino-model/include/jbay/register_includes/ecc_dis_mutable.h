...
#ifndef __REGISTER_INCLUDES_ECC_DIS_MUTABLE_H__
#define __REGISTER_INCLUDES_ECC_DIS_MUTABLE_H__
...
class EccDisMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  EccDisMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_ipb_prsr4_reg), 4, true, write_callback, read_callback, std::string("EccDisMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_ipb_prsr4_reg))
    {
    }
  EccDisMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "EccDisMutable")
    {
    }
public:
  ...
  void pbc_mem0(const uint8_t &v) { pbc_mem0_=v; }
  ...
  void pbc_mem1(const uint8_t &v) { pbc_mem1_=v; }
  ...
  void mbc_mem(const uint8_t &v) { mbc_mem_=v; }
  ...
  void mbc_meta_fifo_mem(const uint8_t &v) { mbc_meta_fifo_mem_=v; }
  ...
  void llc_mem0(const uint8_t &v) { llc_mem0_=v; }
  ...
  void llc_mem1(const uint8_t &v) { llc_mem1_=v; }
  ...
  void llc_mem2(const uint8_t &v) { llc_mem2_=v; }
  ...
  void drop_mem0(const uint8_t &v) { drop_mem0_=v; }
  ...
  void drop_mem1(const uint8_t &v) { drop_mem1_=v; }
  ...
  void papc_merge_mem0(const uint8_t &v) { papc_merge_mem0_=v; }
  ...
  void papc_merge_mem1(const uint8_t &v) { papc_merge_mem1_=v; }
  ...
  void papc_mem0(const uint8_t &v) { papc_mem0_=v; }
  ...
  void dppc_mem0(const uint8_t &v) { dppc_mem0_=v; }
  ...
  void gacc_mem0(const uint8_t &v) { gacc_mem0_=v; }
  ...
  void gacc_mem1(const uint8_t &v) { gacc_mem1_=v; }
  ...
  void gacc_mem2(const uint8_t &v) { gacc_mem2_=v; }
  ...
  void gacc_mem3(const uint8_t &v) { gacc_mem3_=v; }
  ...
  void bcc_mem(const uint8_t &v) { bcc_mem_=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("EccDisMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_ECC_DIS_MUTABLE_H__
