...
#ifndef __REGISTER_INCLUDES_EPB_GLB_GROUP_H__
#define __REGISTER_INCLUDES_EPB_GLB_GROUP_H__
...
#include "epb_ctrl.h"
#include "epb_ecc_dis.h"
#include "epb_ecc_inj.h"
#include "epb_glb_group_intr_stat.h"
#include "epb_glb_group_port_en.h"
#include "epb_glb_group_port_rates.h"
#include "epb_intr_log_group.h"
#include "epb_parser_maxbyte.h"
#include "epb_prsr_crd.h"
#include "epb_prsr_crd_stat.h"
#include "epb_prsr_stat.h"
#include "epb_status.h"
#include "epb_sw_reset.h"
#include "epb_time_offset.h"
#include "glb_epb_tim_off.h"

namespace jbay {
  namespace register_classes {

class EpbGlbGroup : public model_core::RegisterBlock<RegisterCallback> {
public:
  EpbGlbGroup(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_epb_prsr4_reg), 180, false, write_callback, read_callback, std::string("EpbGlbGroup")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_epb_prsr4_reg))
    {
    }
  EpbGlbGroup(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "EpbGlbGroup")
    {
    }
public:
  ...
  EpbSwReset &glb_group_sw_reset() { return glb_group_sw_reset_; }
  ...
  EpbStatus &glb_group_glb_status() { return glb_group_glb_status_; }
  ...
  EpbGlbGroupPortRates &glb_group_port_rates() { return glb_group_port_rates_; }





  EpbGlbGroupPortEn &glb_group_port_en() { return glb_group_port_en_; }





  EpbCtrl &glb_group_glb_ctrl() { return glb_group_glb_ctrl_; }
  ...
  EpbPrsrCrd &glb_group_glb_prsr_crd() { return glb_group_glb_prsr_crd_; }
  ...
  EpbPrsrCrdStat &glb_group_glb_prsr_crd_stat() { return glb_group_glb_prsr_crd_stat_; }
  ...
  EpbPrsrStat &glb_group_glb_prsr_stat() { return glb_group_glb_prsr_stat_; }





  EpbParserMaxbyte &glb_group_glb_parser_maxbyte() { return glb_group_glb_parser_maxbyte_; }
  ...
  EpbEccInj &glb_group_ecc_inj() { return glb_group_ecc_inj_; }
  ...
  EpbEccDis &glb_group_ecc_dis() { return glb_group_ecc_dis_; }
  ...
  EpbTimeOffset &glb_group_time_offset() { return glb_group_time_offset_; }





  GlbEpbTimOff &glb_group_glb_epb_tim_off() { return glb_group_glb_epb_tim_off_; }
  EpbGlbGroupIntrStat &glb_group_intr_stat() { return glb_group_intr_stat_; }
  EpbIntrLogGroup &glb_group_intr_log_group() { return glb_group_intr_log_group_; }
...
private:
  EpbSwReset glb_group_sw_reset_;
  EpbStatus glb_group_glb_status_;
  EpbGlbGroupPortRates glb_group_port_rates_;
  EpbGlbGroupPortEn glb_group_port_en_;
  EpbCtrl glb_group_glb_ctrl_;
  EpbPrsrCrd glb_group_glb_prsr_crd_;
  EpbPrsrCrdStat glb_group_glb_prsr_crd_stat_;
  EpbPrsrStat glb_group_glb_prsr_stat_;
  EpbParserMaxbyte glb_group_glb_parser_maxbyte_;
  EpbEccInj glb_group_ecc_inj_;
  EpbEccDis glb_group_ecc_dis_;
  EpbTimeOffset glb_group_time_offset_;
  GlbEpbTimOff glb_group_glb_epb_tim_off_;
  EpbGlbGroupIntrStat glb_group_intr_stat_;
  EpbIntrLogGroup glb_group_intr_log_group_;
private:
...
#endif // __REGISTER_INCLUDES_EPB_GLB_GROUP_H__
