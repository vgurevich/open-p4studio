...
#ifndef __REGISTER_INCLUDES_EPB_GLB_GROUP_INTR_STAT_EN1_MUTABLE_H__
#define __REGISTER_INCLUDES_EPB_GLB_GROUP_INTR_STAT_EN1_MUTABLE_H__
...
class EpbGlbGroupIntrStatEn1Mutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  EpbGlbGroupIntrStatEn1Mutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_epb_prsr4_reg), 8, true, write_callback, read_callback, std::string("EpbGlbGroupIntrStatEn1Mutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_epb_prsr4_reg))
    {
    }
  EpbGlbGroupIntrStatEn1Mutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "EpbGlbGroupIntrStatEn1Mutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("EpbGlbGroupIntrStatEn1Mutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_EPB_GLB_GROUP_INTR_STAT_EN1_MUTABLE_H__
