...
#ifndef __REGISTER_INCLUDES_EPB_GLB_GROUP_INTR_STAT_FREEZE_ENABLE_MUTABLE_H__
#define __REGISTER_INCLUDES_EPB_GLB_GROUP_INTR_STAT_FREEZE_ENABLE_MUTABLE_H__
...
class EpbGlbGroupIntrStatFreezeEnableMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  EpbGlbGroupIntrStatFreezeEnableMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_epb_prsr4_reg), 8, true, write_callback, read_callback, std::string("EpbGlbGroupIntrStatFreezeEnableMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_epb_prsr4_reg))
    {
    }
  EpbGlbGroupIntrStatFreezeEnableMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "EpbGlbGroupIntrStatFreezeEnableMutable")
    {
    }
public:
  uint8_t chn0_tm_miss_eop() { return chn0_tm_miss_eop_; }
  void chn0_tm_miss_eop(const uint8_t &v) { chn0_tm_miss_eop_=v; }
  uint8_t chn1_tm_miss_eop() { return chn1_tm_miss_eop_; }
  void chn1_tm_miss_eop(const uint8_t &v) { chn1_tm_miss_eop_=v; }
  uint8_t chn2_tm_miss_eop() { return chn2_tm_miss_eop_; }
  void chn2_tm_miss_eop(const uint8_t &v) { chn2_tm_miss_eop_=v; }
  uint8_t chn3_tm_miss_eop() { return chn3_tm_miss_eop_; }
  void chn3_tm_miss_eop(const uint8_t &v) { chn3_tm_miss_eop_=v; }
  uint8_t chn4_tm_miss_eop() { return chn4_tm_miss_eop_; }
  void chn4_tm_miss_eop(const uint8_t &v) { chn4_tm_miss_eop_=v; }
  uint8_t chn5_tm_miss_eop() { return chn5_tm_miss_eop_; }
  void chn5_tm_miss_eop(const uint8_t &v) { chn5_tm_miss_eop_=v; }
  uint8_t chn6_tm_miss_eop() { return chn6_tm_miss_eop_; }
  void chn6_tm_miss_eop(const uint8_t &v) { chn6_tm_miss_eop_=v; }
  uint8_t chn7_tm_miss_eop() { return chn7_tm_miss_eop_; }
  void chn7_tm_miss_eop(const uint8_t &v) { chn7_tm_miss_eop_=v; }
  uint8_t chn0_tm_miss_sop() { return chn0_tm_miss_sop_; }
  void chn0_tm_miss_sop(const uint8_t &v) { chn0_tm_miss_sop_=v; }
  uint8_t chn1_tm_miss_sop() { return chn1_tm_miss_sop_; }
  void chn1_tm_miss_sop(const uint8_t &v) { chn1_tm_miss_sop_=v; }
  uint8_t chn2_tm_miss_sop() { return chn2_tm_miss_sop_; }
  void chn2_tm_miss_sop(const uint8_t &v) { chn2_tm_miss_sop_=v; }
  uint8_t chn3_tm_miss_sop() { return chn3_tm_miss_sop_; }
  void chn3_tm_miss_sop(const uint8_t &v) { chn3_tm_miss_sop_=v; }
  uint8_t chn4_tm_miss_sop() { return chn4_tm_miss_sop_; }
  void chn4_tm_miss_sop(const uint8_t &v) { chn4_tm_miss_sop_=v; }
  uint8_t chn5_tm_miss_sop() { return chn5_tm_miss_sop_; }
  void chn5_tm_miss_sop(const uint8_t &v) { chn5_tm_miss_sop_=v; }
  uint8_t chn6_tm_miss_sop() { return chn6_tm_miss_sop_; }
  void chn6_tm_miss_sop(const uint8_t &v) { chn6_tm_miss_sop_=v; }
  uint8_t chn7_tm_miss_sop() { return chn7_tm_miss_sop_; }
  void chn7_tm_miss_sop(const uint8_t &v) { chn7_tm_miss_sop_=v; }
  uint8_t chn0_pkt_lt_32byte() { return chn0_pkt_lt_32byte_; }
  void chn0_pkt_lt_32byte(const uint8_t &v) { chn0_pkt_lt_32byte_=v; }
  uint8_t chn1_pkt_lt_32byte() { return chn1_pkt_lt_32byte_; }
  void chn1_pkt_lt_32byte(const uint8_t &v) { chn1_pkt_lt_32byte_=v; }
  uint8_t chn2_pkt_lt_32byte() { return chn2_pkt_lt_32byte_; }
  void chn2_pkt_lt_32byte(const uint8_t &v) { chn2_pkt_lt_32byte_=v; }
  uint8_t chn3_pkt_lt_32byte() { return chn3_pkt_lt_32byte_; }
  void chn3_pkt_lt_32byte(const uint8_t &v) { chn3_pkt_lt_32byte_=v; }
  uint8_t chn4_pkt_lt_32byte() { return chn4_pkt_lt_32byte_; }
  void chn4_pkt_lt_32byte(const uint8_t &v) { chn4_pkt_lt_32byte_=v; }
  uint8_t chn5_pkt_lt_32byte() { return chn5_pkt_lt_32byte_; }
  void chn5_pkt_lt_32byte(const uint8_t &v) { chn5_pkt_lt_32byte_=v; }
  uint8_t chn6_pkt_lt_32byte() { return chn6_pkt_lt_32byte_; }
  void chn6_pkt_lt_32byte(const uint8_t &v) { chn6_pkt_lt_32byte_=v; }
  uint8_t chn7_pkt_lt_32byte() { return chn7_pkt_lt_32byte_; }
  void chn7_pkt_lt_32byte(const uint8_t &v) { chn7_pkt_lt_32byte_=v; }
  uint8_t wpc_fifo_fatal0() { return wpc_fifo_fatal0_; }
  void wpc_fifo_fatal0(const uint8_t &v) { wpc_fifo_fatal0_=v; }
  uint8_t wpc_fifo_fatal1() { return wpc_fifo_fatal1_; }
  void wpc_fifo_fatal1(const uint8_t &v) { wpc_fifo_fatal1_=v; }
  uint8_t wpc_fifo_fatal2() { return wpc_fifo_fatal2_; }
  void wpc_fifo_fatal2(const uint8_t &v) { wpc_fifo_fatal2_=v; }
  uint8_t wpc_fifo_fatal3() { return wpc_fifo_fatal3_; }
  void wpc_fifo_fatal3(const uint8_t &v) { wpc_fifo_fatal3_=v; }
  uint8_t wpc_overflow() { return wpc_overflow_; }
  void wpc_overflow(const uint8_t &v) { wpc_overflow_=v; }
  uint8_t prsr0_parity_err() { return prsr0_parity_err_; }
  void prsr0_parity_err(const uint8_t &v) { prsr0_parity_err_=v; }
  uint8_t prsr1_parity_err() { return prsr1_parity_err_; }
  void prsr1_parity_err(const uint8_t &v) { prsr1_parity_err_=v; }
  uint8_t prsr2_parity_err() { return prsr2_parity_err_; }
  void prsr2_parity_err(const uint8_t &v) { prsr2_parity_err_=v; }
  uint8_t prsr3_parity_err() { return prsr3_parity_err_; }
  void prsr3_parity_err(const uint8_t &v) { prsr3_parity_err_=v; }
  uint8_t prsr4_parity_err() { return prsr4_parity_err_; }
  void prsr4_parity_err(const uint8_t &v) { prsr4_parity_err_=v; }
  uint8_t prsr5_parity_err() { return prsr5_parity_err_; }
  void prsr5_parity_err(const uint8_t &v) { prsr5_parity_err_=v; }
  uint8_t prsr6_parity_err() { return prsr6_parity_err_; }
  void prsr6_parity_err(const uint8_t &v) { prsr6_parity_err_=v; }
  uint8_t prsr7_parity_err() { return prsr7_parity_err_; }
  void prsr7_parity_err(const uint8_t &v) { prsr7_parity_err_=v; }
  uint8_t dprsr_err() { return dprsr_err_; }
  void dprsr_err(const uint8_t &v) { dprsr_err_=v; }
  uint8_t warp_err() { return warp_err_; }
  void warp_err(const uint8_t &v) { warp_err_=v; }
  uint8_t wpc_ff_ecc_dual_err() { return wpc_ff_ecc_dual_err_; }
  void wpc_ff_ecc_dual_err(const uint8_t &v) { wpc_ff_ecc_dual_err_=v; }
  uint8_t wpc_ff_ecc_sngl_err() { return wpc_ff_ecc_sngl_err_; }
  void wpc_ff_ecc_sngl_err(const uint8_t &v) { wpc_ff_ecc_sngl_err_=v; }
  uint8_t pbc_overflow() { return pbc_overflow_; }
  void pbc_overflow(const uint8_t &v) { pbc_overflow_=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("EpbGlbGroupIntrStatFreezeEnableMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_EPB_GLB_GROUP_INTR_STAT_FREEZE_ENABLE_MUTABLE_H__
