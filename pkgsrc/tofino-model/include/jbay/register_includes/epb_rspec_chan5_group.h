...
#ifndef __REGISTER_INCLUDES_EPB_RSPEC_CHAN5_GROUP_H__
#define __REGISTER_INCLUDES_EPB_RSPEC_CHAN5_GROUP_H__
...
class EpbRspecChan5Group : public model_core::RegisterBlock<RegisterCallback> {
public:
  EpbRspecChan5Group(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_epb_prsr4_reg), 108, false, write_callback, read_callback, std::string("EpbRspecChan5Group")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_epb_prsr4_reg))
    {
    }
  EpbRspecChan5Group(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "EpbRspecChan5Group")
    {
    }
public:
  ...
  EpbChnlCtrl &chan5_group_chnl_ctrl() { return chan5_group_chnl_ctrl_; }





  EpbChnlFifoCtrl &chan5_group_chnl_fifo_ctrl() { return chan5_group_chnl_fifo_ctrl_; }
  ...
  EpbChnlFifoCfg &chan5_group_chnl_fifo_cfg() { return chan5_group_chnl_fifo_cfg_; }
  ...
  EpbChnlStat &chan5_group_chnl_stat() { return chan5_group_chnl_stat_; }
  ...
  EpbChnlPktnum0 &chan5_group_chnl_pktnum0() { return chan5_group_chnl_pktnum0_; }
  ...
  EpbChnlPktnum1 &chan5_group_chnl_pktnum1() { return chan5_group_chnl_pktnum1_; }
  ...
  EpbChnlPktnum2 &chan5_group_chnl_pktnum2() { return chan5_group_chnl_pktnum2_; }
  ...
  EpbChnlPktnum3 &chan5_group_chnl_pktnum3() { return chan5_group_chnl_pktnum3_; }





  EpbChnlParserSendPkt &chan5_group_chnl_parser_send_pkt() { return chan5_group_chnl_parser_send_pkt_; }





  EpbChnlDeparserSendPkt &chan5_group_chnl_deparser_send_pkt() { return chan5_group_chnl_deparser_send_pkt_; }





  EpbChnlWarpSendPkt &chan5_group_chnl_warp_send_pkt() { return chan5_group_chnl_warp_send_pkt_; }





  EpbChnlP2sReceivedPkt &chan5_group_chnl_p2s_received_pkt() { return chan5_group_chnl_p2s_received_pkt_; }
...
private:
  EpbChnlCtrl chan5_group_chnl_ctrl_;
  EpbChnlFifoCtrl chan5_group_chnl_fifo_ctrl_;
  EpbChnlFifoCfg chan5_group_chnl_fifo_cfg_;
  EpbChnlStat chan5_group_chnl_stat_;
  EpbChnlPktnum0 chan5_group_chnl_pktnum0_;
  EpbChnlPktnum1 chan5_group_chnl_pktnum1_;
  EpbChnlPktnum2 chan5_group_chnl_pktnum2_;
  EpbChnlPktnum3 chan5_group_chnl_pktnum3_;
  EpbChnlParserSendPkt chan5_group_chnl_parser_send_pkt_;
  EpbChnlDeparserSendPkt chan5_group_chnl_deparser_send_pkt_;
  EpbChnlWarpSendPkt chan5_group_chnl_warp_send_pkt_;
  EpbChnlP2sReceivedPkt chan5_group_chnl_p2s_received_pkt_;
private:
...
#endif // __REGISTER_INCLUDES_EPB_RSPEC_CHAN5_GROUP_H__
