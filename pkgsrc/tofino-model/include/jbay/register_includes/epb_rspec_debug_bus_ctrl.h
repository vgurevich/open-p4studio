...
#ifndef __REGISTER_INCLUDES_EPB_RSPEC_DEBUG_BUS_CTRL_H__
#define __REGISTER_INCLUDES_EPB_RSPEC_DEBUG_BUS_CTRL_H__
...
class EpbRspecDebugBusCtrl : public model_core::RegisterBlock<RegisterCallback> {
public:
  EpbRspecDebugBusCtrl(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_epb_prsr4_reg), 4, false, write_callback, read_callback, std::string("EpbRspecDebugBusCtrl")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_epb_prsr4_reg))
    {
    }
  EpbRspecDebugBusCtrl(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "EpbRspecDebugBusCtrl")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("EpbRspecDebugBusCtrl") + ":\n";
...
#endif // __REGISTER_INCLUDES_EPB_RSPEC_DEBUG_BUS_CTRL_H__
