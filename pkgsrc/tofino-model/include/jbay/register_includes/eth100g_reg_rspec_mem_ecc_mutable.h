...
#ifndef __REGISTER_INCLUDES_ETH100G_REG_RSPEC_MEM_ECC_MUTABLE_H__
#define __REGISTER_INCLUDES_ETH100G_REG_RSPEC_MEM_ECC_MUTABLE_H__
...
class Eth100gRegRspecMemEccMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum JbayRegEnum {
    kEth100gRegs,
    kEth100gRegsRot
...
public:
  Eth100gRegRspecMemEccMutable(
      int chipNumber, JbayRegEnum selector_jbay_reg, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(selector_jbay_reg), 4, true, write_callback, read_callback, std::string("Eth100gRegRspecMemEccMutable")+":"+boost::lexical_cast<std::string>(selector_jbay_reg))
    {
    }
  Eth100gRegRspecMemEccMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "Eth100gRegRspecMemEccMutable")
    {
    }
public:
  ...
  void txfifo_sram_disable_check(const uint8_t &v) { txfifo_sram_disable_check_=v; }




  uint8_t txfifo_sram_inject_sbe() { return txfifo_sram_inject_sbe_; }
  void txfifo_sram_inject_sbe(const uint8_t &v) { txfifo_sram_inject_sbe_=v; }




  uint8_t txfifo_sram_inject_mbe() { return txfifo_sram_inject_mbe_; }
  void txfifo_sram_inject_mbe(const uint8_t &v) { txfifo_sram_inject_mbe_=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("Eth100gRegRspecMemEccMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_ETH100G_REG_RSPEC_MEM_ECC_MUTABLE_H__
