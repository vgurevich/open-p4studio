...
#ifndef __REGISTER_INCLUDES_ETH100G_REG_RSPEC_MEM_INTR_INJ_H__
#define __REGISTER_INCLUDES_ETH100G_REG_RSPEC_MEM_INTR_INJ_H__
...
class Eth100gRegRspecMemIntrInj : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum JbayRegEnum {
    kEth100gRegs,
    kEth100gRegsRot
...
public:
  Eth100gRegRspecMemIntrInj(
      int chipNumber, JbayRegEnum selector_jbay_reg, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(selector_jbay_reg), 4, false, write_callback, read_callback, std::string("Eth100gRegRspecMemIntrInj")+":"+boost::lexical_cast<std::string>(selector_jbay_reg))
    {
    }
  Eth100gRegRspecMemIntrInj(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "Eth100gRegRspecMemIntrInj")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("Eth100gRegRspecMemIntrInj") + ":\n";
...
#endif // __REGISTER_INCLUDES_ETH100G_REG_RSPEC_MEM_INTR_INJ_H__
