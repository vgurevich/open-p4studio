...
#ifndef __REGISTER_INCLUDES_ETH100G_REG_RSPEC_MEM_INTR_STAT_MUTABLE_H__
#define __REGISTER_INCLUDES_ETH100G_REG_RSPEC_MEM_INTR_STAT_MUTABLE_H__
...
class Eth100gRegRspecMemIntrStatMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum JbayRegEnum {
    kEth100gRegs,
    kEth100gRegsRot
...
public:
  Eth100gRegRspecMemIntrStatMutable(
      int chipNumber, JbayRegEnum selector_jbay_reg, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(selector_jbay_reg), 4, true, write_callback, read_callback, std::string("Eth100gRegRspecMemIntrStatMutable")+":"+boost::lexical_cast<std::string>(selector_jbay_reg))
    {
    }
  Eth100gRegRspecMemIntrStatMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "Eth100gRegRspecMemIntrStatMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("Eth100gRegRspecMemIntrStatMutable") + ":\n";
  ...
  static int StartOffset(
    ...
    switch (selector_jbay_reg) {
      case kEth100gRegs:
        ...
        offset += 0x100; // to get to mem_intr_stat
        break;
...
#endif // __REGISTER_INCLUDES_ETH100G_REG_RSPEC_MEM_INTR_STAT_MUTABLE_H__
