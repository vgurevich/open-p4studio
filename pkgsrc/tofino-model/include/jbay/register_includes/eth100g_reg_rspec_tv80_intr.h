...
#ifndef __REGISTER_INCLUDES_ETH100G_REG_RSPEC_TV80_INTR_H__
#define __REGISTER_INCLUDES_ETH100G_REG_RSPEC_TV80_INTR_H__
...
#include "eth100g_reg_rspec_tv80_intr_en0.h"
#include "eth100g_reg_rspec_tv80_intr_en1.h"
#include "eth100g_reg_rspec_tv80_intr_freeze_enable.h"
#include "eth100g_reg_rspec_tv80_intr_inj.h"
#include "eth100g_reg_rspec_tv80_intr_stat.h"

namespace jbay {
  namespace register_classes {

class Eth100gRegRspecTv80Intr : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum JbayRegEnum {
    kEth100gRegs,
    kEth100gRegsRot
...
public:
  Eth100gRegRspecTv80Intr(
      int chipNumber, JbayRegEnum selector_jbay_reg, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(selector_jbay_reg), 20, false, write_callback, read_callback, std::string("Eth100gRegRspecTv80Intr")+":"+boost::lexical_cast<std::string>(selector_jbay_reg))
    {
    }
  Eth100gRegRspecTv80Intr(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "Eth100gRegRspecTv80Intr")
    {
    }
public:
  ...
  Eth100gRegRspecTv80IntrStat &tv80_intr_stat() { return tv80_intr_stat_; }
  ...
  Eth100gRegRspecTv80IntrEn0 &tv80_intr_en0() { return tv80_intr_en0_; }
  ...
  Eth100gRegRspecTv80IntrEn1 &tv80_intr_en1() { return tv80_intr_en1_; }
  ...
  Eth100gRegRspecTv80IntrInj &tv80_intr_inj() { return tv80_intr_inj_; }





  Eth100gRegRspecTv80IntrFreezeEnable &tv80_intr_freeze_enable() { return tv80_intr_freeze_enable_; }
...
private:
  Eth100gRegRspecTv80IntrStat tv80_intr_stat_;
  Eth100gRegRspecTv80IntrEn0 tv80_intr_en0_;
  Eth100gRegRspecTv80IntrEn1 tv80_intr_en1_;
  Eth100gRegRspecTv80IntrInj tv80_intr_inj_;
  Eth100gRegRspecTv80IntrFreezeEnable tv80_intr_freeze_enable_;
private:
  static int StartOffset(
    ...
    switch (selector_jbay_reg) {
      case kEth100gRegs:
        ...
        offset += 0x160; // to get to tv80_intr
        break;
...
#endif // __REGISTER_INCLUDES_ETH100G_REG_RSPEC_TV80_INTR_H__
