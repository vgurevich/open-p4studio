...
#ifndef __REGISTER_INCLUDES_ETH100G_REG_RSPEC_TV80_INTR_STAT_MUTABLE_H__
#define __REGISTER_INCLUDES_ETH100G_REG_RSPEC_TV80_INTR_STAT_MUTABLE_H__
...
class Eth100gRegRspecTv80IntrStatMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum JbayRegEnum {
    kEth100gRegs,
    kEth100gRegsRot
...
public:
  Eth100gRegRspecTv80IntrStatMutable(
      int chipNumber, JbayRegEnum selector_jbay_reg, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(selector_jbay_reg), 4, true, write_callback, read_callback, std::string("Eth100gRegRspecTv80IntrStatMutable")+":"+boost::lexical_cast<std::string>(selector_jbay_reg))
    {
    }
  Eth100gRegRspecTv80IntrStatMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "Eth100gRegRspecTv80IntrStatMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("Eth100gRegRspecTv80IntrStatMutable") + ":\n";
  ...
  static int StartOffset(
    ...
    switch (selector_jbay_reg) {
      case kEth100gRegs:
        ...
        offset += 0x160; // to get to tv80_intr_stat
        break;
...
#endif // __REGISTER_INCLUDES_ETH100G_REG_RSPEC_TV80_INTR_STAT_MUTABLE_H__
