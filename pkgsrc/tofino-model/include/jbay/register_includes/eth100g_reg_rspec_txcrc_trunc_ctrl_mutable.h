...
#ifndef __REGISTER_INCLUDES_ETH100G_REG_RSPEC_TXCRC_TRUNC_CTRL_MUTABLE_H__
#define __REGISTER_INCLUDES_ETH100G_REG_RSPEC_TXCRC_TRUNC_CTRL_MUTABLE_H__
...
class Eth100gRegRspecTxcrcTruncCtrlMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum JbayRegEnum {
    kEth100gRegs,
    kEth100gRegsRot
...
public:
  Eth100gRegRspecTxcrcTruncCtrlMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_jbay_reg, index_eth100g_reg_rspec_txcrc_trunc_ctrl), 4, true, write_callback, read_callback, std::string("Eth100gRegRspecTxcrcTruncCtrlMutable")+":"+boost::lexical_cast<std::string>(selector_jbay_reg) + "," + boost::lexical_cast<std::string>(index_eth100g_reg_rspec_txcrc_trunc_ctrl))
    {
    }
  Eth100gRegRspecTxcrcTruncCtrlMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "Eth100gRegRspecTxcrcTruncCtrlMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("Eth100gRegRspecTxcrcTruncCtrlMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_ETH100G_REG_RSPEC_TXCRC_TRUNC_CTRL_MUTABLE_H__
