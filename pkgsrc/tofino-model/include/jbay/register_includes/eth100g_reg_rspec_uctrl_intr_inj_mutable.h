...
#ifndef __REGISTER_INCLUDES_ETH100G_REG_RSPEC_UCTRL_INTR_INJ_MUTABLE_H__
#define __REGISTER_INCLUDES_ETH100G_REG_RSPEC_UCTRL_INTR_INJ_MUTABLE_H__
...
class Eth100gRegRspecUctrlIntrInjMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum JbayRegEnum {
    kEth100gRegs,
    kEth100gRegsRot
...
public:
  Eth100gRegRspecUctrlIntrInjMutable(
      int chipNumber, JbayRegEnum selector_jbay_reg, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(selector_jbay_reg), 4, true, write_callback, read_callback, std::string("Eth100gRegRspecUctrlIntrInjMutable")+":"+boost::lexical_cast<std::string>(selector_jbay_reg))
    {
    }
  Eth100gRegRspecUctrlIntrInjMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "Eth100gRegRspecUctrlIntrInjMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("Eth100gRegRspecUctrlIntrInjMutable") + ":\n";
  ...
  static int StartOffset(
    ...
    switch (selector_jbay_reg) {
      case kEth100gRegs:
        ...
        offset += 0x12c; // to get to uctrl_intr_inj
        break;
...
#endif // __REGISTER_INCLUDES_ETH100G_REG_RSPEC_UCTRL_INTR_INJ_MUTABLE_H__
