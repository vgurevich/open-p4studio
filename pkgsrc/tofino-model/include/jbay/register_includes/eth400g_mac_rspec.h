...
#ifndef __REGISTER_INCLUDES_ETH400G_MAC_RSPEC_H__
#define __REGISTER_INCLUDES_ETH400G_MAC_RSPEC_H__
...
#include "eth400g_mac_rspec_chnl_intr.h"
#include "eth400g_mac_rspec_chnl_seq.h"
#include "eth400g_mac_rspec_crcerr_inj.h"
#include "eth400g_mac_rspec_cts_fifo_out.h"
#include "eth400g_mac_rspec_cts_fifo_stat.h"
#include "eth400g_mac_rspec_cts_intr.h"
#include "eth400g_mac_rspec_eth_clkobs_ctrl.h"
#include "eth400g_mac_rspec_eth_mac_ts_offset_ctrl.h"
#include "eth400g_mac_rspec_eth_mdioci_addr.h"
#include "eth400g_mac_rspec_eth_onestep_ets_offset_ctrl.h"
#include "eth400g_mac_rspec_eth_ring_addr.h"
#include "eth400g_mac_rspec_eth_ring_ctrl.h"
#include "eth400g_mac_rspec_eth_ring_rdata.h"
#include "eth400g_mac_rspec_eth_ring_setup.h"
#include "eth400g_mac_rspec_eth_ring_wdata.h"
#include "eth400g_mac_rspec_eth_soft_reset.h"
#include "eth400g_mac_rspec_eth_status0.h"
#include "eth400g_mac_rspec_eth_status1.h"
#include "eth400g_mac_rspec_global_intr_stat.h"
#include "eth400g_mac_rspec_mac_en0.h"
#include "eth400g_mac_rspec_mac_en1.h"
#include "eth400g_mac_rspec_mac_freeze_enable.h"
#include "eth400g_mac_rspec_mem_intr.h"
#include "eth400g_mac_rspec_port_alive_lut.h"
#include "eth400g_mac_rspec_rxappfifo_mbe_err_log.h"
#include "eth400g_mac_rspec_rxappfifo_sbe_err_log.h"
#include "eth400g_mac_rspec_rxff_ctrl.h"
#include "eth400g_mac_rspec_rxff_stat_ecc.h"
#include "eth400g_mac_rspec_rxpkt_err_sts.h"
#include "eth400g_mac_rspec_soft_port_alive.h"
#include "eth400g_mac_rspec_statsmem_mbe_err_log.h"
#include "eth400g_mac_rspec_statsmem_sbe_err_log.h"
#include "eth400g_mac_rspec_tv80_debug_ctrl.h"
#include "eth400g_mac_rspec_tv80_debug_head_ptr.h"
#include "eth400g_mac_rspec_tv80_debug_tail_ptr.h"
#include "eth400g_mac_rspec_tv80_halted_status.h"
#include "eth400g_mac_rspec_tv80_intr.h"
#include "eth400g_mac_rspec_tv80_stall_on_error.h"
#include "eth400g_mac_rspec_tv80_watchdog_count.h"
#include "eth400g_mac_rspec_tv80_watchdog_ctrl.h"
#include "eth400g_mac_rspec_tv80mem_mbe_err_log.h"
#include "eth400g_mac_rspec_tv80mem_sbe_err_log.h"
#include "eth400g_mac_rspec_txappfifo_mbe_err_log.h"
#include "eth400g_mac_rspec_txappfifo_sbe_err_log.h"
#include "eth400g_mac_rspec_txcrc_trunc_ctrl.h"
#include "eth400g_mac_rspec_txff_ctrl.h"
#include "eth400g_mac_rspec_txff_ecc.h"
#include "eth400g_mac_rspec_txff_status.h"
#include "eth400g_mac_rspec_txfifo_mbe_err_log.h"
#include "eth400g_mac_rspec_txfifo_sbe_err_log.h"
#include "eth400g_mac_rspec_uctrl_intr.h"

namespace jbay {
  namespace register_classes {

class Eth400gMacRspec : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum JbayRegEnum {
    kEth400gP1,
    kEth400gP10,
...
public:
  Eth400gMacRspec(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_jbay_reg), 660, false, write_callback, read_callback, std::string("Eth400gMacRspec")+":"+boost::lexical_cast<std::string>(selector_jbay_reg))
    {
    }
  Eth400gMacRspec(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "Eth400gMacRspec")
    {
    }
public:
  ...
  Eth400gMacRspecEthSoftReset &eth_soft_reset() { return eth_soft_reset_; }
  ...
  Eth400gMacRspecChnlSeq &chnl_seq() { return chnl_seq_; }
  ...
  Eth400gMacRspecPortAliveLut &port_alive_lut() { return port_alive_lut_; }





  Eth400gMacRspecEthClkobsCtrl &eth_clkobs_ctrl() { return eth_clkobs_ctrl_; }
  ...
  Eth400gMacRspecEthOnestepEtsOffsetCtrl &eth_onestep_ets_offset_ctrl(int j0) { return eth_onestep_ets_offset_ctrl_[j0]; }





  Eth400gMacRspecEthMacTsOffsetCtrl &eth_mac_ts_offset_ctrl() { return eth_mac_ts_offset_ctrl_; }





  Eth400gMacRspecEthStatus0 &eth_status0() { return eth_status0_; }





  Eth400gMacRspecEthStatus1 &eth_status1() { return eth_status1_; }
  ...
  Eth400gMacRspecGlobalIntrStat &global_intr_stat() { return global_intr_stat_; }





  Eth400gMacRspecCtsFifoStat &cts_fifo_stat() { return cts_fifo_stat_; }
  ...
  Eth400gMacRspecTxffCtrl &txff_ctrl(int j0) { return txff_ctrl_[j0]; }
  ...
  Eth400gMacRspecTxffStatus &txff_status(int j0) { return txff_status_[j0]; }
  ...
  Eth400gMacRspecTxcrcTruncCtrl &txcrc_trunc_ctrl(int j0) { return txcrc_trunc_ctrl_[j0]; }
  ...
  Eth400gMacRspecRxffCtrl &rxff_ctrl(int j0) { return rxff_ctrl_[j0]; }
  ...
  Eth400gMacRspecRxpktErrSts &rxpkt_err_sts(int j0) { return rxpkt_err_sts_[j0]; }
  ...
  Eth400gMacRspecCtsFifoOut &cts_fifo_out(int j0) { return cts_fifo_out_[j0]; }





  Eth400gMacRspecEthRingAddr &eth_ring_addr() { return eth_ring_addr_; }





  Eth400gMacRspecEthRingWdata &eth_ring_wdata() { return eth_ring_wdata_; }





  Eth400gMacRspecEthRingRdata &eth_ring_rdata() { return eth_ring_rdata_; }





  Eth400gMacRspecEthRingCtrl &eth_ring_ctrl() { return eth_ring_ctrl_; }





  Eth400gMacRspecEthRingSetup &eth_ring_setup() { return eth_ring_setup_; }





  Eth400gMacRspecSoftPortAlive &soft_port_alive() { return soft_port_alive_; }
  ...
  Eth400gMacRspecTxffEcc &txff_ecc() { return txff_ecc_; }
  ...
  Eth400gMacRspecRxffStatEcc &rxff_stat_ecc() { return rxff_stat_ecc_; }





  Eth400gMacRspecTxfifoSbeErrLog &txfifo_sbe_err_log() { return txfifo_sbe_err_log_; }





  Eth400gMacRspecTxfifoMbeErrLog &txfifo_mbe_err_log() { return txfifo_mbe_err_log_; }





  Eth400gMacRspecTxappfifoSbeErrLog &txappfifo_sbe_err_log() { return txappfifo_sbe_err_log_; }





  Eth400gMacRspecTxappfifoMbeErrLog &txappfifo_mbe_err_log() { return txappfifo_mbe_err_log_; }





  Eth400gMacRspecRxappfifoSbeErrLog &rxappfifo_sbe_err_log() { return rxappfifo_sbe_err_log_; }





  Eth400gMacRspecRxappfifoMbeErrLog &rxappfifo_mbe_err_log() { return rxappfifo_mbe_err_log_; }





  Eth400gMacRspecStatsmemSbeErrLog &statsmem_sbe_err_log() { return statsmem_sbe_err_log_; }





  Eth400gMacRspecStatsmemMbeErrLog &statsmem_mbe_err_log() { return statsmem_mbe_err_log_; }





  Eth400gMacRspecTv80memSbeErrLog &tv80mem_sbe_err_log() { return tv80mem_sbe_err_log_; }





  Eth400gMacRspecTv80memMbeErrLog &tv80mem_mbe_err_log() { return tv80mem_mbe_err_log_; }
  ...
  Eth400gMacRspecMacEn0 &mac_en0() { return mac_en0_; }
  ...
  Eth400gMacRspecMacEn1 &mac_en1() { return mac_en1_; }





  Eth400gMacRspecMacFreezeEnable &mac_freeze_enable() { return mac_freeze_enable_; }
  ...
  Eth400gMacRspecCrcerrInj &crcerr_inj() { return crcerr_inj_; }
  ...
  Eth400gMacRspecTv80DebugCtrl &tv80_debug_ctrl() { return tv80_debug_ctrl_; }
  ...
  Eth400gMacRspecTv80DebugHeadPtr &tv80_debug_head_ptr() { return tv80_debug_head_ptr_; }
  ...
  Eth400gMacRspecTv80DebugTailPtr &tv80_debug_tail_ptr() { return tv80_debug_tail_ptr_; }
  ...
  Eth400gMacRspecTv80StallOnError &tv80_stall_on_error() { return tv80_stall_on_error_; }





  Eth400gMacRspecTv80HaltedStatus &tv80_halted_status() { return tv80_halted_status_; }





  Eth400gMacRspecTv80WatchdogCtrl &tv80_watchdog_ctrl() { return tv80_watchdog_ctrl_; }
  ...
  Eth400gMacRspecTv80WatchdogCount &tv80_watchdog_count() { return tv80_watchdog_count_; }
  ...
  Eth400gMacRspecEthMdiociAddr &eth_mdioci_addr() { return eth_mdioci_addr_; }
  Eth400gMacRspecChnlIntr &chnl_intr() { return chnl_intr_; }
  Eth400gMacRspecCtsIntr &cts_intr() { return cts_intr_; }
  Eth400gMacRspecMemIntr &mem_intr() { return mem_intr_; }
  Eth400gMacRspecUctrlIntr &uctrl_intr() { return uctrl_intr_; }
  Eth400gMacRspecTv80Intr &tv80_intr() { return tv80_intr_; }
...
private:
  Eth400gMacRspecEthSoftReset eth_soft_reset_;
  Eth400gMacRspecChnlSeq chnl_seq_;
  Eth400gMacRspecPortAliveLut port_alive_lut_;
  Eth400gMacRspecEthClkobsCtrl eth_clkobs_ctrl_;
  std::array< Eth400gMacRspecEthOnestepEtsOffsetCtrl, 8 > eth_onestep_ets_offset_ctrl_;
  Eth400gMacRspecEthMacTsOffsetCtrl eth_mac_ts_offset_ctrl_;
  Eth400gMacRspecEthStatus0 eth_status0_;
  Eth400gMacRspecEthStatus1 eth_status1_;
  Eth400gMacRspecGlobalIntrStat global_intr_stat_;
  Eth400gMacRspecCtsFifoStat cts_fifo_stat_;
  std::array< Eth400gMacRspecTxffCtrl, 8 > txff_ctrl_;
  std::array< Eth400gMacRspecTxffStatus, 8 > txff_status_;
  std::array< Eth400gMacRspecTxcrcTruncCtrl, 8 > txcrc_trunc_ctrl_;
  std::array< Eth400gMacRspecRxffCtrl, 8 > rxff_ctrl_;
  std::array< Eth400gMacRspecRxpktErrSts, 8 > rxpkt_err_sts_;
  std::array< Eth400gMacRspecCtsFifoOut, 8 > cts_fifo_out_;
  Eth400gMacRspecEthRingAddr eth_ring_addr_;
  Eth400gMacRspecEthRingWdata eth_ring_wdata_;
  Eth400gMacRspecEthRingRdata eth_ring_rdata_;
  Eth400gMacRspecEthRingCtrl eth_ring_ctrl_;
  Eth400gMacRspecEthRingSetup eth_ring_setup_;
  Eth400gMacRspecSoftPortAlive soft_port_alive_;
  Eth400gMacRspecTxffEcc txff_ecc_;
  Eth400gMacRspecRxffStatEcc rxff_stat_ecc_;
  Eth400gMacRspecTxfifoSbeErrLog txfifo_sbe_err_log_;
  Eth400gMacRspecTxfifoMbeErrLog txfifo_mbe_err_log_;
  Eth400gMacRspecTxappfifoSbeErrLog txappfifo_sbe_err_log_;
  Eth400gMacRspecTxappfifoMbeErrLog txappfifo_mbe_err_log_;
  Eth400gMacRspecRxappfifoSbeErrLog rxappfifo_sbe_err_log_;
  Eth400gMacRspecRxappfifoMbeErrLog rxappfifo_mbe_err_log_;
  Eth400gMacRspecStatsmemSbeErrLog statsmem_sbe_err_log_;
  Eth400gMacRspecStatsmemMbeErrLog statsmem_mbe_err_log_;
  Eth400gMacRspecTv80memSbeErrLog tv80mem_sbe_err_log_;
  Eth400gMacRspecTv80memMbeErrLog tv80mem_mbe_err_log_;
  Eth400gMacRspecMacEn0 mac_en0_;
  Eth400gMacRspecMacEn1 mac_en1_;
  Eth400gMacRspecMacFreezeEnable mac_freeze_enable_;
  Eth400gMacRspecCrcerrInj crcerr_inj_;
  Eth400gMacRspecTv80DebugCtrl tv80_debug_ctrl_;
  Eth400gMacRspecTv80DebugHeadPtr tv80_debug_head_ptr_;
  Eth400gMacRspecTv80DebugTailPtr tv80_debug_tail_ptr_;
  Eth400gMacRspecTv80StallOnError tv80_stall_on_error_;
  Eth400gMacRspecTv80HaltedStatus tv80_halted_status_;
  Eth400gMacRspecTv80WatchdogCtrl tv80_watchdog_ctrl_;
  Eth400gMacRspecTv80WatchdogCount tv80_watchdog_count_;
  Eth400gMacRspecEthMdiociAddr eth_mdioci_addr_;
  Eth400gMacRspecChnlIntr chnl_intr_;
  Eth400gMacRspecCtsIntr cts_intr_;
  Eth400gMacRspecMemIntr mem_intr_;
  Eth400gMacRspecUctrlIntr uctrl_intr_;
  Eth400gMacRspecTv80Intr tv80_intr_;
private:
...
#endif // __REGISTER_INCLUDES_ETH400G_MAC_RSPEC_H__
