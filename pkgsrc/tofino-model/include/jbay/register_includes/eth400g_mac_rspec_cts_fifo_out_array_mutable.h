...
#ifndef __REGISTER_INCLUDES_ETH400G_MAC_RSPEC_CTS_FIFO_OUT_ARRAY_MUTABLE_H__
#define __REGISTER_INCLUDES_ETH400G_MAC_RSPEC_CTS_FIFO_OUT_ARRAY_MUTABLE_H__
...
class Eth400gMacRspecCtsFifoOutArrayMutable : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  enum JbayRegEnum {
    kEth400gP1,
    kEth400gP10,
...
public:
  Eth400gMacRspecCtsFifoOutArrayMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_jbay_reg), 8 * ArraySize(selector_jbay_reg, -1), true, write_callback, read_callback, std::string("Eth400gMacRspecCtsFifoOutArrayMutable")+":"+boost::lexical_cast<std::string>(selector_jbay_reg)),
...
public:
  ...
  uint64_t cts(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    return array[a0].cts();
  }
  void cts(uint32_t a0,const uint64_t &v) 
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    array[a0].cts(v);
  }
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("Eth400gMacRspecCtsFifoOutArrayMutable") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
private:
  std::vector<Eth400gMacRspecCtsFifoOutMutable> array;
  uint32_t size0_;
...
#endif // __REGISTER_INCLUDES_ETH400G_MAC_RSPEC_CTS_FIFO_OUT_ARRAY_MUTABLE_H__
