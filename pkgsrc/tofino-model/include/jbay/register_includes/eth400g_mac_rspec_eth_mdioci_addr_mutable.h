...
#ifndef __REGISTER_INCLUDES_ETH400G_MAC_RSPEC_ETH_MDIOCI_ADDR_MUTABLE_H__
#define __REGISTER_INCLUDES_ETH400G_MAC_RSPEC_ETH_MDIOCI_ADDR_MUTABLE_H__
...
class Eth400gMacRspecEthMdiociAddrMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum JbayRegEnum {
    kEth400gP1,
    kEth400gP10,
...
public:
  Eth400gMacRspecEthMdiociAddrMutable(
      int chipNumber, JbayRegEnum selector_jbay_reg, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(selector_jbay_reg), 4, true, write_callback, read_callback, std::string("Eth400gMacRspecEthMdiociAddrMutable")+":"+boost::lexical_cast<std::string>(selector_jbay_reg))
    {
    }
  Eth400gMacRspecEthMdiociAddrMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "Eth400gMacRspecEthMdiociAddrMutable")
    {
    }
public:
  ...
  void cpu_addrreg(const uint8_t &v) { cpu_addrreg_=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("Eth400gMacRspecEthMdiociAddrMutable") + ":\n";
  ...
  static int StartOffset(
    ...
    switch (selector_jbay_reg) {
      case kEth400gP1:
        ...
        offset += 0x290; // to get to eth_mdioci_addr
        break;
      case kEth400gP10:
...
#endif // __REGISTER_INCLUDES_ETH400G_MAC_RSPEC_ETH_MDIOCI_ADDR_MUTABLE_H__
