...
#ifndef __REGISTER_INCLUDES_ETH400G_MAC_RSPEC_ETH_RING_RDATA_MUTABLE_H__
#define __REGISTER_INCLUDES_ETH400G_MAC_RSPEC_ETH_RING_RDATA_MUTABLE_H__
...
class Eth400gMacRspecEthRingRdataMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum JbayRegEnum {
    kEth400gP1,
    kEth400gP10,
...
public:
  Eth400gMacRspecEthRingRdataMutable(
      int chipNumber, JbayRegEnum selector_jbay_reg, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(selector_jbay_reg), 4, true, write_callback, read_callback, std::string("Eth400gMacRspecEthRingRdataMutable")+":"+boost::lexical_cast<std::string>(selector_jbay_reg))
    {
    }
  Eth400gMacRspecEthRingRdataMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "Eth400gMacRspecEthRingRdataMutable")
    {
    }
public:
  ...
  uint32_t rdata() { return rdata_; }
  void rdata(const uint32_t &v) { rdata_=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("Eth400gMacRspecEthRingRdataMutable") + ":\n";
    r += indent_string + "  " + std::string("rdata") +  ": 0x" + boost::str( boost::format("%x") % static_cast<uint>(rdata_) ) + "\n";
    all_zeros &= (0 == rdata_);
  ...
  static int StartOffset(
    ...
    switch (selector_jbay_reg) {
      case kEth400gP1:
        ...
        offset += 0x188; // to get to eth_ring_rdata
        break;
      case kEth400gP10:
...
#endif // __REGISTER_INCLUDES_ETH400G_MAC_RSPEC_ETH_RING_RDATA_MUTABLE_H__
