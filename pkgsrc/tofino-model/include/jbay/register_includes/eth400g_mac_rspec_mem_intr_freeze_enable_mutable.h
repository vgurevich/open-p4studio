...
#ifndef __REGISTER_INCLUDES_ETH400G_MAC_RSPEC_MEM_INTR_FREEZE_ENABLE_MUTABLE_H__
#define __REGISTER_INCLUDES_ETH400G_MAC_RSPEC_MEM_INTR_FREEZE_ENABLE_MUTABLE_H__
...
class Eth400gMacRspecMemIntrFreezeEnableMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum JbayRegEnum {
    kEth400gP1,
    kEth400gP10,
...
public:
  Eth400gMacRspecMemIntrFreezeEnableMutable(
      int chipNumber, JbayRegEnum selector_jbay_reg, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(selector_jbay_reg), 4, true, write_callback, read_callback, std::string("Eth400gMacRspecMemIntrFreezeEnableMutable")+":"+boost::lexical_cast<std::string>(selector_jbay_reg))
    {
    }
  Eth400gMacRspecMemIntrFreezeEnableMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "Eth400gMacRspecMemIntrFreezeEnableMutable")
    {
    }
public:
  uint8_t txfifo_sbe() { return txfifo_sbe_; }
  void txfifo_sbe(const uint8_t &v) { txfifo_sbe_=v; }
  uint8_t txfifo_mbe() { return txfifo_mbe_; }
  void txfifo_mbe(const uint8_t &v) { txfifo_mbe_=v; }
  uint8_t txappfifo_sbe() { return txappfifo_sbe_; }
  void txappfifo_sbe(const uint8_t &v) { txappfifo_sbe_=v; }
  uint8_t txappfifo_mbe() { return txappfifo_mbe_; }
  void txappfifo_mbe(const uint8_t &v) { txappfifo_mbe_=v; }
  uint8_t rxappfifo_sbe() { return rxappfifo_sbe_; }
  void rxappfifo_sbe(const uint8_t &v) { rxappfifo_sbe_=v; }
  uint8_t rxappfifo_mbe() { return rxappfifo_mbe_; }
  void rxappfifo_mbe(const uint8_t &v) { rxappfifo_mbe_=v; }
  uint8_t statsmem_sbe() { return statsmem_sbe_; }
  void statsmem_sbe(const uint8_t &v) { statsmem_sbe_=v; }
  uint8_t statsmem_mbe() { return statsmem_mbe_; }
  void statsmem_mbe(const uint8_t &v) { statsmem_mbe_=v; }
  uint8_t tv80mem_sbe() { return tv80mem_sbe_; }
  void tv80mem_sbe(const uint8_t &v) { tv80mem_sbe_=v; }
  uint8_t tv80mem_mbe() { return tv80mem_mbe_; }
  void tv80mem_mbe(const uint8_t &v) { tv80mem_mbe_=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("Eth400gMacRspecMemIntrFreezeEnableMutable") + ":\n";
  ...
  static int StartOffset(
    ...
    switch (selector_jbay_reg) {
      case kEth400gP1:
        ...
        offset += 0x1f0; // to get to mem_intr_freeze_enable
        break;
      case kEth400gP10:
...
#endif // __REGISTER_INCLUDES_ETH400G_MAC_RSPEC_MEM_INTR_FREEZE_ENABLE_MUTABLE_H__
