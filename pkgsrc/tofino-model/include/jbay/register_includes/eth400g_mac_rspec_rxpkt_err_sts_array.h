...
#ifndef __REGISTER_INCLUDES_ETH400G_MAC_RSPEC_RXPKT_ERR_STS_ARRAY_H__
#define __REGISTER_INCLUDES_ETH400G_MAC_RSPEC_RXPKT_ERR_STS_ARRAY_H__
...
class Eth400gMacRspecRxpktErrStsArray : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  enum JbayRegEnum {
    kEth400gP1,
    kEth400gP10,
...
public:
  Eth400gMacRspecRxpktErrStsArray(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_jbay_reg), 4 * ArraySize(selector_jbay_reg, -1), false, write_callback, read_callback, std::string("Eth400gMacRspecRxpktErrStsArray")+":"+boost::lexical_cast<std::string>(selector_jbay_reg)),
...
public:
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("Eth400gMacRspecRxpktErrStsArray") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
private:
  std::vector<Eth400gMacRspecRxpktErrSts> array;
  uint32_t size0_;
...
#endif // __REGISTER_INCLUDES_ETH400G_MAC_RSPEC_RXPKT_ERR_STS_ARRAY_H__
