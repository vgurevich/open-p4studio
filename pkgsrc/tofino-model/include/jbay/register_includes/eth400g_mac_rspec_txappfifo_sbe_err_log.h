...
#ifndef __REGISTER_INCLUDES_ETH400G_MAC_RSPEC_TXAPPFIFO_SBE_ERR_LOG_H__
#define __REGISTER_INCLUDES_ETH400G_MAC_RSPEC_TXAPPFIFO_SBE_ERR_LOG_H__
...
class Eth400gMacRspecTxappfifoSbeErrLog : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum JbayRegEnum {
    kEth400gP1,
    kEth400gP10,
...
public:
  Eth400gMacRspecTxappfifoSbeErrLog(
      int chipNumber, JbayRegEnum selector_jbay_reg, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(selector_jbay_reg), 4, false, write_callback, read_callback, std::string("Eth400gMacRspecTxappfifoSbeErrLog")+":"+boost::lexical_cast<std::string>(selector_jbay_reg))
    {
    }
  Eth400gMacRspecTxappfifoSbeErrLog(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "Eth400gMacRspecTxappfifoSbeErrLog")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("Eth400gMacRspecTxappfifoSbeErrLog") + ":\n";
...
#endif // __REGISTER_INCLUDES_ETH400G_MAC_RSPEC_TXAPPFIFO_SBE_ERR_LOG_H__
