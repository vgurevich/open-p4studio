...
#ifndef __REGISTER_INCLUDES_ETH400G_MAC_RSPEC_TXCRC_TRUNC_CTRL_MUTABLE_H__
#define __REGISTER_INCLUDES_ETH400G_MAC_RSPEC_TXCRC_TRUNC_CTRL_MUTABLE_H__
...
class Eth400gMacRspecTxcrcTruncCtrlMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum JbayRegEnum {
    kEth400gP1,
    kEth400gP10,
...
public:
  Eth400gMacRspecTxcrcTruncCtrlMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_jbay_reg, index_eth400g_mac_rspec_txcrc_trunc_ctrl), 4, true, write_callback, read_callback, std::string("Eth400gMacRspecTxcrcTruncCtrlMutable")+":"+boost::lexical_cast<std::string>(selector_jbay_reg) + "," + boost::lexical_cast<std::string>(index_eth400g_mac_rspec_txcrc_trunc_ctrl))
    {
    }
  Eth400gMacRspecTxcrcTruncCtrlMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "Eth400gMacRspecTxcrcTruncCtrlMutable")
    {
    }
public:
  ...
  void trunc_ena(const uint8_t &v) { trunc_ena_=v; }
  ...
  void trunc_size(const uint16_t &v) { trunc_size_=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("Eth400gMacRspecTxcrcTruncCtrlMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_ETH400G_MAC_RSPEC_TXCRC_TRUNC_CTRL_MUTABLE_H__
