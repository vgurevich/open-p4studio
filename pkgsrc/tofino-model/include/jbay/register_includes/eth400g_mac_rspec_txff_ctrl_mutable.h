...
#ifndef __REGISTER_INCLUDES_ETH400G_MAC_RSPEC_TXFF_CTRL_MUTABLE_H__
#define __REGISTER_INCLUDES_ETH400G_MAC_RSPEC_TXFF_CTRL_MUTABLE_H__
...
class Eth400gMacRspecTxffCtrlMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum JbayRegEnum {
    kEth400gP1,
    kEth400gP10,
...
public:
  Eth400gMacRspecTxffCtrlMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_jbay_reg, index_eth400g_mac_rspec_txff_ctrl), 4, true, write_callback, read_callback, std::string("Eth400gMacRspecTxffCtrlMutable")+":"+boost::lexical_cast<std::string>(selector_jbay_reg) + "," + boost::lexical_cast<std::string>(index_eth400g_mac_rspec_txff_ctrl))
    {
    }
  Eth400gMacRspecTxffCtrlMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "Eth400gMacRspecTxffCtrlMutable")
    {
    }
public:
  ...
  void tx_flush(const uint8_t &v) { tx_flush_=v; }
  ...
  void rx_xoff_mode(const uint8_t &v) { rx_xoff_mode_=v; }
  ...
  void ovr_rx_pfcxoff(const uint8_t &v) { ovr_rx_pfcxoff_=v; }
  ...
  void txrx_lpbk(const uint8_t &v) { txrx_lpbk_=v; }
  ...
  void val_rx_pfcxoff(const uint8_t &v) { val_rx_pfcxoff_=v; }
  ...
  void cred_ini(const uint8_t &v) { cred_ini_=v; }
  ...
  void min_thr(const uint8_t &v) { min_thr_=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("Eth400gMacRspecTxffCtrlMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_ETH400G_MAC_RSPEC_TXFF_CTRL_MUTABLE_H__
