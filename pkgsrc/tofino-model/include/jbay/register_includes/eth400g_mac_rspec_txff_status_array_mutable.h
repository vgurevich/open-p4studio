...
#ifndef __REGISTER_INCLUDES_ETH400G_MAC_RSPEC_TXFF_STATUS_ARRAY_MUTABLE_H__
#define __REGISTER_INCLUDES_ETH400G_MAC_RSPEC_TXFF_STATUS_ARRAY_MUTABLE_H__
...
class Eth400gMacRspecTxffStatusArrayMutable : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  enum JbayRegEnum {
    kEth400gP1,
    kEth400gP10,
...
public:
  Eth400gMacRspecTxffStatusArrayMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_jbay_reg), 4 * ArraySize(selector_jbay_reg, -1), true, write_callback, read_callback, std::string("Eth400gMacRspecTxffStatusArrayMutable")+":"+boost::lexical_cast<std::string>(selector_jbay_reg)),
...
public:
  ...
  uint8_t pfc_rxxoff(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    return array[a0].pfc_rxxoff();
  }
  void pfc_rxxoff(uint32_t a0,const uint8_t &v) 
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    array[a0].pfc_rxxoff(v);
  }
  ...
  uint16_t txff_count(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    return array[a0].txff_count();
  }
  void txff_count(uint32_t a0,const uint16_t &v) 
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    array[a0].txff_count(v);
  }
  ...
  uint8_t txff_eopcnt(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    return array[a0].txff_eopcnt();
  }
  void txff_eopcnt(uint32_t a0,const uint8_t &v) 
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    array[a0].txff_eopcnt(v);
  }
  ...
  uint8_t txappfifo_count(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    return array[a0].txappfifo_count();
  }
  void txappfifo_count(uint32_t a0,const uint8_t &v) 
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    array[a0].txappfifo_count(v);
  }
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("Eth400gMacRspecTxffStatusArrayMutable") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
private:
  std::vector<Eth400gMacRspecTxffStatusMutable> array;
  uint32_t size0_;
...
#endif // __REGISTER_INCLUDES_ETH400G_MAC_RSPEC_TXFF_STATUS_ARRAY_MUTABLE_H__
