...
#ifndef __REGISTER_INCLUDES_ETH400G_MAC_RSPEC_UCTRL_INTR_MUTABLE_H__
#define __REGISTER_INCLUDES_ETH400G_MAC_RSPEC_UCTRL_INTR_MUTABLE_H__
...
#include "eth400g_mac_rspec_uctrl_intr_en0_mutable.h"
#include "eth400g_mac_rspec_uctrl_intr_en1_mutable.h"
#include "eth400g_mac_rspec_uctrl_intr_freeze_enable_mutable.h"
#include "eth400g_mac_rspec_uctrl_intr_inj_mutable.h"
#include "eth400g_mac_rspec_uctrl_intr_stat_mutable.h"

namespace jbay {
  namespace register_classes {

class Eth400gMacRspecUctrlIntrMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum JbayRegEnum {
    kEth400gP1,
    kEth400gP10,
...
public:
  Eth400gMacRspecUctrlIntrMutable(
      int chipNumber, JbayRegEnum selector_jbay_reg, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(selector_jbay_reg), 20, true, write_callback, read_callback, std::string("Eth400gMacRspecUctrlIntrMutable")+":"+boost::lexical_cast<std::string>(selector_jbay_reg))
    {
    }
  Eth400gMacRspecUctrlIntrMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "Eth400gMacRspecUctrlIntrMutable")
    {
    }
public:
  ...
  Eth400gMacRspecUctrlIntrStatMutable &uctrl_intr_stat() { return uctrl_intr_stat_; }
  ...
  Eth400gMacRspecUctrlIntrEn0Mutable &uctrl_intr_en0() { return uctrl_intr_en0_; }
  ...
  Eth400gMacRspecUctrlIntrEn1Mutable &uctrl_intr_en1() { return uctrl_intr_en1_; }
  ...
  Eth400gMacRspecUctrlIntrInjMutable &uctrl_intr_inj() { return uctrl_intr_inj_; }





  Eth400gMacRspecUctrlIntrFreezeEnableMutable &uctrl_intr_freeze_enable() { return uctrl_intr_freeze_enable_; }
...
private:
  Eth400gMacRspecUctrlIntrStatMutable uctrl_intr_stat_;
  Eth400gMacRspecUctrlIntrEn0Mutable uctrl_intr_en0_;
  Eth400gMacRspecUctrlIntrEn1Mutable uctrl_intr_en1_;
  Eth400gMacRspecUctrlIntrInjMutable uctrl_intr_inj_;
  Eth400gMacRspecUctrlIntrFreezeEnableMutable uctrl_intr_freeze_enable_;
private:
...
#endif // __REGISTER_INCLUDES_ETH400G_MAC_RSPEC_UCTRL_INTR_MUTABLE_H__
