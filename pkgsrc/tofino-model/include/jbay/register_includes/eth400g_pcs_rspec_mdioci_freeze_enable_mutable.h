...
#ifndef __REGISTER_INCLUDES_ETH400G_PCS_RSPEC_MDIOCI_FREEZE_ENABLE_MUTABLE_H__
#define __REGISTER_INCLUDES_ETH400G_PCS_RSPEC_MDIOCI_FREEZE_ENABLE_MUTABLE_H__
...
class Eth400gPcsRspecMdiociFreezeEnableMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum JbayRegEnum {
    kEth400gP1,
    kEth400gP10,
...
public:
  Eth400gPcsRspecMdiociFreezeEnableMutable(
      int chipNumber, JbayRegEnum selector_jbay_reg, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(selector_jbay_reg), 4, true, write_callback, read_callback, std::string("Eth400gPcsRspecMdiociFreezeEnableMutable")+":"+boost::lexical_cast<std::string>(selector_jbay_reg))
    {
    }
  Eth400gPcsRspecMdiociFreezeEnableMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "Eth400gPcsRspecMdiociFreezeEnableMutable")
    {
    }
public:
  uint8_t intr() { return intr_; }
  void intr(const uint8_t &v) { intr_=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("Eth400gPcsRspecMdiociFreezeEnableMutable") + ":\n";
    r += indent_string + "  " + std::string("intr") +  ": 0x" + boost::str( boost::format("%x") % static_cast<uint>(intr_) ) + "\n";
    all_zeros &= (0 == intr_);
  ...
  static int StartOffset(
    ...
    switch (selector_jbay_reg) {
      case kEth400gP1:
        ...
        offset += 0x7c; // to get to mdioci_freeze_enable
        break;
      case kEth400gP10:
...
#endif // __REGISTER_INCLUDES_ETH400G_PCS_RSPEC_MDIOCI_FREEZE_ENABLE_MUTABLE_H__
