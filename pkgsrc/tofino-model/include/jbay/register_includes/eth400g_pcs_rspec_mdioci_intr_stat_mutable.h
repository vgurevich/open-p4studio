...
#ifndef __REGISTER_INCLUDES_ETH400G_PCS_RSPEC_MDIOCI_INTR_STAT_MUTABLE_H__
#define __REGISTER_INCLUDES_ETH400G_PCS_RSPEC_MDIOCI_INTR_STAT_MUTABLE_H__
...
class Eth400gPcsRspecMdiociIntrStatMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum JbayRegEnum {
    kEth400gP1,
    kEth400gP10,
...
public:
  Eth400gPcsRspecMdiociIntrStatMutable(
      int chipNumber, JbayRegEnum selector_jbay_reg, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(selector_jbay_reg), 4, true, write_callback, read_callback, std::string("Eth400gPcsRspecMdiociIntrStatMutable")+":"+boost::lexical_cast<std::string>(selector_jbay_reg))
    {
    }
  Eth400gPcsRspecMdiociIntrStatMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "Eth400gPcsRspecMdiociIntrStatMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("Eth400gPcsRspecMdiociIntrStatMutable") + ":\n";
  ...
  static int StartOffset(
    ...
    switch (selector_jbay_reg) {
      case kEth400gP1:
        ...
        offset += 0x70; // to get to mdioci_intr_stat
        break;
      case kEth400gP10:
...
#endif // __REGISTER_INCLUDES_ETH400G_PCS_RSPEC_MDIOCI_INTR_STAT_MUTABLE_H__
