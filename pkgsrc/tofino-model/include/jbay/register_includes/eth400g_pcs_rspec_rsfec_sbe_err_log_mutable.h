...
#ifndef __REGISTER_INCLUDES_ETH400G_PCS_RSPEC_RSFEC_SBE_ERR_LOG_MUTABLE_H__
#define __REGISTER_INCLUDES_ETH400G_PCS_RSPEC_RSFEC_SBE_ERR_LOG_MUTABLE_H__
...
class Eth400gPcsRspecRsfecSbeErrLogMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum JbayRegEnum {
    kEth400gP1,
    kEth400gP10,
...
public:
  Eth400gPcsRspecRsfecSbeErrLogMutable(
      int chipNumber, JbayRegEnum selector_jbay_reg, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(selector_jbay_reg), 4, true, write_callback, read_callback, std::string("Eth400gPcsRspecRsfecSbeErrLogMutable")+":"+boost::lexical_cast<std::string>(selector_jbay_reg))
    {
    }
  Eth400gPcsRspecRsfecSbeErrLogMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "Eth400gPcsRspecRsfecSbeErrLogMutable")
    {
    }
public:
  uint8_t addr() { return addr_; }
  void addr(const uint8_t &v) { addr_=v; }
  uint8_t instid() { return instid_; }
  void instid(const uint8_t &v) { instid_=v; }
  uint8_t memid() { return memid_; }
  void memid(const uint8_t &v) { memid_=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("Eth400gPcsRspecRsfecSbeErrLogMutable") + ":\n";
    r += indent_string + "  " + std::string("addr") +  ": 0x" + boost::str( boost::format("%x") % static_cast<uint>(addr_) ) + "\n";
    all_zeros &= (0 == addr_);
    r += indent_string + "  " + std::string("instid") +  ": 0x" + boost::str( boost::format("%x") % static_cast<uint>(instid_) ) + "\n";
    all_zeros &= (0 == instid_);
    r += indent_string + "  " + std::string("memid") +  ": 0x" + boost::str( boost::format("%x") % static_cast<uint>(memid_) ) + "\n";
    all_zeros &= (0 == memid_);
  ...
  static int StartOffset(
    ...
    switch (selector_jbay_reg) {
      case kEth400gP1:
        ...
        offset += 0x68; // to get to rsfec_sbe_err_log
        break;
      case kEth400gP10:
...
#endif // __REGISTER_INCLUDES_ETH400G_PCS_RSPEC_RSFEC_SBE_ERR_LOG_MUTABLE_H__
