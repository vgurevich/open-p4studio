...
#ifndef __REGISTER_INCLUDES_ETH400G_PCS_RSPEC_SDS_112G_MUTABLE_H__
#define __REGISTER_INCLUDES_ETH400G_PCS_RSPEC_SDS_112G_MUTABLE_H__
...
class Eth400gPcsRspecSds_112gMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum JbayRegEnum {
    kEth400gP1,
    kEth400gP10,
...
public:
  Eth400gPcsRspecSds_112gMutable(
      int chipNumber, JbayRegEnum selector_jbay_reg, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(selector_jbay_reg), 4, true, write_callback, read_callback, std::string("Eth400gPcsRspecSds_112gMutable")+":"+boost::lexical_cast<std::string>(selector_jbay_reg))
    {
    }
  Eth400gPcsRspecSds_112gMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "Eth400gPcsRspecSds_112gMutable")
    {
    }
public:
  ...
  uint8_t rx_ckmux() { return rx_ckmux_; }
  void rx_ckmux(const uint8_t &v) { rx_ckmux_=v; }
  ...
  uint8_t tx_ckmux() { return tx_ckmux_; }
  void tx_ckmux(const uint8_t &v) { tx_ckmux_=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("Eth400gPcsRspecSds_112gMutable") + ":\n";
    r += indent_string + "  " + std::string("mode") +  ": 0x" + boost::str( boost::format("%x") % static_cast<uint>(mode_) ) + "\n";
    all_zeros &= (0 == mode_);
    r += indent_string + "  " + std::string("rx_ckmux") +  ": 0x" + boost::str( boost::format("%x") % static_cast<uint>(rx_ckmux_) ) + "\n";
    all_zeros &= (0 == rx_ckmux_);
    r += indent_string + "  " + std::string("tx_ckmux") +  ": 0x" + boost::str( boost::format("%x") % static_cast<uint>(tx_ckmux_) ) + "\n";
    all_zeros &= (0 == tx_ckmux_);
  ...
  static int StartOffset(
    ...
    switch (selector_jbay_reg) {
      case kEth400gP1:
        ...
        offset += 0x88; // to get to sds_112g
        break;
      case kEth400gP10:
...
#endif // __REGISTER_INCLUDES_ETH400G_PCS_RSPEC_SDS_112G_MUTABLE_H__
