...
#ifndef __REGISTER_INCLUDES_GLB_GROUP_INTR_STAT_EN0_MUTABLE_H__
#define __REGISTER_INCLUDES_GLB_GROUP_INTR_STAT_EN0_MUTABLE_H__
...
class GlbGroupIntrStatEn0Mutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  GlbGroupIntrStatEn0Mutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_ipb_prsr4_reg), 8, true, write_callback, read_callback, std::string("GlbGroupIntrStatEn0Mutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_ipb_prsr4_reg))
    {
    }
  GlbGroupIntrStatEn0Mutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "GlbGroupIntrStatEn0Mutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("GlbGroupIntrStatEn0Mutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x48; // to get to glb_group_intr_stat_en0
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_GLB_GROUP_INTR_STAT_EN0_MUTABLE_H__
