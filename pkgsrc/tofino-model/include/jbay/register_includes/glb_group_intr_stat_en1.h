...
#ifndef __REGISTER_INCLUDES_GLB_GROUP_INTR_STAT_EN1_H__
#define __REGISTER_INCLUDES_GLB_GROUP_INTR_STAT_EN1_H__
...
class GlbGroupIntrStatEn1 : public model_core::RegisterBlock<RegisterCallback> {
public:
  GlbGroupIntrStatEn1(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_ipb_prsr4_reg), 8, false, write_callback, read_callback, std::string("GlbGroupIntrStatEn1")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_ipb_prsr4_reg))
    {
    }
  GlbGroupIntrStatEn1(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "GlbGroupIntrStatEn1")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("GlbGroupIntrStatEn1") + ":\n";
...
#endif // __REGISTER_INCLUDES_GLB_GROUP_INTR_STAT_EN1_H__
