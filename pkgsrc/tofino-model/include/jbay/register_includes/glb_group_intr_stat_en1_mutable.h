...
#ifndef __REGISTER_INCLUDES_GLB_GROUP_INTR_STAT_EN1_MUTABLE_H__
#define __REGISTER_INCLUDES_GLB_GROUP_INTR_STAT_EN1_MUTABLE_H__
...
class GlbGroupIntrStatEn1Mutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  GlbGroupIntrStatEn1Mutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_ipb_prsr4_reg), 8, true, write_callback, read_callback, std::string("GlbGroupIntrStatEn1Mutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_ipb_prsr4_reg))
    {
    }
  GlbGroupIntrStatEn1Mutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "GlbGroupIntrStatEn1Mutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("GlbGroupIntrStatEn1Mutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_GLB_GROUP_INTR_STAT_EN1_MUTABLE_H__
