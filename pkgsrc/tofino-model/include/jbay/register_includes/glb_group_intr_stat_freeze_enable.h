...
#ifndef __REGISTER_INCLUDES_GLB_GROUP_INTR_STAT_FREEZE_ENABLE_H__
#define __REGISTER_INCLUDES_GLB_GROUP_INTR_STAT_FREEZE_ENABLE_H__
...
class GlbGroupIntrStatFreezeEnable : public model_core::RegisterBlock<RegisterCallback> {
public:
  GlbGroupIntrStatFreezeEnable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_ipb_prsr4_reg), 8, false, write_callback, read_callback, std::string("GlbGroupIntrStatFreezeEnable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_ipb_prsr4_reg))
    {
    }
  GlbGroupIntrStatFreezeEnable(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "GlbGroupIntrStatFreezeEnable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("GlbGroupIntrStatFreezeEnable") + ":\n";
...
#endif // __REGISTER_INCLUDES_GLB_GROUP_INTR_STAT_FREEZE_ENABLE_H__
