...
#ifndef __REGISTER_INCLUDES_GLB_GROUP_INTR_STAT_FREEZE_ENABLE_MUTABLE_H__
#define __REGISTER_INCLUDES_GLB_GROUP_INTR_STAT_FREEZE_ENABLE_MUTABLE_H__
...
class GlbGroupIntrStatFreezeEnableMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  GlbGroupIntrStatFreezeEnableMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_ipb_prsr4_reg), 8, true, write_callback, read_callback, std::string("GlbGroupIntrStatFreezeEnableMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_ipb_prsr4_reg))
    {
    }
  GlbGroupIntrStatFreezeEnableMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "GlbGroupIntrStatFreezeEnableMutable")
    {
    }
public:
  uint8_t resubmit_twice() { return resubmit_twice_; }
  void resubmit_twice(const uint8_t &v) { resubmit_twice_=v; }
  uint8_t pc_fatal() { return pc_fatal_; }
  void pc_fatal(const uint8_t &v) { pc_fatal_=v; }
  uint8_t mac_protocol() { return mac_protocol_; }
  void mac_protocol(const uint8_t &v) { mac_protocol_=v; }
  uint8_t mac_runt_pkt() { return mac_runt_pkt_; }
  void mac_runt_pkt(const uint8_t &v) { mac_runt_pkt_=v; }
  uint8_t mac_oversz_pkt() { return mac_oversz_pkt_; }
  void mac_oversz_pkt(const uint8_t &v) { mac_oversz_pkt_=v; }
  uint8_t free_addr_uninit0() { return free_addr_uninit0_; }
  void free_addr_uninit0(const uint8_t &v) { free_addr_uninit0_=v; }
  uint8_t free_addr_uninit1() { return free_addr_uninit1_; }
  void free_addr_uninit1(const uint8_t &v) { free_addr_uninit1_=v; }
  uint8_t free_addr_uninit2() { return free_addr_uninit2_; }
  void free_addr_uninit2(const uint8_t &v) { free_addr_uninit2_=v; }
  uint8_t free_addr_uninit3() { return free_addr_uninit3_; }
  void free_addr_uninit3(const uint8_t &v) { free_addr_uninit3_=v; }
  uint8_t prsr_pkt_ctl_fatal0() { return prsr_pkt_ctl_fatal0_; }
  void prsr_pkt_ctl_fatal0(const uint8_t &v) { prsr_pkt_ctl_fatal0_=v; }
  uint8_t prsr_pkt_ctl_fatal1() { return prsr_pkt_ctl_fatal1_; }
  void prsr_pkt_ctl_fatal1(const uint8_t &v) { prsr_pkt_ctl_fatal1_=v; }
  uint8_t prsr_pkt_ctl_fatal2() { return prsr_pkt_ctl_fatal2_; }
  void prsr_pkt_ctl_fatal2(const uint8_t &v) { prsr_pkt_ctl_fatal2_=v; }
  uint8_t prsr_pkt_ctl_fatal3() { return prsr_pkt_ctl_fatal3_; }
  void prsr_pkt_ctl_fatal3(const uint8_t &v) { prsr_pkt_ctl_fatal3_=v; }
  uint8_t dprsr_pkt_ctl_fatal0() { return dprsr_pkt_ctl_fatal0_; }
  void dprsr_pkt_ctl_fatal0(const uint8_t &v) { dprsr_pkt_ctl_fatal0_=v; }
  uint8_t dprsr_pkt_ctl_fatal1() { return dprsr_pkt_ctl_fatal1_; }
  void dprsr_pkt_ctl_fatal1(const uint8_t &v) { dprsr_pkt_ctl_fatal1_=v; }
  uint8_t dprsr_pkt_ctl_fatal2() { return dprsr_pkt_ctl_fatal2_; }
  void dprsr_pkt_ctl_fatal2(const uint8_t &v) { dprsr_pkt_ctl_fatal2_=v; }
  uint8_t dprsr_pkt_ctl_fatal3() { return dprsr_pkt_ctl_fatal3_; }
  void dprsr_pkt_ctl_fatal3(const uint8_t &v) { dprsr_pkt_ctl_fatal3_=v; }
  uint8_t meta_fifo_fatal0() { return meta_fifo_fatal0_; }
  void meta_fifo_fatal0(const uint8_t &v) { meta_fifo_fatal0_=v; }
  uint8_t meta_fifo_fatal1() { return meta_fifo_fatal1_; }
  void meta_fifo_fatal1(const uint8_t &v) { meta_fifo_fatal1_=v; }
  uint8_t meta_fifo_fatal2() { return meta_fifo_fatal2_; }
  void meta_fifo_fatal2(const uint8_t &v) { meta_fifo_fatal2_=v; }
  uint8_t meta_fifo_fatal3() { return meta_fifo_fatal3_; }
  void meta_fifo_fatal3(const uint8_t &v) { meta_fifo_fatal3_=v; }
  uint8_t pbc_mem0_ecc_dual_err() { return pbc_mem0_ecc_dual_err_; }
  void pbc_mem0_ecc_dual_err(const uint8_t &v) { pbc_mem0_ecc_dual_err_=v; }
  uint8_t pbc_mem0_ecc_sngl_err() { return pbc_mem0_ecc_sngl_err_; }
  void pbc_mem0_ecc_sngl_err(const uint8_t &v) { pbc_mem0_ecc_sngl_err_=v; }
  uint8_t pbc_mem1_ecc_dual_err() { return pbc_mem1_ecc_dual_err_; }
  void pbc_mem1_ecc_dual_err(const uint8_t &v) { pbc_mem1_ecc_dual_err_=v; }
  uint8_t pbc_mem1_ecc_sngl_err() { return pbc_mem1_ecc_sngl_err_; }
  void pbc_mem1_ecc_sngl_err(const uint8_t &v) { pbc_mem1_ecc_sngl_err_=v; }
  uint8_t mbc_ecc_dual_err() { return mbc_ecc_dual_err_; }
  void mbc_ecc_dual_err(const uint8_t &v) { mbc_ecc_dual_err_=v; }
  uint8_t mbc_ecc_sngl_err() { return mbc_ecc_sngl_err_; }
  void mbc_ecc_sngl_err(const uint8_t &v) { mbc_ecc_sngl_err_=v; }
  uint8_t mbc_meta_fifo_ecc_dual_err() { return mbc_meta_fifo_ecc_dual_err_; }
  void mbc_meta_fifo_ecc_dual_err(const uint8_t &v) { mbc_meta_fifo_ecc_dual_err_=v; }
  uint8_t mbc_meta_fifo_ecc_sngl_err() { return mbc_meta_fifo_ecc_sngl_err_; }
  void mbc_meta_fifo_ecc_sngl_err(const uint8_t &v) { mbc_meta_fifo_ecc_sngl_err_=v; }
  uint8_t llc_mem0_ecc_dual_err() { return llc_mem0_ecc_dual_err_; }
  void llc_mem0_ecc_dual_err(const uint8_t &v) { llc_mem0_ecc_dual_err_=v; }
  uint8_t llc_mem0_ecc_sngl_err() { return llc_mem0_ecc_sngl_err_; }
  void llc_mem0_ecc_sngl_err(const uint8_t &v) { llc_mem0_ecc_sngl_err_=v; }
  uint8_t llc_mem1_ecc_dual_err() { return llc_mem1_ecc_dual_err_; }
  void llc_mem1_ecc_dual_err(const uint8_t &v) { llc_mem1_ecc_dual_err_=v; }
  uint8_t llc_mem1_ecc_sngl_err() { return llc_mem1_ecc_sngl_err_; }
  void llc_mem1_ecc_sngl_err(const uint8_t &v) { llc_mem1_ecc_sngl_err_=v; }
  uint8_t llc_mem2_ecc_dual_err() { return llc_mem2_ecc_dual_err_; }
  void llc_mem2_ecc_dual_err(const uint8_t &v) { llc_mem2_ecc_dual_err_=v; }
  uint8_t llc_mem2_ecc_sngl_err() { return llc_mem2_ecc_sngl_err_; }
  void llc_mem2_ecc_sngl_err(const uint8_t &v) { llc_mem2_ecc_sngl_err_=v; }
  uint8_t drop_mem0_ecc_dual_err() { return drop_mem0_ecc_dual_err_; }
  void drop_mem0_ecc_dual_err(const uint8_t &v) { drop_mem0_ecc_dual_err_=v; }
  uint8_t drop_mem0_ecc_sngl_err() { return drop_mem0_ecc_sngl_err_; }
  void drop_mem0_ecc_sngl_err(const uint8_t &v) { drop_mem0_ecc_sngl_err_=v; }
  uint8_t drop_mem1_ecc_dual_err() { return drop_mem1_ecc_dual_err_; }
  void drop_mem1_ecc_dual_err(const uint8_t &v) { drop_mem1_ecc_dual_err_=v; }
  uint8_t drop_mem1_ecc_sngl_err() { return drop_mem1_ecc_sngl_err_; }
  void drop_mem1_ecc_sngl_err(const uint8_t &v) { drop_mem1_ecc_sngl_err_=v; }
  uint8_t papc_merge_mem0_ecc_dual_err() { return papc_merge_mem0_ecc_dual_err_; }
  void papc_merge_mem0_ecc_dual_err(const uint8_t &v) { papc_merge_mem0_ecc_dual_err_=v; }
  uint8_t papc_merge_mem0_ecc_sngl_err() { return papc_merge_mem0_ecc_sngl_err_; }
  void papc_merge_mem0_ecc_sngl_err(const uint8_t &v) { papc_merge_mem0_ecc_sngl_err_=v; }
  uint8_t papc_merge_mem1_ecc_dual_err() { return papc_merge_mem1_ecc_dual_err_; }
  void papc_merge_mem1_ecc_dual_err(const uint8_t &v) { papc_merge_mem1_ecc_dual_err_=v; }
  uint8_t papc_merge_mem1_ecc_sngl_err() { return papc_merge_mem1_ecc_sngl_err_; }
  void papc_merge_mem1_ecc_sngl_err(const uint8_t &v) { papc_merge_mem1_ecc_sngl_err_=v; }
  uint8_t papc_ecc_dual_err() { return papc_ecc_dual_err_; }
  void papc_ecc_dual_err(const uint8_t &v) { papc_ecc_dual_err_=v; }
  uint8_t papc_ecc_sngl_err() { return papc_ecc_sngl_err_; }
  void papc_ecc_sngl_err(const uint8_t &v) { papc_ecc_sngl_err_=v; }
  uint8_t dppc_ecc_dual_err() { return dppc_ecc_dual_err_; }
  void dppc_ecc_dual_err(const uint8_t &v) { dppc_ecc_dual_err_=v; }
  uint8_t dppc_ecc_sngl_err() { return dppc_ecc_sngl_err_; }
  void dppc_ecc_sngl_err(const uint8_t &v) { dppc_ecc_sngl_err_=v; }
  uint8_t gacc_mem0_ecc_dual_err() { return gacc_mem0_ecc_dual_err_; }
  void gacc_mem0_ecc_dual_err(const uint8_t &v) { gacc_mem0_ecc_dual_err_=v; }
  uint8_t gacc_mem0_ecc_sngl_err() { return gacc_mem0_ecc_sngl_err_; }
  void gacc_mem0_ecc_sngl_err(const uint8_t &v) { gacc_mem0_ecc_sngl_err_=v; }
  uint8_t gacc_mem1_ecc_dual_err() { return gacc_mem1_ecc_dual_err_; }
  void gacc_mem1_ecc_dual_err(const uint8_t &v) { gacc_mem1_ecc_dual_err_=v; }
  uint8_t gacc_mem1_ecc_sngl_err() { return gacc_mem1_ecc_sngl_err_; }
  void gacc_mem1_ecc_sngl_err(const uint8_t &v) { gacc_mem1_ecc_sngl_err_=v; }
  uint8_t gacc_mem2_ecc_dual_err() { return gacc_mem2_ecc_dual_err_; }
  void gacc_mem2_ecc_dual_err(const uint8_t &v) { gacc_mem2_ecc_dual_err_=v; }
  uint8_t gacc_mem2_ecc_sngl_err() { return gacc_mem2_ecc_sngl_err_; }
  void gacc_mem2_ecc_sngl_err(const uint8_t &v) { gacc_mem2_ecc_sngl_err_=v; }
  uint8_t gacc_mem3_ecc_dual_err() { return gacc_mem3_ecc_dual_err_; }
  void gacc_mem3_ecc_dual_err(const uint8_t &v) { gacc_mem3_ecc_dual_err_=v; }
  uint8_t gacc_mem3_ecc_sngl_err() { return gacc_mem3_ecc_sngl_err_; }
  void gacc_mem3_ecc_sngl_err(const uint8_t &v) { gacc_mem3_ecc_sngl_err_=v; }
  uint8_t bcc_ecc_dual_err() { return bcc_ecc_dual_err_; }
  void bcc_ecc_dual_err(const uint8_t &v) { bcc_ecc_dual_err_=v; }
  uint8_t bcc_ecc_sngl_err() { return bcc_ecc_sngl_err_; }
  void bcc_ecc_sngl_err(const uint8_t &v) { bcc_ecc_sngl_err_=v; }
  uint8_t port_meta_fifo_overflow() { return port_meta_fifo_overflow_; }
  void port_meta_fifo_overflow(const uint8_t &v) { port_meta_fifo_overflow_=v; }
  uint8_t resub_2w_fifo_overflow() { return resub_2w_fifo_overflow_; }
  void resub_2w_fifo_overflow(const uint8_t &v) { resub_2w_fifo_overflow_=v; }
  uint8_t dprsr_pkt_pref_fifo_overflow() { return dprsr_pkt_pref_fifo_overflow_; }
  void dprsr_pkt_pref_fifo_overflow(const uint8_t &v) { dprsr_pkt_pref_fifo_overflow_=v; }
  uint8_t bcnt_pkt_fifo_overflow() { return bcnt_pkt_fifo_overflow_; }
  void bcnt_pkt_fifo_overflow(const uint8_t &v) { bcnt_pkt_fifo_overflow_=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("GlbGroupIntrStatFreezeEnableMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x60; // to get to glb_group_intr_stat_freeze_enable
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_GLB_GROUP_INTR_STAT_FREEZE_ENABLE_MUTABLE_H__
