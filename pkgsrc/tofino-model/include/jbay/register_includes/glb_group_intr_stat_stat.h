...
#ifndef __REGISTER_INCLUDES_GLB_GROUP_INTR_STAT_STAT_H__
#define __REGISTER_INCLUDES_GLB_GROUP_INTR_STAT_STAT_H__
...
class GlbGroupIntrStatStat : public model_core::RegisterBlock<RegisterCallback> {
public:
  GlbGroupIntrStatStat(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_ipb_prsr4_reg), 8, false, write_callback, read_callback, std::string("GlbGroupIntrStatStat")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_ipb_prsr4_reg))
    {
    }
  GlbGroupIntrStatStat(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "GlbGroupIntrStatStat")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("GlbGroupIntrStatStat") + ":\n";
...
#endif // __REGISTER_INCLUDES_GLB_GROUP_INTR_STAT_STAT_H__
