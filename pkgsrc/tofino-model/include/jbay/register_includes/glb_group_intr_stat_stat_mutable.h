...
#ifndef __REGISTER_INCLUDES_GLB_GROUP_INTR_STAT_STAT_MUTABLE_H__
#define __REGISTER_INCLUDES_GLB_GROUP_INTR_STAT_STAT_MUTABLE_H__
...
class GlbGroupIntrStatStatMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  GlbGroupIntrStatStatMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_ipb_prsr4_reg), 8, true, write_callback, read_callback, std::string("GlbGroupIntrStatStatMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_ipb_prsr4_reg))
    {
    }
  GlbGroupIntrStatStatMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "GlbGroupIntrStatStatMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("GlbGroupIntrStatStatMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x40; // to get to glb_group_intr_stat_stat
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_GLB_GROUP_INTR_STAT_STAT_MUTABLE_H__
