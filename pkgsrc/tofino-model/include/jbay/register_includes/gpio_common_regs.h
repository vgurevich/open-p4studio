...
#include "gpio_common_regs_eth_gpio_intr.h"
#include "gpio_common_regs_gpio_status.h"
#include "gpio_common_regs_i2c_basetime.h"
#include "gpio_common_regs_ring_lock_timeout.h"
...
public:
  GpioCommonRegs(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_jbay_reg), 392, false, write_callback, read_callback, std::string("GpioCommonRegs")+":"+boost::lexical_cast<std::string>(selector_jbay_reg))
    {
    }
  GpioCommonRegs(
...
public:
  ...
  GpioCommonRegsRingLockTimeout &ring_lock_timeout() { return ring_lock_timeout_; }
  GpioCommonRegsEthGpioIntr &eth_gpio_intr() { return eth_gpio_intr_; }
...
private:
  ...
  GpioCommonRegsRingLockTimeout ring_lock_timeout_;
  GpioCommonRegsEthGpioIntr eth_gpio_intr_;
private:
