...
#ifndef __REGISTER_INCLUDES_GPIO_COMMON_REGS_ETH_GPIO_INTR_INJ_H__
#define __REGISTER_INCLUDES_GPIO_COMMON_REGS_ETH_GPIO_INTR_INJ_H__
...
class GpioCommonRegsEthGpioIntrInj : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum JbayRegEnum {
    kEthgpiobr,
    kEthgpiotl
...
public:
  GpioCommonRegsEthGpioIntrInj(
      int chipNumber, JbayRegEnum selector_jbay_reg, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(selector_jbay_reg), 4, false, write_callback, read_callback, std::string("GpioCommonRegsEthGpioIntrInj")+":"+boost::lexical_cast<std::string>(selector_jbay_reg))
    {
    }
  GpioCommonRegsEthGpioIntrInj(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "GpioCommonRegsEthGpioIntrInj")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("GpioCommonRegsEthGpioIntrInj") + ":\n";
...
#endif // __REGISTER_INCLUDES_GPIO_COMMON_REGS_ETH_GPIO_INTR_INJ_H__
