...
#ifndef __REGISTER_INCLUDES_GPIO_COMMON_REGS_ETH_GPIO_INTR_INJ_MUTABLE_H__
#define __REGISTER_INCLUDES_GPIO_COMMON_REGS_ETH_GPIO_INTR_INJ_MUTABLE_H__
...
class GpioCommonRegsEthGpioIntrInjMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum JbayRegEnum {
    kEthgpiobr,
    kEthgpiotl
...
public:
  GpioCommonRegsEthGpioIntrInjMutable(
      int chipNumber, JbayRegEnum selector_jbay_reg, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(selector_jbay_reg), 4, true, write_callback, read_callback, std::string("GpioCommonRegsEthGpioIntrInjMutable")+":"+boost::lexical_cast<std::string>(selector_jbay_reg))
    {
    }
  GpioCommonRegsEthGpioIntrInjMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "GpioCommonRegsEthGpioIntrInjMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("GpioCommonRegsEthGpioIntrInjMutable") + ":\n";
  ...
  static int StartOffset(
    ...
    switch (selector_jbay_reg) {
      case kEthgpiobr:
        ...
        offset += 0x16c; // to get to eth_gpio_intr_inj
        break;
      case kEthgpiotl:
...
#endif // __REGISTER_INCLUDES_GPIO_COMMON_REGS_ETH_GPIO_INTR_INJ_MUTABLE_H__
