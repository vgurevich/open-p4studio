...
#ifndef __REGISTER_INCLUDES_GPIO_IOTILE_RSPEC_CLKOBS_CTRL_MUTABLE_H__
#define __REGISTER_INCLUDES_GPIO_IOTILE_RSPEC_CLKOBS_CTRL_MUTABLE_H__
...
class GpioIotileRspecClkobsCtrlMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum JbayRegEnum {
    kGpioIotileBl,
    kGpioIotileBr,
...
public:
  GpioIotileRspecClkobsCtrlMutable(
      int chipNumber, JbayRegEnum selector_jbay_reg, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(selector_jbay_reg), 4, true, write_callback, read_callback, std::string("GpioIotileRspecClkobsCtrlMutable")+":"+boost::lexical_cast<std::string>(selector_jbay_reg))
    {
    }
  GpioIotileRspecClkobsCtrlMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "GpioIotileRspecClkobsCtrlMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("GpioIotileRspecClkobsCtrlMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_GPIO_IOTILE_RSPEC_CLKOBS_CTRL_MUTABLE_H__
