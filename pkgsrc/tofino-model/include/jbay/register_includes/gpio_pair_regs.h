...
#ifndef __REGISTER_INCLUDES_GPIO_PAIR_REGS_H__
#define __REGISTER_INCLUDES_GPIO_PAIR_REGS_H__
...
#include "gpio_pair_regs_gpio_config.h"
#include "gpio_pair_regs_gpio_settings.h"
#include "gpio_pair_regs_i2c_addr.h"
#include "gpio_pair_regs_i2c_ctrl.h"
#include "gpio_pair_regs_i2c_rdata.h"
#include "gpio_pair_regs_i2c_scl_freq.h"
#include "gpio_pair_regs_i2c_statein.h"
#include "gpio_pair_regs_i2c_wdata.h"
#include "gpio_pair_regs_mdio_addrdata.h"
#include "gpio_pair_regs_mdio_clkdiv.h"
#include "gpio_pair_regs_mdio_ctrl.h"
#include "gpio_pair_regs_pair_mac_ctrl.h"

namespace jbay {
  namespace register_classes {

class GpioPairRegs : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum JbayRegEnum {
    kEthgpiobr,
    kEthgpiotl
...
public:
  GpioPairRegs(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_jbay_reg, index_gpio_pair_regs), 48, false, write_callback, read_callback, std::string("GpioPairRegs")+":"+boost::lexical_cast<std::string>(selector_jbay_reg) + "," + boost::lexical_cast<std::string>(index_gpio_pair_regs))
    {
    }
  GpioPairRegs(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "GpioPairRegs")
    {
    }
public:
  ...
  GpioPairRegsGpioConfig &gpio_config() { return gpio_config_; }





  GpioPairRegsGpioSettings &gpio_settings() { return gpio_settings_; }





  GpioPairRegsI2cAddr &i2c_addr() { return i2c_addr_; }





  GpioPairRegsI2cWdata &i2c_wdata() { return i2c_wdata_; }





  GpioPairRegsI2cCtrl &i2c_ctrl() { return i2c_ctrl_; }





  GpioPairRegsI2cStatein &i2c_statein() { return i2c_statein_; }





  GpioPairRegsI2cSclFreq &i2c_scl_freq() { return i2c_scl_freq_; }





  GpioPairRegsI2cRdata &i2c_rdata() { return i2c_rdata_; }





  GpioPairRegsMdioCtrl &mdio_ctrl() { return mdio_ctrl_; }





  GpioPairRegsMdioAddrdata &mdio_addrdata() { return mdio_addrdata_; }
  ...
  GpioPairRegsMdioClkdiv &mdio_clkdiv() { return mdio_clkdiv_; }
  ...
  GpioPairRegsPairMacCtrl &pair_mac_ctrl() { return pair_mac_ctrl_; }
  ...
  bool read(
    ...
    if (offset < 0x4) {
      ...
      offset -= 0x2c;
      if (read_callback_) read_callback_();
      pair_mac_ctrl_.read( offset, data );
    }
    return true;
  }
  ...
  bool write(
    ...
    if (offset < 0x4) {
      ...
      offset -= 0x2c;
      pair_mac_ctrl_.write( offset, data );
      if (write_callback_) write_callback_();
    }
    return true;
  }
  ...
  std::string to_string(
    ...
    if (offset < 0x4) {
      ...
      offset -= 0x2c;
      r += pair_mac_ctrl_.to_string(offset,print_zeros,indent_string) ;
    }
  ...
  std::string to_string(
    ...
    r += pair_mac_ctrl_.to_string(print_zeros,indent_string) ;
    if (all_zeros && !print_zeros) {
      return("");
    }
    else {
...
private:
  GpioPairRegsGpioConfig gpio_config_;
  GpioPairRegsGpioSettings gpio_settings_;
  GpioPairRegsI2cAddr i2c_addr_;
  GpioPairRegsI2cWdata i2c_wdata_;
  GpioPairRegsI2cCtrl i2c_ctrl_;
  GpioPairRegsI2cStatein i2c_statein_;
  GpioPairRegsI2cSclFreq i2c_scl_freq_;
  GpioPairRegsI2cRdata i2c_rdata_;
  GpioPairRegsMdioCtrl mdio_ctrl_;
  GpioPairRegsMdioAddrdata mdio_addrdata_;
  GpioPairRegsMdioClkdiv mdio_clkdiv_;
  GpioPairRegsPairMacCtrl pair_mac_ctrl_;
private:
...
#endif // __REGISTER_INCLUDES_GPIO_PAIR_REGS_H__
