...
#ifndef __REGISTER_INCLUDES_GPIO_PAIR_REGS_I2C_CTRL_MUTABLE_H__
#define __REGISTER_INCLUDES_GPIO_PAIR_REGS_I2C_CTRL_MUTABLE_H__
...
class GpioPairRegsI2cCtrlMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum JbayRegEnum {
    kEthgpiobr,
    kEthgpiotl
...
public:
  GpioPairRegsI2cCtrlMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_jbay_reg, index_gpio_pair_regs), 4, true, write_callback, read_callback, std::string("GpioPairRegsI2cCtrlMutable")+":"+boost::lexical_cast<std::string>(selector_jbay_reg) + "," + boost::lexical_cast<std::string>(index_gpio_pair_regs))
    {
    }
  GpioPairRegsI2cCtrlMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "GpioPairRegsI2cCtrlMutable")
    {
    }
public:
  ...
  void i2c_type(const uint8_t &v) { i2c_type_=v; }
  ...
  void i2c_cmd(const uint8_t &v) { i2c_cmd_=v; }
  ...
  void i2c_addrnum(const uint8_t &v) { i2c_addrnum_=v; }
  ...
  void i2c_devaddr(const uint8_t &v) { i2c_devaddr_=v; }
  ...
  void i2c_exec(const uint8_t &v) { i2c_exec_=v; }
  ...
  void i2c_datanum(const uint8_t &v) { i2c_datanum_=v; }
  ...
  void i2c_stateaddr(const uint8_t &v) { i2c_stateaddr_=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("GpioPairRegsI2cCtrlMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_GPIO_PAIR_REGS_I2C_CTRL_MUTABLE_H__
