...
#ifndef __REGISTER_INCLUDES_IMEM_DARK_SUBWORD32_MUTABLE_H__
#define __REGISTER_INCLUDES_IMEM_DARK_SUBWORD32_MUTABLE_H__
...
class ImemDarkSubword32Mutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  ImemDarkSubword32Mutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap, index_imem_dark_subword32_0, index_imem_dark_subword32_1, index_imem_dark_subword32_2, index_imem_dark_subword32_3), 4, true, write_callback, read_callback, std::string("ImemDarkSubword32Mutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap) + "," + boost::lexical_cast<std::string>(index_imem_dark_subword32_0) + "," + boost::lexical_cast<std::string>(index_imem_dark_subword32_1) + "," + boost::lexical_cast<std::string>(index_imem_dark_subword32_2) + "," + boost::lexical_cast<std::string>(index_imem_dark_subword32_3))
    {
    }
  ImemDarkSubword32Mutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "ImemDarkSubword32Mutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("ImemDarkSubword32Mutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_IMEM_DARK_SUBWORD32_MUTABLE_H__
