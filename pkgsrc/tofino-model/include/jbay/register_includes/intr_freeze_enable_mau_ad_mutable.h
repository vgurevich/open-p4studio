...
#ifndef __REGISTER_INCLUDES_INTR_FREEZE_ENABLE_MAU_AD_MUTABLE_H__
#define __REGISTER_INCLUDES_INTR_FREEZE_ENABLE_MAU_AD_MUTABLE_H__
...
class IntrFreezeEnableMauAdMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  IntrFreezeEnableMauAdMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap), 4, true, write_callback, read_callback, std::string("IntrFreezeEnableMauAdMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap))
    {
    }
  IntrFreezeEnableMauAdMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "IntrFreezeEnableMauAdMutable")
    {
    }
public:
  ...
  void def_stats_sbe(const uint8_t &v) { def_stats_sbe_=v; }



  uint8_t def_meter_sbe() { return def_meter_sbe_; }
  void def_meter_sbe(const uint8_t &v) { def_meter_sbe_=v; }


  uint8_t idletime_slip() { return idletime_slip_; }
  void idletime_slip(const uint8_t &v) { idletime_slip_=v; }


  uint8_t meter_sweep() { return meter_sweep_; }
  void meter_sweep(const uint8_t &v) { meter_sweep_=v; }


  uint8_t stateful_log_done() { return stateful_log_done_; }
  void stateful_log_done(const uint8_t &v) { stateful_log_done_=v; }


  uint8_t stateful_log_watermark() { return stateful_log_watermark_; }
  void stateful_log_watermark(const uint8_t &v) { stateful_log_watermark_=v; }



  uint8_t stateful_log_overflow() { return stateful_log_overflow_; }
  void stateful_log_overflow(const uint8_t &v) { stateful_log_overflow_=v; }



  uint8_t stateful_log_underflow() { return stateful_log_underflow_; }
  void stateful_log_underflow(const uint8_t &v) { stateful_log_underflow_=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("IntrFreezeEnableMauAdMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x5c8; // to get to intr_freeze_enable_mau_ad
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_INTR_FREEZE_ENABLE_MAU_AD_MUTABLE_H__
