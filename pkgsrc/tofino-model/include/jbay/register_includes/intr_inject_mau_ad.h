...
#ifndef __REGISTER_INCLUDES_INTR_INJECT_MAU_AD_H__
#define __REGISTER_INCLUDES_INTR_INJECT_MAU_AD_H__
...
class IntrInjectMauAd : public model_core::RegisterBlock<RegisterCallback> {
public:
  IntrInjectMauAd(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap), 4, false, write_callback, read_callback, std::string("IntrInjectMauAd")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap))
    {
    }
  IntrInjectMauAd(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "IntrInjectMauAd")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("IntrInjectMauAd") + ":\n";
...
#endif // __REGISTER_INCLUDES_INTR_INJECT_MAU_AD_H__
