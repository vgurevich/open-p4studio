...
#ifndef __REGISTER_INCLUDES_INTR_INJECT_MAU_SELECTOR_ALU_H__
#define __REGISTER_INCLUDES_INTR_INJECT_MAU_SELECTOR_ALU_H__
...
class IntrInjectMauSelectorAlu : public model_core::RegisterBlock<RegisterCallback> {
public:
  IntrInjectMauSelectorAlu(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap, index_mau_meter_alu_group_addrmap), 4, false, write_callback, read_callback, std::string("IntrInjectMauSelectorAlu")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_meter_alu_group_addrmap))
    {
    }
  IntrInjectMauSelectorAlu(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "IntrInjectMauSelectorAlu")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("IntrInjectMauSelectorAlu") + ":\n";
...
#endif // __REGISTER_INCLUDES_INTR_INJECT_MAU_SELECTOR_ALU_H__
