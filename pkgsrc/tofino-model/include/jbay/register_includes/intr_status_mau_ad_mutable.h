...
#ifndef __REGISTER_INCLUDES_INTR_STATUS_MAU_AD_MUTABLE_H__
#define __REGISTER_INCLUDES_INTR_STATUS_MAU_AD_MUTABLE_H__
...
class IntrStatusMauAdMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  IntrStatusMauAdMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap), 4, true, write_callback, read_callback, std::string("IntrStatusMauAdMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap))
    {
    }
  IntrStatusMauAdMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "IntrStatusMauAdMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("IntrStatusMauAdMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x138; // to get to intr_status_mau_ad
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_INTR_STATUS_MAU_AD_MUTABLE_H__
