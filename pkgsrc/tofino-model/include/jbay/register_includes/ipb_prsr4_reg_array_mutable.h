...
#ifndef __REGISTER_INCLUDES_IPB_PRSR4_REG_ARRAY_MUTABLE_H__
#define __REGISTER_INCLUDES_IPB_PRSR4_REG_ARRAY_MUTABLE_H__
...
class IpbPrsr4RegArrayMutable : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  IpbPrsr4RegArrayMutable(
      int chipNumber, int index_pipe_addrmap, RegisterArrayCallback& write_callback = 0, RegisterArrayCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 8192 * ArraySize(index_pipe_addrmap, -1), true, write_callback, read_callback, std::string("IpbPrsr4RegArrayMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap)),
...
public:
  ...
  IpbRspecMutable &ipbreg(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    return array[a0].ipbreg();
  }
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("IpbPrsr4RegArrayMutable") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
private:
  std::vector<IpbPrsr4RegMutable> array;
  uint32_t size0_;
...
#endif // __REGISTER_INCLUDES_IPB_PRSR4_REG_ARRAY_MUTABLE_H__
