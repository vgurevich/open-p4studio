...
#ifndef __REGISTER_INCLUDES_IPB_RSPEC_H__
#define __REGISTER_INCLUDES_IPB_RSPEC_H__
...
#include "glb_group.h"
#include "ipb_rspec_chan0_group.h"
#include "ipb_rspec_chan1_group.h"
#include "ipb_rspec_chan2_group.h"
#include "ipb_rspec_chan3_group.h"
#include "ipb_rspec_chan4_group.h"
#include "ipb_rspec_chan5_group.h"
#include "ipb_rspec_chan6_group.h"
#include "ipb_rspec_chan7_group.h"
#include "ipb_rspec_debug_bus_ctrl.h"

namespace jbay {
  namespace register_classes {

class IpbRspec : public model_core::RegisterBlock<RegisterCallback> {
public:
  IpbRspec(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_ipb_prsr4_reg), 4096, false, write_callback, read_callback, std::string("IpbRspec")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_ipb_prsr4_reg))
    {
    }
  IpbRspec(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "IpbRspec")
    {
    }
public:
  ...
  IpbRspecDebugBusCtrl &debug_bus_ctrl() { return debug_bus_ctrl_; }
  ...
  IpbRspecChan0Group &chan0_group() { return chan0_group_; }





  IpbRspecChan1Group &chan1_group() { return chan1_group_; }





  IpbRspecChan2Group &chan2_group() { return chan2_group_; }





  IpbRspecChan3Group &chan3_group() { return chan3_group_; }





  IpbRspecChan4Group &chan4_group() { return chan4_group_; }





  IpbRspecChan5Group &chan5_group() { return chan5_group_; }





  IpbRspecChan6Group &chan6_group() { return chan6_group_; }





  IpbRspecChan7Group &chan7_group() { return chan7_group_; }
...
private:
  IpbRspecDebugBusCtrl debug_bus_ctrl_;
  GlbGroup glb_group_;
  IpbRspecChan0Group chan0_group_;
  IpbRspecChan1Group chan1_group_;
  IpbRspecChan2Group chan2_group_;
  IpbRspecChan3Group chan3_group_;
  IpbRspecChan4Group chan4_group_;
  IpbRspecChan5Group chan5_group_;
  IpbRspecChan6Group chan6_group_;
  IpbRspecChan7Group chan7_group_;
private:
...
#endif // __REGISTER_INCLUDES_IPB_RSPEC_H__
