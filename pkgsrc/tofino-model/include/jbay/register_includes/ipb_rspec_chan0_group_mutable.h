...
#ifndef __REGISTER_INCLUDES_IPB_RSPEC_CHAN0_GROUP_MUTABLE_H__
#define __REGISTER_INCLUDES_IPB_RSPEC_CHAN0_GROUP_MUTABLE_H__
...
class IpbRspecChan0GroupMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  IpbRspecChan0GroupMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_ipb_prsr4_reg), 216, true, write_callback, read_callback, std::string("IpbRspecChan0GroupMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_ipb_prsr4_reg))
    {
    }
  IpbRspecChan0GroupMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "IpbRspecChan0GroupMutable")
    {
    }
public:
  ...
  ChnlMetaMutable &chan0_group_chnl_meta() { return chan0_group_chnl_meta_; }





  MetaFifoCtrlMutable &chan0_group_meta_fifo_ctrl() { return chan0_group_meta_fifo_ctrl_; }





  ChnlFifoCtrlMutable &chan0_group_chnl_fifo_ctrl() { return chan0_group_chnl_fifo_ctrl_; }





  ChnlAccCtrlMutable &chan0_group_chnl_acc_ctrl() { return chan0_group_chnl_acc_ctrl_; }





  ChnlAccStatMutable &chan0_group_chnl_acc_stat() { return chan0_group_chnl_acc_stat_; }
  ...
  ChnlPktnum0CfgMutable &chan0_group_chnl_pktnum0_cfg() { return chan0_group_chnl_pktnum0_cfg_; }
  ...
  ChnlPktnum1CfgMutable &chan0_group_chnl_pktnum1_cfg() { return chan0_group_chnl_pktnum1_cfg_; }
  ...
  ChnlMetanumCfgMutable &chan0_group_chnl_metanum_cfg() { return chan0_group_chnl_metanum_cfg_; }
  ...
  ChnlStatMutable &chan0_group_chnl_stat() { return chan0_group_chnl_stat_; }
  ...
  ChnlMetanumMutable &chan0_group_chnl_metanum() { return chan0_group_chnl_metanum_; }
  ...
  ChnlDropTruncPktMutable &chan0_group_chnl_drop_trunc_pkt() { return chan0_group_chnl_drop_trunc_pkt_; }





  ChnlResubmitDiscardPktMutable &chan0_group_chnl_resubmit_discard_pkt() { return chan0_group_chnl_resubmit_discard_pkt_; }
  ...
  ChnlResubmitReceivedPktMutable &chan0_group_chnl_resubmit_received_pkt() { return chan0_group_chnl_resubmit_received_pkt_; }
...
private:
  ...
  ChnlMetaMutable chan0_group_chnl_meta_;
  MetaFifoCtrlMutable chan0_group_meta_fifo_ctrl_;
  ChnlFifoCtrlMutable chan0_group_chnl_fifo_ctrl_;
  ChnlAccCtrlMutable chan0_group_chnl_acc_ctrl_;
  ChnlAccStatMutable chan0_group_chnl_acc_stat_;
  ChnlPktnum0CfgMutable chan0_group_chnl_pktnum0_cfg_;
  ChnlPktnum1CfgMutable chan0_group_chnl_pktnum1_cfg_;
  ChnlMetanumCfgMutable chan0_group_chnl_metanum_cfg_;
  ChnlStatMutable chan0_group_chnl_stat_;
  ChnlPktnum0Mutable chan0_group_chnl_pktnum0_;
  ChnlPktnum1Mutable chan0_group_chnl_pktnum1_;
  ChnlMetanumMutable chan0_group_chnl_metanum_;
  ...
  ChnlDropTruncPktMutable chan0_group_chnl_drop_trunc_pkt_;
  ChnlResubmitDiscardPktMutable chan0_group_chnl_resubmit_discard_pkt_;
  ...
  ChnlResubmitReceivedPktMutable chan0_group_chnl_resubmit_received_pkt_;
private:
...
#endif // __REGISTER_INCLUDES_IPB_RSPEC_CHAN0_GROUP_MUTABLE_H__
