...
#ifndef __REGISTER_INCLUDES_IPB_RSPEC_DEBUG_BUS_CTRL_H__
#define __REGISTER_INCLUDES_IPB_RSPEC_DEBUG_BUS_CTRL_H__
...
class IpbRspecDebugBusCtrl : public model_core::RegisterBlock<RegisterCallback> {
public:
  IpbRspecDebugBusCtrl(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_ipb_prsr4_reg), 4, false, write_callback, read_callback, std::string("IpbRspecDebugBusCtrl")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_ipb_prsr4_reg))
    {
    }
  IpbRspecDebugBusCtrl(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "IpbRspecDebugBusCtrl")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("IpbRspecDebugBusCtrl") + ":\n";
...
#endif // __REGISTER_INCLUDES_IPB_RSPEC_DEBUG_BUS_CTRL_H__
