...
#ifndef __REGISTER_INCLUDES_IPB_RSPEC_DEBUG_BUS_CTRL_MUTABLE_H__
#define __REGISTER_INCLUDES_IPB_RSPEC_DEBUG_BUS_CTRL_MUTABLE_H__
...
class IpbRspecDebugBusCtrlMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  IpbRspecDebugBusCtrlMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_ipb_prsr4_reg), 4, true, write_callback, read_callback, std::string("IpbRspecDebugBusCtrlMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_ipb_prsr4_reg))
    {
    }
  IpbRspecDebugBusCtrlMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "IpbRspecDebugBusCtrlMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("IpbRspecDebugBusCtrlMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0xfd8; // to get to debug_bus_ctrl
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_IPB_RSPEC_DEBUG_BUS_CTRL_MUTABLE_H__
