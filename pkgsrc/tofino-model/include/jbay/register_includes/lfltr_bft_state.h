...
public:
  LfltrBftState(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_lfltr_rspec), 4, false, write_callback, read_callback, std::string("LfltrBftState")+":"+boost::lexical_cast<std::string>(index_lfltr_rspec))
    {
    }
  LfltrBftState(
