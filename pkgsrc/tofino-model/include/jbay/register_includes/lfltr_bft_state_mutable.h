...
public:
  LfltrBftStateMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_lfltr_rspec), 4, true, write_callback, read_callback, std::string("LfltrBftStateMutable")+":"+boost::lexical_cast<std::string>(index_lfltr_rspec))
    {
    }
  LfltrBftStateMutable(
...
private:
  static int StartOffset(
    ...
    offset += 0x84; // to get to bft_state
    return offset;
  }
