...
public:
  LfltrCtr48LqInMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_lfltr_rspec), 8, true, write_callback, read_callback, std::string("LfltrCtr48LqInMutable")+":"+boost::lexical_cast<std::string>(index_lfltr_rspec))
    {
    }
  LfltrCtr48LqInMutable(
