...
#ifndef __REGISTER_INCLUDES_LFLTR_CTR48_LQ_SOP_IN_H__
#define __REGISTER_INCLUDES_LFLTR_CTR48_LQ_SOP_IN_H__
...
class LfltrCtr48LqSopIn : public model_core::RegisterBlock<RegisterCallback> {
public:
  LfltrCtr48LqSopIn(
      int chipNumber, int index_lfltr_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_lfltr_rspec), 8, false, write_callback, read_callback, std::string("LfltrCtr48LqSopIn")+":"+boost::lexical_cast<std::string>(index_lfltr_rspec))
    {
    }
  LfltrCtr48LqSopIn(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "LfltrCtr48LqSopIn")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("LfltrCtr48LqSopIn") + ":\n";
...
#endif // __REGISTER_INCLUDES_LFLTR_CTR48_LQ_SOP_IN_H__
