...
#include "lfltr_ctr48_lq_eop_in_err.h"
#include "lfltr_ctr48_lq_in.h"
#include "lfltr_ctr48_lq_learned.h"
#include "lfltr_ctr48_lq_sop_in.h"
#include "lfltr_ctrl_rspec_debug_bus_ctrl.h"
#include "lfltr_freeze_en.h"
#include "lfltr_hash_seed.h"
#include "lfltr_intr_en0.h"
#include "lfltr_intr_en1.h"
#include "lfltr_intr_inj.h"
#include "lfltr_intr_stat.h"
...
public:
  LfltrCtrlRspec(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_lfltr_rspec), 32768, false, write_callback, read_callback, std::string("LfltrCtrlRspec")+":"+boost::lexical_cast<std::string>(index_lfltr_rspec))
    {
    }
  LfltrCtrlRspec(
...
public:
  ...
  LfltrIntrStat &intr_stat() { return intr_stat_; }





  LfltrIntrEn0 &intr_en0() { return intr_en0_; }





  LfltrIntrEn1 &intr_en1() { return intr_en1_; }
  ...
  LfltrIntrInj &intr_inj() { return intr_inj_; }





  LfltrCtr48LqSopIn &lq_sop_in() { return lq_sop_in_; }





  LfltrCtr48LqEopInErr &lq_eop_in_err() { return lq_eop_in_err_; }
...
private:
  ...
  LfltrIntrStat intr_stat_;
  LfltrIntrEn0 intr_en0_;
  LfltrIntrEn1 intr_en1_;
  LfltrFreezeEn freeze_en_;
  LfltrIntrInj intr_inj_;
  LfltrCtr48LqSopIn lq_sop_in_;
  LfltrCtr48LqEopInErr lq_eop_in_err_;
