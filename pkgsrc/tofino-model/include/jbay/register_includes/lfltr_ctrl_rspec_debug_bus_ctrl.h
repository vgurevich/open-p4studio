...
public:
  LfltrCtrlRspecDebugBusCtrl(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_lfltr_rspec), 4, false, write_callback, read_callback, std::string("LfltrCtrlRspecDebugBusCtrl")+":"+boost::lexical_cast<std::string>(index_lfltr_rspec))
    {
    }
  LfltrCtrlRspecDebugBusCtrl(
