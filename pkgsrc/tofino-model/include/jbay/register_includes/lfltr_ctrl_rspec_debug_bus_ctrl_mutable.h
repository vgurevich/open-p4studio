...
public:
  LfltrCtrlRspecDebugBusCtrlMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_lfltr_rspec), 4, true, write_callback, read_callback, std::string("LfltrCtrlRspecDebugBusCtrlMutable")+":"+boost::lexical_cast<std::string>(index_lfltr_rspec))
    {
    }
  LfltrCtrlRspecDebugBusCtrlMutable(
...
private:
  static int StartOffset(
    ...
    offset += 0x90; // to get to debug_bus_ctrl
    return offset;
  }
