...
public:
  LfltrHashArray(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_lfltr_rspec, index_lfltr_hash_rspec, index_lfltr_hash_array), 48, false, write_callback, read_callback, std::string("LfltrHashArray")+":"+boost::lexical_cast<std::string>(index_lfltr_rspec) + "," + boost::lexical_cast<std::string>(index_lfltr_hash_rspec) + "," + boost::lexical_cast<std::string>(index_lfltr_hash_array))
    {
    }
  LfltrHashArray(
