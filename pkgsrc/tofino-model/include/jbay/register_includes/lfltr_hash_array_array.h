...
public:
  LfltrHashArrayArray(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_lfltr_rspec, index_lfltr_hash_rspec), 48 * ArraySize(index_lfltr_rspec, index_lfltr_hash_rspec, -1), false, write_callback, read_callback, std::string("LfltrHashArrayArray")+":"+boost::lexical_cast<std::string>(index_lfltr_rspec) + "," + boost::lexical_cast<std::string>(index_lfltr_hash_rspec)),
