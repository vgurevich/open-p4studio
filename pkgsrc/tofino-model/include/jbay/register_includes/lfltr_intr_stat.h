...
#ifndef __REGISTER_INCLUDES_LFLTR_INTR_STAT_H__
#define __REGISTER_INCLUDES_LFLTR_INTR_STAT_H__
...
class LfltrIntrStat : public model_core::RegisterBlock<RegisterCallback> {
public:
  LfltrIntrStat(
      int chipNumber, int index_lfltr_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_lfltr_rspec), 4, false, write_callback, read_callback, std::string("LfltrIntrStat")+":"+boost::lexical_cast<std::string>(index_lfltr_rspec))
    {
    }
  LfltrIntrStat(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "LfltrIntrStat")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("LfltrIntrStat") + ":\n";
...
#endif // __REGISTER_INCLUDES_LFLTR_INTR_STAT_H__
