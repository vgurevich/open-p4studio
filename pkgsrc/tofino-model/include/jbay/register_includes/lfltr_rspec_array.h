...
#ifndef __REGISTER_INCLUDES_LFLTR_RSPEC_ARRAY_H__
#define __REGISTER_INCLUDES_LFLTR_RSPEC_ARRAY_H__
...
class LfltrRspecArray : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  LfltrRspecArray(
      int chipNumber, RegisterArrayCallback& write_callback = 0, RegisterArrayCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 524288 * ArraySize(-1), false, write_callback, read_callback, std::string("LfltrRspecArray")),
...
public:
  ...
  LfltrHashRspec &hash(uint32_t a0,int j0)
  {
  ...
  LfltrCtrlRspec &ctrl(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("LfltrRspecArray") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
#endif // __REGISTER_INCLUDES_LFLTR_RSPEC_ARRAY_H__
