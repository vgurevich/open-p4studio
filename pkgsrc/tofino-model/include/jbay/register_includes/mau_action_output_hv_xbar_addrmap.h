...
#ifndef __REGISTER_INCLUDES_MAU_ACTION_OUTPUT_HV_XBAR_ADDRMAP_H__
#define __REGISTER_INCLUDES_MAU_ACTION_OUTPUT_HV_XBAR_ADDRMAP_H__
...
#include "action_hv_ixbar_input_bytemask.h"
#include "action_hv_xbar_disable_ram_adr.h"
#include "mau_diag_row_adb_clk_enable.h"

namespace jbay {
  namespace register_classes {

class MauActionOutputHvXbarAddrmap : public model_core::RegisterBlock<RegisterCallback> {
public:
  MauActionOutputHvXbarAddrmap(
...
public:
  ...
  MauDiagRowAdbClkEnable &mau_diag_row_adb_clk_enable() { return mau_diag_row_adb_clk_enable_; }
  ...
  ActionHvXbarDisableRamAdr &action_hv_xbar_disable_ram_adr() { return action_hv_xbar_disable_ram_adr_; }
  ...
  ActionHvIxbarCtlByte &action_hv_ixbar_ctl_byte(int j0) { return action_hv_ixbar_ctl_byte_[j0]; }
  ...
  ActionHvIxbarInputBytemask &action_hv_ixbar_input_bytemask(int j0) { return action_hv_ixbar_input_bytemask_[j0]; }
  ...
  ActionHvIxbarCtlHalfword &action_hv_ixbar_ctl_halfword(int j1,int j0) { return action_hv_ixbar_ctl_halfword_[j1][j0]; }
  ...
  ActionHvIxbarCtlWord &action_hv_ixbar_ctl_word(int j1,int j0) { return action_hv_ixbar_ctl_word_[j1][j0]; }
...
private:
  MauDiagRowAdbClkEnable mau_diag_row_adb_clk_enable_;
  ActionHvXbarDisableRamAdr action_hv_xbar_disable_ram_adr_;
  std::array< ActionHvIxbarCtlByte, 2 > action_hv_ixbar_ctl_byte_;
  std::array< ActionHvIxbarInputBytemask, 2 > action_hv_ixbar_input_bytemask_;
  std::array< std::array< ActionHvIxbarCtlHalfword, 2 >, 3 > action_hv_ixbar_ctl_halfword_;
  std::array< std::array< ActionHvIxbarCtlWord, 2 >, 4 > action_hv_ixbar_ctl_word_;
private:
...
#endif // __REGISTER_INCLUDES_MAU_ACTION_OUTPUT_HV_XBAR_ADDRMAP_H__
