...
#ifndef __REGISTER_INCLUDES_MAU_ADDRMAP_ARRAY_MUTABLE_H__
#define __REGISTER_INCLUDES_MAU_ADDRMAP_ARRAY_MUTABLE_H__
...
class MauAddrmapArrayMutable : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  MauAddrmapArrayMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 524288 * ArraySize(index_pipe_addrmap, -1), true, write_callback, read_callback, std::string("MauAddrmapArrayMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap)),
...
public:
  ...
  MauDatapathAddrmapMutable &dp(uint32_t a0)
  {
  ...
  MauCfgRegsAddrmapMutable &cfg_regs(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    return array[a0].cfg_regs();
  }
  ...
  MauTcamArrayAddrmapMutable &tcams(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    return array[a0].tcams();
  }
  ...
  MauMemoryCoreAddrmapMutable &rams(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    return array[a0].rams();
  }
...
#endif // __REGISTER_INCLUDES_MAU_ADDRMAP_ARRAY_MUTABLE_H__
