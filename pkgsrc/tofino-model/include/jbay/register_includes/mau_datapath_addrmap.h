...
#ifndef __REGISTER_INCLUDES_MAU_DATAPATH_ADDRMAP_H__
#define __REGISTER_INCLUDES_MAU_DATAPATH_ADDRMAP_H__
...
#include "action_output_delay.h"
#include "actionmux_din_power_ctl.h"
#include "cur_stage_dependency_on_prev.h"
#include "hashout_ctl.h"
#include "imem_parity_ctl.h"
#include "imem_sbe_errlog.h"
#include "imem_table_addr_egress.h"
#include "imem_table_addr_format.h"
#include "imem_table_selector_fallback_addr.h"
#include "imem_table_selector_fallback_icxbar_ctl.h"
#include "imem_word_read_override.h"
#include "intr_enable0_mau_gfm_hash.h"
#include "intr_enable0_mau_imem.h"
#include "intr_enable0_mau_snapshot.h"
#include "intr_enable1_mau_gfm_hash.h"
#include "intr_enable1_mau_imem.h"
#include "intr_enable1_mau_snapshot.h"
#include "intr_freeze_enable_mau_gfm_hash.h"
#include "intr_freeze_enable_mau_imem.h"
#include "intr_freeze_enable_mau_snapshot.h"
#include "intr_inject_mau_gfm_hash.h"
#include "intr_inject_mau_imem.h"
#include "intr_inject_mau_snapshot.h"
#include "intr_status_mau_gfm_hash.h"
#include "intr_status_mau_imem.h"
#include "intr_status_mau_snapshot.h"
#include "match_ie_input_mux_sel.h"
#include "match_input_xbar_din_power_ctl.h"
#include "mau_diag_adb_ctl.h"
#include "mau_imem_addrmap.h"
#include "mau_match_input_xbar_exact_match_enable.h"
#include "mau_match_input_xbar_hash_addrmap.h"
#include "mau_scratch.h"
#include "mau_snapshot_control_addrmap.h"
#include "mau_snapshot_datapath_addrmap.h"
#include "mau_snapshot_imem_logical_read_adr.h"
#include "mau_snapshot_imem_logical_selector_fallback.h"
#include "next_stage_dependency_on_cur.h"
#include "phv_egress_thread.h"
#include "phv_egress_thread_imem.h"
#include "phv_fifo_enable.h"
#include "phv_ingress_thread.h"
#include "phv_ingress_thread_imem.h"
#include "pipelength_added_stages.h"
#include "stage_concurrent_with_prev.h"

namespace jbay {
  namespace register_classes {

class MauDatapathAddrmap : public model_core::RegisterBlock<RegisterCallback> {
public:
  MauDatapathAddrmap(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap), 262144, false, write_callback, read_callback, std::string("MauDatapathAddrmap")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap))
    {
    }
  MauDatapathAddrmap(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "MauDatapathAddrmap")
    {
    }
public:
  ...
  PhvEgressThreadImem &phv_egress_thread_imem(int j1,int j0) { return phv_egress_thread_imem_[j1][j0]; }
  ...
  ActionmuxDinPowerCtl &actionmux_din_power_ctl(int j1,int j0) { return actionmux_din_power_ctl_[j1][j0]; }
  ...
  MatchInputXbarDinPowerCtl &match_input_xbar_din_power_ctl(int j1,int j0) { return match_input_xbar_din_power_ctl_[j1][j0]; }
  ...
  ImemTableAddrFormat &imem_table_addr_format(int j0) { return imem_table_addr_format_[j0]; }
  ...
  ImemTableSelectorFallbackAddr &imem_table_selector_fallback_addr(int j0) { return imem_table_selector_fallback_addr_[j0]; }
  ...
  MauSnapshotImemLogicalReadAdr &mau_snapshot_imem_logical_read_adr(int j0) { return mau_snapshot_imem_logical_read_adr_[j0]; }
  ...
  IntrEnable0MauGfmHash &intr_enable0_mau_gfm_hash() { return intr_enable0_mau_gfm_hash_; }
  ...
  IntrEnable1MauGfmHash &intr_enable1_mau_gfm_hash() { return intr_enable1_mau_gfm_hash_; }
  ...
  IntrInjectMauGfmHash &intr_inject_mau_gfm_hash() { return intr_inject_mau_gfm_hash_; }





  IntrFreezeEnableMauGfmHash &intr_freeze_enable_mau_gfm_hash() { return intr_freeze_enable_mau_gfm_hash_; }
  ...
  ImemWordReadOverride &imem_word_read_override() { return imem_word_read_override_; }





  MauSnapshotImemLogicalSelectorFallback &mau_snapshot_imem_logical_selector_fallback() { return mau_snapshot_imem_logical_selector_fallback_; }
  ...
  ImemTableSelectorFallbackIcxbarCtl &imem_table_selector_fallback_icxbar_ctl(int j0) { return imem_table_selector_fallback_icxbar_ctl_[j0]; }
  ...
  ActionOutputDelay &action_output_delay(int j0) { return action_output_delay_[j0]; }
  ...
  CurStageDependencyOnPrev &cur_stage_dependency_on_prev(int j0) { return cur_stage_dependency_on_prev_[j0]; }
  ...
  NextStageDependencyOnCur &next_stage_dependency_on_cur(int j0) { return next_stage_dependency_on_cur_[j0]; }
  ...
  PipelengthAddedStages &pipelength_added_stages(int j0) { return pipelength_added_stages_[j0]; }
  ...
  MauMatchInputXbarExactMatchEnable &mau_match_input_xbar_exact_match_enable(int j0) { return mau_match_input_xbar_exact_match_enable_[j0]; }
  ...
  MatchIeInputMuxSel &match_ie_input_mux_sel() { return match_ie_input_mux_sel_; }
  ...
  ImemParityCtl &imem_parity_ctl() { return imem_parity_ctl_; }
  ...
  PhvFifoEnable &phv_fifo_enable() { return phv_fifo_enable_; }





  StageConcurrentWithPrev &stage_concurrent_with_prev() { return stage_concurrent_with_prev_; }
  ...
  ImemTableAddrEgress &imem_table_addr_egress() { return imem_table_addr_egress_; }





  MauDiagAdbCtl &mau_diag_adb_ctl() { return mau_diag_adb_ctl_; }
  ...
  IntrStatusMauImem &intr_status_mau_imem() { return intr_status_mau_imem_; }
  ...
  IntrEnable0MauImem &intr_enable0_mau_imem() { return intr_enable0_mau_imem_; }
  ...
  IntrEnable1MauImem &intr_enable1_mau_imem() { return intr_enable1_mau_imem_; }
  ...
  IntrInjectMauImem &intr_inject_mau_imem() { return intr_inject_mau_imem_; }





  IntrFreezeEnableMauImem &intr_freeze_enable_mau_imem() { return intr_freeze_enable_mau_imem_; }
  ...
  IntrStatusMauSnapshot &intr_status_mau_snapshot() { return intr_status_mau_snapshot_; }
  ...
  IntrEnable0MauSnapshot &intr_enable0_mau_snapshot() { return intr_enable0_mau_snapshot_; }
  ...
  IntrEnable1MauSnapshot &intr_enable1_mau_snapshot() { return intr_enable1_mau_snapshot_; }
  ...
  IntrInjectMauSnapshot &intr_inject_mau_snapshot() { return intr_inject_mau_snapshot_; }





  IntrFreezeEnableMauSnapshot &intr_freeze_enable_mau_snapshot() { return intr_freeze_enable_mau_snapshot_; }





  MauScratch &mau_scratch() { return mau_scratch_; }
  ...
  ImemSbeErrlog &imem_sbe_errlog() { return imem_sbe_errlog_; }
  ...
  HashoutCtl &hashout_ctl() { return hashout_ctl_; }
  ...
  IntrStatusMauGfmHash &intr_status_mau_gfm_hash() { return intr_status_mau_gfm_hash_; }
  ...
  PhvIngressThread &phv_ingress_thread(int j1,int j0) { return phv_ingress_thread_[j1][j0]; }
  ...
  PhvEgressThread &phv_egress_thread(int j1,int j0) { return phv_egress_thread_[j1][j0]; }
  ...
  PhvIngressThreadImem &phv_ingress_thread_imem(int j1,int j0) { return phv_ingress_thread_imem_[j1][j0]; }





  MauImemAddrmap &imem() { return imem_; }





  MauSnapshotControlAddrmap &snapshot_ctl() { return snapshot_ctl_; }





  MauSnapshotDatapathAddrmap &snapshot_dp() { return snapshot_dp_; }





  MauMatchInputXbarHashAddrmap &xbar_hash() { return xbar_hash_; }
...
private:
  std::array< std::array< PhvEgressThreadImem, 14 >, 2 > phv_egress_thread_imem_;
  std::array< std::array< ActionmuxDinPowerCtl, 14 >, 2 > actionmux_din_power_ctl_;
  std::array< std::array< MatchInputXbarDinPowerCtl, 14 >, 2 > match_input_xbar_din_power_ctl_;
  std::array< ImemTableAddrFormat, 16 > imem_table_addr_format_;
  std::array< ImemTableSelectorFallbackAddr, 16 > imem_table_selector_fallback_addr_;
  std::array< MauSnapshotImemLogicalReadAdr, 16 > mau_snapshot_imem_logical_read_adr_;
  IntrEnable0MauGfmHash intr_enable0_mau_gfm_hash_;
  IntrEnable1MauGfmHash intr_enable1_mau_gfm_hash_;
  IntrInjectMauGfmHash intr_inject_mau_gfm_hash_;
  IntrFreezeEnableMauGfmHash intr_freeze_enable_mau_gfm_hash_;
  ImemWordReadOverride imem_word_read_override_;
  MauSnapshotImemLogicalSelectorFallback mau_snapshot_imem_logical_selector_fallback_;
  std::array< ImemTableSelectorFallbackIcxbarCtl, 4 > imem_table_selector_fallback_icxbar_ctl_;
  std::array< ActionOutputDelay, 2 > action_output_delay_;
  std::array< CurStageDependencyOnPrev, 2 > cur_stage_dependency_on_prev_;
  std::array< NextStageDependencyOnCur, 2 > next_stage_dependency_on_cur_;
  std::array< PipelengthAddedStages, 2 > pipelength_added_stages_;
  std::array< MauMatchInputXbarExactMatchEnable, 2 > mau_match_input_xbar_exact_match_enable_;
  MatchIeInputMuxSel match_ie_input_mux_sel_;
  ImemParityCtl imem_parity_ctl_;
  PhvFifoEnable phv_fifo_enable_;
  StageConcurrentWithPrev stage_concurrent_with_prev_;
  ImemTableAddrEgress imem_table_addr_egress_;
  MauDiagAdbCtl mau_diag_adb_ctl_;
  IntrStatusMauImem intr_status_mau_imem_;
  IntrEnable0MauImem intr_enable0_mau_imem_;
  IntrEnable1MauImem intr_enable1_mau_imem_;
  IntrInjectMauImem intr_inject_mau_imem_;
  IntrFreezeEnableMauImem intr_freeze_enable_mau_imem_;
  IntrStatusMauSnapshot intr_status_mau_snapshot_;
  IntrEnable0MauSnapshot intr_enable0_mau_snapshot_;
  IntrEnable1MauSnapshot intr_enable1_mau_snapshot_;
  IntrInjectMauSnapshot intr_inject_mau_snapshot_;
  IntrFreezeEnableMauSnapshot intr_freeze_enable_mau_snapshot_;
  MauScratch mau_scratch_;
  ImemSbeErrlog imem_sbe_errlog_;
  HashoutCtl hashout_ctl_;
  IntrStatusMauGfmHash intr_status_mau_gfm_hash_;
  std::array< std::array< PhvIngressThread, 14 >, 2 > phv_ingress_thread_;
  std::array< std::array< PhvEgressThread, 14 >, 2 > phv_egress_thread_;
  std::array< std::array< PhvIngressThreadImem, 14 >, 2 > phv_ingress_thread_imem_;
  MauImemAddrmap imem_;
  MauSnapshotControlAddrmap snapshot_ctl_;
  MauSnapshotDatapathAddrmap snapshot_dp_;
  MauMatchInputXbarHashAddrmap xbar_hash_;
private:
...
#endif // __REGISTER_INCLUDES_MAU_DATAPATH_ADDRMAP_H__
