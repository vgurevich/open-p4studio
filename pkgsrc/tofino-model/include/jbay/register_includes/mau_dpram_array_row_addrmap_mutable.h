...
#ifndef __REGISTER_INCLUDES_MAU_DPRAM_ARRAY_ROW_ADDRMAP_MUTABLE_H__
#define __REGISTER_INCLUDES_MAU_DPRAM_ARRAY_ROW_ADDRMAP_MUTABLE_H__
...
#include "intr_enable0_mau_synth2port_mutable.h"
#include "intr_enable1_mau_synth2port_mutable.h"
#include "intr_inject_mau_synth2port_mutable.h"
#include "intr_status_mau_synth2port_mutable.h"
#include "mau_synth2port_errlog_mutable.h"
#include "mau_synth2port_error_ctl_mutable.h"
#include "synth2port_ctl_mutable.h"
#include "synth2port_fabric_ctl_mutable.h"
#include "synth2port_hbus_members_mutable.h"
#include "synth2port_vpn_ctl_mutable.h"

namespace jbay {
  namespace register_classes {

class MauDpramArrayRowAddrmapMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  MauDpramArrayRowAddrmapMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap, index_mau_map_and_alu_row_addrmap), 128, true, write_callback, read_callback, std::string("MauDpramArrayRowAddrmapMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_map_and_alu_row_addrmap))
    {
    }
  MauDpramArrayRowAddrmapMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "MauDpramArrayRowAddrmapMutable")
    {
    }
public:
  ...
  Synth2portVpnCtlMutable &synth2port_vpn_ctl() { return synth2port_vpn_ctl_; }
  ...
  IntrStatusMauSynth2portMutable &intr_status_mau_synth2port() { return intr_status_mau_synth2port_; }
  ...
  IntrEnable0MauSynth2portMutable &intr_enable0_mau_synth2port() { return intr_enable0_mau_synth2port_; }
  ...
  IntrEnable1MauSynth2portMutable &intr_enable1_mau_synth2port() { return intr_enable1_mau_synth2port_; }
  ...
  IntrInjectMauSynth2portMutable &intr_inject_mau_synth2port() { return intr_inject_mau_synth2port_; }





  MauSynth2portErrlogMutable &mau_synth2port_errlog() { return mau_synth2port_errlog_; }





  MauSynth2portErrorCtlMutable &mau_synth2port_error_ctl() { return mau_synth2port_error_ctl_; }





  Synth2portCtlMutable &synth2port_ctl() { return synth2port_ctl_; }
  ...
  Synth2portFabricCtlMutable &synth2port_fabric_ctl(int j1,int j0) { return synth2port_fabric_ctl_[j1][j0]; }
  ...
  Synth2portHbusMembersMutable &synth2port_hbus_members(int j1,int j0) { return synth2port_hbus_members_[j1][j0]; }
...
private:
  Synth2portVpnCtlMutable synth2port_vpn_ctl_;
  IntrStatusMauSynth2portMutable intr_status_mau_synth2port_;
  IntrEnable0MauSynth2portMutable intr_enable0_mau_synth2port_;
  IntrEnable1MauSynth2portMutable intr_enable1_mau_synth2port_;
  IntrInjectMauSynth2portMutable intr_inject_mau_synth2port_;
  MauSynth2portErrlogMutable mau_synth2port_errlog_;
  MauSynth2portErrorCtlMutable mau_synth2port_error_ctl_;
  Synth2portCtlMutable synth2port_ctl_;
  std::array< std::array< Synth2portFabricCtlMutable, 2 >, 3 > synth2port_fabric_ctl_;
  std::array< std::array< Synth2portHbusMembersMutable, 2 >, 3 > synth2port_hbus_members_;
private:
...
#endif // __REGISTER_INCLUDES_MAU_DPRAM_ARRAY_ROW_ADDRMAP_MUTABLE_H__
