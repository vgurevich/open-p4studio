...
#ifndef __REGISTER_INCLUDES_MAU_MAPRAM_COLOR_SWITCHBOX_ROW_ADDRMAP_ARRAY_H__
#define __REGISTER_INCLUDES_MAU_MAPRAM_COLOR_SWITCHBOX_ROW_ADDRMAP_ARRAY_H__
...
#include "mau_mapram_color_switchbox_row_addrmap.h"
#include "mau_mapram_color_switchbox_row_control_addrmap.h"

namespace jbay {
  namespace register_classes {

class MauMapramColorSwitchboxRowAddrmapArray : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  MauMapramColorSwitchboxRowAddrmapArray(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap), 16 * ArraySize(index_pipe_addrmap, index_mau_addrmap, -1), false, write_callback, read_callback, std::string("MauMapramColorSwitchboxRowAddrmapArray")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap)),
...
public:
  ...
  MauMapramColorSwitchboxRowControlAddrmap &ctl(uint32_t a0)
  {
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("MauMapramColorSwitchboxRowAddrmapArray") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
private:
  std::vector<MauMapramColorSwitchboxRowAddrmap> array;
  uint32_t size0_;
...
#endif // __REGISTER_INCLUDES_MAU_MAPRAM_COLOR_SWITCHBOX_ROW_ADDRMAP_ARRAY_H__
