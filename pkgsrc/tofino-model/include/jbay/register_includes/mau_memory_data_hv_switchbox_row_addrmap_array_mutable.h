...
#ifndef __REGISTER_INCLUDES_MAU_MEMORY_DATA_HV_SWITCHBOX_ROW_ADDRMAP_ARRAY_MUTABLE_H__
#define __REGISTER_INCLUDES_MAU_MEMORY_DATA_HV_SWITCHBOX_ROW_ADDRMAP_ARRAY_MUTABLE_H__
...
#include "mau_memory_data_hv_switchbox_row_addrmap_mutable.h"
#include "mau_memory_data_hv_switchbox_row_control_addrmap_mutable.h"

namespace jbay {
  namespace register_classes {

class MauMemoryDataHvSwitchboxRowAddrmapArrayMutable : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  MauMemoryDataHvSwitchboxRowAddrmapArrayMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap), 64 * ArraySize(index_pipe_addrmap, index_mau_addrmap, -1), true, write_callback, read_callback, std::string("MauMemoryDataHvSwitchboxRowAddrmapArrayMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap)),
...
public:
  ...
  MauMemoryDataHvSwitchboxRowControlAddrmapMutable &ctl(uint32_t a0)
  {
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("MauMemoryDataHvSwitchboxRowAddrmapArrayMutable") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
private:
  std::vector<MauMemoryDataHvSwitchboxRowAddrmapMutable> array;
  uint32_t size0_;
...
#endif // __REGISTER_INCLUDES_MAU_MEMORY_DATA_HV_SWITCHBOX_ROW_ADDRMAP_ARRAY_MUTABLE_H__
