...
#ifndef __REGISTER_INCLUDES_MAU_METER_ALU_GROUP_ADDRMAP_ARRAY_MUTABLE_H__
#define __REGISTER_INCLUDES_MAU_METER_ALU_GROUP_ADDRMAP_ARRAY_MUTABLE_H__
...
class MauMeterAluGroupAddrmapArrayMutable : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  MauMeterAluGroupAddrmapArrayMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap), 1024 * ArraySize(index_pipe_addrmap, index_mau_addrmap, -1), true, write_callback, read_callback, std::string("MauMeterAluGroupAddrmapArrayMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap)),
...
public:
  ...
  MauMeterAluAddrmapMutable &meter(uint32_t a0)
  {
  ...
  MauSelectorAluAddrmapMutable &selector(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
  ...
  MauStatefulAluAddrmapMutable &stateful(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("MauMeterAluGroupAddrmapArrayMutable") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
private:
  std::vector<MauMeterAluGroupAddrmapMutable> array;
  uint32_t size0_;
...
#endif // __REGISTER_INCLUDES_MAU_METER_ALU_GROUP_ADDRMAP_ARRAY_MUTABLE_H__
