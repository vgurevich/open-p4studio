...
#ifndef __REGISTER_INCLUDES_MAU_SNAPSHOT_CONTROL_ADDRMAP_MUTABLE_H__
#define __REGISTER_INCLUDES_MAU_SNAPSHOT_CONTROL_ADDRMAP_MUTABLE_H__
...
#include "mau_fsm_snapshot_cur_stateq_mutable.h"
#include "mau_snapshot_config_mutable.h"
#include "mau_snapshot_datapath_capture_mutable.h"
#include "mau_snapshot_timestamp_hi_mutable.h"
#include "mau_snapshot_timestamp_lo_mutable.h"
#include "mau_snapshot_timestamp_trigger_hi_mutable.h"
#include "mau_snapshot_timestamp_trigger_lo_mutable.h"

namespace jbay {
  namespace register_classes {

class MauSnapshotControlAddrmapMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  MauSnapshotControlAddrmapMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap), 64, true, write_callback, read_callback, std::string("MauSnapshotControlAddrmapMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap))
    {
    }
  MauSnapshotControlAddrmapMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "MauSnapshotControlAddrmapMutable")
    {
    }
public:
  ...
  MauFsmSnapshotCurStateqMutable &mau_fsm_snapshot_cur_stateq(int j0) { return mau_fsm_snapshot_cur_stateq_[j0]; }





  MauSnapshotConfigMutable &mau_snapshot_config() { return mau_snapshot_config_; }
  ...
  MauSnapshotTimestampTriggerHiMutable &mau_snapshot_timestamp_trigger_hi() { return mau_snapshot_timestamp_trigger_hi_; }
  ...
  MauSnapshotTimestampTriggerLoMutable &mau_snapshot_timestamp_trigger_lo() { return mau_snapshot_timestamp_trigger_lo_; }
  ...
  MauSnapshotTimestampHiMutable &mau_snapshot_timestamp_hi() { return mau_snapshot_timestamp_hi_; }
  ...
  MauSnapshotTimestampLoMutable &mau_snapshot_timestamp_lo() { return mau_snapshot_timestamp_lo_; }
  ...
  MauSnapshotDatapathCaptureMutable &mau_snapshot_datapath_capture(int j0) { return mau_snapshot_datapath_capture_[j0]; }
...
private:
  std::array< MauFsmSnapshotCurStateqMutable, 2 > mau_fsm_snapshot_cur_stateq_;
  MauSnapshotConfigMutable mau_snapshot_config_;
  MauSnapshotTimestampTriggerHiMutable mau_snapshot_timestamp_trigger_hi_;
  MauSnapshotTimestampTriggerLoMutable mau_snapshot_timestamp_trigger_lo_;
  MauSnapshotTimestampHiMutable mau_snapshot_timestamp_hi_;
  MauSnapshotTimestampLoMutable mau_snapshot_timestamp_lo_;
  std::array< MauSnapshotDatapathCaptureMutable, 2 > mau_snapshot_datapath_capture_;
private:
...
#endif // __REGISTER_INCLUDES_MAU_SNAPSHOT_CONTROL_ADDRMAP_MUTABLE_H__
