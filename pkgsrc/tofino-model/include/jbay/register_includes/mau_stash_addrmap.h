...
public:
  ...
  StashBusOverloadBytemask &stash_bus_overload_bytemask(int j0) { return stash_bus_overload_bytemask_[j0]; }
...
private:
  ...
  std::array< StashBusOverloadBytemask, 2 > stash_bus_overload_bytemask_;
