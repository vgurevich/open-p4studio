...
#ifndef __REGISTER_INCLUDES_MAU_STATEFUL_LOG_COUNTER_OXBAR_MAP_ARRAY_MUTABLE_H__
#define __REGISTER_INCLUDES_MAU_STATEFUL_LOG_COUNTER_OXBAR_MAP_ARRAY_MUTABLE_H__
...
class MauStatefulLogCounterOxbarMapArrayMutable : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  MauStatefulLogCounterOxbarMapArrayMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap), 4 * ArraySize(index_pipe_addrmap, index_mau_addrmap, -1), true, write_callback, read_callback, std::string("MauStatefulLogCounterOxbarMapArrayMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap)),
...
public:
  ...
  uint8_t stateful_log_counter_oxbar_ctl(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    return array[a0].stateful_log_counter_oxbar_ctl();
  }
  void stateful_log_counter_oxbar_ctl(uint32_t a0,const uint8_t &v) 
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    array[a0].stateful_log_counter_oxbar_ctl(v);
  }


  uint8_t stateful_log_counter_oxbar_enable(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    return array[a0].stateful_log_counter_oxbar_enable();
  }
  void stateful_log_counter_oxbar_enable(uint32_t a0,const uint8_t &v) 
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    array[a0].stateful_log_counter_oxbar_enable(v);
  }
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("MauStatefulLogCounterOxbarMapArrayMutable") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
private:
  std::vector<MauStatefulLogCounterOxbarMapMutable> array;
  uint32_t size0_;
...
#endif // __REGISTER_INCLUDES_MAU_STATEFUL_LOG_COUNTER_OXBAR_MAP_ARRAY_MUTABLE_H__
