...
#ifndef __REGISTER_INCLUDES_MAU_TCAM_ARRAY_ADDRMAP_H__
#define __REGISTER_INCLUDES_MAU_TCAM_ARRAY_ADDRMAP_H__
...
#include "atomic_mod_tcam_go.h"
#include "intr_enable0_mau_tcam_array.h"
#include "intr_enable1_mau_tcam_array.h"
#include "intr_freeze_enable_mau_tcam_array.h"
#include "intr_inject_mau_tcam_array.h"
#include "intr_status_mau_tcam_array.h"
#include "mau_diag_tcam_clk_en.h"
#include "mau_tcam_column_addrmap.h"
#include "mau_tcam_row_vh_xbar_array_addrmap.h"
#include "tcam_error_detect_enable.h"
#include "tcam_logical_channel_errlog_hi.h"
#include "tcam_logical_channel_errlog_lo.h"
#include "tcam_match_adr_shift.h"
#include "tcam_output_table_thread.h"
#include "tcam_parity_control.h"
#include "tcam_piped.h"
#include "tcam_sbe_errlog.h"

namespace jbay {
  namespace register_classes {

class MauTcamArrayAddrmap : public model_core::RegisterBlock<RegisterCallback> {
public:
  MauTcamArrayAddrmap(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap), 2048, false, write_callback, read_callback, std::string("MauTcamArrayAddrmap")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap))
    {
    }
  MauTcamArrayAddrmap(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "MauTcamArrayAddrmap")
    {
    }
public:
  ...
  TcamSbeErrlog &tcam_sbe_errlog(int j0) { return tcam_sbe_errlog_[j0]; }
  ...
  MauDiagTcamClkEn &mau_diag_tcam_clk_en() { return mau_diag_tcam_clk_en_; }
  ...
  IntrStatusMauTcamArray &intr_status_mau_tcam_array() { return intr_status_mau_tcam_array_; }
  ...
  IntrEnable0MauTcamArray &intr_enable0_mau_tcam_array() { return intr_enable0_mau_tcam_array_; }
  ...
  IntrEnable1MauTcamArray &intr_enable1_mau_tcam_array() { return intr_enable1_mau_tcam_array_; }
  ...
  TcamMatchAdrShift &tcam_match_adr_shift(int j0) { return tcam_match_adr_shift_[j0]; }
  ...
  TcamOutputTableThread &tcam_output_table_thread(int j0) { return tcam_output_table_thread_[j0]; }
  ...
  IntrInjectMauTcamArray &intr_inject_mau_tcam_array() { return intr_inject_mau_tcam_array_; }





  IntrFreezeEnableMauTcamArray &intr_freeze_enable_mau_tcam_array() { return intr_freeze_enable_mau_tcam_array_; }
  ...
  TcamLogicalChannelErrlogLo &tcam_logical_channel_errlog_lo(int j0) { return tcam_logical_channel_errlog_lo_[j0]; }
  ...
  TcamLogicalChannelErrlogHi &tcam_logical_channel_errlog_hi(int j0) { return tcam_logical_channel_errlog_hi_[j0]; }
  ...
  AtomicModTcamGo &atomic_mod_tcam_go() { return atomic_mod_tcam_go_; }
  ...
  TcamPiped &tcam_piped() { return tcam_piped_; }
  ...
  TcamErrorDetectEnable &tcam_error_detect_enable() { return tcam_error_detect_enable_; }
  ...
  TcamParityControl &tcam_parity_control(int j0) { return tcam_parity_control_[j0]; }





  MauTcamRowVhXbarArrayAddrmap &vh_data_xbar() { return vh_data_xbar_; }
  ...
  MauTcamColumnAddrmap &col(int j0) { return col_[j0]; }
...
private:
  std::array< TcamSbeErrlog, 12 > tcam_sbe_errlog_;
  MauDiagTcamClkEn mau_diag_tcam_clk_en_;
  IntrStatusMauTcamArray intr_status_mau_tcam_array_;
  IntrEnable0MauTcamArray intr_enable0_mau_tcam_array_;
  IntrEnable1MauTcamArray intr_enable1_mau_tcam_array_;
  std::array< TcamMatchAdrShift, 8 > tcam_match_adr_shift_;
  std::array< TcamOutputTableThread, 8 > tcam_output_table_thread_;
  IntrInjectMauTcamArray intr_inject_mau_tcam_array_;
  IntrFreezeEnableMauTcamArray intr_freeze_enable_mau_tcam_array_;
  std::array< TcamLogicalChannelErrlogLo, 4 > tcam_logical_channel_errlog_lo_;
  std::array< TcamLogicalChannelErrlogHi, 4 > tcam_logical_channel_errlog_hi_;
  AtomicModTcamGo atomic_mod_tcam_go_;
  TcamPiped tcam_piped_;
  TcamErrorDetectEnable tcam_error_detect_enable_;
  std::array< TcamParityControl, 12 > tcam_parity_control_;
  MauTcamRowVhXbarArrayAddrmap vh_data_xbar_;
  std::array< MauTcamColumnAddrmap, 2 > col_;
private:
...
#endif // __REGISTER_INCLUDES_MAU_TCAM_ARRAY_ADDRMAP_H__
