...
#ifndef __REGISTER_INCLUDES_MBUS_BARESYNC_TS_INC_ALT_H__
#define __REGISTER_INCLUDES_MBUS_BARESYNC_TS_INC_ALT_H__
...
class MbusBaresyncTsIncAlt : public model_core::RegisterBlock<RegisterCallback> {
public:
  MbusBaresyncTsIncAlt(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 12, false, write_callback, read_callback, std::string("MbusBaresyncTsIncAlt"))
    {
    }
  MbusBaresyncTsIncAlt(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "MbusBaresyncTsIncAlt")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("MbusBaresyncTsIncAlt") + ":\n";
...
#endif // __REGISTER_INCLUDES_MBUS_BARESYNC_TS_INC_ALT_H__
