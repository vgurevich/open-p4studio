...
#ifndef __REGISTER_INCLUDES_MBUS_CTRL_H__
#define __REGISTER_INCLUDES_MBUS_CTRL_H__
...
class MbusCtrl : public model_core::RegisterBlock<RegisterCallback> {
public:
  MbusCtrl(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 4, false, write_callback, read_callback, std::string("MbusCtrl"))
    {
    }
  MbusCtrl(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "MbusCtrl")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("MbusCtrl") + ":\n";
...
#endif // __REGISTER_INCLUDES_MBUS_CTRL_H__
