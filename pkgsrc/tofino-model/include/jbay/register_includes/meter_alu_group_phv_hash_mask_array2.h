...
#ifndef __REGISTER_INCLUDES_METER_ALU_GROUP_PHV_HASH_MASK_ARRAY2_H__
#define __REGISTER_INCLUDES_METER_ALU_GROUP_PHV_HASH_MASK_ARRAY2_H__
...
class MeterAluGroupPhvHashMaskArray2 : public model_core::RegisterBlock<RegisterArrayCallback2> {
public:
  MeterAluGroupPhvHashMaskArray2(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap), 4 * ArraySize(index_pipe_addrmap, index_mau_addrmap, -1), false, write_callback, read_callback, std::string("MeterAluGroupPhvHashMaskArray2")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap)),
...
public:
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("MeterAluGroupPhvHashMaskArray2") + "["+boost::lexical_cast<std::string>(a1)+"]"+"["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
private:
  std::vector<MeterAluGroupPhvHashMask> array;
  uint32_t size0_;
...
#endif // __REGISTER_INCLUDES_METER_ALU_GROUP_PHV_HASH_MASK_ARRAY2_H__
