...
#ifndef __REGISTER_INCLUDES_METER_CTL_H__
#define __REGISTER_INCLUDES_METER_CTL_H__
...
class MeterCtl : public model_core::RegisterBlock<RegisterCallback> {
public:
  MeterCtl(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap, index_mau_meter_alu_group_addrmap), 4, false, write_callback, read_callback, std::string("MeterCtl")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_meter_alu_group_addrmap))
    {
    }
  MeterCtl(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "MeterCtl")
    {
    }
public:
  ...
  uint8_t &meter_lpf_sat_ctl() { return meter_lpf_sat_ctl_; }


  uint8_t &meter_lpf_virtual_access_ctl() { return meter_lpf_virtual_access_ctl_; }
  ...
  bool read(
    ...
    *data |= ((meter_lpf_sat_ctl_ & 0x1) << 24);
    *data |= ((meter_lpf_virtual_access_ctl_ & 0x1) << 25);
    return true;
  }
  ...
  bool write(
    ...
    meter_lpf_sat_ctl_ = ((data >> 24) & 0x1);
    meter_lpf_virtual_access_ctl_ = ((data >> 25) & 0x1);
  ...
  void reset(
    ...
    meter_lpf_sat_ctl_ = 0x0;
    meter_lpf_virtual_access_ctl_ = 0x0;
    if (write_callback_) write_callback_();
  }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("MeterCtl") + ":\n";
    ...
    r += indent_string + "  " + std::string("meter_lpf_sat_ctl") +  ": 0x" + boost::str( boost::format("%x") % static_cast<uint>(meter_lpf_sat_ctl_) ) + "\n";
    all_zeros &= (0 == meter_lpf_sat_ctl_);
    r += indent_string + "  " + std::string("meter_lpf_virtual_access_ctl") +  ": 0x" + boost::str( boost::format("%x") % static_cast<uint>(meter_lpf_virtual_access_ctl_) ) + "\n";
    all_zeros &= (0 == meter_lpf_virtual_access_ctl_);
...
private:
  ...
  uint8_t meter_lpf_sat_ctl_;
  uint8_t meter_lpf_virtual_access_ctl_;
private:
  static int StartOffset(
    ...
    offset += 0xc; // to get to meter_ctl
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_METER_CTL_H__
