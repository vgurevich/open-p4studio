...
#ifndef __REGISTER_INCLUDES_METER_SWEEP_NUM_SUBWORDS_ARRAY_H__
#define __REGISTER_INCLUDES_METER_SWEEP_NUM_SUBWORDS_ARRAY_H__
...
class MeterSweepNumSubwordsArray : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  MeterSweepNumSubwordsArray(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap), 4 * ArraySize(index_pipe_addrmap, index_mau_addrmap, -1), false, write_callback, read_callback, std::string("MeterSweepNumSubwordsArray")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap)),
...
public:
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("MeterSweepNumSubwordsArray") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
private:
  std::vector<MeterSweepNumSubwords> array;
  uint32_t size0_;
...
#endif // __REGISTER_INCLUDES_METER_SWEEP_NUM_SUBWORDS_ARRAY_H__
