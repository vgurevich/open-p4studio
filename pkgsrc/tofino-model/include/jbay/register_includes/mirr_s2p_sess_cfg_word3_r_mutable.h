...
#ifndef __REGISTER_INCLUDES_MIRR_S2P_SESS_CFG_WORD3_R_MUTABLE_H__
#define __REGISTER_INCLUDES_MIRR_S2P_SESS_CFG_WORD3_R_MUTABLE_H__
...
class MirrS2pSessCfgWord3RMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  MirrS2pSessCfgWord3RMutable(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 4, true, write_callback, read_callback, std::string("MirrS2pSessCfgWord3RMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  MirrS2pSessCfgWord3RMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "MirrS2pSessCfgWord3RMutable")
    {
    }
public:
  ...
  void hash1_f(const uint16_t &v) { hash1_f_=v; }
  ...
  void hash2_f(const uint16_t &v) { hash2_f_=v; }
  ...
  void pipe_vec_f(const uint8_t &v) { pipe_vec_f_=v; }
  ...
  void egress_bypass_f(const uint8_t &v) { egress_bypass_f_=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("MirrS2pSessCfgWord3RMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_MIRR_S2P_SESS_CFG_WORD3_R_MUTABLE_H__
