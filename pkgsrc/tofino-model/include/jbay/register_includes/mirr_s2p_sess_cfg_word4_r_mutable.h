...
#ifndef __REGISTER_INCLUDES_MIRR_S2P_SESS_CFG_WORD4_R_MUTABLE_H__
#define __REGISTER_INCLUDES_MIRR_S2P_SESS_CFG_WORD4_R_MUTABLE_H__
...
class MirrS2pSessCfgWord4RMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  MirrS2pSessCfgWord4RMutable(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 4, true, write_callback, read_callback, std::string("MirrS2pSessCfgWord4RMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  MirrS2pSessCfgWord4RMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "MirrS2pSessCfgWord4RMutable")
    {
    }
public:
  ...
  void icos_f(const uint8_t &v) { icos_f_=v; }
  ...
  void color_f(const uint8_t &v) { color_f_=v; }
  ...
  void mcid1_vld_f(const uint8_t &v) { mcid1_vld_f_=v; }
  ...
  void mcid2_vld_f(const uint8_t &v) { mcid2_vld_f_=v; }
  ...
  void c2c_cos_f(const uint8_t &v) { c2c_cos_f_=v; }
  ...
  void c2c_vld_f(const uint8_t &v) { c2c_vld_f_=v; }
  ...
  void yid_tbl_sel_f(const uint8_t &v) { yid_tbl_sel_f_=v; }
  ...
  void eport_qid_f(const uint8_t &v) { eport_qid_f_=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("MirrS2pSessCfgWord4RMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_MIRR_S2P_SESS_CFG_WORD4_R_MUTABLE_H__
