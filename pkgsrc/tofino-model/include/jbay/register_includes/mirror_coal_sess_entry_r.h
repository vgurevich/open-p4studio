...
#ifndef __REGISTER_INCLUDES_MIRROR_COAL_SESS_ENTRY_R_H__
#define __REGISTER_INCLUDES_MIRROR_COAL_SESS_ENTRY_R_H__
...
class MirrorCoalSessEntryR : public model_core::RegisterBlock<RegisterCallback> {
public:
  MirrorCoalSessEntryR(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mirror_slice_mem, index_mirror_coal_sess_entry_r), 4, false, write_callback, read_callback, std::string("MirrorCoalSessEntryR")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mirror_slice_mem) + "," + boost::lexical_cast<std::string>(index_mirror_coal_sess_entry_r))
    {
    }
  MirrorCoalSessEntryR(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "MirrorCoalSessEntryR")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("MirrorCoalSessEntryR") + ":\n";
...
#endif // __REGISTER_INCLUDES_MIRROR_COAL_SESS_ENTRY_R_H__
