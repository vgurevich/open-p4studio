...
#ifndef __REGISTER_INCLUDES_MIRROR_S2P_REGS_H__
#define __REGISTER_INCLUDES_MIRROR_S2P_REGS_H__
...
#include "mirr_crc_ctrl_r.h"
#include "mirr_s2p_coal_to_interval_r.h"
#include "mirr_s2p_sess_cfg_word0_r.h"
#include "mirr_s2p_sess_cfg_word1_r.h"
#include "mirr_s2p_sess_cfg_word2_r.h"
#include "mirr_s2p_sess_cfg_word3_r.h"
#include "mirr_s2p_sess_cfg_word4_r.h"
#include "mirror_s2p_cnt48_inc.h"
#include "mirror_s2p_curr_credits_r.h"
#include "mirror_s2p_dprsr_bubble_width_r.h"
#include "mirror_s2p_regs_intr.h"
#include "mirror_s2p_regs_s2p_session_mbe_err_log.h"
#include "mirror_s2p_regs_s2p_session_sbe_err_log.h"
#include "s2p_credits_config_r.h"
#include "s2p_session_ecc_inj_ctrl_r.h"

namespace jbay {
  namespace register_classes {

class MirrorS2pRegs : public model_core::RegisterBlock<RegisterCallback> {
public:
  MirrorS2pRegs(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 256, false, write_callback, read_callback, std::string("MirrorS2pRegs")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  MirrorS2pRegs(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "MirrorS2pRegs")
    {
    }
public:
  ...
  S2pCreditsConfigR &s2p_credit_cfg() { return s2p_credit_cfg_; }
  ...
  MirrS2pSessCfgWord0R &sess_entry_word0() { return sess_entry_word0_; }





  MirrS2pSessCfgWord1R &sess_entry_word1() { return sess_entry_word1_; }





  MirrS2pSessCfgWord2R &sess_entry_word2() { return sess_entry_word2_; }





  MirrS2pSessCfgWord3R &sess_entry_word3() { return sess_entry_word3_; }





  MirrS2pSessCfgWord4R &sess_entry_word4() { return sess_entry_word4_; }





  MirrS2pCoalToIntervalR &coal_to_interval() { return coal_to_interval_; }





  MirrorS2pRegsS2pSessionSbeErrLog &s2p_session_sbe_err_log() { return s2p_session_sbe_err_log_; }





  MirrorS2pRegsS2pSessionMbeErrLog &s2p_session_mbe_err_log() { return s2p_session_mbe_err_log_; }





  S2pSessionEccInjCtrlR &s2p_session_ecc_ctrl() { return s2p_session_ecc_ctrl_; }





  MirrCrcCtrlR &mirr_crc_ctrl() { return mirr_crc_ctrl_; }





  MirrorS2pCnt48Inc &ctr48() { return ctr48_; }
  ...
  MirrorS2pDprsrBubbleWidthR &dprsr_bubble() { return dprsr_bubble_; }





  MirrorS2pCurrCreditsR &curr_s2p() { return curr_s2p_; }
  MirrorS2pRegsIntr &intr() { return intr_; }
...
private:
  S2pCreditsConfigR s2p_credit_cfg_;
  MirrS2pSessCfgWord0R sess_entry_word0_;
  MirrS2pSessCfgWord1R sess_entry_word1_;
  MirrS2pSessCfgWord2R sess_entry_word2_;
  MirrS2pSessCfgWord3R sess_entry_word3_;
  MirrS2pSessCfgWord4R sess_entry_word4_;
  MirrS2pCoalToIntervalR coal_to_interval_;
  MirrorS2pRegsS2pSessionSbeErrLog s2p_session_sbe_err_log_;
  MirrorS2pRegsS2pSessionMbeErrLog s2p_session_mbe_err_log_;
  S2pSessionEccInjCtrlR s2p_session_ecc_ctrl_;
  MirrCrcCtrlR mirr_crc_ctrl_;
  MirrorS2pCnt48Inc ctr48_;
  MirrorS2pDprsrBubbleWidthR dprsr_bubble_;
  MirrorS2pCurrCreditsR curr_s2p_;
  MirrorS2pRegsIntr intr_;
private:
...
#endif // __REGISTER_INCLUDES_MIRROR_S2P_REGS_H__
