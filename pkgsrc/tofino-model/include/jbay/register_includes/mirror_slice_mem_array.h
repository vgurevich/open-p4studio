...
#ifndef __REGISTER_INCLUDES_MIRROR_SLICE_MEM_ARRAY_H__
#define __REGISTER_INCLUDES_MIRROR_SLICE_MEM_ARRAY_H__
...
class MirrorSliceMemArray : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  MirrorSliceMemArray(
      int chipNumber, int index_pipe_addrmap, RegisterArrayCallback& write_callback = 0, RegisterArrayCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 2048 * ArraySize(index_pipe_addrmap, -1), false, write_callback, read_callback, std::string("MirrorSliceMemArray")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap)),
...
public:
  MirrorSessCfg &sess_cfg(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    return array[a0].sess_cfg();
  }
  MirrorCoalSessCfg &coal_sess_cfg(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    return array[a0].coal_sess_cfg();
  }
  MirrorCoalToCfg &coal_to_cfg(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("MirrorSliceMemArray") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
private:
  std::vector<MirrorSliceMem> array;
  uint32_t size0_;
...
#endif // __REGISTER_INCLUDES_MIRROR_SLICE_MEM_ARRAY_H__
