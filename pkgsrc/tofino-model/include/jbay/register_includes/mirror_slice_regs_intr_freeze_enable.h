...
#ifndef __REGISTER_INCLUDES_MIRROR_SLICE_REGS_INTR_FREEZE_ENABLE_H__
#define __REGISTER_INCLUDES_MIRROR_SLICE_REGS_INTR_FREEZE_ENABLE_H__
...
class MirrorSliceRegsIntrFreezeEnable : public model_core::RegisterBlock<RegisterCallback> {
public:
  MirrorSliceRegsIntrFreezeEnable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mirror_slice_regs), 4, false, write_callback, read_callback, std::string("MirrorSliceRegsIntrFreezeEnable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mirror_slice_regs))
    {
    }
  MirrorSliceRegsIntrFreezeEnable(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "MirrorSliceRegsIntrFreezeEnable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("MirrorSliceRegsIntrFreezeEnable") + ":\n";
...
#endif // __REGISTER_INCLUDES_MIRROR_SLICE_REGS_INTR_FREEZE_ENABLE_H__
