...
#ifndef __REGISTER_INCLUDES_MIRROR_SLICE_REGS_MUTABLE_H__
#define __REGISTER_INCLUDES_MIRROR_SLICE_REGS_MUTABLE_H__
...
#include "mirr_dbuff_cnt_mutable.h"
#include "mirr_dbuff_th_mutable.h"
#include "mirr_dbuff_wm_mutable.h"
#include "mirr_qdepth_mutable.h"
#include "mirror_cnt48_inc_mutable.h"
#include "mirror_slice_ctrl_mutable.h"
#include "mirror_slice_regs_data_mem_mbe_err_log_mutable.h"
#include "mirror_slice_regs_data_mem_sbe_err_log_mutable.h"
#include "mirror_slice_regs_intr_mutable.h"
#include "mirror_slice_regs_m_slice_ecc_mutable.h"
#include "mirror_slice_regs_meta_mem_mbe_err_log_mutable.h"
#include "mirror_slice_regs_meta_mem_sbe_err_log_mutable.h"
#include "mirror_slice_regs_session_mem_mbe_err_log_mutable.h"
#include "mirror_slice_regs_session_mem_sbe_err_log_mutable.h"

namespace jbay {
  namespace register_classes {

class MirrorSliceRegsMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  MirrorSliceRegsMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mirror_slice_regs), 4096, true, write_callback, read_callback, std::string("MirrorSliceRegsMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mirror_slice_regs))
    {
    }
  MirrorSliceRegsMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "MirrorSliceRegsMutable")
    {
    }
public:
  ...
  MirrorSliceCtrlMutable &slice_ctr() { return slice_ctr_; }
  ...
  MirrDbuffWmMutable &dbuff_wm(int j0) { return dbuff_wm_[j0]; }
  ...
  MirrDbuffCntMutable &dbuff_cnt(int j0) { return dbuff_cnt_[j0]; }





  MirrDbuffThMutable &dbuff_th() { return dbuff_th_; }




  MirrQdepthMutable &qdepth(int j0) { return qdepth_[j0]; }
  ...
  MirrorCnt48IncMutable &mirror_out_pkt_cnt(int j0) { return mirror_out_pkt_cnt_[j0]; }





  MirrorCnt48IncMutable &mirror_egress_in_pk_cnt() { return mirror_egress_in_pk_cnt_; }





  MirrorCnt48IncMutable &mirror_ingress_in_pk_cnt() { return mirror_ingress_in_pk_cnt_; }





  MirrorCnt48IncMutable &mirror_ingress_dbuf_drop_pk_cnt() { return mirror_ingress_dbuf_drop_pk_cnt_; }





  MirrorCnt48IncMutable &mirror_egress_dbuf_drop_pk_cnt() { return mirror_egress_dbuf_drop_pk_cnt_; }
  ...
  MirrorSliceRegsMSliceEccMutable &m_slice_ecc() { return m_slice_ecc_; }
  ...
  MirrorSliceRegsSessionMemSbeErrLogMutable &session_mem_sbe_err_log() { return session_mem_sbe_err_log_; }





  MirrorSliceRegsSessionMemMbeErrLogMutable &session_mem_mbe_err_log() { return session_mem_mbe_err_log_; }





  MirrorSliceRegsDataMemSbeErrLogMutable &data_mem_sbe_err_log() { return data_mem_sbe_err_log_; }





  MirrorSliceRegsDataMemMbeErrLogMutable &data_mem_mbe_err_log() { return data_mem_mbe_err_log_; }





  MirrorSliceRegsMetaMemSbeErrLogMutable &meta_mem_sbe_err_log() { return meta_mem_sbe_err_log_; }





  MirrorSliceRegsMetaMemMbeErrLogMutable &meta_mem_mbe_err_log() { return meta_mem_mbe_err_log_; }
  MirrorSliceRegsIntrMutable &intr() { return intr_; }
...
private:
  MirrorSliceCtrlMutable slice_ctr_;
  std::array< MirrDbuffWmMutable, 5 > dbuff_wm_;
  std::array< MirrDbuffCntMutable, 5 > dbuff_cnt_;
  MirrDbuffThMutable dbuff_th_;
  std::array< MirrQdepthMutable, 54 > qdepth_;
  std::array< MirrorCnt48IncMutable, 5 > mirror_out_pkt_cnt_;
  MirrorCnt48IncMutable mirror_egress_in_pk_cnt_;
  MirrorCnt48IncMutable mirror_ingress_in_pk_cnt_;
  MirrorCnt48IncMutable mirror_ingress_dbuf_drop_pk_cnt_;
  MirrorCnt48IncMutable mirror_egress_dbuf_drop_pk_cnt_;
  MirrorSliceRegsMSliceEccMutable m_slice_ecc_;
  MirrorSliceRegsSessionMemSbeErrLogMutable session_mem_sbe_err_log_;
  MirrorSliceRegsSessionMemMbeErrLogMutable session_mem_mbe_err_log_;
  MirrorSliceRegsDataMemSbeErrLogMutable data_mem_sbe_err_log_;
  MirrorSliceRegsDataMemMbeErrLogMutable data_mem_mbe_err_log_;
  MirrorSliceRegsMetaMemSbeErrLogMutable meta_mem_sbe_err_log_;
  MirrorSliceRegsMetaMemMbeErrLogMutable meta_mem_mbe_err_log_;
  MirrorSliceRegsIntrMutable intr_;
private:
...
#endif // __REGISTER_INCLUDES_MIRROR_SLICE_REGS_MUTABLE_H__
