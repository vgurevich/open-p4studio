...
#ifndef __REGISTER_INCLUDES_MISC_REGS_MISC_INTR_EN0_H__
#define __REGISTER_INCLUDES_MISC_REGS_MISC_INTR_EN0_H__
...
class MiscRegsMiscIntrEn0 : public model_core::RegisterBlock<RegisterCallback> {
public:
  MiscRegsMiscIntrEn0(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 4, false, write_callback, read_callback, std::string("MiscRegsMiscIntrEn0"))
    {
    }
  MiscRegsMiscIntrEn0(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "MiscRegsMiscIntrEn0")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("MiscRegsMiscIntrEn0") + ":\n";
...
#endif // __REGISTER_INCLUDES_MISC_REGS_MISC_INTR_EN0_H__
