...
#ifndef __REGISTER_INCLUDES_MISC_REGS_MISC_INTR_EN1_H__
#define __REGISTER_INCLUDES_MISC_REGS_MISC_INTR_EN1_H__
...
class MiscRegsMiscIntrEn1 : public model_core::RegisterBlock<RegisterCallback> {
public:
  MiscRegsMiscIntrEn1(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 4, false, write_callback, read_callback, std::string("MiscRegsMiscIntrEn1"))
    {
    }
  MiscRegsMiscIntrEn1(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "MiscRegsMiscIntrEn1")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("MiscRegsMiscIntrEn1") + ":\n";
...
#endif // __REGISTER_INCLUDES_MISC_REGS_MISC_INTR_EN1_H__
