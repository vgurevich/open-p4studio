...
#ifndef __REGISTER_INCLUDES_MISC_REGS_MISC_INTR_FREEZE_ENABLE_H__
#define __REGISTER_INCLUDES_MISC_REGS_MISC_INTR_FREEZE_ENABLE_H__
...
class MiscRegsMiscIntrFreezeEnable : public model_core::RegisterBlock<RegisterCallback> {
public:
  MiscRegsMiscIntrFreezeEnable(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 4, false, write_callback, read_callback, std::string("MiscRegsMiscIntrFreezeEnable"))
    {
    }
  MiscRegsMiscIntrFreezeEnable(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "MiscRegsMiscIntrFreezeEnable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("MiscRegsMiscIntrFreezeEnable") + ":\n";
...
#endif // __REGISTER_INCLUDES_MISC_REGS_MISC_INTR_FREEZE_ENABLE_H__
