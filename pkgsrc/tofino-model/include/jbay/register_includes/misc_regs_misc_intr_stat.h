...
#ifndef __REGISTER_INCLUDES_MISC_REGS_MISC_INTR_STAT_H__
#define __REGISTER_INCLUDES_MISC_REGS_MISC_INTR_STAT_H__
...
class MiscRegsMiscIntrStat : public model_core::RegisterBlock<RegisterCallback> {
public:
  MiscRegsMiscIntrStat(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 4, false, write_callback, read_callback, std::string("MiscRegsMiscIntrStat"))
    {
    }
  MiscRegsMiscIntrStat(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "MiscRegsMiscIntrStat")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("MiscRegsMiscIntrStat") + ":\n";
...
#endif // __REGISTER_INCLUDES_MISC_REGS_MISC_INTR_STAT_H__
