...
#ifndef __REGISTER_INCLUDES_MISC_REGS_TV80_INTR_EN0_MUTABLE_H__
#define __REGISTER_INCLUDES_MISC_REGS_TV80_INTR_EN0_MUTABLE_H__
...
class MiscRegsTv80IntrEn0Mutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  MiscRegsTv80IntrEn0Mutable(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 4, true, write_callback, read_callback, std::string("MiscRegsTv80IntrEn0Mutable"))
    {
    }
  MiscRegsTv80IntrEn0Mutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "MiscRegsTv80IntrEn0Mutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("MiscRegsTv80IntrEn0Mutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x244; // to get to tv80_intr_en0
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_MISC_REGS_TV80_INTR_EN0_MUTABLE_H__
