...
#ifndef __REGISTER_INCLUDES_MISC_REGS_TV80_INTR_EN1_H__
#define __REGISTER_INCLUDES_MISC_REGS_TV80_INTR_EN1_H__
...
class MiscRegsTv80IntrEn1 : public model_core::RegisterBlock<RegisterCallback> {
public:
  MiscRegsTv80IntrEn1(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 4, false, write_callback, read_callback, std::string("MiscRegsTv80IntrEn1"))
    {
    }
  MiscRegsTv80IntrEn1(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "MiscRegsTv80IntrEn1")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("MiscRegsTv80IntrEn1") + ":\n";
...
#endif // __REGISTER_INCLUDES_MISC_REGS_TV80_INTR_EN1_H__
