...
#ifndef __REGISTER_INCLUDES_MISC_REGS_TV80_INTR_FREEZE_ENABLE_MUTABLE_H__
#define __REGISTER_INCLUDES_MISC_REGS_TV80_INTR_FREEZE_ENABLE_MUTABLE_H__
...
class MiscRegsTv80IntrFreezeEnableMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  MiscRegsTv80IntrFreezeEnableMutable(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 4, true, write_callback, read_callback, std::string("MiscRegsTv80IntrFreezeEnableMutable"))
    {
    }
  MiscRegsTv80IntrFreezeEnableMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "MiscRegsTv80IntrFreezeEnableMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("MiscRegsTv80IntrFreezeEnableMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x250; // to get to tv80_intr_freeze_enable
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_MISC_REGS_TV80_INTR_FREEZE_ENABLE_MUTABLE_H__
