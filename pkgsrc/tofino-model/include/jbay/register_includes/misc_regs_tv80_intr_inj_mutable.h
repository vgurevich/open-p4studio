...
#ifndef __REGISTER_INCLUDES_MISC_REGS_TV80_INTR_INJ_MUTABLE_H__
#define __REGISTER_INCLUDES_MISC_REGS_TV80_INTR_INJ_MUTABLE_H__
...
class MiscRegsTv80IntrInjMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  MiscRegsTv80IntrInjMutable(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 4, true, write_callback, read_callback, std::string("MiscRegsTv80IntrInjMutable"))
    {
    }
  MiscRegsTv80IntrInjMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "MiscRegsTv80IntrInjMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("MiscRegsTv80IntrInjMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x24c; // to get to tv80_intr_inj
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_MISC_REGS_TV80_INTR_INJ_MUTABLE_H__
