...
#ifndef __REGISTER_INCLUDES_MPR_GLOB_EXEC_LUT_ARRAY_MUTABLE_H__
#define __REGISTER_INCLUDES_MPR_GLOB_EXEC_LUT_ARRAY_MUTABLE_H__
...
class MprGlobExecLutArrayMutable : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  MprGlobExecLutArrayMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap), 4 * ArraySize(index_pipe_addrmap, index_mau_addrmap, -1), true, write_callback, read_callback, std::string("MprGlobExecLutArrayMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap)),
...
public:
  uint16_t mpr_glob_exec_lut(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    return array[a0].mpr_glob_exec_lut();
  }
  void mpr_glob_exec_lut(uint32_t a0,const uint16_t &v) 
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    array[a0].mpr_glob_exec_lut(v);
  }
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("MprGlobExecLutArrayMutable") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
private:
  std::vector<MprGlobExecLutMutable> array;
  uint32_t size0_;
...
#endif // __REGISTER_INCLUDES_MPR_GLOB_EXEC_LUT_ARRAY_MUTABLE_H__
