...
#ifndef __REGISTER_INCLUDES_MPR_NEXT_TABLE_LUT_ARRAY2_MUTABLE_H__
#define __REGISTER_INCLUDES_MPR_NEXT_TABLE_LUT_ARRAY2_MUTABLE_H__
...
class MprNextTableLutArray2Mutable : public model_core::RegisterBlock<RegisterArrayCallback2> {
public:
  MprNextTableLutArray2Mutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap), 4 * ArraySize(index_pipe_addrmap, index_mau_addrmap, -1), true, write_callback, read_callback, std::string("MprNextTableLutArray2Mutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap)),
...
public:
  uint16_t mpr_next_table_lut(uint32_t a1,uint32_t a0)
  {
    CheckArrayBounds(a1,real_size1_,size1_,0,1,false);
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    return array[(a1 * real_size0_) + a0].mpr_next_table_lut();
  }
  void mpr_next_table_lut(uint32_t a1,uint32_t a0,const uint16_t &v) 
  {
    CheckArrayBounds(a1,real_size1_,size1_,0,1,false);
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    array[(a1 * real_size0_) + a0].mpr_next_table_lut(v);
  }
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("MprNextTableLutArray2Mutable") + "["+boost::lexical_cast<std::string>(a1)+"]"+"["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
private:
  std::vector<MprNextTableLutMutable> array;
  uint32_t size0_;
...
#endif // __REGISTER_INCLUDES_MPR_NEXT_TABLE_LUT_ARRAY2_MUTABLE_H__
