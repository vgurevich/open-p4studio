...
#ifndef __REGISTER_INCLUDES_MPR_STAGE_ID_ARRAY_H__
#define __REGISTER_INCLUDES_MPR_STAGE_ID_ARRAY_H__
...
class MprStageIdArray : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  MprStageIdArray(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap), 4 * ArraySize(index_pipe_addrmap, index_mau_addrmap, -1), false, write_callback, read_callback, std::string("MprStageIdArray")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap)),
...
public:
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("MprStageIdArray") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
#endif // __REGISTER_INCLUDES_MPR_STAGE_ID_ARRAY_H__
