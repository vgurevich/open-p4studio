...
#ifndef __REGISTER_INCLUDES_P2S_REG_INTR_EN0_H__
#define __REGISTER_INCLUDES_P2S_REG_INTR_EN0_H__
...
class P2sRegIntrEn0 : public model_core::RegisterBlock<RegisterCallback> {
public:
  P2sRegIntrEn0(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 4, false, write_callback, read_callback, std::string("P2sRegIntrEn0")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  P2sRegIntrEn0(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "P2sRegIntrEn0")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("P2sRegIntrEn0") + ":\n";
...
#endif // __REGISTER_INCLUDES_P2S_REG_INTR_EN0_H__
