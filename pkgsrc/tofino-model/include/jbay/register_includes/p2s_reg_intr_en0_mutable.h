...
#ifndef __REGISTER_INCLUDES_P2S_REG_INTR_EN0_MUTABLE_H__
#define __REGISTER_INCLUDES_P2S_REG_INTR_EN0_MUTABLE_H__
...
class P2sRegIntrEn0Mutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  P2sRegIntrEn0Mutable(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 4, true, write_callback, read_callback, std::string("P2sRegIntrEn0Mutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  P2sRegIntrEn0Mutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "P2sRegIntrEn0Mutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("P2sRegIntrEn0Mutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0xb04; // to get to intr_en0
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_P2S_REG_INTR_EN0_MUTABLE_H__
