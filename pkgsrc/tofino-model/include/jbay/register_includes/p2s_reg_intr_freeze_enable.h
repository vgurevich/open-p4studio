...
#ifndef __REGISTER_INCLUDES_P2S_REG_INTR_FREEZE_ENABLE_H__
#define __REGISTER_INCLUDES_P2S_REG_INTR_FREEZE_ENABLE_H__
...
class P2sRegIntrFreezeEnable : public model_core::RegisterBlock<RegisterCallback> {
public:
  P2sRegIntrFreezeEnable(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 4, false, write_callback, read_callback, std::string("P2sRegIntrFreezeEnable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  P2sRegIntrFreezeEnable(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "P2sRegIntrFreezeEnable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("P2sRegIntrFreezeEnable") + ":\n";
...
#endif // __REGISTER_INCLUDES_P2S_REG_INTR_FREEZE_ENABLE_H__
