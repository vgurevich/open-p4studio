...
#ifndef __REGISTER_INCLUDES_P2S_REG_TM_CRED_ARRAY_MUTABLE_H__
#define __REGISTER_INCLUDES_P2S_REG_TM_CRED_ARRAY_MUTABLE_H__
...
class P2sRegTmCredArrayMutable : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  P2sRegTmCredArrayMutable(
      int chipNumber, int index_pipe_addrmap, RegisterArrayCallback& write_callback = 0, RegisterArrayCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 4 * ArraySize(index_pipe_addrmap, -1), true, write_callback, read_callback, std::string("P2sRegTmCredArrayMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap)),
...
public:
  ...
  uint8_t cred(uint32_t a0,int j0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    return array[a0].cred(j0);
  }
  void cred(uint32_t a0,int j0,const uint8_t &v) 
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    array[a0].cred(j0,v);
  }
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("P2sRegTmCredArrayMutable") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
private:
  std::vector<P2sRegTmCredMutable> array;
  uint32_t size0_;
...
#endif // __REGISTER_INCLUDES_P2S_REG_TM_CRED_ARRAY_MUTABLE_H__
