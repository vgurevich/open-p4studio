...
#ifndef __REGISTER_INCLUDES_PARB_RIGHT_REG_INTR_EN0_MUTABLE_H__
#define __REGISTER_INCLUDES_PARB_RIGHT_REG_INTR_EN0_MUTABLE_H__
...
class ParbRightRegIntrEn0Mutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  ParbRightRegIntrEn0Mutable(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 4, true, write_callback, read_callback, std::string("ParbRightRegIntrEn0Mutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  ParbRightRegIntrEn0Mutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "ParbRightRegIntrEn0Mutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("ParbRightRegIntrEn0Mutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_PARB_RIGHT_REG_INTR_EN0_MUTABLE_H__
