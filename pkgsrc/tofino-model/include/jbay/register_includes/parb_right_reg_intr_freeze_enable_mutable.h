...
#ifndef __REGISTER_INCLUDES_PARB_RIGHT_REG_INTR_FREEZE_ENABLE_MUTABLE_H__
#define __REGISTER_INCLUDES_PARB_RIGHT_REG_INTR_FREEZE_ENABLE_MUTABLE_H__
...
class ParbRightRegIntrFreezeEnableMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  ParbRightRegIntrFreezeEnableMutable(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 4, true, write_callback, read_callback, std::string("ParbRightRegIntrFreezeEnableMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  ParbRightRegIntrFreezeEnableMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "ParbRightRegIntrFreezeEnableMutable")
    {
    }
public:
  uint8_t e_avail_oflow() { return e_avail_oflow_; }
  void e_avail_oflow(const uint8_t &v) { e_avail_oflow_=v; }
  uint8_t e_bcnt_oflow() { return e_bcnt_oflow_; }
  void e_bcnt_oflow(const uint8_t &v) { e_bcnt_oflow_=v; }
  uint8_t tm_stat_oflow() { return tm_stat_oflow_; }
  void tm_stat_oflow(const uint8_t &v) { tm_stat_oflow_=v; }
  uint8_t e_afifo_oflow() { return e_afifo_oflow_; }
  void e_afifo_oflow(const uint8_t &v) { e_afifo_oflow_=v; }
  uint8_t e_arb_cred_uflow() { return e_arb_cred_uflow_; }
  void e_arb_cred_uflow(const uint8_t &v) { e_arb_cred_uflow_=v; }
  uint8_t e_arb_cred_oflow() { return e_arb_cred_oflow_; }
  void e_arb_cred_oflow(const uint8_t &v) { e_arb_cred_oflow_=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("ParbRightRegIntrFreezeEnableMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_PARB_RIGHT_REG_INTR_FREEZE_ENABLE_MUTABLE_H__
