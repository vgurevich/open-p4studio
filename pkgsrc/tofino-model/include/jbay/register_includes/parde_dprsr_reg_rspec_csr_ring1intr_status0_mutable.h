...
#ifndef __REGISTER_INCLUDES_PARDE_DPRSR_REG_RSPEC_CSR_RING1INTR_STATUS0_MUTABLE_H__
#define __REGISTER_INCLUDES_PARDE_DPRSR_REG_RSPEC_CSR_RING1INTR_STATUS0_MUTABLE_H__
...
class PardeDprsrRegRspecCsrRing1intrStatus0Mutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  PardeDprsrRegRspecCsrRing1intrStatus0Mutable(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 4, true, write_callback, read_callback, std::string("PardeDprsrRegRspecCsrRing1intrStatus0Mutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  PardeDprsrRegRspecCsrRing1intrStatus0Mutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "PardeDprsrRegRspecCsrRing1intrStatus0Mutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PardeDprsrRegRspecCsrRing1intrStatus0Mutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_PARDE_DPRSR_REG_RSPEC_CSR_RING1INTR_STATUS0_MUTABLE_H__
