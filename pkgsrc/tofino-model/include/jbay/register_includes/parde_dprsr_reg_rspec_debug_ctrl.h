...
#ifndef __REGISTER_INCLUDES_PARDE_DPRSR_REG_RSPEC_DEBUG_CTRL_H__
#define __REGISTER_INCLUDES_PARDE_DPRSR_REG_RSPEC_DEBUG_CTRL_H__
...
class PardeDprsrRegRspecDebugCtrl : public model_core::RegisterBlock<RegisterCallback> {
public:
  PardeDprsrRegRspecDebugCtrl(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 4, false, write_callback, read_callback, std::string("PardeDprsrRegRspecDebugCtrl")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  PardeDprsrRegRspecDebugCtrl(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "PardeDprsrRegRspecDebugCtrl")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PardeDprsrRegRspecDebugCtrl") + ":\n";
...
#endif // __REGISTER_INCLUDES_PARDE_DPRSR_REG_RSPEC_DEBUG_CTRL_H__
