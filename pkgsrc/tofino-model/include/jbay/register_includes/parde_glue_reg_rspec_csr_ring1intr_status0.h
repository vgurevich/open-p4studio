...
#ifndef __REGISTER_INCLUDES_PARDE_GLUE_REG_RSPEC_CSR_RING1INTR_STATUS0_H__
#define __REGISTER_INCLUDES_PARDE_GLUE_REG_RSPEC_CSR_RING1INTR_STATUS0_H__
...
class PardeGlueRegRspecCsrRing1intrStatus0 : public model_core::RegisterBlock<RegisterCallback> {
public:
  PardeGlueRegRspecCsrRing1intrStatus0(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 4, false, write_callback, read_callback, std::string("PardeGlueRegRspecCsrRing1intrStatus0")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  PardeGlueRegRspecCsrRing1intrStatus0(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "PardeGlueRegRspecCsrRing1intrStatus0")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PardeGlueRegRspecCsrRing1intrStatus0") + ":\n";
...
#endif // __REGISTER_INCLUDES_PARDE_GLUE_REG_RSPEC_CSR_RING1INTR_STATUS0_H__
