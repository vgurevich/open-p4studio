...
#ifndef __REGISTER_INCLUDES_PARDE_GLUE_REG_RSPEC_CSR_RING1INTR_STATUS1_MUTABLE_H__
#define __REGISTER_INCLUDES_PARDE_GLUE_REG_RSPEC_CSR_RING1INTR_STATUS1_MUTABLE_H__
...
class PardeGlueRegRspecCsrRing1intrStatus1Mutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  PardeGlueRegRspecCsrRing1intrStatus1Mutable(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 4, true, write_callback, read_callback, std::string("PardeGlueRegRspecCsrRing1intrStatus1Mutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  PardeGlueRegRspecCsrRing1intrStatus1Mutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "PardeGlueRegRspecCsrRing1intrStatus1Mutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PardeGlueRegRspecCsrRing1intrStatus1Mutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_PARDE_GLUE_REG_RSPEC_CSR_RING1INTR_STATUS1_MUTABLE_H__
