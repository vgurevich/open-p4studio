...
#ifndef __REGISTER_INCLUDES_PARDE_GLUE_REG_RSPEC_DEBUG_CTRL_H__
#define __REGISTER_INCLUDES_PARDE_GLUE_REG_RSPEC_DEBUG_CTRL_H__
...
class PardeGlueRegRspecDebugCtrl : public model_core::RegisterBlock<RegisterCallback> {
public:
  PardeGlueRegRspecDebugCtrl(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 4, false, write_callback, read_callback, std::string("PardeGlueRegRspecDebugCtrl")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  PardeGlueRegRspecDebugCtrl(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "PardeGlueRegRspecDebugCtrl")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PardeGlueRegRspecDebugCtrl") + ":\n";
...
#endif // __REGISTER_INCLUDES_PARDE_GLUE_REG_RSPEC_DEBUG_CTRL_H__
