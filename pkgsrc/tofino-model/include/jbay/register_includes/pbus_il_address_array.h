...
#ifndef __REGISTER_INCLUDES_PBUS_IL_ADDRESS_ARRAY_H__
#define __REGISTER_INCLUDES_PBUS_IL_ADDRESS_ARRAY_H__
...
class PbusIlAddressArray : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  PbusIlAddressArray(
      int chipNumber, RegisterArrayCallback& write_callback = 0, RegisterArrayCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 4 * ArraySize(-1), false, write_callback, read_callback, std::string("PbusIlAddressArray")),
...
public:
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("PbusIlAddressArray") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
private:
  std::vector<PbusIlAddress> array;
  uint32_t size0_;
...
#endif // __REGISTER_INCLUDES_PBUS_IL_ADDRESS_ARRAY_H__
