...
public:
  PbusIlCreqCredit(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pbus_il_creq_credit), 96, false, write_callback, read_callback, std::string("PbusIlCreqCredit")+":"+boost::lexical_cast<std::string>(index_pbus_il_creq_credit))
    {
    }
  PbusIlCreqCredit(
