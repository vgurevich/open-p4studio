...
#ifndef __REGISTER_INCLUDES_PBUS_IL_CREQ_CREDIT_MUTABLE_H__
#define __REGISTER_INCLUDES_PBUS_IL_CREQ_CREDIT_MUTABLE_H__
...
class PbusIlCreqCreditMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  PbusIlCreqCreditMutable(
      int chipNumber, int index_pbus_il_creq_credit, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pbus_il_creq_credit), 96, true, write_callback, read_callback, std::string("PbusIlCreqCreditMutable")+":"+boost::lexical_cast<std::string>(index_pbus_il_creq_credit))
    {
    }
  PbusIlCreqCreditMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "PbusIlCreqCreditMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PbusIlCreqCreditMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    assert(index_pbus_il_creq_credit < 2);
    offset += index_pbus_il_creq_credit * 0x60; // pbus_il_creq_credit[]
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_PBUS_IL_CREQ_CREDIT_MUTABLE_H__
