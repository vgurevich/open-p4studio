...
#ifndef __REGISTER_INCLUDES_PBUS_STATION_REGS_RSPEC_INTR_EN0_H__
#define __REGISTER_INCLUDES_PBUS_STATION_REGS_RSPEC_INTR_EN0_H__
...
class PbusStationRegsRspecIntrEn0 : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum PardeRegEnum {
    kDprsrreg,
    kPgstnreg
...
public:
  PbusStationRegsRspecIntrEn0(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, selector_parde_reg), 4, false, write_callback, read_callback, std::string("PbusStationRegsRspecIntrEn0")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(selector_parde_reg))
    {
    }
  PbusStationRegsRspecIntrEn0(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "PbusStationRegsRspecIntrEn0")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PbusStationRegsRspecIntrEn0") + ":\n";
...
#endif // __REGISTER_INCLUDES_PBUS_STATION_REGS_RSPEC_INTR_EN0_H__
