...
#ifndef __REGISTER_INCLUDES_PBUS_STATION_REGS_RSPEC_INTR_EN0_MUTABLE_H__
#define __REGISTER_INCLUDES_PBUS_STATION_REGS_RSPEC_INTR_EN0_MUTABLE_H__
...
class PbusStationRegsRspecIntrEn0Mutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum PardeRegEnum {
    kDprsrreg,
    kPgstnreg
...
public:
  PbusStationRegsRspecIntrEn0Mutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, selector_parde_reg), 4, true, write_callback, read_callback, std::string("PbusStationRegsRspecIntrEn0Mutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(selector_parde_reg))
    {
    }
  PbusStationRegsRspecIntrEn0Mutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "PbusStationRegsRspecIntrEn0Mutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PbusStationRegsRspecIntrEn0Mutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_PBUS_STATION_REGS_RSPEC_INTR_EN0_MUTABLE_H__
