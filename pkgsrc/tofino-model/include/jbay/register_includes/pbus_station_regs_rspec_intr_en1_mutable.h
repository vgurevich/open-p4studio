...
#ifndef __REGISTER_INCLUDES_PBUS_STATION_REGS_RSPEC_INTR_EN1_MUTABLE_H__
#define __REGISTER_INCLUDES_PBUS_STATION_REGS_RSPEC_INTR_EN1_MUTABLE_H__
...
class PbusStationRegsRspecIntrEn1Mutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum PardeRegEnum {
    kDprsrreg,
    kPgstnreg
...
public:
  PbusStationRegsRspecIntrEn1Mutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, selector_parde_reg), 4, true, write_callback, read_callback, std::string("PbusStationRegsRspecIntrEn1Mutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(selector_parde_reg))
    {
    }
  PbusStationRegsRspecIntrEn1Mutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "PbusStationRegsRspecIntrEn1Mutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PbusStationRegsRspecIntrEn1Mutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_PBUS_STATION_REGS_RSPEC_INTR_EN1_MUTABLE_H__
