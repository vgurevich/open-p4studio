...
#ifndef __REGISTER_INCLUDES_PBUS_STATION_REGS_RSPEC_INTR_INJ_MUTABLE_H__
#define __REGISTER_INCLUDES_PBUS_STATION_REGS_RSPEC_INTR_INJ_MUTABLE_H__
...
class PbusStationRegsRspecIntrInjMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum PardeRegEnum {
    kDprsrreg,
    kPgstnreg
...
public:
  PbusStationRegsRspecIntrInjMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, selector_parde_reg), 4, true, write_callback, read_callback, std::string("PbusStationRegsRspecIntrInjMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(selector_parde_reg))
    {
    }
  PbusStationRegsRspecIntrInjMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "PbusStationRegsRspecIntrInjMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PbusStationRegsRspecIntrInjMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_PBUS_STATION_REGS_RSPEC_INTR_INJ_MUTABLE_H__
