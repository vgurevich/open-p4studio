...
#ifndef __REGISTER_INCLUDES_PBUS_STATION_REGS_RSPEC_INTR_STAT_H__
#define __REGISTER_INCLUDES_PBUS_STATION_REGS_RSPEC_INTR_STAT_H__
...
class PbusStationRegsRspecIntrStat : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum PardeRegEnum {
    kDprsrreg,
    kPgstnreg
...
public:
  PbusStationRegsRspecIntrStat(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, selector_parde_reg), 4, false, write_callback, read_callback, std::string("PbusStationRegsRspecIntrStat")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(selector_parde_reg))
    {
    }
  PbusStationRegsRspecIntrStat(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "PbusStationRegsRspecIntrStat")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PbusStationRegsRspecIntrStat") + ":\n";
...
#endif // __REGISTER_INCLUDES_PBUS_STATION_REGS_RSPEC_INTR_STAT_H__
