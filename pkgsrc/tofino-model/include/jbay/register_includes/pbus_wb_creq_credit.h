...
#ifndef __REGISTER_INCLUDES_PBUS_WB_CREQ_CREDIT_H__
#define __REGISTER_INCLUDES_PBUS_WB_CREQ_CREDIT_H__
...
class PbusWbCreqCredit : public model_core::RegisterBlock<RegisterCallback> {
public:
  PbusWbCreqCredit(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 96, false, write_callback, read_callback, std::string("PbusWbCreqCredit"))
    {
    }
  PbusWbCreqCredit(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "PbusWbCreqCredit")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PbusWbCreqCredit") + ":\n";
...
#endif // __REGISTER_INCLUDES_PBUS_WB_CREQ_CREDIT_H__
