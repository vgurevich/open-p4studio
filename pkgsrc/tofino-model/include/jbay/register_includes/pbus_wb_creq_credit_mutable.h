...
#ifndef __REGISTER_INCLUDES_PBUS_WB_CREQ_CREDIT_MUTABLE_H__
#define __REGISTER_INCLUDES_PBUS_WB_CREQ_CREDIT_MUTABLE_H__
...
class PbusWbCreqCreditMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  PbusWbCreqCreditMutable(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 96, true, write_callback, read_callback, std::string("PbusWbCreqCreditMutable"))
    {
    }
  PbusWbCreqCreditMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "PbusWbCreqCreditMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PbusWbCreqCreditMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x400; // to get to wb_creq_credit
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_PBUS_WB_CREQ_CREDIT_MUTABLE_H__
