...
#ifndef __REGISTER_INCLUDES_PCIE_BAR01_REGS_SRAM_ECC_H__
#define __REGISTER_INCLUDES_PCIE_BAR01_REGS_SRAM_ECC_H__
...
class PcieBar01RegsSramEcc : public model_core::RegisterBlock<RegisterCallback> {
public:
  PcieBar01RegsSramEcc(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 4, false, write_callback, read_callback, std::string("PcieBar01RegsSramEcc"))
    {
    }
  PcieBar01RegsSramEcc(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "PcieBar01RegsSramEcc")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PcieBar01RegsSramEcc") + ":\n";
...
#endif // __REGISTER_INCLUDES_PCIE_BAR01_REGS_SRAM_ECC_H__
