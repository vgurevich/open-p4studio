...
#ifndef __REGISTER_INCLUDES_PCIE_BW_CHANGE_MUTABLE_H__
#define __REGISTER_INCLUDES_PCIE_BW_CHANGE_MUTABLE_H__
...
class PcieBwChangeMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  PcieBwChangeMutable(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 4, true, write_callback, read_callback, std::string("PcieBwChangeMutable"))
    {
    }
  PcieBwChangeMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "PcieBwChangeMutable")
    {
    }
public:
  ...
  void lkwdx2allowed(const uint8_t &v) { lkwdx2allowed_=v; }
  ...
  void lkwdx4allowed(const uint8_t &v) { lkwdx4allowed_=v; }
  ...
  void lkwdx8allowed(const uint8_t &v) { lkwdx8allowed_=v; }
  ...
  void lkwdx16allowed(const uint8_t &v) { lkwdx16allowed_=v; }
  ...
  void lkwdchgreq(const uint8_t &v) { lkwdchgreq_=v; }
  ...
  void maxlkspeed(const uint8_t &v) { maxlkspeed_=v; }
  ...
  void lkspchgreq(const uint8_t &v) { lkspchgreq_=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PcieBwChangeMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_PCIE_BW_CHANGE_MUTABLE_H__
