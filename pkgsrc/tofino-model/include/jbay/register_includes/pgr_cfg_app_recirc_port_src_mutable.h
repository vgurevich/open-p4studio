...
#ifndef __REGISTER_INCLUDES_PGR_CFG_APP_RECIRC_PORT_SRC_MUTABLE_H__
#define __REGISTER_INCLUDES_PGR_CFG_APP_RECIRC_PORT_SRC_MUTABLE_H__
...
class PgrCfgAppRecircPortSrcMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  PgrCfgAppRecircPortSrcMutable(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 4, true, write_callback, read_callback, std::string("PgrCfgAppRecircPortSrcMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  PgrCfgAppRecircPortSrcMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "PgrCfgAppRecircPortSrcMutable")
    {
    }
public:
  ...
  void app_recirc_src(int j0,const uint8_t &v) { app_recirc_src_[j0]=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PgrCfgAppRecircPortSrcMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_PGR_CFG_APP_RECIRC_PORT_SRC_MUTABLE_H__
