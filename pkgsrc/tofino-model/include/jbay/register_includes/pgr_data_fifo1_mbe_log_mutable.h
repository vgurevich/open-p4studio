...
#ifndef __REGISTER_INCLUDES_PGR_DATA_FIFO1_MBE_LOG_MUTABLE_H__
#define __REGISTER_INCLUDES_PGR_DATA_FIFO1_MBE_LOG_MUTABLE_H__
...
class PgrDataFifo1MbeLogMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  PgrDataFifo1MbeLogMutable(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 8, true, write_callback, read_callback, std::string("PgrDataFifo1MbeLogMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  PgrDataFifo1MbeLogMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "PgrDataFifo1MbeLogMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PgrDataFifo1MbeLogMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_PGR_DATA_FIFO1_MBE_LOG_MUTABLE_H__
