...
#ifndef __REGISTER_INCLUDES_PGR_DATA_FIFO1_SBE_LOG_H__
#define __REGISTER_INCLUDES_PGR_DATA_FIFO1_SBE_LOG_H__
...
class PgrDataFifo1SbeLog : public model_core::RegisterBlock<RegisterCallback> {
public:
  PgrDataFifo1SbeLog(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 8, false, write_callback, read_callback, std::string("PgrDataFifo1SbeLog")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  PgrDataFifo1SbeLog(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "PgrDataFifo1SbeLog")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PgrDataFifo1SbeLog") + ":\n";
...
#endif // __REGISTER_INCLUDES_PGR_DATA_FIFO1_SBE_LOG_H__
