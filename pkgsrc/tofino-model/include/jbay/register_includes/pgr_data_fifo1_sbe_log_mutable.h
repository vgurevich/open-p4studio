...
#ifndef __REGISTER_INCLUDES_PGR_DATA_FIFO1_SBE_LOG_MUTABLE_H__
#define __REGISTER_INCLUDES_PGR_DATA_FIFO1_SBE_LOG_MUTABLE_H__
...
class PgrDataFifo1SbeLogMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  PgrDataFifo1SbeLogMutable(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 8, true, write_callback, read_callback, std::string("PgrDataFifo1SbeLogMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  PgrDataFifo1SbeLogMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "PgrDataFifo1SbeLogMutable")
    {
    }
public:
  ...
  void eth_cpu_fifo1_mem0_addr(const uint8_t &v) { eth_cpu_fifo1_mem0_addr_=v; }
  ...
  void eth_cpu_fifo1_mem1_addr(const uint8_t &v) { eth_cpu_fifo1_mem1_addr_=v; }
  ...
  void tbc_fifo1_mem0_addr(const uint8_t &v) { tbc_fifo1_mem0_addr_=v; }
  ...
  void tbc_fifo1_mem1_addr(const uint8_t &v) { tbc_fifo1_mem1_addr_=v; }
  ...
  void ebuf_p0_fifo1_mem0_addr(const uint8_t &v) { ebuf_p0_fifo1_mem0_addr_=v; }
  ...
  void ebuf_p0_fifo1_mem1_addr(const uint8_t &v) { ebuf_p0_fifo1_mem1_addr_=v; }
  ...
  void ebuf_p1_fifo1_mem0_addr(const uint8_t &v) { ebuf_p1_fifo1_mem0_addr_=v; }
  ...
  void ebuf_p1_fifo1_mem1_addr(const uint8_t &v) { ebuf_p1_fifo1_mem1_addr_=v; }
  ...
  void ebuf_p2_fifo1_mem0_addr(const uint8_t &v) { ebuf_p2_fifo1_mem0_addr_=v; }
  ...
  void ebuf_p2_fifo1_mem1_addr(const uint8_t &v) { ebuf_p2_fifo1_mem1_addr_=v; }
  ...
  void ebuf_p3_fifo1_mem0_addr(const uint8_t &v) { ebuf_p3_fifo1_mem0_addr_=v; }
  ...
  void ebuf_p3_fifo1_mem1_addr(const uint8_t &v) { ebuf_p3_fifo1_mem1_addr_=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PgrDataFifo1SbeLogMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x250; // to get to pgr_data_fifo1_sbe_log
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_PGR_DATA_FIFO1_SBE_LOG_MUTABLE_H__
