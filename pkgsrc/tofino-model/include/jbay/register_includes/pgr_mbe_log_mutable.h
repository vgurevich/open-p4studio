...
#ifndef __REGISTER_INCLUDES_PGR_MBE_LOG_MUTABLE_H__
#define __REGISTER_INCLUDES_PGR_MBE_LOG_MUTABLE_H__
...
class PgrMbeLogMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  PgrMbeLogMutable(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 8, true, write_callback, read_callback, std::string("PgrMbeLogMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  PgrMbeLogMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "PgrMbeLogMutable")
    {
    }
public:
  ...
  void buffer0_addr(const uint8_t &v) { buffer0_addr_=v; }
  ...
  void buffer1_addr(const uint8_t &v) { buffer1_addr_=v; }
  ...
  void buffer2_addr(const uint8_t &v) { buffer2_addr_=v; }
  ...
  void buffer3_addr(const uint8_t &v) { buffer3_addr_=v; }
  ...
  void phase0_addr(const uint8_t &v) { phase0_addr_=v; }
  ...
  void pfc0_addr(const uint16_t &v) { pfc0_addr_=v; }
  ...
  void pfc1_addr(const uint16_t &v) { pfc1_addr_=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PgrMbeLogMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_PGR_MBE_LOG_MUTABLE_H__
