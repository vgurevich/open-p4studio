...
#ifndef __REGISTER_INCLUDES_PGR_RECIR_LOG_H__
#define __REGISTER_INCLUDES_PGR_RECIR_LOG_H__
...
class PgrRecirLog : public model_core::RegisterBlock<RegisterCallback> {
public:
  PgrRecirLog(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 16, false, write_callback, read_callback, std::string("PgrRecirLog")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  PgrRecirLog(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "PgrRecirLog")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PgrRecirLog") + ":\n";
...
#endif // __REGISTER_INCLUDES_PGR_RECIR_LOG_H__
