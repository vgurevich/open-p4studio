...
#ifndef __REGISTER_INCLUDES_PGR_SBE_LOG_MUTABLE_H__
#define __REGISTER_INCLUDES_PGR_SBE_LOG_MUTABLE_H__
...
class PgrSbeLogMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  PgrSbeLogMutable(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 8, true, write_callback, read_callback, std::string("PgrSbeLogMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  PgrSbeLogMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "PgrSbeLogMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PgrSbeLogMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_PGR_SBE_LOG_MUTABLE_H__
