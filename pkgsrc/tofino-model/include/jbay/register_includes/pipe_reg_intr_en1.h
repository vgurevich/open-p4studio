...
#ifndef __REGISTER_INCLUDES_PIPE_REG_INTR_EN1_H__
#define __REGISTER_INCLUDES_PIPE_REG_INTR_EN1_H__
...
class PipeRegIntrEn1 : public model_core::RegisterBlock<RegisterCallback> {
public:
  PipeRegIntrEn1(
      int chipNumber, int index_tm_wac_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_wac_pipe_rspec), 4, false, write_callback, read_callback, std::string("PipeRegIntrEn1")+":"+boost::lexical_cast<std::string>(index_tm_wac_pipe_rspec))
    {
    }
  PipeRegIntrEn1(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "PipeRegIntrEn1")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PipeRegIntrEn1") + ":\n";
...
#endif // __REGISTER_INCLUDES_PIPE_REG_INTR_EN1_H__
