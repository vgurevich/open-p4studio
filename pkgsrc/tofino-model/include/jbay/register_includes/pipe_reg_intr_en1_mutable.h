...
#ifndef __REGISTER_INCLUDES_PIPE_REG_INTR_EN1_MUTABLE_H__
#define __REGISTER_INCLUDES_PIPE_REG_INTR_EN1_MUTABLE_H__
...
class PipeRegIntrEn1Mutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  PipeRegIntrEn1Mutable(
      int chipNumber, int index_tm_wac_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_wac_pipe_rspec), 4, true, write_callback, read_callback, std::string("PipeRegIntrEn1Mutable")+":"+boost::lexical_cast<std::string>(index_tm_wac_pipe_rspec))
    {
    }
  PipeRegIntrEn1Mutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "PipeRegIntrEn1Mutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PipeRegIntrEn1Mutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x748; // to get to wac_reg_intr_en1
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_PIPE_REG_INTR_EN1_MUTABLE_H__
