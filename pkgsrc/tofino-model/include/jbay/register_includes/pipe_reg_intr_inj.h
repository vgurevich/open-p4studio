...
#ifndef __REGISTER_INCLUDES_PIPE_REG_INTR_INJ_H__
#define __REGISTER_INCLUDES_PIPE_REG_INTR_INJ_H__
...
class PipeRegIntrInj : public model_core::RegisterBlock<RegisterCallback> {
public:
  PipeRegIntrInj(
      int chipNumber, int index_tm_wac_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_wac_pipe_rspec), 4, false, write_callback, read_callback, std::string("PipeRegIntrInj")+":"+boost::lexical_cast<std::string>(index_tm_wac_pipe_rspec))
    {
    }
  PipeRegIntrInj(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "PipeRegIntrInj")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PipeRegIntrInj") + ":\n";
...
#endif // __REGISTER_INCLUDES_PIPE_REG_INTR_INJ_H__
