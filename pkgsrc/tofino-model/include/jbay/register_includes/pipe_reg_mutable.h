...
#ifndef __REGISTER_INCLUDES_PIPE_REG_MUTABLE_H__
#define __REGISTER_INCLUDES_PIPE_REG_MUTABLE_H__
...
#include "cnt32_inc_mutable.h"
#include "cnt32_mutable.h"
#include "cnt48_inc_mutable.h"
#include "pipe_reg_debug_bus_ctrl_mutable.h"
#include "pipe_reg_drop_cnt_table_mbe_err_log_mutable.h"
#include "pipe_reg_drop_cnt_table_sbe_err_log_mutable.h"
#include "pipe_reg_intr_mutable.h"
#include "pipe_reg_ppg_mapping_table_mbe_err_log_mutable.h"
#include "pipe_reg_ppg_mapping_table_sbe_err_log_mutable.h"
#include "pipe_reg_qid_map_mbe_err_log_mutable.h"
#include "pipe_reg_qid_map_sbe_err_log_mutable.h"
#include "pipe_reg_wac_ecc_mutable.h"
#include "wac_bypass_mutable.h"
#include "wac_debug_register_mutable.h"
#include "wac_offset_mutable.h"
#include "wac_pipe_ctrl_mutable.h"
#include "wac_pipe_mac_spd_mutable.h"
#include "wac_port_config_mutable.h"
#include "wac_port_ct_dis_mutable.h"
#include "wac_pre_fifo_mapping_mutable.h"
#include "wac_rm_pfc_state_mutable.h"

namespace jbay {
  namespace register_classes {

class PipeRegMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  PipeRegMutable(
      int chipNumber, int index_tm_wac_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_wac_pipe_rspec), 1956, true, write_callback, read_callback, std::string("PipeRegMutable")+":"+boost::lexical_cast<std::string>(index_tm_wac_pipe_rspec))
    {
    }
  PipeRegMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "PipeRegMutable")
    {
    }
public:
  ...
  WacPipeCtrlMutable &wac_reg_wac_pipe_ctrl() { return wac_reg_wac_pipe_ctrl_; }
  ...
  WacPipeMacSpdMutable &wac_reg_wac_pipe_mac_spd(int j0) { return wac_reg_wac_pipe_mac_spd_[j0]; }





  WacBypassMutable &wac_reg_wac_bypass_config() { return wac_reg_wac_bypass_config_; }





  Cnt32IncMutable &wac_reg_ctr_drop_in_err() { return wac_reg_ctr_drop_in_err_; }





  Cnt32IncMutable &wac_reg_ctr_drop_fuse_pipe() { return wac_reg_ctr_drop_fuse_pipe_; }





  Cnt32IncMutable &wac_reg_ctr_drop_no_dst() { return wac_reg_ctr_drop_no_dst_; }
  ...
  Cnt32IncMutable &wac_reg_ap_red_drop(int j0) { return wac_reg_ap_red_drop_[j0]; }
  ...
  Cnt32IncMutable &wac_reg_ap_yel_drop(int j0) { return wac_reg_ap_yel_drop_[j0]; }
  ...
  Cnt32IncMutable &wac_reg_ap_green_drop(int j0) { return wac_reg_ap_green_drop_[j0]; }





  Cnt32Mutable &wac_reg_ctr_drop_sop_by_sop() { return wac_reg_ctr_drop_sop_by_sop_; }





  Cnt32Mutable &wac_reg_ctr_caa_full() { return wac_reg_ctr_caa_full_; }





  Cnt48IncMutable &wac_reg_ctr_ctrl_pkt() { return wac_reg_ctr_ctrl_pkt_; }





  Cnt48IncMutable &wac_reg_ctr_vld_sop() { return wac_reg_ctr_vld_sop_; }





  Cnt48IncMutable &wac_reg_wac_drop_buf_full() { return wac_reg_wac_drop_buf_full_; }





  Cnt48IncMutable &wac_reg_wac_drop_psc_full() { return wac_reg_wac_drop_psc_full_; }





  Cnt48IncMutable &wac_reg_wac_inerror_drop() { return wac_reg_wac_inerror_drop_; }





  Cnt48IncMutable &wac_reg_wac_inerror_skip_drop() { return wac_reg_wac_inerror_skip_drop_; }
  ...
  Cnt32IncMutable &wac_reg_wac_iport_sop_cnt(int j0) { return wac_reg_wac_iport_sop_cnt_[j0]; }





  WacDebugRegisterMutable &wac_reg_wac_debug_register() { return wac_reg_wac_debug_register_; }
  ...
  WacOffsetMutable &wac_reg_offset_profile(int j0) { return wac_reg_offset_profile_[j0]; }
  ...
  WacPortConfigMutable &wac_reg_port_config(int j0) { return wac_reg_port_config_[j0]; }
  ...
  WacRmPfcStateMutable &wac_reg_wac_rm_pfc_state(int j0) { return wac_reg_wac_rm_pfc_state_[j0]; }





  WacPortCtDisMutable &wac_reg_wac_port_ct_dis() { return wac_reg_wac_port_ct_dis_; }
  ...
  PipeRegWacEccMutable &wac_reg_wac_ecc() { return wac_reg_wac_ecc_; }





  PipeRegPpgMappingTableSbeErrLogMutable &wac_reg_ppg_mapping_table_sbe_err_log() { return wac_reg_ppg_mapping_table_sbe_err_log_; }





  PipeRegPpgMappingTableMbeErrLogMutable &wac_reg_ppg_mapping_table_mbe_err_log() { return wac_reg_ppg_mapping_table_mbe_err_log_; }





  PipeRegDropCntTableSbeErrLogMutable &wac_reg_drop_cnt_table_sbe_err_log() { return wac_reg_drop_cnt_table_sbe_err_log_; }





  PipeRegDropCntTableMbeErrLogMutable &wac_reg_drop_cnt_table_mbe_err_log() { return wac_reg_drop_cnt_table_mbe_err_log_; }





  PipeRegQidMapSbeErrLogMutable &wac_reg_qid_map_sbe_err_log() { return wac_reg_qid_map_sbe_err_log_; }





  PipeRegQidMapMbeErrLogMutable &wac_reg_qid_map_mbe_err_log() { return wac_reg_qid_map_mbe_err_log_; }
  ...
  WacPreFifoMappingMutable &wac_reg_wac_pre_fifo_mapping(int j0) { return wac_reg_wac_pre_fifo_mapping_[j0]; }





  PipeRegDebugBusCtrlMutable &wac_reg_debug_bus_ctrl() { return wac_reg_debug_bus_ctrl_; }
  PipeRegIntrMutable &wac_reg_intr() { return wac_reg_intr_; }
...
private:
  WacPipeCtrlMutable wac_reg_wac_pipe_ctrl_;
  std::array< WacPipeMacSpdMutable, 9 > wac_reg_wac_pipe_mac_spd_;
  WacBypassMutable wac_reg_wac_bypass_config_;
  Cnt32IncMutable wac_reg_ctr_drop_in_err_;
  Cnt32IncMutable wac_reg_ctr_drop_fuse_pipe_;
  Cnt32IncMutable wac_reg_ctr_drop_no_dst_;
  std::array< Cnt32IncMutable, 4 > wac_reg_ap_red_drop_;
  std::array< Cnt32IncMutable, 4 > wac_reg_ap_yel_drop_;
  std::array< Cnt32IncMutable, 4 > wac_reg_ap_green_drop_;
  Cnt32Mutable wac_reg_ctr_drop_sop_by_sop_;
  Cnt32Mutable wac_reg_ctr_caa_full_;
  Cnt48IncMutable wac_reg_ctr_ctrl_pkt_;
  Cnt48IncMutable wac_reg_ctr_vld_sop_;
  Cnt48IncMutable wac_reg_wac_drop_buf_full_;
  Cnt48IncMutable wac_reg_wac_drop_psc_full_;
  Cnt48IncMutable wac_reg_wac_inerror_drop_;
  Cnt48IncMutable wac_reg_wac_inerror_skip_drop_;
  std::array< Cnt32IncMutable, 73 > wac_reg_wac_iport_sop_cnt_;
  WacDebugRegisterMutable wac_reg_wac_debug_register_;
  std::array< WacOffsetMutable, 32 > wac_reg_offset_profile_;
  std::array< WacPortConfigMutable, 73 > wac_reg_port_config_;
  std::array< WacRmPfcStateMutable, 72 > wac_reg_wac_rm_pfc_state_;
  WacPortCtDisMutable wac_reg_wac_port_ct_dis_;
  PipeRegWacEccMutable wac_reg_wac_ecc_;
  PipeRegPpgMappingTableSbeErrLogMutable wac_reg_ppg_mapping_table_sbe_err_log_;
  PipeRegPpgMappingTableMbeErrLogMutable wac_reg_ppg_mapping_table_mbe_err_log_;
  PipeRegDropCntTableSbeErrLogMutable wac_reg_drop_cnt_table_sbe_err_log_;
  PipeRegDropCntTableMbeErrLogMutable wac_reg_drop_cnt_table_mbe_err_log_;
  PipeRegQidMapSbeErrLogMutable wac_reg_qid_map_sbe_err_log_;
  PipeRegQidMapMbeErrLogMutable wac_reg_qid_map_mbe_err_log_;
  std::array< WacPreFifoMappingMutable, 8 > wac_reg_wac_pre_fifo_mapping_;
  PipeRegDebugBusCtrlMutable wac_reg_debug_bus_ctrl_;
  PipeRegIntrMutable wac_reg_intr_;
private:
...
#endif // __REGISTER_INCLUDES_PIPE_REG_MUTABLE_H__
