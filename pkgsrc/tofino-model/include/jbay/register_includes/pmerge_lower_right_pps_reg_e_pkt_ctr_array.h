...
#ifndef __REGISTER_INCLUDES_PMERGE_LOWER_RIGHT_PPS_REG_E_PKT_CTR_ARRAY_H__
#define __REGISTER_INCLUDES_PMERGE_LOWER_RIGHT_PPS_REG_E_PKT_CTR_ARRAY_H__
...
class PmergeLowerRightPpsRegEPktCtrArray : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  PmergeLowerRightPpsRegEPktCtrArray(
      int chipNumber, int index_pipe_addrmap, RegisterArrayCallback& write_callback = 0, RegisterArrayCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 8 * ArraySize(index_pipe_addrmap, -1), false, write_callback, read_callback, std::string("PmergeLowerRightPpsRegEPktCtrArray")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap)),
...
public:
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("PmergeLowerRightPpsRegEPktCtrArray") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
private:
  std::vector<PmergeLowerRightPpsRegEPktCtr> array;
  uint32_t size0_;
...
#endif // __REGISTER_INCLUDES_PMERGE_LOWER_RIGHT_PPS_REG_E_PKT_CTR_ARRAY_H__
