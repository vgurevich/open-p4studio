...
#ifndef __REGISTER_INCLUDES_PMERGE_UPPER_LEFT_REG_PHV_CLR_ON_WR_127_0_H__
#define __REGISTER_INCLUDES_PMERGE_UPPER_LEFT_REG_PHV_CLR_ON_WR_127_0_H__
...
class PmergeUpperLeftRegPhvClrOnWr_127_0 : public model_core::RegisterBlock<RegisterCallback> {
public:
  PmergeUpperLeftRegPhvClrOnWr_127_0(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 16, false, write_callback, read_callback, std::string("PmergeUpperLeftRegPhvClrOnWr_127_0")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  PmergeUpperLeftRegPhvClrOnWr_127_0(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "PmergeUpperLeftRegPhvClrOnWr_127_0")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PmergeUpperLeftRegPhvClrOnWr_127_0") + ":\n";
...
#endif // __REGISTER_INCLUDES_PMERGE_UPPER_LEFT_REG_PHV_CLR_ON_WR_127_0_H__
