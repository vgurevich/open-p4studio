...
#ifndef __REGISTER_INCLUDES_PMERGE_UPPER_LEFT_REG_PHV_CLR_ON_WR_127_0_MUTABLE_H__
#define __REGISTER_INCLUDES_PMERGE_UPPER_LEFT_REG_PHV_CLR_ON_WR_127_0_MUTABLE_H__
...
class PmergeUpperLeftRegPhvClrOnWr_127_0Mutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  PmergeUpperLeftRegPhvClrOnWr_127_0Mutable(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 16, true, write_callback, read_callback, std::string("PmergeUpperLeftRegPhvClrOnWr_127_0Mutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  PmergeUpperLeftRegPhvClrOnWr_127_0Mutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "PmergeUpperLeftRegPhvClrOnWr_127_0Mutable")
    {
    }
public:
  ...
  void clr(int j0,const uint8_t &v) { clr_[j0]=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PmergeUpperLeftRegPhvClrOnWr_127_0Mutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x30; // to get to phv_clr_on_wr_127_0
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_PMERGE_UPPER_LEFT_REG_PHV_CLR_ON_WR_127_0_MUTABLE_H__
