...
#ifndef __REGISTER_INCLUDES_PMERGE_UPPER_LEFT_REG_PHV_OWNER_127_0_H__
#define __REGISTER_INCLUDES_PMERGE_UPPER_LEFT_REG_PHV_OWNER_127_0_H__
...
class PmergeUpperLeftRegPhvOwner_127_0 : public model_core::RegisterBlock<RegisterCallback> {
public:
  PmergeUpperLeftRegPhvOwner_127_0(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 16, false, write_callback, read_callback, std::string("PmergeUpperLeftRegPhvOwner_127_0")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  PmergeUpperLeftRegPhvOwner_127_0(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "PmergeUpperLeftRegPhvOwner_127_0")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PmergeUpperLeftRegPhvOwner_127_0") + ":\n";
...
#endif // __REGISTER_INCLUDES_PMERGE_UPPER_LEFT_REG_PHV_OWNER_127_0_H__
