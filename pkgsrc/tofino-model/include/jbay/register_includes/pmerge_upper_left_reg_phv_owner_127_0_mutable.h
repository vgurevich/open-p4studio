...
#ifndef __REGISTER_INCLUDES_PMERGE_UPPER_LEFT_REG_PHV_OWNER_127_0_MUTABLE_H__
#define __REGISTER_INCLUDES_PMERGE_UPPER_LEFT_REG_PHV_OWNER_127_0_MUTABLE_H__
...
class PmergeUpperLeftRegPhvOwner_127_0Mutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  PmergeUpperLeftRegPhvOwner_127_0Mutable(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 16, true, write_callback, read_callback, std::string("PmergeUpperLeftRegPhvOwner_127_0Mutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  PmergeUpperLeftRegPhvOwner_127_0Mutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "PmergeUpperLeftRegPhvOwner_127_0Mutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PmergeUpperLeftRegPhvOwner_127_0Mutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x20; // to get to phv_owner_127_0
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_PMERGE_UPPER_LEFT_REG_PHV_OWNER_127_0_MUTABLE_H__
