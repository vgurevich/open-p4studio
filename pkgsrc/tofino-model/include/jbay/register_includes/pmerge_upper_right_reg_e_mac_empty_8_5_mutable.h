...
#ifndef __REGISTER_INCLUDES_PMERGE_UPPER_RIGHT_REG_E_MAC_EMPTY_8_5_MUTABLE_H__
#define __REGISTER_INCLUDES_PMERGE_UPPER_RIGHT_REG_E_MAC_EMPTY_8_5_MUTABLE_H__
...
class PmergeUpperRightRegEMacEmpty_8_5Mutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  PmergeUpperRightRegEMacEmpty_8_5Mutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_pmerge_upper_right_reg_e_mac_empty_8_5), 4, true, write_callback, read_callback, std::string("PmergeUpperRightRegEMacEmpty_8_5Mutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_pmerge_upper_right_reg_e_mac_empty_8_5))
    {
    }
  PmergeUpperRightRegEMacEmpty_8_5Mutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "PmergeUpperRightRegEMacEmpty_8_5Mutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PmergeUpperRightRegEMacEmpty_8_5Mutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_PMERGE_UPPER_RIGHT_REG_E_MAC_EMPTY_8_5_MUTABLE_H__
