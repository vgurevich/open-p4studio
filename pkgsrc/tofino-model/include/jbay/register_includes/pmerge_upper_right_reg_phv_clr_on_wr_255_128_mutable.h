...
#ifndef __REGISTER_INCLUDES_PMERGE_UPPER_RIGHT_REG_PHV_CLR_ON_WR_255_128_MUTABLE_H__
#define __REGISTER_INCLUDES_PMERGE_UPPER_RIGHT_REG_PHV_CLR_ON_WR_255_128_MUTABLE_H__
...
class PmergeUpperRightRegPhvClrOnWr_255_128Mutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  PmergeUpperRightRegPhvClrOnWr_255_128Mutable(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 16, true, write_callback, read_callback, std::string("PmergeUpperRightRegPhvClrOnWr_255_128Mutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  PmergeUpperRightRegPhvClrOnWr_255_128Mutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "PmergeUpperRightRegPhvClrOnWr_255_128Mutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PmergeUpperRightRegPhvClrOnWr_255_128Mutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_PMERGE_UPPER_RIGHT_REG_PHV_CLR_ON_WR_255_128_MUTABLE_H__
