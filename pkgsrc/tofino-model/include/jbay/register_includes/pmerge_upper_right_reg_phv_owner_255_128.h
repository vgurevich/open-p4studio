...
#ifndef __REGISTER_INCLUDES_PMERGE_UPPER_RIGHT_REG_PHV_OWNER_255_128_H__
#define __REGISTER_INCLUDES_PMERGE_UPPER_RIGHT_REG_PHV_OWNER_255_128_H__
...
class PmergeUpperRightRegPhvOwner_255_128 : public model_core::RegisterBlock<RegisterCallback> {
public:
  PmergeUpperRightRegPhvOwner_255_128(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 16, false, write_callback, read_callback, std::string("PmergeUpperRightRegPhvOwner_255_128")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  PmergeUpperRightRegPhvOwner_255_128(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "PmergeUpperRightRegPhvOwner_255_128")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PmergeUpperRightRegPhvOwner_255_128") + ":\n";
...
#endif // __REGISTER_INCLUDES_PMERGE_UPPER_RIGHT_REG_PHV_OWNER_255_128_H__
