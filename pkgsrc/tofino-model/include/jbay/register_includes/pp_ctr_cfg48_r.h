...
#ifndef __REGISTER_INCLUDES_PP_CTR_CFG48_R_H__
#define __REGISTER_INCLUDES_PP_CTR_CFG48_R_H__
...
class PpCtrCfg48R : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum DprsrHoEEnum {
    kHer,
    kOutEgr
...
public:
  PpCtrCfg48R(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_pp_ctr_cfg48_r), 8, false, write_callback, read_callback, std::string("PpCtrCfg48R")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_pp_ctr_cfg48_r))
    {
    }
  PpCtrCfg48R(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_dprsr_ho_e, selector_dprsr_ho_e, index_pp_ctr_cfg48_r), 8, false, write_callback, read_callback, std::string("PpCtrCfg48R")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_dprsr_ho_e) + "," + boost::lexical_cast<std::string>(selector_dprsr_ho_e) + "," + boost::lexical_cast<std::string>(index_pp_ctr_cfg48_r))
    {
    }
  PpCtrCfg48R(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_dprsr_ho_i, selector_dprsr_ho_i, index_pp_ctr_cfg48_r), 8, false, write_callback, read_callback, std::string("PpCtrCfg48R")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_dprsr_ho_i) + "," + boost::lexical_cast<std::string>(selector_dprsr_ho_i) + "," + boost::lexical_cast<std::string>(index_pp_ctr_cfg48_r))
    {
    }
  PpCtrCfg48R(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, selector_dprsr_ipp_regs), 8, false, write_callback, read_callback, std::string("PpCtrCfg48R")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(selector_dprsr_ipp_regs))
    {
    }
  PpCtrCfg48R(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "PpCtrCfg48R")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PpCtrCfg48R") + ":\n";
...
#endif // __REGISTER_INCLUDES_PP_CTR_CFG48_R_H__
