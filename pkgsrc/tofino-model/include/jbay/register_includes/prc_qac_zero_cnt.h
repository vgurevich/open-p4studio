...
#ifndef __REGISTER_INCLUDES_PRC_QAC_ZERO_CNT_H__
#define __REGISTER_INCLUDES_PRC_QAC_ZERO_CNT_H__
...
class PrcQacZeroCnt : public model_core::RegisterBlock<RegisterCallback> {
public:
  PrcQacZeroCnt(
      int chipNumber, int index_tm_prc_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_prc_pipe_rspec), 8, false, write_callback, read_callback, std::string("PrcQacZeroCnt")+":"+boost::lexical_cast<std::string>(index_tm_prc_pipe_rspec))
    {
    }
  PrcQacZeroCnt(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "PrcQacZeroCnt")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PrcQacZeroCnt") + ":\n";
...
#endif // __REGISTER_INCLUDES_PRC_QAC_ZERO_CNT_H__
