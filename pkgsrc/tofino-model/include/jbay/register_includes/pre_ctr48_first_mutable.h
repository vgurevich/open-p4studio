...
#ifndef __REGISTER_INCLUDES_PRE_CTR48_FIRST_MUTABLE_H__
#define __REGISTER_INCLUDES_PRE_CTR48_FIRST_MUTABLE_H__
...
class PreCtr48FirstMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  PreCtr48FirstMutable(
      int chipNumber, int index_tm_pre_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_pre_pipe_rspec), 8, true, write_callback, read_callback, std::string("PreCtr48FirstMutable")+":"+boost::lexical_cast<std::string>(index_tm_pre_pipe_rspec))
    {
    }
  PreCtr48FirstMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "PreCtr48FirstMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PreCtr48FirstMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0xc0; // to get to first_copies
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_PRE_CTR48_FIRST_MUTABLE_H__
