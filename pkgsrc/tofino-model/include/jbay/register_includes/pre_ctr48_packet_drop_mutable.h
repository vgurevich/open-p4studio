...
#ifndef __REGISTER_INCLUDES_PRE_CTR48_PACKET_DROP_MUTABLE_H__
#define __REGISTER_INCLUDES_PRE_CTR48_PACKET_DROP_MUTABLE_H__
...
class PreCtr48PacketDropMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  PreCtr48PacketDropMutable(
      int chipNumber, int index_tm_pre_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_pre_pipe_rspec), 8, true, write_callback, read_callback, std::string("PreCtr48PacketDropMutable")+":"+boost::lexical_cast<std::string>(index_tm_pre_pipe_rspec))
    {
    }
  PreCtr48PacketDropMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "PreCtr48PacketDropMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PreCtr48PacketDropMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x130; // to get to packet_drop
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_PRE_CTR48_PACKET_DROP_MUTABLE_H__
