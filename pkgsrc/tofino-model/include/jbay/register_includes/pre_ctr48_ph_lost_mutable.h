...
#ifndef __REGISTER_INCLUDES_PRE_CTR48_PH_LOST_MUTABLE_H__
#define __REGISTER_INCLUDES_PRE_CTR48_PH_LOST_MUTABLE_H__
...
class PreCtr48PhLostMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  PreCtr48PhLostMutable(
      int chipNumber, int index_tm_pre_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_pre_pipe_rspec), 8, true, write_callback, read_callback, std::string("PreCtr48PhLostMutable")+":"+boost::lexical_cast<std::string>(index_tm_pre_pipe_rspec))
    {
    }
  PreCtr48PhLostMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "PreCtr48PhLostMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PreCtr48PhLostMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x128; // to get to ph_lost
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_PRE_CTR48_PH_LOST_MUTABLE_H__
