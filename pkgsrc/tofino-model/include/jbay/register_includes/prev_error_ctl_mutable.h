...
#ifndef __REGISTER_INCLUDES_PREV_ERROR_CTL_MUTABLE_H__
#define __REGISTER_INCLUDES_PREV_ERROR_CTL_MUTABLE_H__
...
class PrevErrorCtlMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  PrevErrorCtlMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap, index_prev_error_ctl), 4, true, write_callback, read_callback, std::string("PrevErrorCtlMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap) + "," + boost::lexical_cast<std::string>(index_prev_error_ctl))
    {
    }
  PrevErrorCtlMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "PrevErrorCtlMutable")
    {
    }
public:
  ...
  void prev_error_ctl_idata_ovr(const uint8_t &v) { prev_error_ctl_idata_ovr_=v; }



  uint8_t prev_error_ctl_dis_pred() { return prev_error_ctl_dis_pred_; }
  void prev_error_ctl_dis_pred(const uint8_t &v) { prev_error_ctl_dis_pred_=v; }



  uint8_t prev_error_ctl_delay() { return prev_error_ctl_delay_; }
  void prev_error_ctl_delay(const uint8_t &v) { prev_error_ctl_delay_=v; }


  uint8_t prev_error_ctl_action() { return prev_error_ctl_action_; }
  void prev_error_ctl_action(const uint8_t &v) { prev_error_ctl_action_=v; }


  uint8_t prev_error_ctl_conc() { return prev_error_ctl_conc_; }
  void prev_error_ctl_conc(const uint8_t &v) { prev_error_ctl_conc_=v; }


  uint8_t prev_error_ctl_match() { return prev_error_ctl_match_; }
  void prev_error_ctl_match(const uint8_t &v) { prev_error_ctl_match_=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PrevErrorCtlMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_PREV_ERROR_CTL_MUTABLE_H__
