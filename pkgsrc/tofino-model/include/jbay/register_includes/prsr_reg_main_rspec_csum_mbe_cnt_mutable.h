...
#ifndef __REGISTER_INCLUDES_PRSR_REG_MAIN_RSPEC_CSUM_MBE_CNT_MUTABLE_H__
#define __REGISTER_INCLUDES_PRSR_REG_MAIN_RSPEC_CSUM_MBE_CNT_MUTABLE_H__
...
class PrsrRegMainRspecCsumMbeCntMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
...
public:
  PrsrRegMainRspecCsumMbeCntMutable(
...
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PrsrRegMainRspecCsumMbeCntMutable") + ":\n";
  ...
  static int StartOffset(
    ...
    switch (selector_parde_glue_stn_reg) {
      case kEpbprsr4reg:
        ...
        offset += 0x160; // to get to csum_mbe_cnt
        break;
      case kIpbprsr4reg:
        assert(index_epb_prsr4_reg < 9);
...
#endif // __REGISTER_INCLUDES_PRSR_REG_MAIN_RSPEC_CSUM_MBE_CNT_MUTABLE_H__
