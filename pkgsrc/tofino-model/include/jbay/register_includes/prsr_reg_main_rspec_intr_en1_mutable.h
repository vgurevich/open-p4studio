...
#ifndef __REGISTER_INCLUDES_PRSR_REG_MAIN_RSPEC_INTR_EN1_MUTABLE_H__
#define __REGISTER_INCLUDES_PRSR_REG_MAIN_RSPEC_INTR_EN1_MUTABLE_H__
...
class PrsrRegMainRspecIntrEn1Mutable : public model_core::RegisterBlock<RegisterCallback> {
public:
...
public:
  PrsrRegMainRspecIntrEn1Mutable(
...
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PrsrRegMainRspecIntrEn1Mutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_PRSR_REG_MAIN_RSPEC_INTR_EN1_MUTABLE_H__
