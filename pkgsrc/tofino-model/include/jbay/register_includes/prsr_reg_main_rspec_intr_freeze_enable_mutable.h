...
public:
  PrsrRegMainRspecIntrFreezeEnableMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, selector_parde_glue_stn_reg, index_epb_prsr4_reg, index_prsr_reg_main_rspec), 4, true, write_callback, read_callback, std::string("PrsrRegMainRspecIntrFreezeEnableMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(selector_parde_glue_stn_reg) + "," + boost::lexical_cast<std::string>(index_epb_prsr4_reg) + "," + boost::lexical_cast<std::string>(index_prsr_reg_main_rspec))
    {
    }
  PrsrRegMainRspecIntrFreezeEnableMutable(
...
public:
  ...
  void rsvd0(const uint8_t &v) { rsvd0_=v; }
  ...
  void csum_sbe(const uint8_t &v) { csum_sbe_=v; }
  uint8_t csum_mbe() { return csum_mbe_; }
  void csum_mbe(const uint8_t &v) { csum_mbe_=v; }
  ...
  static int StartOffset(
    ...
    switch (selector_parde_glue_stn_reg) {
      case kEpbprsr4reg:
        ...
        offset += 0x190; // to get to intr_freeze_enable
        break;
      case kIpbprsr4reg:
        assert(index_epb_prsr4_reg < 9);
