...
#ifndef __REGISTER_INCLUDES_PRSR_REG_MAIN_RSPEC_INTR_INJ_H__
#define __REGISTER_INCLUDES_PRSR_REG_MAIN_RSPEC_INTR_INJ_H__
...
class PrsrRegMainRspecIntrInj : public model_core::RegisterBlock<RegisterCallback> {
public:
...
public:
  PrsrRegMainRspecIntrInj(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, selector_parde_glue_stn_reg, index_epb_prsr4_reg, index_prsr_reg_main_rspec), 4, false, write_callback, read_callback, std::string("PrsrRegMainRspecIntrInj")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(selector_parde_glue_stn_reg) + "," + boost::lexical_cast<std::string>(index_epb_prsr4_reg) + "," + boost::lexical_cast<std::string>(index_prsr_reg_main_rspec))
    {
    }
  PrsrRegMainRspecIntrInj(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "PrsrRegMainRspecIntrInj")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PrsrRegMainRspecIntrInj") + ":\n";
...
#endif // __REGISTER_INCLUDES_PRSR_REG_MAIN_RSPEC_INTR_INJ_H__
