...
#ifndef __REGISTER_INCLUDES_PRSR_REG_MAIN_RSPEC_IQ_STATE_MUTABLE_H__
#define __REGISTER_INCLUDES_PRSR_REG_MAIN_RSPEC_IQ_STATE_MUTABLE_H__
...
class PrsrRegMainRspecIqStateMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
...
public:
  PrsrRegMainRspecIqStateMutable(
...
public:
  ...
  void pkt_occ(int j0,const uint8_t &v) { pkt_occ_[j0]=v; }
  ...
  void data_occ(int j0,const uint8_t &v) { data_occ_[j0]=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PrsrRegMainRspecIqStateMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_PRSR_REG_MAIN_RSPEC_IQ_STATE_MUTABLE_H__
