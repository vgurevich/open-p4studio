...
#ifndef __REGISTER_INCLUDES_PRSR_REG_MAIN_RSPEC_MEM_CTRL_H__
#define __REGISTER_INCLUDES_PRSR_REG_MAIN_RSPEC_MEM_CTRL_H__
...
class PrsrRegMainRspecMemCtrl : public model_core::RegisterBlock<RegisterCallback> {
public:
...
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PrsrRegMainRspecMemCtrl") + ":\n";
...
#endif // __REGISTER_INCLUDES_PRSR_REG_MAIN_RSPEC_MEM_CTRL_H__
