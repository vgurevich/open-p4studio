...
#ifndef __REGISTER_INCLUDES_PRSR_REG_MAIN_RSPEC_MEM_CTRL_MUTABLE_H__
#define __REGISTER_INCLUDES_PRSR_REG_MAIN_RSPEC_MEM_CTRL_MUTABLE_H__
...
class PrsrRegMainRspecMemCtrlMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
...
public:
  PrsrRegMainRspecMemCtrlMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, selector_parde_glue_stn_reg, index_epb_prsr4_reg, index_prsr_reg_main_rspec), 4, true, write_callback, read_callback, std::string("PrsrRegMainRspecMemCtrlMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(selector_parde_glue_stn_reg) + "," + boost::lexical_cast<std::string>(index_epb_prsr4_reg) + "," + boost::lexical_cast<std::string>(index_prsr_reg_main_rspec))
    {
    }
  PrsrRegMainRspecMemCtrlMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "PrsrRegMainRspecMemCtrlMutable")
    {
    }
public:
  ...
  uint8_t wr_addr() { return wr_addr_; }
  void wr_addr(const uint8_t &v) { wr_addr_=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PrsrRegMainRspecMemCtrlMutable") + ":\n";
    r += indent_string + "  " + std::string("wr_addr") +  ": 0x" + boost::str( boost::format("%x") % static_cast<uint>(wr_addr_) ) + "\n";
    all_zeros &= (0 == wr_addr_);
  ...
  static int StartOffset(
    ...
    switch (selector_parde_glue_stn_reg) {
      case kEpbprsr4reg:
        ...
        offset += 0x1e8; // to get to mem_ctrl
        break;
      case kIpbprsr4reg:
        assert(index_epb_prsr4_reg < 9);
...
#endif // __REGISTER_INCLUDES_PRSR_REG_MAIN_RSPEC_MEM_CTRL_MUTABLE_H__
