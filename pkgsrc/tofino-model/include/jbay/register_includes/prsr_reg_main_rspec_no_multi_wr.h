...
#ifndef __REGISTER_INCLUDES_PRSR_REG_MAIN_RSPEC_NO_MULTI_WR_H__
#define __REGISTER_INCLUDES_PRSR_REG_MAIN_RSPEC_NO_MULTI_WR_H__
...
class PrsrRegMainRspecNoMultiWr : public model_core::RegisterBlock<RegisterCallback> {
public:
...
public:
  PrsrRegMainRspecNoMultiWr(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, selector_parde_glue_stn_reg, index_epb_prsr4_reg, index_prsr_reg_main_rspec), 32, false, write_callback, read_callback, std::string("PrsrRegMainRspecNoMultiWr")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(selector_parde_glue_stn_reg) + "," + boost::lexical_cast<std::string>(index_epb_prsr4_reg) + "," + boost::lexical_cast<std::string>(index_prsr_reg_main_rspec))
    {
    }
  PrsrRegMainRspecNoMultiWr(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "PrsrRegMainRspecNoMultiWr")
    {
    }
public:
  ...
  bool read(
    ...
    if (offset < 0x4) {
      ...
      *data |= ((nmw_[232] & 0x1) << 8);
      *data |= ((nmw_[233] & 0x1) << 9);
      *data |= ((nmw_[234] & 0x1) << 10);
      *data |= ((nmw_[235] & 0x1) << 11);
      *data |= ((nmw_[236] & 0x1) << 12);
      *data |= ((nmw_[237] & 0x1) << 13);
      *data |= ((nmw_[238] & 0x1) << 14);
      *data |= ((nmw_[239] & 0x1) << 15);
      *data |= ((nmw_[240] & 0x1) << 16);
      *data |= ((nmw_[241] & 0x1) << 17);
      *data |= ((nmw_[242] & 0x1) << 18);
      *data |= ((nmw_[243] & 0x1) << 19);
      *data |= ((nmw_[244] & 0x1) << 20);
      *data |= ((nmw_[245] & 0x1) << 21);
      *data |= ((nmw_[246] & 0x1) << 22);
      *data |= ((nmw_[247] & 0x1) << 23);
      *data |= ((nmw_[248] & 0x1) << 24);
      *data |= ((nmw_[249] & 0x1) << 25);
      *data |= ((nmw_[250] & 0x1) << 26);
      *data |= ((nmw_[251] & 0x1) << 27);
      *data |= ((nmw_[252] & 0x1) << 28);
      *data |= ((nmw_[253] & 0x1) << 29);
      *data |= ((nmw_[254] & 0x1) << 30);
      *data |= ((nmw_[255] & 0x1) << 31);
    }
    else {
      assert(0);
    }
  ...
  bool write(
    ...
    if (offset < 0x4) {
      ...
      nmw_[232] = ((data >> 8) & 0x1);
      nmw_[233] = ((data >> 9) & 0x1);
      nmw_[234] = ((data >> 10) & 0x1);
      nmw_[235] = ((data >> 11) & 0x1);
      nmw_[236] = ((data >> 12) & 0x1);
      nmw_[237] = ((data >> 13) & 0x1);
      nmw_[238] = ((data >> 14) & 0x1);
      nmw_[239] = ((data >> 15) & 0x1);
      nmw_[240] = ((data >> 16) & 0x1);
      nmw_[241] = ((data >> 17) & 0x1);
      nmw_[242] = ((data >> 18) & 0x1);
      nmw_[243] = ((data >> 19) & 0x1);
      nmw_[244] = ((data >> 20) & 0x1);
      nmw_[245] = ((data >> 21) & 0x1);
      nmw_[246] = ((data >> 22) & 0x1);
      nmw_[247] = ((data >> 23) & 0x1);
      nmw_[248] = ((data >> 24) & 0x1);
      nmw_[249] = ((data >> 25) & 0x1);
      nmw_[250] = ((data >> 26) & 0x1);
      nmw_[251] = ((data >> 27) & 0x1);
      nmw_[252] = ((data >> 28) & 0x1);
      nmw_[253] = ((data >> 29) & 0x1);
      nmw_[254] = ((data >> 30) & 0x1);
      nmw_[255] = ((data >> 31) & 0x1);
      if (write_callback_) write_callback_();
    }
    else {
      assert(0);
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PrsrRegMainRspecNoMultiWr") + ":\n";
  ...
  static int StartOffset(
    ...
    switch (selector_parde_glue_stn_reg) {
      case kEpbprsr4reg:
        ...
        offset += 0x60; // to get to no_multi_wr
        break;
      case kIpbprsr4reg:
        assert(index_epb_prsr4_reg < 9);
...
#endif // __REGISTER_INCLUDES_PRSR_REG_MAIN_RSPEC_NO_MULTI_WR_H__
