...
#ifndef __REGISTER_INCLUDES_PRSR_REG_MAIN_RSPEC_OUT_ARB_CTRL_MUTABLE_H__
#define __REGISTER_INCLUDES_PRSR_REG_MAIN_RSPEC_OUT_ARB_CTRL_MUTABLE_H__
...
class PrsrRegMainRspecOutArbCtrlMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
...
public:
  PrsrRegMainRspecOutArbCtrlMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, selector_parde_glue_stn_reg, index_epb_prsr4_reg, index_prsr_reg_main_rspec), 4, true, write_callback, read_callback, std::string("PrsrRegMainRspecOutArbCtrlMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(selector_parde_glue_stn_reg) + "," + boost::lexical_cast<std::string>(index_epb_prsr4_reg) + "," + boost::lexical_cast<std::string>(index_prsr_reg_main_rspec))
    {
    }
  PrsrRegMainRspecOutArbCtrlMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "PrsrRegMainRspecOutArbCtrlMutable")
    {
    }
public:
  ...
  uint8_t wc_en() { return wc_en_; }
  void wc_en(const uint8_t &v) { wc_en_=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PrsrRegMainRspecOutArbCtrlMutable") + ":\n";
    r += indent_string + "  " + std::string("wc_en") +  ": 0x" + boost::str( boost::format("%x") % static_cast<uint>(wc_en_) ) + "\n";
    all_zeros &= (0 == wc_en_);
  ...
  static int StartOffset(
    ...
    switch (selector_parde_glue_stn_reg) {
      case kEpbprsr4reg:
        ...
        offset += 0x3c; // to get to out_arb_ctrl
        break;
      case kIpbprsr4reg:
        assert(index_epb_prsr4_reg < 9);
...
#endif // __REGISTER_INCLUDES_PRSR_REG_MAIN_RSPEC_OUT_ARB_CTRL_MUTABLE_H__
