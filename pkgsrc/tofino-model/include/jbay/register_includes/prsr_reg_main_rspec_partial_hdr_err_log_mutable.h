...
#ifndef __REGISTER_INCLUDES_PRSR_REG_MAIN_RSPEC_PARTIAL_HDR_ERR_LOG_MUTABLE_H__
#define __REGISTER_INCLUDES_PRSR_REG_MAIN_RSPEC_PARTIAL_HDR_ERR_LOG_MUTABLE_H__
...
public:
  PrsrRegMainRspecPartialHdrErrLogMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, selector_parde_glue_stn_reg, index_epb_prsr4_reg, index_prsr_reg_main_rspec), 4, true, write_callback, read_callback, std::string("PrsrRegMainRspecPartialHdrErrLogMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(selector_parde_glue_stn_reg) + "," + boost::lexical_cast<std::string>(index_epb_prsr4_reg) + "," + boost::lexical_cast<std::string>(index_prsr_reg_main_rspec))
    {
    }
  PrsrRegMainRspecPartialHdrErrLogMutable(
...
#endif // __REGISTER_INCLUDES_PRSR_REG_MAIN_RSPEC_PARTIAL_HDR_ERR_LOG_MUTABLE_H__
