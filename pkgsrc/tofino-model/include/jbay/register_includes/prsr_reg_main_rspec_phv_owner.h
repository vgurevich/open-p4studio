...
#ifndef __REGISTER_INCLUDES_PRSR_REG_MAIN_RSPEC_PHV_OWNER_H__
#define __REGISTER_INCLUDES_PRSR_REG_MAIN_RSPEC_PHV_OWNER_H__
...
class PrsrRegMainRspecPhvOwner : public model_core::RegisterBlock<RegisterCallback> {
public:
...
public:
  PrsrRegMainRspecPhvOwner(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, selector_parde_glue_stn_reg, index_epb_prsr4_reg, index_prsr_reg_main_rspec), 32, false, write_callback, read_callback, std::string("PrsrRegMainRspecPhvOwner")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(selector_parde_glue_stn_reg) + "," + boost::lexical_cast<std::string>(index_epb_prsr4_reg) + "," + boost::lexical_cast<std::string>(index_prsr_reg_main_rspec))
    {
    }
  PrsrRegMainRspecPhvOwner(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "PrsrRegMainRspecPhvOwner")
    {
    }
public:
  ...
  bool read(
    ...
    if (offset < 0x4) {
      ...
      *data |= ((owner_[223] & 0x1) << 31);
      ...
      if (read_callback_) read_callback_();
      *data = (owner_[224] & 0x1);
      *data |= ((owner_[225] & 0x1) << 1);
      *data |= ((owner_[226] & 0x1) << 2);
      *data |= ((owner_[227] & 0x1) << 3);
      *data |= ((owner_[228] & 0x1) << 4);
      *data |= ((owner_[229] & 0x1) << 5);
      *data |= ((owner_[230] & 0x1) << 6);
      *data |= ((owner_[231] & 0x1) << 7);
      *data |= ((owner_[232] & 0x1) << 8);
      *data |= ((owner_[233] & 0x1) << 9);
      *data |= ((owner_[234] & 0x1) << 10);
      *data |= ((owner_[235] & 0x1) << 11);
      *data |= ((owner_[236] & 0x1) << 12);
      *data |= ((owner_[237] & 0x1) << 13);
      *data |= ((owner_[238] & 0x1) << 14);
      *data |= ((owner_[239] & 0x1) << 15);
      *data |= ((owner_[240] & 0x1) << 16);
      *data |= ((owner_[241] & 0x1) << 17);
      *data |= ((owner_[242] & 0x1) << 18);
      *data |= ((owner_[243] & 0x1) << 19);
      *data |= ((owner_[244] & 0x1) << 20);
      *data |= ((owner_[245] & 0x1) << 21);
      *data |= ((owner_[246] & 0x1) << 22);
      *data |= ((owner_[247] & 0x1) << 23);
      *data |= ((owner_[248] & 0x1) << 24);
      *data |= ((owner_[249] & 0x1) << 25);
      *data |= ((owner_[250] & 0x1) << 26);
      *data |= ((owner_[251] & 0x1) << 27);
      *data |= ((owner_[252] & 0x1) << 28);
      *data |= ((owner_[253] & 0x1) << 29);
      *data |= ((owner_[254] & 0x1) << 30);
      *data |= ((owner_[255] & 0x1) << 31);
    }
    else {
      assert(0);
    }
  ...
  bool write(
    ...
    if (offset < 0x4) {
      ...
      owner_[224] = (data & 0x1);
      owner_[225] = ((data >> 1) & 0x1);
      owner_[226] = ((data >> 2) & 0x1);
      owner_[227] = ((data >> 3) & 0x1);
      owner_[228] = ((data >> 4) & 0x1);
      owner_[229] = ((data >> 5) & 0x1);
      owner_[230] = ((data >> 6) & 0x1);
      owner_[231] = ((data >> 7) & 0x1);
      owner_[232] = ((data >> 8) & 0x1);
      owner_[233] = ((data >> 9) & 0x1);
      owner_[234] = ((data >> 10) & 0x1);
      owner_[235] = ((data >> 11) & 0x1);
      owner_[236] = ((data >> 12) & 0x1);
      owner_[237] = ((data >> 13) & 0x1);
      owner_[238] = ((data >> 14) & 0x1);
      owner_[239] = ((data >> 15) & 0x1);
      owner_[240] = ((data >> 16) & 0x1);
      owner_[241] = ((data >> 17) & 0x1);
      owner_[242] = ((data >> 18) & 0x1);
      owner_[243] = ((data >> 19) & 0x1);
      owner_[244] = ((data >> 20) & 0x1);
      owner_[245] = ((data >> 21) & 0x1);
      owner_[246] = ((data >> 22) & 0x1);
      owner_[247] = ((data >> 23) & 0x1);
      owner_[248] = ((data >> 24) & 0x1);
      owner_[249] = ((data >> 25) & 0x1);
      owner_[250] = ((data >> 26) & 0x1);
      owner_[251] = ((data >> 27) & 0x1);
      owner_[252] = ((data >> 28) & 0x1);
      owner_[253] = ((data >> 29) & 0x1);
      owner_[254] = ((data >> 30) & 0x1);
      owner_[255] = ((data >> 31) & 0x1);
      if (write_callback_) write_callback_();
    }
    else {
      assert(0);
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PrsrRegMainRspecPhvOwner") + ":\n";
...
#endif // __REGISTER_INCLUDES_PRSR_REG_MAIN_RSPEC_PHV_OWNER_H__
