...
#ifndef __REGISTER_INCLUDES_PRSR_REG_MAIN_RSPEC_PRI_MAP_MUTABLE_H__
#define __REGISTER_INCLUDES_PRSR_REG_MAIN_RSPEC_PRI_MAP_MUTABLE_H__
...
class PrsrRegMainRspecPriMapMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
...
public:
  PrsrRegMainRspecPriMapMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, selector_parde_glue_stn_reg, index_epb_prsr4_reg, index_prsr_reg_main_rspec, index_prsr_reg_main_rspec_pri_map), 4, true, write_callback, read_callback, std::string("PrsrRegMainRspecPriMapMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(selector_parde_glue_stn_reg) + "," + boost::lexical_cast<std::string>(index_epb_prsr4_reg) + "," + boost::lexical_cast<std::string>(index_prsr_reg_main_rspec) + "," + boost::lexical_cast<std::string>(index_prsr_reg_main_rspec_pri_map))
    {
    }
  PrsrRegMainRspecPriMapMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "PrsrRegMainRspecPriMapMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PrsrRegMainRspecPriMapMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_PRSR_REG_MAIN_RSPEC_PRI_MAP_MUTABLE_H__
