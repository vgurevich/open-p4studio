...
#ifndef __REGISTER_INCLUDES_PRSR_REG_MAIN_RSPEC_SEQ_RESET_H__
#define __REGISTER_INCLUDES_PRSR_REG_MAIN_RSPEC_SEQ_RESET_H__
...
class PrsrRegMainRspecSeqReset : public model_core::RegisterBlock<RegisterCallback> {
public:
...
public:
  PrsrRegMainRspecSeqReset(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, selector_parde_glue_stn_reg, index_epb_prsr4_reg, index_prsr_reg_main_rspec), 4, false, write_callback, read_callback, std::string("PrsrRegMainRspecSeqReset")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(selector_parde_glue_stn_reg) + "," + boost::lexical_cast<std::string>(index_epb_prsr4_reg) + "," + boost::lexical_cast<std::string>(index_prsr_reg_main_rspec))
    {
    }
  PrsrRegMainRspecSeqReset(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "PrsrRegMainRspecSeqReset")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PrsrRegMainRspecSeqReset") + ":\n";
...
#endif // __REGISTER_INCLUDES_PRSR_REG_MAIN_RSPEC_SEQ_RESET_H__
