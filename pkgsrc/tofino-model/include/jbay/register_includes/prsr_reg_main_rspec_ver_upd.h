...
#ifndef __REGISTER_INCLUDES_PRSR_REG_MAIN_RSPEC_VER_UPD_H__
#define __REGISTER_INCLUDES_PRSR_REG_MAIN_RSPEC_VER_UPD_H__
...
class PrsrRegMainRspecVerUpd : public model_core::RegisterBlock<RegisterCallback> {
public:
...
public:
  PrsrRegMainRspecVerUpd(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, selector_parde_glue_stn_reg, index_epb_prsr4_reg, index_prsr_reg_main_rspec), 4, false, write_callback, read_callback, std::string("PrsrRegMainRspecVerUpd")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(selector_parde_glue_stn_reg) + "," + boost::lexical_cast<std::string>(index_epb_prsr4_reg) + "," + boost::lexical_cast<std::string>(index_prsr_reg_main_rspec))
    {
    }
  PrsrRegMainRspecVerUpd(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "PrsrRegMainRspecVerUpd")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PrsrRegMainRspecVerUpd") + ":\n";
...
#endif // __REGISTER_INCLUDES_PRSR_REG_MAIN_RSPEC_VER_UPD_H__
