...
#ifndef __REGISTER_INCLUDES_PSC_BANK_CTRL_R_ARRAY_H__
#define __REGISTER_INCLUDES_PSC_BANK_CTRL_R_ARRAY_H__
...
class PscBankCtrlRArray : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  PscBankCtrlRArray(
      int chipNumber, RegisterArrayCallback& write_callback = 0, RegisterArrayCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 4 * ArraySize(-1), false, write_callback, read_callback, std::string("PscBankCtrlRArray")),
...
public:
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("PscBankCtrlRArray") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
#endif // __REGISTER_INCLUDES_PSC_BANK_CTRL_R_ARRAY_H__
