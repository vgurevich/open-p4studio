...
public:
  PscBankCtrlRMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_psc_bank_ctrl_r), 4, true, write_callback, read_callback, std::string("PscBankCtrlRMutable")+":"+boost::lexical_cast<std::string>(index_psc_bank_ctrl_r))
    {
    }
  PscBankCtrlRMutable(
