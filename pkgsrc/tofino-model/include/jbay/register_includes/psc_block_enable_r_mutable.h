...
public:
  PscBlockEnableRMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(), 12, true, write_callback, read_callback, std::string("PscBlockEnableRMutable"))
    {
    }
  PscBlockEnableRMutable(
...
private:
  static int StartOffset(
    ...
    offset += 0x120; // to get to block_enable
    return offset;
  }
