...
#ifndef __REGISTER_INCLUDES_PSC_EPIPE_G_ARRAY_MUTABLE_H__
#define __REGISTER_INCLUDES_PSC_EPIPE_G_ARRAY_MUTABLE_H__
...
class PscEpipeGArrayMutable : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  PscEpipeGArrayMutable(
      int chipNumber, RegisterArrayCallback& write_callback = 0, RegisterArrayCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 24 * ArraySize(-1), true, write_callback, read_callback, std::string("PscEpipeGArrayMutable")),
...
public:
  ...
  PscEpipeEnableRMutable &epipe_enable(uint32_t a0)
  {
  ...
  PscEpipeBlocksUsecntRMutable &epipe_blks_usecnt(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
  ...
  PscEpipeBlocksMaxUsecntRMutable &epipe_blks_max_usecnt(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
  ...
  PscEpipePktDropcntRMutable &epipe_pkt_dropcnt(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("PscEpipeGArrayMutable") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
private:
  std::vector<PscEpipeGMutable> array;
  uint32_t size0_;
...
#endif // __REGISTER_INCLUDES_PSC_EPIPE_G_ARRAY_MUTABLE_H__
