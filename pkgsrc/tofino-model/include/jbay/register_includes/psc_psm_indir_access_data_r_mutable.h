...
public:
  PscPsmIndirAccessDataRMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_tm_psc_pipe_rspec), 32, true, write_callback, read_callback, std::string("PscPsmIndirAccessDataRMutable")+":"+boost::lexical_cast<std::string>(index_tm_psc_pipe_rspec))
    {
    }
  PscPsmIndirAccessDataRMutable(
...
public:
  ...
  void field7(const uint32_t &v) { field7_=v; }
  ...
  void field5(const uint32_t &v) { field5_=v; }
