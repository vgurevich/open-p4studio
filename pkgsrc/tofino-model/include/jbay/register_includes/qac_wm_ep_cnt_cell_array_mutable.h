...
#ifndef __REGISTER_INCLUDES_QAC_WM_EP_CNT_CELL_ARRAY_MUTABLE_H__
#define __REGISTER_INCLUDES_QAC_WM_EP_CNT_CELL_ARRAY_MUTABLE_H__
...
class QacWmEpCntCellArrayMutable : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  QacWmEpCntCellArrayMutable(
      int chipNumber, RegisterArrayCallback& write_callback = 0, RegisterArrayCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 4 * ArraySize(-1), true, write_callback, read_callback, std::string("QacWmEpCntCellArrayMutable")),
...
public:
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("QacWmEpCntCellArrayMutable") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
private:
  std::vector<QacWmEpCntCellMutable> array;
  uint32_t size0_;
...
#endif // __REGISTER_INCLUDES_QAC_WM_EP_CNT_CELL_ARRAY_MUTABLE_H__
