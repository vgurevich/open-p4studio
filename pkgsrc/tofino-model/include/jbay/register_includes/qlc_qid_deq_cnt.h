...
#ifndef __REGISTER_INCLUDES_QLC_QID_DEQ_CNT_H__
#define __REGISTER_INCLUDES_QLC_QID_DEQ_CNT_H__
...
class QlcQidDeqCnt : public model_core::RegisterBlock<RegisterCallback> {
public:
  QlcQidDeqCnt(
      int chipNumber, int index_tm_qlc_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_qlc_pipe_rspec), 8, false, write_callback, read_callback, std::string("QlcQidDeqCnt")+":"+boost::lexical_cast<std::string>(index_tm_qlc_pipe_rspec))
    {
    }
  QlcQidDeqCnt(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "QlcQidDeqCnt")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("QlcQidDeqCnt") + ":\n";
...
#endif // __REGISTER_INCLUDES_QLC_QID_DEQ_CNT_H__
