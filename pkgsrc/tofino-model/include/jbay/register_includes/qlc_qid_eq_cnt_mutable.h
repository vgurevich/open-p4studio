...
#ifndef __REGISTER_INCLUDES_QLC_QID_EQ_CNT_MUTABLE_H__
#define __REGISTER_INCLUDES_QLC_QID_EQ_CNT_MUTABLE_H__
...
class QlcQidEqCntMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  QlcQidEqCntMutable(
      int chipNumber, int index_tm_qlc_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_qlc_pipe_rspec), 8, true, write_callback, read_callback, std::string("QlcQidEqCntMutable")+":"+boost::lexical_cast<std::string>(index_tm_qlc_pipe_rspec))
    {
    }
  QlcQidEqCntMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "QlcQidEqCntMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("QlcQidEqCntMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x118; // to get to qid_eq_cnt
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_QLC_QID_EQ_CNT_MUTABLE_H__
