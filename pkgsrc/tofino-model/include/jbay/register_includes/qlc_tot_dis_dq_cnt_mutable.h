...
#ifndef __REGISTER_INCLUDES_QLC_TOT_DIS_DQ_CNT_MUTABLE_H__
#define __REGISTER_INCLUDES_QLC_TOT_DIS_DQ_CNT_MUTABLE_H__
...
class QlcTotDisDqCntMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  QlcTotDisDqCntMutable(
      int chipNumber, int index_tm_qlc_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_qlc_pipe_rspec), 8, true, write_callback, read_callback, std::string("QlcTotDisDqCntMutable")+":"+boost::lexical_cast<std::string>(index_tm_qlc_pipe_rspec))
    {
    }
  QlcTotDisDqCntMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "QlcTotDisDqCntMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("QlcTotDisDqCntMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x138; // to get to tot_dis_dq_cnt
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_QLC_TOT_DIS_DQ_CNT_MUTABLE_H__
