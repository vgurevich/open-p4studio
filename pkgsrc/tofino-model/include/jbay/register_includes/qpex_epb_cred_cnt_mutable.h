...
public:
  QpexEpbCredCntMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_tm_pex_pipe_rspec, index_qpex_epb_cred_cnt), 8, true, write_callback, read_callback, std::string("QpexEpbCredCntMutable")+":"+boost::lexical_cast<std::string>(index_tm_pex_pipe_rspec) + "," + boost::lexical_cast<std::string>(index_qpex_epb_cred_cnt))
    {
    }
  QpexEpbCredCntMutable(
...
public:
  ...
  void cred4(const uint8_t &v) { cred4_=v; }
  ...
  void cred5(const uint8_t &v) { cred5_=v; }
  ...
  void cred6(const uint8_t &v) { cred6_=v; }
  ...
  void cred7(const uint8_t &v) { cred7_=v; }
