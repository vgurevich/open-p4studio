...
#ifndef __REGISTER_INCLUDES_RAM_ADDRESS_MUX_CTL_MUTABLE_H__
#define __REGISTER_INCLUDES_RAM_ADDRESS_MUX_CTL_MUTABLE_H__
...
class RamAddressMuxCtlMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  RamAddressMuxCtlMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap, index_mau_map_and_alu_row_addrmap, index_ram_address_mux_ctl_0, index_ram_address_mux_ctl_1), 4, true, write_callback, read_callback, std::string("RamAddressMuxCtlMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_map_and_alu_row_addrmap) + "," + boost::lexical_cast<std::string>(index_ram_address_mux_ctl_0) + "," + boost::lexical_cast<std::string>(index_ram_address_mux_ctl_1))
    {
    }
  RamAddressMuxCtlMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "RamAddressMuxCtlMutable")
    {
    }
public:
  ...
  void map_ram_wadr_shift(const uint8_t &v) { map_ram_wadr_shift_=v; }
  ...
  void map_ram_wadr_mux_select(const uint8_t &v) { map_ram_wadr_mux_select_=v; }


  uint8_t map_ram_wadr_mux_enable() { return map_ram_wadr_mux_enable_; }
  void map_ram_wadr_mux_enable(const uint8_t &v) { map_ram_wadr_mux_enable_=v; }



  uint8_t map_ram_radr_mux_select_color() { return map_ram_radr_mux_select_color_; }
  void map_ram_radr_mux_select_color(const uint8_t &v) { map_ram_radr_mux_select_color_=v; }


  uint8_t map_ram_radr_mux_select_smoflo() { return map_ram_radr_mux_select_smoflo_; }
  void map_ram_radr_mux_select_smoflo(const uint8_t &v) { map_ram_radr_mux_select_smoflo_=v; }
  ...
  void ram_unitram_adr_mux_select(const uint8_t &v) { ram_unitram_adr_mux_select_=v; }


  uint8_t ram_ofo_stats_mux_select_oflo() { return ram_ofo_stats_mux_select_oflo_; }
  void ram_ofo_stats_mux_select_oflo(const uint8_t &v) { ram_ofo_stats_mux_select_oflo_=v; }


  uint8_t ram_ofo_stats_mux_select_statsmeter() { return ram_ofo_stats_mux_select_statsmeter_; }
  void ram_ofo_stats_mux_select_statsmeter(const uint8_t &v) { ram_ofo_stats_mux_select_statsmeter_=v; }


  uint8_t ram_stats_meter_adr_mux_select_stats() { return ram_stats_meter_adr_mux_select_stats_; }
  void ram_stats_meter_adr_mux_select_stats(const uint8_t &v) { ram_stats_meter_adr_mux_select_stats_=v; }


  uint8_t ram_stats_meter_adr_mux_select_meter() { return ram_stats_meter_adr_mux_select_meter_; }
  void ram_stats_meter_adr_mux_select_meter(const uint8_t &v) { ram_stats_meter_adr_mux_select_meter_=v; }


  uint8_t ram_stats_meter_adr_mux_select_idlet() { return ram_stats_meter_adr_mux_select_idlet_; }
  void ram_stats_meter_adr_mux_select_idlet(const uint8_t &v) { ram_stats_meter_adr_mux_select_idlet_=v; }


  uint8_t ram_oflo_adr_mux_select_oflo() { return ram_oflo_adr_mux_select_oflo_; }
  void ram_oflo_adr_mux_select_oflo(const uint8_t &v) { ram_oflo_adr_mux_select_oflo_=v; }


  uint8_t ram_oflo_adr_mux_select_oflo2() { return ram_oflo_adr_mux_select_oflo2_; }
  void ram_oflo_adr_mux_select_oflo2(const uint8_t &v) { ram_oflo_adr_mux_select_oflo2_=v; }




  uint8_t synth2port_radr_mux_select_home_row() { return synth2port_radr_mux_select_home_row_; }
  void synth2port_radr_mux_select_home_row(const uint8_t &v) { synth2port_radr_mux_select_home_row_=v; }


  uint8_t synth2port_radr_mux_select_oflo() { return synth2port_radr_mux_select_oflo_; }
  void synth2port_radr_mux_select_oflo(const uint8_t &v) { synth2port_radr_mux_select_oflo_=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("RamAddressMuxCtlMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_RAM_ADDRESS_MUX_CTL_MUTABLE_H__
