...
#ifndef __REGISTER_INCLUDES_S2P_COAL_HDR_R_ARRAY_H__
#define __REGISTER_INCLUDES_S2P_COAL_HDR_R_ARRAY_H__
...
#include "s2p_coal_hdr_r.h"

namespace jbay {
  namespace register_classes {

class S2pCoalHdrRArray : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  S2pCoalHdrRArray(
      int chipNumber, int index_pipe_addrmap, RegisterArrayCallback& write_callback = 0, RegisterArrayCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 16 * ArraySize(index_pipe_addrmap, -1), false, write_callback, read_callback, std::string("S2pCoalHdrRArray")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap)),
...
public:
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("S2pCoalHdrRArray") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
#endif // __REGISTER_INCLUDES_S2P_COAL_HDR_R_ARRAY_H__
