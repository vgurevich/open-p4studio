...
public:
  ...
  void salu_cmp_bsrc_mask_enable(const uint8_t &v) { salu_cmp_bsrc_mask_enable_=v; }
  ...
  void salu_cmp_asrc_mask_enable(const uint8_t &v) { salu_cmp_asrc_mask_enable_=v; }
  ...
  void salu_cmp_tmatch_enable(const uint8_t &v) { salu_cmp_tmatch_enable_=v; }




  uint8_t salu_cmp_mask_input() { return salu_cmp_mask_input_; }
  void salu_cmp_mask_input(const uint8_t &v) { salu_cmp_mask_input_=v; }


  uint8_t salu_cmp_regfile_adr() { return salu_cmp_regfile_adr_; }
  void salu_cmp_regfile_adr(const uint8_t &v) { salu_cmp_regfile_adr_=v; }


  uint8_t salu_cmp_sbus_or() { return salu_cmp_sbus_or_; }
  void salu_cmp_sbus_or(const uint8_t &v) { salu_cmp_sbus_or_=v; }


  uint8_t salu_cmp_sbus_and() { return salu_cmp_sbus_and_; }
  void salu_cmp_sbus_and(const uint8_t &v) { salu_cmp_sbus_and_=v; }


  uint8_t salu_cmp_sbus_invert() { return salu_cmp_sbus_invert_; }
  void salu_cmp_sbus_invert(const uint8_t &v) { salu_cmp_sbus_invert_=v; }
