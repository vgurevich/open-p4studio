...
#ifndef __REGISTER_INCLUDES_SALU_INSTR_TMATCH_ALU_ARRAY2_H__
#define __REGISTER_INCLUDES_SALU_INSTR_TMATCH_ALU_ARRAY2_H__
...
class SaluInstrTmatchAluArray2 : public model_core::RegisterBlock<RegisterArrayCallback2> {
public:
  SaluInstrTmatchAluArray2(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap, index_mau_meter_alu_group_addrmap), 4 * ArraySize(index_pipe_addrmap, index_mau_addrmap, index_mau_meter_alu_group_addrmap, -1), false, write_callback, read_callback, std::string("SaluInstrTmatchAluArray2")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_meter_alu_group_addrmap)),
...
public:
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("SaluInstrTmatchAluArray2") + "["+boost::lexical_cast<std::string>(a1)+"]"+"["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
private:
  std::vector<SaluInstrTmatchAlu> array;
  uint32_t size0_;
...
#endif // __REGISTER_INCLUDES_SALU_INSTR_TMATCH_ALU_ARRAY2_H__
