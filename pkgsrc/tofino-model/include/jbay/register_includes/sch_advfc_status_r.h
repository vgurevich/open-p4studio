...
#ifndef __REGISTER_INCLUDES_SCH_ADVFC_STATUS_R_H__
#define __REGISTER_INCLUDES_SCH_ADVFC_STATUS_R_H__
...
class SchAdvfcStatusR : public model_core::RegisterBlock<RegisterCallback> {
public:
...
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("SchAdvfcStatusR") + ":\n";
...
#endif // __REGISTER_INCLUDES_SCH_ADVFC_STATUS_R_H__
