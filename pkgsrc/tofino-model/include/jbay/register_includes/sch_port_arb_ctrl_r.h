...
#ifndef __REGISTER_INCLUDES_SCH_PORT_ARB_CTRL_R_H__
#define __REGISTER_INCLUDES_SCH_PORT_ARB_CTRL_R_H__
...
class SchPortArbCtrlR : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum TmTopRspecEnum {
    kTmSchaTop,
    kTmSchbTop
...
public:
  SchPortArbCtrlR(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_tm_top_rspec, index_tm_sch_pipe_rspec), 4, false, write_callback, read_callback, std::string("SchPortArbCtrlR")+":"+boost::lexical_cast<std::string>(selector_tm_top_rspec) + "," + boost::lexical_cast<std::string>(index_tm_sch_pipe_rspec))
    {
    }
  SchPortArbCtrlR(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "SchPortArbCtrlR")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("SchPortArbCtrlR") + ":\n";
...
#endif // __REGISTER_INCLUDES_SCH_PORT_ARB_CTRL_R_H__
