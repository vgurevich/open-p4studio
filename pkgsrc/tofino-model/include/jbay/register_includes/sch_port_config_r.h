...
public:
  SchPortConfigR(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_tm_top_rspec, index_tm_sch_pipe_rspec, index_sch_port_config_r), 4, false, write_callback, read_callback, std::string("SchPortConfigR")+":"+boost::lexical_cast<std::string>(selector_tm_top_rspec) + "," + boost::lexical_cast<std::string>(index_tm_sch_pipe_rspec) + "," + boost::lexical_cast<std::string>(index_sch_port_config_r))
    {
    }
  SchPortConfigR(
