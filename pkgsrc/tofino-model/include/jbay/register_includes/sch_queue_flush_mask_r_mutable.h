...
#ifndef __REGISTER_INCLUDES_SCH_QUEUE_FLUSH_MASK_R_MUTABLE_H__
#define __REGISTER_INCLUDES_SCH_QUEUE_FLUSH_MASK_R_MUTABLE_H__
...
class SchQueueFlushMaskRMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum TmTopRspecEnum {
    kTmSchaTop,
    kTmSchbTop
...
public:
  SchQueueFlushMaskRMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_tm_top_rspec, index_tm_sch_pipe_rspec), 16, true, write_callback, read_callback, std::string("SchQueueFlushMaskRMutable")+":"+boost::lexical_cast<std::string>(selector_tm_top_rspec) + "," + boost::lexical_cast<std::string>(index_tm_sch_pipe_rspec))
    {
    }
  SchQueueFlushMaskRMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "SchQueueFlushMaskRMutable")
    {
    }
public:
  ...
  void queue_flush_mask(int j0,const uint8_t &v) { queue_flush_mask_[j0]=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("SchQueueFlushMaskRMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_SCH_QUEUE_FLUSH_MASK_R_MUTABLE_H__
