...
#ifndef __REGISTER_INCLUDES_STATS_BUBBLE_REQ_H__
#define __REGISTER_INCLUDES_STATS_BUBBLE_REQ_H__
...
class StatsBubbleReq : public model_core::RegisterBlock<RegisterCallback> {
public:
  StatsBubbleReq(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap, index_stats_bubble_req), 4, false, write_callback, read_callback, std::string("StatsBubbleReq")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap) + "," + boost::lexical_cast<std::string>(index_stats_bubble_req))
    {
    }
  StatsBubbleReq(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "StatsBubbleReq")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("StatsBubbleReq") + ":\n";
...
#endif // __REGISTER_INCLUDES_STATS_BUBBLE_REQ_H__
