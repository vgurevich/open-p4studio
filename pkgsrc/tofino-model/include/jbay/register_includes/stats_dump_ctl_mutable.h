...
#ifndef __REGISTER_INCLUDES_STATS_DUMP_CTL_MUTABLE_H__
#define __REGISTER_INCLUDES_STATS_DUMP_CTL_MUTABLE_H__
...
class StatsDumpCtlMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  StatsDumpCtlMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap, index_stats_dump_ctl), 4, true, write_callback, read_callback, std::string("StatsDumpCtlMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap) + "," + boost::lexical_cast<std::string>(index_stats_dump_ctl))
    {
    }
  StatsDumpCtlMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "StatsDumpCtlMutable")
    {
    }
public:
  ...
  void stats_dump_entries_per_word(const uint8_t &v) { stats_dump_entries_per_word_=v; }



  uint8_t stats_dump_has_bytes() { return stats_dump_has_bytes_; }
  void stats_dump_has_bytes(const uint8_t &v) { stats_dump_has_bytes_=v; }



  uint8_t stats_dump_has_packets() { return stats_dump_has_packets_; }
  void stats_dump_has_packets(const uint8_t &v) { stats_dump_has_packets_=v; }


  uint8_t stats_dump_offset() { return stats_dump_offset_; }
  void stats_dump_offset(const uint8_t &v) { stats_dump_offset_=v; }


  uint8_t stats_dump_size() { return stats_dump_size_; }
  void stats_dump_size(const uint8_t &v) { stats_dump_size_=v; }


  uint8_t stats_dump_remove_hole_pos() { return stats_dump_remove_hole_pos_; }
  void stats_dump_remove_hole_pos(const uint8_t &v) { stats_dump_remove_hole_pos_=v; }


  uint8_t stats_dump_remove_hole_en() { return stats_dump_remove_hole_en_; }
  void stats_dump_remove_hole_en(const uint8_t &v) { stats_dump_remove_hole_en_=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("StatsDumpCtlMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_STATS_DUMP_CTL_MUTABLE_H__
