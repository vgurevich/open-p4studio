...
#ifndef __REGISTER_INCLUDES_TBUS_CTRL_H__
#define __REGISTER_INCLUDES_TBUS_CTRL_H__
...
class TbusCtrl : public model_core::RegisterBlock<RegisterCallback> {
public:
  TbusCtrl(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 4, false, write_callback, read_callback, std::string("TbusCtrl"))
    {
    }
  TbusCtrl(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "TbusCtrl")
    {
    }
public:
  ...
  uint8_t &rx_channel_offset() { return rx_channel_offset_; }
  ...
  uint8_t &crcerr_keep() { return crcerr_keep_; }
  ...
  bool read(
    ...
    *data |= ((rx_channel_offset_ & 0xf) << 22);
    *data |= ((crcerr_keep_ & 0x1) << 26);
    return true;
  }
  ...
  bool write(
    ...
    rx_channel_offset_ = ((data >> 22) & 0xf);
    crcerr_keep_ = ((data >> 26) & 0x1);
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("TbusCtrl") + ":\n";
    ...
    r += indent_string + "  " + std::string("rx_channel_offset") +  ": 0x" + boost::str( boost::format("%x") % static_cast<uint>(rx_channel_offset_) ) + "\n";
    all_zeros &= (0 == rx_channel_offset_);
    r += indent_string + "  " + std::string("crcerr_keep") +  ": 0x" + boost::str( boost::format("%x") % static_cast<uint>(crcerr_keep_) ) + "\n";
    all_zeros &= (0 == crcerr_keep_);
...
private:
  ...
  uint8_t rx_en_;
  uint8_t port_alive_;
  uint8_t rx_channel_offset_;
  uint8_t crcerr_keep_;
private:
...
#endif // __REGISTER_INCLUDES_TBUS_CTRL_H__
