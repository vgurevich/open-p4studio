...
#ifndef __REGISTER_INCLUDES_TM_CAA_TOP_RSPEC_INTR_FREEZE_ENABLE_MUTABLE_H__
#define __REGISTER_INCLUDES_TM_CAA_TOP_RSPEC_INTR_FREEZE_ENABLE_MUTABLE_H__
...
class TmCaaTopRspecIntrFreezeEnableMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  TmCaaTopRspecIntrFreezeEnableMutable(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 4, true, write_callback, read_callback, std::string("TmCaaTopRspecIntrFreezeEnableMutable"))
    {
    }
  TmCaaTopRspecIntrFreezeEnableMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "TmCaaTopRspecIntrFreezeEnableMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("TmCaaTopRspecIntrFreezeEnableMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x36f0; // to get to intr_freeze_enable
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_TM_CAA_TOP_RSPEC_INTR_FREEZE_ENABLE_MUTABLE_H__
