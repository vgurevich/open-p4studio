...
#ifndef __REGISTER_INCLUDES_TM_CAA_TOP_RSPEC_INTR_INJ_H__
#define __REGISTER_INCLUDES_TM_CAA_TOP_RSPEC_INTR_INJ_H__
...
class TmCaaTopRspecIntrInj : public model_core::RegisterBlock<RegisterCallback> {
public:
  TmCaaTopRspecIntrInj(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 4, false, write_callback, read_callback, std::string("TmCaaTopRspecIntrInj"))
    {
    }
  TmCaaTopRspecIntrInj(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "TmCaaTopRspecIntrInj")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("TmCaaTopRspecIntrInj") + ":\n";
...
#endif // __REGISTER_INCLUDES_TM_CAA_TOP_RSPEC_INTR_INJ_H__
