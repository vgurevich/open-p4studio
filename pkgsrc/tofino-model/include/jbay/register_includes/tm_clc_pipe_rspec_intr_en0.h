...
#ifndef __REGISTER_INCLUDES_TM_CLC_PIPE_RSPEC_INTR_EN0_H__
#define __REGISTER_INCLUDES_TM_CLC_PIPE_RSPEC_INTR_EN0_H__
...
class TmClcPipeRspecIntrEn0 : public model_core::RegisterBlock<RegisterCallback> {
public:
  TmClcPipeRspecIntrEn0(
      int chipNumber, int index_tm_clc_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_clc_pipe_rspec), 4, false, write_callback, read_callback, std::string("TmClcPipeRspecIntrEn0")+":"+boost::lexical_cast<std::string>(index_tm_clc_pipe_rspec))
    {
    }
  TmClcPipeRspecIntrEn0(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "TmClcPipeRspecIntrEn0")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("TmClcPipeRspecIntrEn0") + ":\n";
...
#endif // __REGISTER_INCLUDES_TM_CLC_PIPE_RSPEC_INTR_EN0_H__
