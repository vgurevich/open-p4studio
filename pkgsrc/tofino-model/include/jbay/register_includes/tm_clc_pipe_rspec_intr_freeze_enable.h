...
#ifndef __REGISTER_INCLUDES_TM_CLC_PIPE_RSPEC_INTR_FREEZE_ENABLE_H__
#define __REGISTER_INCLUDES_TM_CLC_PIPE_RSPEC_INTR_FREEZE_ENABLE_H__
...
class TmClcPipeRspecIntrFreezeEnable : public model_core::RegisterBlock<RegisterCallback> {
public:
  TmClcPipeRspecIntrFreezeEnable(
      int chipNumber, int index_tm_clc_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_clc_pipe_rspec), 4, false, write_callback, read_callback, std::string("TmClcPipeRspecIntrFreezeEnable")+":"+boost::lexical_cast<std::string>(index_tm_clc_pipe_rspec))
    {
    }
  TmClcPipeRspecIntrFreezeEnable(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "TmClcPipeRspecIntrFreezeEnable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("TmClcPipeRspecIntrFreezeEnable") + ":\n";
...
#endif // __REGISTER_INCLUDES_TM_CLC_PIPE_RSPEC_INTR_FREEZE_ENABLE_H__
