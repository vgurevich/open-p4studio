...
#ifndef __REGISTER_INCLUDES_TM_CLC_PIPE_RSPEC_INTR_FREEZE_ENABLE_MUTABLE_H__
#define __REGISTER_INCLUDES_TM_CLC_PIPE_RSPEC_INTR_FREEZE_ENABLE_MUTABLE_H__
...
class TmClcPipeRspecIntrFreezeEnableMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  TmClcPipeRspecIntrFreezeEnableMutable(
      int chipNumber, int index_tm_clc_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_clc_pipe_rspec), 4, true, write_callback, read_callback, std::string("TmClcPipeRspecIntrFreezeEnableMutable")+":"+boost::lexical_cast<std::string>(index_tm_clc_pipe_rspec))
    {
    }
  TmClcPipeRspecIntrFreezeEnableMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "TmClcPipeRspecIntrFreezeEnableMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("TmClcPipeRspecIntrFreezeEnableMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_TM_CLC_PIPE_RSPEC_INTR_FREEZE_ENABLE_MUTABLE_H__
