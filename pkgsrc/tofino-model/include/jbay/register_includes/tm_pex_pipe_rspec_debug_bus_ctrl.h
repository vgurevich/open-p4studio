...
#ifndef __REGISTER_INCLUDES_TM_PEX_PIPE_RSPEC_DEBUG_BUS_CTRL_H__
#define __REGISTER_INCLUDES_TM_PEX_PIPE_RSPEC_DEBUG_BUS_CTRL_H__
...
class TmPexPipeRspecDebugBusCtrl : public model_core::RegisterBlock<RegisterCallback> {
public:
  TmPexPipeRspecDebugBusCtrl(
      int chipNumber, int index_tm_pex_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_pex_pipe_rspec), 4, false, write_callback, read_callback, std::string("TmPexPipeRspecDebugBusCtrl")+":"+boost::lexical_cast<std::string>(index_tm_pex_pipe_rspec))
    {
    }
  TmPexPipeRspecDebugBusCtrl(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "TmPexPipeRspecDebugBusCtrl")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("TmPexPipeRspecDebugBusCtrl") + ":\n";
...
#endif // __REGISTER_INCLUDES_TM_PEX_PIPE_RSPEC_DEBUG_BUS_CTRL_H__
