...
#ifndef __REGISTER_INCLUDES_TM_PEX_PIPE_RSPEC_INTR_EN1_MUTABLE_H__
#define __REGISTER_INCLUDES_TM_PEX_PIPE_RSPEC_INTR_EN1_MUTABLE_H__
...
class TmPexPipeRspecIntrEn1Mutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  TmPexPipeRspecIntrEn1Mutable(
      int chipNumber, int index_tm_pex_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_pex_pipe_rspec), 4, true, write_callback, read_callback, std::string("TmPexPipeRspecIntrEn1Mutable")+":"+boost::lexical_cast<std::string>(index_tm_pex_pipe_rspec))
    {
    }
  TmPexPipeRspecIntrEn1Mutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "TmPexPipeRspecIntrEn1Mutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("TmPexPipeRspecIntrEn1Mutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_TM_PEX_PIPE_RSPEC_INTR_EN1_MUTABLE_H__
