...
#ifndef __REGISTER_INCLUDES_TM_PRC_PIPE_RSPEC_CACHE_MBE_ERR_LOG_H__
#define __REGISTER_INCLUDES_TM_PRC_PIPE_RSPEC_CACHE_MBE_ERR_LOG_H__
...
public:
  TmPrcPipeRspecCacheMbeErrLog(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_tm_prc_pipe_rspec), 8, false, write_callback, read_callback, std::string("TmPrcPipeRspecCacheMbeErrLog")+":"+boost::lexical_cast<std::string>(index_tm_prc_pipe_rspec))
    {
    }
  TmPrcPipeRspecCacheMbeErrLog(
...
#endif // __REGISTER_INCLUDES_TM_PRC_PIPE_RSPEC_CACHE_MBE_ERR_LOG_H__
