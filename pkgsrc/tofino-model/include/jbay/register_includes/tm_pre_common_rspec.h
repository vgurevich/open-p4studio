...
#ifndef __REGISTER_INCLUDES_TM_PRE_COMMON_RSPEC_H__
#define __REGISTER_INCLUDES_TM_PRE_COMMON_RSPEC_H__
...
#include "pre_common_ctrl.h"
#include "pre_pipe_int_status.h"
#include "pre_port_down.h"
#include "pre_port_mask.h"
#include "pre_prune_rid.h"
#include "pre_rdm_blk_id.h"

namespace jbay {
  namespace register_classes {

class TmPreCommonRspec : public model_core::RegisterBlock<RegisterCallback> {
public:
  TmPreCommonRspec(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 32768, false, write_callback, read_callback, std::string("TmPreCommonRspec"))
    {
    }
  TmPreCommonRspec(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "TmPreCommonRspec")
    {
    }
public:
  ...
  PreCommonCtrl &common_ctrl() { return common_ctrl_; }





  PrePruneRid &prune_rid() { return prune_rid_; }





  PreRdmBlkId &blk_id() { return blk_id_; }
  ...
  PrePortMask &port_mask(int j0) { return port_mask_[j0]; }





  PrePortDown &port_down() { return port_down_; }





  PrePipeIntStatus &pipe_int_status() { return pipe_int_status_; }
...
private:
  PreCommonCtrl common_ctrl_;
  PrePruneRid prune_rid_;
  PreRdmBlkId blk_id_;
  std::array< PrePortMask, 2 > port_mask_;
  PrePortDown port_down_;
  PrePipeIntStatus pipe_int_status_;
private:
...
#endif // __REGISTER_INCLUDES_TM_PRE_COMMON_RSPEC_H__
