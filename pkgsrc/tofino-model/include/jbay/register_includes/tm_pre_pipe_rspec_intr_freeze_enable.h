...
#ifndef __REGISTER_INCLUDES_TM_PRE_PIPE_RSPEC_INTR_FREEZE_ENABLE_H__
#define __REGISTER_INCLUDES_TM_PRE_PIPE_RSPEC_INTR_FREEZE_ENABLE_H__
...
class TmPrePipeRspecIntrFreezeEnable : public model_core::RegisterBlock<RegisterCallback> {
public:
  TmPrePipeRspecIntrFreezeEnable(
      int chipNumber, int index_tm_pre_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_pre_pipe_rspec), 4, false, write_callback, read_callback, std::string("TmPrePipeRspecIntrFreezeEnable")+":"+boost::lexical_cast<std::string>(index_tm_pre_pipe_rspec))
    {
    }
  TmPrePipeRspecIntrFreezeEnable(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "TmPrePipeRspecIntrFreezeEnable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("TmPrePipeRspecIntrFreezeEnable") + ":\n";
...
#endif // __REGISTER_INCLUDES_TM_PRE_PIPE_RSPEC_INTR_FREEZE_ENABLE_H__
