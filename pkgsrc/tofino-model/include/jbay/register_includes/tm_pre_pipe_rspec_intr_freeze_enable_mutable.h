...
#ifndef __REGISTER_INCLUDES_TM_PRE_PIPE_RSPEC_INTR_FREEZE_ENABLE_MUTABLE_H__
#define __REGISTER_INCLUDES_TM_PRE_PIPE_RSPEC_INTR_FREEZE_ENABLE_MUTABLE_H__
...
class TmPrePipeRspecIntrFreezeEnableMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  TmPrePipeRspecIntrFreezeEnableMutable(
      int chipNumber, int index_tm_pre_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_pre_pipe_rspec), 4, true, write_callback, read_callback, std::string("TmPrePipeRspecIntrFreezeEnableMutable")+":"+boost::lexical_cast<std::string>(index_tm_pre_pipe_rspec))
    {
    }
  TmPrePipeRspecIntrFreezeEnableMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "TmPrePipeRspecIntrFreezeEnableMutable")
    {
    }
public:
  ...
  uint8_t ififo_overflow() { return ififo_overflow_; }
  void ififo_overflow(const uint8_t &v) { ififo_overflow_=v; }
  ...
  uint8_t fifo_mem_bankid_mbe() { return fifo_mem_bankid_mbe_; }
  void fifo_mem_bankid_mbe(const uint8_t &v) { fifo_mem_bankid_mbe_=v; }
  ...
  uint8_t fifo_mem_bankid_sbe() { return fifo_mem_bankid_sbe_; }
  void fifo_mem_bankid_sbe(const uint8_t &v) { fifo_mem_bankid_sbe_=v; }
  ...
  bool read(
    ...
    *data |= ((ififo_overflow_ & 0x1) << 8);
    *data |= ((rdm_addr_hit_ & 0x1) << 9);
    *data |= ((rdm_addr_err_ & 0x1) << 10);
    *data |= ((fifo_mbe_ & 0x1) << 11);
    *data |= ((mit_mbe_ & 0x1) << 12);
    *data |= ((lit0_bm_mbe_ & 0x1) << 13);
    *data |= ((lit1_bm_mbe_ & 0x1) << 14);
    *data |= ((lit0_np_mbe_ & 0x1) << 15);
    *data |= ((lit1_np_mbe_ & 0x1) << 16);
    *data |= ((pmt0_mbe_ & 0x1) << 17);
    *data |= ((pmt1_mbe_ & 0x1) << 18);
    *data |= ((rdm_mbe_ & 0x1) << 19);
    *data |= ((fifo_mem_bankid_mbe_ & 0x1) << 20);
    *data |= ((fifo_sbe_ & 0x1) << 21);
    *data |= ((mit_sbe_ & 0x1) << 22);
    *data |= ((lit0_bm_sbe_ & 0x1) << 23);
    *data |= ((lit1_bm_sbe_ & 0x1) << 24);
    *data |= ((lit0_np_sbe_ & 0x1) << 25);
    *data |= ((lit1_np_sbe_ & 0x1) << 26);
    *data |= ((pmt0_sbe_ & 0x1) << 27);
    *data |= ((pmt1_sbe_ & 0x1) << 28);
    *data |= ((rdm_sbe_ & 0x1) << 29);
    *data |= ((fifo_mem_bankid_sbe_ & 0x1) << 30);
    return true;
  }
  ...
  bool write(
    ...
    ififo_overflow_ = ((data >> 8) & 0x1);
    rdm_addr_hit_ = ((data >> 9) & 0x1);
    rdm_addr_err_ = ((data >> 10) & 0x1);
    fifo_mbe_ = ((data >> 11) & 0x1);
    mit_mbe_ = ((data >> 12) & 0x1);
    lit0_bm_mbe_ = ((data >> 13) & 0x1);
    lit1_bm_mbe_ = ((data >> 14) & 0x1);
    lit0_np_mbe_ = ((data >> 15) & 0x1);
    lit1_np_mbe_ = ((data >> 16) & 0x1);
    pmt0_mbe_ = ((data >> 17) & 0x1);
    pmt1_mbe_ = ((data >> 18) & 0x1);
    rdm_mbe_ = ((data >> 19) & 0x1);
    fifo_mem_bankid_mbe_ = ((data >> 20) & 0x1);
    fifo_sbe_ = ((data >> 21) & 0x1);
    mit_sbe_ = ((data >> 22) & 0x1);
    lit0_bm_sbe_ = ((data >> 23) & 0x1);
    lit1_bm_sbe_ = ((data >> 24) & 0x1);
    lit0_np_sbe_ = ((data >> 25) & 0x1);
    lit1_np_sbe_ = ((data >> 26) & 0x1);
    pmt0_sbe_ = ((data >> 27) & 0x1);
    pmt1_sbe_ = ((data >> 28) & 0x1);
    rdm_sbe_ = ((data >> 29) & 0x1);
    fifo_mem_bankid_sbe_ = ((data >> 30) & 0x1);
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("TmPrePipeRspecIntrFreezeEnableMutable") + ":\n";
    ...
    r += indent_string + "  " + std::string("ififo_overflow") +  ": 0x" + boost::str( boost::format("%x") % static_cast<uint>(ififo_overflow_) ) + "\n";
    all_zeros &= (0 == ififo_overflow_);
    ...
    r += indent_string + "  " + std::string("fifo_mem_bankid_mbe") +  ": 0x" + boost::str( boost::format("%x") % static_cast<uint>(fifo_mem_bankid_mbe_) ) + "\n";
    all_zeros &= (0 == fifo_mem_bankid_mbe_);
    ...
    r += indent_string + "  " + std::string("fifo_mem_bankid_sbe") +  ": 0x" + boost::str( boost::format("%x") % static_cast<uint>(fifo_mem_bankid_sbe_) ) + "\n";
    all_zeros &= (0 == fifo_mem_bankid_sbe_);
...
private:
  static int StartOffset(
    ...
    offset += 0x70; // to get to intr_freeze_enable
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_TM_PRE_PIPE_RSPEC_INTR_FREEZE_ENABLE_MUTABLE_H__
