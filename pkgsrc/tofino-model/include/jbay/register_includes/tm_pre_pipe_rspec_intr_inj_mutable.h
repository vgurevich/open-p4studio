...
#ifndef __REGISTER_INCLUDES_TM_PRE_PIPE_RSPEC_INTR_INJ_MUTABLE_H__
#define __REGISTER_INCLUDES_TM_PRE_PIPE_RSPEC_INTR_INJ_MUTABLE_H__
...
class TmPrePipeRspecIntrInjMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  TmPrePipeRspecIntrInjMutable(
      int chipNumber, int index_tm_pre_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_pre_pipe_rspec), 4, true, write_callback, read_callback, std::string("TmPrePipeRspecIntrInjMutable")+":"+boost::lexical_cast<std::string>(index_tm_pre_pipe_rspec))
    {
    }
  TmPrePipeRspecIntrInjMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "TmPrePipeRspecIntrInjMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("TmPrePipeRspecIntrInjMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x6c; // to get to intr_inj
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_TM_PRE_PIPE_RSPEC_INTR_INJ_MUTABLE_H__
