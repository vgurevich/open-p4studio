...
#ifndef __REGISTER_INCLUDES_TM_PRE_PIPE_RSPEC_INTR_STAT_MUTABLE_H__
#define __REGISTER_INCLUDES_TM_PRE_PIPE_RSPEC_INTR_STAT_MUTABLE_H__
...
class TmPrePipeRspecIntrStatMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  TmPrePipeRspecIntrStatMutable(
      int chipNumber, int index_tm_pre_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_pre_pipe_rspec), 4, true, write_callback, read_callback, std::string("TmPrePipeRspecIntrStatMutable")+":"+boost::lexical_cast<std::string>(index_tm_pre_pipe_rspec))
    {
    }
  TmPrePipeRspecIntrStatMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "TmPrePipeRspecIntrStatMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("TmPrePipeRspecIntrStatMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x60; // to get to intr_stat
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_TM_PRE_PIPE_RSPEC_INTR_STAT_MUTABLE_H__
