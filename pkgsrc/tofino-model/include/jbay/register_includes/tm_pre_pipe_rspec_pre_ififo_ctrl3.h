...
#ifndef __REGISTER_INCLUDES_TM_PRE_PIPE_RSPEC_PRE_IFIFO_CTRL3_H__
#define __REGISTER_INCLUDES_TM_PRE_PIPE_RSPEC_PRE_IFIFO_CTRL3_H__
...
class TmPrePipeRspecPreIfifoCtrl3 : public model_core::RegisterBlock<RegisterCallback> {
public:
  TmPrePipeRspecPreIfifoCtrl3(
      int chipNumber, int index_tm_pre_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_pre_pipe_rspec), 4, false, write_callback, read_callback, std::string("TmPrePipeRspecPreIfifoCtrl3")+":"+boost::lexical_cast<std::string>(index_tm_pre_pipe_rspec))
    {
    }
  TmPrePipeRspecPreIfifoCtrl3(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "TmPrePipeRspecPreIfifoCtrl3")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("TmPrePipeRspecPreIfifoCtrl3") + ":\n";
...
#endif // __REGISTER_INCLUDES_TM_PRE_PIPE_RSPEC_PRE_IFIFO_CTRL3_H__
