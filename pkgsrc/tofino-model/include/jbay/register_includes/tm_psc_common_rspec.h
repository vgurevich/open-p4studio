...
#ifndef __REGISTER_INCLUDES_TM_PSC_COMMON_RSPEC_H__
#define __REGISTER_INCLUDES_TM_PSC_COMMON_RSPEC_H__
...
#include "psc_ba_blocks_freecnt_r.h"
#include "psc_bank_ctrl_r.h"
#include "psc_block_enable_r.h"
#include "psc_block_g.h"
#include "psc_block_linkmem_r.h"
#include "psc_block_ready_r.h"
#include "psc_block_reset_r.h"
#include "psc_block_valid_r.h"
#include "psc_ctrl_r.h"
#include "psc_epipe_g.h"
#include "psc_fa_full_threshold_r.h"
#include "psc_fa_hyst_threshold_r.h"
#include "psc_indir_access_addr_r.h"
#include "psc_psm_org_r.h"
#include "psc_timestamp_shift_r.h"
#include "psc_ts_offset_r.h"
#include "tm_psc_common_rspec_ecc.h"
#include "tm_psc_common_rspec_intr.h"
#include "tm_psc_common_rspec_linkmem_mbe_err_log.h"
#include "tm_psc_common_rspec_linkmem_sbe_err_log.h"
#include "tm_psc_common_rspec_overflow_err_log.h"
#include "tm_psc_common_rspec_underflow_err_log.h"

namespace jbay {
  namespace register_classes {

class TmPscCommonRspec : public model_core::RegisterBlock<RegisterCallback> {
public:
  TmPscCommonRspec(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 32768, false, write_callback, read_callback, std::string("TmPscCommonRspec"))
    {
    }
  TmPscCommonRspec(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "TmPscCommonRspec")
    {
    }
public:
  ...
  PscPsmOrgR &psm_org() { return psm_org_; }





  PscCtrlR &ctrl() { return ctrl_; }
  ...
  PscTimestampShiftR &timestamp_shift() { return timestamp_shift_; }
  ...
  PscFaFullThresholdR &full_threshold() { return full_threshold_; }
  ...
  PscFaHystThresholdR &hyst_threshold() { return hyst_threshold_; }
  ...
  PscTsOffsetR &ts_offset() { return ts_offset_; }
  ...
  PscBlockValidR &block_valid() { return block_valid_; }
  ...
  PscBlockResetR &block_reset() { return block_reset_; }
  ...
  PscBlockEnableR &block_enable() { return block_enable_; }
  ...
  PscBlockReadyR &block_ready() { return block_ready_; }
  ...
  PscBaBlocksFreecntR &blocks_freecnt() { return blocks_freecnt_; }
  ...
  PscBankCtrlR &psc_bank_ctrl_r(int j0) { return psc_bank_ctrl_r_[j0]; }
  ...
  PscIndirAccessAddrR &lmem_indir_access_addr() { return lmem_indir_access_addr_; }
  ...
  PscBlockLinkmemR &lmem_indir_access_data() { return lmem_indir_access_data_; }
  ...
  TmPscCommonRspecEcc &ecc() { return ecc_; }





  TmPscCommonRspecLinkmemSbeErrLog &linkmem_sbe_err_log() { return linkmem_sbe_err_log_; }





  TmPscCommonRspecLinkmemMbeErrLog &linkmem_mbe_err_log() { return linkmem_mbe_err_log_; }





  TmPscCommonRspecOverflowErrLog &overflow_err_log() { return overflow_err_log_; }





  TmPscCommonRspecUnderflowErrLog &underflow_err_log() { return underflow_err_log_; }
  ...
  PscEpipeG &epipe(int j0) { return epipe_[j0]; }
  ...
  PscBlockG &block(int j0) { return block_[j0]; }
  TmPscCommonRspecIntr &intr() { return intr_; }
  ...
  bool read(
    ...
    if (offset >= 0x10 && offset < 0x14) {
    ...
    else if (offset >= 0x130 && offset < 0x13c) {
      offset -= 0x130;
      if (read_callback_) read_callback_();
      ...
      offset  -= i0 * 0x4;
      if (read_callback_) read_callback_();
      psc_bank_ctrl_r_[ i0 ].read( offset, data );
    }
    else if (offset >= 0x1e00 && offset < 0x1e04) {
      offset -= 0x1e00;
      if (read_callback_) read_callback_();
      lmem_indir_access_addr_.read( offset, data );
    }
    else if (offset >= 0x1e04 && offset < 0x1e08) {
      offset -= 0x1e04;
      if (read_callback_) read_callback_();
      lmem_indir_access_data_.read( offset, data );
    }
    else if (offset >= 0x1e40 && offset < 0x1e70) {
      offset -= 0x1e40;
      if (read_callback_) read_callback_();
      ecc_.read( offset, data );
    }
    else if (offset >= 0x1e94 && offset < 0x1e98) {
      offset -= 0x1e94;
      if (read_callback_) read_callback_();
      linkmem_sbe_err_log_.read( offset, data );
    }
    else if (offset >= 0x1e98 && offset < 0x1e9c) {
      offset -= 0x1e98;
      if (read_callback_) read_callback_();
      linkmem_mbe_err_log_.read( offset, data );
    }
    else if (offset >= 0x1e9c && offset < 0x1ea0) {
      offset -= 0x1e9c;
      if (read_callback_) read_callback_();
      overflow_err_log_.read( offset, data );
    }
    else if (offset >= 0x1ea0 && offset < 0x1ea4) {
      offset -= 0x1ea0;
      if (read_callback_) read_callback_();
      underflow_err_log_.read( offset, data );
    }
    else if (offset >= 0x800 && offset < 0x860) {
      offset -= 0x800;
      int i0 = offset / 0x18;
      offset  -= i0 * 0x18;
      if (read_callback_) read_callback_();
    ...
    else if (offset >= 0x1e80 && offset < 0x1e94) {
      offset -= 0x1e80;
      if (read_callback_) read_callback_();
  ...
  bool write(
    ...
    if (offset >= 0x10 && offset < 0x14) {
      ...
      int i0 = offset / 0x4;
      offset  -= i0 * 0x4;
      psc_bank_ctrl_r_[ i0 ].write( offset, data );
      if (write_callback_) write_callback_();
    }
    else if (offset >= 0x1e00 && offset < 0x1e04) {
      offset -= 0x1e00;
  ...
  std::string to_string(
    ...
    if (offset >= 0x10 && offset < 0x14) {
      ...
      int i0 = offset / 0x4;
      offset  -= i0 * 0x4;
      r += psc_bank_ctrl_r_[ i0 ].to_string(offset,print_zeros,indent_string) ;
    }
    else if (offset >= 0x1e00 && offset < 0x1e04) {
      offset -= 0x1e00;
  ...
  std::string to_string(
    ...
    for (uint32_t a0=0;a0<384;++a0) {
      r += psc_bank_ctrl_r_[a0].to_string(print_zeros,indent_string) ;
    }
...
private:
  PscPsmOrgR psm_org_;
  PscCtrlR ctrl_;
  PscTimestampShiftR timestamp_shift_;
  PscFaFullThresholdR full_threshold_;
  PscFaHystThresholdR hyst_threshold_;
  PscTsOffsetR ts_offset_;
  PscBlockValidR block_valid_;
  PscBlockResetR block_reset_;
  PscBlockEnableR block_enable_;
  PscBlockReadyR block_ready_;
  PscBaBlocksFreecntR blocks_freecnt_;
  std::array< PscBankCtrlR, 384 > psc_bank_ctrl_r_;
  PscIndirAccessAddrR lmem_indir_access_addr_;
  PscBlockLinkmemR lmem_indir_access_data_;
  TmPscCommonRspecEcc ecc_;
  TmPscCommonRspecLinkmemSbeErrLog linkmem_sbe_err_log_;
  TmPscCommonRspecLinkmemMbeErrLog linkmem_mbe_err_log_;
  TmPscCommonRspecOverflowErrLog overflow_err_log_;
  TmPscCommonRspecUnderflowErrLog underflow_err_log_;
  std::array< PscEpipeG, 4 > epipe_;
  std::array< PscBlockG, 96 > block_;
  TmPscCommonRspecIntr intr_;
private:
...
#endif // __REGISTER_INCLUDES_TM_PSC_COMMON_RSPEC_H__
