...
#ifndef __REGISTER_INCLUDES_TM_PSC_COMMON_RSPEC_INTR_EN0_MUTABLE_H__
#define __REGISTER_INCLUDES_TM_PSC_COMMON_RSPEC_INTR_EN0_MUTABLE_H__
...
class TmPscCommonRspecIntrEn0Mutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  TmPscCommonRspecIntrEn0Mutable(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 4, true, write_callback, read_callback, std::string("TmPscCommonRspecIntrEn0Mutable"))
    {
    }
  TmPscCommonRspecIntrEn0Mutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "TmPscCommonRspecIntrEn0Mutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("TmPscCommonRspecIntrEn0Mutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x1e84; // to get to intr_en0
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_TM_PSC_COMMON_RSPEC_INTR_EN0_MUTABLE_H__
