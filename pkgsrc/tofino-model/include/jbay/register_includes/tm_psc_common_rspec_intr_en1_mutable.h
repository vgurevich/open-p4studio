...
#ifndef __REGISTER_INCLUDES_TM_PSC_COMMON_RSPEC_INTR_EN1_MUTABLE_H__
#define __REGISTER_INCLUDES_TM_PSC_COMMON_RSPEC_INTR_EN1_MUTABLE_H__
...
class TmPscCommonRspecIntrEn1Mutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  TmPscCommonRspecIntrEn1Mutable(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 4, true, write_callback, read_callback, std::string("TmPscCommonRspecIntrEn1Mutable"))
    {
    }
  TmPscCommonRspecIntrEn1Mutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "TmPscCommonRspecIntrEn1Mutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("TmPscCommonRspecIntrEn1Mutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x1e88; // to get to intr_en1
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_TM_PSC_COMMON_RSPEC_INTR_EN1_MUTABLE_H__
