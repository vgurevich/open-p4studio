...
#ifndef __REGISTER_INCLUDES_TM_PSC_COMMON_RSPEC_INTR_FREEZE_ENABLE_H__
#define __REGISTER_INCLUDES_TM_PSC_COMMON_RSPEC_INTR_FREEZE_ENABLE_H__
...
class TmPscCommonRspecIntrFreezeEnable : public model_core::RegisterBlock<RegisterCallback> {
public:
  TmPscCommonRspecIntrFreezeEnable(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 4, false, write_callback, read_callback, std::string("TmPscCommonRspecIntrFreezeEnable"))
    {
    }
  TmPscCommonRspecIntrFreezeEnable(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "TmPscCommonRspecIntrFreezeEnable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("TmPscCommonRspecIntrFreezeEnable") + ":\n";
...
#endif // __REGISTER_INCLUDES_TM_PSC_COMMON_RSPEC_INTR_FREEZE_ENABLE_H__
