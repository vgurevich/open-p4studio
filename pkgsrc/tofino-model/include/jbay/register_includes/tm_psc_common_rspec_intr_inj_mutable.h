...
#ifndef __REGISTER_INCLUDES_TM_PSC_COMMON_RSPEC_INTR_INJ_MUTABLE_H__
#define __REGISTER_INCLUDES_TM_PSC_COMMON_RSPEC_INTR_INJ_MUTABLE_H__
...
class TmPscCommonRspecIntrInjMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  TmPscCommonRspecIntrInjMutable(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 4, true, write_callback, read_callback, std::string("TmPscCommonRspecIntrInjMutable"))
    {
    }
  TmPscCommonRspecIntrInjMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "TmPscCommonRspecIntrInjMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("TmPscCommonRspecIntrInjMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x1e8c; // to get to intr_inj
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_TM_PSC_COMMON_RSPEC_INTR_INJ_MUTABLE_H__
