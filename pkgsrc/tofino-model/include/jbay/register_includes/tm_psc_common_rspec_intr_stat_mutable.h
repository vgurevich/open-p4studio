...
#ifndef __REGISTER_INCLUDES_TM_PSC_COMMON_RSPEC_INTR_STAT_MUTABLE_H__
#define __REGISTER_INCLUDES_TM_PSC_COMMON_RSPEC_INTR_STAT_MUTABLE_H__
...
class TmPscCommonRspecIntrStatMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  TmPscCommonRspecIntrStatMutable(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 4, true, write_callback, read_callback, std::string("TmPscCommonRspecIntrStatMutable"))
    {
    }
  TmPscCommonRspecIntrStatMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "TmPscCommonRspecIntrStatMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("TmPscCommonRspecIntrStatMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x1e80; // to get to intr_stat
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_TM_PSC_COMMON_RSPEC_INTR_STAT_MUTABLE_H__
