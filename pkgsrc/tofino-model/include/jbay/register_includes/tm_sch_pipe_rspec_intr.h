...
#include "tm_sch_pipe_rspec_intr_en0.h"
#include "tm_sch_pipe_rspec_intr_en1.h"
#include "tm_sch_pipe_rspec_intr_freeze_enable.h"
#include "tm_sch_pipe_rspec_intr_inj.h"
#include "tm_sch_pipe_rspec_intr_stat.h"
...
public:
  TmSchPipeRspecIntr(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_tm_top_rspec, index_tm_sch_pipe_rspec), 20, false, write_callback, read_callback, std::string("TmSchPipeRspecIntr")+":"+boost::lexical_cast<std::string>(selector_tm_top_rspec) + "," + boost::lexical_cast<std::string>(index_tm_sch_pipe_rspec))
    {
    }
  TmSchPipeRspecIntr(
...
public:
  ...
  TmSchPipeRspecIntrStat &intr_stat() { return intr_stat_; }
  ...
  TmSchPipeRspecIntrEn0 &intr_en0() { return intr_en0_; }
  ...
  TmSchPipeRspecIntrEn1 &intr_en1() { return intr_en1_; }
  ...
  TmSchPipeRspecIntrInj &intr_inj() { return intr_inj_; }
...
private:
  TmSchPipeRspecIntrStat intr_stat_;
  TmSchPipeRspecIntrEn0 intr_en0_;
  TmSchPipeRspecIntrEn1 intr_en1_;
  TmSchPipeRspecIntrInj intr_inj_;
