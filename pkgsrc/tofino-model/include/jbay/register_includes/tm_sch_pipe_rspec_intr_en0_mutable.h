...
#ifndef __REGISTER_INCLUDES_TM_SCH_PIPE_RSPEC_INTR_EN0_MUTABLE_H__
#define __REGISTER_INCLUDES_TM_SCH_PIPE_RSPEC_INTR_EN0_MUTABLE_H__
...
class TmSchPipeRspecIntrEn0Mutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum TmTopRspecEnum {
    kTmSchaTop,
    kTmSchbTop
...
public:
  TmSchPipeRspecIntrEn0Mutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_tm_top_rspec, index_tm_sch_pipe_rspec), 4, true, write_callback, read_callback, std::string("TmSchPipeRspecIntrEn0Mutable")+":"+boost::lexical_cast<std::string>(selector_tm_top_rspec) + "," + boost::lexical_cast<std::string>(index_tm_sch_pipe_rspec))
    {
    }
  TmSchPipeRspecIntrEn0Mutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "TmSchPipeRspecIntrEn0Mutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("TmSchPipeRspecIntrEn0Mutable") + ":\n";
  ...
  static int StartOffset(
    ...
    switch (selector_tm_top_rspec) {
      case kTmSchaTop:
        ...
        offset += 0x44; // to get to intr_en0
        break;
      case kTmSchbTop:
...
#endif // __REGISTER_INCLUDES_TM_SCH_PIPE_RSPEC_INTR_EN0_MUTABLE_H__
