...
#ifndef __REGISTER_INCLUDES_TM_SCH_PIPE_RSPEC_INTR_EN1_H__
#define __REGISTER_INCLUDES_TM_SCH_PIPE_RSPEC_INTR_EN1_H__
...
class TmSchPipeRspecIntrEn1 : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum TmTopRspecEnum {
    kTmSchaTop,
    kTmSchbTop
...
public:
  TmSchPipeRspecIntrEn1(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_tm_top_rspec, index_tm_sch_pipe_rspec), 4, false, write_callback, read_callback, std::string("TmSchPipeRspecIntrEn1")+":"+boost::lexical_cast<std::string>(selector_tm_top_rspec) + "," + boost::lexical_cast<std::string>(index_tm_sch_pipe_rspec))
    {
    }
  TmSchPipeRspecIntrEn1(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "TmSchPipeRspecIntrEn1")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("TmSchPipeRspecIntrEn1") + ":\n";
...
#endif // __REGISTER_INCLUDES_TM_SCH_PIPE_RSPEC_INTR_EN1_H__
