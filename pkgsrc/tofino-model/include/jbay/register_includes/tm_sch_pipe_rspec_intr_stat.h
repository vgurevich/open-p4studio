...
#ifndef __REGISTER_INCLUDES_TM_SCH_PIPE_RSPEC_INTR_STAT_H__
#define __REGISTER_INCLUDES_TM_SCH_PIPE_RSPEC_INTR_STAT_H__
...
class TmSchPipeRspecIntrStat : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum TmTopRspecEnum {
    kTmSchaTop,
    kTmSchbTop
...
public:
  TmSchPipeRspecIntrStat(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_tm_top_rspec, index_tm_sch_pipe_rspec), 4, false, write_callback, read_callback, std::string("TmSchPipeRspecIntrStat")+":"+boost::lexical_cast<std::string>(selector_tm_top_rspec) + "," + boost::lexical_cast<std::string>(index_tm_sch_pipe_rspec))
    {
    }
  TmSchPipeRspecIntrStat(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "TmSchPipeRspecIntrStat")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("TmSchPipeRspecIntrStat") + ":\n";
...
#endif // __REGISTER_INCLUDES_TM_SCH_PIPE_RSPEC_INTR_STAT_H__
