...
#include "tm_caa_top_rspec.h"
#include "tm_clc_top_rspec.h"
#include "tm_pex_top_rspec.h"
#include "tm_prc_top_rspec.h"
#include "tm_pre_top_rspec.h"
...
public:
  TmTopRspec(
    ...
    : RegisterBlock(chipNumber, StartOffset(), 5767168, false, write_callback, read_callback, std::string("TmTopRspec"))
    {
    }
  TmTopRspec(
...
public:
  ...
  TmCaaTopRspec &tm_caa_top() { return tm_caa_top_; }
  ...
  TmSchTopRspec &tm_scha_top() { return tm_scha_top_; }





  TmSchTopRspec &tm_schb_top() { return tm_schb_top_; }
  ...
  TmPexTopRspec &tm_pex_top() { return tm_pex_top_; }
  ...
  TmPreTopRspec &tm_pre_top() { return tm_pre_top_; }
...
private:
  ...
  TmCaaTopRspec tm_caa_top_;
  TmQacTopRspec tm_qac_top_;
  TmSchTopRspec tm_scha_top_;
  TmSchTopRspec tm_schb_top_;
  TmClcTopRspec tm_clc_top_;
  TmPexTopRspec tm_pex_top_;
  TmQlcTopRspec tm_qlc_top_;
  TmPrcTopRspec tm_prc_top_;
  TmPreTopRspec tm_pre_top_;
