...
#ifndef __REGISTER_INCLUDES_TV80_RSPEC_H__
#define __REGISTER_INCLUDES_TV80_RSPEC_H__
...
class Tv80Rspec : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum JbayRegEnum {
    kEth400gP1,
    kEth400gP10,
...
public:
  Tv80Rspec(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_jbay_reg), 16384, false, write_callback, read_callback, std::string("Tv80Rspec")+":"+boost::lexical_cast<std::string>(selector_jbay_reg))
    {
    }
  Tv80Rspec(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "Tv80Rspec")
    {
    }
public:
  ...
  Tv80RspecDummyRegister &dummy_register(int j0) { return dummy_register_[j0]; }
...
private:
  std::array< Tv80RspecDummyRegister, 4096 > dummy_register_;
private:
...
#endif // __REGISTER_INCLUDES_TV80_RSPEC_H__
