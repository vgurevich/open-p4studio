...
#ifndef __REGISTER_INCLUDES_TV80_RSPEC_DUMMY_REGISTER_ARRAY_MUTABLE_H__
#define __REGISTER_INCLUDES_TV80_RSPEC_DUMMY_REGISTER_ARRAY_MUTABLE_H__
...
#include "tv80_rspec_dummy_register_mutable.h"

namespace jbay {
  namespace register_classes {

class Tv80RspecDummyRegisterArrayMutable : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  enum JbayRegEnum {
    kEth400gP1,
    kEth400gP10,
...
public:
  Tv80RspecDummyRegisterArrayMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_jbay_reg), 4 * ArraySize(selector_jbay_reg, -1), true, write_callback, read_callback, std::string("Tv80RspecDummyRegisterArrayMutable")+":"+boost::lexical_cast<std::string>(selector_jbay_reg)),
...
public:
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("Tv80RspecDummyRegisterArrayMutable") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
private:
  std::vector<Tv80RspecDummyRegisterMutable> array;
  uint32_t size0_;
  ...
  static int StartOffset(
    ...
    switch (selector_jbay_reg) {
      case kEth400gP1:
        ...
        offset += 0x18000; // to get to eth400g_tv80
        break;
      case kEth400gP10:
...
#endif // __REGISTER_INCLUDES_TV80_RSPEC_DUMMY_REGISTER_ARRAY_MUTABLE_H__
