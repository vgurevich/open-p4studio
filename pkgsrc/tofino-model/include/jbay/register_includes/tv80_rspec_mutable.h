...
#ifndef __REGISTER_INCLUDES_TV80_RSPEC_MUTABLE_H__
#define __REGISTER_INCLUDES_TV80_RSPEC_MUTABLE_H__
...
class Tv80RspecMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum JbayRegEnum {
    kEth400gP1,
    kEth400gP10,
...
public:
  Tv80RspecMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_jbay_reg), 16384, true, write_callback, read_callback, std::string("Tv80RspecMutable")+":"+boost::lexical_cast<std::string>(selector_jbay_reg))
    {
    }
  Tv80RspecMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "Tv80RspecMutable")
    {
    }
public:
  ...
  Tv80RspecDummyRegisterMutable &dummy_register(int j0) { return dummy_register_[j0]; }
...
private:
  std::array< Tv80RspecDummyRegisterMutable, 4096 > dummy_register_;
private:
...
#endif // __REGISTER_INCLUDES_TV80_RSPEC_MUTABLE_H__
