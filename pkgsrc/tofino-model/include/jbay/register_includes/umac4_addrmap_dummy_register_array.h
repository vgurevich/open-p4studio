...
#ifndef __REGISTER_INCLUDES_UMAC4_ADDRMAP_DUMMY_REGISTER_ARRAY_H__
#define __REGISTER_INCLUDES_UMAC4_ADDRMAP_DUMMY_REGISTER_ARRAY_H__
...
class Umac4AddrmapDummyRegisterArray : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  enum JbayRegEnum {
    kEth400gP1,
    kEth400gP10,
...
public:
  Umac4AddrmapDummyRegisterArray(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_jbay_reg), 4 * ArraySize(selector_jbay_reg, -1), false, write_callback, read_callback, std::string("Umac4AddrmapDummyRegisterArray")+":"+boost::lexical_cast<std::string>(selector_jbay_reg)),
...
public:
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("Umac4AddrmapDummyRegisterArray") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
private:
  std::vector<Umac4AddrmapDummyRegister> array;
  uint32_t size0_;
...
#endif // __REGISTER_INCLUDES_UMAC4_ADDRMAP_DUMMY_REGISTER_ARRAY_H__
