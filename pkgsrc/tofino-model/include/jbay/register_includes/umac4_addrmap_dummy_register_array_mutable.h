...
#ifndef __REGISTER_INCLUDES_UMAC4_ADDRMAP_DUMMY_REGISTER_ARRAY_MUTABLE_H__
#define __REGISTER_INCLUDES_UMAC4_ADDRMAP_DUMMY_REGISTER_ARRAY_MUTABLE_H__
...
#include "umac4_addrmap_dummy_register_mutable.h"

namespace jbay {
  namespace register_classes {

class Umac4AddrmapDummyRegisterArrayMutable : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  enum JbayRegEnum {
    kEth400gP1,
    kEth400gP10,
...
public:
  Umac4AddrmapDummyRegisterArrayMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_jbay_reg), 4 * ArraySize(selector_jbay_reg, -1), true, write_callback, read_callback, std::string("Umac4AddrmapDummyRegisterArrayMutable")+":"+boost::lexical_cast<std::string>(selector_jbay_reg)),
...
public:
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("Umac4AddrmapDummyRegisterArrayMutable") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
private:
  std::vector<Umac4AddrmapDummyRegisterMutable> array;
  uint32_t size0_;
...
#endif // __REGISTER_INCLUDES_UMAC4_ADDRMAP_DUMMY_REGISTER_ARRAY_MUTABLE_H__
