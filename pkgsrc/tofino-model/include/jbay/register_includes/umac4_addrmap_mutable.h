...
#ifndef __REGISTER_INCLUDES_UMAC4_ADDRMAP_MUTABLE_H__
#define __REGISTER_INCLUDES_UMAC4_ADDRMAP_MUTABLE_H__
...
class Umac4AddrmapMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum JbayRegEnum {
    kEth400gP1,
    kEth400gP10,
...
public:
  Umac4AddrmapMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_jbay_reg), 65536, true, write_callback, read_callback, std::string("Umac4AddrmapMutable")+":"+boost::lexical_cast<std::string>(selector_jbay_reg))
    {
    }
  Umac4AddrmapMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "Umac4AddrmapMutable")
    {
    }
public:
  ...
  Umac4AddrmapDummyRegisterMutable &dummy_register(int j0) { return dummy_register_[j0]; }
...
private:
  std::array< Umac4AddrmapDummyRegisterMutable, 16384 > dummy_register_;
private:
...
#endif // __REGISTER_INCLUDES_UMAC4_ADDRMAP_MUTABLE_H__
