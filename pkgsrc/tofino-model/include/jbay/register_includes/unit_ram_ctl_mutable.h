...
#ifndef __REGISTER_INCLUDES_UNIT_RAM_CTL_MUTABLE_H__
#define __REGISTER_INCLUDES_UNIT_RAM_CTL_MUTABLE_H__
...
class UnitRamCtlMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  UnitRamCtlMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap, index_mau_unit_ram_row_addrmap, index_mau_unit_ram_addrmap), 4, true, write_callback, read_callback, std::string("UnitRamCtlMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_unit_ram_row_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_unit_ram_addrmap))
    {
    }
  UnitRamCtlMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "UnitRamCtlMutable")
    {
    }
public:
  ...
  void match_ram_write_data_mux_select(const uint8_t &v) { match_ram_write_data_mux_select_=v; }
  ...
  void match_ram_read_data_mux_select(const uint8_t &v) { match_ram_read_data_mux_select_=v; }


  uint8_t match_ram_matchdata_bus1_sel() { return match_ram_matchdata_bus1_sel_; }
  void match_ram_matchdata_bus1_sel(const uint8_t &v) { match_ram_matchdata_bus1_sel_=v; }
  ...
  void match_result_bus_select(const uint8_t &v) { match_result_bus_select_=v; }
  ...
  void tind_result_bus_select(const uint8_t &v) { tind_result_bus_select_=v; }




  uint8_t match_entry_enable() { return match_entry_enable_; }
  void match_entry_enable(const uint8_t &v) { match_entry_enable_=v; }



  uint8_t match_ram_logical_table() { return match_ram_logical_table_; }
  void match_ram_logical_table(const uint8_t &v) { match_ram_logical_table_=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("UnitRamCtlMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_UNIT_RAM_CTL_MUTABLE_H__
