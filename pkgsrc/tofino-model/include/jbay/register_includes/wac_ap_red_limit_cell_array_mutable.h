...
#ifndef __REGISTER_INCLUDES_WAC_AP_RED_LIMIT_CELL_ARRAY_MUTABLE_H__
#define __REGISTER_INCLUDES_WAC_AP_RED_LIMIT_CELL_ARRAY_MUTABLE_H__
...
class WacApRedLimitCellArrayMutable : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  WacApRedLimitCellArrayMutable(
      int chipNumber, RegisterArrayCallback& write_callback = 0, RegisterArrayCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 4 * ArraySize(-1), true, write_callback, read_callback, std::string("WacApRedLimitCellArrayMutable")),
...
public:
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("WacApRedLimitCellArrayMutable") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
private:
  std::vector<WacApRedLimitCellMutable> array;
  uint32_t size0_;
...
#endif // __REGISTER_INCLUDES_WAC_AP_RED_LIMIT_CELL_ARRAY_MUTABLE_H__
