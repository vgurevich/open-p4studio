...
#ifndef __REGISTER_INCLUDES_WAC_CNT48_ARRAY_H__
#define __REGISTER_INCLUDES_WAC_CNT48_ARRAY_H__
...
class WacCnt48Array : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  WacCnt48Array(
      int chipNumber, RegisterArrayCallback& write_callback = 0, RegisterArrayCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 8 * ArraySize(-1), false, write_callback, read_callback, std::string("WacCnt48Array")),
...
public:
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("WacCnt48Array") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
#endif // __REGISTER_INCLUDES_WAC_CNT48_ARRAY_H__
