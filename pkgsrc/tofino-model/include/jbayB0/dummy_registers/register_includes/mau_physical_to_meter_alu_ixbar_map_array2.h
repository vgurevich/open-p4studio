...
// Generated using:
//    ./tools/make_dummy_register.py --out_dir include/jbayB0/dummy_registers/register_includes include/tofino/register_includes/mau_physical_to_meter_alu_ixbar_map_array2.h

#ifndef __REGISTER_INCLUDES_MAU_PHYSICAL_TO_METER_ALU_IXBAR_MAP_ARRAY2_H__
#define __REGISTER_INCLUDES_MAU_PHYSICAL_TO_METER_ALU_IXBAR_MAP_ARRAY2_H__
...
class MauPhysicalToMeterAluIxbarMapArray2 : public model_core::DummyRegisterBlock<RegisterArrayCallback2> {
public:
  MauPhysicalToMeterAluIxbarMapArray2(
...
public:
  ...
  std::string to_string(
    ...
    std::string r_s = "";
    if (! r_s.empty()) {
      r += indent_string + std::string("MauPhysicalToMeterAluIxbarMapArray2") + "["+boost::lexical_cast<std::string>(a1)+"]"+"["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
#endif // __REGISTER_INCLUDES_MAU_PHYSICAL_TO_METER_ALU_IXBAR_MAP_ARRAY2_H__
