...
#ifndef __REGISTER_INCLUDES_MIR_BUF_REGS_COAL_CTRL1_H__
#define __REGISTER_INCLUDES_MIR_BUF_REGS_COAL_CTRL1_H__
...
class MirBufRegsCoalCtrl1 : public model_core::RegisterBlock<RegisterCallback> {
public:
  MirBufRegsCoalCtrl1(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mir_buf_regs_coal_desc_grp), 4, false, write_callback, read_callback, std::string("MirBufRegsCoalCtrl1")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mir_buf_regs_coal_desc_grp))
    {
    }
  MirBufRegsCoalCtrl1(

  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "MirBufRegsCoalCtrl1")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("MirBufRegsCoalCtrl1") + ":\n";
...
#endif // __REGISTER_INCLUDES_MIR_BUF_REGS_COAL_CTRL1_H__
