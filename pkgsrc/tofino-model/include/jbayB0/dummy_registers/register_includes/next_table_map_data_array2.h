...
// Generated using:
//    ./tools/make_dummy_register.py --out_dir include/jbayB0/dummy_registers/register_includes include/tofino/register_includes/next_table_map_data_array2.h

#ifndef __REGISTER_INCLUDES_NEXT_TABLE_MAP_DATA_ARRAY2_H__
#define __REGISTER_INCLUDES_NEXT_TABLE_MAP_DATA_ARRAY2_H__
...
class NextTableMapDataArray2 : public model_core::DummyRegisterBlock<RegisterArrayCallback2> {
public:
  NextTableMapDataArray2(
...
public:
  uint8_t next_table_map_data0(uint32_t a1,uint32_t a0)
  {
    CheckArrayBounds(a1,real_size1_,size1_,0,1,false);
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    return 0;
  }
  uint8_t next_table_map_data1(uint32_t a1,uint32_t a0)
  {
    CheckArrayBounds(a1,real_size1_,size1_,0,1,false);
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    return 0;
  }
  uint8_t next_table_map_data2(uint32_t a1,uint32_t a0)
  {
    CheckArrayBounds(a1,real_size1_,size1_,0,1,false);
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    return 0;
  }
  uint8_t next_table_map_data3(uint32_t a1,uint32_t a0)
  {
    CheckArrayBounds(a1,real_size1_,size1_,0,1,false);
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    return 0;
  ...
  std::string to_string(
    ...
    std::string r_s = "";
    if (! r_s.empty()) {
      r += indent_string + std::string("NextTableMapDataArray2") + "["+boost::lexical_cast<std::string>(a1)+"]"+"["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
#endif // __REGISTER_INCLUDES_NEXT_TABLE_MAP_DATA_ARRAY2_H__
