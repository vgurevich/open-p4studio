...
// Generated using:
//    ./tools/make_dummy_register.py --chip_name=jbayB0 include/tofino/register_includes/pre_int_stat_mutable.h
...
class PreIntStatMutable : public model_core::DummyRegisterBlock<RegisterCallback> {
public:
  PreIntStatMutable(
...
public:
  ...
  uint8_t fifo_ready() { assert(0); return 0; }
  void fifo_ready(const uint8_t &v) { assert(0); }
  ...
  uint8_t rdm_change_done() { assert(0); return 0; }
  void rdm_change_done(const uint8_t &v) { assert(0); }





  uint8_t table0_ph_count_zero() { assert(0); return 0; }
  void table0_ph_count_zero(const uint8_t &v) { assert(0); }





  uint8_t table1_ph_count_zero() { assert(0); return 0; }
  void table1_ph_count_zero(const uint8_t &v) { assert(0); }





  uint8_t max_l1_nodes() { assert(0); return 0; }
  void max_l1_nodes(const uint8_t &v) { assert(0); }





  uint8_t max_l2_nodes() { assert(0); return 0; }
  void max_l2_nodes(const uint8_t &v) { assert(0); }





  uint8_t illegal_l1_node() { assert(0); return 0; }
  void illegal_l1_node(const uint8_t &v) { assert(0); }





  uint8_t illegal_l2_node() { assert(0); return 0; }
  void illegal_l2_node(const uint8_t &v) { assert(0); }





  uint8_t fifo0_overflow() { assert(0); return 0; }
  void fifo0_overflow(const uint8_t &v) { assert(0); }





  uint8_t fifo1_overflow() { assert(0); return 0; }
  void fifo1_overflow(const uint8_t &v) { assert(0); }





  uint8_t fifo2_overflow() { assert(0); return 0; }
  void fifo2_overflow(const uint8_t &v) { assert(0); }





  uint8_t fifo3_overflow() { assert(0); return 0; }
  void fifo3_overflow(const uint8_t &v) { assert(0); }





  uint8_t rdm_addr_hit() { assert(0); return 0; }
  void rdm_addr_hit(const uint8_t &v) { assert(0); }





  uint8_t rdm_addr_err() { assert(0); return 0; }
  void rdm_addr_err(const uint8_t &v) { assert(0); }





  uint8_t fifo_mbe() { assert(0); return 0; }
  void fifo_mbe(const uint8_t &v) { assert(0); }





  uint8_t mit_mbe() { assert(0); return 0; }
  void mit_mbe(const uint8_t &v) { assert(0); }





  uint8_t lit0_bm_mbe() { assert(0); return 0; }
  void lit0_bm_mbe(const uint8_t &v) { assert(0); }





  uint8_t lit1_bm_mbe() { assert(0); return 0; }
  void lit1_bm_mbe(const uint8_t &v) { assert(0); }





  uint8_t lit0_np_mbe() { assert(0); return 0; }
  void lit0_np_mbe(const uint8_t &v) { assert(0); }





  uint8_t lit1_np_mbe() { assert(0); return 0; }
  void lit1_np_mbe(const uint8_t &v) { assert(0); }





  uint8_t pmt0_mbe() { assert(0); return 0; }
  void pmt0_mbe(const uint8_t &v) { assert(0); }





  uint8_t pmt1_mbe() { assert(0); return 0; }
  void pmt1_mbe(const uint8_t &v) { assert(0); }





  uint8_t rdm_mbe() { assert(0); return 0; }
  void rdm_mbe(const uint8_t &v) { assert(0); }





  uint8_t fifo_sbe() { assert(0); return 0; }
  void fifo_sbe(const uint8_t &v) { assert(0); }





  uint8_t mit_sbe() { assert(0); return 0; }
  void mit_sbe(const uint8_t &v) { assert(0); }





  uint8_t lit0_bm_sbe() { assert(0); return 0; }
  void lit0_bm_sbe(const uint8_t &v) { assert(0); }





  uint8_t lit1_bm_sbe() { assert(0); return 0; }
  void lit1_bm_sbe(const uint8_t &v) { assert(0); }





  uint8_t lit0_np_sbe() { assert(0); return 0; }
  void lit0_np_sbe(const uint8_t &v) { assert(0); }





  uint8_t lit1_np_sbe() { assert(0); return 0; }
  void lit1_np_sbe(const uint8_t &v) { assert(0); }





  uint8_t pmt0_sbe() { assert(0); return 0; }
  void pmt0_sbe(const uint8_t &v) { assert(0); }





  uint8_t pmt1_sbe() { assert(0); return 0; }
  void pmt1_sbe(const uint8_t &v) { assert(0); }





  uint8_t rdm_sbe() { assert(0); return 0; }
  void rdm_sbe(const uint8_t &v) { assert(0); }
