...
public:
  CaaCdmIndirAccessDataRMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_tm_caa_top_rspec), 88, true, write_callback, read_callback, std::string("CaaCdmIndirAccessDataRMutable")+":"+boost::lexical_cast<std::string>(selector_tm_caa_top_rspec))
    {
    }
  CaaCdmIndirAccessDataRMutable(
