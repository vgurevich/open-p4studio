...
#ifndef __REGISTER_INCLUDES_CBUS_CTRL_MUTABLE_H__
#define __REGISTER_INCLUDES_CBUS_CTRL_MUTABLE_H__
...
class CbusCtrlMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  CbusCtrlMutable(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 4, true, write_callback, read_callback, std::string("CbusCtrlMutable"))
    {
    }
  CbusCtrlMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "CbusCtrlMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("CbusCtrlMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_CBUS_CTRL_MUTABLE_H__
