...
#ifndef __REGISTER_INCLUDES_CBUS_DMA_LOG_H__
#define __REGISTER_INCLUDES_CBUS_DMA_LOG_H__
...
class CbusDmaLog : public model_core::RegisterBlock<RegisterCallback> {
public:
  CbusDmaLog(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 12, false, write_callback, read_callback, std::string("CbusDmaLog"))
    {
    }
  CbusDmaLog(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "CbusDmaLog")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("CbusDmaLog") + ":\n";
...
#endif // __REGISTER_INCLUDES_CBUS_DMA_LOG_H__
