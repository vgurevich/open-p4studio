...
#ifndef __REGISTER_INCLUDES_CBUS_RB_CREQ_CREDIT_H__
#define __REGISTER_INCLUDES_CBUS_RB_CREQ_CREDIT_H__
...
class CbusRbCreqCredit : public model_core::RegisterBlock<RegisterCallback> {
public:
  CbusRbCreqCredit(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 12, false, write_callback, read_callback, std::string("CbusRbCreqCredit"))
    {
    }
  CbusRbCreqCredit(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "CbusRbCreqCredit")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("CbusRbCreqCredit") + ":\n";
...
#endif // __REGISTER_INCLUDES_CBUS_RB_CREQ_CREDIT_H__
