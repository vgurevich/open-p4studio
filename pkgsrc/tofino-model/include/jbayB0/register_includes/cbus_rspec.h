...
#include "cbus_ctrl.h"
#include "cbus_dma_log.h"
#include "cbus_flush.h"
#include "cbus_freeze_en0.h"
#include "cbus_freeze_en1.h"
#include "cbus_host_creq_credit.h"
#include "cbus_host_slv_credit.h"
#include "cbus_int_en0_0.h"
#include "cbus_int_en0_1.h"
#include "cbus_int_en0_2.h"
#include "cbus_int_en0_3.h"
#include "cbus_int_en1_0.h"
#include "cbus_int_en1_1.h"
#include "cbus_int_en1_2.h"
#include "cbus_int_en1_3.h"
#include "cbus_int_inj.h"
#include "cbus_int_stat0.h"
#include "cbus_int_stat1.h"
#include "cbus_link_down.h"
#include "cbus_lq_fm_dr_rd_err_log.h"
#include "cbus_lq_slot_credit.h"
#include "cbus_mst_ctrl_log.h"
#include "cbus_parity_err_log.h"
#include "cbus_pri_ctrl.h"
#include "cbus_rb_creq_credit.h"
#include "cbus_rb_tx_dr_rd_err_log.h"
...
public:
  CbusRspec(
    ...
    : RegisterBlock(chipNumber, StartOffset(), 240, false, write_callback, read_callback, std::string("CbusRspec"))
    {
    }
  CbusRspec(
...
public:
  ...
  CbusLinkDown &link_down() { return link_down_; }
  ...
  CbusIntStat0 &intr_stat0() { return intr_stat0_; }





  CbusIntStat1 &intr_stat1() { return intr_stat1_; }





  CbusIntEn0_0 &intr_en0_0() { return intr_en0_0_; }





  CbusIntEn0_1 &intr_en0_1() { return intr_en0_1_; }





  CbusIntEn0_2 &intr_en0_2() { return intr_en0_2_; }





  CbusIntEn0_3 &intr_en0_3() { return intr_en0_3_; }





  CbusIntEn1_0 &intr_en1_0() { return intr_en1_0_; }





  CbusIntEn1_1 &intr_en1_1() { return intr_en1_1_; }





  CbusIntEn1_2 &intr_en1_2() { return intr_en1_2_; }





  CbusIntEn1_3 &intr_en1_3() { return intr_en1_3_; }





  CbusFreezeEn0 &freeze_en0() { return freeze_en0_; }





  CbusFreezeEn1 &freeze_en1() { return freeze_en1_; }





  CbusIntInj &intr_inj() { return intr_inj_; }
  ...
  CbusWlTxDrRdErrLog &wl_tx_dr_rd_err_log(int j0) { return wl_tx_dr_rd_err_log_[j0]; }
  ...
  CbusRbTxDrRdErrLog &rb_tx_dr_rd_err_log(int j0) { return rb_tx_dr_rd_err_log_[j0]; }
  ...
  CbusRbCreqCredit &rb_creq_credit() { return rb_creq_credit_; }
  ...
  CbusDmaLog &dma_log() { return dma_log_; }





  CbusMstCtrlLog &mst_ctrl_log() { return mst_ctrl_log_; }
...
private:
  CbusCtrl ctrl_;
  CbusFlush flush_;
  CbusLinkDown link_down_;
  CbusArbCtrl arb_ctrl_;
  CbusPriCtrl pri_ctrl_;
  CbusIntStat0 intr_stat0_;
  CbusIntStat1 intr_stat1_;
  CbusIntEn0_0 intr_en0_0_;
  CbusIntEn0_1 intr_en0_1_;
  CbusIntEn0_2 intr_en0_2_;
  CbusIntEn0_3 intr_en0_3_;
  CbusIntEn1_0 intr_en1_0_;
  CbusIntEn1_1 intr_en1_1_;
  CbusIntEn1_2 intr_en1_2_;
  CbusIntEn1_3 intr_en1_3_;
  CbusFreezeEn0 freeze_en0_;
  CbusFreezeEn1 freeze_en1_;
  CbusIntInj intr_inj_;
  std::array< CbusWlTxDrRdErrLog, 2 > wl_tx_dr_rd_err_log_;
  std::array< CbusRbTxDrRdErrLog, 2 > rb_tx_dr_rd_err_log_;
  CbusLqFmDrRdErrLog lq_fm_dr_rd_err_log_;
  CbusControllerMbeLog controller_mbe_log_;
  CbusControllerSbeLog controller_sbe_log_;
  std::array< CbusParityErrLog, 7 > parity_err_log_;
  CbusHostCreqCredit host_creq_credit_;
  CbusWlCreqCredit wl_creq_credit_;
  CbusRbCreqCredit rb_creq_credit_;
  CbusLqSlotCredit lq_slot_credit_;
  CbusHostSlvCredit host_slave_credit_;
  CbusDmaLog dma_log_;
  CbusMstCtrlLog mst_ctrl_log_;
private:
