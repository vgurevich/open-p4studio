...
#ifndef __REGISTER_INCLUDES_CBUS_WL_CREQ_CREDIT_H__
#define __REGISTER_INCLUDES_CBUS_WL_CREQ_CREDIT_H__
...
class CbusWlCreqCredit : public model_core::RegisterBlock<RegisterCallback> {
public:
  CbusWlCreqCredit(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 12, false, write_callback, read_callback, std::string("CbusWlCreqCredit"))
    {
    }
  CbusWlCreqCredit(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "CbusWlCreqCredit")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("CbusWlCreqCredit") + ":\n";
...
#endif // __REGISTER_INCLUDES_CBUS_WL_CREQ_CREDIT_H__
