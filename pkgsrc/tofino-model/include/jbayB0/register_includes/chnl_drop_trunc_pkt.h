...
#ifndef __REGISTER_INCLUDES_CHNL_DROP_TRUNC_PKT_H__
#define __REGISTER_INCLUDES_CHNL_DROP_TRUNC_PKT_H__
...
class ChnlDropTruncPkt : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum IpbRspecEnum {
    kChan0Group,
    kChan1Group,
...
public:
  ChnlDropTruncPkt(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_ipb_prsr4_reg, selector_ipb_rspec), 8, false, write_callback, read_callback, std::string("ChnlDropTruncPkt")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_ipb_prsr4_reg) + "," + boost::lexical_cast<std::string>(selector_ipb_rspec))
    {
    }
  ChnlDropTruncPkt(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "ChnlDropTruncPkt")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("ChnlDropTruncPkt") + ":\n";
...
#endif // __REGISTER_INCLUDES_CHNL_DROP_TRUNC_PKT_H__
