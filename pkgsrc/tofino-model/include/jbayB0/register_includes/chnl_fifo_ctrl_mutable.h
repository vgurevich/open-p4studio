...
#ifndef __REGISTER_INCLUDES_CHNL_FIFO_CTRL_MUTABLE_H__
#define __REGISTER_INCLUDES_CHNL_FIFO_CTRL_MUTABLE_H__
...
class ChnlFifoCtrlMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum IpbRspecEnum {
    kChan0Group,
    kChan1Group,
...
public:
  ChnlFifoCtrlMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_ipb_prsr4_reg, selector_ipb_rspec), 12, true, write_callback, read_callback, std::string("ChnlFifoCtrlMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_ipb_prsr4_reg) + "," + boost::lexical_cast<std::string>(selector_ipb_rspec))
    {
    }
  ChnlFifoCtrlMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "ChnlFifoCtrlMutable")
    {
    }
public:
  ...
  void pkt_fifo_start(const uint16_t &v) { pkt_fifo_start_=v; }
  ...
  void pkt_fifo_end(const uint16_t &v) { pkt_fifo_end_=v; }
  ...
  void pkt_fifo_size(const uint16_t &v) { pkt_fifo_size_=v; }
  ...
  void dprsr_barrel_fifo_start(const uint8_t &v) { dprsr_barrel_fifo_start_=v; }
  ...
  void dprsr_barrel_fifo_end(const uint8_t &v) { dprsr_barrel_fifo_end_=v; }
  ...
  void lat_fifo_alm_full_off(const uint16_t &v) { lat_fifo_alm_full_off_=v; }
  ...
  void ppc_fifo_alm_full_off(const uint16_t &v) { ppc_fifo_alm_full_off_=v; }
  ...
  void dppc_fifo_alm_full_off(const uint16_t &v) { dppc_fifo_alm_full_off_=v; }
  ...
  void meta_fifo_alm_full_off(const uint16_t &v) { meta_fifo_alm_full_off_=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("ChnlFifoCtrlMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_CHNL_FIFO_CTRL_MUTABLE_H__
