...
#ifndef __REGISTER_INCLUDES_CHNL_META_MUTABLE_H__
#define __REGISTER_INCLUDES_CHNL_META_MUTABLE_H__
...
class ChnlMetaMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum IpbRspecEnum {
    kChan0Group,
    kChan1Group,
...
public:
  ChnlMetaMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_ipb_prsr4_reg, selector_ipb_rspec), 16, true, write_callback, read_callback, std::string("ChnlMetaMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_ipb_prsr4_reg) + "," + boost::lexical_cast<std::string>(selector_ipb_rspec))
    {
    }
  ChnlMetaMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "ChnlMetaMutable")
    {
    }
public:
  ...
  void meta1_0(const uint32_t &v) { meta1_0_=v; }
  ...
  void meta1_1(const uint32_t &v) { meta1_1_=v; }
  ...
  void meta1_2(const uint32_t &v) { meta1_2_=v; }
  ...
  void meta1_3(const uint32_t &v) { meta1_3_=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("ChnlMetaMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_CHNL_META_MUTABLE_H__
