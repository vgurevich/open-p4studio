...
#ifndef __REGISTER_INCLUDES_DEF_METER_SBE_ERRLOG_H__
#define __REGISTER_INCLUDES_DEF_METER_SBE_ERRLOG_H__
...
class DefMeterSbeErrlog : public model_core::RegisterBlock<RegisterCallback> {
public:
  DefMeterSbeErrlog(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap, index_def_meter_sbe_errlog), 4, false, write_callback, read_callback, std::string("DefMeterSbeErrlog")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap) + "," + boost::lexical_cast<std::string>(index_def_meter_sbe_errlog))
    {
    }
  DefMeterSbeErrlog(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "DefMeterSbeErrlog")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("DefMeterSbeErrlog") + ":\n";
...
#endif // __REGISTER_INCLUDES_DEF_METER_SBE_ERRLOG_H__
