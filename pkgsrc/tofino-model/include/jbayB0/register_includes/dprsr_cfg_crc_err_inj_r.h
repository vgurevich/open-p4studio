...
#ifndef __REGISTER_INCLUDES_DPRSR_CFG_CRC_ERR_INJ_R_H__
#define __REGISTER_INCLUDES_DPRSR_CFG_CRC_ERR_INJ_R_H__
...
class DprsrCfgCrcErrInjR : public model_core::RegisterBlock<RegisterCallback> {
public:
...
public:
  DprsrCfgCrcErrInjR(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, selector_dprsr_reg_rspec, index_dprsr_ho_e), 4, false, write_callback, read_callback, std::string("DprsrCfgCrcErrInjR")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(selector_dprsr_reg_rspec) + "," + boost::lexical_cast<std::string>(index_dprsr_ho_e))
    {
    }
  DprsrCfgCrcErrInjR(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "DprsrCfgCrcErrInjR")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("DprsrCfgCrcErrInjR") + ":\n";
...
#endif // __REGISTER_INCLUDES_DPRSR_CFG_CRC_ERR_INJ_R_H__
