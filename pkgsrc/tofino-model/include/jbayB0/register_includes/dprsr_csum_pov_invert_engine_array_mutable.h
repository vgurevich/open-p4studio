...
#ifndef __REGISTER_INCLUDES_DPRSR_CSUM_POV_INVERT_ENGINE_ARRAY_MUTABLE_H__
#define __REGISTER_INCLUDES_DPRSR_CSUM_POV_INVERT_ENGINE_ARRAY_MUTABLE_H__
...
class DprsrCsumPovInvertEngineArrayMutable : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  DprsrCsumPovInvertEngineArrayMutable(
      int chipNumber, int index_pipe_addrmap, RegisterArrayCallback& write_callback = 0, RegisterArrayCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 4 * ArraySize(index_pipe_addrmap, -1), true, write_callback, read_callback, std::string("DprsrCsumPovInvertEngineArrayMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap)),
...
public:
  ...
  void mask(uint32_t a0,const uint32_t &v) 
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    array[a0].mask(v);
  }
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("DprsrCsumPovInvertEngineArrayMutable") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
private:
  std::vector<DprsrCsumPovInvertEngineMutable> array;
  uint32_t size0_;
...
#endif // __REGISTER_INCLUDES_DPRSR_CSUM_POV_INVERT_ENGINE_ARRAY_MUTABLE_H__
