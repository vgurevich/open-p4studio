...
#ifndef __REGISTER_INCLUDES_DPRSR_HDR_XBAR_CONST_DEFS_R_MUTABLE_H__
#define __REGISTER_INCLUDES_DPRSR_HDR_XBAR_CONST_DEFS_R_MUTABLE_H__
...
class DprsrHdrXbarConstDefsRMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
...
public:
  DprsrHdrXbarConstDefsRMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, selector_dprsr_reg_rspec, index_dprsr_ho_e), 8, true, write_callback, read_callback, std::string("DprsrHdrXbarConstDefsRMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(selector_dprsr_reg_rspec) + "," + boost::lexical_cast<std::string>(index_dprsr_ho_e))
    {
    }
  DprsrHdrXbarConstDefsRMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "DprsrHdrXbarConstDefsRMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("DprsrHdrXbarConstDefsRMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_DPRSR_HDR_XBAR_CONST_DEFS_R_MUTABLE_H__
