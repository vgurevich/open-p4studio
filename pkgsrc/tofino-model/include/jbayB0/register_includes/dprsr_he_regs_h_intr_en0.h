...
#ifndef __REGISTER_INCLUDES_DPRSR_HE_REGS_H_INTR_EN0_H__
#define __REGISTER_INCLUDES_DPRSR_HE_REGS_H_INTR_EN0_H__
...
class DprsrHeRegsHIntrEn0 : public model_core::RegisterBlock<RegisterCallback> {
public:
  DprsrHeRegsHIntrEn0(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_dprsr_ho_e), 4, false, write_callback, read_callback, std::string("DprsrHeRegsHIntrEn0")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_dprsr_ho_e))
    {
    }
  DprsrHeRegsHIntrEn0(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "DprsrHeRegsHIntrEn0")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("DprsrHeRegsHIntrEn0") + ":\n";
...
#endif // __REGISTER_INCLUDES_DPRSR_HE_REGS_H_INTR_EN0_H__
