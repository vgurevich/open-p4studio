...
#ifndef __REGISTER_INCLUDES_DPRSR_HE_REGS_H_INTR_EN0_MUTABLE_H__
#define __REGISTER_INCLUDES_DPRSR_HE_REGS_H_INTR_EN0_MUTABLE_H__
...
class DprsrHeRegsHIntrEn0Mutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  DprsrHeRegsHIntrEn0Mutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_dprsr_ho_e), 4, true, write_callback, read_callback, std::string("DprsrHeRegsHIntrEn0Mutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_dprsr_ho_e))
    {
    }
  DprsrHeRegsHIntrEn0Mutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "DprsrHeRegsHIntrEn0Mutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("DprsrHeRegsHIntrEn0Mutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x84; // to get to h_intr_en0
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_DPRSR_HE_REGS_H_INTR_EN0_MUTABLE_H__
