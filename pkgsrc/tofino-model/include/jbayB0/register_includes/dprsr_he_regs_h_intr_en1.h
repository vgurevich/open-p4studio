...
#ifndef __REGISTER_INCLUDES_DPRSR_HE_REGS_H_INTR_EN1_H__
#define __REGISTER_INCLUDES_DPRSR_HE_REGS_H_INTR_EN1_H__
...
class DprsrHeRegsHIntrEn1 : public model_core::RegisterBlock<RegisterCallback> {
public:
  DprsrHeRegsHIntrEn1(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_dprsr_ho_e), 4, false, write_callback, read_callback, std::string("DprsrHeRegsHIntrEn1")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_dprsr_ho_e))
    {
    }
  DprsrHeRegsHIntrEn1(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "DprsrHeRegsHIntrEn1")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("DprsrHeRegsHIntrEn1") + ":\n";
...
#endif // __REGISTER_INCLUDES_DPRSR_HE_REGS_H_INTR_EN1_H__
