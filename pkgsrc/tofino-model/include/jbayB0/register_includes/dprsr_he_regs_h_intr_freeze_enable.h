...
#ifndef __REGISTER_INCLUDES_DPRSR_HE_REGS_H_INTR_FREEZE_ENABLE_H__
#define __REGISTER_INCLUDES_DPRSR_HE_REGS_H_INTR_FREEZE_ENABLE_H__
...
class DprsrHeRegsHIntrFreezeEnable : public model_core::RegisterBlock<RegisterCallback> {
public:
  DprsrHeRegsHIntrFreezeEnable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_dprsr_ho_e), 4, false, write_callback, read_callback, std::string("DprsrHeRegsHIntrFreezeEnable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_dprsr_ho_e))
    {
    }
  DprsrHeRegsHIntrFreezeEnable(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "DprsrHeRegsHIntrFreezeEnable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("DprsrHeRegsHIntrFreezeEnable") + ":\n";
...
#endif // __REGISTER_INCLUDES_DPRSR_HE_REGS_H_INTR_FREEZE_ENABLE_H__
