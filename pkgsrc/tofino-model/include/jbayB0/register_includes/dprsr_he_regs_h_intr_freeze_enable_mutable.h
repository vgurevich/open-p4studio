...
#ifndef __REGISTER_INCLUDES_DPRSR_HE_REGS_H_INTR_FREEZE_ENABLE_MUTABLE_H__
#define __REGISTER_INCLUDES_DPRSR_HE_REGS_H_INTR_FREEZE_ENABLE_MUTABLE_H__
...
class DprsrHeRegsHIntrFreezeEnableMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  DprsrHeRegsHIntrFreezeEnableMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_dprsr_ho_e), 4, true, write_callback, read_callback, std::string("DprsrHeRegsHIntrFreezeEnableMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_dprsr_ho_e))
    {
    }
  DprsrHeRegsHIntrFreezeEnableMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "DprsrHeRegsHIntrFreezeEnableMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("DprsrHeRegsHIntrFreezeEnableMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x90; // to get to h_intr_freeze_enable
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_DPRSR_HE_REGS_H_INTR_FREEZE_ENABLE_MUTABLE_H__
