...
#ifndef __REGISTER_INCLUDES_DPRSR_HE_REGS_H_INTR_INJ_MUTABLE_H__
#define __REGISTER_INCLUDES_DPRSR_HE_REGS_H_INTR_INJ_MUTABLE_H__
...
class DprsrHeRegsHIntrInjMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  DprsrHeRegsHIntrInjMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_dprsr_ho_e), 4, true, write_callback, read_callback, std::string("DprsrHeRegsHIntrInjMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_dprsr_ho_e))
    {
    }
  DprsrHeRegsHIntrInjMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "DprsrHeRegsHIntrInjMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("DprsrHeRegsHIntrInjMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_DPRSR_HE_REGS_H_INTR_INJ_MUTABLE_H__
