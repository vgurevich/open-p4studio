...
#ifndef __REGISTER_INCLUDES_DPRSR_HI_REGS_H_INTR_EN0_MUTABLE_H__
#define __REGISTER_INCLUDES_DPRSR_HI_REGS_H_INTR_EN0_MUTABLE_H__
...
class DprsrHiRegsHIntrEn0Mutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  DprsrHiRegsHIntrEn0Mutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_dprsr_ho_i), 4, true, write_callback, read_callback, std::string("DprsrHiRegsHIntrEn0Mutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_dprsr_ho_i))
    {
    }
  DprsrHiRegsHIntrEn0Mutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "DprsrHiRegsHIntrEn0Mutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("DprsrHiRegsHIntrEn0Mutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_DPRSR_HI_REGS_H_INTR_EN0_MUTABLE_H__
