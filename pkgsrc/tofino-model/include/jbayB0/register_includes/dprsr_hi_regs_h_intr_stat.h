...
#ifndef __REGISTER_INCLUDES_DPRSR_HI_REGS_H_INTR_STAT_H__
#define __REGISTER_INCLUDES_DPRSR_HI_REGS_H_INTR_STAT_H__
...
class DprsrHiRegsHIntrStat : public model_core::RegisterBlock<RegisterCallback> {
public:
  DprsrHiRegsHIntrStat(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_dprsr_ho_i), 4, false, write_callback, read_callback, std::string("DprsrHiRegsHIntrStat")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_dprsr_ho_i))
    {
    }
  DprsrHiRegsHIntrStat(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "DprsrHiRegsHIntrStat")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("DprsrHiRegsHIntrStat") + ":\n";
...
#endif // __REGISTER_INCLUDES_DPRSR_HI_REGS_H_INTR_STAT_H__
