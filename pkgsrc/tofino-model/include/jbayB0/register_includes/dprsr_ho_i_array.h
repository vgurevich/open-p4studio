...
#ifndef __REGISTER_INCLUDES_DPRSR_HO_I_ARRAY_H__
#define __REGISTER_INCLUDES_DPRSR_HO_I_ARRAY_H__
...
class DprsrHoIArray : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  DprsrHoIArray(
      int chipNumber, int index_pipe_addrmap, RegisterArrayCallback& write_callback = 0, RegisterArrayCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 8192 * ArraySize(index_pipe_addrmap, -1), false, write_callback, read_callback, std::string("DprsrHoIArray")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap)),
...
public:
  ...
  DprsrOutIngr &out_ingr(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("DprsrHoIArray") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
#endif // __REGISTER_INCLUDES_DPRSR_HO_I_ARRAY_H__
