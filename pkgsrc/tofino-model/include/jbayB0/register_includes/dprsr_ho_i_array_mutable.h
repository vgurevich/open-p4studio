...
#ifndef __REGISTER_INCLUDES_DPRSR_HO_I_ARRAY_MUTABLE_H__
#define __REGISTER_INCLUDES_DPRSR_HO_I_ARRAY_MUTABLE_H__
...
#include "dprsr_hi_mem_mutable.h"
#include "dprsr_hi_regs_mutable.h"
...
class DprsrHoIArrayMutable : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  DprsrHoIArrayMutable(
      int chipNumber, int index_pipe_addrmap, RegisterArrayCallback& write_callback = 0, RegisterArrayCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 8192 * ArraySize(index_pipe_addrmap, -1), true, write_callback, read_callback, std::string("DprsrHoIArrayMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap)),
...
public:
  DprsrHiMemMutable &him(uint32_t a0)
  {
  ...
  DprsrHiRegsMutable &hir(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    return array[a0].hir();
  }
  ...
  DprsrOutIngrMutable &out_ingr(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    return array[a0].out_ingr();
  }
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("DprsrHoIArrayMutable") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
private:
  std::vector<DprsrHoIMutable> array;
  uint32_t size0_;
...
#endif // __REGISTER_INCLUDES_DPRSR_HO_I_ARRAY_MUTABLE_H__
