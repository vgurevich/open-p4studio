...
#ifndef __REGISTER_INCLUDES_DPRSR_IC_REGS_INTR_B_EN0_MUTABLE_H__
#define __REGISTER_INCLUDES_DPRSR_IC_REGS_INTR_B_EN0_MUTABLE_H__
...
class DprsrIcRegsIntrBEn0Mutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  DprsrIcRegsIntrBEn0Mutable(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 4, true, write_callback, read_callback, std::string("DprsrIcRegsIntrBEn0Mutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  DprsrIcRegsIntrBEn0Mutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "DprsrIcRegsIntrBEn0Mutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("DprsrIcRegsIntrBEn0Mutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x2be4; // to get to intr_b_en0
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_DPRSR_IC_REGS_INTR_B_EN0_MUTABLE_H__
