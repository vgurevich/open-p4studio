...
#ifndef __REGISTER_INCLUDES_DPRSR_IC_REGS_INTR_B_FREEZE_ENABLE_MUTABLE_H__
#define __REGISTER_INCLUDES_DPRSR_IC_REGS_INTR_B_FREEZE_ENABLE_MUTABLE_H__
...
class DprsrIcRegsIntrBFreezeEnableMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  DprsrIcRegsIntrBFreezeEnableMutable(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 4, true, write_callback, read_callback, std::string("DprsrIcRegsIntrBFreezeEnableMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  DprsrIcRegsIntrBFreezeEnableMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "DprsrIcRegsIntrBFreezeEnableMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("DprsrIcRegsIntrBFreezeEnableMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x2bf0; // to get to intr_b_freeze_enable
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_DPRSR_IC_REGS_INTR_B_FREEZE_ENABLE_MUTABLE_H__
