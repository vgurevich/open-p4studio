...
#ifndef __REGISTER_INCLUDES_DPRSR_IC_REGS_INTR_FREEZE_ENABLE_H__
#define __REGISTER_INCLUDES_DPRSR_IC_REGS_INTR_FREEZE_ENABLE_H__
...
class DprsrIcRegsIntrFreezeEnable : public model_core::RegisterBlock<RegisterCallback> {
public:
  DprsrIcRegsIntrFreezeEnable(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 4, false, write_callback, read_callback, std::string("DprsrIcRegsIntrFreezeEnable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  DprsrIcRegsIntrFreezeEnable(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "DprsrIcRegsIntrFreezeEnable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("DprsrIcRegsIntrFreezeEnable") + ":\n";
...
#endif // __REGISTER_INCLUDES_DPRSR_IC_REGS_INTR_FREEZE_ENABLE_H__
