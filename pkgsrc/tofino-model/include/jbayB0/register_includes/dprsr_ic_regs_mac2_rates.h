...
#ifndef __REGISTER_INCLUDES_DPRSR_IC_REGS_MAC2_RATES_H__
#define __REGISTER_INCLUDES_DPRSR_IC_REGS_MAC2_RATES_H__
...
class DprsrIcRegsMac2Rates : public model_core::RegisterBlock<RegisterCallback> {
public:
  DprsrIcRegsMac2Rates(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 4, false, write_callback, read_callback, std::string("DprsrIcRegsMac2Rates")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  DprsrIcRegsMac2Rates(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "DprsrIcRegsMac2Rates")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("DprsrIcRegsMac2Rates") + ":\n";
...
#endif // __REGISTER_INCLUDES_DPRSR_IC_REGS_MAC2_RATES_H__
