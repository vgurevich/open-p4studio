...
#ifndef __REGISTER_INCLUDES_DPRSR_INP_SLICE_INTR_EN1_H__
#define __REGISTER_INCLUDES_DPRSR_INP_SLICE_INTR_EN1_H__
...
class DprsrInpSliceIntrEn1 : public model_core::RegisterBlock<RegisterCallback> {
public:
  DprsrInpSliceIntrEn1(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_dprsr_inp_slice), 4, false, write_callback, read_callback, std::string("DprsrInpSliceIntrEn1")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_dprsr_inp_slice))
    {
    }
  DprsrInpSliceIntrEn1(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "DprsrInpSliceIntrEn1")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("DprsrInpSliceIntrEn1") + ":\n";
...
#endif // __REGISTER_INCLUDES_DPRSR_INP_SLICE_INTR_EN1_H__
