...
#ifndef __REGISTER_INCLUDES_DPRSR_INP_SLICE_INTR_EN1_MUTABLE_H__
#define __REGISTER_INCLUDES_DPRSR_INP_SLICE_INTR_EN1_MUTABLE_H__
...
class DprsrInpSliceIntrEn1Mutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  DprsrInpSliceIntrEn1Mutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_dprsr_inp_slice), 4, true, write_callback, read_callback, std::string("DprsrInpSliceIntrEn1Mutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_dprsr_inp_slice))
    {
    }
  DprsrInpSliceIntrEn1Mutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "DprsrInpSliceIntrEn1Mutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("DprsrInpSliceIntrEn1Mutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_DPRSR_INP_SLICE_INTR_EN1_MUTABLE_H__
