...
#ifndef __REGISTER_INCLUDES_DPRSR_INP_SLICE_INTR_FREEZE_ENABLE_MUTABLE_H__
#define __REGISTER_INCLUDES_DPRSR_INP_SLICE_INTR_FREEZE_ENABLE_MUTABLE_H__
...
class DprsrInpSliceIntrFreezeEnableMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  DprsrInpSliceIntrFreezeEnableMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_dprsr_inp_slice), 4, true, write_callback, read_callback, std::string("DprsrInpSliceIntrFreezeEnableMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_dprsr_inp_slice))
    {
    }
  DprsrInpSliceIntrFreezeEnableMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "DprsrInpSliceIntrFreezeEnableMutable")
    {
    }
public:
  ...
  void i_hdr_cmd_overflow(const uint8_t &v) { i_hdr_cmd_overflow_=v; }
  uint8_t i_hdr_cmd_underflow() { return i_hdr_cmd_underflow_; }
  void i_hdr_cmd_underflow(const uint8_t &v) { i_hdr_cmd_underflow_=v; }
  uint8_t e_hdr_cmd_overflow() { return e_hdr_cmd_overflow_; }
  void e_hdr_cmd_overflow(const uint8_t &v) { e_hdr_cmd_overflow_=v; }
  uint8_t e_hdr_cmd_underflow() { return e_hdr_cmd_underflow_; }
  void e_hdr_cmd_underflow(const uint8_t &v) { e_hdr_cmd_underflow_=v; }
  uint8_t i_credfifo_overflow() { return i_credfifo_overflow_; }
  void i_credfifo_overflow(const uint8_t &v) { i_credfifo_overflow_=v; }
  uint8_t e_credfifo_overflow() { return e_credfifo_overflow_; }
  void e_credfifo_overflow(const uint8_t &v) { e_credfifo_overflow_=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("DprsrInpSliceIntrFreezeEnableMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_DPRSR_INP_SLICE_INTR_FREEZE_ENABLE_MUTABLE_H__
