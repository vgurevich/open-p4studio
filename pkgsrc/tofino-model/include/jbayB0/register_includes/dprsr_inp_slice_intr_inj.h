...
#ifndef __REGISTER_INCLUDES_DPRSR_INP_SLICE_INTR_INJ_H__
#define __REGISTER_INCLUDES_DPRSR_INP_SLICE_INTR_INJ_H__
...
class DprsrInpSliceIntrInj : public model_core::RegisterBlock<RegisterCallback> {
public:
  DprsrInpSliceIntrInj(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_dprsr_inp_slice), 4, false, write_callback, read_callback, std::string("DprsrInpSliceIntrInj")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_dprsr_inp_slice))
    {
    }
  DprsrInpSliceIntrInj(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "DprsrInpSliceIntrInj")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("DprsrInpSliceIntrInj") + ":\n";
...
#endif // __REGISTER_INCLUDES_DPRSR_INP_SLICE_INTR_INJ_H__
