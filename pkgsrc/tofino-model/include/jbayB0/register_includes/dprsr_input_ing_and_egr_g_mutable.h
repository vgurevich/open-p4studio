...
#ifndef __REGISTER_INCLUDES_DPRSR_INPUT_ING_AND_EGR_G_MUTABLE_H__
#define __REGISTER_INCLUDES_DPRSR_INPUT_ING_AND_EGR_G_MUTABLE_H__
...
#include "dprsr_cnt_vld_i_phv_mutable.h"
#include "dprsr_input_ing_and_egr_g_pp_ctr_cfg_data_mutable.h"
#include "dprsr_input_ing_and_egr_g_pp_ctr_cfg_mask_mutable.h"
#include "dprsr_pov_position_r_mutable.h"
#include "pp_ctr_cfg48_r_mutable.h"

namespace jbayB0 {
  namespace register_classes {

class DprsrInputIngAndEgrGMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
...
public:
  DprsrInputIngAndEgrGMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, selector_dprsr_ipp_regs), 48, true, write_callback, read_callback, std::string("DprsrInputIngAndEgrGMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(selector_dprsr_ipp_regs))
    {
    }
  DprsrInputIngAndEgrGMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "DprsrInputIngAndEgrGMutable")
    {
    }
public:
  ...
  DprsrPovPositionRMutable &main_i_pov() { return main_i_pov_; }





  DprsrCntVldIPhvMutable &main_i_cnt_i_phv() { return main_i_cnt_i_phv_; }
  ...
  PpCtrCfg48RMutable &main_i_pp_ctr_cfg48() { return main_i_pp_ctr_cfg48_; }
  ...
  DprsrInputIngAndEgrGPpCtrCfgMaskMutable &main_i_pp_ctr_cfg_mask() { return main_i_pp_ctr_cfg_mask_; }
  ...
  DprsrInputIngAndEgrGPpCtrCfgDataMutable &main_i_pp_ctr_cfg_data() { return main_i_pp_ctr_cfg_data_; }
...
private:
  DprsrPovPositionRMutable main_i_pov_;
  DprsrCntVldIPhvMutable main_i_cnt_i_phv_;
  PpCtrCfg48RMutable main_i_pp_ctr_cfg48_;
  DprsrInputIngAndEgrGPpCtrCfgMaskMutable main_i_pp_ctr_cfg_mask_;
  DprsrInputIngAndEgrGPpCtrCfgDataMutable main_i_pp_ctr_cfg_data_;
private:
...
#endif // __REGISTER_INCLUDES_DPRSR_INPUT_ING_AND_EGR_G_MUTABLE_H__
