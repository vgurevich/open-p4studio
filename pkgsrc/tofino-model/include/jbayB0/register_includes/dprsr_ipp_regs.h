...
#ifndef __REGISTER_INCLUDES_DPRSR_IPP_REGS_H__
#define __REGISTER_INCLUDES_DPRSR_IPP_REGS_H__
...
class DprsrIppRegs : public model_core::RegisterBlock<RegisterCallback> {
public:
  DprsrIppRegs(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 1864, false, write_callback, read_callback, std::string("DprsrIppRegs")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  DprsrIppRegs(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "DprsrIppRegs")
    {
    }
public:
  ...
  DprsrCsumPovCfg &phv_csum_pov_cfg() { return phv_csum_pov_cfg_; }
...
private:
  ...
  DprsrCsumPovCfg phv_csum_pov_cfg_;
private:
...
#endif // __REGISTER_INCLUDES_DPRSR_IPP_REGS_H__
