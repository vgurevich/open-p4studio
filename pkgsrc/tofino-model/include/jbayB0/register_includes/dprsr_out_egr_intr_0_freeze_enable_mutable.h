...
#ifndef __REGISTER_INCLUDES_DPRSR_OUT_EGR_INTR_0_FREEZE_ENABLE_MUTABLE_H__
#define __REGISTER_INCLUDES_DPRSR_OUT_EGR_INTR_0_FREEZE_ENABLE_MUTABLE_H__
...
class DprsrOutEgrIntr_0FreezeEnableMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  DprsrOutEgrIntr_0FreezeEnableMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_dprsr_ho_e), 4, true, write_callback, read_callback, std::string("DprsrOutEgrIntr_0FreezeEnableMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_dprsr_ho_e))
    {
    }
  DprsrOutEgrIntr_0FreezeEnableMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "DprsrOutEgrIntr_0FreezeEnableMutable")
    {
    }
public:
  uint8_t pktst_ovf() { return pktst_ovf_; }
  void pktst_ovf(const uint8_t &v) { pktst_ovf_=v; }
  uint8_t pktst_und() { return pktst_und_; }
  void pktst_und(const uint8_t &v) { pktst_und_=v; }
  uint8_t metafifo_ovf() { return metafifo_ovf_; }
  void metafifo_ovf(const uint8_t &v) { metafifo_ovf_=v; }
  uint8_t metafifo_und() { return metafifo_und_; }
  void metafifo_und(const uint8_t &v) { metafifo_und_=v; }
  uint8_t pkthdr_ovf() { return pkthdr_ovf_; }
  void pkthdr_ovf(const uint8_t &v) { pkthdr_ovf_=v; }
  uint8_t pkthdr_und() { return pkthdr_und_; }
  void pkthdr_und(const uint8_t &v) { pkthdr_und_=v; }
  uint8_t mirrhdr_ovf() { return mirrhdr_ovf_; }
  void mirrhdr_ovf(const uint8_t &v) { mirrhdr_ovf_=v; }
  uint8_t mirrhdr_und() { return mirrhdr_und_; }
  void mirrhdr_und(const uint8_t &v) { mirrhdr_und_=v; }
  uint8_t datast0_ovf() { return datast0_ovf_; }
  void datast0_ovf(const uint8_t &v) { datast0_ovf_=v; }
  uint8_t datast0_und() { return datast0_und_; }
  void datast0_und(const uint8_t &v) { datast0_und_=v; }
  uint8_t pktdatafifo0_ovf() { return pktdatafifo0_ovf_; }
  void pktdatafifo0_ovf(const uint8_t &v) { pktdatafifo0_ovf_=v; }
  uint8_t pktdatafifo0_und() { return pktdatafifo0_und_; }
  void pktdatafifo0_und(const uint8_t &v) { pktdatafifo0_und_=v; }
  uint8_t datast1_ovf() { return datast1_ovf_; }
  void datast1_ovf(const uint8_t &v) { datast1_ovf_=v; }
  uint8_t datast1_und() { return datast1_und_; }
  void datast1_und(const uint8_t &v) { datast1_und_=v; }
  uint8_t pktdatafifo1_ovf() { return pktdatafifo1_ovf_; }
  void pktdatafifo1_ovf(const uint8_t &v) { pktdatafifo1_ovf_=v; }
  uint8_t pktdatafifo1_und() { return pktdatafifo1_und_; }
  void pktdatafifo1_und(const uint8_t &v) { pktdatafifo1_und_=v; }
  uint8_t datast2_ovf() { return datast2_ovf_; }
  void datast2_ovf(const uint8_t &v) { datast2_ovf_=v; }
  uint8_t datast2_und() { return datast2_und_; }
  void datast2_und(const uint8_t &v) { datast2_und_=v; }
  uint8_t pktdatafifo2_ovf() { return pktdatafifo2_ovf_; }
  void pktdatafifo2_ovf(const uint8_t &v) { pktdatafifo2_ovf_=v; }
  uint8_t pktdatafifo2_und() { return pktdatafifo2_und_; }
  void pktdatafifo2_und(const uint8_t &v) { pktdatafifo2_und_=v; }
  uint8_t arbfifo_ovf() { return arbfifo_ovf_; }
  void arbfifo_ovf(const uint8_t &v) { arbfifo_ovf_=v; }
  uint8_t arbfifo_und() { return arbfifo_und_; }
  void arbfifo_und(const uint8_t &v) { arbfifo_und_=v; }
  uint8_t tmschfifo_ovf() { return tmschfifo_ovf_; }
  void tmschfifo_ovf(const uint8_t &v) { tmschfifo_ovf_=v; }
  uint8_t tmschfifo_und() { return tmschfifo_und_; }
  void tmschfifo_und(const uint8_t &v) { tmschfifo_und_=v; }
  uint8_t ctl_chan_err() { return ctl_chan_err_; }
  void ctl_chan_err(const uint8_t &v) { ctl_chan_err_=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("DprsrOutEgrIntr_0FreezeEnableMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x3b0; // to get to intr_0_freeze_enable
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_DPRSR_OUT_EGR_INTR_0_FREEZE_ENABLE_MUTABLE_H__
