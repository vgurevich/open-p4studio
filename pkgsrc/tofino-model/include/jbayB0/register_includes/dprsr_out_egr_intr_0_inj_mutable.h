...
#ifndef __REGISTER_INCLUDES_DPRSR_OUT_EGR_INTR_0_INJ_MUTABLE_H__
#define __REGISTER_INCLUDES_DPRSR_OUT_EGR_INTR_0_INJ_MUTABLE_H__
...
class DprsrOutEgrIntr_0InjMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  DprsrOutEgrIntr_0InjMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_dprsr_ho_e), 4, true, write_callback, read_callback, std::string("DprsrOutEgrIntr_0InjMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_dprsr_ho_e))
    {
    }
  DprsrOutEgrIntr_0InjMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "DprsrOutEgrIntr_0InjMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("DprsrOutEgrIntr_0InjMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_DPRSR_OUT_EGR_INTR_0_INJ_MUTABLE_H__
