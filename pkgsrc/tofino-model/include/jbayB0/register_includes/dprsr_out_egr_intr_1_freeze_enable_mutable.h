...
#ifndef __REGISTER_INCLUDES_DPRSR_OUT_EGR_INTR_1_FREEZE_ENABLE_MUTABLE_H__
#define __REGISTER_INCLUDES_DPRSR_OUT_EGR_INTR_1_FREEZE_ENABLE_MUTABLE_H__
...
class DprsrOutEgrIntr_1FreezeEnableMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  DprsrOutEgrIntr_1FreezeEnableMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_dprsr_ho_e), 4, true, write_callback, read_callback, std::string("DprsrOutEgrIntr_1FreezeEnableMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_dprsr_ho_e))
    {
    }
  DprsrOutEgrIntr_1FreezeEnableMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "DprsrOutEgrIntr_1FreezeEnableMutable")
    {
    }
public:
  ...
  void tmsch_sbe(const uint8_t &v) { tmsch_sbe_=v; }
  uint8_t tmsch_mbe() { return tmsch_mbe_; }
  void tmsch_mbe(const uint8_t &v) { tmsch_mbe_=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("DprsrOutEgrIntr_1FreezeEnableMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_DPRSR_OUT_EGR_INTR_1_FREEZE_ENABLE_MUTABLE_H__
