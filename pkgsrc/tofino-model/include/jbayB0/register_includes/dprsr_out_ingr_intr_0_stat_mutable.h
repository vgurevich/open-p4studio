...
#ifndef __REGISTER_INCLUDES_DPRSR_OUT_INGR_INTR_0_STAT_MUTABLE_H__
#define __REGISTER_INCLUDES_DPRSR_OUT_INGR_INTR_0_STAT_MUTABLE_H__
...
class DprsrOutIngrIntr_0StatMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  DprsrOutIngrIntr_0StatMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_dprsr_ho_i), 4, true, write_callback, read_callback, std::string("DprsrOutIngrIntr_0StatMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_dprsr_ho_i))
    {
    }
  DprsrOutIngrIntr_0StatMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "DprsrOutIngrIntr_0StatMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("DprsrOutIngrIntr_0StatMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x2a0; // to get to intr_0_stat
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_DPRSR_OUT_INGR_INTR_0_STAT_MUTABLE_H__
