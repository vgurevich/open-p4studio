...
#ifndef __REGISTER_INCLUDES_DPRSR_OUT_INGR_INTR_1_FREEZE_ENABLE_H__
#define __REGISTER_INCLUDES_DPRSR_OUT_INGR_INTR_1_FREEZE_ENABLE_H__
...
class DprsrOutIngrIntr_1FreezeEnable : public model_core::RegisterBlock<RegisterCallback> {
public:
  DprsrOutIngrIntr_1FreezeEnable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_dprsr_ho_i), 4, false, write_callback, read_callback, std::string("DprsrOutIngrIntr_1FreezeEnable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_dprsr_ho_i))
    {
    }
  DprsrOutIngrIntr_1FreezeEnable(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "DprsrOutIngrIntr_1FreezeEnable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("DprsrOutIngrIntr_1FreezeEnable") + ":\n";
...
#endif // __REGISTER_INCLUDES_DPRSR_OUT_INGR_INTR_1_FREEZE_ENABLE_H__
