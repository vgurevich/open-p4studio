...
#ifndef __REGISTER_INCLUDES_DPRSR_OUT_INGR_INTR_1_STAT_MUTABLE_H__
#define __REGISTER_INCLUDES_DPRSR_OUT_INGR_INTR_1_STAT_MUTABLE_H__
...
class DprsrOutIngrIntr_1StatMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  DprsrOutIngrIntr_1StatMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_dprsr_ho_i), 4, true, write_callback, read_callback, std::string("DprsrOutIngrIntr_1StatMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_dprsr_ho_i))
    {
    }
  DprsrOutIngrIntr_1StatMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "DprsrOutIngrIntr_1StatMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("DprsrOutIngrIntr_1StatMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x2c0; // to get to intr_1_stat
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_DPRSR_OUT_INGR_INTR_1_STAT_MUTABLE_H__
