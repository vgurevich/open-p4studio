...
#ifndef __REGISTER_INCLUDES_DR_EMPTY_INT_TIME_MUTABLE_H__
#define __REGISTER_INCLUDES_DR_EMPTY_INT_TIME_MUTABLE_H__
...
class DrEmptyIntTimeMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum CbcRspecEnum {
    kCbcLqFmDr,
    kCbcLqRxDr,
...
public:
  DrEmptyIntTimeMutable(
      int chipNumber, CbcRspecEnum selector_cbc_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(selector_cbc_rspec), 4, true, write_callback, read_callback, std::string("DrEmptyIntTimeMutable")+":"+boost::lexical_cast<std::string>(selector_cbc_rspec))
    {
    }
  DrEmptyIntTimeMutable(
      int chipNumber, MbcRspecEnum selector_mbc_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(selector_mbc_rspec), 4, true, write_callback, read_callback, std::string("DrEmptyIntTimeMutable")+":"+boost::lexical_cast<std::string>(selector_mbc_rspec))
    {
    }
  DrEmptyIntTimeMutable(
      int chipNumber, PbcRspecEnum selector_pbc_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(selector_pbc_rspec), 4, true, write_callback, read_callback, std::string("DrEmptyIntTimeMutable")+":"+boost::lexical_cast<std::string>(selector_pbc_rspec))
    {
    }
  DrEmptyIntTimeMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_pbc_rspec, index_dru_rspec), 4, true, write_callback, read_callback, std::string("DrEmptyIntTimeMutable")+":"+boost::lexical_cast<std::string>(selector_pbc_rspec) + "," + boost::lexical_cast<std::string>(index_dru_rspec))
    {
    }
  DrEmptyIntTimeMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_tbc_rspec, index_dru_rspec), 4, true, write_callback, read_callback, std::string("DrEmptyIntTimeMutable")+":"+boost::lexical_cast<std::string>(selector_tbc_rspec) + "," + boost::lexical_cast<std::string>(index_dru_rspec))
    {
    }
  DrEmptyIntTimeMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "DrEmptyIntTimeMutable")
    {
    }
public:
  ...
  uint32_t time_value() { return time_value_; }
  void time_value(const uint32_t &v) { time_value_=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("DrEmptyIntTimeMutable") + ":\n";
    r += indent_string + "  " + std::string("en") +  ": 0x" + boost::str( boost::format("%x") % static_cast<uint>(en_) ) + "\n";
    all_zeros &= (0 == en_);
    r += indent_string + "  " + std::string("time_value") +  ": 0x" + boost::str( boost::format("%x") % static_cast<uint>(time_value_) ) + "\n";
    all_zeros &= (0 == time_value_);
  ...
  static int StartOffset(
    ...
    switch (selector_cbc_rspec) {
      case kCbcLqFmDr:
        ...
        offset += 0x2c; // to get to empty_int_time
        break;
      case kCbcLqRxDr:
...
#endif // __REGISTER_INCLUDES_DR_EMPTY_INT_TIME_MUTABLE_H__
