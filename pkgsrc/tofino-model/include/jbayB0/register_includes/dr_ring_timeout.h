...
#ifndef __REGISTER_INCLUDES_DR_RING_TIMEOUT_H__
#define __REGISTER_INCLUDES_DR_RING_TIMEOUT_H__
...
class DrRingTimeout : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum CbcRspecEnum {
    kCbcLqFmDr,
    kCbcLqRxDr,
...
public:
  DrRingTimeout(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_cbc_rspec), 4, false, write_callback, read_callback, std::string("DrRingTimeout")+":"+boost::lexical_cast<std::string>(selector_cbc_rspec))
    {
    }
  DrRingTimeout(
      int chipNumber, MbcRspecEnum selector_mbc_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(selector_mbc_rspec), 4, false, write_callback, read_callback, std::string("DrRingTimeout")+":"+boost::lexical_cast<std::string>(selector_mbc_rspec))
    {
    }
  DrRingTimeout(
      int chipNumber, PbcRspecEnum selector_pbc_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(selector_pbc_rspec), 4, false, write_callback, read_callback, std::string("DrRingTimeout")+":"+boost::lexical_cast<std::string>(selector_pbc_rspec))
    {
    }
  DrRingTimeout(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_pbc_rspec, index_dru_rspec), 4, false, write_callback, read_callback, std::string("DrRingTimeout")+":"+boost::lexical_cast<std::string>(selector_pbc_rspec) + "," + boost::lexical_cast<std::string>(index_dru_rspec))
    {
    }
  DrRingTimeout(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_tbc_rspec, index_dru_rspec), 4, false, write_callback, read_callback, std::string("DrRingTimeout")+":"+boost::lexical_cast<std::string>(selector_tbc_rspec) + "," + boost::lexical_cast<std::string>(index_dru_rspec))
    {
    }
  DrRingTimeout(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "DrRingTimeout")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("DrRingTimeout") + ":\n";
...
#endif // __REGISTER_INCLUDES_DR_RING_TIMEOUT_H__
