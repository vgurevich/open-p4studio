...
#ifndef __REGISTER_INCLUDES_DR_RING_TIMEOUT_MUTABLE_H__
#define __REGISTER_INCLUDES_DR_RING_TIMEOUT_MUTABLE_H__
...
class DrRingTimeoutMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum CbcRspecEnum {
    kCbcLqFmDr,
    kCbcLqRxDr,
...
public:
  DrRingTimeoutMutable(
      int chipNumber, CbcRspecEnum selector_cbc_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(selector_cbc_rspec), 4, true, write_callback, read_callback, std::string("DrRingTimeoutMutable")+":"+boost::lexical_cast<std::string>(selector_cbc_rspec))
    {
    }
  DrRingTimeoutMutable(
      int chipNumber, MbcRspecEnum selector_mbc_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(selector_mbc_rspec), 4, true, write_callback, read_callback, std::string("DrRingTimeoutMutable")+":"+boost::lexical_cast<std::string>(selector_mbc_rspec))
    {
    }
  DrRingTimeoutMutable(
      int chipNumber, PbcRspecEnum selector_pbc_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(selector_pbc_rspec), 4, true, write_callback, read_callback, std::string("DrRingTimeoutMutable")+":"+boost::lexical_cast<std::string>(selector_pbc_rspec))
    {
    }
  DrRingTimeoutMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_pbc_rspec, index_dru_rspec), 4, true, write_callback, read_callback, std::string("DrRingTimeoutMutable")+":"+boost::lexical_cast<std::string>(selector_pbc_rspec) + "," + boost::lexical_cast<std::string>(index_dru_rspec))
    {
    }
  DrRingTimeoutMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_tbc_rspec, index_dru_rspec), 4, true, write_callback, read_callback, std::string("DrRingTimeoutMutable")+":"+boost::lexical_cast<std::string>(selector_tbc_rspec) + "," + boost::lexical_cast<std::string>(index_dru_rspec))
    {
    }
  DrRingTimeoutMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "DrRingTimeoutMutable")
    {
    }
public:
  ...
  uint16_t write_timeout() { return write_timeout_; }
  void write_timeout(const uint16_t &v) { write_timeout_=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("DrRingTimeoutMutable") + ":\n";
    r += indent_string + "  " + std::string("write_timeout") +  ": 0x" + boost::str( boost::format("%x") % static_cast<uint>(write_timeout_) ) + "\n";
    all_zeros &= (0 == write_timeout_);
  ...
  static int StartOffset(
    ...
    switch (selector_cbc_rspec) {
      case kCbcLqFmDr:
        ...
        offset += 0x20; // to get to ring_timeout
        break;
      case kCbcLqRxDr:
...
#endif // __REGISTER_INCLUDES_DR_RING_TIMEOUT_MUTABLE_H__
