...
#ifndef __REGISTER_INCLUDES_DRU_RSPEC_H__
#define __REGISTER_INCLUDES_DRU_RSPEC_H__
...
#include "dr_base_addr_high.h"
#include "dr_base_addr_low.h"
#include "dr_ctrl.h"
#include "dr_data_timeout.h"
#include "dr_empty_int_count.h"
#include "dr_empty_int_time.h"
#include "dr_head_ptr.h"
#include "dr_limit_addr_high.h"
#include "dr_limit_addr_low.h"
#include "dr_ring_timeout.h"
#include "dr_size.h"
#include "dr_status.h"
#include "dr_tail_ptr.h"

namespace jbayB0 {
  namespace register_classes {

class DruRspec : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum CbcRspecEnum {
    kCbcLqFmDr,
    kCbcLqRxDr,
...
public:
  DruRspec(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_cbc_rspec), 52, false, write_callback, read_callback, std::string("DruRspec")+":"+boost::lexical_cast<std::string>(selector_cbc_rspec))
    {
    }
  DruRspec(
      int chipNumber, MbcRspecEnum selector_mbc_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(selector_mbc_rspec), 52, false, write_callback, read_callback, std::string("DruRspec")+":"+boost::lexical_cast<std::string>(selector_mbc_rspec))
    {
    }
  DruRspec(
      int chipNumber, PbcRspecEnum selector_pbc_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(selector_pbc_rspec), 52, false, write_callback, read_callback, std::string("DruRspec")+":"+boost::lexical_cast<std::string>(selector_pbc_rspec))
    {
    }
  DruRspec(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_pbc_rspec, index_dru_rspec), 52, false, write_callback, read_callback, std::string("DruRspec")+":"+boost::lexical_cast<std::string>(selector_pbc_rspec) + "," + boost::lexical_cast<std::string>(index_dru_rspec))
    {
    }
  DruRspec(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_tbc_rspec, index_dru_rspec), 52, false, write_callback, read_callback, std::string("DruRspec")+":"+boost::lexical_cast<std::string>(selector_tbc_rspec) + "," + boost::lexical_cast<std::string>(index_dru_rspec))
    {
    }
  DruRspec(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "DruRspec")
    {
    }
public:
  ...
  DrCtrl &ctrl() { return ctrl_; }





  DrBaseAddrLow &base_addr_low() { return base_addr_low_; }





  DrBaseAddrHigh &base_addr_high() { return base_addr_high_; }





  DrLimitAddrLow &limit_addr_low() { return limit_addr_low_; }





  DrLimitAddrHigh &limit_addr_high() { return limit_addr_high_; }





  DrSize &size() { return size_; }





  DrHeadPtr &head_ptr() { return head_ptr_; }





  DrTailPtr &tail_ptr() { return tail_ptr_; }





  DrRingTimeout &ring_timeout() { return ring_timeout_; }





  DrDataTimeout &data_timeout() { return data_timeout_; }





  DrStatus &status() { return status_; }




  DrEmptyIntTime &empty_int_time() { return empty_int_time_; }




  DrEmptyIntCount &empty_int_count() { return empty_int_count_; }
  ...
  bool read(
    ...
    if (offset < 0x4) {
      ...
      offset -= 0x2c;
      if (read_callback_) read_callback_();
      empty_int_time_.read( offset, data );
    }
    else if (offset >= 0x30 && offset < 0x34) {
      offset -= 0x30;
      if (read_callback_) read_callback_();
      empty_int_count_.read( offset, data );
    }
    return true;
  }
  ...
  bool write(
    ...
    if (offset < 0x4) {
      ...
      offset -= 0x2c;
      empty_int_time_.write( offset, data );
      if (write_callback_) write_callback_();
    }
    else if (offset >= 0x30 && offset < 0x34) {
      offset -= 0x30;
      empty_int_count_.write( offset, data );
      if (write_callback_) write_callback_();
    }
    return true;
  }
  ...
  void reset(
    ...
    data_timeout_.reset();
    status_.reset();
    empty_int_time_.reset();
    empty_int_count_.reset();
    if (write_callback_) write_callback_();
  }
  ...
  std::string to_string(
    ...
    if (offset < 0x4) {
      ...
      offset -= 0x2c;
      r += empty_int_time_.to_string(offset,print_zeros,indent_string) ;
    }
    else if (offset >= 0x30 && offset < 0x34) {
      offset -= 0x30;
      r += empty_int_count_.to_string(offset,print_zeros,indent_string) ;
    }
  ...
  std::string to_string(
    ...
    r += empty_int_time_.to_string(print_zeros,indent_string) ;
    r += empty_int_count_.to_string(print_zeros,indent_string) ;
    if (all_zeros && !print_zeros) {
      return("");
    }
    else {
...
private:
  DrCtrl ctrl_;
  DrBaseAddrLow base_addr_low_;
  DrBaseAddrHigh base_addr_high_;
  DrLimitAddrLow limit_addr_low_;
  DrLimitAddrHigh limit_addr_high_;
  DrSize size_;
  DrHeadPtr head_ptr_;
  DrTailPtr tail_ptr_;
  DrRingTimeout ring_timeout_;
  DrDataTimeout data_timeout_;
  DrStatus status_;
  DrEmptyIntTime empty_int_time_;
  DrEmptyIntCount empty_int_count_;
private:
...
#endif // __REGISTER_INCLUDES_DRU_RSPEC_H__
