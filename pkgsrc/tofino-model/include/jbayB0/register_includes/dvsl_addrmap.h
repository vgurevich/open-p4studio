...
public:
  DvslAddrmap(
    ...
    : RegisterBlock(chipNumber, StartOffset(), 16777216, false, write_callback, read_callback, std::string("DvslAddrmap"))
    {
    }
  DvslAddrmap(
...
public:
  ...
  MiscTv80Rspec &misc_tv80_regs() { return misc_tv80_regs_; }
  ...
  LfltrRspec &lfltr(int j0) { return lfltr_[j0]; }
...
private:
  ...
  MiscRegs misc_regs_;
  MiscTv80Rspec misc_tv80_regs_;
  MbcRspec mbc_;
  PbcRspec pbc_;
  CbcRspec cbc_;
  TbcRspec tbc_;
  std::array< LfltrRspec, 4 > lfltr_;
  TmTopRspec tm_top_;
private:
