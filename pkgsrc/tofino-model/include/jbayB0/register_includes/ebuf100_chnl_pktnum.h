...
#ifndef __REGISTER_INCLUDES_EBUF100_CHNL_PKTNUM_H__
#define __REGISTER_INCLUDES_EBUF100_CHNL_PKTNUM_H__
...
class Ebuf100ChnlPktnum : public model_core::RegisterBlock<RegisterCallback> {
public:
  Ebuf100ChnlPktnum(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_ebuf900_reg, index_ebuf100_chan_group), 56, false, write_callback, read_callback, std::string("Ebuf100ChnlPktnum")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_ebuf900_reg) + "," + boost::lexical_cast<std::string>(index_ebuf100_chan_group))
    {
    }
  Ebuf100ChnlPktnum(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "Ebuf100ChnlPktnum")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("Ebuf100ChnlPktnum") + ":\n";
...
#endif // __REGISTER_INCLUDES_EBUF100_CHNL_PKTNUM_H__
