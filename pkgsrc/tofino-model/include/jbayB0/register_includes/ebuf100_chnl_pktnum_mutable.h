...
#ifndef __REGISTER_INCLUDES_EBUF100_CHNL_PKTNUM_MUTABLE_H__
#define __REGISTER_INCLUDES_EBUF100_CHNL_PKTNUM_MUTABLE_H__
...
class Ebuf100ChnlPktnumMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  Ebuf100ChnlPktnumMutable(
...
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("Ebuf100ChnlPktnumMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x140; // to get to chan_group_chnl_pktnum
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_EBUF100_CHNL_PKTNUM_MUTABLE_H__
