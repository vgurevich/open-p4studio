...
#ifndef __REGISTER_INCLUDES_EBUF100_CHNL_STAT_H__
#define __REGISTER_INCLUDES_EBUF100_CHNL_STAT_H__
...
class Ebuf100ChnlStat : public model_core::RegisterBlock<RegisterCallback> {
public:
  Ebuf100ChnlStat(
...
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("Ebuf100ChnlStat") + ":\n";
...
#endif // __REGISTER_INCLUDES_EBUF100_CHNL_STAT_H__
