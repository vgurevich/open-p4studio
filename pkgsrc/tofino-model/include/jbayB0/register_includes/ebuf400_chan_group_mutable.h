...
#ifndef __REGISTER_INCLUDES_EBUF400_CHAN_GROUP_MUTABLE_H__
#define __REGISTER_INCLUDES_EBUF400_CHAN_GROUP_MUTABLE_H__
...
class Ebuf400ChanGroupMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  Ebuf400ChanGroupMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_ebuf900_reg, index_ebuf400_rspec, index_ebuf400_chan_group), 120, true, write_callback, read_callback, std::string("Ebuf400ChanGroupMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_ebuf900_reg) + "," + boost::lexical_cast<std::string>(index_ebuf400_rspec) + "," + boost::lexical_cast<std::string>(index_ebuf400_chan_group))
    {
    }
  Ebuf400ChanGroupMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "Ebuf400ChanGroupMutable")
    {
    }
public:
  ...
  Ebuf400ChnlCtrlMutable &chan_group_chnl_ctrl() { return chan_group_chnl_ctrl_; }
  ...
  Ebuf400ChnlStatMutable &chan_group_chnl_stat() { return chan_group_chnl_stat_; }
  ...
  Ebuf400ChnlFifoCtrlMutable &chan_group_chnl_fifo_ctrl() { return chan_group_chnl_fifo_ctrl_; }
  ...
  Ebuf400ChnlFifoStatMutable &chan_group_chnl_fifo_stat() { return chan_group_chnl_fifo_stat_; }





  Ebuf400ChnlPktnumMutable &chan_group_chnl_pktnum() { return chan_group_chnl_pktnum_; }
...
private:
  Ebuf400ChnlCtrlMutable chan_group_chnl_ctrl_;
  Ebuf400ChnlStatMutable chan_group_chnl_stat_;
  Ebuf400ChnlFifoCtrlMutable chan_group_chnl_fifo_ctrl_;
  Ebuf400ChnlFifoStatMutable chan_group_chnl_fifo_stat_;
  Ebuf400ChnlPktnumMutable chan_group_chnl_pktnum_;
private:
...
#endif // __REGISTER_INCLUDES_EBUF400_CHAN_GROUP_MUTABLE_H__
