...
#ifndef __REGISTER_INCLUDES_EBUF400_CHNL_FIFO_CTRL_H__
#define __REGISTER_INCLUDES_EBUF400_CHNL_FIFO_CTRL_H__
...
class Ebuf400ChnlFifoCtrl : public model_core::RegisterBlock<RegisterCallback> {
public:
  Ebuf400ChnlFifoCtrl(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_ebuf900_reg, index_ebuf400_rspec, index_ebuf400_chan_group), 8, false, write_callback, read_callback, std::string("Ebuf400ChnlFifoCtrl")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_ebuf900_reg) + "," + boost::lexical_cast<std::string>(index_ebuf400_rspec) + "," + boost::lexical_cast<std::string>(index_ebuf400_chan_group))
    {
    }
  Ebuf400ChnlFifoCtrl(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "Ebuf400ChnlFifoCtrl")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("Ebuf400ChnlFifoCtrl") + ":\n";
...
#endif // __REGISTER_INCLUDES_EBUF400_CHNL_FIFO_CTRL_H__
