...
#ifndef __REGISTER_INCLUDES_EBUF400_CHNL_PKTNUM_MUTABLE_H__
#define __REGISTER_INCLUDES_EBUF400_CHNL_PKTNUM_MUTABLE_H__
...
class Ebuf400ChnlPktnumMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  Ebuf400ChnlPktnumMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_ebuf900_reg, index_ebuf400_rspec, index_ebuf400_chan_group), 56, true, write_callback, read_callback, std::string("Ebuf400ChnlPktnumMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_ebuf900_reg) + "," + boost::lexical_cast<std::string>(index_ebuf400_rspec) + "," + boost::lexical_cast<std::string>(index_ebuf400_chan_group))
    {
    }
  Ebuf400ChnlPktnumMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "Ebuf400ChnlPktnumMutable")
    {
    }
public:
  ...
  void dprsr_rcv_pkt(const uint64_t &v) { dprsr_rcv_pkt_=v; }
  ...
  void dprsr_err_pkt(const uint32_t &v) { dprsr_err_pkt_=v; }
  ...
  void dprsr_runt_pkt(const uint32_t &v) { dprsr_runt_pkt_=v; }
  ...
  void dprsr_ct_timeout_pkt(const uint32_t &v) { dprsr_ct_timeout_pkt_=v; }
  ...
  void dprsr_drp_pkt(const uint32_t &v) { dprsr_drp_pkt_=v; }
  ...
  void warp_rcv_pkt(const uint64_t &v) { warp_rcv_pkt_=v; }
  ...
  void warp_err_pkt(const uint32_t &v) { warp_err_pkt_=v; }
  ...
  void warp_runt_pkt(const uint32_t &v) { warp_runt_pkt_=v; }
  ...
  void warp_drp_pkt(const uint32_t &v) { warp_drp_pkt_=v; }
  ...
  void mac_xmt_pkt(const uint64_t &v) { mac_xmt_pkt_=v; }
  ...
  void mac_err_pkt(const uint32_t &v) { mac_err_pkt_=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("Ebuf400ChnlPktnumMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_EBUF400_CHNL_PKTNUM_MUTABLE_H__
