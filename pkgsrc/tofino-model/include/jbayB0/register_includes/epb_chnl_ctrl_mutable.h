...
#ifndef __REGISTER_INCLUDES_EPB_CHNL_CTRL_MUTABLE_H__
#define __REGISTER_INCLUDES_EPB_CHNL_CTRL_MUTABLE_H__
...
class EpbChnlCtrlMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum EpbRspecEnum {
    kChan0Group,
    kChan1Group,
...
public:
  EpbChnlCtrlMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_epb_prsr4_reg, selector_epb_rspec), 8, true, write_callback, read_callback, std::string("EpbChnlCtrlMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_epb_prsr4_reg) + "," + boost::lexical_cast<std::string>(selector_epb_rspec))
    {
    }
  EpbChnlCtrlMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "EpbChnlCtrlMutable")
    {
    }
public:
  ...
  void pipeid(const uint8_t &v) { pipeid_=v; }
  ...
  void init_dprsr_credit(const uint16_t &v) { init_dprsr_credit_=v; }
  ...
  void init_ebuf_credit(const uint8_t &v) { init_ebuf_credit_=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("EpbChnlCtrlMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_EPB_CHNL_CTRL_MUTABLE_H__
