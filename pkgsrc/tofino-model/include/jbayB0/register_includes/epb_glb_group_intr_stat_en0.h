...
#ifndef __REGISTER_INCLUDES_EPB_GLB_GROUP_INTR_STAT_EN0_H__
#define __REGISTER_INCLUDES_EPB_GLB_GROUP_INTR_STAT_EN0_H__
...
class EpbGlbGroupIntrStatEn0 : public model_core::RegisterBlock<RegisterCallback> {
public:
  EpbGlbGroupIntrStatEn0(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_epb_prsr4_reg), 8, false, write_callback, read_callback, std::string("EpbGlbGroupIntrStatEn0")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_epb_prsr4_reg))
    {
    }
  EpbGlbGroupIntrStatEn0(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "EpbGlbGroupIntrStatEn0")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("EpbGlbGroupIntrStatEn0") + ":\n";
...
#endif // __REGISTER_INCLUDES_EPB_GLB_GROUP_INTR_STAT_EN0_H__
