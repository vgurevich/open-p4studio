...
#ifndef __REGISTER_INCLUDES_EPB_GLB_GROUP_INTR_STAT_FREEZE_ENABLE_H__
#define __REGISTER_INCLUDES_EPB_GLB_GROUP_INTR_STAT_FREEZE_ENABLE_H__
...
class EpbGlbGroupIntrStatFreezeEnable : public model_core::RegisterBlock<RegisterCallback> {
public:
  EpbGlbGroupIntrStatFreezeEnable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_epb_prsr4_reg), 8, false, write_callback, read_callback, std::string("EpbGlbGroupIntrStatFreezeEnable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_epb_prsr4_reg))
    {
    }
  EpbGlbGroupIntrStatFreezeEnable(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "EpbGlbGroupIntrStatFreezeEnable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("EpbGlbGroupIntrStatFreezeEnable") + ":\n";
...
#endif // __REGISTER_INCLUDES_EPB_GLB_GROUP_INTR_STAT_FREEZE_ENABLE_H__
