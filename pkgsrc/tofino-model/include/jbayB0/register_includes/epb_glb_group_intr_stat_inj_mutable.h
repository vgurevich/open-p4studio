...
#ifndef __REGISTER_INCLUDES_EPB_GLB_GROUP_INTR_STAT_INJ_MUTABLE_H__
#define __REGISTER_INCLUDES_EPB_GLB_GROUP_INTR_STAT_INJ_MUTABLE_H__
...
class EpbGlbGroupIntrStatInjMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  EpbGlbGroupIntrStatInjMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_epb_prsr4_reg), 8, true, write_callback, read_callback, std::string("EpbGlbGroupIntrStatInjMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_epb_prsr4_reg))
    {
    }
  EpbGlbGroupIntrStatInjMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "EpbGlbGroupIntrStatInjMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("EpbGlbGroupIntrStatInjMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_EPB_GLB_GROUP_INTR_STAT_INJ_MUTABLE_H__
