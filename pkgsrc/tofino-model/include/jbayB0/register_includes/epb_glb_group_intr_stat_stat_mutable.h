...
#ifndef __REGISTER_INCLUDES_EPB_GLB_GROUP_INTR_STAT_STAT_MUTABLE_H__
#define __REGISTER_INCLUDES_EPB_GLB_GROUP_INTR_STAT_STAT_MUTABLE_H__
...
class EpbGlbGroupIntrStatStatMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  EpbGlbGroupIntrStatStatMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_epb_prsr4_reg), 8, true, write_callback, read_callback, std::string("EpbGlbGroupIntrStatStatMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_epb_prsr4_reg))
    {
    }
  EpbGlbGroupIntrStatStatMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "EpbGlbGroupIntrStatStatMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("EpbGlbGroupIntrStatStatMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_EPB_GLB_GROUP_INTR_STAT_STAT_MUTABLE_H__
