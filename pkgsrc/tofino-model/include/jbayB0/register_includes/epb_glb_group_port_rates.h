...
#ifndef __REGISTER_INCLUDES_EPB_GLB_GROUP_PORT_RATES_H__
#define __REGISTER_INCLUDES_EPB_GLB_GROUP_PORT_RATES_H__
...
class EpbGlbGroupPortRates : public model_core::RegisterBlock<RegisterCallback> {
public:
  EpbGlbGroupPortRates(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_epb_prsr4_reg), 4, false, write_callback, read_callback, std::string("EpbGlbGroupPortRates")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_epb_prsr4_reg))
    {
    }
  EpbGlbGroupPortRates(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "EpbGlbGroupPortRates")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("EpbGlbGroupPortRates") + ":\n";
...
#endif // __REGISTER_INCLUDES_EPB_GLB_GROUP_PORT_RATES_H__
