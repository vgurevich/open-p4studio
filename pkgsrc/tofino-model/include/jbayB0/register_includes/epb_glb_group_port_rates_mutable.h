...
#ifndef __REGISTER_INCLUDES_EPB_GLB_GROUP_PORT_RATES_MUTABLE_H__
#define __REGISTER_INCLUDES_EPB_GLB_GROUP_PORT_RATES_MUTABLE_H__
...
class EpbGlbGroupPortRatesMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  EpbGlbGroupPortRatesMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_epb_prsr4_reg), 4, true, write_callback, read_callback, std::string("EpbGlbGroupPortRatesMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_epb_prsr4_reg))
    {
    }
  EpbGlbGroupPortRatesMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "EpbGlbGroupPortRatesMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("EpbGlbGroupPortRatesMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x8; // to get to glb_group_port_rates
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_EPB_GLB_GROUP_PORT_RATES_MUTABLE_H__
