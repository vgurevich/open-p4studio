...
#ifndef __REGISTER_INCLUDES_EPB_RSPEC_DEBUG_BUS_CTRL_MUTABLE_H__
#define __REGISTER_INCLUDES_EPB_RSPEC_DEBUG_BUS_CTRL_MUTABLE_H__
...
class EpbRspecDebugBusCtrlMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  EpbRspecDebugBusCtrlMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_epb_prsr4_reg), 4, true, write_callback, read_callback, std::string("EpbRspecDebugBusCtrlMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_epb_prsr4_reg))
    {
    }
  EpbRspecDebugBusCtrlMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "EpbRspecDebugBusCtrlMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("EpbRspecDebugBusCtrlMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0xf6c; // to get to debug_bus_ctrl
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_EPB_RSPEC_DEBUG_BUS_CTRL_MUTABLE_H__
