...
#ifndef __REGISTER_INCLUDES_EPB_RSPEC_MUTABLE_H__
#define __REGISTER_INCLUDES_EPB_RSPEC_MUTABLE_H__
...
#include "epb_glb_group_mutable.h"
#include "epb_rspec_chan0_group_mutable.h"
#include "epb_rspec_chan1_group_mutable.h"
#include "epb_rspec_chan2_group_mutable.h"
#include "epb_rspec_chan3_group_mutable.h"
#include "epb_rspec_chan4_group_mutable.h"
#include "epb_rspec_chan5_group_mutable.h"
#include "epb_rspec_chan6_group_mutable.h"
#include "epb_rspec_chan7_group_mutable.h"
#include "epb_rspec_debug_bus_ctrl_mutable.h"

namespace jbayB0 {
  namespace register_classes {

class EpbRspecMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  EpbRspecMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_epb_prsr4_reg), 4096, true, write_callback, read_callback, std::string("EpbRspecMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_epb_prsr4_reg))
    {
    }
  EpbRspecMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "EpbRspecMutable")
    {
    }
public:
  ...
  EpbRspecDebugBusCtrlMutable &debug_bus_ctrl() { return debug_bus_ctrl_; }





  EpbGlbGroupMutable &glb_group() { return glb_group_; }





  EpbRspecChan0GroupMutable &chan0_group() { return chan0_group_; }





  EpbRspecChan1GroupMutable &chan1_group() { return chan1_group_; }





  EpbRspecChan2GroupMutable &chan2_group() { return chan2_group_; }





  EpbRspecChan3GroupMutable &chan3_group() { return chan3_group_; }





  EpbRspecChan4GroupMutable &chan4_group() { return chan4_group_; }





  EpbRspecChan5GroupMutable &chan5_group() { return chan5_group_; }





  EpbRspecChan6GroupMutable &chan6_group() { return chan6_group_; }





  EpbRspecChan7GroupMutable &chan7_group() { return chan7_group_; }
...
private:
  EpbRspecDebugBusCtrlMutable debug_bus_ctrl_;
  EpbGlbGroupMutable glb_group_;
  EpbRspecChan0GroupMutable chan0_group_;
  EpbRspecChan1GroupMutable chan1_group_;
  EpbRspecChan2GroupMutable chan2_group_;
  EpbRspecChan3GroupMutable chan3_group_;
  EpbRspecChan4GroupMutable chan4_group_;
  EpbRspecChan5GroupMutable chan5_group_;
  EpbRspecChan6GroupMutable chan6_group_;
  EpbRspecChan7GroupMutable chan7_group_;
private:
...
#endif // __REGISTER_INCLUDES_EPB_RSPEC_MUTABLE_H__
