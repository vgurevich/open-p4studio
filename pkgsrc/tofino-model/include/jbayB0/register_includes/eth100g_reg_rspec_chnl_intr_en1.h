...
#ifndef __REGISTER_INCLUDES_ETH100G_REG_RSPEC_CHNL_INTR_EN1_H__
#define __REGISTER_INCLUDES_ETH100G_REG_RSPEC_CHNL_INTR_EN1_H__
...
class Eth100gRegRspecChnlIntrEn1 : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum JbayRegEnum {
    kEth100gRegs,
    kEth100gRegsRot
...
public:
  Eth100gRegRspecChnlIntrEn1(
      int chipNumber, JbayRegEnum selector_jbay_reg, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(selector_jbay_reg), 4, false, write_callback, read_callback, std::string("Eth100gRegRspecChnlIntrEn1")+":"+boost::lexical_cast<std::string>(selector_jbay_reg))
    {
    }
  Eth100gRegRspecChnlIntrEn1(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "Eth100gRegRspecChnlIntrEn1")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("Eth100gRegRspecChnlIntrEn1") + ":\n";
...
#endif // __REGISTER_INCLUDES_ETH100G_REG_RSPEC_CHNL_INTR_EN1_H__
