...
#ifndef __REGISTER_INCLUDES_ETH100G_REG_RSPEC_MEM_INTR_EN1_MUTABLE_H__
#define __REGISTER_INCLUDES_ETH100G_REG_RSPEC_MEM_INTR_EN1_MUTABLE_H__
...
class Eth100gRegRspecMemIntrEn1Mutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum JbayRegEnum {
    kEth100gRegs,
    kEth100gRegsRot
...
public:
  Eth100gRegRspecMemIntrEn1Mutable(
      int chipNumber, JbayRegEnum selector_jbay_reg, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(selector_jbay_reg), 4, true, write_callback, read_callback, std::string("Eth100gRegRspecMemIntrEn1Mutable")+":"+boost::lexical_cast<std::string>(selector_jbay_reg))
    {
    }
  Eth100gRegRspecMemIntrEn1Mutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "Eth100gRegRspecMemIntrEn1Mutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("Eth100gRegRspecMemIntrEn1Mutable") + ":\n";
  ...
  static int StartOffset(
    ...
    switch (selector_jbay_reg) {
      case kEth100gRegs:
        ...
        offset += 0x108; // to get to mem_intr_en1
        break;
...
#endif // __REGISTER_INCLUDES_ETH100G_REG_RSPEC_MEM_INTR_EN1_MUTABLE_H__
