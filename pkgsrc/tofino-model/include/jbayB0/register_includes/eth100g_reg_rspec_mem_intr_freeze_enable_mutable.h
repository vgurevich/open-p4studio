...
#ifndef __REGISTER_INCLUDES_ETH100G_REG_RSPEC_MEM_INTR_FREEZE_ENABLE_MUTABLE_H__
#define __REGISTER_INCLUDES_ETH100G_REG_RSPEC_MEM_INTR_FREEZE_ENABLE_MUTABLE_H__
...
class Eth100gRegRspecMemIntrFreezeEnableMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum JbayRegEnum {
    kEth100gRegs,
    kEth100gRegsRot
...
public:
  Eth100gRegRspecMemIntrFreezeEnableMutable(
      int chipNumber, JbayRegEnum selector_jbay_reg, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(selector_jbay_reg), 4, true, write_callback, read_callback, std::string("Eth100gRegRspecMemIntrFreezeEnableMutable")+":"+boost::lexical_cast<std::string>(selector_jbay_reg))
    {
    }
  Eth100gRegRspecMemIntrFreezeEnableMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "Eth100gRegRspecMemIntrFreezeEnableMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("Eth100gRegRspecMemIntrFreezeEnableMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_ETH100G_REG_RSPEC_MEM_INTR_FREEZE_ENABLE_MUTABLE_H__
