...
#ifndef __REGISTER_INCLUDES_ETH100G_REG_RSPEC_TV80_DEBUG_CTRL_H__
#define __REGISTER_INCLUDES_ETH100G_REG_RSPEC_TV80_DEBUG_CTRL_H__
...
class Eth100gRegRspecTv80DebugCtrl : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum JbayRegEnum {
    kEth100gRegs,
    kEth100gRegsRot
...
public:
  Eth100gRegRspecTv80DebugCtrl(
      int chipNumber, JbayRegEnum selector_jbay_reg, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(selector_jbay_reg), 4, false, write_callback, read_callback, std::string("Eth100gRegRspecTv80DebugCtrl")+":"+boost::lexical_cast<std::string>(selector_jbay_reg))
    {
    }
  Eth100gRegRspecTv80DebugCtrl(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "Eth100gRegRspecTv80DebugCtrl")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("Eth100gRegRspecTv80DebugCtrl") + ":\n";
...
#endif // __REGISTER_INCLUDES_ETH100G_REG_RSPEC_TV80_DEBUG_CTRL_H__
