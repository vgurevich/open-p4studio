...
#ifndef __REGISTER_INCLUDES_ETH100G_REG_RSPEC_TXFF_CTRL_MUTABLE_H__
#define __REGISTER_INCLUDES_ETH100G_REG_RSPEC_TXFF_CTRL_MUTABLE_H__
...
class Eth100gRegRspecTxffCtrlMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum JbayRegEnum {
    kEth100gRegs,
    kEth100gRegsRot
...
public:
  Eth100gRegRspecTxffCtrlMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_jbay_reg, index_eth100g_reg_rspec_txff_ctrl), 4, true, write_callback, read_callback, std::string("Eth100gRegRspecTxffCtrlMutable")+":"+boost::lexical_cast<std::string>(selector_jbay_reg) + "," + boost::lexical_cast<std::string>(index_eth100g_reg_rspec_txff_ctrl))
    {
    }
  Eth100gRegRspecTxffCtrlMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "Eth100gRegRspecTxffCtrlMutable")
    {
    }
public:
  ...
  void en_rx_xoff(const uint8_t &v) { en_rx_xoff_=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("Eth100gRegRspecTxffCtrlMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_ETH100G_REG_RSPEC_TXFF_CTRL_MUTABLE_H__
