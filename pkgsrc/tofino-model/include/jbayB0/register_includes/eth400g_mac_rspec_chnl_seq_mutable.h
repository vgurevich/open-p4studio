...
#ifndef __REGISTER_INCLUDES_ETH400G_MAC_RSPEC_CHNL_SEQ_MUTABLE_H__
#define __REGISTER_INCLUDES_ETH400G_MAC_RSPEC_CHNL_SEQ_MUTABLE_H__
...
class Eth400gMacRspecChnlSeqMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum JbayRegEnum {
    kEth400gP1,
    kEth400gP10,
...
public:
  Eth400gMacRspecChnlSeqMutable(
      int chipNumber, JbayRegEnum selector_jbay_reg, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(selector_jbay_reg), 4, true, write_callback, read_callback, std::string("Eth400gMacRspecChnlSeqMutable")+":"+boost::lexical_cast<std::string>(selector_jbay_reg))
    {
    }
  Eth400gMacRspecChnlSeqMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "Eth400gMacRspecChnlSeqMutable")
    {
    }
public:
  ...
  uint32_t chnl_seq() { return chnl_seq_; }
  void chnl_seq(const uint32_t &v) { chnl_seq_=v; }
  ...
  void sel_buf_seq(const uint8_t &v) { sel_buf_seq_=v; }

  bool read(
      uint32_t offset, uint32_t* data
      ) const {
    if (read_callback_) read_callback_();
    *data = (chnl_seq_ & 0xffffff);
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("Eth400gMacRspecChnlSeqMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_ETH400G_MAC_RSPEC_CHNL_SEQ_MUTABLE_H__
