...
#ifndef __REGISTER_INCLUDES_ETH400G_MAC_RSPEC_ETH_ONESTEP_ETS_OFFSET_CTRL_ARRAY_H__
#define __REGISTER_INCLUDES_ETH400G_MAC_RSPEC_ETH_ONESTEP_ETS_OFFSET_CTRL_ARRAY_H__
...
class Eth400gMacRspecEthOnestepEtsOffsetCtrlArray : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  enum JbayRegEnum {
    kEth400gP1,
    kEth400gP10,
...
public:
  Eth400gMacRspecEthOnestepEtsOffsetCtrlArray(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_jbay_reg), 8 * ArraySize(selector_jbay_reg, -1), false, write_callback, read_callback, std::string("Eth400gMacRspecEthOnestepEtsOffsetCtrlArray")+":"+boost::lexical_cast<std::string>(selector_jbay_reg)),
...
public:
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("Eth400gMacRspecEthOnestepEtsOffsetCtrlArray") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
private:
  std::vector<Eth400gMacRspecEthOnestepEtsOffsetCtrl> array;
  uint32_t size0_;
...
#endif // __REGISTER_INCLUDES_ETH400G_MAC_RSPEC_ETH_ONESTEP_ETS_OFFSET_CTRL_ARRAY_H__
