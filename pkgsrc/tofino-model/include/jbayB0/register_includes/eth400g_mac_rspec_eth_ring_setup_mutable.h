...
#ifndef __REGISTER_INCLUDES_ETH400G_MAC_RSPEC_ETH_RING_SETUP_MUTABLE_H__
#define __REGISTER_INCLUDES_ETH400G_MAC_RSPEC_ETH_RING_SETUP_MUTABLE_H__
...
class Eth400gMacRspecEthRingSetupMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum JbayRegEnum {
    kEth400gP1,
    kEth400gP10,
...
public:
  Eth400gMacRspecEthRingSetupMutable(
      int chipNumber, JbayRegEnum selector_jbay_reg, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(selector_jbay_reg), 4, true, write_callback, read_callback, std::string("Eth400gMacRspecEthRingSetupMutable")+":"+boost::lexical_cast<std::string>(selector_jbay_reg))
    {
    }
  Eth400gMacRspecEthRingSetupMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "Eth400gMacRspecEthRingSetupMutable")
    {
    }
public:
  ...
  void ring_id(const uint8_t &v) { ring_id_=v; }
  ...
  void ring_sel(const uint8_t &v) { ring_sel_=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("Eth400gMacRspecEthRingSetupMutable") + ":\n";
  ...
  static int StartOffset(
    ...
    switch (selector_jbay_reg) {
      case kEth400gP1:
        ...
        offset += 0x190; // to get to eth_ring_setup
        break;
      case kEth400gP10:
...
#endif // __REGISTER_INCLUDES_ETH400G_MAC_RSPEC_ETH_RING_SETUP_MUTABLE_H__
