...
#ifndef __REGISTER_INCLUDES_ETH400G_MAC_RSPEC_GLOBAL_INTR_STAT_MUTABLE_H__
#define __REGISTER_INCLUDES_ETH400G_MAC_RSPEC_GLOBAL_INTR_STAT_MUTABLE_H__
...
class Eth400gMacRspecGlobalIntrStatMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum JbayRegEnum {
    kEth400gP1,
    kEth400gP10,
...
public:
  Eth400gMacRspecGlobalIntrStatMutable(
      int chipNumber, JbayRegEnum selector_jbay_reg, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(selector_jbay_reg), 4, true, write_callback, read_callback, std::string("Eth400gMacRspecGlobalIntrStatMutable")+":"+boost::lexical_cast<std::string>(selector_jbay_reg))
    {
    }
  Eth400gMacRspecGlobalIntrStatMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "Eth400gMacRspecGlobalIntrStatMutable")
    {
    }
public:
  ...
  uint8_t intr_lo_stat() { return intr_lo_stat_; }
  void intr_lo_stat(const uint8_t &v) { intr_lo_stat_=v; }
  ...
  uint8_t intr_hi_stat() { return intr_hi_stat_; }
  void intr_hi_stat(const uint8_t &v) { intr_hi_stat_=v; }

  bool read(
      uint32_t offset, uint32_t* data
      ) const {
    if (read_callback_) read_callback_();
    *data = (intr_lo_stat_ & 0x7f);
    *data |= ((intr_hi_stat_ & 0x7f) << 8);
    return true;
  }
  ...
  bool write(
    ...
    intr_lo_stat_ = (data & 0x7f);
    intr_hi_stat_ = ((data >> 8) & 0x7f);
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("Eth400gMacRspecGlobalIntrStatMutable") + ":\n";
    r += indent_string + "  " + std::string("intr_lo_stat") +  ": 0x" + boost::str( boost::format("%x") % static_cast<uint>(intr_lo_stat_) ) + "\n";
    all_zeros &= (0 == intr_lo_stat_);
    r += indent_string + "  " + std::string("intr_hi_stat") +  ": 0x" + boost::str( boost::format("%x") % static_cast<uint>(intr_hi_stat_) ) + "\n";
    all_zeros &= (0 == intr_hi_stat_);
...
private:
  uint8_t intr_lo_stat_;
  uint8_t intr_hi_stat_;
private:
  static int StartOffset(
    ...
    switch (selector_jbay_reg) {
      case kEth400gP1:
        ...
        offset += 0x90; // to get to global_intr_stat
        break;
      case kEth400gP10:
...
#endif // __REGISTER_INCLUDES_ETH400G_MAC_RSPEC_GLOBAL_INTR_STAT_MUTABLE_H__
