...
#ifndef __REGISTER_INCLUDES_ETH400G_MAC_RSPEC_MAC_EN0_H__
#define __REGISTER_INCLUDES_ETH400G_MAC_RSPEC_MAC_EN0_H__
...
class Eth400gMacRspecMacEn0 : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum JbayRegEnum {
    kEth400gP1,
    kEth400gP10,
...
public:
  Eth400gMacRspecMacEn0(
      int chipNumber, JbayRegEnum selector_jbay_reg, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(selector_jbay_reg), 4, false, write_callback, read_callback, std::string("Eth400gMacRspecMacEn0")+":"+boost::lexical_cast<std::string>(selector_jbay_reg))
    {
    }
  Eth400gMacRspecMacEn0(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "Eth400gMacRspecMacEn0")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("Eth400gMacRspecMacEn0") + ":\n";
...
#endif // __REGISTER_INCLUDES_ETH400G_MAC_RSPEC_MAC_EN0_H__
