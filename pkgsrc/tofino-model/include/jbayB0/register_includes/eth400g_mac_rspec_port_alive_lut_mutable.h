...
#ifndef __REGISTER_INCLUDES_ETH400G_MAC_RSPEC_PORT_ALIVE_LUT_MUTABLE_H__
#define __REGISTER_INCLUDES_ETH400G_MAC_RSPEC_PORT_ALIVE_LUT_MUTABLE_H__
...
class Eth400gMacRspecPortAliveLutMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum JbayRegEnum {
    kEth400gP1,
    kEth400gP10,
...
public:
  Eth400gMacRspecPortAliveLutMutable(
      int chipNumber, JbayRegEnum selector_jbay_reg, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(selector_jbay_reg), 4, true, write_callback, read_callback, std::string("Eth400gMacRspecPortAliveLutMutable")+":"+boost::lexical_cast<std::string>(selector_jbay_reg))
    {
    }
  Eth400gMacRspecPortAliveLutMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "Eth400gMacRspecPortAliveLutMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("Eth400gMacRspecPortAliveLutMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_ETH400G_MAC_RSPEC_PORT_ALIVE_LUT_MUTABLE_H__
