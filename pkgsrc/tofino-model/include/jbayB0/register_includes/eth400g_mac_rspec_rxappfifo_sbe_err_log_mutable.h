...
#ifndef __REGISTER_INCLUDES_ETH400G_MAC_RSPEC_RXAPPFIFO_SBE_ERR_LOG_MUTABLE_H__
#define __REGISTER_INCLUDES_ETH400G_MAC_RSPEC_RXAPPFIFO_SBE_ERR_LOG_MUTABLE_H__
...
class Eth400gMacRspecRxappfifoSbeErrLogMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum JbayRegEnum {
    kEth400gP1,
    kEth400gP10,
...
public:
  Eth400gMacRspecRxappfifoSbeErrLogMutable(
      int chipNumber, JbayRegEnum selector_jbay_reg, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(selector_jbay_reg), 4, true, write_callback, read_callback, std::string("Eth400gMacRspecRxappfifoSbeErrLogMutable")+":"+boost::lexical_cast<std::string>(selector_jbay_reg))
    {
    }
  Eth400gMacRspecRxappfifoSbeErrLogMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "Eth400gMacRspecRxappfifoSbeErrLogMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("Eth400gMacRspecRxappfifoSbeErrLogMutable") + ":\n";
  ...
  static int StartOffset(
    ...
    switch (selector_jbay_reg) {
      case kEth400gP1:
        ...
        offset += 0x234; // to get to rxappfifo_sbe_err_log
        break;
      case kEth400gP10:
...
#endif // __REGISTER_INCLUDES_ETH400G_MAC_RSPEC_RXAPPFIFO_SBE_ERR_LOG_MUTABLE_H__
