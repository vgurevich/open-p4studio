...
#ifndef __REGISTER_INCLUDES_ETH400G_MAC_RSPEC_RXPKT_ERR_STS_H__
#define __REGISTER_INCLUDES_ETH400G_MAC_RSPEC_RXPKT_ERR_STS_H__
...
class Eth400gMacRspecRxpktErrSts : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum JbayRegEnum {
    kEth400gP1,
    kEth400gP10,
...
public:
  Eth400gMacRspecRxpktErrSts(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_jbay_reg, index_eth400g_mac_rspec_rxpkt_err_sts), 4, false, write_callback, read_callback, std::string("Eth400gMacRspecRxpktErrSts")+":"+boost::lexical_cast<std::string>(selector_jbay_reg) + "," + boost::lexical_cast<std::string>(index_eth400g_mac_rspec_rxpkt_err_sts))
    {
    }
  Eth400gMacRspecRxpktErrSts(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "Eth400gMacRspecRxpktErrSts")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("Eth400gMacRspecRxpktErrSts") + ":\n";
...
#endif // __REGISTER_INCLUDES_ETH400G_MAC_RSPEC_RXPKT_ERR_STS_H__
