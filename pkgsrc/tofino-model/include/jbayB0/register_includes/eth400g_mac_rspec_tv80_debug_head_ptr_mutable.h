...
#ifndef __REGISTER_INCLUDES_ETH400G_MAC_RSPEC_TV80_DEBUG_HEAD_PTR_MUTABLE_H__
#define __REGISTER_INCLUDES_ETH400G_MAC_RSPEC_TV80_DEBUG_HEAD_PTR_MUTABLE_H__
...
class Eth400gMacRspecTv80DebugHeadPtrMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum JbayRegEnum {
    kEth400gP1,
    kEth400gP10,
...
public:
  Eth400gMacRspecTv80DebugHeadPtrMutable(
      int chipNumber, JbayRegEnum selector_jbay_reg, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(selector_jbay_reg), 4, true, write_callback, read_callback, std::string("Eth400gMacRspecTv80DebugHeadPtrMutable")+":"+boost::lexical_cast<std::string>(selector_jbay_reg))
    {
    }
  Eth400gMacRspecTv80DebugHeadPtrMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "Eth400gMacRspecTv80DebugHeadPtrMutable")
    {
    }
public:
  ...
  uint16_t head_ptr() { return head_ptr_; }
  void head_ptr(const uint16_t &v) { head_ptr_=v; }

  bool read(
      uint32_t offset, uint32_t* data
      ) const {
    if (read_callback_) read_callback_();
    *data = (head_ptr_ & 0xfff);
    return true;
  }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("Eth400gMacRspecTv80DebugHeadPtrMutable") + ":\n";
    r += indent_string + "  " + std::string("head_ptr") +  ": 0x" + boost::str( boost::format("%x") % static_cast<uint>(head_ptr_) ) + "\n";
    all_zeros &= (0 == head_ptr_);
  ...
  static int StartOffset(
    ...
    switch (selector_jbay_reg) {
      case kEth400gP1:
        ...
        offset += 0x278; // to get to tv80_debug_head_ptr
        break;
      case kEth400gP10:
...
#endif // __REGISTER_INCLUDES_ETH400G_MAC_RSPEC_TV80_DEBUG_HEAD_PTR_MUTABLE_H__
