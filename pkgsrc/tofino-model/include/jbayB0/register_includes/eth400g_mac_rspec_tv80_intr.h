...
#ifndef __REGISTER_INCLUDES_ETH400G_MAC_RSPEC_TV80_INTR_H__
#define __REGISTER_INCLUDES_ETH400G_MAC_RSPEC_TV80_INTR_H__
...
#include "eth400g_mac_rspec_tv80_intr_en0.h"
#include "eth400g_mac_rspec_tv80_intr_en1.h"
#include "eth400g_mac_rspec_tv80_intr_freeze_enable.h"
#include "eth400g_mac_rspec_tv80_intr_inj.h"
#include "eth400g_mac_rspec_tv80_intr_stat.h"

namespace jbayB0 {
  namespace register_classes {

class Eth400gMacRspecTv80Intr : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum JbayRegEnum {
    kEth400gP1,
    kEth400gP10,
...
public:
  Eth400gMacRspecTv80Intr(
      int chipNumber, JbayRegEnum selector_jbay_reg, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(selector_jbay_reg), 20, false, write_callback, read_callback, std::string("Eth400gMacRspecTv80Intr")+":"+boost::lexical_cast<std::string>(selector_jbay_reg))
    {
    }
  Eth400gMacRspecTv80Intr(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "Eth400gMacRspecTv80Intr")
    {
    }
public:
  ...
  Eth400gMacRspecTv80IntrStat &tv80_intr_stat() { return tv80_intr_stat_; }
  ...
  Eth400gMacRspecTv80IntrEn0 &tv80_intr_en0() { return tv80_intr_en0_; }
  ...
  Eth400gMacRspecTv80IntrEn1 &tv80_intr_en1() { return tv80_intr_en1_; }
  ...
  Eth400gMacRspecTv80IntrInj &tv80_intr_inj() { return tv80_intr_inj_; }





  Eth400gMacRspecTv80IntrFreezeEnable &tv80_intr_freeze_enable() { return tv80_intr_freeze_enable_; }
...
private:
  Eth400gMacRspecTv80IntrStat tv80_intr_stat_;
  Eth400gMacRspecTv80IntrEn0 tv80_intr_en0_;
  Eth400gMacRspecTv80IntrEn1 tv80_intr_en1_;
  Eth400gMacRspecTv80IntrInj tv80_intr_inj_;
  Eth400gMacRspecTv80IntrFreezeEnable tv80_intr_freeze_enable_;
private:
...
#endif // __REGISTER_INCLUDES_ETH400G_MAC_RSPEC_TV80_INTR_H__
