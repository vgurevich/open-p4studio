...
#ifndef __REGISTER_INCLUDES_ETH400G_MAC_RSPEC_TV80_INTR_MUTABLE_H__
#define __REGISTER_INCLUDES_ETH400G_MAC_RSPEC_TV80_INTR_MUTABLE_H__
...
#include "eth400g_mac_rspec_tv80_intr_en0_mutable.h"
#include "eth400g_mac_rspec_tv80_intr_en1_mutable.h"
#include "eth400g_mac_rspec_tv80_intr_freeze_enable_mutable.h"
#include "eth400g_mac_rspec_tv80_intr_inj_mutable.h"
#include "eth400g_mac_rspec_tv80_intr_stat_mutable.h"

namespace jbayB0 {
  namespace register_classes {

class Eth400gMacRspecTv80IntrMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum JbayRegEnum {
    kEth400gP1,
    kEth400gP10,
...
public:
  Eth400gMacRspecTv80IntrMutable(
      int chipNumber, JbayRegEnum selector_jbay_reg, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(selector_jbay_reg), 20, true, write_callback, read_callback, std::string("Eth400gMacRspecTv80IntrMutable")+":"+boost::lexical_cast<std::string>(selector_jbay_reg))
    {
    }
  Eth400gMacRspecTv80IntrMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "Eth400gMacRspecTv80IntrMutable")
    {
    }
public:
  ...
  Eth400gMacRspecTv80IntrStatMutable &tv80_intr_stat() { return tv80_intr_stat_; }
  ...
  Eth400gMacRspecTv80IntrEn0Mutable &tv80_intr_en0() { return tv80_intr_en0_; }
  ...
  Eth400gMacRspecTv80IntrEn1Mutable &tv80_intr_en1() { return tv80_intr_en1_; }
  ...
  Eth400gMacRspecTv80IntrInjMutable &tv80_intr_inj() { return tv80_intr_inj_; }





  Eth400gMacRspecTv80IntrFreezeEnableMutable &tv80_intr_freeze_enable() { return tv80_intr_freeze_enable_; }

  bool read(
      uint32_t offset, uint32_t* data
      ) const {
    if (offset >= 0x260 && offset < 0x264) {
      offset -= 0x260;
...
private:
  Eth400gMacRspecTv80IntrStatMutable tv80_intr_stat_;
  Eth400gMacRspecTv80IntrEn0Mutable tv80_intr_en0_;
  Eth400gMacRspecTv80IntrEn1Mutable tv80_intr_en1_;
  Eth400gMacRspecTv80IntrInjMutable tv80_intr_inj_;
  Eth400gMacRspecTv80IntrFreezeEnableMutable tv80_intr_freeze_enable_;
private:
...
#endif // __REGISTER_INCLUDES_ETH400G_MAC_RSPEC_TV80_INTR_MUTABLE_H__
