...
#ifndef __REGISTER_INCLUDES_ETH400G_MAC_RSPEC_TXAPPFIFO_MBE_ERR_LOG_MUTABLE_H__
#define __REGISTER_INCLUDES_ETH400G_MAC_RSPEC_TXAPPFIFO_MBE_ERR_LOG_MUTABLE_H__
...
class Eth400gMacRspecTxappfifoMbeErrLogMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum JbayRegEnum {
    kEth400gP1,
    kEth400gP10,
...
public:
  Eth400gMacRspecTxappfifoMbeErrLogMutable(
      int chipNumber, JbayRegEnum selector_jbay_reg, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(selector_jbay_reg), 4, true, write_callback, read_callback, std::string("Eth400gMacRspecTxappfifoMbeErrLogMutable")+":"+boost::lexical_cast<std::string>(selector_jbay_reg))
    {
    }
  Eth400gMacRspecTxappfifoMbeErrLogMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "Eth400gMacRspecTxappfifoMbeErrLogMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("Eth400gMacRspecTxappfifoMbeErrLogMutable") + ":\n";
  ...
  static int StartOffset(
    ...
    switch (selector_jbay_reg) {
      case kEth400gP1:
        ...
        offset += 0x230; // to get to txappfifo_mbe_err_log
        break;
      case kEth400gP10:
...
#endif // __REGISTER_INCLUDES_ETH400G_MAC_RSPEC_TXAPPFIFO_MBE_ERR_LOG_MUTABLE_H__
