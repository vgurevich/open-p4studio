...
#ifndef __REGISTER_INCLUDES_ETH400G_MAC_RSPEC_TXCRC_TRUNC_CTRL_ARRAY_H__
#define __REGISTER_INCLUDES_ETH400G_MAC_RSPEC_TXCRC_TRUNC_CTRL_ARRAY_H__
...
class Eth400gMacRspecTxcrcTruncCtrlArray : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  enum JbayRegEnum {
    kEth400gP1,
    kEth400gP10,
...
public:
  Eth400gMacRspecTxcrcTruncCtrlArray(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_jbay_reg), 4 * ArraySize(selector_jbay_reg, -1), false, write_callback, read_callback, std::string("Eth400gMacRspecTxcrcTruncCtrlArray")+":"+boost::lexical_cast<std::string>(selector_jbay_reg)),
...
public:
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("Eth400gMacRspecTxcrcTruncCtrlArray") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
private:
  std::vector<Eth400gMacRspecTxcrcTruncCtrl> array;
  uint32_t size0_;
...
#endif // __REGISTER_INCLUDES_ETH400G_MAC_RSPEC_TXCRC_TRUNC_CTRL_ARRAY_H__
