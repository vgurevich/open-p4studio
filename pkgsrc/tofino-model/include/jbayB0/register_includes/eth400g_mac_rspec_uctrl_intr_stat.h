...
#ifndef __REGISTER_INCLUDES_ETH400G_MAC_RSPEC_UCTRL_INTR_STAT_H__
#define __REGISTER_INCLUDES_ETH400G_MAC_RSPEC_UCTRL_INTR_STAT_H__
...
class Eth400gMacRspecUctrlIntrStat : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum JbayRegEnum {
    kEth400gP1,
    kEth400gP10,
...
public:
  Eth400gMacRspecUctrlIntrStat(
      int chipNumber, JbayRegEnum selector_jbay_reg, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(selector_jbay_reg), 4, false, write_callback, read_callback, std::string("Eth400gMacRspecUctrlIntrStat")+":"+boost::lexical_cast<std::string>(selector_jbay_reg))
    {
    }
  Eth400gMacRspecUctrlIntrStat(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "Eth400gMacRspecUctrlIntrStat")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("Eth400gMacRspecUctrlIntrStat") + ":\n";
...
#endif // __REGISTER_INCLUDES_ETH400G_MAC_RSPEC_UCTRL_INTR_STAT_H__
