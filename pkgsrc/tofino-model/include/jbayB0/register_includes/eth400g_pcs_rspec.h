...
#ifndef __REGISTER_INCLUDES_ETH400G_PCS_RSPEC_H__
#define __REGISTER_INCLUDES_ETH400G_PCS_RSPEC_H__
...
#include "eth400g_pcs_rspec_deskew_ecc.h"
#include "eth400g_pcs_rspec_deskew_mbe_err_log.h"
#include "eth400g_pcs_rspec_deskew_sbe_err_log.h"
#include "eth400g_pcs_rspec_eth_clkobs_ctrl.h"
#include "eth400g_pcs_rspec_eth_mdioci_ctrl.h"
#include "eth400g_pcs_rspec_eth_mdioci_poll_ctrl.h"
#include "eth400g_pcs_rspec_eth_mdioci_poll_time.h"
#include "eth400g_pcs_rspec_eth_ppm_ctrl.h"
#include "eth400g_pcs_rspec_eth_ppm_sel.h"
#include "eth400g_pcs_rspec_eth_ppm_stat.h"
#include "eth400g_pcs_rspec_eth_rxsigok_bitsel.h"
#include "eth400g_pcs_rspec_eth_rxsigok_ctrl.h"
#include "eth400g_pcs_rspec_eth_soft_reset.h"
#include "eth400g_pcs_rspec_mdioci_en0.h"
#include "eth400g_pcs_rspec_mdioci_en1.h"
#include "eth400g_pcs_rspec_mdioci_freeze_enable.h"
#include "eth400g_pcs_rspec_mdioci_intr_stat.h"
#include "eth400g_pcs_rspec_mem_intr.h"
#include "eth400g_pcs_rspec_rsfec01_ecc.h"
#include "eth400g_pcs_rspec_rsfec23_ecc.h"
#include "eth400g_pcs_rspec_rsfec_mbe_err_log.h"
#include "eth400g_pcs_rspec_rsfec_sbe_err_log.h"
#include "eth400g_pcs_rspec_rxsds_mode.h"
#include "eth400g_pcs_rspec_sds_112g.h"
#include "eth400g_pcs_rspec_txsds_mode.h"

namespace jbayB0 {
  namespace register_classes {

class Eth400gPcsRspec : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum JbayRegEnum {
    kEth400gP1,
    kEth400gP10,
...
public:
  Eth400gPcsRspec(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_jbay_reg), 152, false, write_callback, read_callback, std::string("Eth400gPcsRspec")+":"+boost::lexical_cast<std::string>(selector_jbay_reg))
    {
    }
  Eth400gPcsRspec(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "Eth400gPcsRspec")
    {
    }
public:
  ...
  Eth400gPcsRspecEthSoftReset &eth_soft_reset() { return eth_soft_reset_; }





  Eth400gPcsRspecEthClkobsCtrl &eth_clkobs_ctrl() { return eth_clkobs_ctrl_; }
  ...
  Eth400gPcsRspecEthRxsigokCtrl &eth_rxsigok_ctrl() { return eth_rxsigok_ctrl_; }
  ...
  Eth400gPcsRspecEthMdiociCtrl &eth_mdioci_ctrl() { return eth_mdioci_ctrl_; }
  ...
  Eth400gPcsRspecEthMdiociPollCtrl &eth_mdioci_poll_ctrl() { return eth_mdioci_poll_ctrl_; }





  Eth400gPcsRspecEthMdiociPollTime &eth_mdioci_poll_time() { return eth_mdioci_poll_time_; }





  Eth400gPcsRspecEthRxsigokBitsel &eth_rxsigok_bitsel() { return eth_rxsigok_bitsel_; }
  ...
  Eth400gPcsRspecDeskewEcc &deskew_ecc() { return deskew_ecc_; }
  ...
  Eth400gPcsRspecRsfec01Ecc &rsfec01_ecc() { return rsfec01_ecc_; }
  ...
  Eth400gPcsRspecRsfec23Ecc &rsfec23_ecc() { return rsfec23_ecc_; }





  Eth400gPcsRspecDeskewSbeErrLog &deskew_sbe_err_log() { return deskew_sbe_err_log_; }





  Eth400gPcsRspecDeskewMbeErrLog &deskew_mbe_err_log() { return deskew_mbe_err_log_; }
  ...
  Eth400gPcsRspecRsfecSbeErrLog &rsfec_sbe_err_log() { return rsfec_sbe_err_log_; }





  Eth400gPcsRspecRsfecMbeErrLog &rsfec_mbe_err_log() { return rsfec_mbe_err_log_; }





  Eth400gPcsRspecMdiociIntrStat &mdioci_intr_stat() { return mdioci_intr_stat_; }
  ...
  Eth400gPcsRspecMdiociEn0 &mdioci_en0() { return mdioci_en0_; }
  ...
  Eth400gPcsRspecMdiociEn1 &mdioci_en1() { return mdioci_en1_; }





  Eth400gPcsRspecMdiociFreezeEnable &mdioci_freeze_enable() { return mdioci_freeze_enable_; }





  Eth400gPcsRspecTxsdsMode &txsds_mode() { return txsds_mode_; }





  Eth400gPcsRspecRxsdsMode &rxsds_mode() { return rxsds_mode_; }
  ...
  Eth400gPcsRspecSds_112g &sds_112g() { return sds_112g_; }





  Eth400gPcsRspecEthPpmSel &eth_ppm_sel() { return eth_ppm_sel_; }





  Eth400gPcsRspecEthPpmCtrl &eth_ppm_ctrl() { return eth_ppm_ctrl_; }





  Eth400gPcsRspecEthPpmStat &eth_ppm_stat() { return eth_ppm_stat_; }
  Eth400gPcsRspecMemIntr &mem_intr() { return mem_intr_; }
...
private:
  Eth400gPcsRspecEthSoftReset eth_soft_reset_;
  Eth400gPcsRspecEthClkobsCtrl eth_clkobs_ctrl_;
  Eth400gPcsRspecEthRxsigokCtrl eth_rxsigok_ctrl_;
  Eth400gPcsRspecEthMdiociCtrl eth_mdioci_ctrl_;
  Eth400gPcsRspecEthMdiociPollCtrl eth_mdioci_poll_ctrl_;
  Eth400gPcsRspecEthMdiociPollTime eth_mdioci_poll_time_;
  Eth400gPcsRspecEthRxsigokBitsel eth_rxsigok_bitsel_;
  Eth400gPcsRspecDeskewEcc deskew_ecc_;
  Eth400gPcsRspecRsfec01Ecc rsfec01_ecc_;
  Eth400gPcsRspecRsfec23Ecc rsfec23_ecc_;
  Eth400gPcsRspecDeskewSbeErrLog deskew_sbe_err_log_;
  Eth400gPcsRspecDeskewMbeErrLog deskew_mbe_err_log_;
  Eth400gPcsRspecRsfecSbeErrLog rsfec_sbe_err_log_;
  Eth400gPcsRspecRsfecMbeErrLog rsfec_mbe_err_log_;
  Eth400gPcsRspecMdiociIntrStat mdioci_intr_stat_;
  Eth400gPcsRspecMdiociEn0 mdioci_en0_;
  Eth400gPcsRspecMdiociEn1 mdioci_en1_;
  Eth400gPcsRspecMdiociFreezeEnable mdioci_freeze_enable_;
  Eth400gPcsRspecTxsdsMode txsds_mode_;
  Eth400gPcsRspecRxsdsMode rxsds_mode_;
  Eth400gPcsRspecSds_112g sds_112g_;
  Eth400gPcsRspecEthPpmSel eth_ppm_sel_;
  Eth400gPcsRspecEthPpmCtrl eth_ppm_ctrl_;
  Eth400gPcsRspecEthPpmStat eth_ppm_stat_;
  Eth400gPcsRspecMemIntr mem_intr_;
private:
...
#endif // __REGISTER_INCLUDES_ETH400G_PCS_RSPEC_H__
