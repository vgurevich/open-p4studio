...
#ifndef __REGISTER_INCLUDES_ETH400G_PCS_RSPEC_DESKEW_MBE_ERR_LOG_MUTABLE_H__
#define __REGISTER_INCLUDES_ETH400G_PCS_RSPEC_DESKEW_MBE_ERR_LOG_MUTABLE_H__
...
class Eth400gPcsRspecDeskewMbeErrLogMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum JbayRegEnum {
    kEth400gP1,
    kEth400gP10,
...
public:
  Eth400gPcsRspecDeskewMbeErrLogMutable(
      int chipNumber, JbayRegEnum selector_jbay_reg, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(selector_jbay_reg), 4, true, write_callback, read_callback, std::string("Eth400gPcsRspecDeskewMbeErrLogMutable")+":"+boost::lexical_cast<std::string>(selector_jbay_reg))
    {
    }
  Eth400gPcsRspecDeskewMbeErrLogMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "Eth400gPcsRspecDeskewMbeErrLogMutable")
    {
    }
public:
  uint8_t addr() { return addr_; }
  void addr(const uint8_t &v) { addr_=v; }
  uint8_t laneid() { return laneid_; }
  void laneid(const uint8_t &v) { laneid_=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("Eth400gPcsRspecDeskewMbeErrLogMutable") + ":\n";
    r += indent_string + "  " + std::string("addr") +  ": 0x" + boost::str( boost::format("%x") % static_cast<uint>(addr_) ) + "\n";
    all_zeros &= (0 == addr_);
    r += indent_string + "  " + std::string("laneid") +  ": 0x" + boost::str( boost::format("%x") % static_cast<uint>(laneid_) ) + "\n";
    all_zeros &= (0 == laneid_);
  ...
  static int StartOffset(
    ...
    switch (selector_jbay_reg) {
      case kEth400gP1:
        ...
        offset += 0x64; // to get to deskew_mbe_err_log
        break;
      case kEth400gP10:
...
#endif // __REGISTER_INCLUDES_ETH400G_PCS_RSPEC_DESKEW_MBE_ERR_LOG_MUTABLE_H__
