...
#ifndef __REGISTER_INCLUDES_ETH400G_PCS_RSPEC_ETH_SOFT_RESET_MUTABLE_H__
#define __REGISTER_INCLUDES_ETH400G_PCS_RSPEC_ETH_SOFT_RESET_MUTABLE_H__
...
class Eth400gPcsRspecEthSoftResetMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum JbayRegEnum {
    kEth400gP1,
    kEth400gP10,
...
public:
  Eth400gPcsRspecEthSoftResetMutable(
      int chipNumber, JbayRegEnum selector_jbay_reg, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(selector_jbay_reg), 4, true, write_callback, read_callback, std::string("Eth400gPcsRspecEthSoftResetMutable")+":"+boost::lexical_cast<std::string>(selector_jbay_reg))
    {
    }
  Eth400gPcsRspecEthSoftResetMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "Eth400gPcsRspecEthSoftResetMutable")
    {
    }
public:
  ...
  uint8_t ethpcs_swrst() { return ethpcs_swrst_; }
  void ethpcs_swrst(const uint8_t &v) { ethpcs_swrst_=v; }

  bool read(
      uint32_t offset, uint32_t* data
      ) const {
    if (read_callback_) read_callback_();
    *data = (ethpcs_swrst_ & 0x3);
    return true;
  }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("Eth400gPcsRspecEthSoftResetMutable") + ":\n";
    r += indent_string + "  " + std::string("ethpcs_swrst") +  ": 0x" + boost::str( boost::format("%x") % static_cast<uint>(ethpcs_swrst_) ) + "\n";
    all_zeros &= (0 == ethpcs_swrst_);
  ...
  static int StartOffset(
    ...
    switch (selector_jbay_reg) {
      case kEth400gP1:
        ...
        offset += 0x14; // to get to eth_soft_reset
        break;
      case kEth400gP10:
...
#endif // __REGISTER_INCLUDES_ETH400G_PCS_RSPEC_ETH_SOFT_RESET_MUTABLE_H__
