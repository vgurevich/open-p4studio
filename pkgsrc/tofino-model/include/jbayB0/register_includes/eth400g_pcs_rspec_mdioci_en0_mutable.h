...
#ifndef __REGISTER_INCLUDES_ETH400G_PCS_RSPEC_MDIOCI_EN0_MUTABLE_H__
#define __REGISTER_INCLUDES_ETH400G_PCS_RSPEC_MDIOCI_EN0_MUTABLE_H__
...
class Eth400gPcsRspecMdiociEn0Mutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum JbayRegEnum {
    kEth400gP1,
    kEth400gP10,
...
public:
  Eth400gPcsRspecMdiociEn0Mutable(
      int chipNumber, JbayRegEnum selector_jbay_reg, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(selector_jbay_reg), 4, true, write_callback, read_callback, std::string("Eth400gPcsRspecMdiociEn0Mutable")+":"+boost::lexical_cast<std::string>(selector_jbay_reg))
    {
    }
  Eth400gPcsRspecMdiociEn0Mutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "Eth400gPcsRspecMdiociEn0Mutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("Eth400gPcsRspecMdiociEn0Mutable") + ":\n";
  ...
  static int StartOffset(
    ...
    switch (selector_jbay_reg) {
      case kEth400gP1:
        ...
        offset += 0x74; // to get to mdioci_en0
        break;
      case kEth400gP10:
...
#endif // __REGISTER_INCLUDES_ETH400G_PCS_RSPEC_MDIOCI_EN0_MUTABLE_H__
