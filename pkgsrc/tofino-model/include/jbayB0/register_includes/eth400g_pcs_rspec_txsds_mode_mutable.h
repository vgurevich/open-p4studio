...
#ifndef __REGISTER_INCLUDES_ETH400G_PCS_RSPEC_TXSDS_MODE_MUTABLE_H__
#define __REGISTER_INCLUDES_ETH400G_PCS_RSPEC_TXSDS_MODE_MUTABLE_H__
...
class Eth400gPcsRspecTxsdsModeMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum JbayRegEnum {
    kEth400gP1,
    kEth400gP10,
...
public:
  Eth400gPcsRspecTxsdsModeMutable(
      int chipNumber, JbayRegEnum selector_jbay_reg, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(selector_jbay_reg), 4, true, write_callback, read_callback, std::string("Eth400gPcsRspecTxsdsModeMutable")+":"+boost::lexical_cast<std::string>(selector_jbay_reg))
    {
    }
  Eth400gPcsRspecTxsdsModeMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "Eth400gPcsRspecTxsdsModeMutable")
    {
    }
public:
  ...
  void mode(const uint32_t &v) { mode_=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("Eth400gPcsRspecTxsdsModeMutable") + ":\n";
  ...
  static int StartOffset(
    ...
    switch (selector_jbay_reg) {
      case kEth400gP1:
        ...
        offset += 0x80; // to get to txsds_mode
        break;
      case kEth400gP10:
...
#endif // __REGISTER_INCLUDES_ETH400G_PCS_RSPEC_TXSDS_MODE_MUTABLE_H__
