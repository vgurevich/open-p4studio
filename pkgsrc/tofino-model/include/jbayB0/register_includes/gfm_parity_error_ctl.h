...
#ifndef __REGISTER_INCLUDES_GFM_PARITY_ERROR_CTL_H__
#define __REGISTER_INCLUDES_GFM_PARITY_ERROR_CTL_H__
...
class GfmParityErrorCtl : public model_core::RegisterBlock<RegisterCallback> {
public:
  GfmParityErrorCtl(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap, index_gfm_parity_error_ctl), 4, false, write_callback, read_callback, std::string("GfmParityErrorCtl")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap) + "," + boost::lexical_cast<std::string>(index_gfm_parity_error_ctl))
    {
    }
  GfmParityErrorCtl(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "GfmParityErrorCtl")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("GfmParityErrorCtl") + ":\n";
...
#endif // __REGISTER_INCLUDES_GFM_PARITY_ERROR_CTL_H__
