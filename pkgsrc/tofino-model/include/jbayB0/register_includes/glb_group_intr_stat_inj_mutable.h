...
#ifndef __REGISTER_INCLUDES_GLB_GROUP_INTR_STAT_INJ_MUTABLE_H__
#define __REGISTER_INCLUDES_GLB_GROUP_INTR_STAT_INJ_MUTABLE_H__
...
class GlbGroupIntrStatInjMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  GlbGroupIntrStatInjMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_ipb_prsr4_reg), 8, true, write_callback, read_callback, std::string("GlbGroupIntrStatInjMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_ipb_prsr4_reg))
    {
    }
  GlbGroupIntrStatInjMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "GlbGroupIntrStatInjMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("GlbGroupIntrStatInjMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_GLB_GROUP_INTR_STAT_INJ_MUTABLE_H__
