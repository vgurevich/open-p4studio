...
#ifndef __REGISTER_INCLUDES_GLB_GROUP_PORT_RATES_H__
#define __REGISTER_INCLUDES_GLB_GROUP_PORT_RATES_H__
...
class GlbGroupPortRates : public model_core::RegisterBlock<RegisterCallback> {
public:
  GlbGroupPortRates(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_ipb_prsr4_reg), 4, false, write_callback, read_callback, std::string("GlbGroupPortRates")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_ipb_prsr4_reg))
    {
    }
  GlbGroupPortRates(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "GlbGroupPortRates")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("GlbGroupPortRates") + ":\n";
...
#endif // __REGISTER_INCLUDES_GLB_GROUP_PORT_RATES_H__
