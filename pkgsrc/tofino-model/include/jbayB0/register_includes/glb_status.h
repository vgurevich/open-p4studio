...
#ifndef __REGISTER_INCLUDES_GLB_STATUS_H__
#define __REGISTER_INCLUDES_GLB_STATUS_H__
...
class GlbStatus : public model_core::RegisterBlock<RegisterCallback> {
public:
  GlbStatus(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_ipb_prsr4_reg), 8, false, write_callback, read_callback, std::string("GlbStatus")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_ipb_prsr4_reg))
    {
    }
  GlbStatus(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "GlbStatus")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("GlbStatus") + ":\n";
...
#endif // __REGISTER_INCLUDES_GLB_STATUS_H__
