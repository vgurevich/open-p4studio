...
public:
  GpioPairRegsMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_jbay_reg, index_gpio_pair_regs), 48, true, write_callback, read_callback, std::string("GpioPairRegsMutable")+":"+boost::lexical_cast<std::string>(selector_jbay_reg) + "," + boost::lexical_cast<std::string>(index_gpio_pair_regs))
    {
    }
  GpioPairRegsMutable(
...
public:
  ...
  GpioPairRegsPairMacCtrlMutable &pair_mac_ctrl() { return pair_mac_ctrl_; }
...
private:
  ...
  GpioPairRegsPairMacCtrlMutable pair_mac_ctrl_;
private:
