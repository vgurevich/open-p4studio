...
#ifndef __REGISTER_INCLUDES_IMEM_PARITY_ERROR_CTL_H__
#define __REGISTER_INCLUDES_IMEM_PARITY_ERROR_CTL_H__
...
class ImemParityErrorCtl : public model_core::RegisterBlock<RegisterCallback> {
public:
  ImemParityErrorCtl(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap), 4, false, write_callback, read_callback, std::string("ImemParityErrorCtl")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap))
    {
    }
  ImemParityErrorCtl(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "ImemParityErrorCtl")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("ImemParityErrorCtl") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x34c; // to get to imem_parity_error_ctl
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_IMEM_PARITY_ERROR_CTL_H__
