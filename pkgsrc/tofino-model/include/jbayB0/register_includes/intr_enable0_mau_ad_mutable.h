...
#ifndef __REGISTER_INCLUDES_INTR_ENABLE0_MAU_AD_MUTABLE_H__
#define __REGISTER_INCLUDES_INTR_ENABLE0_MAU_AD_MUTABLE_H__
...
class IntrEnable0MauAdMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  IntrEnable0MauAdMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap), 4, true, write_callback, read_callback, std::string("IntrEnable0MauAdMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap))
    {
    }
  IntrEnable0MauAdMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "IntrEnable0MauAdMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("IntrEnable0MauAdMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x13c; // to get to intr_enable0_mau_ad
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_INTR_ENABLE0_MAU_AD_MUTABLE_H__
