...
#ifndef __REGISTER_INCLUDES_INTR_ENABLE1_MAU_AD_MUTABLE_H__
#define __REGISTER_INCLUDES_INTR_ENABLE1_MAU_AD_MUTABLE_H__
...
class IntrEnable1MauAdMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  IntrEnable1MauAdMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap), 4, true, write_callback, read_callback, std::string("IntrEnable1MauAdMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap))
    {
    }
  IntrEnable1MauAdMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "IntrEnable1MauAdMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("IntrEnable1MauAdMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_INTR_ENABLE1_MAU_AD_MUTABLE_H__
