...
#ifndef __REGISTER_INCLUDES_INTR_INJECT_MAU_AD_MUTABLE_H__
#define __REGISTER_INCLUDES_INTR_INJECT_MAU_AD_MUTABLE_H__
...
class IntrInjectMauAdMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  IntrInjectMauAdMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap), 4, true, write_callback, read_callback, std::string("IntrInjectMauAdMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap))
    {
    }
  IntrInjectMauAdMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "IntrInjectMauAdMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("IntrInjectMauAdMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x5c4; // to get to intr_inject_mau_ad
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_INTR_INJECT_MAU_AD_MUTABLE_H__
