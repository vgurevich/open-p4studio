...
public:
  LfltrCtr48LqIn(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_lfltr_rspec), 8, false, write_callback, read_callback, std::string("LfltrCtr48LqIn")+":"+boost::lexical_cast<std::string>(index_lfltr_rspec))
    {
    }
  LfltrCtr48LqIn(
