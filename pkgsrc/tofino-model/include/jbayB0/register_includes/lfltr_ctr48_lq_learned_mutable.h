...
public:
  LfltrCtr48LqLearnedMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_lfltr_rspec), 8, true, write_callback, read_callback, std::string("LfltrCtr48LqLearnedMutable")+":"+boost::lexical_cast<std::string>(index_lfltr_rspec))
    {
    }
  LfltrCtr48LqLearnedMutable(
...
private:
  static int StartOffset(
    ...
    offset += 0x70; // to get to lq_learned
    return offset;
  }
