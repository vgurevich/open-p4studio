...
#ifndef __REGISTER_INCLUDES_LFLTR_CTR48_LQ_SOP_IN_MUTABLE_H__
#define __REGISTER_INCLUDES_LFLTR_CTR48_LQ_SOP_IN_MUTABLE_H__
...
class LfltrCtr48LqSopInMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  LfltrCtr48LqSopInMutable(
      int chipNumber, int index_lfltr_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_lfltr_rspec), 8, true, write_callback, read_callback, std::string("LfltrCtr48LqSopInMutable")+":"+boost::lexical_cast<std::string>(index_lfltr_rspec))
    {
    }
  LfltrCtr48LqSopInMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "LfltrCtr48LqSopInMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("LfltrCtr48LqSopInMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x48; // to get to lq_sop_in
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_LFLTR_CTR48_LQ_SOP_IN_MUTABLE_H__
