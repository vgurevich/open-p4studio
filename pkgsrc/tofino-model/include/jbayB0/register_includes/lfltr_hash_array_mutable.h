...
#ifndef __REGISTER_INCLUDES_LFLTR_HASH_ARRAY_MUTABLE_H__
#define __REGISTER_INCLUDES_LFLTR_HASH_ARRAY_MUTABLE_H__
...
class LfltrHashArrayMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  LfltrHashArrayMutable(
      int chipNumber, int index_lfltr_rspec, int index_lfltr_hash_rspec, int index_lfltr_hash_array, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_lfltr_rspec, index_lfltr_hash_rspec, index_lfltr_hash_array), 48, true, write_callback, read_callback, std::string("LfltrHashArrayMutable")+":"+boost::lexical_cast<std::string>(index_lfltr_rspec) + "," + boost::lexical_cast<std::string>(index_lfltr_hash_rspec) + "," + boost::lexical_cast<std::string>(index_lfltr_hash_array))
    {
    }
  LfltrHashArrayMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "LfltrHashArrayMutable")
    {
    }
public:
  ...
  void sel(int j0,const uint8_t &v) { sel_[j0]=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("LfltrHashArrayMutable") + ":\n";
...
private:
  static int StartOffset(
      int index_lfltr_rspec, int index_lfltr_hash_rspec, int index_lfltr_hash_array
      ) {
    int offset=0;
    ...
    assert(index_lfltr_hash_array < 16);
...
#endif // __REGISTER_INCLUDES_LFLTR_HASH_ARRAY_MUTABLE_H__
