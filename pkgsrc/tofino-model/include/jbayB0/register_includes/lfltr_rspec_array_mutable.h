...
#ifndef __REGISTER_INCLUDES_LFLTR_RSPEC_ARRAY_MUTABLE_H__
#define __REGISTER_INCLUDES_LFLTR_RSPEC_ARRAY_MUTABLE_H__
...
class LfltrRspecArrayMutable : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  LfltrRspecArrayMutable(
      int chipNumber, RegisterArrayCallback& write_callback = 0, RegisterArrayCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 524288 * ArraySize(-1), true, write_callback, read_callback, std::string("LfltrRspecArrayMutable")),
...
public:
  ...
  LfltrHashRspecMutable &hash(uint32_t a0,int j0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    return array[a0].hash(j0);
  }
  ...
  LfltrCtrlRspecMutable &ctrl(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("LfltrRspecArrayMutable") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
private:
  std::vector<LfltrRspecMutable> array;
  uint32_t size0_;
...
#endif // __REGISTER_INCLUDES_LFLTR_RSPEC_ARRAY_MUTABLE_H__
