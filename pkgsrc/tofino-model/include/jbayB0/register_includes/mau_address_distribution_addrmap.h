...
#include "atomic_mod_sram_go_pending.h"
...
#include "dp_teop_meter_ctl.h"
#include "dp_teop_stats_ctl.h"
...
#include "mau_meter_alu_vpn_range.h"
#include "mau_snapshot_meter_adr.h"
#include "mau_stateful_log_counter_logical_map.h"
#include "mau_stateful_log_counter_oxbar_map.h"
#include "mau_stateful_log_stage_vpn_offset.h"
#include "mau_stats_alu_vpn_range.h"
#include "meter_adr_shift.h"
#include "meter_alu_adr_range_check_icxbar_map.h"
#include "meter_bubble_req.h"
#include "meter_color_logical_to_phys_icxbar_ctl.h"
#include "meter_color_output_map.h"
#include "meter_enable.h"
#include "meter_sweep_cmd_ovr_ctl.h"
#include "meter_sweep_ctl.h"
#include "meter_sweep_errlog.h"
#include "meter_sweep_num_subwords.h"
#include "meter_to_teop_adr_oxbar_ctl.h"
...
#include "stateful_instr_width_logical.h"
...
#include "stats_to_teop_adr_oxbar_ctl.h"
#include "teop_bus_ctl.h"
#include "teop_to_meter_adr_oxbar_ctl.h"
#include "teop_to_stats_adr_oxbar_ctl.h"
...
public:
  ...
  MeterToTeopAdrOxbarCtl &meter_to_teop_adr_oxbar_ctl(int j0) { return meter_to_teop_adr_oxbar_ctl_[j0]; }
  ...
  TeopBusCtl &teop_bus_ctl(int j0) { return teop_bus_ctl_[j0]; }
  ...
  MauSnapshotMeterAdr &mau_snapshot_meter_adr(int j0) { return mau_snapshot_meter_adr_[j0]; }
  ...
  AtomicModSramGoPending &atomic_mod_sram_go_pending(int j0) { return atomic_mod_sram_go_pending_[j0]; }
  ...
  MeterColorLogicalToPhysIcxbarCtl &meter_color_logical_to_phys_icxbar_ctl(int j0) { return meter_color_logical_to_phys_icxbar_ctl_[j0]; }
  ...
  MauStatefulLogCounterLogicalMap &mau_stateful_log_counter_logical_map(int j0) { return mau_stateful_log_counter_logical_map_[j0]; }
  ...
  MauStatefulLogStageVpnOffset &mau_stateful_log_stage_vpn_offset(int j0) { return mau_stateful_log_stage_vpn_offset_[j0]; }
  ...
  StatefulInstrWidthLogical &stateful_instr_width_logical(int j0) { return stateful_instr_width_logical_[j0]; }
  ...
  MeterAdrShift &meter_adr_shift() { return meter_adr_shift_; }
  ...
  MeterSweepCmdOvrCtl &meter_sweep_cmd_ovr_ctl(int j0) { return meter_sweep_cmd_ovr_ctl_[j0]; }
  ...
  MeterSweepNumSubwords &meter_sweep_num_subwords(int j0) { return meter_sweep_num_subwords_[j0]; }
  ...
  MauStatsAluVpnRange &mau_stats_alu_vpn_range(int j0) { return mau_stats_alu_vpn_range_[j0]; }
  ...
  MauMeterAluVpnRange &mau_meter_alu_vpn_range(int j0) { return mau_meter_alu_vpn_range_[j0]; }
  ...
  MauStatefulLogCounterOxbarMap &mau_stateful_log_counter_oxbar_map(int j0) { return mau_stateful_log_counter_oxbar_map_[j0]; }
  ...
  MeterAluAdrRangeCheckIcxbarMap &meter_alu_adr_range_check_icxbar_map(int j0) { return meter_alu_adr_range_check_icxbar_map_[j0]; }
  ...
  DpTeopStatsCtl &dp_teop_stats_ctl(int j0) { return dp_teop_stats_ctl_[j0]; }
  ...
  DpTeopMeterCtl &dp_teop_meter_ctl(int j0) { return dp_teop_meter_ctl_[j0]; }
  ...
  TeopToStatsAdrOxbarCtl &teop_to_stats_adr_oxbar_ctl(int j0) { return teop_to_stats_adr_oxbar_ctl_[j0]; }
  ...
  TeopToMeterAdrOxbarCtl &teop_to_meter_adr_oxbar_ctl(int j0) { return teop_to_meter_adr_oxbar_ctl_[j0]; }
  ...
  StatsToTeopAdrOxbarCtl &stats_to_teop_adr_oxbar_ctl(int j0) { return stats_to_teop_adr_oxbar_ctl_[j0]; }
...
private:
  std::array< MeterToTeopAdrOxbarCtl, 4 > meter_to_teop_adr_oxbar_ctl_;
  std::array< TeopBusCtl, 4 > teop_bus_ctl_;
  std::array< MauSnapshotMeterAdr, 4 > mau_snapshot_meter_adr_;
  ...
  std::array< AtomicModSramGoPending, 2 > atomic_mod_sram_go_pending_;
  ...
  std::array< MeterColorLogicalToPhysIcxbarCtl, 16 > meter_color_logical_to_phys_icxbar_ctl_;
  ...
  std::array< MauStatefulLogCounterLogicalMap, 16 > mau_stateful_log_counter_logical_map_;
  std::array< MauStatefulLogStageVpnOffset, 16 > mau_stateful_log_stage_vpn_offset_;
  std::array< StatefulInstrWidthLogical, 16 > stateful_instr_width_logical_;
  ...
  MeterAdrShift meter_adr_shift_;
  std::array< MeterSweepCtl, 4 > meter_sweep_ctl_;
  std::array< MeterSweepCmdOvrCtl, 4 > meter_sweep_cmd_ovr_ctl_;
  std::array< MeterSweepNumSubwords, 4 > meter_sweep_num_subwords_;
  ...
  std::array< MauStatsAluVpnRange, 4 > mau_stats_alu_vpn_range_;
  std::array< MauMeterAluVpnRange, 4 > mau_meter_alu_vpn_range_;
  std::array< MauStatefulLogCounterOxbarMap, 4 > mau_stateful_log_counter_oxbar_map_;
  std::array< MeterAluAdrRangeCheckIcxbarMap, 4 > meter_alu_adr_range_check_icxbar_map_;
  std::array< DpTeopStatsCtl, 4 > dp_teop_stats_ctl_;
  std::array< DpTeopMeterCtl, 4 > dp_teop_meter_ctl_;
  std::array< TeopToStatsAdrOxbarCtl, 4 > teop_to_stats_adr_oxbar_ctl_;
  std::array< TeopToMeterAdrOxbarCtl, 4 > teop_to_meter_adr_oxbar_ctl_;
  std::array< StatsToTeopAdrOxbarCtl, 4 > stats_to_teop_adr_oxbar_ctl_;
private:
