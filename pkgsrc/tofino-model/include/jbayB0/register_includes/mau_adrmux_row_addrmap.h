...
#ifndef __REGISTER_INCLUDES_MAU_ADRMUX_ROW_ADDRMAP_H__
#define __REGISTER_INCLUDES_MAU_ADRMUX_ROW_ADDRMAP_H__
...
#include "adrmux_row_mem_slow_mode.h"
#include "atomic_mod_shadow_ram_status_left.h"
#include "atomic_mod_shadow_ram_status_right.h"
#include "idletime_cfg_rd_clear_val.h"
#include "idletime_logical_to_physical_sweep_grant_ctl.h"
#include "idletime_physical_to_logical_req_inc_ctl.h"
#include "intr_enable0_mau_adrmux_row.h"
#include "intr_enable1_mau_adrmux_row.h"
#include "intr_freeze_enable_mau_adrmux_row.h"
#include "intr_inject_mau_adrmux_row.h"
#include "intr_status_mau_adrmux_row.h"
#include "mapram_config.h"
#include "mapram_mbe_errlog.h"
#include "mapram_mbe_inj.h"
#include "mapram_sbe_errlog.h"
#include "mapram_sbe_inj.h"
#include "ram_address_mux_ctl.h"
#include "unitram_config.h"

namespace jbayB0 {
  namespace register_classes {

class MauAdrmuxRowAddrmap : public model_core::RegisterBlock<RegisterCallback> {
public:
  MauAdrmuxRowAddrmap(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap, index_mau_map_and_alu_row_addrmap), 512, false, write_callback, read_callback, std::string("MauAdrmuxRowAddrmap")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_map_and_alu_row_addrmap))
    {
    }
  MauAdrmuxRowAddrmap(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "MauAdrmuxRowAddrmap")
    {
    }
public:
  ...
  AtomicModShadowRamStatusLeft &atomic_mod_shadow_ram_status_left(int j0) { return atomic_mod_shadow_ram_status_left_[j0]; }
  ...
  AtomicModShadowRamStatusRight &atomic_mod_shadow_ram_status_right(int j0) { return atomic_mod_shadow_ram_status_right_[j0]; }





  MapramSbeInj &mapram_sbe_inj() { return mapram_sbe_inj_; }





  MapramMbeInj &mapram_mbe_inj() { return mapram_mbe_inj_; }
  ...
  AdrmuxRowMemSlowMode &adrmux_row_mem_slow_mode() { return adrmux_row_mem_slow_mode_; }
  ...
  IntrStatusMauAdrmuxRow &intr_status_mau_adrmux_row() { return intr_status_mau_adrmux_row_; }
  ...
  IntrEnable0MauAdrmuxRow &intr_enable0_mau_adrmux_row() { return intr_enable0_mau_adrmux_row_; }
  ...
  IntrEnable1MauAdrmuxRow &intr_enable1_mau_adrmux_row() { return intr_enable1_mau_adrmux_row_; }
  ...
  IntrInjectMauAdrmuxRow &intr_inject_mau_adrmux_row() { return intr_inject_mau_adrmux_row_; }





  IntrFreezeEnableMauAdrmuxRow &intr_freeze_enable_mau_adrmux_row() { return intr_freeze_enable_mau_adrmux_row_; }
  ...
  RamAddressMuxCtl &ram_address_mux_ctl(int j1,int j0) { return ram_address_mux_ctl_[j1][j0]; }
  ...
  UnitramConfig &unitram_config(int j1,int j0) { return unitram_config_[j1][j0]; }
  ...
  MapramConfig &mapram_config(int j0) { return mapram_config_[j0]; }
  ...
  MapramSbeErrlog &mapram_sbe_errlog(int j0) { return mapram_sbe_errlog_[j0]; }
  ...
  MapramMbeErrlog &mapram_mbe_errlog(int j0) { return mapram_mbe_errlog_[j0]; }
  ...
  IdletimeLogicalToPhysicalSweepGrantCtl &idletime_logical_to_physical_sweep_grant_ctl(int j0) { return idletime_logical_to_physical_sweep_grant_ctl_[j0]; }
  ...
  IdletimePhysicalToLogicalReqIncCtl &idletime_physical_to_logical_req_inc_ctl(int j0) { return idletime_physical_to_logical_req_inc_ctl_[j0]; }
  ...
  IdletimeCfgRdClearVal &idletime_cfg_rd_clear_val(int j0) { return idletime_cfg_rd_clear_val_[j0]; }
...
private:
  std::array< AtomicModShadowRamStatusLeft, 6 > atomic_mod_shadow_ram_status_left_;
  std::array< AtomicModShadowRamStatusRight, 6 > atomic_mod_shadow_ram_status_right_;
  MapramSbeInj mapram_sbe_inj_;
  MapramMbeInj mapram_mbe_inj_;
  AdrmuxRowMemSlowMode adrmux_row_mem_slow_mode_;
  IntrStatusMauAdrmuxRow intr_status_mau_adrmux_row_;
  IntrEnable0MauAdrmuxRow intr_enable0_mau_adrmux_row_;
  IntrEnable1MauAdrmuxRow intr_enable1_mau_adrmux_row_;
  IntrInjectMauAdrmuxRow intr_inject_mau_adrmux_row_;
  IntrFreezeEnableMauAdrmuxRow intr_freeze_enable_mau_adrmux_row_;
  std::array< std::array< RamAddressMuxCtl, 6 >, 2 > ram_address_mux_ctl_;
  std::array< std::array< UnitramConfig, 6 >, 2 > unitram_config_;
  std::array< MapramConfig, 6 > mapram_config_;
  std::array< MapramSbeErrlog, 6 > mapram_sbe_errlog_;
  std::array< MapramMbeErrlog, 6 > mapram_mbe_errlog_;
  std::array< IdletimeLogicalToPhysicalSweepGrantCtl, 6 > idletime_logical_to_physical_sweep_grant_ctl_;
  std::array< IdletimePhysicalToLogicalReqIncCtl, 6 > idletime_physical_to_logical_req_inc_ctl_;
  std::array< IdletimeCfgRdClearVal, 6 > idletime_cfg_rd_clear_val_;
private:
...
#endif // __REGISTER_INCLUDES_MAU_ADRMUX_ROW_ADDRMAP_H__
