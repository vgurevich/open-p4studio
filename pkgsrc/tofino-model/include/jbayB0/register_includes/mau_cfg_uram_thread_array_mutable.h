...
#ifndef __REGISTER_INCLUDES_MAU_CFG_URAM_THREAD_ARRAY_MUTABLE_H__
#define __REGISTER_INCLUDES_MAU_CFG_URAM_THREAD_ARRAY_MUTABLE_H__
...
class MauCfgUramThreadArrayMutable : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  MauCfgUramThreadArrayMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap), 4 * ArraySize(index_pipe_addrmap, index_mau_addrmap, -1), true, write_callback, read_callback, std::string("MauCfgUramThreadArrayMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap)),
...
public:
  uint32_t mau_cfg_uram_thread(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    return array[a0].mau_cfg_uram_thread();
  }
  void mau_cfg_uram_thread(uint32_t a0,const uint32_t &v) 
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    array[a0].mau_cfg_uram_thread(v);
  }
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("MauCfgUramThreadArrayMutable") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
private:
  std::vector<MauCfgUramThreadMutable> array;
  uint32_t size0_;
...
#endif // __REGISTER_INCLUDES_MAU_CFG_URAM_THREAD_ARRAY_MUTABLE_H__
