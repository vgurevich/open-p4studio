...
#ifndef __REGISTER_INCLUDES_MAU_DIAG_CFG_OXBAR_CTL_H__
#define __REGISTER_INCLUDES_MAU_DIAG_CFG_OXBAR_CTL_H__
...
class MauDiagCfgOxbarCtl : public model_core::RegisterBlock<RegisterCallback> {
public:
  MauDiagCfgOxbarCtl(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap, index_mau_diag_cfg_oxbar_ctl), 4, false, write_callback, read_callback, std::string("MauDiagCfgOxbarCtl")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_diag_cfg_oxbar_ctl))
    {
    }
  MauDiagCfgOxbarCtl(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "MauDiagCfgOxbarCtl")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("MauDiagCfgOxbarCtl") + ":\n";
...
#endif // __REGISTER_INCLUDES_MAU_DIAG_CFG_OXBAR_CTL_H__
