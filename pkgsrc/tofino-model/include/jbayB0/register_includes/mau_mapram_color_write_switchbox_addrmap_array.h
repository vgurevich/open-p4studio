...
#ifndef __REGISTER_INCLUDES_MAU_MAPRAM_COLOR_WRITE_SWITCHBOX_ADDRMAP_ARRAY_H__
#define __REGISTER_INCLUDES_MAU_MAPRAM_COLOR_WRITE_SWITCHBOX_ADDRMAP_ARRAY_H__
...
class MauMapramColorWriteSwitchboxAddrmapArray : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  MauMapramColorWriteSwitchboxAddrmapArray(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap), 8 * ArraySize(index_pipe_addrmap, index_mau_addrmap, -1), false, write_callback, read_callback, std::string("MauMapramColorWriteSwitchboxAddrmapArray")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap)),
...
public:
  ...
  MauMapramColorWriteSwitchboxControlAddrmap &ctl(uint32_t a0)
  {
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("MauMapramColorWriteSwitchboxAddrmapArray") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
private:
  std::vector<MauMapramColorWriteSwitchboxAddrmap> array;
  uint32_t size0_;
...
#endif // __REGISTER_INCLUDES_MAU_MAPRAM_COLOR_WRITE_SWITCHBOX_ADDRMAP_ARRAY_H__
