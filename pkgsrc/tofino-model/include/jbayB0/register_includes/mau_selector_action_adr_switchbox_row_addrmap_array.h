...
#ifndef __REGISTER_INCLUDES_MAU_SELECTOR_ACTION_ADR_SWITCHBOX_ROW_ADDRMAP_ARRAY_H__
#define __REGISTER_INCLUDES_MAU_SELECTOR_ACTION_ADR_SWITCHBOX_ROW_ADDRMAP_ARRAY_H__
...
#include "mau_selector_action_adr_switchbox_row_addrmap.h"
#include "mau_selector_action_adr_switchbox_row_control_addrmap.h"

namespace jbayB0 {
  namespace register_classes {

class MauSelectorActionAdrSwitchboxRowAddrmapArray : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  MauSelectorActionAdrSwitchboxRowAddrmapArray(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap), 32 * ArraySize(index_pipe_addrmap, index_mau_addrmap, -1), false, write_callback, read_callback, std::string("MauSelectorActionAdrSwitchboxRowAddrmapArray")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap)),
...
public:
  ...
  MauSelectorActionAdrSwitchboxRowControlAddrmap &ctl(uint32_t a0)
  {
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("MauSelectorActionAdrSwitchboxRowAddrmapArray") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
private:
  std::vector<MauSelectorActionAdrSwitchboxRowAddrmap> array;
  uint32_t size0_;
...
#endif // __REGISTER_INCLUDES_MAU_SELECTOR_ACTION_ADR_SWITCHBOX_ROW_ADDRMAP_ARRAY_H__
