...
#ifndef __REGISTER_INCLUDES_MAU_STATS_ALU_WRAP_ADDRMAP_ARRAY_H__
#define __REGISTER_INCLUDES_MAU_STATS_ALU_WRAP_ADDRMAP_ARRAY_H__
...
class MauStatsAluWrapAddrmapArray : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  MauStatsAluWrapAddrmapArray(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap), 128 * ArraySize(index_pipe_addrmap, index_mau_addrmap, -1), false, write_callback, read_callback, std::string("MauStatsAluWrapAddrmapArray")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap)),
...
public:
  ...
  MauStatsAluAddrmap &stats(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    return array[a0].stats();
  }
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("MauStatsAluWrapAddrmapArray") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
private:
  std::vector<MauStatsAluWrapAddrmap> array;
  uint32_t size0_;
...
#endif // __REGISTER_INCLUDES_MAU_STATS_ALU_WRAP_ADDRMAP_ARRAY_H__
