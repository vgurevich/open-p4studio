...
#ifndef __REGISTER_INCLUDES_MAU_STATS_ALU_WRAP_ADDRMAP_ARRAY_MUTABLE_H__
#define __REGISTER_INCLUDES_MAU_STATS_ALU_WRAP_ADDRMAP_ARRAY_MUTABLE_H__
...
class MauStatsAluWrapAddrmapArrayMutable : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  MauStatsAluWrapAddrmapArrayMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap), 128 * ArraySize(index_pipe_addrmap, index_mau_addrmap, -1), true, write_callback, read_callback, std::string("MauStatsAluWrapAddrmapArrayMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap)),
...
public:
  ...
  MauStatsAluAddrmapMutable &stats(uint32_t a0)
  {
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("MauStatsAluWrapAddrmapArrayMutable") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
private:
  std::vector<MauStatsAluWrapAddrmapMutable> array;
  uint32_t size0_;
...
#endif // __REGISTER_INCLUDES_MAU_STATS_ALU_WRAP_ADDRMAP_ARRAY_MUTABLE_H__
