...
public:
  ...
  TcamExtraBitMuxCtlMutable &tcam_extra_bit_mux_ctl(int j1,int j0) { return tcam_extra_bit_mux_ctl_[j1][j0]; }
...
private:
  ...
  std::array< std::array< TcamExtraBitMuxCtlMutable, 12 >, 2 > tcam_extra_bit_mux_ctl_;
