...
#ifndef __REGISTER_INCLUDES_MAU_UNIT_RAM_ROW_ADDRMAP_MUTABLE_H__
#define __REGISTER_INCLUDES_MAU_UNIT_RAM_ROW_ADDRMAP_MUTABLE_H__
...
#include "actiondata_error_uram_ctl_mutable.h"
#include "emm_ecc_error_uram_ctl_mutable.h"
#include "exactmatch_row_vh_xbar_byteswizzle_ctl_mutable.h"
#include "intr_enable0_mau_unit_ram_row_mutable.h"
#include "intr_enable1_mau_unit_ram_row_mutable.h"
#include "intr_freeze_enable_mau_unit_ram_row_mutable.h"
#include "intr_inject_mau_unit_ram_row_mutable.h"
#include "intr_status_mau_unit_ram_row_mutable.h"
#include "mau_action_output_hv_xbar_addrmap_mutable.h"
#include "mau_exactmatch_row_adr_vh_xbar_addrmap_mutable.h"
#include "mau_exactmatch_row_vh_xbar_addrmap_mutable.h"
#include "mau_gateway_table_addrmap_mutable.h"
#include "mau_stash_addrmap_mutable.h"
#include "mau_unit_ram_addrmap_mutable.h"
#include "tind_ecc_error_uram_ctl_mutable.h"

namespace jbayB0 {
  namespace register_classes {

class MauUnitRamRowAddrmapMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  MauUnitRamRowAddrmapMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap, index_mau_unit_ram_row_addrmap), 4096, true, write_callback, read_callback, std::string("MauUnitRamRowAddrmapMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_unit_ram_row_addrmap))
    {
    }
  MauUnitRamRowAddrmapMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "MauUnitRamRowAddrmapMutable")
    {
    }
public:
  ...
  ExactmatchRowVhXbarByteswizzleCtlMutable &exactmatch_row_vh_xbar_byteswizzle_ctl(int j2,int j1,int j0) { return exactmatch_row_vh_xbar_byteswizzle_ctl_[j2][j1][j0]; }





  IntrFreezeEnableMauUnitRamRowMutable &intr_freeze_enable_mau_unit_ram_row() { return intr_freeze_enable_mau_unit_ram_row_; }
  ...
  TindEccErrorUramCtlMutable &tind_ecc_error_uram_ctl(int j0) { return tind_ecc_error_uram_ctl_[j0]; }
  ...
  EmmEccErrorUramCtlMutable &emm_ecc_error_uram_ctl(int j0) { return emm_ecc_error_uram_ctl_[j0]; }
  ...
  ActiondataErrorUramCtlMutable &actiondata_error_uram_ctl(int j0) { return actiondata_error_uram_ctl_[j0]; }
  ...
  IntrStatusMauUnitRamRowMutable &intr_status_mau_unit_ram_row() { return intr_status_mau_unit_ram_row_; }
  ...
  IntrEnable0MauUnitRamRowMutable &intr_enable0_mau_unit_ram_row() { return intr_enable0_mau_unit_ram_row_; }
  ...
  IntrEnable1MauUnitRamRowMutable &intr_enable1_mau_unit_ram_row() { return intr_enable1_mau_unit_ram_row_; }
  ...
  IntrInjectMauUnitRamRowMutable &intr_inject_mau_unit_ram_row() { return intr_inject_mau_unit_ram_row_; }
  ...
  MauUnitRamAddrmapMutable &ram(int j0) { return ram_[j0]; }





  MauExactmatchRowAdrVhXbarAddrmapMutable &vh_adr_xbar() { return vh_adr_xbar_; }





  MauStashAddrmapMutable &stash() { return stash_; }
  ...
  MauGatewayTableAddrmapMutable &gateway_table(int j0) { return gateway_table_[j0]; }
  ...
  MauExactmatchRowVhXbarAddrmapMutable &vh_xbar(int j0) { return vh_xbar_[j0]; }





  MauActionOutputHvXbarAddrmapMutable &action_hv_xbar() { return action_hv_xbar_; }
...
private:
  std::array< std::array< std::array< ExactmatchRowVhXbarByteswizzleCtlMutable, 8 >, 16 >, 2 > exactmatch_row_vh_xbar_byteswizzle_ctl_;
  IntrFreezeEnableMauUnitRamRowMutable intr_freeze_enable_mau_unit_ram_row_;
  std::array< TindEccErrorUramCtlMutable, 2 > tind_ecc_error_uram_ctl_;
  std::array< EmmEccErrorUramCtlMutable, 2 > emm_ecc_error_uram_ctl_;
  std::array< ActiondataErrorUramCtlMutable, 2 > actiondata_error_uram_ctl_;
  IntrStatusMauUnitRamRowMutable intr_status_mau_unit_ram_row_;
  IntrEnable0MauUnitRamRowMutable intr_enable0_mau_unit_ram_row_;
  IntrEnable1MauUnitRamRowMutable intr_enable1_mau_unit_ram_row_;
  IntrInjectMauUnitRamRowMutable intr_inject_mau_unit_ram_row_;
  std::array< MauUnitRamAddrmapMutable, 12 > ram_;
  MauExactmatchRowAdrVhXbarAddrmapMutable vh_adr_xbar_;
  MauStashAddrmapMutable stash_;
  std::array< MauGatewayTableAddrmapMutable, 2 > gateway_table_;
  std::array< MauExactmatchRowVhXbarAddrmapMutable, 2 > vh_xbar_;
  MauActionOutputHvXbarAddrmapMutable action_hv_xbar_;
private:
...
#endif // __REGISTER_INCLUDES_MAU_UNIT_RAM_ROW_ADDRMAP_MUTABLE_H__
