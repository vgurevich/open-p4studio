...
#ifndef __REGISTER_INCLUDES_MBUS_BARESYNC_TS_INC_MUTABLE_H__
#define __REGISTER_INCLUDES_MBUS_BARESYNC_TS_INC_MUTABLE_H__
...
class MbusBaresyncTsIncMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  MbusBaresyncTsIncMutable(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 12, true, write_callback, read_callback, std::string("MbusBaresyncTsIncMutable"))
    {
    }
  MbusBaresyncTsIncMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "MbusBaresyncTsIncMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("MbusBaresyncTsIncMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_MBUS_BARESYNC_TS_INC_MUTABLE_H__
