...
#ifndef __REGISTER_INCLUDES_MBUS_RSPEC_MUTABLE_H__
#define __REGISTER_INCLUDES_MBUS_RSPEC_MUTABLE_H__
...
#include "global_ts_ctrl_log_mutable.h"
#include "mbus_baresync_alt_cyc_ctrl_mutable.h"
#include "mbus_baresync_alt_cyc_gap_ctrl_mutable.h"
#include "mbus_baresync_alt_cyc_status_mutable.h"
#include "mbus_baresync_alt_ts_value_mutable.h"
#include "mbus_baresync_ts_inc_alt_mutable.h"
#include "mbus_baresync_ts_inc_mutable.h"
#include "mbus_baresync_ts_set_value_mutable.h"
#include "mbus_baresync_ts_value_mutable.h"
#include "mbus_controller_mbe_log_mutable.h"
#include "mbus_controller_sbe_log_mutable.h"
#include "mbus_ctrl_mutable.h"
#include "mbus_flush_mutable.h"
#include "mbus_freeze_en_mutable.h"
#include "mbus_global_ts_inc_mutable.h"
#include "mbus_global_ts_inc_value_mutable.h"
#include "mbus_global_ts_offset_value_mutable.h"
#include "mbus_global_ts_set_mutable.h"
#include "mbus_global_ts_value_mutable.h"
#include "mbus_host_creq_credit_mutable.h"
#include "mbus_host_slv_credit_mutable.h"
#include "mbus_int_en_0_mutable.h"
#include "mbus_int_en_1_mutable.h"
#include "mbus_int_inj_mutable.h"
#include "mbus_int_stat_mutable.h"
#include "mbus_link_down_mutable.h"
#include "mbus_mac_wb_multicast_vec_mutable.h"
#include "mbus_mac_0_creq_credit_mutable.h"
#include "mbus_mac_0_dma_log_mutable.h"
#include "mbus_mac_0_tx_dr_rd_err_log_mutable.h"
#include "mbus_mst_ctrl_log_mutable.h"
#include "mbus_parity_err_log_mutable.h"
#include "mbus_ts_capture_mutable.h"
#include "mbus_ts_timer_mutable.h"
#include "mbus_ts_4ns_capture_mutable.h"
#include "mbus_ts_4ns_inc_value_mutable.h"
#include "mbus_ts_4ns_set_value_mutable.h"
#include "mbus_ts_4ns_value_mutable.h"
#include "mbus_wb_creq_credit_mutable.h"
#include "mbus_wb_dma_log_mutable.h"
#include "mbus_wb_tx_dr_rd_err_log_mutable.h"

namespace jbayB0 {
  namespace register_classes {

class MbusRspecMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  MbusRspecMutable(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 336, true, write_callback, read_callback, std::string("MbusRspecMutable"))
    {
    }
  MbusRspecMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "MbusRspecMutable")
    {
    }
public:
  ...
  MbusCtrlMutable &ctrl() { return ctrl_; }





  MbusFlushMutable &flush() { return flush_; }





  MbusLinkDownMutable &link_down() { return link_down_; }





  MbusBaresyncTsSetValueMutable &baresync_ts_set_value() { return baresync_ts_set_value_; }





  MbusBaresyncTsIncMutable &baresync_ts_inc() { return baresync_ts_inc_; }





  MbusGlobalTsSetMutable &global_ts_set() { return global_ts_set_; }





  MbusGlobalTsIncMutable &global_ts_inc() { return global_ts_inc_; }





  MbusGlobalTsIncValueMutable &global_ts_inc_value() { return global_ts_inc_value_; }





  MbusGlobalTsOffsetValueMutable &global_ts_offset_value() { return global_ts_offset_value_; }





  MbusTsTimerMutable &ts_timer() { return ts_timer_; }





  MbusTsCaptureMutable &ts_capture() { return ts_capture_; }





  MbusGlobalTsValueMutable &global_ts_value() { return global_ts_value_; }





  MbusBaresyncTsValueMutable &baresync_ts_value() { return baresync_ts_value_; }





  MbusBaresyncAltTsValueMutable &baresync_alt_ts_value() { return baresync_alt_ts_value_; }





  MbusIntStatMutable &intr_stat() { return intr_stat_; }





  MbusIntEn_0Mutable &intr_en_0() { return intr_en_0_; }





  MbusIntEn_1Mutable &intr_en_1() { return intr_en_1_; }





  MbusFreezeEnMutable &freeze_en() { return freeze_en_; }





  MbusIntInjMutable &intr_inj() { return intr_inj_; }





  MbusMac_0TxDrRdErrLogMutable &mac_0_tx_dr_rd_err_log() { return mac_0_tx_dr_rd_err_log_; }





  MbusWbTxDrRdErrLogMutable &wb_tx_dr_rd_err_log() { return wb_tx_dr_rd_err_log_; }





  MbusControllerMbeLogMutable &controller_mbe_log() { return controller_mbe_log_; }





  MbusControllerSbeLogMutable &controller_sbe_log() { return controller_sbe_log_; }
  ...
  MbusParityErrLogMutable &parity_err_log(int j0) { return parity_err_log_[j0]; }





  MbusHostCreqCreditMutable &host_creq_credit() { return host_creq_credit_; }





  MbusMac_0CreqCreditMutable &mac_0_creq_credit() { return mac_0_creq_credit_; }





  MbusWbCreqCreditMutable &wb_creq_credit() { return wb_creq_credit_; }





  MbusHostSlvCreditMutable &host_slave_credit() { return host_slave_credit_; }





  MbusMac_0DmaLogMutable &mac_0_dma_log() { return mac_0_dma_log_; }





  MbusWbDmaLogMutable &wb_dma_log() { return wb_dma_log_; }





  MbusTs_4nsSetValueMutable &ts_4ns_set_value() { return ts_4ns_set_value_; }





  MbusTs_4nsIncValueMutable &ts_4ns_inc_value() { return ts_4ns_inc_value_; }





  MbusMacWbMulticastVecMutable &mac_wb_multicast() { return mac_wb_multicast_; }





  MbusBaresyncTsIncAltMutable &baresync_ts_inc_alt() { return baresync_ts_inc_alt_; }





  MbusTs_4nsValueMutable &ts_4ns_value() { return ts_4ns_value_; }





  MbusTs_4nsCaptureMutable &ts_4ns_capture() { return ts_4ns_capture_; }
  MbusBaresyncAltCycStatusMutable &baresync_alt_cyc() { return baresync_alt_cyc_; }





  MbusBaresyncAltCycGapCtrlMutable &baresync_ts_inc_alt_gap() { return baresync_ts_inc_alt_gap_; }





  MbusBaresyncAltCycCtrlMutable &baresync_ts_inc_alt_cyc() { return baresync_ts_inc_alt_cyc_; }





  MbusMstCtrlLogMutable &mst_ctrl_log() { return mst_ctrl_log_; }





  GlobalTsCtrlLogMutable &global_ts_log() { return global_ts_log_; }
...
private:
  MbusCtrlMutable ctrl_;
  MbusFlushMutable flush_;
  MbusLinkDownMutable link_down_;
  MbusBaresyncTsSetValueMutable baresync_ts_set_value_;
  MbusBaresyncTsIncMutable baresync_ts_inc_;
  MbusGlobalTsSetMutable global_ts_set_;
  MbusGlobalTsIncMutable global_ts_inc_;
  MbusGlobalTsIncValueMutable global_ts_inc_value_;
  MbusGlobalTsOffsetValueMutable global_ts_offset_value_;
  MbusTsTimerMutable ts_timer_;
  MbusTsCaptureMutable ts_capture_;
  MbusGlobalTsValueMutable global_ts_value_;
  MbusBaresyncTsValueMutable baresync_ts_value_;
  MbusBaresyncAltTsValueMutable baresync_alt_ts_value_;
  MbusIntStatMutable intr_stat_;
  MbusIntEn_0Mutable intr_en_0_;
  MbusIntEn_1Mutable intr_en_1_;
  MbusFreezeEnMutable freeze_en_;
  MbusIntInjMutable intr_inj_;
  MbusMac_0TxDrRdErrLogMutable mac_0_tx_dr_rd_err_log_;
  MbusWbTxDrRdErrLogMutable wb_tx_dr_rd_err_log_;
  MbusControllerMbeLogMutable controller_mbe_log_;
  MbusControllerSbeLogMutable controller_sbe_log_;
  std::array< MbusParityErrLogMutable, 4 > parity_err_log_;
  MbusHostCreqCreditMutable host_creq_credit_;
  MbusMac_0CreqCreditMutable mac_0_creq_credit_;
  MbusWbCreqCreditMutable wb_creq_credit_;
  MbusHostSlvCreditMutable host_slave_credit_;
  MbusMac_0DmaLogMutable mac_0_dma_log_;
  MbusWbDmaLogMutable wb_dma_log_;
  MbusTs_4nsSetValueMutable ts_4ns_set_value_;
  MbusTs_4nsIncValueMutable ts_4ns_inc_value_;
  MbusMacWbMulticastVecMutable mac_wb_multicast_;
  MbusBaresyncTsIncAltMutable baresync_ts_inc_alt_;
  MbusTs_4nsValueMutable ts_4ns_value_;
  MbusTs_4nsCaptureMutable ts_4ns_capture_;
  MbusBaresyncAltCycStatusMutable baresync_alt_cyc_;
  MbusBaresyncAltCycGapCtrlMutable baresync_ts_inc_alt_gap_;
  MbusBaresyncAltCycCtrlMutable baresync_ts_inc_alt_cyc_;
  MbusMstCtrlLogMutable mst_ctrl_log_;
  GlobalTsCtrlLogMutable global_ts_log_;
private:
...
#endif // __REGISTER_INCLUDES_MBUS_RSPEC_MUTABLE_H__
