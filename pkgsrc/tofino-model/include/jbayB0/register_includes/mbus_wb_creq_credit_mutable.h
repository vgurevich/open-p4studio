...
#ifndef __REGISTER_INCLUDES_MBUS_WB_CREQ_CREDIT_MUTABLE_H__
#define __REGISTER_INCLUDES_MBUS_WB_CREQ_CREDIT_MUTABLE_H__
...
class MbusWbCreqCreditMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  MbusWbCreqCreditMutable(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 28, true, write_callback, read_callback, std::string("MbusWbCreqCreditMutable"))
    {
    }
  MbusWbCreqCreditMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "MbusWbCreqCreditMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("MbusWbCreqCreditMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_MBUS_WB_CREQ_CREDIT_MUTABLE_H__
