...
#ifndef __REGISTER_INCLUDES_MIRR_S2P_SESS_CFG_WORD0_R_MUTABLE_H__
#define __REGISTER_INCLUDES_MIRR_S2P_SESS_CFG_WORD0_R_MUTABLE_H__
...
class MirrS2pSessCfgWord0RMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  MirrS2pSessCfgWord0RMutable(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 4, true, write_callback, read_callback, std::string("MirrS2pSessCfgWord0RMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  MirrS2pSessCfgWord0RMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "MirrS2pSessCfgWord0RMutable")
    {
    }
public:
  ...
  void hash_cfg_f(const uint8_t &v) { hash_cfg_f_=v; }
  ...
  void icos_cfg_f(const uint8_t &v) { icos_cfg_f_=v; }
  ...
  void dod_cfg_f(const uint8_t &v) { dod_cfg_f_=v; }
  ...
  void c2c_cfg_f(const uint8_t &v) { c2c_cfg_f_=v; }
  ...
  void mc_cfg_f(const uint8_t &v) { mc_cfg_f_=v; }
  ...
  void epipe_cfg_f(const uint8_t &v) { epipe_cfg_f_=v; }
  ...
  void yid_f(const uint16_t &v) { yid_f_=v; }
  ...
  void xid_f(const uint16_t &v) { xid_f_=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("MirrS2pSessCfgWord0RMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_MIRR_S2P_SESS_CFG_WORD0_R_MUTABLE_H__
