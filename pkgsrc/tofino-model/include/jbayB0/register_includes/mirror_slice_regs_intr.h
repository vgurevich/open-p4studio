...
#ifndef __REGISTER_INCLUDES_MIRROR_SLICE_REGS_INTR_H__
#define __REGISTER_INCLUDES_MIRROR_SLICE_REGS_INTR_H__
...
#include "mirror_slice_regs_intr_en0.h"
#include "mirror_slice_regs_intr_en1.h"
#include "mirror_slice_regs_intr_freeze_enable.h"
#include "mirror_slice_regs_intr_inj.h"
#include "mirror_slice_regs_intr_stat.h"

namespace jbayB0 {
  namespace register_classes {

class MirrorSliceRegsIntr : public model_core::RegisterBlock<RegisterCallback> {
public:
  MirrorSliceRegsIntr(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mirror_slice_regs), 20, false, write_callback, read_callback, std::string("MirrorSliceRegsIntr")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mirror_slice_regs))
    {
    }
  MirrorSliceRegsIntr(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "MirrorSliceRegsIntr")
    {
    }
public:
  ...
  MirrorSliceRegsIntrStat &intr_stat() { return intr_stat_; }
  ...
  MirrorSliceRegsIntrEn0 &intr_en0() { return intr_en0_; }
  ...
  MirrorSliceRegsIntrEn1 &intr_en1() { return intr_en1_; }
  ...
  MirrorSliceRegsIntrInj &intr_inj() { return intr_inj_; }





  MirrorSliceRegsIntrFreezeEnable &intr_freeze_enable() { return intr_freeze_enable_; }
...
private:
  MirrorSliceRegsIntrStat intr_stat_;
  MirrorSliceRegsIntrEn0 intr_en0_;
  MirrorSliceRegsIntrEn1 intr_en1_;
  MirrorSliceRegsIntrInj intr_inj_;
  MirrorSliceRegsIntrFreezeEnable intr_freeze_enable_;
private:
...
#endif // __REGISTER_INCLUDES_MIRROR_SLICE_REGS_INTR_H__
