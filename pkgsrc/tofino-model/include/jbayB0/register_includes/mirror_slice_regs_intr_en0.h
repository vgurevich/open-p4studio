...
#ifndef __REGISTER_INCLUDES_MIRROR_SLICE_REGS_INTR_EN0_H__
#define __REGISTER_INCLUDES_MIRROR_SLICE_REGS_INTR_EN0_H__
...
class MirrorSliceRegsIntrEn0 : public model_core::RegisterBlock<RegisterCallback> {
public:
  MirrorSliceRegsIntrEn0(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mirror_slice_regs), 4, false, write_callback, read_callback, std::string("MirrorSliceRegsIntrEn0")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mirror_slice_regs))
    {
    }
  MirrorSliceRegsIntrEn0(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "MirrorSliceRegsIntrEn0")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("MirrorSliceRegsIntrEn0") + ":\n";
...
#endif // __REGISTER_INCLUDES_MIRROR_SLICE_REGS_INTR_EN0_H__
