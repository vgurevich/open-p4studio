...
#ifndef __REGISTER_INCLUDES_MIRROR_SLICE_REGS_INTR_EN1_MUTABLE_H__
#define __REGISTER_INCLUDES_MIRROR_SLICE_REGS_INTR_EN1_MUTABLE_H__
...
class MirrorSliceRegsIntrEn1Mutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  MirrorSliceRegsIntrEn1Mutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mirror_slice_regs), 4, true, write_callback, read_callback, std::string("MirrorSliceRegsIntrEn1Mutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mirror_slice_regs))
    {
    }
  MirrorSliceRegsIntrEn1Mutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "MirrorSliceRegsIntrEn1Mutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("MirrorSliceRegsIntrEn1Mutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x268; // to get to intr_en1
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_MIRROR_SLICE_REGS_INTR_EN1_MUTABLE_H__
