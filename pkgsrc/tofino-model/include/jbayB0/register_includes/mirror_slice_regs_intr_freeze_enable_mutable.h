...
#ifndef __REGISTER_INCLUDES_MIRROR_SLICE_REGS_INTR_FREEZE_ENABLE_MUTABLE_H__
#define __REGISTER_INCLUDES_MIRROR_SLICE_REGS_INTR_FREEZE_ENABLE_MUTABLE_H__
...
class MirrorSliceRegsIntrFreezeEnableMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  MirrorSliceRegsIntrFreezeEnableMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mirror_slice_regs), 4, true, write_callback, read_callback, std::string("MirrorSliceRegsIntrFreezeEnableMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mirror_slice_regs))
    {
    }
  MirrorSliceRegsIntrFreezeEnableMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "MirrorSliceRegsIntrFreezeEnableMutable")
    {
    }
public:
  uint8_t idprs_input_sop_eop_mismatch() { return idprs_input_sop_eop_mismatch_; }
  void idprs_input_sop_eop_mismatch(const uint8_t &v) { idprs_input_sop_eop_mismatch_=v; }
  uint8_t edprs_input_sop_eop_mismatch() { return edprs_input_sop_eop_mismatch_; }
  void edprs_input_sop_eop_mismatch(const uint8_t &v) { edprs_input_sop_eop_mismatch_=v; }
  uint8_t session_mem_sbe() { return session_mem_sbe_; }
  void session_mem_sbe(const uint8_t &v) { session_mem_sbe_=v; }
  uint8_t session_mem_mbe() { return session_mem_mbe_; }
  void session_mem_mbe(const uint8_t &v) { session_mem_mbe_=v; }
  uint8_t data_mem_sbe() { return data_mem_sbe_; }
  void data_mem_sbe(const uint8_t &v) { data_mem_sbe_=v; }
  uint8_t data_mem_mbe() { return data_mem_mbe_; }
  void data_mem_mbe(const uint8_t &v) { data_mem_mbe_=v; }
  uint8_t meta_mem_sbe() { return meta_mem_sbe_; }
  void meta_mem_sbe(const uint8_t &v) { meta_mem_sbe_=v; }
  uint8_t meta_mem_mbe() { return meta_mem_mbe_; }
  void meta_mem_mbe(const uint8_t &v) { meta_mem_mbe_=v; }
  uint8_t dbuff_almost_full() { return dbuff_almost_full_; }
  void dbuff_almost_full(const uint8_t &v) { dbuff_almost_full_=v; }
  uint8_t dbuff_full() { return dbuff_full_; }
  void dbuff_full(const uint8_t &v) { dbuff_full_=v; }
  uint8_t idpr_bcnt_err() { return idpr_bcnt_err_; }
  void idpr_bcnt_err(const uint8_t &v) { idpr_bcnt_err_=v; }
  uint8_t buffer_alloc_error() { return buffer_alloc_error_; }
  void buffer_alloc_error(const uint8_t &v) { buffer_alloc_error_=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("MirrorSliceRegsIntrFreezeEnableMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x270; // to get to intr_freeze_enable
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_MIRROR_SLICE_REGS_INTR_FREEZE_ENABLE_MUTABLE_H__
