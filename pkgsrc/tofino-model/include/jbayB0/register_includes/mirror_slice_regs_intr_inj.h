...
#ifndef __REGISTER_INCLUDES_MIRROR_SLICE_REGS_INTR_INJ_H__
#define __REGISTER_INCLUDES_MIRROR_SLICE_REGS_INTR_INJ_H__
...
class MirrorSliceRegsIntrInj : public model_core::RegisterBlock<RegisterCallback> {
public:
  MirrorSliceRegsIntrInj(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mirror_slice_regs), 4, false, write_callback, read_callback, std::string("MirrorSliceRegsIntrInj")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mirror_slice_regs))
    {
    }
  MirrorSliceRegsIntrInj(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "MirrorSliceRegsIntrInj")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("MirrorSliceRegsIntrInj") + ":\n";
...
#endif // __REGISTER_INCLUDES_MIRROR_SLICE_REGS_INTR_INJ_H__
