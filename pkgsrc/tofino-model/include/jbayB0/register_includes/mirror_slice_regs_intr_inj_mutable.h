...
#ifndef __REGISTER_INCLUDES_MIRROR_SLICE_REGS_INTR_INJ_MUTABLE_H__
#define __REGISTER_INCLUDES_MIRROR_SLICE_REGS_INTR_INJ_MUTABLE_H__
...
class MirrorSliceRegsIntrInjMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  MirrorSliceRegsIntrInjMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mirror_slice_regs), 4, true, write_callback, read_callback, std::string("MirrorSliceRegsIntrInjMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mirror_slice_regs))
    {
    }
  MirrorSliceRegsIntrInjMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "MirrorSliceRegsIntrInjMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("MirrorSliceRegsIntrInjMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x26c; // to get to intr_inj
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_MIRROR_SLICE_REGS_INTR_INJ_MUTABLE_H__
