...
#ifndef __REGISTER_INCLUDES_MIRROR_SLICE_REGS_INTR_STAT_MUTABLE_H__
#define __REGISTER_INCLUDES_MIRROR_SLICE_REGS_INTR_STAT_MUTABLE_H__
...
class MirrorSliceRegsIntrStatMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  MirrorSliceRegsIntrStatMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mirror_slice_regs), 4, true, write_callback, read_callback, std::string("MirrorSliceRegsIntrStatMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mirror_slice_regs))
    {
    }
  MirrorSliceRegsIntrStatMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "MirrorSliceRegsIntrStatMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("MirrorSliceRegsIntrStatMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_MIRROR_SLICE_REGS_INTR_STAT_MUTABLE_H__
