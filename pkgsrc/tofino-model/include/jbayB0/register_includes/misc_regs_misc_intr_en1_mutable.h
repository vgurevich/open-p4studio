...
#ifndef __REGISTER_INCLUDES_MISC_REGS_MISC_INTR_EN1_MUTABLE_H__
#define __REGISTER_INCLUDES_MISC_REGS_MISC_INTR_EN1_MUTABLE_H__
...
class MiscRegsMiscIntrEn1Mutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  MiscRegsMiscIntrEn1Mutable(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 4, true, write_callback, read_callback, std::string("MiscRegsMiscIntrEn1Mutable"))
    {
    }
  MiscRegsMiscIntrEn1Mutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "MiscRegsMiscIntrEn1Mutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("MiscRegsMiscIntrEn1Mutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x208; // to get to misc_intr_en1
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_MISC_REGS_MISC_INTR_EN1_MUTABLE_H__
