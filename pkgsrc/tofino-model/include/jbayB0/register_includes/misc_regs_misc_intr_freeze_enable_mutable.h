...
#ifndef __REGISTER_INCLUDES_MISC_REGS_MISC_INTR_FREEZE_ENABLE_MUTABLE_H__
#define __REGISTER_INCLUDES_MISC_REGS_MISC_INTR_FREEZE_ENABLE_MUTABLE_H__
...
class MiscRegsMiscIntrFreezeEnableMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  MiscRegsMiscIntrFreezeEnableMutable(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 4, true, write_callback, read_callback, std::string("MiscRegsMiscIntrFreezeEnableMutable"))
    {
    }
  MiscRegsMiscIntrFreezeEnableMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "MiscRegsMiscIntrFreezeEnableMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("MiscRegsMiscIntrFreezeEnableMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x210; // to get to misc_intr_freeze_enable
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_MISC_REGS_MISC_INTR_FREEZE_ENABLE_MUTABLE_H__
