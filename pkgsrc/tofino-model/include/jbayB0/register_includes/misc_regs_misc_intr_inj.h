...
#ifndef __REGISTER_INCLUDES_MISC_REGS_MISC_INTR_INJ_H__
#define __REGISTER_INCLUDES_MISC_REGS_MISC_INTR_INJ_H__
...
class MiscRegsMiscIntrInj : public model_core::RegisterBlock<RegisterCallback> {
public:
  MiscRegsMiscIntrInj(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 4, false, write_callback, read_callback, std::string("MiscRegsMiscIntrInj"))
    {
    }
  MiscRegsMiscIntrInj(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "MiscRegsMiscIntrInj")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("MiscRegsMiscIntrInj") + ":\n";
...
#endif // __REGISTER_INCLUDES_MISC_REGS_MISC_INTR_INJ_H__
