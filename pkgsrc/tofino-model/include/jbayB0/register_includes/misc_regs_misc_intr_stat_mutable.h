...
#ifndef __REGISTER_INCLUDES_MISC_REGS_MISC_INTR_STAT_MUTABLE_H__
#define __REGISTER_INCLUDES_MISC_REGS_MISC_INTR_STAT_MUTABLE_H__
...
class MiscRegsMiscIntrStatMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  MiscRegsMiscIntrStatMutable(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 4, true, write_callback, read_callback, std::string("MiscRegsMiscIntrStatMutable"))
    {
    }
  MiscRegsMiscIntrStatMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "MiscRegsMiscIntrStatMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("MiscRegsMiscIntrStatMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x200; // to get to misc_intr_stat
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_MISC_REGS_MISC_INTR_STAT_MUTABLE_H__
