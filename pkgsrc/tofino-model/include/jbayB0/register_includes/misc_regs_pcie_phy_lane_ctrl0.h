...
#ifndef __REGISTER_INCLUDES_MISC_REGS_PCIE_PHY_LANE_CTRL0_H__
#define __REGISTER_INCLUDES_MISC_REGS_PCIE_PHY_LANE_CTRL0_H__
...
class MiscRegsPciePhyLaneCtrl0 : public model_core::RegisterBlock<RegisterCallback> {
public:
  MiscRegsPciePhyLaneCtrl0(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 4, false, write_callback, read_callback, std::string("MiscRegsPciePhyLaneCtrl0"))
    {
    }
  MiscRegsPciePhyLaneCtrl0(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "MiscRegsPciePhyLaneCtrl0")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("MiscRegsPciePhyLaneCtrl0") + ":\n";
...
#endif // __REGISTER_INCLUDES_MISC_REGS_PCIE_PHY_LANE_CTRL0_H__
