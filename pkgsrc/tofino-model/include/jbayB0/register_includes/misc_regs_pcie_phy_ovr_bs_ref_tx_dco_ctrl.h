...
#ifndef __REGISTER_INCLUDES_MISC_REGS_PCIE_PHY_OVR_BS_REF_TX_DCO_CTRL_H__
#define __REGISTER_INCLUDES_MISC_REGS_PCIE_PHY_OVR_BS_REF_TX_DCO_CTRL_H__
...
class MiscRegsPciePhyOvrBsRefTxDcoCtrl : public model_core::RegisterBlock<RegisterCallback> {
public:
  MiscRegsPciePhyOvrBsRefTxDcoCtrl(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 4, false, write_callback, read_callback, std::string("MiscRegsPciePhyOvrBsRefTxDcoCtrl"))
    {
    }
  MiscRegsPciePhyOvrBsRefTxDcoCtrl(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "MiscRegsPciePhyOvrBsRefTxDcoCtrl")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("MiscRegsPciePhyOvrBsRefTxDcoCtrl") + ":\n";
...
#endif // __REGISTER_INCLUDES_MISC_REGS_PCIE_PHY_OVR_BS_REF_TX_DCO_CTRL_H__
