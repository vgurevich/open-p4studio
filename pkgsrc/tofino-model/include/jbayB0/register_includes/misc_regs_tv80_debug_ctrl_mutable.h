...
#ifndef __REGISTER_INCLUDES_MISC_REGS_TV80_DEBUG_CTRL_MUTABLE_H__
#define __REGISTER_INCLUDES_MISC_REGS_TV80_DEBUG_CTRL_MUTABLE_H__
...
class MiscRegsTv80DebugCtrlMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  MiscRegsTv80DebugCtrlMutable(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 4, true, write_callback, read_callback, std::string("MiscRegsTv80DebugCtrlMutable"))
    {
    }
  MiscRegsTv80DebugCtrlMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "MiscRegsTv80DebugCtrlMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("MiscRegsTv80DebugCtrlMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_MISC_REGS_TV80_DEBUG_CTRL_MUTABLE_H__
