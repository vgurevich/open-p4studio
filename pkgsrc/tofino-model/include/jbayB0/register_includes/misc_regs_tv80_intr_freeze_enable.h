...
#ifndef __REGISTER_INCLUDES_MISC_REGS_TV80_INTR_FREEZE_ENABLE_H__
#define __REGISTER_INCLUDES_MISC_REGS_TV80_INTR_FREEZE_ENABLE_H__
...
class MiscRegsTv80IntrFreezeEnable : public model_core::RegisterBlock<RegisterCallback> {
public:
  MiscRegsTv80IntrFreezeEnable(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 4, false, write_callback, read_callback, std::string("MiscRegsTv80IntrFreezeEnable"))
    {
    }
  MiscRegsTv80IntrFreezeEnable(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "MiscRegsTv80IntrFreezeEnable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("MiscRegsTv80IntrFreezeEnable") + ":\n";
...
#endif // __REGISTER_INCLUDES_MISC_REGS_TV80_INTR_FREEZE_ENABLE_H__
