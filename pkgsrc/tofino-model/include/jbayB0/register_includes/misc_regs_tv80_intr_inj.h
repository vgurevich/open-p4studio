...
#ifndef __REGISTER_INCLUDES_MISC_REGS_TV80_INTR_INJ_H__
#define __REGISTER_INCLUDES_MISC_REGS_TV80_INTR_INJ_H__
...
class MiscRegsTv80IntrInj : public model_core::RegisterBlock<RegisterCallback> {
public:
  MiscRegsTv80IntrInj(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 4, false, write_callback, read_callback, std::string("MiscRegsTv80IntrInj"))
    {
    }
  MiscRegsTv80IntrInj(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "MiscRegsTv80IntrInj")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("MiscRegsTv80IntrInj") + ":\n";
...
#endif // __REGISTER_INCLUDES_MISC_REGS_TV80_INTR_INJ_H__
