...
#ifndef __REGISTER_INCLUDES_MISC_REGS_TV80_INTR_STAT_MUTABLE_H__
#define __REGISTER_INCLUDES_MISC_REGS_TV80_INTR_STAT_MUTABLE_H__
...
class MiscRegsTv80IntrStatMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  MiscRegsTv80IntrStatMutable(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 4, true, write_callback, read_callback, std::string("MiscRegsTv80IntrStatMutable"))
    {
    }
  MiscRegsTv80IntrStatMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "MiscRegsTv80IntrStatMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("MiscRegsTv80IntrStatMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_MISC_REGS_TV80_INTR_STAT_MUTABLE_H__
