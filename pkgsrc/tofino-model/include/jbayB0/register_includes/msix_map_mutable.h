...
#ifndef __REGISTER_INCLUDES_MSIX_MAP_MUTABLE_H__
#define __REGISTER_INCLUDES_MSIX_MAP_MUTABLE_H__
...
class MsixMapMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  MsixMapMutable(
      int chipNumber, int index_msix_map, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_msix_map), 4, true, write_callback, read_callback, std::string("MsixMapMutable")+":"+boost::lexical_cast<std::string>(index_msix_map))
    {
    }
  MsixMapMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "MsixMapMutable")
    {
    }
public:
  ...
  void int_4np0(const uint8_t &v) { int_4np0_=v; }
  ...
  void int_4np1(const uint8_t &v) { int_4np1_=v; }
  ...
  void int_4np2(const uint8_t &v) { int_4np2_=v; }
  ...
  void int_4np3(const uint8_t &v) { int_4np3_=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("MsixMapMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_MSIX_MAP_MUTABLE_H__
