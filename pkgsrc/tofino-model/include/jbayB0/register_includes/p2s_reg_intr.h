...
#ifndef __REGISTER_INCLUDES_P2S_REG_INTR_H__
#define __REGISTER_INCLUDES_P2S_REG_INTR_H__
...
#include "p2s_reg_intr_en0.h"
#include "p2s_reg_intr_en1.h"
#include "p2s_reg_intr_freeze_enable.h"
#include "p2s_reg_intr_inj.h"
#include "p2s_reg_intr_stat.h"

namespace jbayB0 {
  namespace register_classes {

class P2sRegIntr : public model_core::RegisterBlock<RegisterCallback> {
public:
  P2sRegIntr(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 20, false, write_callback, read_callback, std::string("P2sRegIntr")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  P2sRegIntr(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "P2sRegIntr")
    {
    }
public:
  ...
  P2sRegIntrStat &intr_stat() { return intr_stat_; }
  ...
  P2sRegIntrEn0 &intr_en0() { return intr_en0_; }
  ...
  P2sRegIntrEn1 &intr_en1() { return intr_en1_; }
  ...
  P2sRegIntrInj &intr_inj() { return intr_inj_; }





  P2sRegIntrFreezeEnable &intr_freeze_enable() { return intr_freeze_enable_; }
...
private:
  P2sRegIntrStat intr_stat_;
  P2sRegIntrEn0 intr_en0_;
  P2sRegIntrEn1 intr_en1_;
  P2sRegIntrInj intr_inj_;
  P2sRegIntrFreezeEnable intr_freeze_enable_;
private:
...
#endif // __REGISTER_INCLUDES_P2S_REG_INTR_H__
