...
#ifndef __REGISTER_INCLUDES_P2S_REG_INTR_EN1_H__
#define __REGISTER_INCLUDES_P2S_REG_INTR_EN1_H__
...
class P2sRegIntrEn1 : public model_core::RegisterBlock<RegisterCallback> {
public:
  P2sRegIntrEn1(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 4, false, write_callback, read_callback, std::string("P2sRegIntrEn1")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  P2sRegIntrEn1(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "P2sRegIntrEn1")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("P2sRegIntrEn1") + ":\n";
...
#endif // __REGISTER_INCLUDES_P2S_REG_INTR_EN1_H__
