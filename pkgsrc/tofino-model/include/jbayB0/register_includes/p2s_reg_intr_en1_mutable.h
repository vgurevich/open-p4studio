...
#ifndef __REGISTER_INCLUDES_P2S_REG_INTR_EN1_MUTABLE_H__
#define __REGISTER_INCLUDES_P2S_REG_INTR_EN1_MUTABLE_H__
...
class P2sRegIntrEn1Mutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  P2sRegIntrEn1Mutable(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 4, true, write_callback, read_callback, std::string("P2sRegIntrEn1Mutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  P2sRegIntrEn1Mutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "P2sRegIntrEn1Mutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("P2sRegIntrEn1Mutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0xb08; // to get to intr_en1
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_P2S_REG_INTR_EN1_MUTABLE_H__
