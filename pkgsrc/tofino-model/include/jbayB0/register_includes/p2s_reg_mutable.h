...
#ifndef __REGISTER_INCLUDES_P2S_REG_MUTABLE_H__
#define __REGISTER_INCLUDES_P2S_REG_MUTABLE_H__
...
#include "p2s_reg_byte_ctr_mutable.h"
#include "p2s_reg_ctr_sample_mutable.h"
#include "p2s_reg_ctr_time_mutable.h"
#include "p2s_reg_ecc_mutable.h"
#include "p2s_reg_epb_cred_oflow_err_log_mutable.h"
#include "p2s_reg_epb_cred_rd_mutable.h"
#include "p2s_reg_epb_cred_uflow_err_log_mutable.h"
#include "p2s_reg_epb_cred_wr_mutable.h"
#include "p2s_reg_intr_mutable.h"
#include "p2s_reg_pipe_map_mutable.h"
#include "p2s_reg_pkt_ctr_mutable.h"
#include "p2s_reg_port_rate_cfg_mutable.h"
#include "p2s_reg_sb_oflow_err_log_mutable.h"
#include "p2s_reg_sb_uflow_err_log_mutable.h"
#include "p2s_reg_sb_0_mbe_err_log_mutable.h"
#include "p2s_reg_sb_0_sbe_err_log_mutable.h"
#include "p2s_reg_sb_1_mbe_err_log_mutable.h"
#include "p2s_reg_sb_1_sbe_err_log_mutable.h"
#include "p2s_reg_sb_2_mbe_err_log_mutable.h"
#include "p2s_reg_sb_2_sbe_err_log_mutable.h"
#include "p2s_reg_sb_3_mbe_err_log_mutable.h"
#include "p2s_reg_sb_3_sbe_err_log_mutable.h"
#include "p2s_reg_sb_4_mbe_err_log_mutable.h"
#include "p2s_reg_sb_4_sbe_err_log_mutable.h"
#include "p2s_reg_tm_cred_mutable.h"
#include "p2s_reg_tm_mbe_err_log_mutable.h"
#include "p2s_reg_tm_sbe_err_log_mutable.h"

namespace jbayB0 {
  namespace register_classes {

class P2sRegMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  P2sRegMutable(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 3016, true, write_callback, read_callback, std::string("P2sRegMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  P2sRegMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "P2sRegMutable")
    {
    }
public:
  ...
  P2sRegPortRateCfgMutable &port_rate_cfg(int j0) { return port_rate_cfg_[j0]; }
  ...
  P2sRegEpbCredWrMutable &epb_cred_wr(int j0) { return epb_cred_wr_[j0]; }
  ...
  P2sRegEpbCredRdMutable &epb_cred_rd(int j0) { return epb_cred_rd_[j0]; }
  ...
  P2sRegPktCtrMutable &pkt_ctr(int j0) { return pkt_ctr_[j0]; }
  ...
  P2sRegByteCtrMutable &byte_ctr(int j0) { return byte_ctr_[j0]; }




  P2sRegCtrTimeMutable &ctr_time() { return ctr_time_; }




  P2sRegCtrSampleMutable &ctr_sample() { return ctr_sample_; }
  ...
  P2sRegEccMutable &ecc() { return ecc_; }





  P2sRegTmSbeErrLogMutable &tm_sbe_err_log() { return tm_sbe_err_log_; }





  P2sRegTmMbeErrLogMutable &tm_mbe_err_log() { return tm_mbe_err_log_; }





  P2sRegSb_0SbeErrLogMutable &sb_0_sbe_err_log() { return sb_0_sbe_err_log_; }





  P2sRegSb_0MbeErrLogMutable &sb_0_mbe_err_log() { return sb_0_mbe_err_log_; }





  P2sRegSb_1SbeErrLogMutable &sb_1_sbe_err_log() { return sb_1_sbe_err_log_; }





  P2sRegSb_1MbeErrLogMutable &sb_1_mbe_err_log() { return sb_1_mbe_err_log_; }





  P2sRegSb_2SbeErrLogMutable &sb_2_sbe_err_log() { return sb_2_sbe_err_log_; }





  P2sRegSb_2MbeErrLogMutable &sb_2_mbe_err_log() { return sb_2_mbe_err_log_; }





  P2sRegSb_3SbeErrLogMutable &sb_3_sbe_err_log() { return sb_3_sbe_err_log_; }





  P2sRegSb_3MbeErrLogMutable &sb_3_mbe_err_log() { return sb_3_mbe_err_log_; }





  P2sRegSb_4SbeErrLogMutable &sb_4_sbe_err_log() { return sb_4_sbe_err_log_; }





  P2sRegSb_4MbeErrLogMutable &sb_4_mbe_err_log() { return sb_4_mbe_err_log_; }





  P2sRegSbOflowErrLogMutable &sb_oflow_err_log() { return sb_oflow_err_log_; }





  P2sRegSbUflowErrLogMutable &sb_uflow_err_log() { return sb_uflow_err_log_; }





  P2sRegEpbCredOflowErrLogMutable &epb_cred_oflow_err_log() { return epb_cred_oflow_err_log_; }





  P2sRegEpbCredUflowErrLogMutable &epb_cred_uflow_err_log() { return epb_cred_uflow_err_log_; }





  P2sRegPipeMapMutable &pipe_map() { return pipe_map_; }
  ...
  P2sRegTmCredMutable &tm_cred(int j0) { return tm_cred_[j0]; }
  P2sRegIntrMutable &intr() { return intr_; }
...
private:
  std::array< P2sRegPortRateCfgMutable, 9 > port_rate_cfg_;
  std::array< P2sRegEpbCredWrMutable, 18 > epb_cred_wr_;
  std::array< P2sRegEpbCredRdMutable, 18 > epb_cred_rd_;
  std::array< P2sRegPktCtrMutable, 72 > pkt_ctr_;
  std::array< P2sRegByteCtrMutable, 72 > byte_ctr_;
  P2sRegCtrTimeMutable ctr_time_;
  P2sRegCtrSampleMutable ctr_sample_;
  P2sRegEccMutable ecc_;
  P2sRegTmSbeErrLogMutable tm_sbe_err_log_;
  P2sRegTmMbeErrLogMutable tm_mbe_err_log_;
  P2sRegSb_0SbeErrLogMutable sb_0_sbe_err_log_;
  P2sRegSb_0MbeErrLogMutable sb_0_mbe_err_log_;
  P2sRegSb_1SbeErrLogMutable sb_1_sbe_err_log_;
  P2sRegSb_1MbeErrLogMutable sb_1_mbe_err_log_;
  P2sRegSb_2SbeErrLogMutable sb_2_sbe_err_log_;
  P2sRegSb_2MbeErrLogMutable sb_2_mbe_err_log_;
  P2sRegSb_3SbeErrLogMutable sb_3_sbe_err_log_;
  P2sRegSb_3MbeErrLogMutable sb_3_mbe_err_log_;
  P2sRegSb_4SbeErrLogMutable sb_4_sbe_err_log_;
  P2sRegSb_4MbeErrLogMutable sb_4_mbe_err_log_;
  P2sRegSbOflowErrLogMutable sb_oflow_err_log_;
  P2sRegSbUflowErrLogMutable sb_uflow_err_log_;
  P2sRegEpbCredOflowErrLogMutable epb_cred_oflow_err_log_;
  P2sRegEpbCredUflowErrLogMutable epb_cred_uflow_err_log_;
  P2sRegPipeMapMutable pipe_map_;
  std::array< P2sRegTmCredMutable, 18 > tm_cred_;
  P2sRegIntrMutable intr_;
private:
...
#endif // __REGISTER_INCLUDES_P2S_REG_MUTABLE_H__
