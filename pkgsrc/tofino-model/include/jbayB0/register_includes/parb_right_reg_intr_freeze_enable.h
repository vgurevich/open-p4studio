...
#ifndef __REGISTER_INCLUDES_PARB_RIGHT_REG_INTR_FREEZE_ENABLE_H__
#define __REGISTER_INCLUDES_PARB_RIGHT_REG_INTR_FREEZE_ENABLE_H__
...
class ParbRightRegIntrFreezeEnable : public model_core::RegisterBlock<RegisterCallback> {
public:
  ParbRightRegIntrFreezeEnable(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 4, false, write_callback, read_callback, std::string("ParbRightRegIntrFreezeEnable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  ParbRightRegIntrFreezeEnable(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "ParbRightRegIntrFreezeEnable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("ParbRightRegIntrFreezeEnable") + ":\n";
...
#endif // __REGISTER_INCLUDES_PARB_RIGHT_REG_INTR_FREEZE_ENABLE_H__
