...
#ifndef __REGISTER_INCLUDES_PARB_RIGHT_REG_INTR_INJ_H__
#define __REGISTER_INCLUDES_PARB_RIGHT_REG_INTR_INJ_H__
...
class ParbRightRegIntrInj : public model_core::RegisterBlock<RegisterCallback> {
public:
  ParbRightRegIntrInj(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 4, false, write_callback, read_callback, std::string("ParbRightRegIntrInj")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  ParbRightRegIntrInj(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "ParbRightRegIntrInj")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("ParbRightRegIntrInj") + ":\n";
...
#endif // __REGISTER_INCLUDES_PARB_RIGHT_REG_INTR_INJ_H__
