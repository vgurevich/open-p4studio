...
#ifndef __REGISTER_INCLUDES_PARB_RIGHT_REG_INTR_STAT_MUTABLE_H__
#define __REGISTER_INCLUDES_PARB_RIGHT_REG_INTR_STAT_MUTABLE_H__
...
class ParbRightRegIntrStatMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  ParbRightRegIntrStatMutable(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 4, true, write_callback, read_callback, std::string("ParbRightRegIntrStatMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  ParbRightRegIntrStatMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "ParbRightRegIntrStatMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("ParbRightRegIntrStatMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_PARB_RIGHT_REG_INTR_STAT_MUTABLE_H__
