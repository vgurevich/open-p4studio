...
#ifndef __REGISTER_INCLUDES_PARDE_DPRSR_REG_RSPEC_CSR_RING_FULL_THRESH_H__
#define __REGISTER_INCLUDES_PARDE_DPRSR_REG_RSPEC_CSR_RING_FULL_THRESH_H__
...
class PardeDprsrRegRspecCsrRingFullThresh : public model_core::RegisterBlock<RegisterCallback> {
public:
  PardeDprsrRegRspecCsrRingFullThresh(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 4, false, write_callback, read_callback, std::string("PardeDprsrRegRspecCsrRingFullThresh")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  PardeDprsrRegRspecCsrRingFullThresh(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "PardeDprsrRegRspecCsrRingFullThresh")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PardeDprsrRegRspecCsrRingFullThresh") + ":\n";
...
#endif // __REGISTER_INCLUDES_PARDE_DPRSR_REG_RSPEC_CSR_RING_FULL_THRESH_H__
