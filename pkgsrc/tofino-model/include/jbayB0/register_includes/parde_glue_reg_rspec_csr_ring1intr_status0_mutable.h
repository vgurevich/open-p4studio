...
#ifndef __REGISTER_INCLUDES_PARDE_GLUE_REG_RSPEC_CSR_RING1INTR_STATUS0_MUTABLE_H__
#define __REGISTER_INCLUDES_PARDE_GLUE_REG_RSPEC_CSR_RING1INTR_STATUS0_MUTABLE_H__
...
class PardeGlueRegRspecCsrRing1intrStatus0Mutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  PardeGlueRegRspecCsrRing1intrStatus0Mutable(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 4, true, write_callback, read_callback, std::string("PardeGlueRegRspecCsrRing1intrStatus0Mutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  PardeGlueRegRspecCsrRing1intrStatus0Mutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "PardeGlueRegRspecCsrRing1intrStatus0Mutable")
    {
    }
public:
  ...
  void csr_ring1sid_4(const uint8_t &v) { csr_ring1sid_4_=v; }
  ...
  void csr_ring1sid_5(const uint8_t &v) { csr_ring1sid_5_=v; }
  ...
  void csr_ring1sid_6(const uint8_t &v) { csr_ring1sid_6_=v; }
  ...
  void csr_ring1sid_7(const uint8_t &v) { csr_ring1sid_7_=v; }
  ...
  void csr_ring1sid_8(const uint8_t &v) { csr_ring1sid_8_=v; }
  ...
  void csr_ring1sid_9(const uint8_t &v) { csr_ring1sid_9_=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PardeGlueRegRspecCsrRing1intrStatus0Mutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x18; // to get to csr_ring1intr_status0
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_PARDE_GLUE_REG_RSPEC_CSR_RING1INTR_STATUS0_MUTABLE_H__
