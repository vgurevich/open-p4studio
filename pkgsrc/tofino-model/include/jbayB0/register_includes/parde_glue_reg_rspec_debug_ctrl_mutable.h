...
#ifndef __REGISTER_INCLUDES_PARDE_GLUE_REG_RSPEC_DEBUG_CTRL_MUTABLE_H__
#define __REGISTER_INCLUDES_PARDE_GLUE_REG_RSPEC_DEBUG_CTRL_MUTABLE_H__
...
class PardeGlueRegRspecDebugCtrlMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  PardeGlueRegRspecDebugCtrlMutable(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 4, true, write_callback, read_callback, std::string("PardeGlueRegRspecDebugCtrlMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  PardeGlueRegRspecDebugCtrlMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "PardeGlueRegRspecDebugCtrlMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PardeGlueRegRspecDebugCtrlMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_PARDE_GLUE_REG_RSPEC_DEBUG_CTRL_MUTABLE_H__
