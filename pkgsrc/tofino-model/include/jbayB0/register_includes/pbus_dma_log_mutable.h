...
#ifndef __REGISTER_INCLUDES_PBUS_DMA_LOG_MUTABLE_H__
#define __REGISTER_INCLUDES_PBUS_DMA_LOG_MUTABLE_H__
...
class PbusDmaLogMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  PbusDmaLogMutable(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 28, true, write_callback, read_callback, std::string("PbusDmaLogMutable"))
    {
    }
  PbusDmaLogMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "PbusDmaLogMutable")
    {
    }
public:
  ...
  void il_read_statemachine(int j0,const uint8_t &v) { il_read_statemachine_[j0]=v; }
  ...
  void il_instr_statemachine(int j0,const uint8_t &v) { il_instr_statemachine_[j0]=v; }
  ...
  void il_write_statemachine(int j0,const uint8_t &v) { il_write_statemachine_[j0]=v; }
  ...
  void il_iqueue_data_credit(int j0,const uint16_t &v) { il_iqueue_data_credit_[j0]=v; }
  ...
  void il_oqueue_data_credit(int j0,const uint16_t &v) { il_oqueue_data_credit_[j0]=v; }
  ...
  void il_oqueue_resp_credit(int j0,const uint16_t &v) { il_oqueue_resp_credit_[j0]=v; }
  ...
  void il_req_mem_credit(int j0,const uint8_t &v) { il_req_mem_credit_[j0]=v; }
  ...
  void wb_read_statemachine(const uint8_t &v) { wb_read_statemachine_=v; }
  ...
  void wb_write_statemachine(const uint8_t &v) { wb_write_statemachine_=v; }
  ...
  void wb_data_credit(const uint16_t &v) { wb_data_credit_=v; }
  ...
  void rb_read_statemachine(const uint8_t &v) { rb_read_statemachine_=v; }
  ...
  void rb_write_statemachine(const uint8_t &v) { rb_write_statemachine_=v; }
  ...
  void rb_data_credit(const uint16_t &v) { rb_data_credit_=v; }
  ...
  void rb_resp_credit(const uint16_t &v) { rb_resp_credit_=v; }
  ...
  void rb_req_mem_credit(const uint8_t &v) { rb_req_mem_credit_=v; }
  ...
  void stat_write_statemachine(const uint8_t &v) { stat_write_statemachine_=v; }
  ...
  void stat_req_mem_credit(const uint8_t &v) { stat_req_mem_credit_=v; }
  ...
  void stat_write_data_count(const uint8_t &v) { stat_write_data_count_=v; }
  ...
  void idle_write_statemachine(const uint8_t &v) { idle_write_statemachine_=v; }
  ...
  void idle_req_mem_credit(const uint8_t &v) { idle_req_mem_credit_=v; }
  ...
  void idle_write_data_count(const uint8_t &v) { idle_write_data_count_=v; }
  ...
  void diag_statemachine(const uint8_t &v) { diag_statemachine_=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PbusDmaLogMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_PBUS_DMA_LOG_MUTABLE_H__
