...
#ifndef __REGISTER_INCLUDES_PBUS_HOST_CREQ_CREDIT_H__
#define __REGISTER_INCLUDES_PBUS_HOST_CREQ_CREDIT_H__
...
class PbusHostCreqCredit : public model_core::RegisterBlock<RegisterCallback> {
public:
  PbusHostCreqCredit(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 96, false, write_callback, read_callback, std::string("PbusHostCreqCredit"))
    {
    }
  PbusHostCreqCredit(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "PbusHostCreqCredit")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PbusHostCreqCredit") + ":\n";
...
#endif // __REGISTER_INCLUDES_PBUS_HOST_CREQ_CREDIT_H__
