...
#ifndef __REGISTER_INCLUDES_PGR_APP_CTRL_MUTABLE_H__
#define __REGISTER_INCLUDES_PGR_APP_CTRL_MUTABLE_H__
...
class PgrAppCtrlMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  PgrAppCtrlMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_pgr_app_reg_rspec), 4, true, write_callback, read_callback, std::string("PgrAppCtrlMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_pgr_app_reg_rspec))
    {
    }
  PgrAppCtrlMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "PgrAppCtrlMutable")
    {
    }
public:
  ...
  void app_en(const uint8_t &v) { app_en_=v; }
  ...
  void app_type(const uint8_t &v) { app_type_=v; }
  ...
  void app_chnl(const uint8_t &v) { app_chnl_=v; }
  ...
  void app_prio(const uint8_t &v) { app_prio_=v; }
  ...
  void app_nokey(const uint8_t &v) { app_nokey_=v; }
  ...
  void app_stop_at_pkt_bndry(const uint8_t &v) { app_stop_at_pkt_bndry_=v; }
  ...
  void app_port_down_mask_sel(const uint8_t &v) { app_port_down_mask_sel_=v; }
  ...
  void app_sel_curr_timestamp(const uint8_t &v) { app_sel_curr_timestamp_=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PgrAppCtrlMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_PGR_APP_CTRL_MUTABLE_H__
