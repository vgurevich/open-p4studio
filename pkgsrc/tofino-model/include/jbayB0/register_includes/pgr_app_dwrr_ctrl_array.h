...
#ifndef __REGISTER_INCLUDES_PGR_APP_DWRR_CTRL_ARRAY_H__
#define __REGISTER_INCLUDES_PGR_APP_DWRR_CTRL_ARRAY_H__
...
class PgrAppDwrrCtrlArray : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  PgrAppDwrrCtrlArray(
      int chipNumber, int index_pipe_addrmap, RegisterArrayCallback& write_callback = 0, RegisterArrayCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 4 * ArraySize(index_pipe_addrmap, -1), false, write_callback, read_callback, std::string("PgrAppDwrrCtrlArray")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap)),
...
public:
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("PgrAppDwrrCtrlArray") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
private:
  std::vector<PgrAppDwrrCtrl> array;
  uint32_t size0_;
...
#endif // __REGISTER_INCLUDES_PGR_APP_DWRR_CTRL_ARRAY_H__
