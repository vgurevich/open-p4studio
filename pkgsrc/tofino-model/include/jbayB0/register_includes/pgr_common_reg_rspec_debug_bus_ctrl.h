...
#ifndef __REGISTER_INCLUDES_PGR_COMMON_REG_RSPEC_DEBUG_BUS_CTRL_H__
#define __REGISTER_INCLUDES_PGR_COMMON_REG_RSPEC_DEBUG_BUS_CTRL_H__
...
class PgrCommonRegRspecDebugBusCtrl : public model_core::RegisterBlock<RegisterCallback> {
public:
  PgrCommonRegRspecDebugBusCtrl(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 4, false, write_callback, read_callback, std::string("PgrCommonRegRspecDebugBusCtrl")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  PgrCommonRegRspecDebugBusCtrl(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "PgrCommonRegRspecDebugBusCtrl")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PgrCommonRegRspecDebugBusCtrl") + ":\n";
...
#endif // __REGISTER_INCLUDES_PGR_COMMON_REG_RSPEC_DEBUG_BUS_CTRL_H__
