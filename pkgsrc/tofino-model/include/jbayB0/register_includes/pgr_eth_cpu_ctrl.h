...
#ifndef __REGISTER_INCLUDES_PGR_ETH_CPU_CTRL_H__
#define __REGISTER_INCLUDES_PGR_ETH_CPU_CTRL_H__
...
class PgrEthCpuCtrl : public model_core::RegisterBlock<RegisterCallback> {
public:
  PgrEthCpuCtrl(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 4, false, write_callback, read_callback, std::string("PgrEthCpuCtrl")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  PgrEthCpuCtrl(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "PgrEthCpuCtrl")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PgrEthCpuCtrl") + ":\n";
...
#endif // __REGISTER_INCLUDES_PGR_ETH_CPU_CTRL_H__
