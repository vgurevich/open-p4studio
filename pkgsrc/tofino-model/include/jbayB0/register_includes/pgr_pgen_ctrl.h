...
#ifndef __REGISTER_INCLUDES_PGR_PGEN_CTRL_H__
#define __REGISTER_INCLUDES_PGR_PGEN_CTRL_H__
...
class PgrPgenCtrl : public model_core::RegisterBlock<RegisterCallback> {
public:
  PgrPgenCtrl(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 8, false, write_callback, read_callback, std::string("PgrPgenCtrl")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  PgrPgenCtrl(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "PgrPgenCtrl")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PgrPgenCtrl") + ":\n";
...
#endif // __REGISTER_INCLUDES_PGR_PGEN_CTRL_H__
