...
#ifndef __REGISTER_INCLUDES_PGR_PGEN_PFC_LOG_MUTABLE_H__
#define __REGISTER_INCLUDES_PGR_PGEN_PFC_LOG_MUTABLE_H__
...
class PgrPgenPfcLogMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  PgrPgenPfcLogMutable(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 8, true, write_callback, read_callback, std::string("PgrPgenPfcLogMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  PgrPgenPfcLogMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "PgrPgenPfcLogMutable")
    {
    }
public:
  ...
  void pfc_statemachine_write(const uint8_t &v) { pfc_statemachine_write_=v; }
  ...
  void pfc_statemachine_read(const uint8_t &v) { pfc_statemachine_read_=v; }
  ...
  void pfc_mem_cur_wraddr(const uint16_t &v) { pfc_mem_cur_wraddr_=v; }
  ...
  void pfc_mem_rd_num_words(int j0,const uint16_t &v) { pfc_mem_rd_num_words_[j0]=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PgrPgenPfcLogMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_PGR_PGEN_PFC_LOG_MUTABLE_H__
