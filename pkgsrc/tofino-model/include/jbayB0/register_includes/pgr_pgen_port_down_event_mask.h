...
#ifndef __REGISTER_INCLUDES_PGR_PGEN_PORT_DOWN_EVENT_MASK_H__
#define __REGISTER_INCLUDES_PGR_PGEN_PORT_DOWN_EVENT_MASK_H__
...
class PgrPgenPortDownEventMask : public model_core::RegisterBlock<RegisterCallback> {
public:
  PgrPgenPortDownEventMask(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_pgr_pgen_port_down_event_mask), 12, false, write_callback, read_callback, std::string("PgrPgenPortDownEventMask")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_pgr_pgen_port_down_event_mask))
    {
    }
  PgrPgenPortDownEventMask(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "PgrPgenPortDownEventMask")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PgrPgenPortDownEventMask") + ":\n";
...
#endif // __REGISTER_INCLUDES_PGR_PGEN_PORT_DOWN_EVENT_MASK_H__
