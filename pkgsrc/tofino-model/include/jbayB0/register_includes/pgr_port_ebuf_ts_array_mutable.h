...
#ifndef __REGISTER_INCLUDES_PGR_PORT_EBUF_TS_ARRAY_MUTABLE_H__
#define __REGISTER_INCLUDES_PGR_PORT_EBUF_TS_ARRAY_MUTABLE_H__
...
class PgrPortEbufTsArrayMutable : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  PgrPortEbufTsArrayMutable(
      int chipNumber, int index_pipe_addrmap, RegisterArrayCallback& write_callback = 0, RegisterArrayCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 4 * ArraySize(index_pipe_addrmap, -1), true, write_callback, read_callback, std::string("PgrPortEbufTsArrayMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap)),
...
public:
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("PgrPortEbufTsArrayMutable") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
private:
  std::vector<PgrPortEbufTsMutable> array;
  uint32_t size0_;
...
#endif // __REGISTER_INCLUDES_PGR_PORT_EBUF_TS_ARRAY_MUTABLE_H__
