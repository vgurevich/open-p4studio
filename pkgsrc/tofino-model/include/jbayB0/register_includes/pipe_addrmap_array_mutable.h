...
public:
  PipeAddrmapArrayMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(), 16777216 * ArraySize(-1), true, write_callback, read_callback, std::string("PipeAddrmapArrayMutable")),
...
public:
  ...
  PardeRegMutable &pardereg(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    return array[a0].pardereg();
  }
  bool calculate_index(
      uint32_t* offset, uint32_t* a0
      ) const {
    int i = (*offset)/16777216;
    (*offset) -= (i*16777216);
    uint32_t t = i;
    *a0 = t;
    bool in_bounds = true;
