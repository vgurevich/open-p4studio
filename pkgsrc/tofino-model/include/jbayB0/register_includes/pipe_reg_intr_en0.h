...
#ifndef __REGISTER_INCLUDES_PIPE_REG_INTR_EN0_H__
#define __REGISTER_INCLUDES_PIPE_REG_INTR_EN0_H__
...
class PipeRegIntrEn0 : public model_core::RegisterBlock<RegisterCallback> {
public:
  PipeRegIntrEn0(
      int chipNumber, int index_tm_wac_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_wac_pipe_rspec), 4, false, write_callback, read_callback, std::string("PipeRegIntrEn0")+":"+boost::lexical_cast<std::string>(index_tm_wac_pipe_rspec))
    {
    }
  PipeRegIntrEn0(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "PipeRegIntrEn0")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PipeRegIntrEn0") + ":\n";
...
#endif // __REGISTER_INCLUDES_PIPE_REG_INTR_EN0_H__
