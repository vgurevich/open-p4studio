...
#ifndef __REGISTER_INCLUDES_PIPE_REG_INTR_EN0_MUTABLE_H__
#define __REGISTER_INCLUDES_PIPE_REG_INTR_EN0_MUTABLE_H__
...
class PipeRegIntrEn0Mutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  PipeRegIntrEn0Mutable(
      int chipNumber, int index_tm_wac_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_wac_pipe_rspec), 4, true, write_callback, read_callback, std::string("PipeRegIntrEn0Mutable")+":"+boost::lexical_cast<std::string>(index_tm_wac_pipe_rspec))
    {
    }
  PipeRegIntrEn0Mutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "PipeRegIntrEn0Mutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PipeRegIntrEn0Mutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x744; // to get to wac_reg_intr_en0
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_PIPE_REG_INTR_EN0_MUTABLE_H__
