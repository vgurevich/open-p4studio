...
#ifndef __REGISTER_INCLUDES_PIPE_REG_INTR_STAT_MUTABLE_H__
#define __REGISTER_INCLUDES_PIPE_REG_INTR_STAT_MUTABLE_H__
...
class PipeRegIntrStatMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  PipeRegIntrStatMutable(
      int chipNumber, int index_tm_wac_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_wac_pipe_rspec), 4, true, write_callback, read_callback, std::string("PipeRegIntrStatMutable")+":"+boost::lexical_cast<std::string>(index_tm_wac_pipe_rspec))
    {
    }
  PipeRegIntrStatMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "PipeRegIntrStatMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PipeRegIntrStatMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_PIPE_REG_INTR_STAT_MUTABLE_H__
