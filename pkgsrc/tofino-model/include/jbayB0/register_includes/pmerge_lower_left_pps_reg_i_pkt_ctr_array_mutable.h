...
#ifndef __REGISTER_INCLUDES_PMERGE_LOWER_LEFT_PPS_REG_I_PKT_CTR_ARRAY_MUTABLE_H__
#define __REGISTER_INCLUDES_PMERGE_LOWER_LEFT_PPS_REG_I_PKT_CTR_ARRAY_MUTABLE_H__
...
class PmergeLowerLeftPpsRegIPktCtrArrayMutable : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  PmergeLowerLeftPpsRegIPktCtrArrayMutable(
      int chipNumber, int index_pipe_addrmap, RegisterArrayCallback& write_callback = 0, RegisterArrayCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 8 * ArraySize(index_pipe_addrmap, -1), true, write_callback, read_callback, std::string("PmergeLowerLeftPpsRegIPktCtrArrayMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap)),
...
public:
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("PmergeLowerLeftPpsRegIPktCtrArrayMutable") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
private:
  std::vector<PmergeLowerLeftPpsRegIPktCtrMutable> array;
  uint32_t size0_;
...
#endif // __REGISTER_INCLUDES_PMERGE_LOWER_LEFT_PPS_REG_I_PKT_CTR_ARRAY_MUTABLE_H__
