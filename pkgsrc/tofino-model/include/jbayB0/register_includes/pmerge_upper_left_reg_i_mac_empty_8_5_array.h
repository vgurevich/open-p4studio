...
#ifndef __REGISTER_INCLUDES_PMERGE_UPPER_LEFT_REG_I_MAC_EMPTY_8_5_ARRAY_H__
#define __REGISTER_INCLUDES_PMERGE_UPPER_LEFT_REG_I_MAC_EMPTY_8_5_ARRAY_H__
...
class PmergeUpperLeftRegIMacEmpty_8_5Array : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  PmergeUpperLeftRegIMacEmpty_8_5Array(
      int chipNumber, int index_pipe_addrmap, RegisterArrayCallback& write_callback = 0, RegisterArrayCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 4 * ArraySize(index_pipe_addrmap, -1), false, write_callback, read_callback, std::string("PmergeUpperLeftRegIMacEmpty_8_5Array")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap)),
...
public:
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("PmergeUpperLeftRegIMacEmpty_8_5Array") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
private:
  std::vector<PmergeUpperLeftRegIMacEmpty_8_5> array;
  uint32_t size0_;
...
#endif // __REGISTER_INCLUDES_PMERGE_UPPER_LEFT_REG_I_MAC_EMPTY_8_5_ARRAY_H__
