...
#ifndef __REGISTER_INCLUDES_PP_CTR_CFG48_R_ARRAY_H__
#define __REGISTER_INCLUDES_PP_CTR_CFG48_R_ARRAY_H__
...
class PpCtrCfg48RArray : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  enum DprsrHoEEnum {
    kHer,
    kOutEgr
...
public:
  PpCtrCfg48RArray(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 8 * ArraySize(index_pipe_addrmap, -1), false, write_callback, read_callback, std::string("PpCtrCfg48RArray")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap)),
  ...
  PpCtrCfg48RArray(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_dprsr_ho_e, selector_dprsr_ho_e), 8 * ArraySize(index_pipe_addrmap, index_dprsr_ho_e, selector_dprsr_ho_e, -1), false, write_callback, read_callback, std::string("PpCtrCfg48RArray")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_dprsr_ho_e) + "," + boost::lexical_cast<std::string>(selector_dprsr_ho_e)),
  ...
  PpCtrCfg48RArray(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_dprsr_ho_i, selector_dprsr_ho_i), 8 * ArraySize(index_pipe_addrmap, index_dprsr_ho_i, selector_dprsr_ho_i, -1), false, write_callback, read_callback, std::string("PpCtrCfg48RArray")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_dprsr_ho_i) + "," + boost::lexical_cast<std::string>(selector_dprsr_ho_i)),
...
public:
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("PpCtrCfg48RArray") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
#endif // __REGISTER_INCLUDES_PP_CTR_CFG48_R_ARRAY_H__
