...
#ifndef __REGISTER_INCLUDES_PRC_PEX_CNT_MUTABLE_H__
#define __REGISTER_INCLUDES_PRC_PEX_CNT_MUTABLE_H__
...
class PrcPexCntMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  PrcPexCntMutable(
      int chipNumber, int index_tm_prc_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_prc_pipe_rspec), 8, true, write_callback, read_callback, std::string("PrcPexCntMutable")+":"+boost::lexical_cast<std::string>(index_tm_prc_pipe_rspec))
    {
    }
  PrcPexCntMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "PrcPexCntMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PrcPexCntMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_PRC_PEX_CNT_MUTABLE_H__
