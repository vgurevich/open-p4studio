...
#ifndef __REGISTER_INCLUDES_PRC_PEX_ZERO_CNT_MUTABLE_H__
#define __REGISTER_INCLUDES_PRC_PEX_ZERO_CNT_MUTABLE_H__
...
class PrcPexZeroCntMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  PrcPexZeroCntMutable(
      int chipNumber, int index_tm_prc_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_prc_pipe_rspec), 8, true, write_callback, read_callback, std::string("PrcPexZeroCntMutable")+":"+boost::lexical_cast<std::string>(index_tm_prc_pipe_rspec))
    {
    }
  PrcPexZeroCntMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "PrcPexZeroCntMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PrcPexZeroCntMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x60; // to get to pex_zero_cnt
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_PRC_PEX_ZERO_CNT_MUTABLE_H__
