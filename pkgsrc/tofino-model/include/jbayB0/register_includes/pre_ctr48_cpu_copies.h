...
#ifndef __REGISTER_INCLUDES_PRE_CTR48_CPU_COPIES_H__
#define __REGISTER_INCLUDES_PRE_CTR48_CPU_COPIES_H__
...
class PreCtr48CpuCopies : public model_core::RegisterBlock<RegisterCallback> {
public:
  PreCtr48CpuCopies(
      int chipNumber, int index_tm_pre_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_pre_pipe_rspec), 8, false, write_callback, read_callback, std::string("PreCtr48CpuCopies")+":"+boost::lexical_cast<std::string>(index_tm_pre_pipe_rspec))
    {
    }
  PreCtr48CpuCopies(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "PreCtr48CpuCopies")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PreCtr48CpuCopies") + ":\n";
...
#endif // __REGISTER_INCLUDES_PRE_CTR48_CPU_COPIES_H__
