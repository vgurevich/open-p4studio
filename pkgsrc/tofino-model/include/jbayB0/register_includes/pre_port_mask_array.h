...
#ifndef __REGISTER_INCLUDES_PRE_PORT_MASK_ARRAY_H__
#define __REGISTER_INCLUDES_PRE_PORT_MASK_ARRAY_H__
...
class PrePortMaskArray : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  PrePortMaskArray(
      int chipNumber, RegisterArrayCallback& write_callback = 0, RegisterArrayCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 36 * ArraySize(-1), false, write_callback, read_callback, std::string("PrePortMaskArray")),
...
public:
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("PrePortMaskArray") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
#endif // __REGISTER_INCLUDES_PRE_PORT_MASK_ARRAY_H__
