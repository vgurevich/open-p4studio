...
#ifndef __REGISTER_INCLUDES_PRE_RDM_BLK_ID_MUTABLE_H__
#define __REGISTER_INCLUDES_PRE_RDM_BLK_ID_MUTABLE_H__
...
class PreRdmBlkIdMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  PreRdmBlkIdMutable(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 64, true, write_callback, read_callback, std::string("PreRdmBlkIdMutable"))
    {
    }
  PreRdmBlkIdMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "PreRdmBlkIdMutable")
    {
    }
public:
  ...
  void id(int j0,const uint8_t &v) { id_[j0]=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PreRdmBlkIdMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_PRE_RDM_BLK_ID_MUTABLE_H__
