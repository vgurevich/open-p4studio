...
#ifndef __REGISTER_INCLUDES_PRSR_REG_MAIN_RSPEC_H__
#define __REGISTER_INCLUDES_PRSR_REG_MAIN_RSPEC_H__
...
class PrsrRegMainRspec : public model_core::RegisterBlock<RegisterCallback> {
public:
...
public:
  PrsrRegMainRspec(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, selector_parde_glue_stn_reg, index_epb_prsr4_reg, index_prsr_reg_main_rspec), 1024, false, write_callback, read_callback, std::string("PrsrRegMainRspec")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(selector_parde_glue_stn_reg) + "," + boost::lexical_cast<std::string>(index_epb_prsr4_reg) + "," + boost::lexical_cast<std::string>(index_prsr_reg_main_rspec))
    {
    }
  PrsrRegMainRspec(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "PrsrRegMainRspec")
    {
    }
public:
  ...
  PrsrRegMainRspecPortRateCfg &port_rate_cfg() { return port_rate_cfg_; }





  PrsrRegMainRspecPortChnlEn &port_chnl_en() { return port_chnl_en_; }





  PrsrRegMainRspecStartState &start_state() { return start_state_; }
  ...
  PrsrRegMainRspecStartLookupOffsets &start_lookup_offsets(int j0) { return start_lookup_offsets_[j0]; }
  ...
  PrsrRegMainRspecMaxIter &max_iter() { return max_iter_; }
  ...
  PrsrRegMainRspecMaxCycle &max_cycle() { return max_cycle_; }





  PrsrRegMainRspecPriStart &pri_start() { return pri_start_; }
  ...
  PrsrRegMainRspecPriThresh &pri_thresh() { return pri_thresh_; }





  PrsrRegMainRspecHdrLenAdj &hdr_len_adj() { return hdr_len_adj_; }
  ...
  PrsrRegMainRspecPriMap &pri_map(int j0) { return pri_map_[j0]; }





  PrsrRegMainRspecSeqReset &seq_reset() { return seq_reset_; }





  PrsrRegMainRspecOutArbCtrl &out_arb_ctrl() { return out_arb_ctrl_; }





  PrsrRegMainRspecPhvOwner &phv_owner() { return phv_owner_; }
  ...
  PrsrRegMainRspecNoMultiWr &no_multi_wr() { return no_multi_wr_; }
  ...
  PrsrRegMainRspecErrPhvCfg &err_phv_cfg(int j0) { return err_phv_cfg_[j0]; }
  ...
  PrsrRegMainRspecHdrByteCnt &hdr_byte_cnt(int j0) { return hdr_byte_cnt_[j0]; }
  ...
  PrsrRegMainRspecIdleCnt &idle_cnt(int j0) { return idle_cnt_[j0]; }
  ...
  PrsrRegMainRspecPktRxCnt &pkt_rx_cnt(int j0) { return pkt_rx_cnt_[j0]; }
  ...
  PrsrRegMainRspecPktTxCnt &pkt_tx_cnt(int j0) { return pkt_tx_cnt_[j0]; }
  ...
  PrsrRegMainRspecPktDropCnt &pkt_drop_cnt(int j0) { return pkt_drop_cnt_[j0]; }




  PrsrRegMainRspecOpFifoFullCnt &op_fifo_full_cnt() { return op_fifo_full_cnt_; }




  PrsrRegMainRspecOpFifoFullStallCnt &op_fifo_full_stall_cnt() { return op_fifo_full_stall_cnt_; }




  PrsrRegMainRspecNoTcamMatchErrCnt &no_tcam_match_err_cnt() { return no_tcam_match_err_cnt_; }




  PrsrRegMainRspecPartialHdrErrCnt &partial_hdr_err_cnt() { return partial_hdr_err_cnt_; }




  PrsrRegMainRspecCtrRangeErrCnt &ctr_range_err_cnt() { return ctr_range_err_cnt_; }




  PrsrRegMainRspecTimeoutIterErrCnt &timeout_iter_err_cnt() { return timeout_iter_err_cnt_; }




  PrsrRegMainRspecTimeoutCycleErrCnt &timeout_cycle_err_cnt() { return timeout_cycle_err_cnt_; }




  PrsrRegMainRspecSrcExtErrCnt &src_ext_err_cnt() { return src_ext_err_cnt_; }




  PrsrRegMainRspecPhvOwnerErrCnt &phv_owner_err_cnt() { return phv_owner_err_cnt_; }




  PrsrRegMainRspecMultiWrErrCnt &multi_wr_err_cnt() { return multi_wr_err_cnt_; }




  PrsrRegMainRspecAramSbeCnt &aram_sbe_cnt() { return aram_sbe_cnt_; }




  PrsrRegMainRspecAramMbeCnt &aram_mbe_cnt() { return aram_mbe_cnt_; }




  PrsrRegMainRspecFcsErrCnt &fcs_err_cnt() { return fcs_err_cnt_; }




  PrsrRegMainRspecCsumErrCnt &csum_err_cnt() { return csum_err_cnt_; }




  PrsrRegMainRspecTcamParErrCnt &tcam_par_err_cnt() { return tcam_par_err_cnt_; }




  PrsrRegMainRspecCsumSbeCnt &csum_sbe_cnt() { return csum_sbe_cnt_; }




  PrsrRegMainRspecCsumMbeCnt &csum_mbe_cnt() { return csum_mbe_cnt_; }





  PrsrRegMainRspecNoTcamMatchErrLog &no_tcam_match_err_log() { return no_tcam_match_err_log_; }





  PrsrRegMainRspecTimeoutIterErrLog &timeout_iter_err_log() { return timeout_iter_err_log_; }





  PrsrRegMainRspecTimeoutCycleErrLog &timeout_cycle_err_log() { return timeout_cycle_err_log_; }





  PrsrRegMainRspecPartialHdrErrLog &partial_hdr_err_log() { return partial_hdr_err_log_; }





  PrsrRegMainRspecCtrRangeErrLog &ctr_range_err_log() { return ctr_range_err_log_; }





  PrsrRegMainRspecMultiWrErrLog &multi_wr_err_log() { return multi_wr_err_log_; }





  PrsrRegMainRspecPhvOwnerErrLog &phv_owner_err_log() { return phv_owner_err_log_; }





  PrsrRegMainRspecSrcExtErrLog &src_ext_err_log() { return src_ext_err_log_; }





  PrsrRegMainRspecAramSbeErrLog &aram_sbe_err_log() { return aram_sbe_err_log_; }





  PrsrRegMainRspecAramMbeErrLog &aram_mbe_err_log() { return aram_mbe_err_log_; }





  PrsrRegMainRspecTcamParErrLog &tcam_par_err_log() { return tcam_par_err_log_; }





  PrsrRegMainRspecIbufOflowErrLog &ibuf_oflow_err_log() { return ibuf_oflow_err_log_; }





  PrsrRegMainRspecIbufUflowErrLog &ibuf_uflow_err_log() { return ibuf_uflow_err_log_; }





  PrsrRegMainRspecOpFifoOflowErrLog &op_fifo_oflow_err_log() { return op_fifo_oflow_err_log_; }





  PrsrRegMainRspecOpFifoUflowErrLog &op_fifo_uflow_err_log() { return op_fifo_uflow_err_log_; }





  PrsrRegMainRspecCsumSbeErrLog &csum_sbe_err_log() { return csum_sbe_err_log_; }





  PrsrRegMainRspecCsumMbeErrLog &csum_mbe_err_log() { return csum_mbe_err_log_; }
  ...
  PrsrRegMainRspecEcc &ecc() { return ecc_; }





  ParityControlR &parity() { return parity_; }





  PrsrRegMainRspecDebugCtrl &debug_ctrl() { return debug_ctrl_; }





  PrsrRegMainRspecMemCtrl &mem_ctrl() { return mem_ctrl_; }





  PrsrRegMainRspecOpFifoState &op_fifo_state() { return op_fifo_state_; }





  PrsrRegMainRspecVerUpd &ver_upd() { return ver_upd_; }





  PrsrRegMainRspecIqState &iq_state() { return iq_state_; }
  ...
  PrsrRegMainRspecPhvClrOnWr &phv_clr_on_wr() { return phv_clr_on_wr_; }
  PrsrRegMainRspecIntr &intr() { return intr_; }
...
private:
  PrsrRegMainRspecPortRateCfg port_rate_cfg_;
  PrsrRegMainRspecPortChnlEn port_chnl_en_;
  PrsrRegMainRspecStartState start_state_;
  std::array< PrsrRegMainRspecStartLookupOffsets, 2 > start_lookup_offsets_;
  PrsrRegMainRspecMaxIter max_iter_;
  PrsrRegMainRspecMaxCycle max_cycle_;
  PrsrRegMainRspecPriStart pri_start_;
  PrsrRegMainRspecPriThresh pri_thresh_;
  PrsrRegMainRspecHdrLenAdj hdr_len_adj_;
  std::array< PrsrRegMainRspecPriMap, 2 > pri_map_;
  PrsrRegMainRspecSeqReset seq_reset_;
  PrsrRegMainRspecOutArbCtrl out_arb_ctrl_;
  PrsrRegMainRspecPhvOwner phv_owner_;
  PrsrRegMainRspecNoMultiWr no_multi_wr_;
  std::array< PrsrRegMainRspecErrPhvCfg, 2 > err_phv_cfg_;
  std::array< PrsrRegMainRspecHdrByteCnt, 2 > hdr_byte_cnt_;
  std::array< PrsrRegMainRspecIdleCnt, 2 > idle_cnt_;
  std::array< PrsrRegMainRspecPktRxCnt, 2 > pkt_rx_cnt_;
  std::array< PrsrRegMainRspecPktTxCnt, 2 > pkt_tx_cnt_;
  std::array< PrsrRegMainRspecPktDropCnt, 2 > pkt_drop_cnt_;
  PrsrRegMainRspecOpFifoFullCnt op_fifo_full_cnt_;
  PrsrRegMainRspecOpFifoFullStallCnt op_fifo_full_stall_cnt_;
  PrsrRegMainRspecNoTcamMatchErrCnt no_tcam_match_err_cnt_;
  PrsrRegMainRspecPartialHdrErrCnt partial_hdr_err_cnt_;
  PrsrRegMainRspecCtrRangeErrCnt ctr_range_err_cnt_;
  PrsrRegMainRspecTimeoutIterErrCnt timeout_iter_err_cnt_;
  PrsrRegMainRspecTimeoutCycleErrCnt timeout_cycle_err_cnt_;
  PrsrRegMainRspecSrcExtErrCnt src_ext_err_cnt_;
  PrsrRegMainRspecPhvOwnerErrCnt phv_owner_err_cnt_;
  PrsrRegMainRspecMultiWrErrCnt multi_wr_err_cnt_;
  PrsrRegMainRspecAramSbeCnt aram_sbe_cnt_;
  PrsrRegMainRspecAramMbeCnt aram_mbe_cnt_;
  PrsrRegMainRspecFcsErrCnt fcs_err_cnt_;
  PrsrRegMainRspecCsumErrCnt csum_err_cnt_;
  PrsrRegMainRspecTcamParErrCnt tcam_par_err_cnt_;
  PrsrRegMainRspecCsumSbeCnt csum_sbe_cnt_;
  PrsrRegMainRspecCsumMbeCnt csum_mbe_cnt_;
  PrsrRegMainRspecNoTcamMatchErrLog no_tcam_match_err_log_;
  PrsrRegMainRspecTimeoutIterErrLog timeout_iter_err_log_;
  PrsrRegMainRspecTimeoutCycleErrLog timeout_cycle_err_log_;
  PrsrRegMainRspecPartialHdrErrLog partial_hdr_err_log_;
  PrsrRegMainRspecCtrRangeErrLog ctr_range_err_log_;
  PrsrRegMainRspecMultiWrErrLog multi_wr_err_log_;
  PrsrRegMainRspecPhvOwnerErrLog phv_owner_err_log_;
  PrsrRegMainRspecSrcExtErrLog src_ext_err_log_;
  PrsrRegMainRspecAramSbeErrLog aram_sbe_err_log_;
  PrsrRegMainRspecAramMbeErrLog aram_mbe_err_log_;
  PrsrRegMainRspecTcamParErrLog tcam_par_err_log_;
  PrsrRegMainRspecIbufOflowErrLog ibuf_oflow_err_log_;
  PrsrRegMainRspecIbufUflowErrLog ibuf_uflow_err_log_;
  PrsrRegMainRspecOpFifoOflowErrLog op_fifo_oflow_err_log_;
  PrsrRegMainRspecOpFifoUflowErrLog op_fifo_uflow_err_log_;
  PrsrRegMainRspecCsumSbeErrLog csum_sbe_err_log_;
  PrsrRegMainRspecCsumMbeErrLog csum_mbe_err_log_;
  PrsrRegMainRspecEcc ecc_;
  ParityControlR parity_;
  PrsrRegMainRspecDebugCtrl debug_ctrl_;
  PrsrRegMainRspecMemCtrl mem_ctrl_;
  PrsrRegMainRspecOpFifoState op_fifo_state_;
  PrsrRegMainRspecVerUpd ver_upd_;
  PrsrRegMainRspecIqState iq_state_;
  PrsrRegMainRspecPhvClrOnWr phv_clr_on_wr_;
  PrsrRegMainRspecIntr intr_;
private:
...
#endif // __REGISTER_INCLUDES_PRSR_REG_MAIN_RSPEC_H__
