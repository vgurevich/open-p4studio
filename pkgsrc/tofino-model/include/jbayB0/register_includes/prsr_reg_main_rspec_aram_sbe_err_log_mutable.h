...
#ifndef __REGISTER_INCLUDES_PRSR_REG_MAIN_RSPEC_ARAM_SBE_ERR_LOG_MUTABLE_H__
#define __REGISTER_INCLUDES_PRSR_REG_MAIN_RSPEC_ARAM_SBE_ERR_LOG_MUTABLE_H__
  ...
  static int StartOffset(
    ...
    switch (selector_parde_glue_stn_reg) {
      case kEpbprsr4reg:
        ...
        offset += 0x1b4; // to get to aram_sbe_err_log
        break;
      case kIpbprsr4reg:
        assert(index_epb_prsr4_reg < 9);
...
#endif // __REGISTER_INCLUDES_PRSR_REG_MAIN_RSPEC_ARAM_SBE_ERR_LOG_MUTABLE_H__
