...
#ifndef __REGISTER_INCLUDES_PRSR_REG_MAIN_RSPEC_CSUM_MBE_ERR_LOG_MUTABLE_H__
#define __REGISTER_INCLUDES_PRSR_REG_MAIN_RSPEC_CSUM_MBE_ERR_LOG_MUTABLE_H__
...
class PrsrRegMainRspecCsumMbeErrLogMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
...
public:
  PrsrRegMainRspecCsumMbeErrLogMutable(
...
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PrsrRegMainRspecCsumMbeErrLogMutable") + ":\n";
  ...
  static int StartOffset(
    ...
    switch (selector_parde_glue_stn_reg) {
      case kEpbprsr4reg:
        ...
        offset += 0x1d4; // to get to csum_mbe_err_log
        break;
      case kIpbprsr4reg:
        assert(index_epb_prsr4_reg < 9);
...
#endif // __REGISTER_INCLUDES_PRSR_REG_MAIN_RSPEC_CSUM_MBE_ERR_LOG_MUTABLE_H__
