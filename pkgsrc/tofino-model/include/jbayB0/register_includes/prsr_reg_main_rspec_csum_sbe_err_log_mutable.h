...
#ifndef __REGISTER_INCLUDES_PRSR_REG_MAIN_RSPEC_CSUM_SBE_ERR_LOG_MUTABLE_H__
#define __REGISTER_INCLUDES_PRSR_REG_MAIN_RSPEC_CSUM_SBE_ERR_LOG_MUTABLE_H__
...
class PrsrRegMainRspecCsumSbeErrLogMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
...
public:
  PrsrRegMainRspecCsumSbeErrLogMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, selector_parde_glue_stn_reg, index_epb_prsr4_reg, index_prsr_reg_main_rspec), 4, true, write_callback, read_callback, std::string("PrsrRegMainRspecCsumSbeErrLogMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(selector_parde_glue_stn_reg) + "," + boost::lexical_cast<std::string>(index_epb_prsr4_reg) + "," + boost::lexical_cast<std::string>(index_prsr_reg_main_rspec))
    {
    }
  PrsrRegMainRspecCsumSbeErrLogMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "PrsrRegMainRspecCsumSbeErrLogMutable")
    {
    }
public:
  ...
  void unit(const uint8_t &v) { unit_=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PrsrRegMainRspecCsumSbeErrLogMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_PRSR_REG_MAIN_RSPEC_CSUM_SBE_ERR_LOG_MUTABLE_H__
