...
#ifndef __REGISTER_INCLUDES_PRSR_REG_MAIN_RSPEC_CTR_RANGE_ERR_LOG_MUTABLE_H__
#define __REGISTER_INCLUDES_PRSR_REG_MAIN_RSPEC_CTR_RANGE_ERR_LOG_MUTABLE_H__
...
public:
  PrsrRegMainRspecCtrRangeErrLogMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, selector_parde_glue_stn_reg, index_epb_prsr4_reg, index_prsr_reg_main_rspec), 4, true, write_callback, read_callback, std::string("PrsrRegMainRspecCtrRangeErrLogMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(selector_parde_glue_stn_reg) + "," + boost::lexical_cast<std::string>(index_epb_prsr4_reg) + "," + boost::lexical_cast<std::string>(index_prsr_reg_main_rspec))
    {
    }
  PrsrRegMainRspecCtrRangeErrLogMutable(
  ...
  static int StartOffset(
    ...
    switch (selector_parde_glue_stn_reg) {
      case kEpbprsr4reg:
        ...
        offset += 0x1a4; // to get to ctr_range_err_log
        break;
      case kIpbprsr4reg:
        assert(index_epb_prsr4_reg < 9);
...
#endif // __REGISTER_INCLUDES_PRSR_REG_MAIN_RSPEC_CTR_RANGE_ERR_LOG_MUTABLE_H__
