...
#ifndef __REGISTER_INCLUDES_PRSR_REG_MAIN_RSPEC_PORT_CHNL_EN_H__
#define __REGISTER_INCLUDES_PRSR_REG_MAIN_RSPEC_PORT_CHNL_EN_H__
...
class PrsrRegMainRspecPortChnlEn : public model_core::RegisterBlock<RegisterCallback> {
public:
...
public:
  PrsrRegMainRspecPortChnlEn(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, selector_parde_glue_stn_reg, index_epb_prsr4_reg, index_prsr_reg_main_rspec), 4, false, write_callback, read_callback, std::string("PrsrRegMainRspecPortChnlEn")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(selector_parde_glue_stn_reg) + "," + boost::lexical_cast<std::string>(index_epb_prsr4_reg) + "," + boost::lexical_cast<std::string>(index_prsr_reg_main_rspec))
    {
    }
  PrsrRegMainRspecPortChnlEn(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "PrsrRegMainRspecPortChnlEn")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PrsrRegMainRspecPortChnlEn") + ":\n";
...
#endif // __REGISTER_INCLUDES_PRSR_REG_MAIN_RSPEC_PORT_CHNL_EN_H__
