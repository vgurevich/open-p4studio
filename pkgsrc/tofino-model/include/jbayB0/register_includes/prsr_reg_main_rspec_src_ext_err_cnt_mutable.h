...
public:
  PrsrRegMainRspecSrcExtErrCntMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, selector_parde_glue_stn_reg, index_epb_prsr4_reg, index_prsr_reg_main_rspec), 8, true, write_callback, read_callback, std::string("PrsrRegMainRspecSrcExtErrCntMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(selector_parde_glue_stn_reg) + "," + boost::lexical_cast<std::string>(index_epb_prsr4_reg) + "," + boost::lexical_cast<std::string>(index_prsr_reg_main_rspec))
    {
    }
  PrsrRegMainRspecSrcExtErrCntMutable(
  ...
  static int StartOffset(
    ...
    switch (selector_parde_glue_stn_reg) {
      case kEpbprsr4reg:
        ...
        offset += 0x118; // to get to src_ext_err_cnt
        break;
      case kIpbprsr4reg:
        assert(index_epb_prsr4_reg < 9);
