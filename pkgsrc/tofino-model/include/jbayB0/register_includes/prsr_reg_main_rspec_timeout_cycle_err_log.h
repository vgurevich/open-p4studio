...
#ifndef __REGISTER_INCLUDES_PRSR_REG_MAIN_RSPEC_TIMEOUT_CYCLE_ERR_LOG_H__
#define __REGISTER_INCLUDES_PRSR_REG_MAIN_RSPEC_TIMEOUT_CYCLE_ERR_LOG_H__
...
class PrsrRegMainRspecTimeoutCycleErrLog : public model_core::RegisterBlock<RegisterCallback> {
public:
...
public:
  PrsrRegMainRspecTimeoutCycleErrLog(
...
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PrsrRegMainRspecTimeoutCycleErrLog") + ":\n";
...
#endif // __REGISTER_INCLUDES_PRSR_REG_MAIN_RSPEC_TIMEOUT_CYCLE_ERR_LOG_H__
