...
#ifndef __REGISTER_INCLUDES_PSC_EPIPE_G_H__
#define __REGISTER_INCLUDES_PSC_EPIPE_G_H__
...
#include "psc_epipe_blocks_max_usecnt_r.h"
#include "psc_epipe_blocks_usecnt_r.h"
#include "psc_epipe_enable_r.h"
#include "psc_epipe_pkt_dropcnt_r.h"

namespace jbayB0 {
  namespace register_classes {

class PscEpipeG : public model_core::RegisterBlock<RegisterCallback> {
public:
  PscEpipeG(
      int chipNumber, int index_psc_epipe_g, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_psc_epipe_g), 24, false, write_callback, read_callback, std::string("PscEpipeG")+":"+boost::lexical_cast<std::string>(index_psc_epipe_g))
    {
    }
  PscEpipeG(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "PscEpipeG")
    {
    }
public:
  ...
  PscEpipeEnableR &epipe_enable() { return epipe_enable_; }
  ...
  PscEpipeBlocksUsecntR &epipe_blks_usecnt() { return epipe_blks_usecnt_; }





  PscEpipeBlocksMaxUsecntR &epipe_blks_max_usecnt() { return epipe_blks_max_usecnt_; }





  PscEpipePktDropcntR &epipe_pkt_dropcnt() { return epipe_pkt_dropcnt_; }

  bool read(
      uint32_t offset, uint32_t* data
      ) const {
    if (offset >= 0x800 && offset < 0x804) {
      offset -= 0x800;
      if (read_callback_) read_callback_();
      epipe_enable_.read( offset, data );
    }
    else if (offset >= 0x804 && offset < 0x808) {
      offset -= 0x804;
      if (read_callback_) read_callback_();
      epipe_blks_usecnt_.read( offset, data );
    }
    else if (offset >= 0x808 && offset < 0x80c) {
      offset -= 0x808;
      if (read_callback_) read_callback_();
      epipe_blks_max_usecnt_.read( offset, data );
    }
    else if (offset >= 0x810 && offset < 0x818) {
      offset -= 0x810;
      if (read_callback_) read_callback_();
...
private:
  PscEpipeEnableR epipe_enable_;
  PscEpipeBlocksUsecntR epipe_blks_usecnt_;
  PscEpipeBlocksMaxUsecntR epipe_blks_max_usecnt_;
  PscEpipePktDropcntR epipe_pkt_dropcnt_;
private:
...
#endif // __REGISTER_INCLUDES_PSC_EPIPE_G_H__
