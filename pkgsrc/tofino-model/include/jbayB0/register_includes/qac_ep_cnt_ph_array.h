...
#ifndef __REGISTER_INCLUDES_QAC_EP_CNT_PH_ARRAY_H__
#define __REGISTER_INCLUDES_QAC_EP_CNT_PH_ARRAY_H__
...
class QacEpCntPhArray : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  QacEpCntPhArray(
      int chipNumber, RegisterArrayCallback& write_callback = 0, RegisterArrayCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 4 * ArraySize(-1), false, write_callback, read_callback, std::string("QacEpCntPhArray")),
...
public:
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("QacEpCntPhArray") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
#endif // __REGISTER_INCLUDES_QAC_EP_CNT_PH_ARRAY_H__
