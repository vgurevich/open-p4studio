...
#ifndef __REGISTER_INCLUDES_QAC_GLB_AP_CNT_CELL_ARRAY_H__
#define __REGISTER_INCLUDES_QAC_GLB_AP_CNT_CELL_ARRAY_H__
...
class QacGlbApCntCellArray : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  QacGlbApCntCellArray(
      int chipNumber, RegisterArrayCallback& write_callback = 0, RegisterArrayCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 4 * ArraySize(-1), false, write_callback, read_callback, std::string("QacGlbApCntCellArray")),
...
public:
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("QacGlbApCntCellArray") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
private:
  std::vector<QacGlbApCntCell> array;
  uint32_t size0_;
...
#endif // __REGISTER_INCLUDES_QAC_GLB_AP_CNT_CELL_ARRAY_H__
