...
#ifndef __REGISTER_INCLUDES_QAC_PORT_RX_DISABLE_H__
#define __REGISTER_INCLUDES_QAC_PORT_RX_DISABLE_H__
...
class QacPortRxDisable : public model_core::RegisterBlock<RegisterCallback> {
public:
  QacPortRxDisable(
      int chipNumber, int index_tm_qac_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_qac_pipe_rspec), 12, false, write_callback, read_callback, std::string("QacPortRxDisable")+":"+boost::lexical_cast<std::string>(index_tm_qac_pipe_rspec))
    {
    }
  QacPortRxDisable(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "QacPortRxDisable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("QacPortRxDisable") + ":\n";
...
#endif // __REGISTER_INCLUDES_QAC_PORT_RX_DISABLE_H__
