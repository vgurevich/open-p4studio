...
public:
  QclcPtCtCntMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_tm_clc_common_rspec, index_qclc_pt_ct_cnt), 4, true, write_callback, read_callback, std::string("QclcPtCtCntMutable")+":"+boost::lexical_cast<std::string>(selector_tm_clc_common_rspec) + "," + boost::lexical_cast<std::string>(index_qclc_pt_ct_cnt))
    {
    }
  QclcPtCtCntMutable(
