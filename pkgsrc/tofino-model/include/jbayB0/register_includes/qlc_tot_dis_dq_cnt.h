...
#ifndef __REGISTER_INCLUDES_QLC_TOT_DIS_DQ_CNT_H__
#define __REGISTER_INCLUDES_QLC_TOT_DIS_DQ_CNT_H__
...
class QlcTotDisDqCnt : public model_core::RegisterBlock<RegisterCallback> {
public:
  QlcTotDisDqCnt(
      int chipNumber, int index_tm_qlc_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_qlc_pipe_rspec), 8, false, write_callback, read_callback, std::string("QlcTotDisDqCnt")+":"+boost::lexical_cast<std::string>(index_tm_qlc_pipe_rspec))
    {
    }
  QlcTotDisDqCnt(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "QlcTotDisDqCnt")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("QlcTotDisDqCnt") + ":\n";
...
#endif // __REGISTER_INCLUDES_QLC_TOT_DIS_DQ_CNT_H__
