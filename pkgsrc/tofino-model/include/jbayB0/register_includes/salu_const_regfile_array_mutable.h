...
#ifndef __REGISTER_INCLUDES_SALU_CONST_REGFILE_ARRAY_MUTABLE_H__
#define __REGISTER_INCLUDES_SALU_CONST_REGFILE_ARRAY_MUTABLE_H__
...
class SaluConstRegfileArrayMutable : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  SaluConstRegfileArrayMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap, index_mau_meter_alu_group_addrmap), 4 * ArraySize(index_pipe_addrmap, index_mau_addrmap, index_mau_meter_alu_group_addrmap, -1), true, write_callback, read_callback, std::string("SaluConstRegfileArrayMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_meter_alu_group_addrmap)),
...
public:
  ...
  void salu_const_regfile(uint32_t a0,const uint32_t &v) 
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    array[a0].salu_const_regfile(v);
  }
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("SaluConstRegfileArrayMutable") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
private:
  std::vector<SaluConstRegfileMutable> array;
  uint32_t size0_;
...
#endif // __REGISTER_INCLUDES_SALU_CONST_REGFILE_ARRAY_MUTABLE_H__
