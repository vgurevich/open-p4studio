...
#ifndef __REGISTER_INCLUDES_SALU_CONST_REGFILE_MSBS_ARRAY_H__
#define __REGISTER_INCLUDES_SALU_CONST_REGFILE_MSBS_ARRAY_H__
...
class SaluConstRegfileMsbsArray : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  SaluConstRegfileMsbsArray(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap, index_mau_meter_alu_group_addrmap), 4 * ArraySize(index_pipe_addrmap, index_mau_addrmap, index_mau_meter_alu_group_addrmap, -1), false, write_callback, read_callback, std::string("SaluConstRegfileMsbsArray")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_meter_alu_group_addrmap)),
...
public:
  uint8_t &salu_const_regfile_msbs(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    return array[a0].salu_const_regfile_msbs();
  }
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("SaluConstRegfileMsbsArray") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
private:
  std::vector<SaluConstRegfileMsbs> array;
  uint32_t size0_;
...
#endif // __REGISTER_INCLUDES_SALU_CONST_REGFILE_MSBS_ARRAY_H__
