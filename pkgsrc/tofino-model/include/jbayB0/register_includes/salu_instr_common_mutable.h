...
public:
  ...
  void salu_lmatch_sbus_listen(const uint8_t &v) { salu_lmatch_sbus_listen_=v; }


  uint8_t salu_match_sbus_listen() { return salu_match_sbus_listen_; }
  void salu_match_sbus_listen(const uint8_t &v) { salu_match_sbus_listen_=v; }



  uint8_t salu_minmax_mask_ctl() { return salu_minmax_mask_ctl_; }
  void salu_minmax_mask_ctl(const uint8_t &v) { salu_minmax_mask_ctl_=v; }
  ...
  void salu_minmax_ctl(const uint8_t &v) { salu_minmax_ctl_=v; }


  uint8_t salu_minmax_enable() { return salu_minmax_enable_; }
  void salu_minmax_enable(const uint8_t &v) { salu_minmax_enable_=v; }


  uint8_t salu_minmax_postinc_enable() { return salu_minmax_postinc_enable_; }
  void salu_minmax_postinc_enable(const uint8_t &v) { salu_minmax_postinc_enable_=v; }


  uint8_t salu_minmax_postdec_enable() { return salu_minmax_postdec_enable_; }
  void salu_minmax_postdec_enable(const uint8_t &v) { salu_minmax_postdec_enable_=v; }




  uint8_t salu_minmax_postmod_value_ctl() { return salu_minmax_postmod_value_ctl_; }
  void salu_minmax_postmod_value_ctl(const uint8_t &v) { salu_minmax_postmod_value_ctl_=v; }




  uint8_t salu_minmax_src_sel() { return salu_minmax_src_sel_; }
  void salu_minmax_src_sel(const uint8_t &v) { salu_minmax_src_sel_=v; }


  uint8_t salu_divide_enable() { return salu_divide_enable_; }
  void salu_divide_enable(const uint8_t &v) { salu_divide_enable_=v; }
  ...
  void salu_sbus_learn_comb(const uint8_t &v) { salu_sbus_learn_comb_=v; }
  ...
  void salu_sbus_match_comb(const uint8_t &v) { salu_sbus_match_comb_=v; }




  uint8_t salu_sbus_in_comb() { return salu_sbus_in_comb_; }
  void salu_sbus_in_comb(const uint8_t &v) { salu_sbus_in_comb_=v; }
