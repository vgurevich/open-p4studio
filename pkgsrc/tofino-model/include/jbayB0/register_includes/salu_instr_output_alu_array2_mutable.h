...
#ifndef __REGISTER_INCLUDES_SALU_INSTR_OUTPUT_ALU_ARRAY2_MUTABLE_H__
#define __REGISTER_INCLUDES_SALU_INSTR_OUTPUT_ALU_ARRAY2_MUTABLE_H__
...
class SaluInstrOutputAluArray2Mutable : public model_core::RegisterBlock<RegisterArrayCallback2> {
public:
  SaluInstrOutputAluArray2Mutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap, index_mau_meter_alu_group_addrmap), 4 * ArraySize(index_pipe_addrmap, index_mau_addrmap, index_mau_meter_alu_group_addrmap, -1), true, write_callback, read_callback, std::string("SaluInstrOutputAluArray2Mutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_meter_alu_group_addrmap)),
...
public:
  ...
  uint16_t salu_output_cmpfn(uint32_t a1,uint32_t a0)
  {
    CheckArrayBounds(a1,real_size1_,size1_,0,1,false);
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    return array[(a1 * real_size0_) + a0].salu_output_cmpfn();
  }
  void salu_output_cmpfn(uint32_t a1,uint32_t a0,const uint16_t &v) 
  {
    CheckArrayBounds(a1,real_size1_,size1_,0,1,false);
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    array[(a1 * real_size0_) + a0].salu_output_cmpfn(v);
  }
  ...
  uint8_t salu_output_asrc(uint32_t a1,uint32_t a0)
  {
    CheckArrayBounds(a1,real_size1_,size1_,0,1,false);
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    return array[(a1 * real_size0_) + a0].salu_output_asrc();
  }
  void salu_output_asrc(uint32_t a1,uint32_t a0,const uint8_t &v) 
  {
    CheckArrayBounds(a1,real_size1_,size1_,0,1,false);
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    array[(a1 * real_size0_) + a0].salu_output_asrc(v);
  }




  uint8_t salu_lmatch_adr_bit_enable(uint32_t a1,uint32_t a0)
  {
    CheckArrayBounds(a1,real_size1_,size1_,0,1,false);
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    return array[(a1 * real_size0_) + a0].salu_lmatch_adr_bit_enable();
  }
  void salu_lmatch_adr_bit_enable(uint32_t a1,uint32_t a0,const uint8_t &v) 
  {
    CheckArrayBounds(a1,real_size1_,size1_,0,1,false);
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    array[(a1 * real_size0_) + a0].salu_lmatch_adr_bit_enable(v);
  }


  uint8_t salu_pred_disable(uint32_t a1,uint32_t a0)
  {
    CheckArrayBounds(a1,real_size1_,size1_,0,1,false);
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    return array[(a1 * real_size0_) + a0].salu_pred_disable();
  }
  void salu_pred_disable(uint32_t a1,uint32_t a0,const uint8_t &v) 
  {
    CheckArrayBounds(a1,real_size1_,size1_,0,1,false);
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    array[(a1 * real_size0_) + a0].salu_pred_disable(v);
  }
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("SaluInstrOutputAluArray2Mutable") + "["+boost::lexical_cast<std::string>(a1)+"]"+"["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
private:
  std::vector<SaluInstrOutputAluMutable> array;
  uint32_t size0_;
...
#endif // __REGISTER_INCLUDES_SALU_INSTR_OUTPUT_ALU_ARRAY2_MUTABLE_H__
