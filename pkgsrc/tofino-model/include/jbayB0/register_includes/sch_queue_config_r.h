...
#ifndef __REGISTER_INCLUDES_SCH_QUEUE_CONFIG_R_H__
#define __REGISTER_INCLUDES_SCH_QUEUE_CONFIG_R_H__
...
class SchQueueConfigR : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum TmTopRspecEnum {
    kTmSchaTop,
    kTmSchbTop
...
public:
  SchQueueConfigR(
      int chipNumber, TmTopRspecEnum selector_tm_top_rspec, int index_tm_sch_pipe_rspec, int index_sch_queue_config_r, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(selector_tm_top_rspec, index_tm_sch_pipe_rspec, index_sch_queue_config_r), 4, false, write_callback, read_callback, std::string("SchQueueConfigR")+":"+boost::lexical_cast<std::string>(selector_tm_top_rspec) + "," + boost::lexical_cast<std::string>(index_tm_sch_pipe_rspec) + "," + boost::lexical_cast<std::string>(index_sch_queue_config_r))
    {
    }
  SchQueueConfigR(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "SchQueueConfigR")
    {
    }
public:
  ...
  uint8_t &adv_fc_mode() { return adv_fc_mode_; }
  ...
  bool read(
    ...
    *data |= ((l1_id_ & 0x1f) << 4);
    *data |= ((pfc_pri_ & 0x7) << 10);
    *data |= ((min_rate_pri_ & 0x7) << 13);
    *data |= ((max_rate_pri_ & 0x7) << 16);
    *data |= ((adv_fc_mode_ & 0x1) << 19);
    *data |= ((pps_ & 0x1) << 31);
    return true;
  }
  ...
  bool write(
    ...
    l1_id_ = ((data >> 4) & 0x1f);
    pfc_pri_ = ((data >> 10) & 0x7);
    min_rate_pri_ = ((data >> 13) & 0x7);
    max_rate_pri_ = ((data >> 16) & 0x7);
    adv_fc_mode_ = ((data >> 19) & 0x1);
    pps_ = ((data >> 31) & 0x1);
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("SchQueueConfigR") + ":\n";
    ...
    r += indent_string + "  " + std::string("l1_id") +  ": 0x" + boost::str( boost::format("%x") % static_cast<uint>(l1_id_) ) + "\n";
    all_zeros &= (0 == l1_id_);
    ...
    r += indent_string + "  " + std::string("adv_fc_mode") +  ": 0x" + boost::str( boost::format("%x") % static_cast<uint>(adv_fc_mode_) ) + "\n";
    all_zeros &= (0 == adv_fc_mode_);
...
private:
  ...
  uint8_t adv_fc_mode_;
  uint8_t pps_;
private:
  static int StartOffset(
      TmTopRspecEnum selector_tm_top_rspec, int index_tm_sch_pipe_rspec, int index_sch_queue_config_r
      ) {
    int offset=0;
    ...
    switch (selector_tm_top_rspec) {
      case kTmSchaTop:
        ...
        assert(index_sch_queue_config_r < 1152);
...
#endif // __REGISTER_INCLUDES_SCH_QUEUE_CONFIG_R_H__
