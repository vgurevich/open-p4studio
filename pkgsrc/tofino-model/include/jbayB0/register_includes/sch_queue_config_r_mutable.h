...
public:
  SchQueueConfigRMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_tm_top_rspec, index_tm_sch_pipe_rspec, index_sch_queue_config_r), 4, true, write_callback, read_callback, std::string("SchQueueConfigRMutable")+":"+boost::lexical_cast<std::string>(selector_tm_top_rspec) + "," + boost::lexical_cast<std::string>(index_tm_sch_pipe_rspec) + "," + boost::lexical_cast<std::string>(index_sch_queue_config_r))
    {
    }
  SchQueueConfigRMutable(
...
public:
  ...
  void l1_id(const uint8_t &v) { l1_id_=v; }
  ...
  void adv_fc_mode(const uint8_t &v) { adv_fc_mode_=v; }
