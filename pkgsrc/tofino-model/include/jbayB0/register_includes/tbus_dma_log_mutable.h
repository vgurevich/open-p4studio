...
#ifndef __REGISTER_INCLUDES_TBUS_DMA_LOG_MUTABLE_H__
#define __REGISTER_INCLUDES_TBUS_DMA_LOG_MUTABLE_H__
...
class TbusDmaLogMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  TbusDmaLogMutable(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 4, true, write_callback, read_callback, std::string("TbusDmaLogMutable"))
    {
    }
  TbusDmaLogMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "TbusDmaLogMutable")
    {
    }
public:
  ...
  void tx_read_statemachine(const uint8_t &v) { tx_read_statemachine_=v; }
  ...
  void tx_write_statemachine(const uint8_t &v) { tx_write_statemachine_=v; }
  ...
  void tx_data_credit(const uint16_t &v) { tx_data_credit_=v; }
  ...
  void rx_write_statemachine(const uint8_t &v) { rx_write_statemachine_=v; }
  ...
  void rx_write_data_count(const uint8_t &v) { rx_write_data_count_=v; }
  ...
  void rx_req_mem_credit(const uint8_t &v) { rx_req_mem_credit_=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("TbusDmaLogMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_TBUS_DMA_LOG_MUTABLE_H__
