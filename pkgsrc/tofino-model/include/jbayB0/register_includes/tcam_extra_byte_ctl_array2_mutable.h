...
#ifndef __REGISTER_INCLUDES_TCAM_EXTRA_BYTE_CTL_ARRAY2_MUTABLE_H__
#define __REGISTER_INCLUDES_TCAM_EXTRA_BYTE_CTL_ARRAY2_MUTABLE_H__
...
class TcamExtraByteCtlArray2Mutable : public model_core::RegisterBlock<RegisterArrayCallback2> {
public:
  TcamExtraByteCtlArray2Mutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap), 4 * ArraySize(index_pipe_addrmap, index_mau_addrmap, -1), true, write_callback, read_callback, std::string("TcamExtraByteCtlArray2Mutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap)),
...
public:
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("TcamExtraByteCtlArray2Mutable") + "["+boost::lexical_cast<std::string>(a1)+"]"+"["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
private:
  std::vector<TcamExtraByteCtlMutable> array;
  uint32_t size0_;
...
#endif // __REGISTER_INCLUDES_TCAM_EXTRA_BYTE_CTL_ARRAY2_MUTABLE_H__
