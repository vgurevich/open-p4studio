...
#ifndef __REGISTER_INCLUDES_TCAM_LOGICAL_CHANNEL_ERRLOG_LO_MUTABLE_H__
#define __REGISTER_INCLUDES_TCAM_LOGICAL_CHANNEL_ERRLOG_LO_MUTABLE_H__
...
class TcamLogicalChannelErrlogLoMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  TcamLogicalChannelErrlogLoMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap, index_tcam_logical_channel_errlog_lo), 4, true, write_callback, read_callback, std::string("TcamLogicalChannelErrlogLoMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap) + "," + boost::lexical_cast<std::string>(index_tcam_logical_channel_errlog_lo))
    {
    }
  TcamLogicalChannelErrlogLoMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "TcamLogicalChannelErrlogLoMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("TcamLogicalChannelErrlogLoMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_TCAM_LOGICAL_CHANNEL_ERRLOG_LO_MUTABLE_H__
