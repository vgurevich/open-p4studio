...
#ifndef __REGISTER_INCLUDES_TCAM_MATCH_ADR_SHIFT_ARRAY_MUTABLE_H__
#define __REGISTER_INCLUDES_TCAM_MATCH_ADR_SHIFT_ARRAY_MUTABLE_H__
...
class TcamMatchAdrShiftArrayMutable : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  TcamMatchAdrShiftArrayMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap), 4 * ArraySize(index_pipe_addrmap, index_mau_addrmap, -1), true, write_callback, read_callback, std::string("TcamMatchAdrShiftArrayMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap)),
...
public:
  uint8_t tcam_match_adr_shift(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    return array[a0].tcam_match_adr_shift();
  }
  void tcam_match_adr_shift(uint32_t a0,const uint8_t &v) 
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    array[a0].tcam_match_adr_shift(v);
  }
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("TcamMatchAdrShiftArrayMutable") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
private:
  std::vector<TcamMatchAdrShiftMutable> array;
  uint32_t size0_;
...
#endif // __REGISTER_INCLUDES_TCAM_MATCH_ADR_SHIFT_ARRAY_MUTABLE_H__
