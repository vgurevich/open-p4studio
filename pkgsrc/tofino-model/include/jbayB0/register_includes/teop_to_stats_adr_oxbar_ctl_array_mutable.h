...
#ifndef __REGISTER_INCLUDES_TEOP_TO_STATS_ADR_OXBAR_CTL_ARRAY_MUTABLE_H__
#define __REGISTER_INCLUDES_TEOP_TO_STATS_ADR_OXBAR_CTL_ARRAY_MUTABLE_H__
...
class TeopToStatsAdrOxbarCtlArrayMutable : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  TeopToStatsAdrOxbarCtlArrayMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap), 4 * ArraySize(index_pipe_addrmap, index_mau_addrmap, -1), true, write_callback, read_callback, std::string("TeopToStatsAdrOxbarCtlArrayMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap)),
...
public:
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("TeopToStatsAdrOxbarCtlArrayMutable") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
private:
  std::vector<TeopToStatsAdrOxbarCtlMutable> array;
  uint32_t size0_;
...
#endif // __REGISTER_INCLUDES_TEOP_TO_STATS_ADR_OXBAR_CTL_ARRAY_MUTABLE_H__
