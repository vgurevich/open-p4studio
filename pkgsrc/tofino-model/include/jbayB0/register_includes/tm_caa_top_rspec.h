...
#ifndef __REGISTER_INCLUDES_TM_CAA_TOP_RSPEC_H__
#define __REGISTER_INCLUDES_TM_CAA_TOP_RSPEC_H__
...
#include "caa_fa_almost_full_threshold_r.h"
...
#include "tm_caa_top_rspec_debug_bus_ctrl.h"
#include "tm_caa_top_rspec_ecc.h"
#include "tm_caa_top_rspec_intr.h"
#include "tm_caa_top_rspec_linkmem_mbe_err_log.h"
#include "tm_caa_top_rspec_linkmem_sbe_err_log.h"
#include "tm_caa_top_rspec_overflow_err_log.h"
#include "tm_caa_top_rspec_underflow_err_log.h"

namespace jbayB0 {
  namespace register_classes {

class TmCaaTopRspec : public model_core::RegisterBlock<RegisterCallback> {
public:
  TmCaaTopRspec(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 524288, false, write_callback, read_callback, std::string("TmCaaTopRspec"))
    {
    }
  TmCaaTopRspec(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "TmCaaTopRspec")
    {
    }
public:
  ...
  CaaFaAlmostFullThresholdR &almost_full_threshold() { return almost_full_threshold_; }
  ...
  CaaBankCtrlR &caa_bank_ctr(int j0) { return caa_bank_ctr_[j0]; }
  ...
  CaaIndirAccessAddrR &lmem_indir_access_addr() { return lmem_indir_access_addr_; }
  ...
  TmCaaTopRspecEcc &ecc() { return ecc_; }





  TmCaaTopRspecLinkmemSbeErrLog &linkmem_sbe_err_log() { return linkmem_sbe_err_log_; }





  TmCaaTopRspecLinkmemMbeErrLog &linkmem_mbe_err_log() { return linkmem_mbe_err_log_; }





  TmCaaTopRspecOverflowErrLog &overflow_err_log() { return overflow_err_log_; }





  TmCaaTopRspecUnderflowErrLog &underflow_err_log() { return underflow_err_log_; }





  TmCaaTopRspecDebugBusCtrl &debug_bus_ctrl() { return debug_bus_ctrl_; }





  TmCaaCdmRspec &cdm_lo() { return cdm_lo_; }





  TmCaaCdmRspec &cdm_hi() { return cdm_hi_; }
  ...
  TmCaaTopRspecIntr &intr() { return intr_; }
...
private:
  ...
  CaaFaAlmostFullThresholdR almost_full_threshold_;
  ...
  std::array< CaaBankCtrlR, 384 > caa_bank_ctr_;
  CaaIndirAccessAddrR lmem_indir_access_addr_;
  CaaBlockLinkmemR lmem_indir_access_data_;
  TmCaaTopRspecEcc ecc_;
  TmCaaTopRspecLinkmemSbeErrLog linkmem_sbe_err_log_;
  TmCaaTopRspecLinkmemMbeErrLog linkmem_mbe_err_log_;
  TmCaaTopRspecOverflowErrLog overflow_err_log_;
  TmCaaTopRspecUnderflowErrLog underflow_err_log_;
  TmCaaTopRspecDebugBusCtrl debug_bus_ctrl_;
  TmCaaCdmRspec cdm_lo_;
  TmCaaCdmRspec cdm_hi_;
  std::array< CaaEpipeG, 16 > epipe_;
  std::array< CaaBlockG, 192 > block_;
  TmCaaTopRspecIntr intr_;
private:
...
#endif // __REGISTER_INCLUDES_TM_CAA_TOP_RSPEC_H__
