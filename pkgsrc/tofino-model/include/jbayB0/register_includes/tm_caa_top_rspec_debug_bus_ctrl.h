...
#ifndef __REGISTER_INCLUDES_TM_CAA_TOP_RSPEC_DEBUG_BUS_CTRL_H__
#define __REGISTER_INCLUDES_TM_CAA_TOP_RSPEC_DEBUG_BUS_CTRL_H__
...
class TmCaaTopRspecDebugBusCtrl : public model_core::RegisterBlock<RegisterCallback> {
public:
  TmCaaTopRspecDebugBusCtrl(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 4, false, write_callback, read_callback, std::string("TmCaaTopRspecDebugBusCtrl"))
    {
    }
  TmCaaTopRspecDebugBusCtrl(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "TmCaaTopRspecDebugBusCtrl")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("TmCaaTopRspecDebugBusCtrl") + ":\n";
...
#endif // __REGISTER_INCLUDES_TM_CAA_TOP_RSPEC_DEBUG_BUS_CTRL_H__
