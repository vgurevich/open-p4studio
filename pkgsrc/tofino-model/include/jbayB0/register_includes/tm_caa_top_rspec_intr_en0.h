...
#ifndef __REGISTER_INCLUDES_TM_CAA_TOP_RSPEC_INTR_EN0_H__
#define __REGISTER_INCLUDES_TM_CAA_TOP_RSPEC_INTR_EN0_H__
...
class TmCaaTopRspecIntrEn0 : public model_core::RegisterBlock<RegisterCallback> {
public:
  TmCaaTopRspecIntrEn0(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 4, false, write_callback, read_callback, std::string("TmCaaTopRspecIntrEn0"))
    {
    }
  TmCaaTopRspecIntrEn0(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "TmCaaTopRspecIntrEn0")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("TmCaaTopRspecIntrEn0") + ":\n";
...
#endif // __REGISTER_INCLUDES_TM_CAA_TOP_RSPEC_INTR_EN0_H__
