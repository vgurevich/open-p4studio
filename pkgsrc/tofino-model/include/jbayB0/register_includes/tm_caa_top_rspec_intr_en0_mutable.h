...
#ifndef __REGISTER_INCLUDES_TM_CAA_TOP_RSPEC_INTR_EN0_MUTABLE_H__
#define __REGISTER_INCLUDES_TM_CAA_TOP_RSPEC_INTR_EN0_MUTABLE_H__
...
class TmCaaTopRspecIntrEn0Mutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  TmCaaTopRspecIntrEn0Mutable(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 4, true, write_callback, read_callback, std::string("TmCaaTopRspecIntrEn0Mutable"))
    {
    }
  TmCaaTopRspecIntrEn0Mutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "TmCaaTopRspecIntrEn0Mutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("TmCaaTopRspecIntrEn0Mutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x36e4; // to get to intr_en0
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_TM_CAA_TOP_RSPEC_INTR_EN0_MUTABLE_H__
