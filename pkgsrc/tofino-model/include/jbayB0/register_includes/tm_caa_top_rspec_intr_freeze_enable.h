...
#ifndef __REGISTER_INCLUDES_TM_CAA_TOP_RSPEC_INTR_FREEZE_ENABLE_H__
#define __REGISTER_INCLUDES_TM_CAA_TOP_RSPEC_INTR_FREEZE_ENABLE_H__
...
class TmCaaTopRspecIntrFreezeEnable : public model_core::RegisterBlock<RegisterCallback> {
public:
  TmCaaTopRspecIntrFreezeEnable(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 4, false, write_callback, read_callback, std::string("TmCaaTopRspecIntrFreezeEnable"))
    {
    }
  TmCaaTopRspecIntrFreezeEnable(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "TmCaaTopRspecIntrFreezeEnable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("TmCaaTopRspecIntrFreezeEnable") + ":\n";
...
#endif // __REGISTER_INCLUDES_TM_CAA_TOP_RSPEC_INTR_FREEZE_ENABLE_H__
