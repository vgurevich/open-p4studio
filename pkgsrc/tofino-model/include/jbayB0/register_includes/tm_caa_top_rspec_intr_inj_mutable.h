...
#ifndef __REGISTER_INCLUDES_TM_CAA_TOP_RSPEC_INTR_INJ_MUTABLE_H__
#define __REGISTER_INCLUDES_TM_CAA_TOP_RSPEC_INTR_INJ_MUTABLE_H__
...
class TmCaaTopRspecIntrInjMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  TmCaaTopRspecIntrInjMutable(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 4, true, write_callback, read_callback, std::string("TmCaaTopRspecIntrInjMutable"))
    {
    }
  TmCaaTopRspecIntrInjMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "TmCaaTopRspecIntrInjMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("TmCaaTopRspecIntrInjMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x36ec; // to get to intr_inj
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_TM_CAA_TOP_RSPEC_INTR_INJ_MUTABLE_H__
