...
#ifndef __REGISTER_INCLUDES_TM_CAA_TOP_RSPEC_INTR_STAT_H__
#define __REGISTER_INCLUDES_TM_CAA_TOP_RSPEC_INTR_STAT_H__
...
class TmCaaTopRspecIntrStat : public model_core::RegisterBlock<RegisterCallback> {
public:
  TmCaaTopRspecIntrStat(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 4, false, write_callback, read_callback, std::string("TmCaaTopRspecIntrStat"))
    {
    }
  TmCaaTopRspecIntrStat(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "TmCaaTopRspecIntrStat")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("TmCaaTopRspecIntrStat") + ":\n";
...
#endif // __REGISTER_INCLUDES_TM_CAA_TOP_RSPEC_INTR_STAT_H__
