...
public:
  ...
  TmPexPipeRspecEcc &ecc() { return ecc_; }





  TmPexPipeRspecLinkmemMbeErrLog &linkmem_mbe_err_log() { return linkmem_mbe_err_log_; }





  TmPexPipeRspecLinkmemSbeErrLog &linkmem_sbe_err_log() { return linkmem_sbe_err_log_; }





  TmPexPipeRspecDqPhFifoSbeErrLog &dq_ph_fifo_sbe_err_log() { return dq_ph_fifo_sbe_err_log_; }





  TmPexPipeRspecDqPhFifoMbeErrLog &dq_ph_fifo_mbe_err_log() { return dq_ph_fifo_mbe_err_log_; }





  TmPexPipeRspecDqMetaFifoSbeErrLog &dq_meta_fifo_sbe_err_log() { return dq_meta_fifo_sbe_err_log_; }





  TmPexPipeRspecDqMetaFifoMbeErrLog &dq_meta_fifo_mbe_err_log() { return dq_meta_fifo_mbe_err_log_; }





  TmPexPipeRspecPhAfifoSbeErrLog &ph_afifo_sbe_err_log() { return ph_afifo_sbe_err_log_; }





  TmPexPipeRspecPhAfifoMbeErrLog &ph_afifo_mbe_err_log() { return ph_afifo_mbe_err_log_; }





  TmPexPipeRspecDiscardPhFifo0SbeErrLog &discard_ph_fifo0_sbe_err_log() { return discard_ph_fifo0_sbe_err_log_; }





  TmPexPipeRspecDiscardPhFifo0MbeErrLog &discard_ph_fifo0_mbe_err_log() { return discard_ph_fifo0_mbe_err_log_; }





  TmPexPipeRspecDiscardPhFifo1SbeErrLog &discard_ph_fifo1_sbe_err_log() { return discard_ph_fifo1_sbe_err_log_; }





  TmPexPipeRspecDiscardPhFifo1MbeErrLog &discard_ph_fifo1_mbe_err_log() { return discard_ph_fifo1_mbe_err_log_; }
  ...
  QpexPortTdmEnbMap &port_tdm_enb_map() { return port_tdm_enb_map_; }
  ...
  CfgCtTimer &cfg_ct_timer() { return cfg_ct_timer_; }
  ...
  PexPfcMapTable &pex_pfc_map_table(int j0) { return pex_pfc_map_table_[j0]; }
  ...
  PexEportTxCnt &pex_eport_tx_cnt(int j0) { return pex_eport_tx_cnt_[j0]; }





  PexDebugRegister &pex_debug_register() { return pex_debug_register_; }
  ...
  PexTxCntTimer &pex_tx_cnt_timer() { return pex_tx_cnt_timer_; }
  ...
  PexEpbCreditProbe &pex_epb_credit_probe() { return pex_epb_credit_probe_; }





  PexCnt &tot_byte_cnt() { return tot_byte_cnt_; }





  PexCnt &tot_pkt_cnt() { return tot_pkt_cnt_; }





  PexCnt &dis_cell_cnt() { return dis_cell_cnt_; }
...
private:
  ...
  TmPexPipeRspecEcc ecc_;
  TmPexPipeRspecLinkmemMbeErrLog linkmem_mbe_err_log_;
  TmPexPipeRspecLinkmemSbeErrLog linkmem_sbe_err_log_;
  TmPexPipeRspecDqPhFifoSbeErrLog dq_ph_fifo_sbe_err_log_;
  TmPexPipeRspecDqPhFifoMbeErrLog dq_ph_fifo_mbe_err_log_;
  TmPexPipeRspecDqMetaFifoSbeErrLog dq_meta_fifo_sbe_err_log_;
  TmPexPipeRspecDqMetaFifoMbeErrLog dq_meta_fifo_mbe_err_log_;
  TmPexPipeRspecPhAfifoSbeErrLog ph_afifo_sbe_err_log_;
  TmPexPipeRspecPhAfifoMbeErrLog ph_afifo_mbe_err_log_;
  TmPexPipeRspecDiscardPhFifo0SbeErrLog discard_ph_fifo0_sbe_err_log_;
  TmPexPipeRspecDiscardPhFifo0MbeErrLog discard_ph_fifo0_mbe_err_log_;
  TmPexPipeRspecDiscardPhFifo1SbeErrLog discard_ph_fifo1_sbe_err_log_;
  TmPexPipeRspecDiscardPhFifo1MbeErrLog discard_ph_fifo1_mbe_err_log_;
  QpexPortTdmEnbMap port_tdm_enb_map_;
  std::array< QpexPtState, 11 > pt_state_;
  std::array< QpexEpbCredCnt, 9 > pt_epb_cred_;
  std::array< QpexQEmpty, 24 > q_empty_;
  std::array< QpexPtGapWm, 72 > pt_gap_wm_;
  CfgCtTimer cfg_ct_timer_;
  std::array< PexPfcMapTable, 576 > pex_pfc_map_table_;
  std::array< PexEportTxCnt, 72 > pex_eport_tx_cnt_;
  PexDebugRegister pex_debug_register_;
  PexTxCntTimer pex_tx_cnt_timer_;
  PexEpbCreditProbe pex_epb_credit_probe_;
  PexCnt tot_byte_cnt_;
  PexCnt tot_pkt_cnt_;
  PexCnt dis_cell_cnt_;
