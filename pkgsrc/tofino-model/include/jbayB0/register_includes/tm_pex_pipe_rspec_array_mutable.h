...
public:
  ...
  TmPexPipeRspecEccMutable &ecc(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    return array[a0].ecc();
  }
  ...
  TmPexPipeRspecLinkmemMbeErrLogMutable &linkmem_mbe_err_log(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
  ...
  TmPexPipeRspecLinkmemSbeErrLogMutable &linkmem_sbe_err_log(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
  ...
  TmPexPipeRspecDqPhFifoSbeErrLogMutable &dq_ph_fifo_sbe_err_log(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
  ...
  TmPexPipeRspecDqPhFifoMbeErrLogMutable &dq_ph_fifo_mbe_err_log(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
  ...
  TmPexPipeRspecDqMetaFifoSbeErrLogMutable &dq_meta_fifo_sbe_err_log(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
  ...
  TmPexPipeRspecDqMetaFifoMbeErrLogMutable &dq_meta_fifo_mbe_err_log(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
  ...
  TmPexPipeRspecPhAfifoSbeErrLogMutable &ph_afifo_sbe_err_log(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
  ...
  TmPexPipeRspecPhAfifoMbeErrLogMutable &ph_afifo_mbe_err_log(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
  ...
  TmPexPipeRspecDiscardPhFifo0SbeErrLogMutable &discard_ph_fifo0_sbe_err_log(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
  ...
  TmPexPipeRspecDiscardPhFifo0MbeErrLogMutable &discard_ph_fifo0_mbe_err_log(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
  ...
  TmPexPipeRspecDiscardPhFifo1SbeErrLogMutable &discard_ph_fifo1_sbe_err_log(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
  ...
  TmPexPipeRspecDiscardPhFifo1MbeErrLogMutable &discard_ph_fifo1_mbe_err_log(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
  ...
  QpexPortTdmEnbMapMutable &port_tdm_enb_map(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
  ...
  CfgCtTimerMutable &cfg_ct_timer(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
  ...
  PexPfcMapTableMutable &pex_pfc_map_table(uint32_t a0,int j0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
  ...
  PexEportTxCntMutable &pex_eport_tx_cnt(uint32_t a0,int j0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
  ...
  PexDebugRegisterMutable &pex_debug_register(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
  ...
  PexTxCntTimerMutable &pex_tx_cnt_timer(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
  ...
  PexEpbCreditProbeMutable &pex_epb_credit_probe(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
  ...
  PexCntMutable &tot_byte_cnt(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
  ...
  PexCntMutable &tot_pkt_cnt(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
  ...
  PexCntMutable &dis_cell_cnt(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
