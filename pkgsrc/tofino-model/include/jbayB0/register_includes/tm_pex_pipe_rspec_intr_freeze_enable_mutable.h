...
public:
  ...
  void qpex_int_stat_clm_serr(const uint8_t &v) { qpex_int_stat_clm_serr_=v; }
  uint8_t qpex_int_stat_dq_ph_fifo_serr() { return qpex_int_stat_dq_ph_fifo_serr_; }
  void qpex_int_stat_dq_ph_fifo_serr(const uint8_t &v) { qpex_int_stat_dq_ph_fifo_serr_=v; }
  uint8_t qpex_int_stat_dq_ph_fifo_merr() { return qpex_int_stat_dq_ph_fifo_merr_; }
  void qpex_int_stat_dq_ph_fifo_merr(const uint8_t &v) { qpex_int_stat_dq_ph_fifo_merr_=v; }
  uint8_t qpex_int_stat_dq_meta_fifo_serr() { return qpex_int_stat_dq_meta_fifo_serr_; }
  void qpex_int_stat_dq_meta_fifo_serr(const uint8_t &v) { qpex_int_stat_dq_meta_fifo_serr_=v; }
  uint8_t qpex_int_stat_dq_meta_fifo_merr() { return qpex_int_stat_dq_meta_fifo_merr_; }
  void qpex_int_stat_dq_meta_fifo_merr(const uint8_t &v) { qpex_int_stat_dq_meta_fifo_merr_=v; }
  uint8_t qpex_int_stat_ph_afifo_serr() { return qpex_int_stat_ph_afifo_serr_; }
  void qpex_int_stat_ph_afifo_serr(const uint8_t &v) { qpex_int_stat_ph_afifo_serr_=v; }
  uint8_t qpex_int_stat_ph_afifo_merr() { return qpex_int_stat_ph_afifo_merr_; }
  void qpex_int_stat_ph_afifo_merr(const uint8_t &v) { qpex_int_stat_ph_afifo_merr_=v; }
  uint8_t qpex_int_stat_ph_discard_fifo_serr0() { return qpex_int_stat_ph_discard_fifo_serr0_; }
  void qpex_int_stat_ph_discard_fifo_serr0(const uint8_t &v) { qpex_int_stat_ph_discard_fifo_serr0_=v; }
  uint8_t qpex_int_stat_ph_discard_fifo_merr0() { return qpex_int_stat_ph_discard_fifo_merr0_; }
  void qpex_int_stat_ph_discard_fifo_merr0(const uint8_t &v) { qpex_int_stat_ph_discard_fifo_merr0_=v; }
  uint8_t qpex_int_stat_ph_discard_fifo_serr1() { return qpex_int_stat_ph_discard_fifo_serr1_; }
  void qpex_int_stat_ph_discard_fifo_serr1(const uint8_t &v) { qpex_int_stat_ph_discard_fifo_serr1_=v; }
  uint8_t qpex_int_stat_ph_discard_fifo_merr1() { return qpex_int_stat_ph_discard_fifo_merr1_; }
  void qpex_int_stat_ph_discard_fifo_merr1(const uint8_t &v) { qpex_int_stat_ph_discard_fifo_merr1_=v; }
