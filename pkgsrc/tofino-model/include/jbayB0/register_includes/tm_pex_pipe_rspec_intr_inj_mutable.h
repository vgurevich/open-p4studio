...
#ifndef __REGISTER_INCLUDES_TM_PEX_PIPE_RSPEC_INTR_INJ_MUTABLE_H__
#define __REGISTER_INCLUDES_TM_PEX_PIPE_RSPEC_INTR_INJ_MUTABLE_H__
...
class TmPexPipeRspecIntrInjMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  TmPexPipeRspecIntrInjMutable(
      int chipNumber, int index_tm_pex_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_pex_pipe_rspec), 4, true, write_callback, read_callback, std::string("TmPexPipeRspecIntrInjMutable")+":"+boost::lexical_cast<std::string>(index_tm_pex_pipe_rspec))
    {
    }
  TmPexPipeRspecIntrInjMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "TmPexPipeRspecIntrInjMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("TmPexPipeRspecIntrInjMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_TM_PEX_PIPE_RSPEC_INTR_INJ_MUTABLE_H__
