...
public:
  ...
  TmPrePipeRspecEccMutable &ecc(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    return array[a0].ecc();
  }
  ...
  PreCtr48FirstMutable &first_copies(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
  ...
  TmPrePipeRspecPreIfifoCtrl0Mutable &pre_ififo_ctrl0(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
  ...
  TmPrePipeRspecPreIfifoCtrl1Mutable &pre_ififo_ctrl1(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
  ...
  TmPrePipeRspecPreIfifoCtrl2Mutable &pre_ififo_ctrl2(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
  ...
  TmPrePipeRspecPreIfifoCtrl3Mutable &pre_ififo_ctrl3(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
  ...
  PreIfifoStatsRMutable &pre_ififo_stats(uint32_t a0,int j0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
  ...
  PreDebugMutable &debug(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
  ...
  TmPrePipeRspecIntrMutable &intr(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
