...
#ifndef __REGISTER_INCLUDES_TM_PRE_PIPE_RSPEC_ECC_MUTABLE_H__
#define __REGISTER_INCLUDES_TM_PRE_PIPE_RSPEC_ECC_MUTABLE_H__
...
class TmPrePipeRspecEccMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  TmPrePipeRspecEccMutable(
      int chipNumber, int index_tm_pre_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_pre_pipe_rspec), 8, true, write_callback, read_callback, std::string("TmPrePipeRspecEccMutable")+":"+boost::lexical_cast<std::string>(index_tm_pre_pipe_rspec))
    {
    }
  TmPrePipeRspecEccMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "TmPrePipeRspecEccMutable")
    {
    }
public:
  ...
  void fifo_disable_check(const uint8_t &v) { fifo_disable_check_=v; }




  uint8_t fifo_inject_sbe() { return fifo_inject_sbe_; }
  void fifo_inject_sbe(const uint8_t &v) { fifo_inject_sbe_=v; }




  uint8_t fifo_inject_mbe() { return fifo_inject_mbe_; }
  void fifo_inject_mbe(const uint8_t &v) { fifo_inject_mbe_=v; }




  uint8_t mit_disable_check() { return mit_disable_check_; }
  void mit_disable_check(const uint8_t &v) { mit_disable_check_=v; }




  uint8_t mit_inject_sbe() { return mit_inject_sbe_; }
  void mit_inject_sbe(const uint8_t &v) { mit_inject_sbe_=v; }




  uint8_t mit_inject_mbe() { return mit_inject_mbe_; }
  void mit_inject_mbe(const uint8_t &v) { mit_inject_mbe_=v; }




  uint8_t lit0_bm_disable_check() { return lit0_bm_disable_check_; }
  void lit0_bm_disable_check(const uint8_t &v) { lit0_bm_disable_check_=v; }




  uint8_t lit0_bm_inject_sbe() { return lit0_bm_inject_sbe_; }
  void lit0_bm_inject_sbe(const uint8_t &v) { lit0_bm_inject_sbe_=v; }




  uint8_t lit0_bm_inject_mbe() { return lit0_bm_inject_mbe_; }
  void lit0_bm_inject_mbe(const uint8_t &v) { lit0_bm_inject_mbe_=v; }




  uint8_t lit1_bm_disable_check() { return lit1_bm_disable_check_; }
  void lit1_bm_disable_check(const uint8_t &v) { lit1_bm_disable_check_=v; }




  uint8_t lit1_bm_inject_sbe() { return lit1_bm_inject_sbe_; }
  void lit1_bm_inject_sbe(const uint8_t &v) { lit1_bm_inject_sbe_=v; }




  uint8_t lit1_bm_inject_mbe() { return lit1_bm_inject_mbe_; }
  void lit1_bm_inject_mbe(const uint8_t &v) { lit1_bm_inject_mbe_=v; }




  uint8_t lit0_np_disable_check() { return lit0_np_disable_check_; }
  void lit0_np_disable_check(const uint8_t &v) { lit0_np_disable_check_=v; }




  uint8_t lit0_np_inject_sbe() { return lit0_np_inject_sbe_; }
  void lit0_np_inject_sbe(const uint8_t &v) { lit0_np_inject_sbe_=v; }




  uint8_t lit0_np_inject_mbe() { return lit0_np_inject_mbe_; }
  void lit0_np_inject_mbe(const uint8_t &v) { lit0_np_inject_mbe_=v; }




  uint8_t lit1_np_disable_check() { return lit1_np_disable_check_; }
  void lit1_np_disable_check(const uint8_t &v) { lit1_np_disable_check_=v; }




  uint8_t lit1_np_inject_sbe() { return lit1_np_inject_sbe_; }
  void lit1_np_inject_sbe(const uint8_t &v) { lit1_np_inject_sbe_=v; }




  uint8_t lit1_np_inject_mbe() { return lit1_np_inject_mbe_; }
  void lit1_np_inject_mbe(const uint8_t &v) { lit1_np_inject_mbe_=v; }




  uint8_t pmt0_disable_check() { return pmt0_disable_check_; }
  void pmt0_disable_check(const uint8_t &v) { pmt0_disable_check_=v; }




  uint8_t pmt0_inject_sbe() { return pmt0_inject_sbe_; }
  void pmt0_inject_sbe(const uint8_t &v) { pmt0_inject_sbe_=v; }




  uint8_t pmt0_inject_mbe() { return pmt0_inject_mbe_; }
  void pmt0_inject_mbe(const uint8_t &v) { pmt0_inject_mbe_=v; }




  uint8_t pmt1_disable_check() { return pmt1_disable_check_; }
  void pmt1_disable_check(const uint8_t &v) { pmt1_disable_check_=v; }




  uint8_t pmt1_inject_sbe() { return pmt1_inject_sbe_; }
  void pmt1_inject_sbe(const uint8_t &v) { pmt1_inject_sbe_=v; }




  uint8_t pmt1_inject_mbe() { return pmt1_inject_mbe_; }
  void pmt1_inject_mbe(const uint8_t &v) { pmt1_inject_mbe_=v; }




  uint8_t rdm_disable_check() { return rdm_disable_check_; }
  void rdm_disable_check(const uint8_t &v) { rdm_disable_check_=v; }




  uint8_t rdm_inject_sbe() { return rdm_inject_sbe_; }
  void rdm_inject_sbe(const uint8_t &v) { rdm_inject_sbe_=v; }




  uint8_t rdm_inject_mbe() { return rdm_inject_mbe_; }
  void rdm_inject_mbe(const uint8_t &v) { rdm_inject_mbe_=v; }




  uint8_t fifo_mem_bankid_disable_check() { return fifo_mem_bankid_disable_check_; }
  void fifo_mem_bankid_disable_check(const uint8_t &v) { fifo_mem_bankid_disable_check_=v; }




  uint8_t fifo_mem_bankid_inject_sbe() { return fifo_mem_bankid_inject_sbe_; }
  void fifo_mem_bankid_inject_sbe(const uint8_t &v) { fifo_mem_bankid_inject_sbe_=v; }




  uint8_t fifo_mem_bankid_inject_mbe() { return fifo_mem_bankid_inject_mbe_; }
  void fifo_mem_bankid_inject_mbe(const uint8_t &v) { fifo_mem_bankid_inject_mbe_=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("TmPrePipeRspecEccMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_TM_PRE_PIPE_RSPEC_ECC_MUTABLE_H__
