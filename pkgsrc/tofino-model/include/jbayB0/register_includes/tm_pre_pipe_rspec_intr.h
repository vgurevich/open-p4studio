...
#ifndef __REGISTER_INCLUDES_TM_PRE_PIPE_RSPEC_INTR_H__
#define __REGISTER_INCLUDES_TM_PRE_PIPE_RSPEC_INTR_H__
...
#include "tm_pre_pipe_rspec_intr_en0.h"
#include "tm_pre_pipe_rspec_intr_en1.h"
#include "tm_pre_pipe_rspec_intr_freeze_enable.h"
#include "tm_pre_pipe_rspec_intr_inj.h"
#include "tm_pre_pipe_rspec_intr_stat.h"

namespace jbayB0 {
  namespace register_classes {

class TmPrePipeRspecIntr : public model_core::RegisterBlock<RegisterCallback> {
public:
  TmPrePipeRspecIntr(
      int chipNumber, int index_tm_pre_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_pre_pipe_rspec), 20, false, write_callback, read_callback, std::string("TmPrePipeRspecIntr")+":"+boost::lexical_cast<std::string>(index_tm_pre_pipe_rspec))
    {
    }
  TmPrePipeRspecIntr(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "TmPrePipeRspecIntr")
    {
    }
public:
  ...
  TmPrePipeRspecIntrStat &intr_stat() { return intr_stat_; }
  ...
  TmPrePipeRspecIntrEn0 &intr_en0() { return intr_en0_; }
  ...
  TmPrePipeRspecIntrEn1 &intr_en1() { return intr_en1_; }
  ...
  TmPrePipeRspecIntrInj &intr_inj() { return intr_inj_; }





  TmPrePipeRspecIntrFreezeEnable &intr_freeze_enable() { return intr_freeze_enable_; }
...
private:
  TmPrePipeRspecIntrStat intr_stat_;
  TmPrePipeRspecIntrEn0 intr_en0_;
  TmPrePipeRspecIntrEn1 intr_en1_;
  TmPrePipeRspecIntrInj intr_inj_;
  TmPrePipeRspecIntrFreezeEnable intr_freeze_enable_;
private:
...
#endif // __REGISTER_INCLUDES_TM_PRE_PIPE_RSPEC_INTR_H__
