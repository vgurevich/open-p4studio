...
#ifndef __REGISTER_INCLUDES_TM_PRE_PIPE_RSPEC_INTR_EN0_H__
#define __REGISTER_INCLUDES_TM_PRE_PIPE_RSPEC_INTR_EN0_H__
...
class TmPrePipeRspecIntrEn0 : public model_core::RegisterBlock<RegisterCallback> {
public:
  TmPrePipeRspecIntrEn0(
      int chipNumber, int index_tm_pre_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_pre_pipe_rspec), 4, false, write_callback, read_callback, std::string("TmPrePipeRspecIntrEn0")+":"+boost::lexical_cast<std::string>(index_tm_pre_pipe_rspec))
    {
    }
  TmPrePipeRspecIntrEn0(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "TmPrePipeRspecIntrEn0")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("TmPrePipeRspecIntrEn0") + ":\n";
...
#endif // __REGISTER_INCLUDES_TM_PRE_PIPE_RSPEC_INTR_EN0_H__
