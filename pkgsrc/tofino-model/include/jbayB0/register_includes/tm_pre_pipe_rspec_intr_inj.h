...
#ifndef __REGISTER_INCLUDES_TM_PRE_PIPE_RSPEC_INTR_INJ_H__
#define __REGISTER_INCLUDES_TM_PRE_PIPE_RSPEC_INTR_INJ_H__
...
class TmPrePipeRspecIntrInj : public model_core::RegisterBlock<RegisterCallback> {
public:
  TmPrePipeRspecIntrInj(
      int chipNumber, int index_tm_pre_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_pre_pipe_rspec), 4, false, write_callback, read_callback, std::string("TmPrePipeRspecIntrInj")+":"+boost::lexical_cast<std::string>(index_tm_pre_pipe_rspec))
    {
    }
  TmPrePipeRspecIntrInj(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "TmPrePipeRspecIntrInj")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("TmPrePipeRspecIntrInj") + ":\n";
...
#endif // __REGISTER_INCLUDES_TM_PRE_PIPE_RSPEC_INTR_INJ_H__
