...
#ifndef __REGISTER_INCLUDES_TM_PRE_PIPE_RSPEC_INTR_STAT_H__
#define __REGISTER_INCLUDES_TM_PRE_PIPE_RSPEC_INTR_STAT_H__
...
class TmPrePipeRspecIntrStat : public model_core::RegisterBlock<RegisterCallback> {
public:
  TmPrePipeRspecIntrStat(
      int chipNumber, int index_tm_pre_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_pre_pipe_rspec), 4, false, write_callback, read_callback, std::string("TmPrePipeRspecIntrStat")+":"+boost::lexical_cast<std::string>(index_tm_pre_pipe_rspec))
    {
    }
  TmPrePipeRspecIntrStat(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "TmPrePipeRspecIntrStat")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("TmPrePipeRspecIntrStat") + ":\n";
...
#endif // __REGISTER_INCLUDES_TM_PRE_PIPE_RSPEC_INTR_STAT_H__
