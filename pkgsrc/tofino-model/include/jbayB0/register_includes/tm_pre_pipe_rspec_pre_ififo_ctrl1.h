...
#ifndef __REGISTER_INCLUDES_TM_PRE_PIPE_RSPEC_PRE_IFIFO_CTRL1_H__
#define __REGISTER_INCLUDES_TM_PRE_PIPE_RSPEC_PRE_IFIFO_CTRL1_H__
...
class TmPrePipeRspecPreIfifoCtrl1 : public model_core::RegisterBlock<RegisterCallback> {
public:
  TmPrePipeRspecPreIfifoCtrl1(
      int chipNumber, int index_tm_pre_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_pre_pipe_rspec), 4, false, write_callback, read_callback, std::string("TmPrePipeRspecPreIfifoCtrl1")+":"+boost::lexical_cast<std::string>(index_tm_pre_pipe_rspec))
    {
    }
  TmPrePipeRspecPreIfifoCtrl1(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "TmPrePipeRspecPreIfifoCtrl1")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("TmPrePipeRspecPreIfifoCtrl1") + ":\n";
...
#endif // __REGISTER_INCLUDES_TM_PRE_PIPE_RSPEC_PRE_IFIFO_CTRL1_H__
