...
#ifndef __REGISTER_INCLUDES_TM_PSC_COMMON_RSPEC_INTR_EN1_H__
#define __REGISTER_INCLUDES_TM_PSC_COMMON_RSPEC_INTR_EN1_H__
...
class TmPscCommonRspecIntrEn1 : public model_core::RegisterBlock<RegisterCallback> {
public:
  TmPscCommonRspecIntrEn1(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 4, false, write_callback, read_callback, std::string("TmPscCommonRspecIntrEn1"))
    {
    }
  TmPscCommonRspecIntrEn1(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "TmPscCommonRspecIntrEn1")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("TmPscCommonRspecIntrEn1") + ":\n";
...
#endif // __REGISTER_INCLUDES_TM_PSC_COMMON_RSPEC_INTR_EN1_H__
