...
#ifndef __REGISTER_INCLUDES_TM_PSC_COMMON_RSPEC_INTR_FREEZE_ENABLE_MUTABLE_H__
#define __REGISTER_INCLUDES_TM_PSC_COMMON_RSPEC_INTR_FREEZE_ENABLE_MUTABLE_H__
...
class TmPscCommonRspecIntrFreezeEnableMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  TmPscCommonRspecIntrFreezeEnableMutable(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 4, true, write_callback, read_callback, std::string("TmPscCommonRspecIntrFreezeEnableMutable"))
    {
    }
  TmPscCommonRspecIntrFreezeEnableMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "TmPscCommonRspecIntrFreezeEnableMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("TmPscCommonRspecIntrFreezeEnableMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x1e90; // to get to intr_freeze_enable
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_TM_PSC_COMMON_RSPEC_INTR_FREEZE_ENABLE_MUTABLE_H__
