...
#include "tm_psc_common_rspec_linkmem_mbe_err_log_mutable.h"
#include "tm_psc_common_rspec_linkmem_sbe_err_log_mutable.h"
#include "tm_psc_common_rspec_overflow_err_log_mutable.h"
#include "tm_psc_common_rspec_underflow_err_log_mutable.h"
...
public:
  ...
  PscBankCtrlRMutable &psc_bank_ctrl_r(int j0) { return psc_bank_ctrl_r_[j0]; }
  ...
  PscIndirAccessAddrRMutable &lmem_indir_access_addr() { return lmem_indir_access_addr_; }
  ...
  TmPscCommonRspecLinkmemSbeErrLogMutable &linkmem_sbe_err_log() { return linkmem_sbe_err_log_; }





  TmPscCommonRspecLinkmemMbeErrLogMutable &linkmem_mbe_err_log() { return linkmem_mbe_err_log_; }





  TmPscCommonRspecOverflowErrLogMutable &overflow_err_log() { return overflow_err_log_; }





  TmPscCommonRspecUnderflowErrLogMutable &underflow_err_log() { return underflow_err_log_; }
...
private:
  ...
  std::array< PscBankCtrlRMutable, 384 > psc_bank_ctrl_r_;
  PscIndirAccessAddrRMutable lmem_indir_access_addr_;
  PscBlockLinkmemRMutable lmem_indir_access_data_;
  TmPscCommonRspecEccMutable ecc_;
  TmPscCommonRspecLinkmemSbeErrLogMutable linkmem_sbe_err_log_;
  TmPscCommonRspecLinkmemMbeErrLogMutable linkmem_mbe_err_log_;
  TmPscCommonRspecOverflowErrLogMutable overflow_err_log_;
  TmPscCommonRspecUnderflowErrLogMutable underflow_err_log_;
  std::array< PscEpipeGMutable, 4 > epipe_;
  std::array< PscBlockGMutable, 96 > block_;
