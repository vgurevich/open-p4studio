...
#ifndef __REGISTER_INCLUDES_TM_SCH_PIPE_RSPEC_H__
#define __REGISTER_INCLUDES_TM_SCH_PIPE_RSPEC_H__
...
class TmSchPipeRspec : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum TmTopRspecEnum {
    kTmSchaTop,
    kTmSchbTop
...
public:
  TmSchPipeRspec(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_tm_top_rspec, index_tm_sch_pipe_rspec), 32768, false, write_callback, read_callback, std::string("TmSchPipeRspec")+":"+boost::lexical_cast<std::string>(selector_tm_top_rspec) + "," + boost::lexical_cast<std::string>(index_tm_sch_pipe_rspec))
    {
    }
  TmSchPipeRspec(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "TmSchPipeRspec")
    {
    }
public:
  ...
  TmSchPipeRspecEcc &ecc() { return ecc_; }





  TmSchPipeRspecTdmTableSbeErrLog &tdm_table_sbe_err_log() { return tdm_table_sbe_err_log_; }





  TmSchPipeRspecTdmTableMbeErrLog &tdm_table_mbe_err_log() { return tdm_table_mbe_err_log_; }





  TmSchPipeRspecUpdWacSbeErrLog &upd_wac_sbe_err_log() { return upd_wac_sbe_err_log_; }





  TmSchPipeRspecUpdWacMbeErrLog &upd_wac_mbe_err_log() { return upd_wac_mbe_err_log_; }





  TmSchPipeRspecUpdEdprsrAdvfcSbeErrLog &upd_edprsr_advfc_sbe_err_log() { return upd_edprsr_advfc_sbe_err_log_; }





  TmSchPipeRspecUpdEdprsrAdvfcMbeErrLog &upd_edprsr_advfc_mbe_err_log() { return upd_edprsr_advfc_mbe_err_log_; }





  TmSchPipeRspecQMinrateSbeErrLog &q_minrate_sbe_err_log() { return q_minrate_sbe_err_log_; }





  TmSchPipeRspecQMinrateMbeErrLog &q_minrate_mbe_err_log() { return q_minrate_mbe_err_log_; }





  TmSchPipeRspecQExcrateSbeErrLog &q_excrate_sbe_err_log() { return q_excrate_sbe_err_log_; }





  TmSchPipeRspecQExcrateMbeErrLog &q_excrate_mbe_err_log() { return q_excrate_mbe_err_log_; }





  TmSchPipeRspecQMaxrateSbeErrLog &q_maxrate_sbe_err_log() { return q_maxrate_sbe_err_log_; }





  TmSchPipeRspecQMaxrateMbeErrLog &q_maxrate_mbe_err_log() { return q_maxrate_mbe_err_log_; }





  TmSchPipeRspecL1MinrateSbeErrLog &l1_minrate_sbe_err_log() { return l1_minrate_sbe_err_log_; }





  TmSchPipeRspecL1MinrateMbeErrLog &l1_minrate_mbe_err_log() { return l1_minrate_mbe_err_log_; }





  TmSchPipeRspecL1ExcrateSbeErrLog &l1_excrate_sbe_err_log() { return l1_excrate_sbe_err_log_; }





  TmSchPipeRspecL1ExcrateMbeErrLog &l1_excrate_mbe_err_log() { return l1_excrate_mbe_err_log_; }





  TmSchPipeRspecL1MaxrateSbeErrLog &l1_maxrate_sbe_err_log() { return l1_maxrate_sbe_err_log_; }





  TmSchPipeRspecL1MaxrateMbeErrLog &l1_maxrate_mbe_err_log() { return l1_maxrate_mbe_err_log_; }





  TmSchPipeRspecPMaxrateSbeErrLog &p_maxrate_sbe_err_log() { return p_maxrate_sbe_err_log_; }





  TmSchPipeRspecPMaxrateMbeErrLog &p_maxrate_mbe_err_log() { return p_maxrate_mbe_err_log_; }
  ...
  TmSchPipeRspecUpdPex0SbeErrLog &upd_pex0_sbe_err_log() { return upd_pex0_sbe_err_log_; }
  ...
  TmSchPipeRspecUpdPex0MbeErrLog &upd_pex0_mbe_err_log() { return upd_pex0_mbe_err_log_; }
  ...
  TmSchPipeRspecUpdPex1SbeErrLog &upd_pex1_sbe_err_log() { return upd_pex1_sbe_err_log_; }
  ...
  TmSchPipeRspecUpdPex1MbeErrLog &upd_pex1_mbe_err_log() { return upd_pex1_mbe_err_log_; }
  ...
  TmSchPipeRspecUpdEdprsrSbeErrLog &upd_edprsr_sbe_err_log() { return upd_edprsr_sbe_err_log_; }
  ...
  TmSchPipeRspecUpdEdprsrMbeErrLog &upd_edprsr_mbe_err_log() { return upd_edprsr_mbe_err_log_; }





  TmSchPipeRspecPexCreditErrLog &pex_credit_err_log() { return pex_credit_err_log_; }





  TmSchPipeRspecPexMacCreditErrLog &pex_mac_credit_err_log() { return pex_mac_credit_err_log_; }





  TmSchPipeRspecQWatchdogSbeErrLog &q_watchdog_sbe_err_log() { return q_watchdog_sbe_err_log_; }





  TmSchPipeRspecQWatchdogMbeErrLog &q_watchdog_mbe_err_log() { return q_watchdog_mbe_err_log_; }
  ...
  SchByteCountAdjustR &global_bytecnt_adj() { return global_bytecnt_adj_; }





  SchTdmConfigR &tdm_config() { return tdm_config_; }
  ...
  SchTdmTableEntryR &tdm_table(int j0) { return tdm_table_[j0]; }





  SchPortArbCtrlR &port_arb_ctrl() { return port_arb_ctrl_; }





  SchPexCreditCtrlR &pex_credit_ctrl() { return pex_credit_ctrl_; }
  ...
  SchPortConfigR &port_config(int j0) { return port_config_[j0]; }
  ...
  SchPortPfcStatusR &port_pfc_status_mem(int j0) { return port_pfc_status_mem_[j0]; }
  ...
  SchPortPexStatusR &port_pex_status_mem(int j0) { return port_pex_status_mem_[j0]; }
  ...
  SchMacPexStatusR &mac_pex_status_mem(int j0) { return mac_pex_status_mem_[j0]; }
  ...
  SchL1ConfigR &l1_config(int j0) { return l1_config_[j0]; }
  ...
  SchQueueConfigR &queue_config(int j0) { return queue_config_[j0]; }




  SchQueueFlushCtrlR &queue_flush_ctrl() { return queue_flush_ctrl_; }




  SchQueueFlushMaskR &queue_flush_mask() { return queue_flush_mask_; }





  SchWatchdogConfigR &watchdog_config() { return watchdog_config_; }
  ...
  SchWatchdogStatusR &watchdog_status(int j0) { return watchdog_status_[j0]; }





  SchWatchdogTimerR &watchdog_timer() { return watchdog_timer_; }





  SchAdvfcConfigR &iadvfc_config() { return iadvfc_config_; }





  SchAdvfcStatusR &iadvfc_status() { return iadvfc_status_; }





  SchAdvCntrR &iadvfc_ctr() { return iadvfc_ctr_; }





  SchAdvfcConfigR &eadvfc_config() { return eadvfc_config_; }





  SchAdvfcStatusR &eadvfc_status() { return eadvfc_status_; }





  SchAdvCntrR &eadvfc_ctr() { return eadvfc_ctr_; }
  ...
  SchPqCtrlR &pq_ctrl() { return pq_ctrl_; }
  ...
  SchPqPortEnR &pq_port_en() { return pq_port_en_; }
  ...
  SchPqPortProfileSelR &pq_port_profile_sel() { return pq_port_profile_sel_; }





  TmSchPipeRspecDebugBusCtrl &debug_bus_ctrl() { return debug_bus_ctrl_; }
  TmSchPipeRspecIntr &intr() { return intr_; }
...
private:
  TmSchPipeRspecEcc ecc_;
  TmSchPipeRspecTdmTableSbeErrLog tdm_table_sbe_err_log_;
  TmSchPipeRspecTdmTableMbeErrLog tdm_table_mbe_err_log_;
  TmSchPipeRspecUpdWacSbeErrLog upd_wac_sbe_err_log_;
  TmSchPipeRspecUpdWacMbeErrLog upd_wac_mbe_err_log_;
  TmSchPipeRspecUpdEdprsrAdvfcSbeErrLog upd_edprsr_advfc_sbe_err_log_;
  TmSchPipeRspecUpdEdprsrAdvfcMbeErrLog upd_edprsr_advfc_mbe_err_log_;
  TmSchPipeRspecQMinrateSbeErrLog q_minrate_sbe_err_log_;
  TmSchPipeRspecQMinrateMbeErrLog q_minrate_mbe_err_log_;
  TmSchPipeRspecQExcrateSbeErrLog q_excrate_sbe_err_log_;
  TmSchPipeRspecQExcrateMbeErrLog q_excrate_mbe_err_log_;
  TmSchPipeRspecQMaxrateSbeErrLog q_maxrate_sbe_err_log_;
  TmSchPipeRspecQMaxrateMbeErrLog q_maxrate_mbe_err_log_;
  TmSchPipeRspecL1MinrateSbeErrLog l1_minrate_sbe_err_log_;
  TmSchPipeRspecL1MinrateMbeErrLog l1_minrate_mbe_err_log_;
  TmSchPipeRspecL1ExcrateSbeErrLog l1_excrate_sbe_err_log_;
  TmSchPipeRspecL1ExcrateMbeErrLog l1_excrate_mbe_err_log_;
  TmSchPipeRspecL1MaxrateSbeErrLog l1_maxrate_sbe_err_log_;
  TmSchPipeRspecL1MaxrateMbeErrLog l1_maxrate_mbe_err_log_;
  TmSchPipeRspecPMaxrateSbeErrLog p_maxrate_sbe_err_log_;
  TmSchPipeRspecPMaxrateMbeErrLog p_maxrate_mbe_err_log_;
  TmSchPipeRspecUpdPex0SbeErrLog upd_pex0_sbe_err_log_;
  TmSchPipeRspecUpdPex0MbeErrLog upd_pex0_mbe_err_log_;
  TmSchPipeRspecUpdPex1SbeErrLog upd_pex1_sbe_err_log_;
  TmSchPipeRspecUpdPex1MbeErrLog upd_pex1_mbe_err_log_;
  TmSchPipeRspecUpdEdprsrSbeErrLog upd_edprsr_sbe_err_log_;
  TmSchPipeRspecUpdEdprsrMbeErrLog upd_edprsr_mbe_err_log_;
  TmSchPipeRspecPexCreditErrLog pex_credit_err_log_;
  TmSchPipeRspecPexMacCreditErrLog pex_mac_credit_err_log_;
  TmSchPipeRspecQWatchdogSbeErrLog q_watchdog_sbe_err_log_;
  TmSchPipeRspecQWatchdogMbeErrLog q_watchdog_mbe_err_log_;
  SchCtrlR ctrl_;
  SchReadyR ready_;
  SchByteCountAdjustR global_bytecnt_adj_;
  SchTdmConfigR tdm_config_;
  std::array< SchTdmTableEntryR, 128 > tdm_table_;
  SchPortArbCtrlR port_arb_ctrl_;
  SchPexCreditCtrlR pex_credit_ctrl_;
  std::array< SchPortConfigR, 72 > port_config_;
  std::array< SchPortPfcStatusR, 72 > port_pfc_status_mem_;
  std::array< SchPortPexStatusR, 576 > port_pex_status_mem_;
  std::array< SchMacPexStatusR, 5 > mac_pex_status_mem_;
  std::array< SchL1ConfigR, 288 > l1_config_;
  std::array< SchQueueConfigR, 1152 > queue_config_;
  SchQueueFlushCtrlR queue_flush_ctrl_;
  SchQueueFlushMaskR queue_flush_mask_;
  SchWatchdogConfigR watchdog_config_;
  std::array< SchWatchdogStatusR, 1152 > watchdog_status_;
  SchWatchdogTimerR watchdog_timer_;
  SchAdvfcConfigR iadvfc_config_;
  SchAdvfcStatusR iadvfc_status_;
  SchAdvCntrR iadvfc_ctr_;
  SchAdvfcConfigR eadvfc_config_;
  SchAdvfcStatusR eadvfc_status_;
  SchAdvCntrR eadvfc_ctr_;
  SchPqCtrlR pq_ctrl_;
  SchPqPortEnR pq_port_en_;
  SchPqPortProfileSelR pq_port_profile_sel_;
  TmSchPipeRspecDebugBusCtrl debug_bus_ctrl_;
  TmSchPipeRspecIntr intr_;
private:
...
#endif // __REGISTER_INCLUDES_TM_SCH_PIPE_RSPEC_H__
