...
#ifndef __REGISTER_INCLUDES_TM_SCH_PIPE_RSPEC_DEBUG_BUS_CTRL_H__
#define __REGISTER_INCLUDES_TM_SCH_PIPE_RSPEC_DEBUG_BUS_CTRL_H__
...
class TmSchPipeRspecDebugBusCtrl : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum TmTopRspecEnum {
    kTmSchaTop,
    kTmSchbTop
...
public:
  TmSchPipeRspecDebugBusCtrl(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_tm_top_rspec, index_tm_sch_pipe_rspec), 4, false, write_callback, read_callback, std::string("TmSchPipeRspecDebugBusCtrl")+":"+boost::lexical_cast<std::string>(selector_tm_top_rspec) + "," + boost::lexical_cast<std::string>(index_tm_sch_pipe_rspec))
    {
    }
  TmSchPipeRspecDebugBusCtrl(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "TmSchPipeRspecDebugBusCtrl")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("TmSchPipeRspecDebugBusCtrl") + ":\n";
...
#endif // __REGISTER_INCLUDES_TM_SCH_PIPE_RSPEC_DEBUG_BUS_CTRL_H__
