...
#ifndef __REGISTER_INCLUDES_TM_SCH_PIPE_RSPEC_DEBUG_BUS_CTRL_MUTABLE_H__
#define __REGISTER_INCLUDES_TM_SCH_PIPE_RSPEC_DEBUG_BUS_CTRL_MUTABLE_H__
...
class TmSchPipeRspecDebugBusCtrlMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum TmTopRspecEnum {
    kTmSchaTop,
    kTmSchbTop
...
public:
  TmSchPipeRspecDebugBusCtrlMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_tm_top_rspec, index_tm_sch_pipe_rspec), 4, true, write_callback, read_callback, std::string("TmSchPipeRspecDebugBusCtrlMutable")+":"+boost::lexical_cast<std::string>(selector_tm_top_rspec) + "," + boost::lexical_cast<std::string>(index_tm_sch_pipe_rspec))
    {
    }
  TmSchPipeRspecDebugBusCtrlMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "TmSchPipeRspecDebugBusCtrlMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("TmSchPipeRspecDebugBusCtrlMutable") + ":\n";
  ...
  static int StartOffset(
    ...
    switch (selector_tm_top_rspec) {
      case kTmSchaTop:
        ...
        offset += 0x724c; // to get to debug_bus_ctrl
        break;
      case kTmSchbTop:
...
#endif // __REGISTER_INCLUDES_TM_SCH_PIPE_RSPEC_DEBUG_BUS_CTRL_MUTABLE_H__
