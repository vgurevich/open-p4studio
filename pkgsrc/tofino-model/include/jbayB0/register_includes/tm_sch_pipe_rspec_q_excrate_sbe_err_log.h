...
#ifndef __REGISTER_INCLUDES_TM_SCH_PIPE_RSPEC_Q_EXCRATE_SBE_ERR_LOG_H__
#define __REGISTER_INCLUDES_TM_SCH_PIPE_RSPEC_Q_EXCRATE_SBE_ERR_LOG_H__
...
class TmSchPipeRspecQExcrateSbeErrLog : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum TmTopRspecEnum {
    kTmSchaTop,
    kTmSchbTop
...
public:
  TmSchPipeRspecQExcrateSbeErrLog(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_tm_top_rspec, index_tm_sch_pipe_rspec), 4, false, write_callback, read_callback, std::string("TmSchPipeRspecQExcrateSbeErrLog")+":"+boost::lexical_cast<std::string>(selector_tm_top_rspec) + "," + boost::lexical_cast<std::string>(index_tm_sch_pipe_rspec))
    {
    }
  TmSchPipeRspecQExcrateSbeErrLog(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "TmSchPipeRspecQExcrateSbeErrLog")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("TmSchPipeRspecQExcrateSbeErrLog") + ":\n";
...
#endif // __REGISTER_INCLUDES_TM_SCH_PIPE_RSPEC_Q_EXCRATE_SBE_ERR_LOG_H__
