...
#ifndef __REGISTER_INCLUDES_TM_SCH_PIPE_RSPEC_Q_MAXRATE_MBE_ERR_LOG_H__
#define __REGISTER_INCLUDES_TM_SCH_PIPE_RSPEC_Q_MAXRATE_MBE_ERR_LOG_H__
...
class TmSchPipeRspecQMaxrateMbeErrLog : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum TmTopRspecEnum {
    kTmSchaTop,
    kTmSchbTop
...
public:
  TmSchPipeRspecQMaxrateMbeErrLog(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_tm_top_rspec, index_tm_sch_pipe_rspec), 4, false, write_callback, read_callback, std::string("TmSchPipeRspecQMaxrateMbeErrLog")+":"+boost::lexical_cast<std::string>(selector_tm_top_rspec) + "," + boost::lexical_cast<std::string>(index_tm_sch_pipe_rspec))
    {
    }
  TmSchPipeRspecQMaxrateMbeErrLog(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "TmSchPipeRspecQMaxrateMbeErrLog")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("TmSchPipeRspecQMaxrateMbeErrLog") + ":\n";
...
#endif // __REGISTER_INCLUDES_TM_SCH_PIPE_RSPEC_Q_MAXRATE_MBE_ERR_LOG_H__
