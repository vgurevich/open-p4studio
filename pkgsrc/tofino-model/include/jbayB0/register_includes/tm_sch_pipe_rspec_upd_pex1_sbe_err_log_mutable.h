...
#ifndef __REGISTER_INCLUDES_TM_SCH_PIPE_RSPEC_UPD_PEX1_SBE_ERR_LOG_MUTABLE_H__
#define __REGISTER_INCLUDES_TM_SCH_PIPE_RSPEC_UPD_PEX1_SBE_ERR_LOG_MUTABLE_H__
...
class TmSchPipeRspecUpdPex1SbeErrLogMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum TmTopRspecEnum {
    kTmSchaTop,
    kTmSchbTop
...
public:
  TmSchPipeRspecUpdPex1SbeErrLogMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_tm_top_rspec, index_tm_sch_pipe_rspec), 4, true, write_callback, read_callback, std::string("TmSchPipeRspecUpdPex1SbeErrLogMutable")+":"+boost::lexical_cast<std::string>(selector_tm_top_rspec) + "," + boost::lexical_cast<std::string>(index_tm_sch_pipe_rspec))
    {
    }
  TmSchPipeRspecUpdPex1SbeErrLogMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "TmSchPipeRspecUpdPex1SbeErrLogMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("TmSchPipeRspecUpdPex1SbeErrLogMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_TM_SCH_PIPE_RSPEC_UPD_PEX1_SBE_ERR_LOG_MUTABLE_H__
