...
#ifndef __REGISTER_INCLUDES_TMATCH_MASK_ARRAY2_H__
#define __REGISTER_INCLUDES_TMATCH_MASK_ARRAY2_H__
...
class TmatchMaskArray2 : public model_core::RegisterBlock<RegisterArrayCallback2> {
public:
  TmatchMaskArray2(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap, index_mau_meter_alu_group_addrmap), 4 * ArraySize(index_pipe_addrmap, index_mau_addrmap, index_mau_meter_alu_group_addrmap, -1), false, write_callback, read_callback, std::string("TmatchMaskArray2")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_meter_alu_group_addrmap)),
...
public:
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("TmatchMaskArray2") + "["+boost::lexical_cast<std::string>(a1)+"]"+"["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
#endif // __REGISTER_INCLUDES_TMATCH_MASK_ARRAY2_H__
