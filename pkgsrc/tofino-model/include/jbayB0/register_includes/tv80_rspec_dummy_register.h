...
#ifndef __REGISTER_INCLUDES_TV80_RSPEC_DUMMY_REGISTER_H__
#define __REGISTER_INCLUDES_TV80_RSPEC_DUMMY_REGISTER_H__
...
class Tv80RspecDummyRegister : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum JbayRegEnum {
    kEth400gP1,
    kEth400gP10,
...
public:
  Tv80RspecDummyRegister(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_jbay_reg, index_tv80_rspec_dummy_register), 4, false, write_callback, read_callback, std::string("Tv80RspecDummyRegister")+":"+boost::lexical_cast<std::string>(selector_jbay_reg) + "," + boost::lexical_cast<std::string>(index_tv80_rspec_dummy_register))
    {
    }
  Tv80RspecDummyRegister(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "Tv80RspecDummyRegister")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("Tv80RspecDummyRegister") + ":\n";
...
#endif // __REGISTER_INCLUDES_TV80_RSPEC_DUMMY_REGISTER_H__
