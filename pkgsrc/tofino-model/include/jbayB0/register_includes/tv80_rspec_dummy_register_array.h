...
#ifndef __REGISTER_INCLUDES_TV80_RSPEC_DUMMY_REGISTER_ARRAY_H__
#define __REGISTER_INCLUDES_TV80_RSPEC_DUMMY_REGISTER_ARRAY_H__
...
#include "tv80_rspec_dummy_register.h"

namespace jbayB0 {
  namespace register_classes {

class Tv80RspecDummyRegisterArray : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  enum JbayRegEnum {
    kEth400gP1,
    kEth400gP10,
...
public:
  Tv80RspecDummyRegisterArray(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_jbay_reg), 4 * ArraySize(selector_jbay_reg, -1), false, write_callback, read_callback, std::string("Tv80RspecDummyRegisterArray")+":"+boost::lexical_cast<std::string>(selector_jbay_reg)),
...
public:
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("Tv80RspecDummyRegisterArray") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
private:
  std::vector<Tv80RspecDummyRegister> array;
  uint32_t size0_;
...
#endif // __REGISTER_INCLUDES_TV80_RSPEC_DUMMY_REGISTER_ARRAY_H__
