...
#ifndef __REGISTER_INCLUDES_TV80_RSPEC_DUMMY_REGISTER_MUTABLE_H__
#define __REGISTER_INCLUDES_TV80_RSPEC_DUMMY_REGISTER_MUTABLE_H__
...
class Tv80RspecDummyRegisterMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum JbayRegEnum {
    kEth400gP1,
    kEth400gP10,
...
public:
  Tv80RspecDummyRegisterMutable(
      int chipNumber, JbayRegEnum selector_jbay_reg, int index_tv80_rspec_dummy_register, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(selector_jbay_reg, index_tv80_rspec_dummy_register), 4, true, write_callback, read_callback, std::string("Tv80RspecDummyRegisterMutable")+":"+boost::lexical_cast<std::string>(selector_jbay_reg) + "," + boost::lexical_cast<std::string>(index_tv80_rspec_dummy_register))
    {
    }
  Tv80RspecDummyRegisterMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "Tv80RspecDummyRegisterMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("Tv80RspecDummyRegisterMutable") + ":\n";
...
private:
  static int StartOffset(
      JbayRegEnum selector_jbay_reg, int index_tv80_rspec_dummy_register
      ) {
    int offset=0;
    switch (selector_jbay_reg) {
      case kEth400gP1:
        ...
        assert(index_tv80_rspec_dummy_register < 4096);
        offset += index_tv80_rspec_dummy_register * 0x4; // tv80_rspec_dummy_register[]
        break;
      case kEth400gP10:
...
#endif // __REGISTER_INCLUDES_TV80_RSPEC_DUMMY_REGISTER_MUTABLE_H__
