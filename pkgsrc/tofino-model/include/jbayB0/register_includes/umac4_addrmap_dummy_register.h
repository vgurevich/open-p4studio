...
#ifndef __REGISTER_INCLUDES_UMAC4_ADDRMAP_DUMMY_REGISTER_H__
#define __REGISTER_INCLUDES_UMAC4_ADDRMAP_DUMMY_REGISTER_H__
...
class Umac4AddrmapDummyRegister : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum JbayRegEnum {
    kEth400gP1,
    kEth400gP10,
...
public:
  Umac4AddrmapDummyRegister(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_jbay_reg, index_umac4_addrmap_dummy_register), 4, false, write_callback, read_callback, std::string("Umac4AddrmapDummyRegister")+":"+boost::lexical_cast<std::string>(selector_jbay_reg) + "," + boost::lexical_cast<std::string>(index_umac4_addrmap_dummy_register))
    {
    }
  Umac4AddrmapDummyRegister(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "Umac4AddrmapDummyRegister")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("Umac4AddrmapDummyRegister") + ":\n";
...
#endif // __REGISTER_INCLUDES_UMAC4_ADDRMAP_DUMMY_REGISTER_H__
