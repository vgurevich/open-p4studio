...
#ifndef __REGISTER_INCLUDES_WAC_AP_LIMIT_CELL_ARRAY_MUTABLE_H__
#define __REGISTER_INCLUDES_WAC_AP_LIMIT_CELL_ARRAY_MUTABLE_H__
...
class WacApLimitCellArrayMutable : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  WacApLimitCellArrayMutable(
      int chipNumber, RegisterArrayCallback& write_callback = 0, RegisterArrayCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 4 * ArraySize(-1), true, write_callback, read_callback, std::string("WacApLimitCellArrayMutable")),
...
public:
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("WacApLimitCellArrayMutable") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
private:
  std::vector<WacApLimitCellMutable> array;
  uint32_t size0_;
...
#endif // __REGISTER_INCLUDES_WAC_AP_LIMIT_CELL_ARRAY_MUTABLE_H__
