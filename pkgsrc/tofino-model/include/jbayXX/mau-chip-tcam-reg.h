...
#ifndef _JBAYXX_MAU_CHIP_TCAM_REG_
#define _JBAYXX_MAU_CHIP_TCAM_REG_

#include <rmt-defs.h>
#include <register_adapters.h>

#include <register_includes/tcam_ghost_thread_en.h>
...
namespace MODEL_CHIP_NAMESPACE {
 ...
 private:
   void tcam_ghost_thread_en_write_callback();

   bool                                 ctor_running_;
   MauTcam                             *tcam_;
   register_classes::TcamGhostThreadEn  tcam_ghost_thread_en_;

  };
}

#endif // _JBAYXX_MAU_CHIP_TCAM_REG_
