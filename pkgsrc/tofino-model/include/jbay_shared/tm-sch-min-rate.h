...
#ifndef __JBAY_SHARED_TM_SCH_MIN_RATE_BLK__
#define __JBAY_SHARED_TM_SCH_MIN_RATE_BLK__
#include <tm-object.h>
...
class TmSchMinRate : public TmObject {

 public:
  TmSchMinRate(RmtObjectManager *om, uint8_t pipe_index);
  void pps_tick();
  void one_ns_tick();
 ...
 private:
  ...
  // min bucket size is 8M so plenty
  // of space
  int l1_min_bucket[TmDefs::kNumL1PerPipe];
  int q_min_bucket[TmDefs::kNumVqPerPipe];
