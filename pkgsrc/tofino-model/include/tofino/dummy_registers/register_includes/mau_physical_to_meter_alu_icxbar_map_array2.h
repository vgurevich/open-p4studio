...
// Generated using:
//    ./tools/make_dummy_register.py --chip_name notjbay include/jbay/register_includes/mau_physical_to_meter_alu_icxbar_map_array2.h
...
class MauPhysicalToMeterAluIcxbarMapArray2 : public model_core::DummyRegisterBlock<RegisterArrayCallback2> {
public:
...
private:
  static int StartOffset(
    ...
    offset += 0x11f0; // to get to mau_physical_to_meter_alu_icxbar_map
    return offset;
  }
