...
// Generated using:
//    ./tools/make_dummy_register.py --stub_out_array 0 --chip_name tofino --out_dir include/tofino/dummy_registers/register_includes include/jbay/register_includes/meter_alu_group_phv_hash_mask_array2.h
