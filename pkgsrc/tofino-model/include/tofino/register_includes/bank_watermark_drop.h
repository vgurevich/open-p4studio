...
#ifndef __REGISTER_INCLUDES_BANK_WATERMARK_DROP_H__
#define __REGISTER_INCLUDES_BANK_WATERMARK_DROP_H__
...
class BankWatermarkDrop : public model_core::RegisterBlock<RegisterCallback> {
public:
  BankWatermarkDrop(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_ibp_rspec), 4, false, write_callback, read_callback, std::string("BankWatermarkDrop")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_ibp_rspec))
    {
    }
  BankWatermarkDrop(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "BankWatermarkDrop")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("BankWatermarkDrop") + ":\n";
...
#endif // __REGISTER_INCLUDES_BANK_WATERMARK_DROP_H__
