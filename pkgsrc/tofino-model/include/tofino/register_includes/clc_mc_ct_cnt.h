...
#ifndef __REGISTER_INCLUDES_CLC_MC_CT_CNT_H__
#define __REGISTER_INCLUDES_CLC_MC_CT_CNT_H__
...
class ClcMcCtCnt : public model_core::RegisterBlock<RegisterCallback> {
public:
  ClcMcCtCnt(
      int chipNumber, int index_tm_clc_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_clc_pipe_rspec), 8, false, write_callback, read_callback, std::string("ClcMcCtCnt")+":"+boost::lexical_cast<std::string>(index_tm_clc_pipe_rspec))
    {
    }
  ClcMcCtCnt(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "ClcMcCtCnt")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("ClcMcCtCnt") + ":\n";
...
#endif // __REGISTER_INCLUDES_CLC_MC_CT_CNT_H__
