...
#ifndef __REGISTER_INCLUDES_CRED_CUR_MUTABLE_H__
#define __REGISTER_INCLUDES_CRED_CUR_MUTABLE_H__
...
class CredCurMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  CredCurMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_ibp_rspec), 4, true, write_callback, read_callback, std::string("CredCurMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_ibp_rspec))
    {
    }
  CredCurMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "CredCurMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("CredCurMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0xa8; // to get to glb_group_cred_cur
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_CRED_CUR_MUTABLE_H__
