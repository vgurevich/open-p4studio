...
public:
  DprsrCntVldIPhv(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, selector_dprsr_inp), 8, false, write_callback, read_callback, std::string("DprsrCntVldIPhv")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(selector_dprsr_inp))
    {
    }
  DprsrCntVldIPhv(
