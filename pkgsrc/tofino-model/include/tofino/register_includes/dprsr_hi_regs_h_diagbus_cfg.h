...
#ifndef __REGISTER_INCLUDES_DPRSR_HI_REGS_H_DIAGBUS_CFG_H__
#define __REGISTER_INCLUDES_DPRSR_HI_REGS_H_DIAGBUS_CFG_H__
...
class DprsrHiRegsHDiagbusCfg : public model_core::RegisterBlock<RegisterCallback> {
public:
  DprsrHiRegsHDiagbusCfg(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 4, false, write_callback, read_callback, std::string("DprsrHiRegsHDiagbusCfg")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  DprsrHiRegsHDiagbusCfg(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "DprsrHiRegsHDiagbusCfg")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("DprsrHiRegsHDiagbusCfg") + ":\n";
...
#endif // __REGISTER_INCLUDES_DPRSR_HI_REGS_H_DIAGBUS_CFG_H__
