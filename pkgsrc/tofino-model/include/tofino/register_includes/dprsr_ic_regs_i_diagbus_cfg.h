...
#ifndef __REGISTER_INCLUDES_DPRSR_IC_REGS_I_DIAGBUS_CFG_H__
#define __REGISTER_INCLUDES_DPRSR_IC_REGS_I_DIAGBUS_CFG_H__
...
class DprsrIcRegsIDiagbusCfg : public model_core::RegisterBlock<RegisterCallback> {
public:
  DprsrIcRegsIDiagbusCfg(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 4, false, write_callback, read_callback, std::string("DprsrIcRegsIDiagbusCfg")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  DprsrIcRegsIDiagbusCfg(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "DprsrIcRegsIDiagbusCfg")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("DprsrIcRegsIDiagbusCfg") + ":\n";
...
#endif // __REGISTER_INCLUDES_DPRSR_IC_REGS_I_DIAGBUS_CFG_H__
