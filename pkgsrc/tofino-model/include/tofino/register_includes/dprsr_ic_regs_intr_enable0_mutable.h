...
#ifndef __REGISTER_INCLUDES_DPRSR_IC_REGS_INTR_ENABLE0_MUTABLE_H__
#define __REGISTER_INCLUDES_DPRSR_IC_REGS_INTR_ENABLE0_MUTABLE_H__
...
class DprsrIcRegsIntrEnable0Mutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  DprsrIcRegsIntrEnable0Mutable(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 4, true, write_callback, read_callback, std::string("DprsrIcRegsIntrEnable0Mutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  DprsrIcRegsIntrEnable0Mutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "DprsrIcRegsIntrEnable0Mutable")
    {
    }
public:
  uint8_t ig_hdr_too_long() { return ig_hdr_too_long_; }
  void ig_hdr_too_long(const uint8_t &v) { ig_hdr_too_long_=v; }
  uint8_t eg_hdr_too_long() { return eg_hdr_too_long_; }
  void eg_hdr_too_long(const uint8_t &v) { eg_hdr_too_long_=v; }
  uint8_t i_tphv_mbe() { return i_tphv_mbe_; }
  void i_tphv_mbe(const uint8_t &v) { i_tphv_mbe_=v; }
  uint8_t i_tphv_sbe() { return i_tphv_sbe_; }
  void i_tphv_sbe(const uint8_t &v) { i_tphv_sbe_=v; }
  uint8_t e_tphv_mbe() { return e_tphv_mbe_; }
  void e_tphv_mbe(const uint8_t &v) { e_tphv_mbe_=v; }
  uint8_t e_tphv_sbe() { return e_tphv_sbe_; }
  void e_tphv_sbe(const uint8_t &v) { e_tphv_sbe_=v; }
  ...
  void i_dly_full(const uint8_t &v) { i_dly_full_=v; }
  uint8_t i_dly_empt() { return i_dly_empt_; }
  void i_dly_empt(const uint8_t &v) { i_dly_empt_=v; }
  uint8_t e_fl_full() { return e_fl_full_; }
  void e_fl_full(const uint8_t &v) { e_fl_full_=v; }
  uint8_t e_dly_full() { return e_dly_full_; }
  void e_dly_full(const uint8_t &v) { e_dly_full_=v; }
  uint8_t e_dly_empt() { return e_dly_empt_; }
  void e_dly_empt(const uint8_t &v) { e_dly_empt_=v; }
  uint8_t ipbmeta_fifo_full() { return ipbmeta_fifo_full_; }
  void ipbmeta_fifo_full(const uint8_t &v) { ipbmeta_fifo_full_=v; }
  uint8_t ipbmeta_fifo_empt() { return ipbmeta_fifo_empt_; }
  void ipbmeta_fifo_empt(const uint8_t &v) { ipbmeta_fifo_empt_=v; }
  uint8_t epbmeta_fifo_full() { return epbmeta_fifo_full_; }
  void epbmeta_fifo_full(const uint8_t &v) { epbmeta_fifo_full_=v; }
  uint8_t epbmeta_fifo_empt() { return epbmeta_fifo_empt_; }
  void epbmeta_fifo_empt(const uint8_t &v) { epbmeta_fifo_empt_=v; }
  uint8_t i_chan_mismatch() { return i_chan_mismatch_; }
  void i_chan_mismatch(const uint8_t &v) { i_chan_mismatch_=v; }
  uint8_t e_chan_mismatch() { return e_chan_mismatch_; }
  void e_chan_mismatch(const uint8_t &v) { e_chan_mismatch_=v; }
  ...
  void reset(
    ...
    ig_hdr_too_long_ = 0x1;
    eg_hdr_too_long_ = 0x1;
    i_tphv_mbe_ = 0x1;
    i_tphv_sbe_ = 0x1;
    e_tphv_mbe_ = 0x1;
    e_tphv_sbe_ = 0x1;
    ...
    e_dly_full_ = 0x1;
    e_dly_empt_ = 0x1;
    ipbmeta_fifo_full_ = 0x1;
    ipbmeta_fifo_empt_ = 0x1;
    epbmeta_fifo_full_ = 0x1;
    epbmeta_fifo_empt_ = 0x1;
    i_chan_mismatch_ = 0x1;
    e_chan_mismatch_ = 0x1;
    if (write_callback_) write_callback_();
  }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("DprsrIcRegsIntrEnable0Mutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0xc4; // to get to intr_enable0
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_DPRSR_IC_REGS_INTR_ENABLE0_MUTABLE_H__
