...
#ifndef __REGISTER_INCLUDES_DPRSR_IC_REGS_INTR_FREEZE_ENABLE_MUTABLE_H__
#define __REGISTER_INCLUDES_DPRSR_IC_REGS_INTR_FREEZE_ENABLE_MUTABLE_H__
...
class DprsrIcRegsIntrFreezeEnableMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  DprsrIcRegsIntrFreezeEnableMutable(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 4, true, write_callback, read_callback, std::string("DprsrIcRegsIntrFreezeEnableMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  DprsrIcRegsIntrFreezeEnableMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "DprsrIcRegsIntrFreezeEnableMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("DprsrIcRegsIntrFreezeEnableMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0xd0; // to get to intr_freeze_enable
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_DPRSR_IC_REGS_INTR_FREEZE_ENABLE_MUTABLE_H__
