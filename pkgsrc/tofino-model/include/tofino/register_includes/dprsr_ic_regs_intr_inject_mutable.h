...
#ifndef __REGISTER_INCLUDES_DPRSR_IC_REGS_INTR_INJECT_MUTABLE_H__
#define __REGISTER_INCLUDES_DPRSR_IC_REGS_INTR_INJECT_MUTABLE_H__
...
class DprsrIcRegsIntrInjectMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  DprsrIcRegsIntrInjectMutable(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 4, true, write_callback, read_callback, std::string("DprsrIcRegsIntrInjectMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  DprsrIcRegsIntrInjectMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "DprsrIcRegsIntrInjectMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("DprsrIcRegsIntrInjectMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0xcc; // to get to intr_inject
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_DPRSR_IC_REGS_INTR_INJECT_MUTABLE_H__
