...
#ifndef __REGISTER_INCLUDES_DPRSR_II_REGS_MUTABLE_H__
#define __REGISTER_INCLUDES_DPRSR_II_REGS_MUTABLE_H__
...
#include "dprsr_ii_regs_hdr_too_long_i_mutable.h"
...
class DprsrIiRegsMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  DprsrIiRegsMutable(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 2036, true, write_callback, read_callback, std::string("DprsrIiRegsMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  DprsrIiRegsMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "DprsrIiRegsMutable")
    {
    }
public:
  ...
  DprsrCntIMauErrRMutable &mau_err_i() { return mau_err_i_; }





  DprsrIiRegsHdrTooLongIMutable &hdr_too_long_i() { return hdr_too_long_i_; }
  ...
  DprsrInputIngAndEgrEccGMutable &ecc_i() { return ecc_i_; }
...
private:
  DprsrCntIMauErrRMutable mau_err_i_;
  DprsrIiRegsHdrTooLongIMutable hdr_too_long_i_;
  DprsrInputIngAndEgrGMutable main_i_;
  DprsrInputIngressOnlyGMutable ingr_;
  DprsrInputIngAndEgrEccGMutable ecc_i_;
private:
...
#endif // __REGISTER_INCLUDES_DPRSR_II_REGS_MUTABLE_H__
