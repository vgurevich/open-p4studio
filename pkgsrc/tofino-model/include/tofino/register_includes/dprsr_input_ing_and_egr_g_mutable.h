...
#include "dprsr_cnt_vld_i_tphv_mutable.h"
#include "dprsr_drop_ctl_r_mutable.h"
#include "dprsr_egress_unicast_port_mutable.h"
...
public:
  DprsrInputIngAndEgrGMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, selector_dprsr_inp), 60, true, write_callback, read_callback, std::string("DprsrInputIngAndEgrGMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(selector_dprsr_inp))
    {
    }
  DprsrInputIngAndEgrGMutable(
...
public:
  ...
  DprsrEgressUnicastPortMutable &main_i_egress_unicast_port() { return main_i_egress_unicast_port_; }
  ...
  DprsrCntVldITphvMutable &main_i_cnt_i_tphv() { return main_i_cnt_i_tphv_; }
  ...
  DprsrDropCtlRMutable &main_i_drop_ctl() { return main_i_drop_ctl_; }
...
private:
  ...
  DprsrEgressUnicastPortMutable main_i_egress_unicast_port_;
  DprsrCntVldIPhvMutable main_i_cnt_i_phv_;
  DprsrCntVldITphvMutable main_i_cnt_i_tphv_;
  DprsrDropCtlRMutable main_i_drop_ctl_;
private:
