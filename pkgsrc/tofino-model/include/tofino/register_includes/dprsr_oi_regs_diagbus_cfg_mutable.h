...
#ifndef __REGISTER_INCLUDES_DPRSR_OI_REGS_DIAGBUS_CFG_MUTABLE_H__
#define __REGISTER_INCLUDES_DPRSR_OI_REGS_DIAGBUS_CFG_MUTABLE_H__
...
class DprsrOiRegsDiagbusCfgMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  DprsrOiRegsDiagbusCfgMutable(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 4, true, write_callback, read_callback, std::string("DprsrOiRegsDiagbusCfgMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  DprsrOiRegsDiagbusCfgMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "DprsrOiRegsDiagbusCfgMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("DprsrOiRegsDiagbusCfgMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x954; // to get to diagbus_cfg
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_DPRSR_OI_REGS_DIAGBUS_CFG_MUTABLE_H__
