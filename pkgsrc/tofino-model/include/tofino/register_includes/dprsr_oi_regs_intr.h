...
#ifndef __REGISTER_INCLUDES_DPRSR_OI_REGS_INTR_H__
#define __REGISTER_INCLUDES_DPRSR_OI_REGS_INTR_H__
...
#include "dprsr_oi_regs_intr_enable0.h"
#include "dprsr_oi_regs_intr_enable1.h"
#include "dprsr_oi_regs_intr_freeze_enable.h"
#include "dprsr_oi_regs_intr_inject.h"
#include "dprsr_oi_regs_intr_status.h"

namespace tofino {
  namespace register_classes {

class DprsrOiRegsIntr : public model_core::RegisterBlock<RegisterCallback> {
public:
  DprsrOiRegsIntr(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 20, false, write_callback, read_callback, std::string("DprsrOiRegsIntr")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  DprsrOiRegsIntr(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "DprsrOiRegsIntr")
    {
    }
public:
  ...
  DprsrOiRegsIntrStatus &intr_status() { return intr_status_; }
  ...
  DprsrOiRegsIntrEnable0 &intr_enable0() { return intr_enable0_; }
  ...
  DprsrOiRegsIntrEnable1 &intr_enable1() { return intr_enable1_; }
  ...
  DprsrOiRegsIntrInject &intr_inject() { return intr_inject_; }





  DprsrOiRegsIntrFreezeEnable &intr_freeze_enable() { return intr_freeze_enable_; }
...
private:
  DprsrOiRegsIntrStatus intr_status_;
  DprsrOiRegsIntrEnable0 intr_enable0_;
  DprsrOiRegsIntrEnable1 intr_enable1_;
  DprsrOiRegsIntrInject intr_inject_;
  DprsrOiRegsIntrFreezeEnable intr_freeze_enable_;
private:
...
#endif // __REGISTER_INCLUDES_DPRSR_OI_REGS_INTR_H__
