...
#ifndef __REGISTER_INCLUDES_DPRSR_OI_REGS_INTR_ENABLE0_MUTABLE_H__
#define __REGISTER_INCLUDES_DPRSR_OI_REGS_INTR_ENABLE0_MUTABLE_H__
...
class DprsrOiRegsIntrEnable0Mutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  DprsrOiRegsIntrEnable0Mutable(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 4, true, write_callback, read_callback, std::string("DprsrOiRegsIntrEnable0Mutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  DprsrOiRegsIntrEnable0Mutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "DprsrOiRegsIntrEnable0Mutable")
    {
    }
public:
  ...
  void reset(
    ...
    i_mirr_hdr_mbe_ = 0x1;
    i_mirr_hdr_sbe_ = 0x1;
    pbs_req_ctrl_mbe_ = 0x1;
    pbs_req_ctrl_sbe_ = 0x1;
    pbs_req_data_mbe_ = 0x1;
    pbs_req_data_sbe_ = 0x1;
    pbs_resp_ctrl_mbe_ = 0x1;
    pbs_resp_ctrl_sbe_ = 0x1;
    pbs_resp_data_mbe_ = 0x1;
    pbs_resp_data_sbe_ = 0x1;
    i_pkt_state_push_err_ = 0x1;
    i_pkt_state_pop_err_ = 0x1;
    i_hdr_push_err_ = 0x1;
    i_hdr_pop_err_ = 0x1;
    mirr_tm_push_err_ = 0x1;
    mirr_tm_pop_err_ = 0x1;
    i_metadata_mbe_ = 0x1;
    i_metadata_sbe_ = 0x1;
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("DprsrOiRegsIntrEnable0Mutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_DPRSR_OI_REGS_INTR_ENABLE0_MUTABLE_H__
