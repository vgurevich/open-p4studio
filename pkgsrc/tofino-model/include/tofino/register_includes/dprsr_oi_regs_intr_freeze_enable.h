...
#ifndef __REGISTER_INCLUDES_DPRSR_OI_REGS_INTR_FREEZE_ENABLE_H__
#define __REGISTER_INCLUDES_DPRSR_OI_REGS_INTR_FREEZE_ENABLE_H__
...
class DprsrOiRegsIntrFreezeEnable : public model_core::RegisterBlock<RegisterCallback> {
public:
  DprsrOiRegsIntrFreezeEnable(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 4, false, write_callback, read_callback, std::string("DprsrOiRegsIntrFreezeEnable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  DprsrOiRegsIntrFreezeEnable(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "DprsrOiRegsIntrFreezeEnable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("DprsrOiRegsIntrFreezeEnable") + ":\n";
...
#endif // __REGISTER_INCLUDES_DPRSR_OI_REGS_INTR_FREEZE_ENABLE_H__
