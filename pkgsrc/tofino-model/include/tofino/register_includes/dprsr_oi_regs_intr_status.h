...
#ifndef __REGISTER_INCLUDES_DPRSR_OI_REGS_INTR_STATUS_H__
#define __REGISTER_INCLUDES_DPRSR_OI_REGS_INTR_STATUS_H__
...
class DprsrOiRegsIntrStatus : public model_core::RegisterBlock<RegisterCallback> {
public:
  DprsrOiRegsIntrStatus(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 4, false, write_callback, read_callback, std::string("DprsrOiRegsIntrStatus")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  DprsrOiRegsIntrStatus(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "DprsrOiRegsIntrStatus")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("DprsrOiRegsIntrStatus") + ":\n";
...
#endif // __REGISTER_INCLUDES_DPRSR_OI_REGS_INTR_STATUS_H__
