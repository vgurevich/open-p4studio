...
#ifndef __REGISTER_INCLUDES_DR_BASE_ADDR_HIGH_MUTABLE_H__
#define __REGISTER_INCLUDES_DR_BASE_ADDR_HIGH_MUTABLE_H__
...
class DrBaseAddrHighMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum CbcRspecEnum {
    kCbcLqFmDr,
    kCbcLqRxDr,
...
public:
  DrBaseAddrHighMutable(
      int chipNumber, CbcRspecEnum selector_cbc_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(selector_cbc_rspec), 4, true, write_callback, read_callback, std::string("DrBaseAddrHighMutable")+":"+boost::lexical_cast<std::string>(selector_cbc_rspec))
    {
    }
  DrBaseAddrHighMutable(
      int chipNumber, MbcRspecEnum selector_mbc_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(selector_mbc_rspec), 4, true, write_callback, read_callback, std::string("DrBaseAddrHighMutable")+":"+boost::lexical_cast<std::string>(selector_mbc_rspec))
    {
    }
  DrBaseAddrHighMutable(
      int chipNumber, PbcRspecEnum selector_pbc_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(selector_pbc_rspec), 4, true, write_callback, read_callback, std::string("DrBaseAddrHighMutable")+":"+boost::lexical_cast<std::string>(selector_pbc_rspec))
    {
    }
  DrBaseAddrHighMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_pbc_rspec, index_dru_rspec), 4, true, write_callback, read_callback, std::string("DrBaseAddrHighMutable")+":"+boost::lexical_cast<std::string>(selector_pbc_rspec) + "," + boost::lexical_cast<std::string>(index_dru_rspec))
    {
    }
  DrBaseAddrHighMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_tbc_rspec, index_dru_rspec), 4, true, write_callback, read_callback, std::string("DrBaseAddrHighMutable")+":"+boost::lexical_cast<std::string>(selector_tbc_rspec) + "," + boost::lexical_cast<std::string>(index_dru_rspec))
    {
    }
  DrBaseAddrHighMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "DrBaseAddrHighMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("DrBaseAddrHighMutable") + ":\n";
  ...
  static int StartOffset(
    ...
    switch (selector_cbc_rspec) {
      case kCbcLqFmDr:
        ...
        offset += 0x8; // to get to base_addr_high
        break;
      case kCbcLqRxDr:
...
#endif // __REGISTER_INCLUDES_DR_BASE_ADDR_HIGH_MUTABLE_H__
