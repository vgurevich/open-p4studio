...
#ifndef __REGISTER_INCLUDES_DR_HEAD_PTR_MUTABLE_H__
#define __REGISTER_INCLUDES_DR_HEAD_PTR_MUTABLE_H__
...
class DrHeadPtrMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum CbcRspecEnum {
    kCbcLqFmDr,
    kCbcLqRxDr,
...
public:
  DrHeadPtrMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_cbc_rspec), 4, true, write_callback, read_callback, std::string("DrHeadPtrMutable")+":"+boost::lexical_cast<std::string>(selector_cbc_rspec))
    {
    }
  DrHeadPtrMutable(
      int chipNumber, MbcRspecEnum selector_mbc_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(selector_mbc_rspec), 4, true, write_callback, read_callback, std::string("DrHeadPtrMutable")+":"+boost::lexical_cast<std::string>(selector_mbc_rspec))
    {
    }
  DrHeadPtrMutable(
      int chipNumber, PbcRspecEnum selector_pbc_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(selector_pbc_rspec), 4, true, write_callback, read_callback, std::string("DrHeadPtrMutable")+":"+boost::lexical_cast<std::string>(selector_pbc_rspec))
    {
    }
  DrHeadPtrMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_pbc_rspec, index_dru_rspec), 4, true, write_callback, read_callback, std::string("DrHeadPtrMutable")+":"+boost::lexical_cast<std::string>(selector_pbc_rspec) + "," + boost::lexical_cast<std::string>(index_dru_rspec))
    {
    }
  DrHeadPtrMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_tbc_rspec, index_dru_rspec), 4, true, write_callback, read_callback, std::string("DrHeadPtrMutable")+":"+boost::lexical_cast<std::string>(selector_tbc_rspec) + "," + boost::lexical_cast<std::string>(index_dru_rspec))
    {
    }
  DrHeadPtrMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "DrHeadPtrMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("DrHeadPtrMutable") + ":\n";
  ...
  static int StartOffset(
    ...
    switch (selector_cbc_rspec) {
      case kCbcLqFmDr:
        ...
        offset += 0x18; // to get to head_ptr
        break;
      case kCbcLqRxDr:
...
#endif // __REGISTER_INCLUDES_DR_HEAD_PTR_MUTABLE_H__
