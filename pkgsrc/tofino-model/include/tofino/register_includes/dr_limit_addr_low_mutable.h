...
#ifndef __REGISTER_INCLUDES_DR_LIMIT_ADDR_LOW_MUTABLE_H__
#define __REGISTER_INCLUDES_DR_LIMIT_ADDR_LOW_MUTABLE_H__
...
class DrLimitAddrLowMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum CbcRspecEnum {
    kCbcLqFmDr,
    kCbcLqRxDr,
...
public:
  DrLimitAddrLowMutable(
      int chipNumber, CbcRspecEnum selector_cbc_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(selector_cbc_rspec), 4, true, write_callback, read_callback, std::string("DrLimitAddrLowMutable")+":"+boost::lexical_cast<std::string>(selector_cbc_rspec))
    {
    }
  DrLimitAddrLowMutable(
      int chipNumber, MbcRspecEnum selector_mbc_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(selector_mbc_rspec), 4, true, write_callback, read_callback, std::string("DrLimitAddrLowMutable")+":"+boost::lexical_cast<std::string>(selector_mbc_rspec))
    {
    }
  DrLimitAddrLowMutable(
      int chipNumber, PbcRspecEnum selector_pbc_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(selector_pbc_rspec), 4, true, write_callback, read_callback, std::string("DrLimitAddrLowMutable")+":"+boost::lexical_cast<std::string>(selector_pbc_rspec))
    {
    }
  DrLimitAddrLowMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_pbc_rspec, index_dru_rspec), 4, true, write_callback, read_callback, std::string("DrLimitAddrLowMutable")+":"+boost::lexical_cast<std::string>(selector_pbc_rspec) + "," + boost::lexical_cast<std::string>(index_dru_rspec))
    {
    }
  DrLimitAddrLowMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_tbc_rspec, index_dru_rspec), 4, true, write_callback, read_callback, std::string("DrLimitAddrLowMutable")+":"+boost::lexical_cast<std::string>(selector_tbc_rspec) + "," + boost::lexical_cast<std::string>(index_dru_rspec))
    {
    }
  DrLimitAddrLowMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "DrLimitAddrLowMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("DrLimitAddrLowMutable") + ":\n";
  ...
  static int StartOffset(
    ...
    switch (selector_cbc_rspec) {
      case kCbcLqFmDr:
        ...
        offset += 0xc; // to get to limit_addr_low
        break;
      case kCbcLqRxDr:
...
#endif // __REGISTER_INCLUDES_DR_LIMIT_ADDR_LOW_MUTABLE_H__
