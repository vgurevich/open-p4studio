...
public:
  DruRspec(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_cbc_rspec), 44, false, write_callback, read_callback, std::string("DruRspec")+":"+boost::lexical_cast<std::string>(selector_cbc_rspec))
    {
    }
  DruRspec(
      int chipNumber, MbcRspecEnum selector_mbc_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(selector_mbc_rspec), 44, false, write_callback, read_callback, std::string("DruRspec")+":"+boost::lexical_cast<std::string>(selector_mbc_rspec))
    {
    }
  DruRspec(
      int chipNumber, PbcRspecEnum selector_pbc_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(selector_pbc_rspec), 44, false, write_callback, read_callback, std::string("DruRspec")+":"+boost::lexical_cast<std::string>(selector_pbc_rspec))
    {
    }
  DruRspec(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_pbc_rspec, index_dru_rspec), 44, false, write_callback, read_callback, std::string("DruRspec")+":"+boost::lexical_cast<std::string>(selector_pbc_rspec) + "," + boost::lexical_cast<std::string>(index_dru_rspec))
    {
    }
  DruRspec(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_tbc_rspec, index_dru_rspec), 44, false, write_callback, read_callback, std::string("DruRspec")+":"+boost::lexical_cast<std::string>(selector_tbc_rspec) + "," + boost::lexical_cast<std::string>(index_dru_rspec))
    {
    }
  DruRspec(
