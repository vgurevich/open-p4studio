...
#ifndef __REGISTER_INCLUDES_EBUF_DISP_REGS_H__
#define __REGISTER_INCLUDES_EBUF_DISP_REGS_H__
...
#include "ebuf_disp_regs_cred_ctrl.h"
#include "ebuf_disp_regs_dbg_ctrl.h"
#include "ebuf_disp_regs_dprs_ctrl.h"
#include "ebuf_disp_regs_ebuf_disp_fifo_avail.h"
#include "ebuf_disp_regs_int_en.h"
#include "ebuf_disp_regs_int_freeze.h"
#include "ebuf_disp_regs_int_inj.h"
#include "ebuf_disp_regs_int_pri.h"
#include "ebuf_disp_regs_int_stat.h"
#include "ebuf_disp_regs_port_mode.h"

namespace tofino {
  namespace register_classes {

class EbufDispRegs : public model_core::RegisterBlock<RegisterCallback> {
public:
  EbufDispRegs(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_egrNx_regs), 60, false, write_callback, read_callback, std::string("EbufDispRegs")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_egrNx_regs))
    {
    }
  EbufDispRegs(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "EbufDispRegs")
    {
    }
public:
  ...
  EbufDispRegsPortMode &port_mode() { return port_mode_; }





  EbufDispRegsCredCtrl &cred_ctrl() { return cred_ctrl_; }
  ...
  EbufDispRegsDprsCtrl &chnl_ctrl(int j0) { return chnl_ctrl_[j0]; }





  EbufDispRegsIntStat &int_stat() { return int_stat_; }





  EbufDispRegsIntEn &int_en() { return int_en_; }





  EbufDispRegsIntPri &int_pri() { return int_pri_; }
  ...
  EbufDispRegsIntInj &int_inj() { return int_inj_; }





  EbufDispRegsEbufDispFifoAvail &ebuf_disp_fifo_avail() { return ebuf_disp_fifo_avail_; }





  EbufDispRegsIntFreeze &int_freeze() { return int_freeze_; }





  EbufDispRegsDbgCtrl &dbg_ctrl() { return dbg_ctrl_; }
...
private:
  EbufDispRegsPortMode port_mode_;
  EbufDispRegsCredCtrl cred_ctrl_;
  std::array< EbufDispRegsDprsCtrl, 4 > chnl_ctrl_;
  EbufDispRegsIntStat int_stat_;
  EbufDispRegsIntEn int_en_;
  EbufDispRegsIntPri int_pri_;
  EbufDispRegsIntInj int_inj_;
  EbufDispRegsEbufDispFifoAvail ebuf_disp_fifo_avail_;
  EbufDispRegsIntFreeze int_freeze_;
  EbufDispRegsDbgCtrl dbg_ctrl_;
private:
...
#endif // __REGISTER_INCLUDES_EBUF_DISP_REGS_H__
