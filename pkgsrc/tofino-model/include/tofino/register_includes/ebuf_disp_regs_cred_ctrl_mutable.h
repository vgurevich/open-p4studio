...
#ifndef __REGISTER_INCLUDES_EBUF_DISP_REGS_CRED_CTRL_MUTABLE_H__
#define __REGISTER_INCLUDES_EBUF_DISP_REGS_CRED_CTRL_MUTABLE_H__
...
class EbufDispRegsCredCtrlMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  EbufDispRegsCredCtrlMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_egrNx_regs), 4, true, write_callback, read_callback, std::string("EbufDispRegsCredCtrlMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_egrNx_regs))
    {
    }
  EbufDispRegsCredCtrlMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "EbufDispRegsCredCtrlMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("EbufDispRegsCredCtrlMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_EBUF_DISP_REGS_CRED_CTRL_MUTABLE_H__
