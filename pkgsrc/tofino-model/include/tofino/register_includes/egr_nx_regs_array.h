...
#ifndef __REGISTER_INCLUDES_EGR_NX_REGS_ARRAY_H__
#define __REGISTER_INCLUDES_EGR_NX_REGS_ARRAY_H__
...
class EgrNxRegsArray : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  EgrNxRegsArray(
      int chipNumber, int index_pipe_addrmap, RegisterArrayCallback& write_callback = 0, RegisterArrayCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 512 * ArraySize(index_pipe_addrmap, -1), false, write_callback, read_callback, std::string("EgrNxRegsArray")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap)),
...
public:
  ...
  EbufDispRegs &ebuf_disp_regs(uint32_t a0)
  {
  ...
  EbufFifoRegs &ebuf_fifo_regs(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
  ...
  EpbDprsRegs &epb_dprs_regs(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
  ...
  EpbDispPortRegs &epb_disp_port_regs(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("EgrNxRegsArray") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
#endif // __REGISTER_INCLUDES_EGR_NX_REGS_ARRAY_H__
