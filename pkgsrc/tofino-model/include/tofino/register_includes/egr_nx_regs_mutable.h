...
#ifndef __REGISTER_INCLUDES_EGR_NX_REGS_MUTABLE_H__
#define __REGISTER_INCLUDES_EGR_NX_REGS_MUTABLE_H__
...
class EgrNxRegsMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  EgrNxRegsMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_egrNx_regs), 512, true, write_callback, read_callback, std::string("EgrNxRegsMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_egrNx_regs))
    {
    }
  EgrNxRegsMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "EgrNxRegsMutable")
    {
    }
public:
  ...
  EbufDispRegsMutable &ebuf_disp_regs() { return ebuf_disp_regs_; }





  EbufFifoRegsMutable &ebuf_fifo_regs() { return ebuf_fifo_regs_; }





  EpbDprsRegsMutable &epb_dprs_regs() { return epb_dprs_regs_; }





  EpbDispPortRegsMutable &epb_disp_port_regs() { return epb_disp_port_regs_; }
...
private:
  EbufDispRegsMutable ebuf_disp_regs_;
  EbufFifoRegsMutable ebuf_fifo_regs_;
  EpbDprsRegsMutable epb_dprs_regs_;
  EpbDispPortRegsMutable epb_disp_port_regs_;
private:
...
#endif // __REGISTER_INCLUDES_EGR_NX_REGS_MUTABLE_H__
