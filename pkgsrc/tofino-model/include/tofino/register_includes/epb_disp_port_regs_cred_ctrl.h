...
#ifndef __REGISTER_INCLUDES_EPB_DISP_PORT_REGS_CRED_CTRL_H__
#define __REGISTER_INCLUDES_EPB_DISP_PORT_REGS_CRED_CTRL_H__
...
class EpbDispPortRegsCredCtrl : public model_core::RegisterBlock<RegisterCallback> {
public:
  EpbDispPortRegsCredCtrl(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_egrNx_regs), 4, false, write_callback, read_callback, std::string("EpbDispPortRegsCredCtrl")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_egrNx_regs))
    {
    }
  EpbDispPortRegsCredCtrl(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "EpbDispPortRegsCredCtrl")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("EpbDispPortRegsCredCtrl") + ":\n";
...
#endif // __REGISTER_INCLUDES_EPB_DISP_PORT_REGS_CRED_CTRL_H__
