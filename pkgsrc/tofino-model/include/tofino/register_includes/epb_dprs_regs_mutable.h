...
#ifndef __REGISTER_INCLUDES_EPB_DPRS_REGS_MUTABLE_H__
#define __REGISTER_INCLUDES_EPB_DPRS_REGS_MUTABLE_H__
...
#include "epb_dprs_regs_capt_dual_ecc_addr_mutable.h"
#include "epb_dprs_regs_chnl_ctrl_mutable.h"
#include "epb_dprs_regs_cred_ctrl_mutable.h"
#include "epb_dprs_regs_cred_cur_mutable.h"
#include "epb_dprs_regs_dprsff_emp_mutable.h"
#include "epb_dprs_regs_dprsff_max_mutable.h"
#include "epb_dprs_regs_int_en_mutable.h"
#include "epb_dprs_regs_int_freeze_mutable.h"
#include "epb_dprs_regs_int_inj_mutable.h"
#include "epb_dprs_regs_int_pri_mutable.h"
#include "epb_dprs_regs_int_stat_mutable.h"
#include "epb_dprs_regs_port_id_mutable.h"

namespace tofino {
  namespace register_classes {

class EpbDprsRegsMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  EpbDprsRegsMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_egrNx_regs), 64, true, write_callback, read_callback, std::string("EpbDprsRegsMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_egrNx_regs))
    {
    }
  EpbDprsRegsMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "EpbDprsRegsMutable")
    {
    }
public:
  ...
  EpbDprsRegsChnlCtrlMutable &chnl_ctrl(int j0) { return chnl_ctrl_[j0]; }





  EpbDprsRegsPortIdMutable &port_id() { return port_id_; }





  EpbDprsRegsIntStatMutable &int_stat() { return int_stat_; }





  EpbDprsRegsIntEnMutable &int_en() { return int_en_; }





  EpbDprsRegsIntPriMutable &int_pri() { return int_pri_; }
  ...
  EpbDprsRegsIntInjMutable &int_inj() { return int_inj_; }





  EpbDprsRegsCaptDualEccAddrMutable &capt_dual_ecc_addr() { return capt_dual_ecc_addr_; }





  EpbDprsRegsCredCtrlMutable &cred_ctrl() { return cred_ctrl_; }





  EpbDprsRegsCredCurMutable &cred_cur() { return cred_cur_; }





  EpbDprsRegsDprsffMaxMutable &dprsff_max() { return dprsff_max_; }





  EpbDprsRegsDprsffEmpMutable &dprsff_emp() { return dprsff_emp_; }





  EpbDprsRegsIntFreezeMutable &int_freeze() { return int_freeze_; }
...
private:
  std::array< EpbDprsRegsChnlCtrlMutable, 4 > chnl_ctrl_;
  EpbDprsRegsPortIdMutable port_id_;
  EpbDprsRegsIntStatMutable int_stat_;
  EpbDprsRegsIntEnMutable int_en_;
  EpbDprsRegsIntPriMutable int_pri_;
  EpbDprsRegsIntInjMutable int_inj_;
  EpbDprsRegsCaptDualEccAddrMutable capt_dual_ecc_addr_;
  EpbDprsRegsCredCtrlMutable cred_ctrl_;
  EpbDprsRegsCredCurMutable cred_cur_;
  EpbDprsRegsDprsffMaxMutable dprsff_max_;
  EpbDprsRegsDprsffEmpMutable dprsff_emp_;
  EpbDprsRegsIntFreezeMutable int_freeze_;
private:
...
#endif // __REGISTER_INCLUDES_EPB_DPRS_REGS_MUTABLE_H__
