...
#ifndef __REGISTER_INCLUDES_ETH_REGS_FORCE_PFC_FLUSH_H__
#define __REGISTER_INCLUDES_ETH_REGS_FORCE_PFC_FLUSH_H__
...
class EthRegsForcePfcFlush : public model_core::RegisterBlock<RegisterCallback> {
public:
  EthRegsForcePfcFlush(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_mac_addrmap, index_eth_regs_force_pfc_flush), 4, false, write_callback, read_callback, std::string("EthRegsForcePfcFlush")+":"+boost::lexical_cast<std::string>(index_mac_addrmap) + "," + boost::lexical_cast<std::string>(index_eth_regs_force_pfc_flush))
    {
    }
  EthRegsForcePfcFlush(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "EthRegsForcePfcFlush")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("EthRegsForcePfcFlush") + ":\n";
...
#endif // __REGISTER_INCLUDES_ETH_REGS_FORCE_PFC_FLUSH_H__
