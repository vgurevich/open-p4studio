...
#ifndef __REGISTER_INCLUDES_ETH_REGS_TXFF_CTRL_MUTABLE_H__
#define __REGISTER_INCLUDES_ETH_REGS_TXFF_CTRL_MUTABLE_H__
...
class EthRegsTxffCtrlMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  EthRegsTxffCtrlMutable(
      int chipNumber, int index_mac_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_mac_addrmap), 4, true, write_callback, read_callback, std::string("EthRegsTxffCtrlMutable")+":"+boost::lexical_cast<std::string>(index_mac_addrmap))
    {
    }
  EthRegsTxffCtrlMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "EthRegsTxffCtrlMutable")
    {
    }
public:
  ...
  void chnl_mode0(const uint8_t &v) { chnl_mode0_=v; }
  ...
  void chnl_mode1(const uint8_t &v) { chnl_mode1_=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("EthRegsTxffCtrlMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_ETH_REGS_TXFF_CTRL_MUTABLE_H__
