...
#ifndef __REGISTER_INCLUDES_GPIO_COMMON_REGS_INT_STAT_H__
#define __REGISTER_INCLUDES_GPIO_COMMON_REGS_INT_STAT_H__
...
class GpioCommonRegsIntStat : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum TofinoEnum {
    kEthgpiobr,
    kEthgpiotl
...
public:
  GpioCommonRegsIntStat(
      int chipNumber, TofinoEnum selector_tofino, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(selector_tofino), 4, false, write_callback, read_callback, std::string("GpioCommonRegsIntStat")+":"+boost::lexical_cast<std::string>(selector_tofino))
    {
    }
  GpioCommonRegsIntStat(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "GpioCommonRegsIntStat")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("GpioCommonRegsIntStat") + ":\n";
...
#endif // __REGISTER_INCLUDES_GPIO_COMMON_REGS_INT_STAT_H__
