...
#ifndef __REGISTER_INCLUDES_GPIO_COMMON_REGS_INT_STAT_MUTABLE_H__
#define __REGISTER_INCLUDES_GPIO_COMMON_REGS_INT_STAT_MUTABLE_H__
...
class GpioCommonRegsIntStatMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum TofinoEnum {
    kEthgpiobr,
    kEthgpiotl
...
public:
  GpioCommonRegsIntStatMutable(
      int chipNumber, TofinoEnum selector_tofino, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(selector_tofino), 4, true, write_callback, read_callback, std::string("GpioCommonRegsIntStatMutable")+":"+boost::lexical_cast<std::string>(selector_tofino))
    {
    }
  GpioCommonRegsIntStatMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "GpioCommonRegsIntStatMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("GpioCommonRegsIntStatMutable") + ":\n";
  ...
  static int StartOffset(
    ...
    switch (selector_tofino) {
      case kEthgpiobr:
        ...
        offset += 0x144; // to get to int_stat
        break;
      case kEthgpiotl:
...
#endif // __REGISTER_INCLUDES_GPIO_COMMON_REGS_INT_STAT_MUTABLE_H__
