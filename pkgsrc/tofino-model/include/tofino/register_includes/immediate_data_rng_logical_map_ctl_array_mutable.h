...
#ifndef __REGISTER_INCLUDES_IMMEDIATE_DATA_RNG_LOGICAL_MAP_CTL_ARRAY_MUTABLE_H__
#define __REGISTER_INCLUDES_IMMEDIATE_DATA_RNG_LOGICAL_MAP_CTL_ARRAY_MUTABLE_H__
...
class ImmediateDataRngLogicalMapCtlArrayMutable : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  ImmediateDataRngLogicalMapCtlArrayMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap), 4 * ArraySize(index_pipe_addrmap, index_mau_addrmap, -1), true, write_callback, read_callback, std::string("ImmediateDataRngLogicalMapCtlArrayMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap)),
...
public:
  uint32_t immediate_data_rng_logical_map_ctl(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    return array[a0].immediate_data_rng_logical_map_ctl();
  }
  void immediate_data_rng_logical_map_ctl(uint32_t a0,const uint32_t &v) 
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    array[a0].immediate_data_rng_logical_map_ctl(v);
  }
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("ImmediateDataRngLogicalMapCtlArrayMutable") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
private:
  std::vector<ImmediateDataRngLogicalMapCtlMutable> array;
  uint32_t size0_;
...
#endif // __REGISTER_INCLUDES_IMMEDIATE_DATA_RNG_LOGICAL_MAP_CTL_ARRAY_MUTABLE_H__
