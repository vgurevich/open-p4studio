...
#ifndef __REGISTER_INCLUDES_ING_BUF_REGS_MUTABLE_H__
#define __REGISTER_INCLUDES_ING_BUF_REGS_MUTABLE_H__
...
#include "ing_buf_regs_chan0_group_mutable.h"
#include "ing_buf_regs_chan1_group_mutable.h"
#include "ing_buf_regs_chan2_group_mutable.h"
#include "ing_buf_regs_chan3_group_mutable.h"

namespace tofino {
  namespace register_classes {

class IngBufRegsMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  IngBufRegsMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_ibp_rspec), 992, true, write_callback, read_callback, std::string("IngBufRegsMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_ibp_rspec))
    {
    }
  IngBufRegsMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "IngBufRegsMutable")
    {
    }
public:
  ...
  IngBufRegsChan0GroupMutable &chan0_group() { return chan0_group_; }





  IngBufRegsChan1GroupMutable &chan1_group() { return chan1_group_; }





  IngBufRegsChan2GroupMutable &chan2_group() { return chan2_group_; }





  IngBufRegsChan3GroupMutable &chan3_group() { return chan3_group_; }
...
private:
  ...
  IngBufRegsChan0GroupMutable chan0_group_;
  IngBufRegsChan1GroupMutable chan1_group_;
  IngBufRegsChan2GroupMutable chan2_group_;
  IngBufRegsChan3GroupMutable chan3_group_;
private:
...
#endif // __REGISTER_INCLUDES_ING_BUF_REGS_MUTABLE_H__
