...
#ifndef __REGISTER_INCLUDES_INT_STAT_MUTABLE_H__
#define __REGISTER_INCLUDES_INT_STAT_MUTABLE_H__
...
class IntStatMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  IntStatMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_ibp_rspec), 4, true, write_callback, read_callback, std::string("IntStatMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_ibp_rspec))
    {
    }
  IntStatMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "IntStatMutable")
    {
    }
public:
  ...
  void ptrff_ecc_dual_err(const uint8_t &v) { ptrff_ecc_dual_err_=v; }
  ...
  void recirc_ecc_dual_err(const uint8_t &v) { recirc_ecc_dual_err_=v; }
  ...
  void dbuf_ecc_dual_err(const uint8_t &v) { dbuf_ecc_dual_err_=v; }
  ...
  void indm_ecc_dual_err(const uint8_t &v) { indm_ecc_dual_err_=v; }
  ...
  void meta_ecc_dual_err(const uint8_t &v) { meta_ecc_dual_err_=v; }
  ...
  void bcnt_ecc_dual_err(const uint8_t &v) { bcnt_ecc_dual_err_=v; }
  ...
  void ptrff_ecc_sngl_err(const uint8_t &v) { ptrff_ecc_sngl_err_=v; }
  ...
  void recirc_ecc_sngl_err(const uint8_t &v) { recirc_ecc_sngl_err_=v; }
  ...
  void dbuf_ecc_sngl_err(const uint8_t &v) { dbuf_ecc_sngl_err_=v; }
  ...
  void indm_ecc_sngl_err(const uint8_t &v) { indm_ecc_sngl_err_=v; }
  ...
  void meta_ecc_sngl_err(const uint8_t &v) { meta_ecc_sngl_err_=v; }
  ...
  void bcnt_ecc_sngl_err(const uint8_t &v) { bcnt_ecc_sngl_err_=v; }
  ...
  void meta_ovf(const uint8_t &v) { meta_ovf_=v; }
  ...
  void rclean_ovf(const uint8_t &v) { rclean_ovf_=v; }
  ...
  void pclean_ovf(const uint8_t &v) { pclean_ovf_=v; }
  ...
  void dprs_ovf(const uint8_t &v) { dprs_ovf_=v; }
  ...
  void recirc_ovf(const uint8_t &v) { recirc_ovf_=v; }
  ...
  void linklist_err(const uint8_t &v) { linklist_err_=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("IntStatMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_INT_STAT_MUTABLE_H__
