...
#ifndef __REGISTER_INCLUDES_INTR_ENABLE0_MAU_AD_H__
#define __REGISTER_INCLUDES_INTR_ENABLE0_MAU_AD_H__
...
class IntrEnable0MauAd : public model_core::RegisterBlock<RegisterCallback> {
public:
  IntrEnable0MauAd(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap), 4, false, write_callback, read_callback, std::string("IntrEnable0MauAd")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap))
    {
    }
  IntrEnable0MauAd(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "IntrEnable0MauAd")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("IntrEnable0MauAd") + ":\n";
...
#endif // __REGISTER_INCLUDES_INTR_ENABLE0_MAU_AD_H__
