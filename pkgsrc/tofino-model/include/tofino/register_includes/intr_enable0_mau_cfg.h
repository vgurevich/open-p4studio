...
#ifndef __REGISTER_INCLUDES_INTR_ENABLE0_MAU_CFG_H__
#define __REGISTER_INCLUDES_INTR_ENABLE0_MAU_CFG_H__
...
class IntrEnable0MauCfg : public model_core::RegisterBlock<RegisterCallback> {
public:
  IntrEnable0MauCfg(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap), 4, false, write_callback, read_callback, std::string("IntrEnable0MauCfg")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap))
    {
    }
  IntrEnable0MauCfg(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "IntrEnable0MauCfg")
    {
    }
public:
  ...
  void reset(
    ...
    pbs_creq_data_sbe_ = 0x1;
    pbs_creq_data_mbe_ = 0x1;
    pbs_creq_ctrl_sbe_ = 0x1;
    pbs_creq_ctrl_mbe_ = 0x1;
    pbs_cresp_data_sbe_ = 0x1;
    pbs_cresp_data_mbe_ = 0x1;
    pbs_cresp_ctrl_sbe_ = 0x1;
    pbs_cresp_ctrl_mbe_ = 0x1;
    pbs_sreq_data_sbe_ = 0x1;
    pbs_sreq_data_mbe_ = 0x1;
    pbs_sreq_ctrl_sbe_ = 0x1;
    pbs_sreq_ctrl_mbe_ = 0x1;
    timeout_err_ = 0x7f;
    pbs_creq_hole_acc_ = 0x1;
    if (write_callback_) write_callback_();
  }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("IntrEnable0MauCfg") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x110; // to get to intr_enable0_mau_cfg
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_INTR_ENABLE0_MAU_CFG_H__
