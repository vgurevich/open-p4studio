...
#ifndef __REGISTER_INCLUDES_INTR_ENABLE0_MAU_SELECTOR_ALU_H__
#define __REGISTER_INCLUDES_INTR_ENABLE0_MAU_SELECTOR_ALU_H__
...
class IntrEnable0MauSelectorAlu : public model_core::RegisterBlock<RegisterCallback> {
public:
  IntrEnable0MauSelectorAlu(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap, index_mau_meter_alu_group_addrmap), 4, false, write_callback, read_callback, std::string("IntrEnable0MauSelectorAlu")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_meter_alu_group_addrmap))
    {
    }
  IntrEnable0MauSelectorAlu(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "IntrEnable0MauSelectorAlu")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("IntrEnable0MauSelectorAlu") + ":\n";
...
#endif // __REGISTER_INCLUDES_INTR_ENABLE0_MAU_SELECTOR_ALU_H__
