...
#ifndef __REGISTER_INCLUDES_INTR_ENABLE1_MAU_CFG_H__
#define __REGISTER_INCLUDES_INTR_ENABLE1_MAU_CFG_H__
...
class IntrEnable1MauCfg : public model_core::RegisterBlock<RegisterCallback> {
public:
  IntrEnable1MauCfg(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap), 4, false, write_callback, read_callback, std::string("IntrEnable1MauCfg")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap))
    {
    }
  IntrEnable1MauCfg(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "IntrEnable1MauCfg")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("IntrEnable1MauCfg") + ":\n";
...
#endif // __REGISTER_INCLUDES_INTR_ENABLE1_MAU_CFG_H__
