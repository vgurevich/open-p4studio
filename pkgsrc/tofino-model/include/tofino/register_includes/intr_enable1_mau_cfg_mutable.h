...
#ifndef __REGISTER_INCLUDES_INTR_ENABLE1_MAU_CFG_MUTABLE_H__
#define __REGISTER_INCLUDES_INTR_ENABLE1_MAU_CFG_MUTABLE_H__
...
class IntrEnable1MauCfgMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  IntrEnable1MauCfgMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap), 4, true, write_callback, read_callback, std::string("IntrEnable1MauCfgMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap))
    {
    }
  IntrEnable1MauCfgMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "IntrEnable1MauCfgMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("IntrEnable1MauCfgMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x114; // to get to intr_enable1_mau_cfg
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_INTR_ENABLE1_MAU_CFG_MUTABLE_H__
