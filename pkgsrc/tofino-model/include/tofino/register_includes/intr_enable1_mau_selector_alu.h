...
#ifndef __REGISTER_INCLUDES_INTR_ENABLE1_MAU_SELECTOR_ALU_H__
#define __REGISTER_INCLUDES_INTR_ENABLE1_MAU_SELECTOR_ALU_H__
...
class IntrEnable1MauSelectorAlu : public model_core::RegisterBlock<RegisterCallback> {
public:
  IntrEnable1MauSelectorAlu(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap, index_mau_meter_alu_group_addrmap), 4, false, write_callback, read_callback, std::string("IntrEnable1MauSelectorAlu")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_meter_alu_group_addrmap))
    {
    }
  IntrEnable1MauSelectorAlu(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "IntrEnable1MauSelectorAlu")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("IntrEnable1MauSelectorAlu") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x1c; // to get to intr_enable1_mau_selector_alu
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_INTR_ENABLE1_MAU_SELECTOR_ALU_H__
