...
#ifndef __REGISTER_INCLUDES_INTR_FREEZE_ENABLE_MAU_CFG_MUTABLE_H__
#define __REGISTER_INCLUDES_INTR_FREEZE_ENABLE_MAU_CFG_MUTABLE_H__
...
class IntrFreezeEnableMauCfgMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  IntrFreezeEnableMauCfgMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap), 4, true, write_callback, read_callback, std::string("IntrFreezeEnableMauCfgMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap))
    {
    }
  IntrFreezeEnableMauCfgMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "IntrFreezeEnableMauCfgMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("IntrFreezeEnableMauCfgMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x11c; // to get to intr_freeze_enable_mau_cfg
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_INTR_FREEZE_ENABLE_MAU_CFG_MUTABLE_H__
