...
#ifndef __REGISTER_INCLUDES_INTR_INJECT_MAU_CFG_MUTABLE_H__
#define __REGISTER_INCLUDES_INTR_INJECT_MAU_CFG_MUTABLE_H__
...
class IntrInjectMauCfgMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  IntrInjectMauCfgMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap), 4, true, write_callback, read_callback, std::string("IntrInjectMauCfgMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap))
    {
    }
  IntrInjectMauCfgMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "IntrInjectMauCfgMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("IntrInjectMauCfgMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x118; // to get to intr_inject_mau_cfg
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_INTR_INJECT_MAU_CFG_MUTABLE_H__
