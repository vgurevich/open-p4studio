...
#ifndef __REGISTER_INCLUDES_LFLTR_BFT_STATE_MUTABLE_H__
#define __REGISTER_INCLUDES_LFLTR_BFT_STATE_MUTABLE_H__
...
class LfltrBftStateMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
...
public:
  LfltrBftStateMutable(
      int chipNumber, DvslAddrmapEnum selector_dvsl_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(selector_dvsl_addrmap), 4, true, write_callback, read_callback, std::string("LfltrBftStateMutable")+":"+boost::lexical_cast<std::string>(selector_dvsl_addrmap))
    {
    }
  LfltrBftStateMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "LfltrBftStateMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("LfltrBftStateMutable") + ":\n";
  ...
  static int StartOffset(
    ...
    switch (selector_dvsl_addrmap) {
      case kLfltr0:
        ...
        offset += 0x74; // to get to bft_state
        break;
      case kLfltr1:
...
#endif // __REGISTER_INCLUDES_LFLTR_BFT_STATE_MUTABLE_H__
