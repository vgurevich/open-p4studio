...
#ifndef __REGISTER_INCLUDES_LFLTR_CTR48_LQ_DROPPED_STATE_H__
#define __REGISTER_INCLUDES_LFLTR_CTR48_LQ_DROPPED_STATE_H__
...
class LfltrCtr48LqDroppedState : public model_core::RegisterBlock<RegisterCallback> {
public:
...
public:
  LfltrCtr48LqDroppedState(
      int chipNumber, DvslAddrmapEnum selector_dvsl_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(selector_dvsl_addrmap), 8, false, write_callback, read_callback, std::string("LfltrCtr48LqDroppedState")+":"+boost::lexical_cast<std::string>(selector_dvsl_addrmap))
    {
    }
  LfltrCtr48LqDroppedState(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "LfltrCtr48LqDroppedState")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("LfltrCtr48LqDroppedState") + ":\n";
...
#endif // __REGISTER_INCLUDES_LFLTR_CTR48_LQ_DROPPED_STATE_H__
