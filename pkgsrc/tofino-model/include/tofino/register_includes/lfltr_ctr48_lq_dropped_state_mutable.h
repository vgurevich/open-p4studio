...
#ifndef __REGISTER_INCLUDES_LFLTR_CTR48_LQ_DROPPED_STATE_MUTABLE_H__
#define __REGISTER_INCLUDES_LFLTR_CTR48_LQ_DROPPED_STATE_MUTABLE_H__
...
class LfltrCtr48LqDroppedStateMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
...
public:
  LfltrCtr48LqDroppedStateMutable(
      int chipNumber, DvslAddrmapEnum selector_dvsl_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(selector_dvsl_addrmap), 8, true, write_callback, read_callback, std::string("LfltrCtr48LqDroppedStateMutable")+":"+boost::lexical_cast<std::string>(selector_dvsl_addrmap))
    {
    }
  LfltrCtr48LqDroppedStateMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "LfltrCtr48LqDroppedStateMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("LfltrCtr48LqDroppedStateMutable") + ":\n";
  ...
  static int StartOffset(
    ...
    switch (selector_dvsl_addrmap) {
      case kLfltr0:
        ...
        offset += 0x50; // to get to lq_dropped_state
        break;
      case kLfltr1:
...
#endif // __REGISTER_INCLUDES_LFLTR_CTR48_LQ_DROPPED_STATE_MUTABLE_H__
