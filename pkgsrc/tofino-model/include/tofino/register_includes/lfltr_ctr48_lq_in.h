...
#ifndef __REGISTER_INCLUDES_LFLTR_CTR48_LQ_IN_H__
#define __REGISTER_INCLUDES_LFLTR_CTR48_LQ_IN_H__
...
class LfltrCtr48LqIn : public model_core::RegisterBlock<RegisterCallback> {
public:
...
public:
  LfltrCtr48LqIn(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_dvsl_addrmap), 8, false, write_callback, read_callback, std::string("LfltrCtr48LqIn")+":"+boost::lexical_cast<std::string>(selector_dvsl_addrmap))
    {
    }
  LfltrCtr48LqIn(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "LfltrCtr48LqIn")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("LfltrCtr48LqIn") + ":\n";
...
#endif // __REGISTER_INCLUDES_LFLTR_CTR48_LQ_IN_H__
