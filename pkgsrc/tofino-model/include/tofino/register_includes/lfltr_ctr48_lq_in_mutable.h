...
#ifndef __REGISTER_INCLUDES_LFLTR_CTR48_LQ_IN_MUTABLE_H__
#define __REGISTER_INCLUDES_LFLTR_CTR48_LQ_IN_MUTABLE_H__
...
class LfltrCtr48LqInMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
...
public:
  LfltrCtr48LqInMutable(
      int chipNumber, DvslAddrmapEnum selector_dvsl_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(selector_dvsl_addrmap), 8, true, write_callback, read_callback, std::string("LfltrCtr48LqInMutable")+":"+boost::lexical_cast<std::string>(selector_dvsl_addrmap))
    {
    }
  LfltrCtr48LqInMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "LfltrCtr48LqInMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("LfltrCtr48LqInMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_LFLTR_CTR48_LQ_IN_MUTABLE_H__
