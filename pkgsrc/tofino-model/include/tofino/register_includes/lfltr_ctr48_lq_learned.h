...
#ifndef __REGISTER_INCLUDES_LFLTR_CTR48_LQ_LEARNED_H__
#define __REGISTER_INCLUDES_LFLTR_CTR48_LQ_LEARNED_H__
...
class LfltrCtr48LqLearned : public model_core::RegisterBlock<RegisterCallback> {
public:
...
public:
  LfltrCtr48LqLearned(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_dvsl_addrmap), 8, false, write_callback, read_callback, std::string("LfltrCtr48LqLearned")+":"+boost::lexical_cast<std::string>(selector_dvsl_addrmap))
    {
    }
  LfltrCtr48LqLearned(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "LfltrCtr48LqLearned")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("LfltrCtr48LqLearned") + ":\n";
...
#endif // __REGISTER_INCLUDES_LFLTR_CTR48_LQ_LEARNED_H__
