...
#include "lfltr_int_en0_mutable.h"
#include "lfltr_int_en1_mutable.h"
#include "lfltr_int_inj_mutable.h"
#include "lfltr_int_stat_mutable.h"
...
public:
  LfltrCtrlRspecMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_dvsl_addrmap), 32768, true, write_callback, read_callback, std::string("LfltrCtrlRspecMutable")+":"+boost::lexical_cast<std::string>(selector_dvsl_addrmap))
    {
    }
  LfltrCtrlRspecMutable(
...
public:
  ...
  LfltrIntStatMutable &int_stat() { return int_stat_; }





  LfltrIntEn0Mutable &int_en0() { return int_en0_; }





  LfltrIntEn1Mutable &int_en1() { return int_en1_; }
  ...
  LfltrIntInjMutable &int_inj() { return int_inj_; }
...
private:
  ...
  LfltrIntStatMutable int_stat_;
  LfltrIntEn0Mutable int_en0_;
  LfltrIntEn1Mutable int_en1_;
  LfltrFreezeEnMutable freeze_en_;
  LfltrIntInjMutable int_inj_;
