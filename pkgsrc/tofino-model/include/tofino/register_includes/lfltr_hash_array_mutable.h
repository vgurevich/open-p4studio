...
public:
  LfltrHashArrayMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_dvsl_addrmap, index_lfltr_hash_rspec, index_lfltr_hash_array), 48, true, write_callback, read_callback, std::string("LfltrHashArrayMutable")+":"+boost::lexical_cast<std::string>(selector_dvsl_addrmap) + "," + boost::lexical_cast<std::string>(index_lfltr_hash_rspec) + "," + boost::lexical_cast<std::string>(index_lfltr_hash_array))
    {
    }
  LfltrHashArrayMutable(
