...
#ifndef __REGISTER_INCLUDES_LFLTR_INT_STAT_H__
#define __REGISTER_INCLUDES_LFLTR_INT_STAT_H__
...
class LfltrIntStat : public model_core::RegisterBlock<RegisterCallback> {
public:
...
public:
  LfltrIntStat(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_dvsl_addrmap), 4, false, write_callback, read_callback, std::string("LfltrIntStat")+":"+boost::lexical_cast<std::string>(selector_dvsl_addrmap))
    {
    }
  LfltrIntStat(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "LfltrIntStat")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("LfltrIntStat") + ":\n";
...
#endif // __REGISTER_INCLUDES_LFLTR_INT_STAT_H__
