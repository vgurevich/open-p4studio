...
#ifndef __REGISTER_INCLUDES_LFLTR_RSPEC_H__
#define __REGISTER_INCLUDES_LFLTR_RSPEC_H__
...
#include "lfltr_ctrl_rspec.h"
#include "lfltr_hash_rspec.h"

namespace tofino {
  namespace register_classes {

class LfltrRspec : public model_core::RegisterBlock<RegisterCallback> {
public:
...
public:
  LfltrRspec(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_dvsl_addrmap), 262144, false, write_callback, read_callback, std::string("LfltrRspec")+":"+boost::lexical_cast<std::string>(selector_dvsl_addrmap))
    {
    }
  LfltrRspec(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "LfltrRspec")
    {
    }
public:
  ...
  LfltrHashRspec &hash(int j0) { return hash_[j0]; }





  LfltrCtrlRspec &ctrl() { return ctrl_; }
...
private:
  std::array< LfltrHashRspec, 4 > hash_;
  LfltrCtrlRspec ctrl_;
private:
...
#endif // __REGISTER_INCLUDES_LFLTR_RSPEC_H__
