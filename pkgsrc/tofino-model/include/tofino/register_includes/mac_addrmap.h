...
#ifndef __REGISTER_INCLUDES_MAC_ADDRMAP_H__
#define __REGISTER_INCLUDES_MAC_ADDRMAP_H__
...
class MacAddrmap : public model_core::RegisterBlock<RegisterCallback> {
public:
  MacAddrmap(
      int chipNumber, int index_mac_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_mac_addrmap), 130504, false, write_callback, read_callback, std::string("MacAddrmap")+":"+boost::lexical_cast<std::string>(index_mac_addrmap))
    {
    }
  MacAddrmap(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "MacAddrmap")
    {
    }
public:
  ...
  ComiraRegs &comira_regs() { return comira_regs_; }





  EthRegs &eth_regs() { return eth_regs_; }
...
#endif // __REGISTER_INCLUDES_MAC_ADDRMAP_H__
