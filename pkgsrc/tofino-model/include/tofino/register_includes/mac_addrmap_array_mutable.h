...
#ifndef __REGISTER_INCLUDES_MAC_ADDRMAP_ARRAY_MUTABLE_H__
#define __REGISTER_INCLUDES_MAC_ADDRMAP_ARRAY_MUTABLE_H__
...
class MacAddrmapArrayMutable : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  MacAddrmapArrayMutable(
      int chipNumber, RegisterArrayCallback& write_callback = 0, RegisterArrayCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 131072 * ArraySize(-1), true, write_callback, read_callback, std::string("MacAddrmapArrayMutable")),
...
public:
  ...
  ComiraRegsMutable &comira_regs(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    return array[a0].comira_regs();
  }
  ...
  EthRegsMutable &eth_regs(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    return array[a0].eth_regs();
  }
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("MacAddrmapArrayMutable") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
private:
  std::vector<MacAddrmapMutable> array;
  uint32_t size0_;
...
#endif // __REGISTER_INCLUDES_MAC_ADDRMAP_ARRAY_MUTABLE_H__
