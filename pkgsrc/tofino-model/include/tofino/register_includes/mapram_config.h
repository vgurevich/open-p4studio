...
#ifndef __REGISTER_INCLUDES_MAPRAM_CONFIG_H__
#define __REGISTER_INCLUDES_MAPRAM_CONFIG_H__
...
class MapramConfig : public model_core::RegisterBlock<RegisterCallback> {
public:
  MapramConfig(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap, index_mau_map_and_alu_row_addrmap, index_mapram_config), 4, false, write_callback, read_callback, std::string("MapramConfig")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_map_and_alu_row_addrmap) + "," + boost::lexical_cast<std::string>(index_mapram_config))
    {
    }
  MapramConfig(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "MapramConfig")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("MapramConfig") + ":\n";
...
#endif // __REGISTER_INCLUDES_MAPRAM_CONFIG_H__
