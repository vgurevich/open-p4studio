...
#ifndef __REGISTER_INCLUDES_MAU_ACTIONDATA_ADR_PER_ENTRY_EN_MUX_CTL_ARRAY2_H__
#define __REGISTER_INCLUDES_MAU_ACTIONDATA_ADR_PER_ENTRY_EN_MUX_CTL_ARRAY2_H__
...
class MauActiondataAdrPerEntryEnMuxCtlArray2 : public model_core::RegisterBlock<RegisterArrayCallback2> {
public:
  MauActiondataAdrPerEntryEnMuxCtlArray2(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap), 4 * ArraySize(index_pipe_addrmap, index_mau_addrmap, -1), false, write_callback, read_callback, std::string("MauActiondataAdrPerEntryEnMuxCtlArray2")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap)),
...
public:
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("MauActiondataAdrPerEntryEnMuxCtlArray2") + "["+boost::lexical_cast<std::string>(a1)+"]"+"["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
private:
  std::vector<MauActiondataAdrPerEntryEnMuxCtl> array;
  uint32_t size0_;
...
#endif // __REGISTER_INCLUDES_MAU_ACTIONDATA_ADR_PER_ENTRY_EN_MUX_CTL_ARRAY2_H__
