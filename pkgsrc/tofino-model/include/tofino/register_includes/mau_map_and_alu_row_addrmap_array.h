...
#ifndef __REGISTER_INCLUDES_MAU_MAP_AND_ALU_ROW_ADDRMAP_ARRAY_H__
#define __REGISTER_INCLUDES_MAU_MAP_AND_ALU_ROW_ADDRMAP_ARRAY_H__
...
class MauMapAndAluRowAddrmapArray : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  MauMapAndAluRowAddrmapArray(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap), 1024 * ArraySize(index_pipe_addrmap, index_mau_addrmap, -1), false, write_callback, read_callback, std::string("MauMapAndAluRowAddrmapArray")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap)),
...
public:
  ...
  MauReadAdrVhSwitchboxAddrmap &vh_xbars(uint32_t a0)
  {
  ...
  MauDpramArrayRowAddrmap &i2portctl(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
  ...
  MauAdrmuxRowAddrmap &adrmux(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("MauMapAndAluRowAddrmapArray") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
private:
  std::vector<MauMapAndAluRowAddrmap> array;
  uint32_t size0_;
...
#endif // __REGISTER_INCLUDES_MAU_MAP_AND_ALU_ROW_ADDRMAP_ARRAY_H__
