...
#include "mbus_baresync_ts_inc_value_mutable.h"
...
#include "mbus_mac_creq_credit_mutable.h"
#include "mbus_mac_dma_statemachine_mutable.h"
#include "mbus_mac_tx_dr_rd_err_log_mutable.h"
...
public:
  MbusRspecMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(), 200, true, write_callback, read_callback, std::string("MbusRspecMutable"))
    {
    }
  MbusRspecMutable(
...
public:
  ...
  MbusBaresyncTsIncValueMutable &baresync_ts_inc_value() { return baresync_ts_inc_value_; }
  ...
  MbusIntStatMutable &int_stat() { return int_stat_; }





  MbusIntEn_0Mutable &int_en_0() { return int_en_0_; }





  MbusIntEn_1Mutable &int_en_1() { return int_en_1_; }
  ...
  MbusIntInjMutable &int_inj() { return int_inj_; }





  MbusMacTxDrRdErrLogMutable &mac_tx_dr_rd_err_log() { return mac_tx_dr_rd_err_log_; }
  ...
  MbusHostCreqCreditMutable &host_creq_credit(int j0) { return host_creq_credit_[j0]; }
  ...
  MbusMacCreqCreditMutable &mac_creq_credit(int j0) { return mac_creq_credit_[j0]; }
  ...
  MbusMacDmaStatemachineMutable &mac_dma_statemachine() { return mac_dma_statemachine_; }
...
private:
  ...
  MbusBaresyncTsIncValueMutable baresync_ts_inc_value_;
  ...
  MbusIntStatMutable int_stat_;
  MbusIntEn_0Mutable int_en_0_;
  MbusIntEn_1Mutable int_en_1_;
  MbusFreezeEnMutable freeze_en_;
  MbusIntInjMutable int_inj_;
  MbusMacTxDrRdErrLogMutable mac_tx_dr_rd_err_log_;
  ...
  std::array< MbusHostCreqCreditMutable, 4 > host_creq_credit_;
  std::array< MbusMacCreqCreditMutable, 4 > mac_creq_credit_;
  MbusHostSlvCreditMutable host_slave_credit_;
  MbusMacDmaStatemachineMutable mac_dma_statemachine_;
private:
