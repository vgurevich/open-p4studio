...
#ifndef __REGISTER_INCLUDES_MIR_BUF_DESC_SESSION_CTRL_MUTABLE_H__
#define __REGISTER_INCLUDES_MIR_BUF_DESC_SESSION_CTRL_MUTABLE_H__
...
class MirBufDescSessionCtrlMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  MirBufDescSessionCtrlMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mir_buf_desc_norm_desc_grp), 4, true, write_callback, read_callback, std::string("MirBufDescSessionCtrlMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mir_buf_desc_norm_desc_grp))
    {
    }
  MirBufDescSessionCtrlMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "MirBufDescSessionCtrlMutable")
    {
    }
public:
  ...
  void norm_ingr_ena(const uint8_t &v) { norm_ingr_ena_=v; }
  ...
  void norm_egr_ena(const uint8_t &v) { norm_egr_ena_=v; }
  ...
  void norm_max_entries(const uint8_t &v) { norm_max_entries_=v; }
  ...
  void norm_trunc_size(const uint16_t &v) { norm_trunc_size_=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("MirBufDescSessionCtrlMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_MIR_BUF_DESC_SESSION_CTRL_MUTABLE_H__
