...
#ifndef __REGISTER_INCLUDES_MIR_BUF_REGS_COAL_PKTDROP_ARRAY_MUTABLE_H__
#define __REGISTER_INCLUDES_MIR_BUF_REGS_COAL_PKTDROP_ARRAY_MUTABLE_H__
...
class MirBufRegsCoalPktdropArrayMutable : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  MirBufRegsCoalPktdropArrayMutable(
      int chipNumber, int index_pipe_addrmap, RegisterArrayCallback& write_callback = 0, RegisterArrayCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 8 * ArraySize(index_pipe_addrmap, -1), true, write_callback, read_callback, std::string("MirBufRegsCoalPktdropArrayMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap)),
...
public:
  ...
  uint64_t coal_drop_pkt(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    return array[a0].coal_drop_pkt();
  }
  void coal_drop_pkt(uint32_t a0,const uint64_t &v) 
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    array[a0].coal_drop_pkt(v);
  }
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("MirBufRegsCoalPktdropArrayMutable") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
private:
  std::vector<MirBufRegsCoalPktdropMutable> array;
  uint32_t size0_;
...
#endif // __REGISTER_INCLUDES_MIR_BUF_REGS_COAL_PKTDROP_ARRAY_MUTABLE_H__
