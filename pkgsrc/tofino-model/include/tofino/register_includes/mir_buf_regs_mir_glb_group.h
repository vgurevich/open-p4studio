...
public:
  MirBufRegsMirGlbGroup(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 332, false, write_callback, read_callback, std::string("MirBufRegsMirGlbGroup")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  MirBufRegsMirGlbGroup(
