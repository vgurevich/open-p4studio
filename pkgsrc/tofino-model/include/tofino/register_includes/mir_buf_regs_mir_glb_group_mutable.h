...
public:
  MirBufRegsMirGlbGroupMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 332, true, write_callback, read_callback, std::string("MirBufRegsMirGlbGroupMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  MirBufRegsMirGlbGroupMutable(
