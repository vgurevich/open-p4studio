...
#include "misc_regs_int_en.h"
#include "misc_regs_int_inj.h"
#include "misc_regs_int_pri.h"
#include "misc_regs_int_stat.h"
#include "misc_regs_linkdown_ctrl.h"
#include "misc_regs_mac_pll_ctrl0.h"
#include "misc_regs_mac_pll_ctrl1.h"
#include "misc_regs_pcie_int_gen1_ctrl.h"
#include "misc_regs_pcie_int_gen1_enable.h"
#include "misc_regs_pcie_int_gen2_ctrl.h"
#include "misc_regs_pcie_int_gen2_enable.h"
#include "misc_regs_pcie_int_gen3_ctrl.h"
#include "misc_regs_pcie_int_gen3_enable.h"
#include "misc_regs_pcie_int_pwrup_ctrl.h"
#include "misc_regs_pcie_int_pwrup_enable.h"
#include "misc_regs_pcie_pll_ctrl0.h"
#include "misc_regs_pcie_pll_ctrl1.h"
#include "misc_regs_pcie_reset_trig.h"
#include "misc_regs_pcie_rxeq_ctrl.h"
#include "misc_regs_pciectl_gen3_default.h"
#include "misc_regs_pciephy_side_cntl.h"
#include "misc_regs_pciephy_status0.h"
#include "misc_regs_pciephy_status1.h"
#include "misc_regs_refclk_pad_ctrl.h"
#include "misc_regs_sbm_ind_ctrl.h"
#include "misc_regs_sbm_ind_rdata.h"
#include "misc_regs_sbm_ind_rslt.h"
#include "misc_regs_sbm_ind_wdata.h"
#include "misc_regs_sbm_timeout_ena.h"
...
public:
  MiscRegs(
    ...
    : RegisterBlock(chipNumber, StartOffset(), 316, false, write_callback, read_callback, std::string("MiscRegs"))
    {
    }
  MiscRegs(
...
public:
  ...
  MiscRegsRefclkPadCtrl &refclk_pad_ctrl() { return refclk_pad_ctrl_; }





  MiscRegsPciePllCtrl0 &pcie_pll_ctrl0() { return pcie_pll_ctrl0_; }





  MiscRegsPciePllCtrl1 &pcie_pll_ctrl1() { return pcie_pll_ctrl1_; }
  ...
  MiscRegsMacPllCtrl0 &mac_pll_ctrl0() { return mac_pll_ctrl0_; }





  MiscRegsMacPllCtrl1 &mac_pll_ctrl1() { return mac_pll_ctrl1_; }
  ...
  MiscRegsPcieIntPwrupEnable &pcie_int_pwrup_enable() { return pcie_int_pwrup_enable_; }
  ...
  MiscRegsPcieIntGen1Enable &pcie_int_gen1_enable() { return pcie_int_gen1_enable_; }
  ...
  MiscRegsPcieIntGen2Enable &pcie_int_gen2_enable() { return pcie_int_gen2_enable_; }
  ...
  MiscRegsPcieIntGen3Enable &pcie_int_gen3_enable() { return pcie_int_gen3_enable_; }
  ...
  MiscRegsPcieIntPwrupCtrl &pcie_int_pwrup_ctrl(int j0) { return pcie_int_pwrup_ctrl_[j0]; }
  ...
  MiscRegsPcieIntGen1Ctrl &pcie_int_gen1_ctrl(int j0) { return pcie_int_gen1_ctrl_[j0]; }
  ...
  MiscRegsPcieIntGen2Ctrl &pcie_int_gen2_ctrl(int j0) { return pcie_int_gen2_ctrl_[j0]; }
  ...
  MiscRegsPcieIntGen3Ctrl &pcie_int_gen3_ctrl(int j0) { return pcie_int_gen3_ctrl_[j0]; }
  ...
  MiscRegsPciephySideCntl &pciephy_side_cntl(int j0) { return pciephy_side_cntl_[j0]; }
  ...
  MiscRegsPciephyStatus0 &pciephy_status0(int j0) { return pciephy_status0_[j0]; }
  ...
  MiscRegsPciephyStatus1 &pciephy_status1(int j0) { return pciephy_status1_[j0]; }





  MiscRegsIntStat &int_stat() { return int_stat_; }





  MiscRegsIntEn &int_en() { return int_en_; }





  MiscRegsIntPri &int_pri() { return int_pri_; }
  ...
  MiscRegsIntInj &int_inj() { return int_inj_; }
  ...
  MiscRegsSbmIndWdata &sbm_ind_wdata() { return sbm_ind_wdata_; }
  ...
  MiscRegsSbmIndCtrl &sbm_ind_ctrl() { return sbm_ind_ctrl_; }





  MiscRegsSbmIndRdata &sbm_ind_rdata() { return sbm_ind_rdata_; }





  MiscRegsSbmIndRslt &sbm_ind_rslt() { return sbm_ind_rslt_; }





  MiscRegsSbmTimeoutEna &sbm_timeout_ena() { return sbm_timeout_ena_; }
  ...
  MiscRegsLinkdownCtrl &linkdown_ctrl() { return linkdown_ctrl_; }





  MiscRegsPcieResetTrig &pcie_reset_trig() { return pcie_reset_trig_; }
  ...
  MiscRegsDbgRst &dbg_rst0() { return dbg_rst0_; }





  MiscRegsDbgRst &dbg_rst1() { return dbg_rst1_; }
...
private:
  ...
  MiscRegsRefclkPadCtrl refclk_pad_ctrl_;
  MiscRegsPciePllCtrl0 pcie_pll_ctrl0_;
  MiscRegsPciePllCtrl1 pcie_pll_ctrl1_;
  MiscRegsCorePllCtrl0 core_pll_ctrl0_;
  MiscRegsCorePllCtrl1 core_pll_ctrl1_;
  MiscRegsMacPllCtrl0 mac_pll_ctrl0_;
  MiscRegsMacPllCtrl1 mac_pll_ctrl1_;
  MiscRegsPcieIntPwrupEnable pcie_int_pwrup_enable_;
  MiscRegsPcieIntGen1Enable pcie_int_gen1_enable_;
  MiscRegsPcieIntGen2Enable pcie_int_gen2_enable_;
  MiscRegsPcieIntGen3Enable pcie_int_gen3_enable_;
  std::array< MiscRegsPcieIntPwrupCtrl, 4 > pcie_int_pwrup_ctrl_;
  std::array< MiscRegsPcieIntGen1Ctrl, 4 > pcie_int_gen1_ctrl_;
  std::array< MiscRegsPcieIntGen2Ctrl, 4 > pcie_int_gen2_ctrl_;
  std::array< MiscRegsPcieIntGen3Ctrl, 4 > pcie_int_gen3_ctrl_;
  std::array< MiscRegsPciephySideCntl, 4 > pciephy_side_cntl_;
  std::array< MiscRegsPciephyStatus0, 4 > pciephy_status0_;
  std::array< MiscRegsPciephyStatus1, 4 > pciephy_status1_;
  MiscRegsIntStat int_stat_;
  MiscRegsIntEn int_en_;
  MiscRegsIntPri int_pri_;
  MiscRegsIntInj int_inj_;
  MiscRegsGpioCtrl gpio_ctrl_;
  MiscRegsSbmIndWdata sbm_ind_wdata_;
  MiscRegsSbmIndCtrl sbm_ind_ctrl_;
  MiscRegsSbmIndRdata sbm_ind_rdata_;
  MiscRegsSbmIndRslt sbm_ind_rslt_;
  MiscRegsSbmTimeoutEna sbm_timeout_ena_;
  ...
  MiscRegsLinkdownCtrl linkdown_ctrl_;
  MiscRegsPcieResetTrig pcie_reset_trig_;
  std::array< MiscRegsFuncFuse, 8 > func_fuse_;
  MiscRegsFuseStatus fuse_status_;
  MiscRegsDbgRst dbg_rst0_;
  MiscRegsDbgRst dbg_rst1_;
