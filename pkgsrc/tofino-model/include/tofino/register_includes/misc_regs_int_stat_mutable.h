...
#ifndef __REGISTER_INCLUDES_MISC_REGS_INT_STAT_MUTABLE_H__
#define __REGISTER_INCLUDES_MISC_REGS_INT_STAT_MUTABLE_H__
...
class MiscRegsIntStatMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  MiscRegsIntStatMutable(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 4, true, write_callback, read_callback, std::string("MiscRegsIntStatMutable"))
    {
    }
  MiscRegsIntStatMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "MiscRegsIntStatMutable")
    {
    }
public:
  ...
  void pciephy_lane0_dual_err(const uint8_t &v) { pciephy_lane0_dual_err_=v; }
  ...
  void pciephy_lane1_dual_err(const uint8_t &v) { pciephy_lane1_dual_err_=v; }
  ...
  void pciephy_lane2_dual_err(const uint8_t &v) { pciephy_lane2_dual_err_=v; }
  ...
  void pciephy_lane3_dual_err(const uint8_t &v) { pciephy_lane3_dual_err_=v; }
  ...
  void pciephy_lane0_sngl_err(const uint8_t &v) { pciephy_lane0_sngl_err_=v; }
  ...
  void pciephy_lane1_sngl_err(const uint8_t &v) { pciephy_lane1_sngl_err_=v; }
  ...
  void pciephy_lane2_sngl_err(const uint8_t &v) { pciephy_lane2_sngl_err_=v; }
  ...
  void pciephy_lane3_sngl_err(const uint8_t &v) { pciephy_lane3_sngl_err_=v; }
  ...
  void pciepll_lol_err(const uint8_t &v) { pciepll_lol_err_=v; }
  ...
  void corepll_lol_err(const uint8_t &v) { corepll_lol_err_=v; }
  ...
  void macpll_lol_err(const uint8_t &v) { macpll_lol_err_=v; }
  ...
  void gts_pll_lol_err(const uint8_t &v) { gts_pll_lol_err_=v; }
  ...
  void sbm0_dbe_err(const uint8_t &v) { sbm0_dbe_err_=v; }
  ...
  void sbm1_dbe_err(const uint8_t &v) { sbm1_dbe_err_=v; }
  ...
  void sbm0_sbe_err(const uint8_t &v) { sbm0_sbe_err_=v; }
  ...
  void sbm1_sbe_err(const uint8_t &v) { sbm1_sbe_err_=v; }
  ...
  void sbm0_wr_err(const uint8_t &v) { sbm0_wr_err_=v; }
  ...
  void sbm1_wr_err(const uint8_t &v) { sbm1_wr_err_=v; }
  ...
  void sbm0_rd_err(const uint8_t &v) { sbm0_rd_err_=v; }
  ...
  void sbm1_rd_err(const uint8_t &v) { sbm1_rd_err_=v; }
  ...
  void sbm0_timeout(const uint8_t &v) { sbm0_timeout_=v; }
  ...
  void sbm1_timeout(const uint8_t &v) { sbm1_timeout_=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("MiscRegsIntStatMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_MISC_REGS_INT_STAT_MUTABLE_H__
