...
#ifndef __REGISTER_INCLUDES_MISC_REGS_PCIEPHY_SIDE_CNTL_H__
#define __REGISTER_INCLUDES_MISC_REGS_PCIEPHY_SIDE_CNTL_H__
...
class MiscRegsPciephySideCntl : public model_core::RegisterBlock<RegisterCallback> {
public:
  MiscRegsPciephySideCntl(
      int chipNumber, int index_misc_regs_pciephy_side_cntl, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_misc_regs_pciephy_side_cntl), 4, false, write_callback, read_callback, std::string("MiscRegsPciephySideCntl")+":"+boost::lexical_cast<std::string>(index_misc_regs_pciephy_side_cntl))
    {
    }
  MiscRegsPciephySideCntl(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "MiscRegsPciephySideCntl")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("MiscRegsPciephySideCntl") + ":\n";
...
#endif // __REGISTER_INCLUDES_MISC_REGS_PCIEPHY_SIDE_CNTL_H__
