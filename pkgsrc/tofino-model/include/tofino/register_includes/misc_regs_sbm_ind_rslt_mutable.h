...
#ifndef __REGISTER_INCLUDES_MISC_REGS_SBM_IND_RSLT_MUTABLE_H__
#define __REGISTER_INCLUDES_MISC_REGS_SBM_IND_RSLT_MUTABLE_H__
...
class MiscRegsSbmIndRsltMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  MiscRegsSbmIndRsltMutable(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 4, true, write_callback, read_callback, std::string("MiscRegsSbmIndRsltMutable"))
    {
    }
  MiscRegsSbmIndRsltMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "MiscRegsSbmIndRsltMutable")
    {
    }
public:
  ...
  void sbm_ind_rslt(const uint8_t &v) { sbm_ind_rslt_=v; }
  ...
  void sbm_ind_timeout(const uint8_t &v) { sbm_ind_timeout_=v; }
  ...
  void sbm_ind_busy(const uint8_t &v) { sbm_ind_busy_=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("MiscRegsSbmIndRsltMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_MISC_REGS_SBM_IND_RSLT_MUTABLE_H__
