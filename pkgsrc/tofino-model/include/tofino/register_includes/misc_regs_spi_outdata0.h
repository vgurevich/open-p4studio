...
#ifndef __REGISTER_INCLUDES_MISC_REGS_SPI_OUTDATA0_H__
#define __REGISTER_INCLUDES_MISC_REGS_SPI_OUTDATA0_H__
...
class MiscRegsSpiOutdata0 : public model_core::RegisterBlock<RegisterCallback> {
public:
  MiscRegsSpiOutdata0(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 4, false, write_callback, read_callback, std::string("MiscRegsSpiOutdata0"))
    {
    }
  MiscRegsSpiOutdata0(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "MiscRegsSpiOutdata0")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("MiscRegsSpiOutdata0") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0xc8; // to get to spi_outdata0
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_MISC_REGS_SPI_OUTDATA0_H__
