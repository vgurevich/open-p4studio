...
#ifndef __REGISTER_INCLUDES_MOVEREG_AD_DIRECT_ARRAY_MUTABLE_H__
#define __REGISTER_INCLUDES_MOVEREG_AD_DIRECT_ARRAY_MUTABLE_H__
...
class MoveregAdDirectArrayMutable : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  MoveregAdDirectArrayMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap), 4 * ArraySize(index_pipe_addrmap, index_mau_addrmap, -1), true, write_callback, read_callback, std::string("MoveregAdDirectArrayMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap)),
...
public:
  uint16_t movereg_ad_direct(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    return array[a0].movereg_ad_direct();
  }
  void movereg_ad_direct(uint32_t a0,const uint16_t &v) 
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    array[a0].movereg_ad_direct(v);
  }
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("MoveregAdDirectArrayMutable") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
private:
  std::vector<MoveregAdDirectMutable> array;
  uint32_t size0_;
...
#endif // __REGISTER_INCLUDES_MOVEREG_AD_DIRECT_ARRAY_MUTABLE_H__
