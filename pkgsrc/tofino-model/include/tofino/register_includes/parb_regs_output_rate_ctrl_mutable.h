...
#ifndef __REGISTER_INCLUDES_PARB_REGS_OUTPUT_RATE_CTRL_MUTABLE_H__
#define __REGISTER_INCLUDES_PARB_REGS_OUTPUT_RATE_CTRL_MUTABLE_H__
...
class ParbRegsOutputRateCtrlMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
...
public:
  ParbRegsOutputRateCtrlMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, selector_parb_regs_parb_group), 4, true, write_callback, read_callback, std::string("ParbRegsOutputRateCtrlMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(selector_parb_regs_parb_group))
    {
    }
  ParbRegsOutputRateCtrlMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "ParbRegsOutputRateCtrlMutable")
    {
    }
public:
  ...
  void ratectrl_inc(const uint8_t &v) { ratectrl_inc_=v; }
  ...
  void ratectrl_dec(const uint8_t &v) { ratectrl_dec_=v; }
  ...
  void ratectrl_max(const uint16_t &v) { ratectrl_max_=v; }
  ...
  void ratectrl_ena(const uint8_t &v) { ratectrl_ena_=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("ParbRegsOutputRateCtrlMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_PARB_REGS_OUTPUT_RATE_CTRL_MUTABLE_H__
