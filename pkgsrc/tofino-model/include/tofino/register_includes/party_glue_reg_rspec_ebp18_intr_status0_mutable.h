...
#ifndef __REGISTER_INCLUDES_PARTY_GLUE_REG_RSPEC_EBP18_INTR_STATUS0_MUTABLE_H__
#define __REGISTER_INCLUDES_PARTY_GLUE_REG_RSPEC_EBP18_INTR_STATUS0_MUTABLE_H__
...
class PartyGlueRegRspecEbp18IntrStatus0Mutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  PartyGlueRegRspecEbp18IntrStatus0Mutable(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 4, true, write_callback, read_callback, std::string("PartyGlueRegRspecEbp18IntrStatus0Mutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  PartyGlueRegRspecEbp18IntrStatus0Mutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "PartyGlueRegRspecEbp18IntrStatus0Mutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PartyGlueRegRspecEbp18IntrStatus0Mutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_PARTY_GLUE_REG_RSPEC_EBP18_INTR_STATUS0_MUTABLE_H__
