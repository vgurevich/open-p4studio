...
#ifndef __REGISTER_INCLUDES_PARTY_GLUE_REG_RSPEC_EGR18_INTR_STATUS0_MUTABLE_H__
#define __REGISTER_INCLUDES_PARTY_GLUE_REG_RSPEC_EGR18_INTR_STATUS0_MUTABLE_H__
...
class PartyGlueRegRspecEgr18IntrStatus0Mutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  PartyGlueRegRspecEgr18IntrStatus0Mutable(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 4, true, write_callback, read_callback, std::string("PartyGlueRegRspecEgr18IntrStatus0Mutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  PartyGlueRegRspecEgr18IntrStatus0Mutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "PartyGlueRegRspecEgr18IntrStatus0Mutable")
    {
    }
public:
  ...
  void egr0(const uint8_t &v) { egr0_=v; }
  ...
  void egr1(const uint8_t &v) { egr1_=v; }
  ...
  void egr2(const uint8_t &v) { egr2_=v; }
  ...
  void egr3(const uint8_t &v) { egr3_=v; }
  ...
  void egr4(const uint8_t &v) { egr4_=v; }
  ...
  void egr5(const uint8_t &v) { egr5_=v; }
  ...
  void egr6(const uint8_t &v) { egr6_=v; }
  ...
  void egr7(const uint8_t &v) { egr7_=v; }
  ...
  void egr8(const uint8_t &v) { egr8_=v; }
  ...
  void egr9(const uint8_t &v) { egr9_=v; }
  ...
  void egr10(const uint8_t &v) { egr10_=v; }
  ...
  void egr11(const uint8_t &v) { egr11_=v; }
  ...
  void egr12(const uint8_t &v) { egr12_=v; }
  ...
  void egr13(const uint8_t &v) { egr13_=v; }
  ...
  void egr14(const uint8_t &v) { egr14_=v; }
  ...
  void egr15(const uint8_t &v) { egr15_=v; }
  ...
  void egr16(const uint8_t &v) { egr16_=v; }
  ...
  void egr17(const uint8_t &v) { egr17_=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PartyGlueRegRspecEgr18IntrStatus0Mutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x20; // to get to egr18_intr_status0
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_PARTY_GLUE_REG_RSPEC_EGR18_INTR_STATUS0_MUTABLE_H__
