...
#ifndef __REGISTER_INCLUDES_PARTY_GLUE_REG_RSPEC_IBP18_INTR_STATUS1_MUTABLE_H__
#define __REGISTER_INCLUDES_PARTY_GLUE_REG_RSPEC_IBP18_INTR_STATUS1_MUTABLE_H__
...
class PartyGlueRegRspecIbp18IntrStatus1Mutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  PartyGlueRegRspecIbp18IntrStatus1Mutable(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 4, true, write_callback, read_callback, std::string("PartyGlueRegRspecIbp18IntrStatus1Mutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  PartyGlueRegRspecIbp18IntrStatus1Mutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "PartyGlueRegRspecIbp18IntrStatus1Mutable")
    {
    }
public:
  ...
  void ibp0(const uint8_t &v) { ibp0_=v; }
  ...
  void ibp1(const uint8_t &v) { ibp1_=v; }
  ...
  void ibp2(const uint8_t &v) { ibp2_=v; }
  ...
  void ibp3(const uint8_t &v) { ibp3_=v; }
  ...
  void ibp4(const uint8_t &v) { ibp4_=v; }
  ...
  void ibp5(const uint8_t &v) { ibp5_=v; }
  ...
  void ibp6(const uint8_t &v) { ibp6_=v; }
  ...
  void ibp7(const uint8_t &v) { ibp7_=v; }
  ...
  void ibp8(const uint8_t &v) { ibp8_=v; }
  ...
  void ibp9(const uint8_t &v) { ibp9_=v; }
  ...
  void ibp10(const uint8_t &v) { ibp10_=v; }
  ...
  void ibp11(const uint8_t &v) { ibp11_=v; }
  ...
  void ibp12(const uint8_t &v) { ibp12_=v; }
  ...
  void ibp13(const uint8_t &v) { ibp13_=v; }
  ...
  void ibp14(const uint8_t &v) { ibp14_=v; }
  ...
  void ibp15(const uint8_t &v) { ibp15_=v; }
  ...
  void ibp16(const uint8_t &v) { ibp16_=v; }
  ...
  void ibp17(const uint8_t &v) { ibp17_=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PartyGlueRegRspecIbp18IntrStatus1Mutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x14; // to get to ibp18_intr_status1
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_PARTY_GLUE_REG_RSPEC_IBP18_INTR_STATUS1_MUTABLE_H__
