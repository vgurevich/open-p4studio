...
#ifndef __REGISTER_INCLUDES_PARTY_GLUE_REG_RSPEC_PARDE_INTR_STATUS1_MUTABLE_H__
#define __REGISTER_INCLUDES_PARTY_GLUE_REG_RSPEC_PARDE_INTR_STATUS1_MUTABLE_H__
...
class PartyGlueRegRspecPardeIntrStatus1Mutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  PartyGlueRegRspecPardeIntrStatus1Mutable(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 4, true, write_callback, read_callback, std::string("PartyGlueRegRspecPardeIntrStatus1Mutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  PartyGlueRegRspecPardeIntrStatus1Mutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "PartyGlueRegRspecPardeIntrStatus1Mutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PartyGlueRegRspecPardeIntrStatus1Mutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_PARTY_GLUE_REG_RSPEC_PARDE_INTR_STATUS1_MUTABLE_H__
