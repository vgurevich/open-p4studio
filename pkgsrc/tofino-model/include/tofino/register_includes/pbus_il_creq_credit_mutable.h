...
public:
  PbusIlCreqCreditMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pbus_il_creq_credit), 48, true, write_callback, read_callback, std::string("PbusIlCreqCreditMutable")+":"+boost::lexical_cast<std::string>(index_pbus_il_creq_credit))
    {
    }
  PbusIlCreqCreditMutable(
