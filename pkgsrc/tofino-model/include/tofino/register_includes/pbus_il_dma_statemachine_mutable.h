...
#ifndef __REGISTER_INCLUDES_PBUS_IL_DMA_STATEMACHINE_MUTABLE_H__
#define __REGISTER_INCLUDES_PBUS_IL_DMA_STATEMACHINE_MUTABLE_H__
...
class PbusIlDmaStatemachineMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  PbusIlDmaStatemachineMutable(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 4, true, write_callback, read_callback, std::string("PbusIlDmaStatemachineMutable"))
    {
    }
  PbusIlDmaStatemachineMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "PbusIlDmaStatemachineMutable")
    {
    }
public:
  ...
  void read(int j0,const uint8_t &v) { read_[j0]=v; }
  ...
  void instr(int j0,const uint8_t &v) { instr_[j0]=v; }
  ...
  void write(int j0,const uint8_t &v) { write_[j0]=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PbusIlDmaStatemachineMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_PBUS_IL_DMA_STATEMACHINE_MUTABLE_H__
