...
#ifndef __REGISTER_INCLUDES_PBUS_STATION_REGS_INTR_ENABLE0_MUTABLE_H__
#define __REGISTER_INCLUDES_PBUS_STATION_REGS_INTR_ENABLE0_MUTABLE_H__
...
class PbusStationRegsIntrEnable0Mutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  PbusStationRegsIntrEnable0Mutable(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 4, true, write_callback, read_callback, std::string("PbusStationRegsIntrEnable0Mutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  PbusStationRegsIntrEnable0Mutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "PbusStationRegsIntrEnable0Mutable")
    {
    }
public:
  uint8_t creq_ctrl_ecc_dual_err() { return creq_ctrl_ecc_dual_err_; }
  void creq_ctrl_ecc_dual_err(const uint8_t &v) { creq_ctrl_ecc_dual_err_=v; }
  uint8_t creq_ctrl_ecc_sngl_err() { return creq_ctrl_ecc_sngl_err_; }
  void creq_ctrl_ecc_sngl_err(const uint8_t &v) { creq_ctrl_ecc_sngl_err_=v; }
  uint8_t creq_data_ecc_dual_err() { return creq_data_ecc_dual_err_; }
  void creq_data_ecc_dual_err(const uint8_t &v) { creq_data_ecc_dual_err_=v; }
  uint8_t creq_data_ecc_sngl_err() { return creq_data_ecc_sngl_err_; }
  void creq_data_ecc_sngl_err(const uint8_t &v) { creq_data_ecc_sngl_err_=v; }
  uint8_t cresp_ctrl_ecc_dual_err() { return cresp_ctrl_ecc_dual_err_; }
  void cresp_ctrl_ecc_dual_err(const uint8_t &v) { cresp_ctrl_ecc_dual_err_=v; }
  uint8_t cresp_ctrl_ecc_sngl_err() { return cresp_ctrl_ecc_sngl_err_; }
  void cresp_ctrl_ecc_sngl_err(const uint8_t &v) { cresp_ctrl_ecc_sngl_err_=v; }
  uint8_t cresp_data_ecc_dual_err() { return cresp_data_ecc_dual_err_; }
  void cresp_data_ecc_dual_err(const uint8_t &v) { cresp_data_ecc_dual_err_=v; }
  uint8_t cresp_data_ecc_sngl_err() { return cresp_data_ecc_sngl_err_; }
  void cresp_data_ecc_sngl_err(const uint8_t &v) { cresp_data_ecc_sngl_err_=v; }
  uint8_t creq_il_err() { return creq_il_err_; }
  void creq_il_err(const uint8_t &v) { creq_il_err_=v; }
  ...
  void reset(
    ...
    creq_ctrl_ecc_dual_err_ = 0x1;
    creq_ctrl_ecc_sngl_err_ = 0x1;
    creq_data_ecc_dual_err_ = 0x1;
    creq_data_ecc_sngl_err_ = 0x1;
    cresp_ctrl_ecc_dual_err_ = 0x1;
    cresp_ctrl_ecc_sngl_err_ = 0x1;
    cresp_data_ecc_dual_err_ = 0x1;
    cresp_data_ecc_sngl_err_ = 0x1;
    creq_il_err_ = 0x1;
    if (write_callback_) write_callback_();
  }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PbusStationRegsIntrEnable0Mutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x4; // to get to intr_enable0
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_PBUS_STATION_REGS_INTR_ENABLE0_MUTABLE_H__
