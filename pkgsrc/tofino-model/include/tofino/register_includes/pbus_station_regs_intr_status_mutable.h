...
#ifndef __REGISTER_INCLUDES_PBUS_STATION_REGS_INTR_STATUS_MUTABLE_H__
#define __REGISTER_INCLUDES_PBUS_STATION_REGS_INTR_STATUS_MUTABLE_H__
...
class PbusStationRegsIntrStatusMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  PbusStationRegsIntrStatusMutable(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 4, true, write_callback, read_callback, std::string("PbusStationRegsIntrStatusMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  PbusStationRegsIntrStatusMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "PbusStationRegsIntrStatusMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PbusStationRegsIntrStatusMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_PBUS_STATION_REGS_INTR_STATUS_MUTABLE_H__
