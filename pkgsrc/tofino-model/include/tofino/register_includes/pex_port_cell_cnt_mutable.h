...
#ifndef __REGISTER_INCLUDES_PEX_PORT_CELL_CNT_MUTABLE_H__
#define __REGISTER_INCLUDES_PEX_PORT_CELL_CNT_MUTABLE_H__
...
class PexPortCellCntMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  PexPortCellCntMutable(
      int chipNumber, int index_tm_pex_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_pex_pipe_rspec), 8, true, write_callback, read_callback, std::string("PexPortCellCntMutable")+":"+boost::lexical_cast<std::string>(index_tm_pex_pipe_rspec))
    {
    }
  PexPortCellCntMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "PexPortCellCntMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PexPortCellCntMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x5e0; // to get to port_cell_cnt
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_PEX_PORT_CELL_CNT_MUTABLE_H__
