...
#ifndef __REGISTER_INCLUDES_PEX_PORT_PKT_CNT_H__
#define __REGISTER_INCLUDES_PEX_PORT_PKT_CNT_H__
...
class PexPortPktCnt : public model_core::RegisterBlock<RegisterCallback> {
public:
  PexPortPktCnt(
      int chipNumber, int index_tm_pex_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_pex_pipe_rspec), 8, false, write_callback, read_callback, std::string("PexPortPktCnt")+":"+boost::lexical_cast<std::string>(index_tm_pex_pipe_rspec))
    {
    }
  PexPortPktCnt(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "PexPortPktCnt")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PexPortPktCnt") + ":\n";
...
#endif // __REGISTER_INCLUDES_PEX_PORT_PKT_CNT_H__
