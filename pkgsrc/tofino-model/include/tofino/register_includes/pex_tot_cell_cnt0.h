...
#ifndef __REGISTER_INCLUDES_PEX_TOT_CELL_CNT0_H__
#define __REGISTER_INCLUDES_PEX_TOT_CELL_CNT0_H__
...
class PexTotCellCnt0 : public model_core::RegisterBlock<RegisterCallback> {
public:
  PexTotCellCnt0(
      int chipNumber, int index_tm_pex_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_pex_pipe_rspec), 8, false, write_callback, read_callback, std::string("PexTotCellCnt0")+":"+boost::lexical_cast<std::string>(index_tm_pex_pipe_rspec))
    {
    }
  PexTotCellCnt0(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "PexTotCellCnt0")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PexTotCellCnt0") + ":\n";
...
#endif // __REGISTER_INCLUDES_PEX_TOT_CELL_CNT0_H__
