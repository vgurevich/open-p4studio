...
#ifndef __REGISTER_INCLUDES_PEX_TOT_CELL_CNT1_MUTABLE_H__
#define __REGISTER_INCLUDES_PEX_TOT_CELL_CNT1_MUTABLE_H__
...
class PexTotCellCnt1Mutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  PexTotCellCnt1Mutable(
      int chipNumber, int index_tm_pex_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_pex_pipe_rspec), 8, true, write_callback, read_callback, std::string("PexTotCellCnt1Mutable")+":"+boost::lexical_cast<std::string>(index_tm_pex_pipe_rspec))
    {
    }
  PexTotCellCnt1Mutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "PexTotCellCnt1Mutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PexTotCellCnt1Mutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x5f8; // to get to tot_cell_cnt1
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_PEX_TOT_CELL_CNT1_MUTABLE_H__
