...
#ifndef __REGISTER_INCLUDES_PEX_TOT_CELL_CNT2_MUTABLE_H__
#define __REGISTER_INCLUDES_PEX_TOT_CELL_CNT2_MUTABLE_H__
...
class PexTotCellCnt2Mutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  PexTotCellCnt2Mutable(
      int chipNumber, int index_tm_pex_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_pex_pipe_rspec), 8, true, write_callback, read_callback, std::string("PexTotCellCnt2Mutable")+":"+boost::lexical_cast<std::string>(index_tm_pex_pipe_rspec))
    {
    }
  PexTotCellCnt2Mutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "PexTotCellCnt2Mutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PexTotCellCnt2Mutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x600; // to get to tot_cell_cnt2
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_PEX_TOT_CELL_CNT2_MUTABLE_H__
