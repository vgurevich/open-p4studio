...
#ifndef __REGISTER_INCLUDES_PEX_TOT_ERR_PKT_CNT_MUTABLE_H__
#define __REGISTER_INCLUDES_PEX_TOT_ERR_PKT_CNT_MUTABLE_H__
...
class PexTotErrPktCntMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  PexTotErrPktCntMutable(
      int chipNumber, int index_tm_pex_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_pex_pipe_rspec), 8, true, write_callback, read_callback, std::string("PexTotErrPktCntMutable")+":"+boost::lexical_cast<std::string>(index_tm_pex_pipe_rspec))
    {
    }
  PexTotErrPktCntMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "PexTotErrPktCntMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PexTotErrPktCntMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x610; // to get to tot_err_pkt_cnt
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_PEX_TOT_ERR_PKT_CNT_MUTABLE_H__
