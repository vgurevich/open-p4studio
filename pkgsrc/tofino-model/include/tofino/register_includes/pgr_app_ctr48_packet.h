...
#ifndef __REGISTER_INCLUDES_PGR_APP_CTR48_PACKET_H__
#define __REGISTER_INCLUDES_PGR_APP_CTR48_PACKET_H__
...
class PgrAppCtr48Packet : public model_core::RegisterBlock<RegisterCallback> {
public:
  PgrAppCtr48Packet(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_party_pgr_app_reg_rspec), 8, false, write_callback, read_callback, std::string("PgrAppCtr48Packet")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_party_pgr_app_reg_rspec))
    {
    }
  PgrAppCtr48Packet(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "PgrAppCtr48Packet")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PgrAppCtr48Packet") + ":\n";
...
#endif // __REGISTER_INCLUDES_PGR_APP_CTR48_PACKET_H__
