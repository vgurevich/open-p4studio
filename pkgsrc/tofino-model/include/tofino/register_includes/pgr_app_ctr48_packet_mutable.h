...
#ifndef __REGISTER_INCLUDES_PGR_APP_CTR48_PACKET_MUTABLE_H__
#define __REGISTER_INCLUDES_PGR_APP_CTR48_PACKET_MUTABLE_H__
...
class PgrAppCtr48PacketMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  PgrAppCtr48PacketMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_party_pgr_app_reg_rspec), 8, true, write_callback, read_callback, std::string("PgrAppCtr48PacketMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_party_pgr_app_reg_rspec))
    {
    }
  PgrAppCtr48PacketMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "PgrAppCtr48PacketMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PgrAppCtr48PacketMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x48; // to get to ctr48_packet
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_PGR_APP_CTR48_PACKET_MUTABLE_H__
