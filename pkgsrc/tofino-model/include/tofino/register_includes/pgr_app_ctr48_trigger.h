...
#ifndef __REGISTER_INCLUDES_PGR_APP_CTR48_TRIGGER_H__
#define __REGISTER_INCLUDES_PGR_APP_CTR48_TRIGGER_H__
...
class PgrAppCtr48Trigger : public model_core::RegisterBlock<RegisterCallback> {
public:
  PgrAppCtr48Trigger(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_party_pgr_app_reg_rspec), 8, false, write_callback, read_callback, std::string("PgrAppCtr48Trigger")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_party_pgr_app_reg_rspec))
    {
    }
  PgrAppCtr48Trigger(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "PgrAppCtr48Trigger")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PgrAppCtr48Trigger") + ":\n";
...
#endif // __REGISTER_INCLUDES_PGR_APP_CTR48_TRIGGER_H__
