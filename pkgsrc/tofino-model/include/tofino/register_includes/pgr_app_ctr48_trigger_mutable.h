...
#ifndef __REGISTER_INCLUDES_PGR_APP_CTR48_TRIGGER_MUTABLE_H__
#define __REGISTER_INCLUDES_PGR_APP_CTR48_TRIGGER_MUTABLE_H__
...
class PgrAppCtr48TriggerMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  PgrAppCtr48TriggerMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_party_pgr_app_reg_rspec), 8, true, write_callback, read_callback, std::string("PgrAppCtr48TriggerMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_party_pgr_app_reg_rspec))
    {
    }
  PgrAppCtr48TriggerMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "PgrAppCtr48TriggerMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PgrAppCtr48TriggerMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x38; // to get to ctr48_trigger
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_PGR_APP_CTR48_TRIGGER_MUTABLE_H__
