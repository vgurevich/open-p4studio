...
#ifndef __REGISTER_INCLUDES_PGR_INT_INJ_H__
#define __REGISTER_INCLUDES_PGR_INT_INJ_H__
...
class PgrIntInj : public model_core::RegisterBlock<RegisterCallback> {
public:
  PgrIntInj(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 4, false, write_callback, read_callback, std::string("PgrIntInj")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  PgrIntInj(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "PgrIntInj")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PgrIntInj") + ":\n";
...
#endif // __REGISTER_INCLUDES_PGR_INT_INJ_H__
