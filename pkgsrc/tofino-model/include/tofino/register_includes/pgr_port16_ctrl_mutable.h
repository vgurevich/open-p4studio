...
#ifndef __REGISTER_INCLUDES_PGR_PORT16_CTRL_MUTABLE_H__
#define __REGISTER_INCLUDES_PGR_PORT16_CTRL_MUTABLE_H__
...
class PgrPort16CtrlMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  PgrPort16CtrlMutable(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 4, true, write_callback, read_callback, std::string("PgrPort16CtrlMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  PgrPort16CtrlMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "PgrPort16CtrlMutable")
    {
    }
public:
  ...
  void mxbar_en(const uint8_t &v) { mxbar_en_=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PgrPort16CtrlMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_PGR_PORT16_CTRL_MUTABLE_H__
