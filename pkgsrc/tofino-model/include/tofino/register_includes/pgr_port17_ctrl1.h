...
#ifndef __REGISTER_INCLUDES_PGR_PORT17_CTRL1_H__
#define __REGISTER_INCLUDES_PGR_PORT17_CTRL1_H__
...
class PgrPort17Ctrl1 : public model_core::RegisterBlock<RegisterCallback> {
public:
  PgrPort17Ctrl1(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 4, false, write_callback, read_callback, std::string("PgrPort17Ctrl1")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  PgrPort17Ctrl1(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "PgrPort17Ctrl1")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PgrPort17Ctrl1") + ":\n";
...
#endif // __REGISTER_INCLUDES_PGR_PORT17_CTRL1_H__
