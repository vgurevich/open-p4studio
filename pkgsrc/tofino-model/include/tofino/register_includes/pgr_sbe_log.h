...
public:
  PgrSbeLog(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 4, false, write_callback, read_callback, std::string("PgrSbeLog")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  PgrSbeLog(
