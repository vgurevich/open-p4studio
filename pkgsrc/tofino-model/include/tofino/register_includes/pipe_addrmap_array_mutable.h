...
#ifndef __REGISTER_INCLUDES_PIPE_ADDRMAP_ARRAY_MUTABLE_H__
#define __REGISTER_INCLUDES_PIPE_ADDRMAP_ARRAY_MUTABLE_H__
...
class PipeAddrmapArrayMutable : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  PipeAddrmapArrayMutable(
      int chipNumber, RegisterArrayCallback& write_callback = 0, RegisterArrayCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 8388608 * ArraySize(-1), true, write_callback, read_callback, std::string("PipeAddrmapArrayMutable")),
...
public:
  ...
  PmarbRspecMutable &pmarb(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    return array[a0].pmarb();
  }
  ...
  DprsrRegRspecMutable &deparser(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    return array[a0].deparser();
  }
  bool calculate_index(
      uint32_t* offset, uint32_t* a0
      ) const {
    int i = (*offset)/8388608;
    (*offset) -= (i*8388608);
    uint32_t t = i;
    *a0 = t;
    bool in_bounds = true;
...
#endif // __REGISTER_INCLUDES_PIPE_ADDRMAP_ARRAY_MUTABLE_H__
