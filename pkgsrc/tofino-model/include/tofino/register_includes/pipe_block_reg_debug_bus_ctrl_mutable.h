...
#ifndef __REGISTER_INCLUDES_PIPE_BLOCK_REG_DEBUG_BUS_CTRL_MUTABLE_H__
#define __REGISTER_INCLUDES_PIPE_BLOCK_REG_DEBUG_BUS_CTRL_MUTABLE_H__
...
class PipeBlockRegDebugBusCtrlMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  PipeBlockRegDebugBusCtrlMutable(
      int chipNumber, int index_tm_qac_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_qac_pipe_rspec), 4, true, write_callback, read_callback, std::string("PipeBlockRegDebugBusCtrlMutable")+":"+boost::lexical_cast<std::string>(index_tm_qac_pipe_rspec))
    {
    }
  PipeBlockRegDebugBusCtrlMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "PipeBlockRegDebugBusCtrlMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PipeBlockRegDebugBusCtrlMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x7084; // to get to qac_reg_debug_bus_ctrl
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_PIPE_BLOCK_REG_DEBUG_BUS_CTRL_MUTABLE_H__
