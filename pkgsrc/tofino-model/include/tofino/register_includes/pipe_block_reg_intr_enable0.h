...
#ifndef __REGISTER_INCLUDES_PIPE_BLOCK_REG_INTR_ENABLE0_H__
#define __REGISTER_INCLUDES_PIPE_BLOCK_REG_INTR_ENABLE0_H__
...
class PipeBlockRegIntrEnable0 : public model_core::RegisterBlock<RegisterCallback> {
public:
  PipeBlockRegIntrEnable0(
      int chipNumber, int index_tm_qac_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_qac_pipe_rspec), 4, false, write_callback, read_callback, std::string("PipeBlockRegIntrEnable0")+":"+boost::lexical_cast<std::string>(index_tm_qac_pipe_rspec))
    {
    }
  PipeBlockRegIntrEnable0(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "PipeBlockRegIntrEnable0")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PipeBlockRegIntrEnable0") + ":\n";
...
#endif // __REGISTER_INCLUDES_PIPE_BLOCK_REG_INTR_ENABLE0_H__
