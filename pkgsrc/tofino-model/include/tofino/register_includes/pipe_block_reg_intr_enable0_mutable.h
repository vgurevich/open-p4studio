...
#ifndef __REGISTER_INCLUDES_PIPE_BLOCK_REG_INTR_ENABLE0_MUTABLE_H__
#define __REGISTER_INCLUDES_PIPE_BLOCK_REG_INTR_ENABLE0_MUTABLE_H__
...
class PipeBlockRegIntrEnable0Mutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  PipeBlockRegIntrEnable0Mutable(
      int chipNumber, int index_tm_qac_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_qac_pipe_rspec), 4, true, write_callback, read_callback, std::string("PipeBlockRegIntrEnable0Mutable")+":"+boost::lexical_cast<std::string>(index_tm_qac_pipe_rspec))
    {
    }
  PipeBlockRegIntrEnable0Mutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "PipeBlockRegIntrEnable0Mutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PipeBlockRegIntrEnable0Mutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x7064; // to get to qac_reg_intr_enable0
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_PIPE_BLOCK_REG_INTR_ENABLE0_MUTABLE_H__
