...
#ifndef __REGISTER_INCLUDES_PIPE_BLOCK_REG_INTR_ENABLE1_H__
#define __REGISTER_INCLUDES_PIPE_BLOCK_REG_INTR_ENABLE1_H__
...
class PipeBlockRegIntrEnable1 : public model_core::RegisterBlock<RegisterCallback> {
public:
  PipeBlockRegIntrEnable1(
      int chipNumber, int index_tm_qac_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_qac_pipe_rspec), 4, false, write_callback, read_callback, std::string("PipeBlockRegIntrEnable1")+":"+boost::lexical_cast<std::string>(index_tm_qac_pipe_rspec))
    {
    }
  PipeBlockRegIntrEnable1(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "PipeBlockRegIntrEnable1")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PipeBlockRegIntrEnable1") + ":\n";
...
#endif // __REGISTER_INCLUDES_PIPE_BLOCK_REG_INTR_ENABLE1_H__
