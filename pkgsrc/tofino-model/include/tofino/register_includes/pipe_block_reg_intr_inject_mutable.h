...
#ifndef __REGISTER_INCLUDES_PIPE_BLOCK_REG_INTR_INJECT_MUTABLE_H__
#define __REGISTER_INCLUDES_PIPE_BLOCK_REG_INTR_INJECT_MUTABLE_H__
...
class PipeBlockRegIntrInjectMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  PipeBlockRegIntrInjectMutable(
      int chipNumber, int index_tm_qac_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_qac_pipe_rspec), 4, true, write_callback, read_callback, std::string("PipeBlockRegIntrInjectMutable")+":"+boost::lexical_cast<std::string>(index_tm_qac_pipe_rspec))
    {
    }
  PipeBlockRegIntrInjectMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "PipeBlockRegIntrInjectMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PipeBlockRegIntrInjectMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x706c; // to get to qac_reg_intr_inject
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_PIPE_BLOCK_REG_INTR_INJECT_MUTABLE_H__
