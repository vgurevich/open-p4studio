...
#ifndef __REGISTER_INCLUDES_PIPE_REG_CTR_VLD_SOP_H__
#define __REGISTER_INCLUDES_PIPE_REG_CTR_VLD_SOP_H__
...
class PipeRegCtrVldSop : public model_core::RegisterBlock<RegisterCallback> {
public:
  PipeRegCtrVldSop(
      int chipNumber, int index_tm_wac_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_wac_pipe_rspec), 8, false, write_callback, read_callback, std::string("PipeRegCtrVldSop")+":"+boost::lexical_cast<std::string>(index_tm_wac_pipe_rspec))
    {
    }
  PipeRegCtrVldSop(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "PipeRegCtrVldSop")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PipeRegCtrVldSop") + ":\n";
...
#endif // __REGISTER_INCLUDES_PIPE_REG_CTR_VLD_SOP_H__
