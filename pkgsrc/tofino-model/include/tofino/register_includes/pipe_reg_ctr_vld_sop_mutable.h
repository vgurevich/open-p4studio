...
#ifndef __REGISTER_INCLUDES_PIPE_REG_CTR_VLD_SOP_MUTABLE_H__
#define __REGISTER_INCLUDES_PIPE_REG_CTR_VLD_SOP_MUTABLE_H__
...
class PipeRegCtrVldSopMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  PipeRegCtrVldSopMutable(
      int chipNumber, int index_tm_wac_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_wac_pipe_rspec), 8, true, write_callback, read_callback, std::string("PipeRegCtrVldSopMutable")+":"+boost::lexical_cast<std::string>(index_tm_wac_pipe_rspec))
    {
    }
  PipeRegCtrVldSopMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "PipeRegCtrVldSopMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PipeRegCtrVldSopMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x10; // to get to wac_reg_ctr_vld_sop
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_PIPE_REG_CTR_VLD_SOP_MUTABLE_H__
