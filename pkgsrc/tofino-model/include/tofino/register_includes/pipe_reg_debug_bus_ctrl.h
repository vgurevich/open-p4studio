...
#ifndef __REGISTER_INCLUDES_PIPE_REG_DEBUG_BUS_CTRL_H__
#define __REGISTER_INCLUDES_PIPE_REG_DEBUG_BUS_CTRL_H__
...
class PipeRegDebugBusCtrl : public model_core::RegisterBlock<RegisterCallback> {
public:
  PipeRegDebugBusCtrl(
      int chipNumber, int index_tm_wac_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_wac_pipe_rspec), 4, false, write_callback, read_callback, std::string("PipeRegDebugBusCtrl")+":"+boost::lexical_cast<std::string>(index_tm_wac_pipe_rspec))
    {
    }
  PipeRegDebugBusCtrl(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "PipeRegDebugBusCtrl")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PipeRegDebugBusCtrl") + ":\n";
...
#endif // __REGISTER_INCLUDES_PIPE_REG_DEBUG_BUS_CTRL_H__
