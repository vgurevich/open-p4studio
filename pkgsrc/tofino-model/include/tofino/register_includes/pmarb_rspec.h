...
#ifndef __REGISTER_INCLUDES_PMARB_RSPEC_H__
#define __REGISTER_INCLUDES_PMARB_RSPEC_H__
...
#include "ebp18_rspec.h"
#include "ibp18_rspec.h"
#include "parb_regs.h"
#include "party_glue_reg_rspec.h"
#include "party_pgr_reg_rspec.h"
#include "pbus_station_regs.h"
#include "prsr_reg_merge_rspec.h"

namespace tofino {
  namespace register_classes {

class PmarbRspec : public model_core::RegisterBlock<RegisterCallback> {
public:
  PmarbRspec(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 524288, false, write_callback, read_callback, std::string("PmarbRspec")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  PmarbRspec(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "PmarbRspec")
    {
    }
public:
  Ibp18Rspec &ibp18_reg() { return ibp18_reg_; }





  ParbRegs &parb_reg() { return parb_reg_; }





  PrsrRegMergeRspec &prsr_reg() { return prsr_reg_; }





  PbusStationRegs &pbusstat_reg() { return pbusstat_reg_; }





  PartyPgrRegRspec &pgr_reg() { return pgr_reg_; }





  PartyGlueRegRspec &party_glue_reg() { return party_glue_reg_; }
  Ebp18Rspec &ebp18_reg() { return ebp18_reg_; }
...
private:
  Ibp18Rspec ibp18_reg_;
  ParbRegs parb_reg_;
  PrsrRegMergeRspec prsr_reg_;
  PbusStationRegs pbusstat_reg_;
  PartyPgrRegRspec pgr_reg_;
  PartyGlueRegRspec party_glue_reg_;
  Ebp18Rspec ebp18_reg_;
private:
...
#endif // __REGISTER_INCLUDES_PMARB_RSPEC_H__
