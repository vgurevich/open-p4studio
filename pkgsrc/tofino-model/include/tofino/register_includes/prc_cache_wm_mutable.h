...
#ifndef __REGISTER_INCLUDES_PRC_CACHE_WM_MUTABLE_H__
#define __REGISTER_INCLUDES_PRC_CACHE_WM_MUTABLE_H__
...
class PrcCacheWmMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  PrcCacheWmMutable(
      int chipNumber, int index_tm_prc_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_prc_pipe_rspec), 4, true, write_callback, read_callback, std::string("PrcCacheWmMutable")+":"+boost::lexical_cast<std::string>(index_tm_prc_pipe_rspec))
    {
    }
  PrcCacheWmMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "PrcCacheWmMutable")
    {
    }
public:
  ...
  void map_cache_wm(const uint8_t &v) { map_cache_wm_=v; }
  ...
  void mem_cache_wm(const uint8_t &v) { mem_cache_wm_=v; }
  ...
  void wm_reset(const uint8_t &v) { wm_reset_=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PrcCacheWmMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x78; // to get to cache_wm
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_PRC_CACHE_WM_MUTABLE_H__
