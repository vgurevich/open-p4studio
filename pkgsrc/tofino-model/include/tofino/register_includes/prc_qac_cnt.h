...
#ifndef __REGISTER_INCLUDES_PRC_QAC_CNT_H__
#define __REGISTER_INCLUDES_PRC_QAC_CNT_H__
...
class PrcQacCnt : public model_core::RegisterBlock<RegisterCallback> {
public:
  PrcQacCnt(
      int chipNumber, int index_tm_prc_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_prc_pipe_rspec), 8, false, write_callback, read_callback, std::string("PrcQacCnt")+":"+boost::lexical_cast<std::string>(index_tm_prc_pipe_rspec))
    {
    }
  PrcQacCnt(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "PrcQacCnt")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PrcQacCnt") + ":\n";
...
#endif // __REGISTER_INCLUDES_PRC_QAC_CNT_H__
