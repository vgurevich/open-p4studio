...
#ifndef __REGISTER_INCLUDES_PRC_QAC_CNT_MUTABLE_H__
#define __REGISTER_INCLUDES_PRC_QAC_CNT_MUTABLE_H__
...
class PrcQacCntMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  PrcQacCntMutable(
      int chipNumber, int index_tm_prc_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_prc_pipe_rspec), 8, true, write_callback, read_callback, std::string("PrcQacCntMutable")+":"+boost::lexical_cast<std::string>(index_tm_prc_pipe_rspec))
    {
    }
  PrcQacCntMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "PrcQacCntMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PrcQacCntMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_PRC_QAC_CNT_MUTABLE_H__
