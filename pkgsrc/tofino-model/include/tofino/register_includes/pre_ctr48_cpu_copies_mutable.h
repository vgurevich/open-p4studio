...
#ifndef __REGISTER_INCLUDES_PRE_CTR48_CPU_COPIES_MUTABLE_H__
#define __REGISTER_INCLUDES_PRE_CTR48_CPU_COPIES_MUTABLE_H__
...
class PreCtr48CpuCopiesMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  PreCtr48CpuCopiesMutable(
      int chipNumber, int index_tm_pre_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_pre_pipe_rspec), 8, true, write_callback, read_callback, std::string("PreCtr48CpuCopiesMutable")+":"+boost::lexical_cast<std::string>(index_tm_pre_pipe_rspec))
    {
    }
  PreCtr48CpuCopiesMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "PreCtr48CpuCopiesMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PreCtr48CpuCopiesMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x88; // to get to cpu_copies
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_PRE_CTR48_CPU_COPIES_MUTABLE_H__
