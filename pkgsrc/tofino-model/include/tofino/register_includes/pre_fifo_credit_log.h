...
#ifndef __REGISTER_INCLUDES_PRE_FIFO_CREDIT_LOG_H__
#define __REGISTER_INCLUDES_PRE_FIFO_CREDIT_LOG_H__
...
class PreFifoCreditLog : public model_core::RegisterBlock<RegisterCallback> {
public:
  PreFifoCreditLog(
      int chipNumber, int index_tm_pre_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_pre_pipe_rspec), 4, false, write_callback, read_callback, std::string("PreFifoCreditLog")+":"+boost::lexical_cast<std::string>(index_tm_pre_pipe_rspec))
    {
    }
  PreFifoCreditLog(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "PreFifoCreditLog")
    {
    }
public:
  ...
  bool read(
    ...
    *data |= ((l1_fifo_credit_ & 0x1f) << 5);
    *data |= ((l1l2_fifo_credit_ & 0x1f) << 10);
    *data |= ((l2_fifo_credit_ & 0x1f) << 15);
    *data |= ((l2_sel_fifo_credit_ & 0xf) << 20);
    *data |= ((l2_port_fifo_credit_ & 0x1f) << 24);
    return true;
  }
  ...
  bool write(
    ...
    l1_fifo_credit_ = ((data >> 5) & 0x1f);
    l1l2_fifo_credit_ = ((data >> 10) & 0x1f);
    l2_fifo_credit_ = ((data >> 15) & 0x1f);
    l2_sel_fifo_credit_ = ((data >> 20) & 0xf);
    l2_port_fifo_credit_ = ((data >> 24) & 0x1f);
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PreFifoCreditLog") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x130; // to get to credit_log
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_PRE_FIFO_CREDIT_LOG_H__
