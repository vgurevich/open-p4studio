...
#ifndef __REGISTER_INCLUDES_PRE_FILTER_CTRL_MUTABLE_H__
#define __REGISTER_INCLUDES_PRE_FILTER_CTRL_MUTABLE_H__
...
class PreFilterCtrlMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  PreFilterCtrlMutable(
      int chipNumber, int index_tm_pre_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_pre_pipe_rspec), 12, true, write_callback, read_callback, std::string("PreFilterCtrlMutable")+":"+boost::lexical_cast<std::string>(index_tm_pre_pipe_rspec))
    {
    }
  PreFilterCtrlMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "PreFilterCtrlMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PreFilterCtrlMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x30; // to get to filter_ctrl
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_PRE_FILTER_CTRL_MUTABLE_H__
