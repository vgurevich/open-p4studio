...
#ifndef __REGISTER_INCLUDES_PRE_PORT_DOWN_MUTABLE_H__
#define __REGISTER_INCLUDES_PRE_PORT_DOWN_MUTABLE_H__
...
class PrePortDownMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  PrePortDownMutable(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 36, true, write_callback, read_callback, std::string("PrePortDownMutable"))
    {
    }
  PrePortDownMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "PrePortDownMutable")
    {
    }
public:
  ...
  void port_down(int j0,const uint8_t &v) { port_down_[j0]=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PrePortDownMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_PRE_PORT_DOWN_MUTABLE_H__
