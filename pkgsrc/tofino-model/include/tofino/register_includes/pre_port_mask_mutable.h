...
#ifndef __REGISTER_INCLUDES_PRE_PORT_MASK_MUTABLE_H__
#define __REGISTER_INCLUDES_PRE_PORT_MASK_MUTABLE_H__
...
class PrePortMaskMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  PrePortMaskMutable(
      int chipNumber, int index_pre_port_mask, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pre_port_mask), 36, true, write_callback, read_callback, std::string("PrePortMaskMutable")+":"+boost::lexical_cast<std::string>(index_pre_port_mask))
    {
    }
  PrePortMaskMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "PrePortMaskMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PrePortMaskMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_PRE_PORT_MASK_MUTABLE_H__
