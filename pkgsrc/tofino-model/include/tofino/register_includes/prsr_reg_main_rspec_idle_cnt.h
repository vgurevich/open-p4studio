...
public:
  PrsrRegMainRspecIdleCnt(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, selector_pmarb_rspec, index_ebp_rspec, index_prsr_reg_main_rspec_idle_cnt), 8, false, write_callback, read_callback, std::string("PrsrRegMainRspecIdleCnt")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(selector_pmarb_rspec) + "," + boost::lexical_cast<std::string>(index_ebp_rspec) + "," + boost::lexical_cast<std::string>(index_prsr_reg_main_rspec_idle_cnt))
    {
    }
  PrsrRegMainRspecIdleCnt(
