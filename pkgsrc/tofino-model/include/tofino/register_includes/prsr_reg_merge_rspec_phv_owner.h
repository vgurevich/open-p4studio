...
#ifndef __REGISTER_INCLUDES_PRSR_REG_MERGE_RSPEC_PHV_OWNER_H__
#define __REGISTER_INCLUDES_PRSR_REG_MERGE_RSPEC_PHV_OWNER_H__
...
class PrsrRegMergeRspecPhvOwner : public model_core::RegisterBlock<RegisterCallback> {
public:
  PrsrRegMergeRspecPhvOwner(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 48, false, write_callback, read_callback, std::string("PrsrRegMergeRspecPhvOwner")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  PrsrRegMergeRspecPhvOwner(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "PrsrRegMergeRspecPhvOwner")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PrsrRegMergeRspecPhvOwner") + ":\n";
...
#endif // __REGISTER_INCLUDES_PRSR_REG_MERGE_RSPEC_PHV_OWNER_H__
