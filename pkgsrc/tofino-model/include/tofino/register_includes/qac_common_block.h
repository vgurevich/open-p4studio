...
public:
  QacCommonBlock(
    ...
    : RegisterBlock(chipNumber, StartOffset(), 616, false, write_callback, read_callback, std::string("QacCommonBlock"))
    {
    }
  QacCommonBlock(
...
public:
  ...
  QacIntrBmp &qac_common_qac_intr_bmp() { return qac_common_qac_intr_bmp_; }
...
private:
  ...
  QacIntrBmp qac_common_qac_intr_bmp_;
