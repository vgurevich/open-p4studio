...
#ifndef __REGISTER_INCLUDES_QAC_PRE_FIFO_CNT_CELL_ARRAY_H__
#define __REGISTER_INCLUDES_QAC_PRE_FIFO_CNT_CELL_ARRAY_H__
...
class QacPreFifoCntCellArray : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
...
public:
  QacPreFifoCntCellArray(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_qac_common_block), 4 * ArraySize(selector_qac_common_block, -1), false, write_callback, read_callback, std::string("QacPreFifoCntCellArray")+":"+boost::lexical_cast<std::string>(selector_qac_common_block)),
...
public:
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("QacPreFifoCntCellArray") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
private:
  std::vector<QacPreFifoCntCell> array;
  uint32_t size0_;
...
#endif // __REGISTER_INCLUDES_QAC_PRE_FIFO_CNT_CELL_ARRAY_H__
