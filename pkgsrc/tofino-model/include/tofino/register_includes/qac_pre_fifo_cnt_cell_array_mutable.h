...
#ifndef __REGISTER_INCLUDES_QAC_PRE_FIFO_CNT_CELL_ARRAY_MUTABLE_H__
#define __REGISTER_INCLUDES_QAC_PRE_FIFO_CNT_CELL_ARRAY_MUTABLE_H__
...
class QacPreFifoCntCellArrayMutable : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
...
public:
  QacPreFifoCntCellArrayMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_qac_common_block), 4 * ArraySize(selector_qac_common_block, -1), true, write_callback, read_callback, std::string("QacPreFifoCntCellArrayMutable")+":"+boost::lexical_cast<std::string>(selector_qac_common_block)),
...
public:
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("QacPreFifoCntCellArrayMutable") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
private:
  std::vector<QacPreFifoCntCellMutable> array;
  uint32_t size0_;
...
#endif // __REGISTER_INCLUDES_QAC_PRE_FIFO_CNT_CELL_ARRAY_MUTABLE_H__
