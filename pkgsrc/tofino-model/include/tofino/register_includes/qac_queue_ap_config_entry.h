...
#ifndef __REGISTER_INCLUDES_QAC_QUEUE_AP_CONFIG_ENTRY_H__
#define __REGISTER_INCLUDES_QAC_QUEUE_AP_CONFIG_ENTRY_H__
...
class QacQueueApConfigEntry : public model_core::RegisterBlock<RegisterCallback> {
public:
  QacQueueApConfigEntry(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_tm_qac_pipe_rspec, index_qac_queue_ap_config_entry), 4, false, write_callback, read_callback, std::string("QacQueueApConfigEntry")+":"+boost::lexical_cast<std::string>(index_tm_qac_pipe_rspec) + "," + boost::lexical_cast<std::string>(index_qac_queue_ap_config_entry))
    {
    }
  QacQueueApConfigEntry(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "QacQueueApConfigEntry")
    {
    }
public:
...
#endif // __REGISTER_INCLUDES_QAC_QUEUE_AP_CONFIG_ENTRY_H__
