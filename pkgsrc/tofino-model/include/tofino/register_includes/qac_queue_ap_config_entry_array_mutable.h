...
#ifndef __REGISTER_INCLUDES_QAC_QUEUE_AP_CONFIG_ENTRY_ARRAY_MUTABLE_H__
#define __REGISTER_INCLUDES_QAC_QUEUE_AP_CONFIG_ENTRY_ARRAY_MUTABLE_H__
...
class QacQueueApConfigEntryArrayMutable : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  QacQueueApConfigEntryArrayMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_tm_qac_pipe_rspec), 4 * ArraySize(index_tm_qac_pipe_rspec, -1), true, write_callback, read_callback, std::string("QacQueueApConfigEntryArrayMutable")+":"+boost::lexical_cast<std::string>(index_tm_qac_pipe_rspec)),
...
#endif // __REGISTER_INCLUDES_QAC_QUEUE_AP_CONFIG_ENTRY_ARRAY_MUTABLE_H__
