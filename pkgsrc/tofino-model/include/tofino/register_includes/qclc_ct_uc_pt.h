...
#ifndef __REGISTER_INCLUDES_QCLC_CT_UC_PT_H__
#define __REGISTER_INCLUDES_QCLC_CT_UC_PT_H__
...
class QclcCtUcPt : public model_core::RegisterBlock<RegisterCallback> {
public:
  QclcCtUcPt(
      int chipNumber, int index_qclc_ct_uc_pt, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_qclc_ct_uc_pt), 4, false, write_callback, read_callback, std::string("QclcCtUcPt")+":"+boost::lexical_cast<std::string>(index_qclc_ct_uc_pt))
    {
    }
  QclcCtUcPt(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "QclcCtUcPt")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("QclcCtUcPt") + ":\n";
...
#endif // __REGISTER_INCLUDES_QCLC_CT_UC_PT_H__
