...
#ifndef __REGISTER_INCLUDES_QLC_QAC_DIS_CNT_MUTABLE_H__
#define __REGISTER_INCLUDES_QLC_QAC_DIS_CNT_MUTABLE_H__
...
class QlcQacDisCntMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  QlcQacDisCntMutable(
      int chipNumber, int index_tm_qlc_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_qlc_pipe_rspec), 8, true, write_callback, read_callback, std::string("QlcQacDisCntMutable")+":"+boost::lexical_cast<std::string>(index_tm_qlc_pipe_rspec))
    {
    }
  QlcQacDisCntMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "QlcQacDisCntMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("QlcQacDisCntMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x120; // to get to qac_dis_cnt
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_QLC_QAC_DIS_CNT_MUTABLE_H__
