...
#ifndef __REGISTER_INCLUDES_QLC_TOT_EQ_CNT_MUTABLE_H__
#define __REGISTER_INCLUDES_QLC_TOT_EQ_CNT_MUTABLE_H__
...
class QlcTotEqCntMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  QlcTotEqCntMutable(
      int chipNumber, int index_tm_qlc_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_qlc_pipe_rspec), 8, true, write_callback, read_callback, std::string("QlcTotEqCntMutable")+":"+boost::lexical_cast<std::string>(index_tm_qlc_pipe_rspec))
    {
    }
  QlcTotEqCntMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "QlcTotEqCntMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("QlcTotEqCntMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x138; // to get to tot_eq_cnt
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_QLC_TOT_EQ_CNT_MUTABLE_H__
