...
#ifndef __REGISTER_INCLUDES_QUEUE_DROP_STATE_ARRAY_MUTABLE_H__
#define __REGISTER_INCLUDES_QUEUE_DROP_STATE_ARRAY_MUTABLE_H__
...
class QueueDropStateArrayMutable : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
...
public:
  QueueDropStateArrayMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_tm_qac_pipe_rspec, selector_pipe_block_reg), 4 * ArraySize(index_tm_qac_pipe_rspec, selector_pipe_block_reg, -1), true, write_callback, read_callback, std::string("QueueDropStateArrayMutable")+":"+boost::lexical_cast<std::string>(index_tm_qac_pipe_rspec) + "," + boost::lexical_cast<std::string>(selector_pipe_block_reg)),
...
public:
  ...
  void st(uint32_t a0,const uint32_t &v) 
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    array[a0].st(v);
  }
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("QueueDropStateArrayMutable") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
private:
  std::vector<QueueDropStateMutable> array;
  uint32_t size0_;
...
#endif // __REGISTER_INCLUDES_QUEUE_DROP_STATE_ARRAY_MUTABLE_H__
