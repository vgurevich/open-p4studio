...
#ifndef __REGISTER_INCLUDES_SALU_INSTR_OUTPUT_ALU_ARRAY_H__
#define __REGISTER_INCLUDES_SALU_INSTR_OUTPUT_ALU_ARRAY_H__
...
class SaluInstrOutputAluArray : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  SaluInstrOutputAluArray(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap, index_mau_meter_alu_group_addrmap), 4 * ArraySize(index_pipe_addrmap, index_mau_addrmap, index_mau_meter_alu_group_addrmap, -1), false, write_callback, read_callback, std::string("SaluInstrOutputAluArray")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_meter_alu_group_addrmap)),
...
public:
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("SaluInstrOutputAluArray") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
#endif // __REGISTER_INCLUDES_SALU_INSTR_OUTPUT_ALU_ARRAY_H__
