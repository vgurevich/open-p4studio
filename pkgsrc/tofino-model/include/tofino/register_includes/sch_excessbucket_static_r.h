...
#ifndef __REGISTER_INCLUDES_SCH_EXCESSBUCKET_STATIC_R_H__
#define __REGISTER_INCLUDES_SCH_EXCESSBUCKET_STATIC_R_H__
...
class SchExcessbucketStaticR : public model_core::RegisterBlock<RegisterCallback> {
public:
  SchExcessbucketStaticR(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_tm_sch_pipe_rspec, index_sch_excessbucket_static_r), 4, false, write_callback, read_callback, std::string("SchExcessbucketStaticR")+":"+boost::lexical_cast<std::string>(index_tm_sch_pipe_rspec) + "," + boost::lexical_cast<std::string>(index_sch_excessbucket_static_r))
    {
    }
  SchExcessbucketStaticR(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "SchExcessbucketStaticR")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("SchExcessbucketStaticR") + ":\n";
...
#endif // __REGISTER_INCLUDES_SCH_EXCESSBUCKET_STATIC_R_H__
