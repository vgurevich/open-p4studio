...
#ifndef __REGISTER_INCLUDES_SCH_LEAKYBUCKET_STATIC_R_H__
#define __REGISTER_INCLUDES_SCH_LEAKYBUCKET_STATIC_R_H__
...
class SchLeakybucketStaticR : public model_core::RegisterBlock<RegisterCallback> {
public:
...
public:
  SchLeakybucketStaticR(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_tm_sch_pipe_rspec, selector_tm_sch_pipe_rspec, index_sch_leakybucket_static_r), 4, false, write_callback, read_callback, std::string("SchLeakybucketStaticR")+":"+boost::lexical_cast<std::string>(index_tm_sch_pipe_rspec) + "," + boost::lexical_cast<std::string>(selector_tm_sch_pipe_rspec) + "," + boost::lexical_cast<std::string>(index_sch_leakybucket_static_r))
    {
    }
  SchLeakybucketStaticR(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "SchLeakybucketStaticR")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("SchLeakybucketStaticR") + ":\n";
...
#endif // __REGISTER_INCLUDES_SCH_LEAKYBUCKET_STATIC_R_H__
