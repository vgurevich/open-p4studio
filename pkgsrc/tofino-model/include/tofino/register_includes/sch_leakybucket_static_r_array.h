...
#ifndef __REGISTER_INCLUDES_SCH_LEAKYBUCKET_STATIC_R_ARRAY_H__
#define __REGISTER_INCLUDES_SCH_LEAKYBUCKET_STATIC_R_ARRAY_H__
...
class SchLeakybucketStaticRArray : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
...
public:
  SchLeakybucketStaticRArray(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_tm_sch_pipe_rspec, selector_tm_sch_pipe_rspec), 4 * ArraySize(index_tm_sch_pipe_rspec, selector_tm_sch_pipe_rspec, -1), false, write_callback, read_callback, std::string("SchLeakybucketStaticRArray")+":"+boost::lexical_cast<std::string>(index_tm_sch_pipe_rspec) + "," + boost::lexical_cast<std::string>(selector_tm_sch_pipe_rspec)),
...
public:
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("SchLeakybucketStaticRArray") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
private:
  std::vector<SchLeakybucketStaticR> array;
  uint32_t size0_;
...
#endif // __REGISTER_INCLUDES_SCH_LEAKYBUCKET_STATIC_R_ARRAY_H__
