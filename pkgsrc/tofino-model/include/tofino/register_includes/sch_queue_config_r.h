...
public:
  SchQueueConfigR(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_tm_sch_pipe_rspec, index_sch_queue_config_r), 4, false, write_callback, read_callback, std::string("SchQueueConfigR")+":"+boost::lexical_cast<std::string>(index_tm_sch_pipe_rspec) + "," + boost::lexical_cast<std::string>(index_sch_queue_config_r))
    {
    }
  SchQueueConfigR(
