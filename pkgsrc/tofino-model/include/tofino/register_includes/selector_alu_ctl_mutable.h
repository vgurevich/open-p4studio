...
#ifndef __REGISTER_INCLUDES_SELECTOR_ALU_CTL_MUTABLE_H__
#define __REGISTER_INCLUDES_SELECTOR_ALU_CTL_MUTABLE_H__
...
class SelectorAluCtlMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  SelectorAluCtlMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap, index_mau_meter_alu_group_addrmap), 4, true, write_callback, read_callback, std::string("SelectorAluCtlMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_meter_alu_group_addrmap))
    {
    }
  SelectorAluCtlMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "SelectorAluCtlMutable")
    {
    }
public:
  ...
  void sps_nonlinear_hash_enable(const uint8_t &v) { sps_nonlinear_hash_enable_=v; }



  uint8_t resilient_hash_enable() { return resilient_hash_enable_; }
  void resilient_hash_enable(const uint8_t &v) { resilient_hash_enable_=v; }




  uint8_t resilient_hash_mode() { return resilient_hash_mode_; }
  void resilient_hash_mode(const uint8_t &v) { resilient_hash_mode_=v; }
  ...
  void selector_fair_hash_select(const uint8_t &v) { selector_fair_hash_select_=v; }


  uint8_t selector_enable() { return selector_enable_; }
  void selector_enable(const uint8_t &v) { selector_enable_=v; }



  uint8_t selector_thread() { return selector_thread_; }
  void selector_thread(const uint8_t &v) { selector_thread_=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("SelectorAluCtlMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x10; // to get to selector_alu_ctl
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_SELECTOR_ALU_CTL_MUTABLE_H__
