...
#ifndef __REGISTER_INCLUDES_SERDES_ADDRMAP_ARRAY_MUTABLE_H__
#define __REGISTER_INCLUDES_SERDES_ADDRMAP_ARRAY_MUTABLE_H__
...
#include "serdes_addrmap_dummy_register_mutable.h"
#include "serdes_addrmap_mutable.h"

namespace tofino {
  namespace register_classes {

class SerdesAddrmapArrayMutable : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  SerdesAddrmapArrayMutable(
      int chipNumber, RegisterArrayCallback& write_callback = 0, RegisterArrayCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 4194304 * ArraySize(-1), true, write_callback, read_callback, std::string("SerdesAddrmapArrayMutable")),
...
public:
  SerdesAddrmapDummyRegisterMutable &dummy_register(uint32_t a0)
  {
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("SerdesAddrmapArrayMutable") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
private:
  std::vector<SerdesAddrmapMutable> array;
  uint32_t size0_;
...
#endif // __REGISTER_INCLUDES_SERDES_ADDRMAP_ARRAY_MUTABLE_H__
