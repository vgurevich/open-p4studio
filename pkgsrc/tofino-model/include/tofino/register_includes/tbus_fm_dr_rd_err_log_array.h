...
#ifndef __REGISTER_INCLUDES_TBUS_FM_DR_RD_ERR_LOG_ARRAY_H__
#define __REGISTER_INCLUDES_TBUS_FM_DR_RD_ERR_LOG_ARRAY_H__
...
class TbusFmDrRdErrLogArray : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  TbusFmDrRdErrLogArray(
      int chipNumber, RegisterArrayCallback& write_callback = 0, RegisterArrayCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 4 * ArraySize(-1), false, write_callback, read_callback, std::string("TbusFmDrRdErrLogArray")),
...
public:
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("TbusFmDrRdErrLogArray") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
private:
  std::vector<TbusFmDrRdErrLog> array;
  uint32_t size0_;
...
#endif // __REGISTER_INCLUDES_TBUS_FM_DR_RD_ERR_LOG_ARRAY_H__
