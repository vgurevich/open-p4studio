...
#ifndef __REGISTER_INCLUDES_TBUS_INT_STAT0_MUTABLE_H__
#define __REGISTER_INCLUDES_TBUS_INT_STAT0_MUTABLE_H__
...
class TbusIntStat0Mutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  TbusIntStat0Mutable(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 4, true, write_callback, read_callback, std::string("TbusIntStat0Mutable"))
    {
    }
  TbusIntStat0Mutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "TbusIntStat0Mutable")
    {
    }
public:
  ...
  void tx_dr_0_empty(const uint8_t &v) { tx_dr_0_empty_=v; }
  ...
  void tx_dr_1_empty(const uint8_t &v) { tx_dr_1_empty_=v; }
  ...
  void tx_dr_2_empty(const uint8_t &v) { tx_dr_2_empty_=v; }
  ...
  void tx_dr_3_empty(const uint8_t &v) { tx_dr_3_empty_=v; }
  ...
  void tx_dr_0_full(const uint8_t &v) { tx_dr_0_full_=v; }
  ...
  void tx_dr_1_full(const uint8_t &v) { tx_dr_1_full_=v; }
  ...
  void tx_dr_2_full(const uint8_t &v) { tx_dr_2_full_=v; }
  ...
  void tx_dr_3_full(const uint8_t &v) { tx_dr_3_full_=v; }
  ...
  void cpl_dr_0_empty(const uint8_t &v) { cpl_dr_0_empty_=v; }
  ...
  void cpl_dr_1_empty(const uint8_t &v) { cpl_dr_1_empty_=v; }
  ...
  void cpl_dr_2_empty(const uint8_t &v) { cpl_dr_2_empty_=v; }
  ...
  void cpl_dr_3_empty(const uint8_t &v) { cpl_dr_3_empty_=v; }
  ...
  void cpl_dr_0_full(const uint8_t &v) { cpl_dr_0_full_=v; }
  ...
  void cpl_dr_1_full(const uint8_t &v) { cpl_dr_1_full_=v; }
  ...
  void cpl_dr_2_full(const uint8_t &v) { cpl_dr_2_full_=v; }
  ...
  void cpl_dr_3_full(const uint8_t &v) { cpl_dr_3_full_=v; }
  ...
  void tx_dr_0_rd_err(const uint8_t &v) { tx_dr_0_rd_err_=v; }
  ...
  void tx_dr_1_rd_err(const uint8_t &v) { tx_dr_1_rd_err_=v; }
  ...
  void tx_dr_2_rd_err(const uint8_t &v) { tx_dr_2_rd_err_=v; }
  ...
  void tx_dr_3_rd_err(const uint8_t &v) { tx_dr_3_rd_err_=v; }
  ...
  void fm_dr_0_rd_err(const uint8_t &v) { fm_dr_0_rd_err_=v; }
  ...
  void fm_dr_1_rd_err(const uint8_t &v) { fm_dr_1_rd_err_=v; }
  ...
  void fm_dr_2_rd_err(const uint8_t &v) { fm_dr_2_rd_err_=v; }
  ...
  void fm_dr_3_rd_err(const uint8_t &v) { fm_dr_3_rd_err_=v; }
  ...
  void fm_dr_4_rd_err(const uint8_t &v) { fm_dr_4_rd_err_=v; }
  ...
  void fm_dr_5_rd_err(const uint8_t &v) { fm_dr_5_rd_err_=v; }
  ...
  void fm_dr_6_rd_err(const uint8_t &v) { fm_dr_6_rd_err_=v; }
  ...
  void fm_dr_7_rd_err(const uint8_t &v) { fm_dr_7_rd_err_=v; }
  ...
  void tbus_flush_done(const uint8_t &v) { tbus_flush_done_=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("TbusIntStat0Mutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x1c; // to get to int_stat0
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_TBUS_INT_STAT0_MUTABLE_H__
