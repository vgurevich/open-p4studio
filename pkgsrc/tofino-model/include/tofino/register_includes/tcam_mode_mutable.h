...
#ifndef __REGISTER_INCLUDES_TCAM_MODE_MUTABLE_H__
#define __REGISTER_INCLUDES_TCAM_MODE_MUTABLE_H__
...
class TcamModeMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  TcamModeMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap, index_mau_tcam_column_addrmap, index_tcam_mode), 4, true, write_callback, read_callback, std::string("TcamModeMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_tcam_column_addrmap) + "," + boost::lexical_cast<std::string>(index_tcam_mode))
    {
    }
  TcamModeMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "TcamModeMutable")
    {
    }
public:
  uint16_t tcam_data_dirtcam_mode() { return tcam_data_dirtcam_mode_; }
  void tcam_data_dirtcam_mode(const uint16_t &v) { tcam_data_dirtcam_mode_=v; }



  uint8_t tcam_vbit_dirtcam_mode() { return tcam_vbit_dirtcam_mode_; }
  void tcam_vbit_dirtcam_mode(const uint8_t &v) { tcam_vbit_dirtcam_mode_=v; }



  uint8_t tcam_data1_select() { return tcam_data1_select_; }
  void tcam_data1_select(const uint8_t &v) { tcam_data1_select_=v; }




  uint8_t tcam_chain_out_enable() { return tcam_chain_out_enable_; }
  void tcam_chain_out_enable(const uint8_t &v) { tcam_chain_out_enable_=v; }
  uint8_t tcam_ingress() { return tcam_ingress_; }
  void tcam_ingress(const uint8_t &v) { tcam_ingress_=v; }
  uint8_t tcam_egress() { return tcam_egress_; }
  void tcam_egress(const uint8_t &v) { tcam_egress_=v; }




  uint8_t tcam_match_output_enable() { return tcam_match_output_enable_; }
  void tcam_match_output_enable(const uint8_t &v) { tcam_match_output_enable_=v; }
  ...
  void tcam_vpn(const uint8_t &v) { tcam_vpn_=v; }
  ...
  void tcam_logical_table(const uint8_t &v) { tcam_logical_table_=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("TcamModeMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_TCAM_MODE_MUTABLE_H__
