...
#ifndef __REGISTER_INCLUDES_TM_CAA_CDM_RSPEC_INTR_H__
#define __REGISTER_INCLUDES_TM_CAA_CDM_RSPEC_INTR_H__
...
#include "tm_caa_cdm_rspec_intr_enable0.h"
#include "tm_caa_cdm_rspec_intr_enable1.h"
#include "tm_caa_cdm_rspec_intr_freeze_enable.h"
#include "tm_caa_cdm_rspec_intr_inject.h"
#include "tm_caa_cdm_rspec_intr_status.h"

namespace tofino {
  namespace register_classes {

class TmCaaCdmRspecIntr : public model_core::RegisterBlock<RegisterCallback> {
public:
  TmCaaCdmRspecIntr(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 20, false, write_callback, read_callback, std::string("TmCaaCdmRspecIntr"))
    {
    }
  TmCaaCdmRspecIntr(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "TmCaaCdmRspecIntr")
    {
    }
public:
  ...
  TmCaaCdmRspecIntrStatus &intr_status() { return intr_status_; }
  ...
  TmCaaCdmRspecIntrEnable0 &intr_enable0() { return intr_enable0_; }
  ...
  TmCaaCdmRspecIntrEnable1 &intr_enable1() { return intr_enable1_; }
  ...
  TmCaaCdmRspecIntrInject &intr_inject() { return intr_inject_; }





  TmCaaCdmRspecIntrFreezeEnable &intr_freeze_enable() { return intr_freeze_enable_; }
...
private:
  TmCaaCdmRspecIntrStatus intr_status_;
  TmCaaCdmRspecIntrEnable0 intr_enable0_;
  TmCaaCdmRspecIntrEnable1 intr_enable1_;
  TmCaaCdmRspecIntrInject intr_inject_;
  TmCaaCdmRspecIntrFreezeEnable intr_freeze_enable_;
private:
...
#endif // __REGISTER_INCLUDES_TM_CAA_CDM_RSPEC_INTR_H__
