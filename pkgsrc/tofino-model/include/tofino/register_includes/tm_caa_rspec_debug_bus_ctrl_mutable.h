...
#ifndef __REGISTER_INCLUDES_TM_CAA_RSPEC_DEBUG_BUS_CTRL_MUTABLE_H__
#define __REGISTER_INCLUDES_TM_CAA_RSPEC_DEBUG_BUS_CTRL_MUTABLE_H__
...
class TmCaaRspecDebugBusCtrlMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  TmCaaRspecDebugBusCtrlMutable(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 4, true, write_callback, read_callback, std::string("TmCaaRspecDebugBusCtrlMutable"))
    {
    }
  TmCaaRspecDebugBusCtrlMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "TmCaaRspecDebugBusCtrlMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("TmCaaRspecDebugBusCtrlMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x3064; // to get to debug_bus_ctrl
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_TM_CAA_RSPEC_DEBUG_BUS_CTRL_MUTABLE_H__
