...
#ifndef __REGISTER_INCLUDES_TM_CAA_RSPEC_INTR_ENABLE0_H__
#define __REGISTER_INCLUDES_TM_CAA_RSPEC_INTR_ENABLE0_H__
...
class TmCaaRspecIntrEnable0 : public model_core::RegisterBlock<RegisterCallback> {
public:
  TmCaaRspecIntrEnable0(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 4, false, write_callback, read_callback, std::string("TmCaaRspecIntrEnable0"))
    {
    }
  TmCaaRspecIntrEnable0(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "TmCaaRspecIntrEnable0")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("TmCaaRspecIntrEnable0") + ":\n";
...
#endif // __REGISTER_INCLUDES_TM_CAA_RSPEC_INTR_ENABLE0_H__
