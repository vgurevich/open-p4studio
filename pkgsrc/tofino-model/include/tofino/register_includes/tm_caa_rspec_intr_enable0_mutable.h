...
#ifndef __REGISTER_INCLUDES_TM_CAA_RSPEC_INTR_ENABLE0_MUTABLE_H__
#define __REGISTER_INCLUDES_TM_CAA_RSPEC_INTR_ENABLE0_MUTABLE_H__
...
class TmCaaRspecIntrEnable0Mutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  TmCaaRspecIntrEnable0Mutable(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 4, true, write_callback, read_callback, std::string("TmCaaRspecIntrEnable0Mutable"))
    {
    }
  TmCaaRspecIntrEnable0Mutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "TmCaaRspecIntrEnable0Mutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("TmCaaRspecIntrEnable0Mutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_TM_CAA_RSPEC_INTR_ENABLE0_MUTABLE_H__
