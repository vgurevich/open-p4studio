...
#ifndef __REGISTER_INCLUDES_TM_CAA_RSPEC_INTR_INJECT_MUTABLE_H__
#define __REGISTER_INCLUDES_TM_CAA_RSPEC_INTR_INJECT_MUTABLE_H__
...
class TmCaaRspecIntrInjectMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  TmCaaRspecIntrInjectMutable(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 4, true, write_callback, read_callback, std::string("TmCaaRspecIntrInjectMutable"))
    {
    }
  TmCaaRspecIntrInjectMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "TmCaaRspecIntrInjectMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("TmCaaRspecIntrInjectMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_TM_CAA_RSPEC_INTR_INJECT_MUTABLE_H__
