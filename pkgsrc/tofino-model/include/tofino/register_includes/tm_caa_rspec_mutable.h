...
#ifndef __REGISTER_INCLUDES_TM_CAA_RSPEC_MUTABLE_H__
#define __REGISTER_INCLUDES_TM_CAA_RSPEC_MUTABLE_H__
...
#include "tm_caa_rspec_debug_bus_ctrl_mutable.h"
#include "tm_caa_rspec_ecc_mutable.h"
#include "tm_caa_rspec_intr_mutable.h"
#include "tm_caa_rspec_linkmem_mbe_errlog_mutable.h"
#include "tm_caa_rspec_linkmem_sbe_errlog_mutable.h"
#include "tm_caa_rspec_lmem_indir_access_addr_mutable.h"
#include "tm_caa_rspec_overflow_errlog_mutable.h"
#include "tm_caa_rspec_underflow_errlog_mutable.h"

namespace tofino {
  namespace register_classes {

class TmCaaRspecMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  TmCaaRspecMutable(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 262144, true, write_callback, read_callback, std::string("TmCaaRspecMutable"))
    {
    }
  TmCaaRspecMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "TmCaaRspecMutable")
    {
    }
public:
  ...
  CaaIndirAccessAddrRMutable &bank_indir_access_addr() { return bank_indir_access_addr_; }
  ...
  CaaBankCtrlRMutable &bank_indir_access_data() { return bank_indir_access_data_; }
  ...
  TmCaaRspecLmemIndirAccessAddrMutable &lmem_indir_access_addr() { return lmem_indir_access_addr_; }
  ...
  TmCaaRspecEccMutable &ecc() { return ecc_; }





  TmCaaRspecLinkmemSbeErrlogMutable &linkmem_sbe_errlog() { return linkmem_sbe_errlog_; }





  TmCaaRspecLinkmemMbeErrlogMutable &linkmem_mbe_errlog() { return linkmem_mbe_errlog_; }





  TmCaaRspecOverflowErrlogMutable &overflow_errlog() { return overflow_errlog_; }





  TmCaaRspecUnderflowErrlogMutable &underflow_errlog() { return underflow_errlog_; }





  TmCaaRspecDebugBusCtrlMutable &debug_bus_ctrl() { return debug_bus_ctrl_; }





  TmCaaCdmRspecMutable &cdm() { return cdm_; }
  ...
  TmCaaRspecIntrMutable &intr() { return intr_; }
...
private:
  ...
  CaaIndirAccessAddrRMutable bank_indir_access_addr_;
  CaaBankCtrlRMutable bank_indir_access_data_;
  TmCaaRspecLmemIndirAccessAddrMutable lmem_indir_access_addr_;
  CaaBlockLinkmemRMutable lmem_indir_access_data_;
  TmCaaRspecEccMutable ecc_;
  TmCaaRspecLinkmemSbeErrlogMutable linkmem_sbe_errlog_;
  TmCaaRspecLinkmemMbeErrlogMutable linkmem_mbe_errlog_;
  TmCaaRspecOverflowErrlogMutable overflow_errlog_;
  TmCaaRspecUnderflowErrlogMutable underflow_errlog_;
  TmCaaRspecDebugBusCtrlMutable debug_bus_ctrl_;
  TmCaaCdmRspecMutable cdm_;
  std::array< CaaEpipeGMutable, 4 > epipe_;
  std::array< CaaBlockGMutable, 28 > block_;
  TmCaaRspecIntrMutable intr_;
private:
...
#endif // __REGISTER_INCLUDES_TM_CAA_RSPEC_MUTABLE_H__
