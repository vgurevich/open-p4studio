...
#ifndef __REGISTER_INCLUDES_TM_CLC_PIPE_RSPEC_INTR_H__
#define __REGISTER_INCLUDES_TM_CLC_PIPE_RSPEC_INTR_H__
...
#include "tm_clc_pipe_rspec_intr_enable0.h"
#include "tm_clc_pipe_rspec_intr_enable1.h"
#include "tm_clc_pipe_rspec_intr_freeze_enable.h"
#include "tm_clc_pipe_rspec_intr_inject.h"
#include "tm_clc_pipe_rspec_intr_status.h"

namespace tofino {
  namespace register_classes {

class TmClcPipeRspecIntr : public model_core::RegisterBlock<RegisterCallback> {
public:
  TmClcPipeRspecIntr(
      int chipNumber, int index_tm_clc_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_clc_pipe_rspec), 20, false, write_callback, read_callback, std::string("TmClcPipeRspecIntr")+":"+boost::lexical_cast<std::string>(index_tm_clc_pipe_rspec))
    {
    }
  TmClcPipeRspecIntr(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "TmClcPipeRspecIntr")
    {
    }
public:
  ...
  TmClcPipeRspecIntrStatus &intr_status() { return intr_status_; }
  ...
  TmClcPipeRspecIntrEnable0 &intr_enable0() { return intr_enable0_; }
  ...
  TmClcPipeRspecIntrEnable1 &intr_enable1() { return intr_enable1_; }
  ...
  TmClcPipeRspecIntrInject &intr_inject() { return intr_inject_; }





  TmClcPipeRspecIntrFreezeEnable &intr_freeze_enable() { return intr_freeze_enable_; }
...
private:
  TmClcPipeRspecIntrStatus intr_status_;
  TmClcPipeRspecIntrEnable0 intr_enable0_;
  TmClcPipeRspecIntrEnable1 intr_enable1_;
  TmClcPipeRspecIntrInject intr_inject_;
  TmClcPipeRspecIntrFreezeEnable intr_freeze_enable_;
private:
...
#endif // __REGISTER_INCLUDES_TM_CLC_PIPE_RSPEC_INTR_H__
