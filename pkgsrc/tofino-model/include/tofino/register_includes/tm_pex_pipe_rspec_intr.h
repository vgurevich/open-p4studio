...
#ifndef __REGISTER_INCLUDES_TM_PEX_PIPE_RSPEC_INTR_H__
#define __REGISTER_INCLUDES_TM_PEX_PIPE_RSPEC_INTR_H__
...
#include "tm_pex_pipe_rspec_intr_enable0.h"
#include "tm_pex_pipe_rspec_intr_enable1.h"
#include "tm_pex_pipe_rspec_intr_freeze_enable.h"
#include "tm_pex_pipe_rspec_intr_inject.h"
#include "tm_pex_pipe_rspec_intr_status.h"

namespace tofino {
  namespace register_classes {

class TmPexPipeRspecIntr : public model_core::RegisterBlock<RegisterCallback> {
public:
  TmPexPipeRspecIntr(
      int chipNumber, int index_tm_pex_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_pex_pipe_rspec), 20, false, write_callback, read_callback, std::string("TmPexPipeRspecIntr")+":"+boost::lexical_cast<std::string>(index_tm_pex_pipe_rspec))
    {
    }
  TmPexPipeRspecIntr(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "TmPexPipeRspecIntr")
    {
    }
public:
  ...
  TmPexPipeRspecIntrStatus &intr_status() { return intr_status_; }
  ...
  TmPexPipeRspecIntrEnable0 &intr_enable0() { return intr_enable0_; }
  ...
  TmPexPipeRspecIntrEnable1 &intr_enable1() { return intr_enable1_; }
  ...
  TmPexPipeRspecIntrInject &intr_inject() { return intr_inject_; }





  TmPexPipeRspecIntrFreezeEnable &intr_freeze_enable() { return intr_freeze_enable_; }
...
private:
  TmPexPipeRspecIntrStatus intr_status_;
  TmPexPipeRspecIntrEnable0 intr_enable0_;
  TmPexPipeRspecIntrEnable1 intr_enable1_;
  TmPexPipeRspecIntrInject intr_inject_;
  TmPexPipeRspecIntrFreezeEnable intr_freeze_enable_;
private:
...
#endif // __REGISTER_INCLUDES_TM_PEX_PIPE_RSPEC_INTR_H__
