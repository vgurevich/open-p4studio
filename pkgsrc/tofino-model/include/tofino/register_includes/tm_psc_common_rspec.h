...
#include "tm_psc_common_rspec_linkmem_mbe_errlog.h"
#include "tm_psc_common_rspec_linkmem_sbe_errlog.h"
#include "tm_psc_common_rspec_lmem_indir_access_addr.h"
#include "tm_psc_common_rspec_overflow_errlog.h"
#include "tm_psc_common_rspec_underflow_errlog.h"
...
public:
  ...
  PscIndirAccessAddrR &bank_indir_access_addr() { return bank_indir_access_addr_; }
  ...
  PscBankCtrlR &bank_indir_access_data() { return bank_indir_access_data_; }
  ...
  TmPscCommonRspecLmemIndirAccessAddr &lmem_indir_access_addr() { return lmem_indir_access_addr_; }
  ...
  TmPscCommonRspecLinkmemSbeErrlog &linkmem_sbe_errlog() { return linkmem_sbe_errlog_; }





  TmPscCommonRspecLinkmemMbeErrlog &linkmem_mbe_errlog() { return linkmem_mbe_errlog_; }





  TmPscCommonRspecOverflowErrlog &overflow_errlog() { return overflow_errlog_; }





  TmPscCommonRspecUnderflowErrlog &underflow_errlog() { return underflow_errlog_; }
...
private:
  ...
  PscIndirAccessAddrR bank_indir_access_addr_;
  PscBankCtrlR bank_indir_access_data_;
  TmPscCommonRspecLmemIndirAccessAddr lmem_indir_access_addr_;
  PscBlockLinkmemR lmem_indir_access_data_;
  TmPscCommonRspecEcc ecc_;
  TmPscCommonRspecLinkmemSbeErrlog linkmem_sbe_errlog_;
  TmPscCommonRspecLinkmemMbeErrlog linkmem_mbe_errlog_;
  TmPscCommonRspecOverflowErrlog overflow_errlog_;
  TmPscCommonRspecUnderflowErrlog underflow_errlog_;
  std::array< PscEpipeG, 4 > epipe_;
  std::array< PscBlockG, 36 > block_;
