...
#ifndef __REGISTER_INCLUDES_TM_PSC_COMMON_RSPEC_INTR_ENABLE1_H__
#define __REGISTER_INCLUDES_TM_PSC_COMMON_RSPEC_INTR_ENABLE1_H__
...
class TmPscCommonRspecIntrEnable1 : public model_core::RegisterBlock<RegisterCallback> {
public:
  TmPscCommonRspecIntrEnable1(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 4, false, write_callback, read_callback, std::string("TmPscCommonRspecIntrEnable1"))
    {
    }
  TmPscCommonRspecIntrEnable1(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "TmPscCommonRspecIntrEnable1")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("TmPscCommonRspecIntrEnable1") + ":\n";
...
#endif // __REGISTER_INCLUDES_TM_PSC_COMMON_RSPEC_INTR_ENABLE1_H__
