...
#ifndef __REGISTER_INCLUDES_TM_PSC_COMMON_RSPEC_INTR_ENABLE1_MUTABLE_H__
#define __REGISTER_INCLUDES_TM_PSC_COMMON_RSPEC_INTR_ENABLE1_MUTABLE_H__
...
class TmPscCommonRspecIntrEnable1Mutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  TmPscCommonRspecIntrEnable1Mutable(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 4, true, write_callback, read_callback, std::string("TmPscCommonRspecIntrEnable1Mutable"))
    {
    }
  TmPscCommonRspecIntrEnable1Mutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "TmPscCommonRspecIntrEnable1Mutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("TmPscCommonRspecIntrEnable1Mutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x3048; // to get to intr_enable1
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_TM_PSC_COMMON_RSPEC_INTR_ENABLE1_MUTABLE_H__
