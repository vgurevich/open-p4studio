...
#ifndef __REGISTER_INCLUDES_TM_PSC_COMMON_RSPEC_INTR_STATUS_H__
#define __REGISTER_INCLUDES_TM_PSC_COMMON_RSPEC_INTR_STATUS_H__
...
class TmPscCommonRspecIntrStatus : public model_core::RegisterBlock<RegisterCallback> {
public:
  TmPscCommonRspecIntrStatus(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 4, false, write_callback, read_callback, std::string("TmPscCommonRspecIntrStatus"))
    {
    }
  TmPscCommonRspecIntrStatus(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "TmPscCommonRspecIntrStatus")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("TmPscCommonRspecIntrStatus") + ":\n";
...
#endif // __REGISTER_INCLUDES_TM_PSC_COMMON_RSPEC_INTR_STATUS_H__
