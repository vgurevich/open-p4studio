...
#ifndef __REGISTER_INCLUDES_TM_PSC_COMMON_RSPEC_INTR_STATUS_MUTABLE_H__
#define __REGISTER_INCLUDES_TM_PSC_COMMON_RSPEC_INTR_STATUS_MUTABLE_H__
...
class TmPscCommonRspecIntrStatusMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  TmPscCommonRspecIntrStatusMutable(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 4, true, write_callback, read_callback, std::string("TmPscCommonRspecIntrStatusMutable"))
    {
    }
  TmPscCommonRspecIntrStatusMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "TmPscCommonRspecIntrStatusMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("TmPscCommonRspecIntrStatusMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_TM_PSC_COMMON_RSPEC_INTR_STATUS_MUTABLE_H__
