...
#ifndef __REGISTER_INCLUDES_TM_PSC_PIPE_RSPEC_DEBUG_BUS_CTRL_MUTABLE_H__
#define __REGISTER_INCLUDES_TM_PSC_PIPE_RSPEC_DEBUG_BUS_CTRL_MUTABLE_H__
...
class TmPscPipeRspecDebugBusCtrlMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  TmPscPipeRspecDebugBusCtrlMutable(
      int chipNumber, int index_tm_psc_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_psc_pipe_rspec), 4, true, write_callback, read_callback, std::string("TmPscPipeRspecDebugBusCtrlMutable")+":"+boost::lexical_cast<std::string>(index_tm_psc_pipe_rspec))
    {
    }
  TmPscPipeRspecDebugBusCtrlMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "TmPscPipeRspecDebugBusCtrlMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("TmPscPipeRspecDebugBusCtrlMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x58; // to get to debug_bus_ctrl
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_TM_PSC_PIPE_RSPEC_DEBUG_BUS_CTRL_MUTABLE_H__
