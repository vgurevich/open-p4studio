...
#ifndef __REGISTER_INCLUDES_TM_QAC_PIPE_RSPEC_H__
#define __REGISTER_INCLUDES_TM_QAC_PIPE_RSPEC_H__
...
#include "pipe_block_reg.h"
#include "qac_port_cell_count.h"
#include "qac_port_config.h"
#include "qac_port_wm_cell_count.h"
#include "qac_queue_ap_config.h"
#include "qac_queue_cell_count.h"
#include "qac_queue_color_limit.h"
#include "qac_queue_min_thrd_config.h"
#include "qac_queue_shr_thrd_config.h"
#include "qac_queue_wm_cell_count.h"

namespace tofino {
  namespace register_classes {

class TmQacPipeRspec : public model_core::RegisterBlock<RegisterCallback> {
public:
  TmQacPipeRspec(
      int chipNumber, int index_tm_qac_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_qac_pipe_rspec), 32768, false, write_callback, read_callback, std::string("TmQacPipeRspec")+":"+boost::lexical_cast<std::string>(index_tm_qac_pipe_rspec))
    {
    }
  TmQacPipeRspec(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "TmQacPipeRspec")
    {
    }
public:
  ...
  QacQueueMinThrdConfig &csr_mem_qac_queue_min_thrd_config() { return csr_mem_qac_queue_min_thrd_config_; }
  ...
  QacQueueShrThrdConfig &csr_mem_qac_queue_shr_thrd_config() { return csr_mem_qac_queue_shr_thrd_config_; }
  ...
  QacQueueApConfig &csr_mem_qac_queue_ap_config() { return csr_mem_qac_queue_ap_config_; }
  ...
  QacQueueColorLimit &csr_mem_qac_queue_color_limit() { return csr_mem_qac_queue_color_limit_; }
  ...
  QacQueueCellCount &csr_mem_qac_queue_cell_count() { return csr_mem_qac_queue_cell_count_; }
  ...
  QacQueueWmCellCount &csr_mem_qac_queue_wm_cell_count() { return csr_mem_qac_queue_wm_cell_count_; }
  ...
  QacPortWmCellCount &csr_mem_qac_port_wm_cell_count() { return csr_mem_qac_port_wm_cell_count_; }
  ...
  QacPortConfig &csr_mem_qac_port_config() { return csr_mem_qac_port_config_; }
  ...
  QacPortCellCount &csr_mem_qac_port_cell_count() { return csr_mem_qac_port_cell_count_; }
  PipeBlockReg &qac_reg() { return qac_reg_; }
...
private:
  QacQueueMinThrdConfig csr_mem_qac_queue_min_thrd_config_;
  QacQueueShrThrdConfig csr_mem_qac_queue_shr_thrd_config_;
  QacQueueApConfig csr_mem_qac_queue_ap_config_;
  QacQueueColorLimit csr_mem_qac_queue_color_limit_;
  QacQueueCellCount csr_mem_qac_queue_cell_count_;
  QacQueueWmCellCount csr_mem_qac_queue_wm_cell_count_;
  QacPortWmCellCount csr_mem_qac_port_wm_cell_count_;
  QacPortConfig csr_mem_qac_port_config_;
  QacPortCellCount csr_mem_qac_port_cell_count_;
  PipeBlockReg qac_reg_;
private:
...
#endif // __REGISTER_INCLUDES_TM_QAC_PIPE_RSPEC_H__
