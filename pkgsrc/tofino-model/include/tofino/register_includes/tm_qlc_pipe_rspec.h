...
public:
  ...
  TmQlcPipeRspecLinkmemMbeErrlog &linkmem_mbe_errlog() { return linkmem_mbe_errlog_; }





  TmQlcPipeRspecLinkmemSbeErrlog &linkmem_sbe_errlog() { return linkmem_sbe_errlog_; }
  ...
  QlcIndAddr &ind_target() { return ind_target_; }
  ...
  QlcIndData &ind_data() { return ind_data_; }
...
private:
  ...
  TmQlcPipeRspecLinkmemMbeErrlog linkmem_mbe_errlog_;
  TmQlcPipeRspecLinkmemSbeErrlog linkmem_sbe_errlog_;
  std::array< QlcDisQlen, 32 > dis_qlen_;
  QlcDisCred dis_cred_;
  QlcIndAddr ind_target_;
  QlcIndData ind_data_;
