...
public:
  TmSchPipeRspecDebugBusCtrl(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_tm_sch_pipe_rspec), 4, false, write_callback, read_callback, std::string("TmSchPipeRspecDebugBusCtrl")+":"+boost::lexical_cast<std::string>(index_tm_sch_pipe_rspec))
    {
    }
  TmSchPipeRspecDebugBusCtrl(
