...
public:
  TmSchPipeRspecDebugBusCtrlMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_tm_sch_pipe_rspec), 4, true, write_callback, read_callback, std::string("TmSchPipeRspecDebugBusCtrlMutable")+":"+boost::lexical_cast<std::string>(index_tm_sch_pipe_rspec))
    {
    }
  TmSchPipeRspecDebugBusCtrlMutable(
...
private:
  static int StartOffset(
    ...
    offset += 0x9900; // to get to debug_bus_ctrl
    return offset;
  }
