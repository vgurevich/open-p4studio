...
#ifndef __REGISTER_INCLUDES_TM_SCH_PIPE_RSPEC_Q_MINRATE_MBE_ERRLOG_H__
#define __REGISTER_INCLUDES_TM_SCH_PIPE_RSPEC_Q_MINRATE_MBE_ERRLOG_H__
...
public:
  TmSchPipeRspecQMinrateMbeErrlog(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_tm_sch_pipe_rspec), 4, false, write_callback, read_callback, std::string("TmSchPipeRspecQMinrateMbeErrlog")+":"+boost::lexical_cast<std::string>(index_tm_sch_pipe_rspec))
    {
    }
  TmSchPipeRspecQMinrateMbeErrlog(
...
#endif // __REGISTER_INCLUDES_TM_SCH_PIPE_RSPEC_Q_MINRATE_MBE_ERRLOG_H__
