...
#ifndef __REGISTER_INCLUDES_TM_SCH_PIPE_RSPEC_UPD_EDPRSR_MBE_ERRLOG_H__
#define __REGISTER_INCLUDES_TM_SCH_PIPE_RSPEC_UPD_EDPRSR_MBE_ERRLOG_H__
...
public:
  TmSchPipeRspecUpdEdprsrMbeErrlog(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_tm_sch_pipe_rspec), 4, false, write_callback, read_callback, std::string("TmSchPipeRspecUpdEdprsrMbeErrlog")+":"+boost::lexical_cast<std::string>(index_tm_sch_pipe_rspec))
    {
    }
  TmSchPipeRspecUpdEdprsrMbeErrlog(
...
#endif // __REGISTER_INCLUDES_TM_SCH_PIPE_RSPEC_UPD_EDPRSR_MBE_ERRLOG_H__
