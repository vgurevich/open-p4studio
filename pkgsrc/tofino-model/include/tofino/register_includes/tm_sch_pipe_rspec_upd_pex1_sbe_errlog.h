...
#ifndef __REGISTER_INCLUDES_TM_SCH_PIPE_RSPEC_UPD_PEX1_SBE_ERRLOG_H__
#define __REGISTER_INCLUDES_TM_SCH_PIPE_RSPEC_UPD_PEX1_SBE_ERRLOG_H__
...
public:
  TmSchPipeRspecUpdPex1SbeErrlog(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_tm_sch_pipe_rspec), 4, false, write_callback, read_callback, std::string("TmSchPipeRspecUpdPex1SbeErrlog")+":"+boost::lexical_cast<std::string>(index_tm_sch_pipe_rspec))
    {
    }
  TmSchPipeRspecUpdPex1SbeErrlog(
...
#endif // __REGISTER_INCLUDES_TM_SCH_PIPE_RSPEC_UPD_PEX1_SBE_ERRLOG_H__
