...
#include "wac_queue_state_shadow.h"
...
public:
  WacCommonBlockDropSt(
    ...
    : RegisterBlock(chipNumber, StartOffset(), 6400, false, write_callback, read_callback, std::string("WacCommonBlockDropSt"))
    {
    }
  WacCommonBlockDropSt(
...
public:
  ...
  WacQueueStateShadow &wac_common_block_drop_st_wac_queue_state_shadow(int j0) { return wac_common_block_drop_st_wac_queue_state_shadow_[j0]; }
...
private:
  ...
  std::array< WacQueueStateShadow, 576 > wac_common_block_drop_st_wac_queue_state_shadow_;
private:
