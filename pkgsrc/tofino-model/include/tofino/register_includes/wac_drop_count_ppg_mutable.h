...
#ifndef __REGISTER_INCLUDES_WAC_DROP_COUNT_PPG_MUTABLE_H__
#define __REGISTER_INCLUDES_WAC_DROP_COUNT_PPG_MUTABLE_H__
...
class WacDropCountPpgMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  WacDropCountPpgMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_tm_wac_pipe_rspec, index_wac_drop_count_ppg), 8, true, write_callback, read_callback, std::string("WacDropCountPpgMutable")+":"+boost::lexical_cast<std::string>(index_tm_wac_pipe_rspec) + "," + boost::lexical_cast<std::string>(index_wac_drop_count_ppg))
    {
    }
  WacDropCountPpgMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "WacDropCountPpgMutable")
    {
    }
public:
  ...
  void ecc(const uint8_t &v) { ecc_=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("WacDropCountPpgMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_WAC_DROP_COUNT_PPG_MUTABLE_H__
