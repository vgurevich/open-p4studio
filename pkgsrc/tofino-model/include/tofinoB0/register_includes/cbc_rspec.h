...
public:
  CbcRspec(
    ...
    : RegisterBlock(chipNumber, StartOffset(), 492, false, write_callback, read_callback, std::string("CbcRspec"))
    {
    }
  CbcRspec(
...
public:
  ...
  DruRspec &cbc_wl_tx_dr() { return cbc_wl_tx_dr_; }





  DruRspec &cbc_wl_cpl_dr() { return cbc_wl_cpl_dr_; }
...
private:
  CbusRspec cbc_cbus_;
  DruRspec cbc_wl_tx_dr_;
  DruRspec cbc_wl_cpl_dr_;
