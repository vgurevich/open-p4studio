...
#include "cbus_dma_statemachine_mutable.h"
#include "cbus_flush_mutable.h"
#include "cbus_freeze_en_mutable.h"
#include "cbus_host_creq_credit_mutable.h"
#include "cbus_host_slv_credit_mutable.h"
#include "cbus_int_en_0_mutable.h"
#include "cbus_int_en_1_mutable.h"
#include "cbus_int_inj_mutable.h"
#include "cbus_int_stat_mutable.h"
...
public:
  CbusRspecMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(), 168, true, write_callback, read_callback, std::string("CbusRspecMutable"))
    {
    }
  CbusRspecMutable(
...
public:
  ...
  CbusIntStatMutable &int_stat() { return int_stat_; }





  CbusIntEn_0Mutable &int_en_0() { return int_en_0_; }





  CbusIntEn_1Mutable &int_en_1() { return int_en_1_; }





  CbusFreezeEnMutable &freeze_en() { return freeze_en_; }





  CbusIntInjMutable &int_inj() { return int_inj_; }





  CbusWlTxDrRdErrLogMutable &wl_tx_dr_rd_err_log() { return wl_tx_dr_rd_err_log_; }
  ...
  CbusDmaStatemachineMutable &dma_statemachine() { return dma_statemachine_; }
...
private:
  ...
  CbusIntStatMutable int_stat_;
  CbusIntEn_0Mutable int_en_0_;
  CbusIntEn_1Mutable int_en_1_;
  CbusFreezeEnMutable freeze_en_;
  CbusIntInjMutable int_inj_;
  CbusWlTxDrRdErrLogMutable wl_tx_dr_rd_err_log_;
  ...
  std::array< CbusParityErrLogMutable, 6 > parity_err_log_;
  ...
  CbusDmaStatemachineMutable dma_statemachine_;
private:
