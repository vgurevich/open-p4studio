...
#ifndef __REGISTER_INCLUDES_CBUS_WL_CREQ_CREDIT_MUTABLE_H__
#define __REGISTER_INCLUDES_CBUS_WL_CREQ_CREDIT_MUTABLE_H__
...
class CbusWlCreqCreditMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  CbusWlCreqCreditMutable(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 12, true, write_callback, read_callback, std::string("CbusWlCreqCreditMutable"))
    {
    }
  CbusWlCreqCreditMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "CbusWlCreqCreditMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("CbusWlCreqCreditMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x90; // to get to wl_creq_credit
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_CBUS_WL_CREQ_CREDIT_MUTABLE_H__
