...
#include "gpio_regs_mutable.h"
#include "mac_addrmap_mutable.h"
...
public:
  ChipMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(), 67108864, true, write_callback, read_callback, std::string("ChipMutable"))
    {
    }
  ChipMutable(
...
public:
  ...
  SerdesAddrmapMutable &serdes(int j0) { return serdes_[j0]; }
  ...
  MacAddrmapMutable &macs(int j0) { return macs_[j0]; }





  GpioRegsMutable &ethgpiobr() { return ethgpiobr_; }





  GpioRegsMutable &ethgpiotl() { return ethgpiotl_; }
  ...
  bool read(
    ...
    else if (offset >= 0x1820000 && offset < 0x1840000) {
      offset -= 0x1820000;
      if (read_callback_) read_callback_();
      ethgpiobr_.read( offset, data );
    }
    else if (offset >= 0x1840000 && offset < 0x1860000) {
      offset -= 0x1840000;
      if (read_callback_) read_callback_();
...
private:
  ...
  std::array< SerdesAddrmapMutable, 2 > serdes_;
  std::array< MacAddrmapMutable, 65 > macs_;
  GpioRegsMutable ethgpiobr_;
  GpioRegsMutable ethgpiotl_;
