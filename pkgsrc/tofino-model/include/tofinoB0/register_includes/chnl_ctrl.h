...
public:
  ChnlCtrl(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_ibp_rspec, selector_ing_buf_regs), 4, false, write_callback, read_callback, std::string("ChnlCtrl")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_ibp_rspec) + "," + boost::lexical_cast<std::string>(selector_ing_buf_regs))
    {
    }
  ChnlCtrl(
