...
public:
  ChnlPktnum1Mutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_ibp_rspec, selector_ing_buf_regs), 4, true, write_callback, read_callback, std::string("ChnlPktnum1Mutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_ibp_rspec) + "," + boost::lexical_cast<std::string>(selector_ing_buf_regs))
    {
    }
  ChnlPktnum1Mutable(
...
public:
  ...
  void reg_rclean_cnt(const uint8_t &v) { reg_rclean_cnt_=v; }
  ...
  void reg_pclean_cnt(const uint8_t &v) { reg_pclean_cnt_=v; }
  ...
  void reg_dprs_cnt(const uint8_t &v) { reg_dprs_cnt_=v; }
