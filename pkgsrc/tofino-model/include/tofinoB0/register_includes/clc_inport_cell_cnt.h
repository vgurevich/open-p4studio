...
#ifndef __REGISTER_INCLUDES_CLC_INPORT_CELL_CNT_H__
#define __REGISTER_INCLUDES_CLC_INPORT_CELL_CNT_H__
...
class ClcInportCellCnt : public model_core::RegisterBlock<RegisterCallback> {
public:
  ClcInportCellCnt(
      int chipNumber, int index_tm_clc_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_clc_pipe_rspec), 8, false, write_callback, read_callback, std::string("ClcInportCellCnt")+":"+boost::lexical_cast<std::string>(index_tm_clc_pipe_rspec))
    {
    }
  ClcInportCellCnt(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "ClcInportCellCnt")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("ClcInportCellCnt") + ":\n";
...
#endif // __REGISTER_INCLUDES_CLC_INPORT_CELL_CNT_H__
