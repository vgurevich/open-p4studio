...
#ifndef __REGISTER_INCLUDES_CLC_INPORT_PKT_CNT_H__
#define __REGISTER_INCLUDES_CLC_INPORT_PKT_CNT_H__
...
class ClcInportPktCnt : public model_core::RegisterBlock<RegisterCallback> {
public:
  ClcInportPktCnt(
      int chipNumber, int index_tm_clc_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_clc_pipe_rspec), 8, false, write_callback, read_callback, std::string("ClcInportPktCnt")+":"+boost::lexical_cast<std::string>(index_tm_clc_pipe_rspec))
    {
    }
  ClcInportPktCnt(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "ClcInportPktCnt")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("ClcInportPktCnt") + ":\n";
...
#endif // __REGISTER_INCLUDES_CLC_INPORT_PKT_CNT_H__
