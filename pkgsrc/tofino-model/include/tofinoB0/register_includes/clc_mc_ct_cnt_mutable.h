...
#ifndef __REGISTER_INCLUDES_CLC_MC_CT_CNT_MUTABLE_H__
#define __REGISTER_INCLUDES_CLC_MC_CT_CNT_MUTABLE_H__
...
class ClcMcCtCntMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  ClcMcCtCntMutable(
      int chipNumber, int index_tm_clc_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_clc_pipe_rspec), 8, true, write_callback, read_callback, std::string("ClcMcCtCntMutable")+":"+boost::lexical_cast<std::string>(index_tm_clc_pipe_rspec))
    {
    }
  ClcMcCtCntMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "ClcMcCtCntMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("ClcMcCtCntMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x68; // to get to mc_ct_cnt
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_CLC_MC_CT_CNT_MUTABLE_H__
