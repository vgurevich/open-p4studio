...
#ifndef __REGISTER_INCLUDES_CLC_TOT_CELL_CNT_H__
#define __REGISTER_INCLUDES_CLC_TOT_CELL_CNT_H__
...
class ClcTotCellCnt : public model_core::RegisterBlock<RegisterCallback> {
public:
  ClcTotCellCnt(
      int chipNumber, int index_tm_clc_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_clc_pipe_rspec), 8, false, write_callback, read_callback, std::string("ClcTotCellCnt")+":"+boost::lexical_cast<std::string>(index_tm_clc_pipe_rspec))
    {
    }
  ClcTotCellCnt(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "ClcTotCellCnt")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("ClcTotCellCnt") + ":\n";
...
#endif // __REGISTER_INCLUDES_CLC_TOT_CELL_CNT_H__
