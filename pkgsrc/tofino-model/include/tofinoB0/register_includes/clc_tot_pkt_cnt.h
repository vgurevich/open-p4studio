...
#ifndef __REGISTER_INCLUDES_CLC_TOT_PKT_CNT_H__
#define __REGISTER_INCLUDES_CLC_TOT_PKT_CNT_H__
...
class ClcTotPktCnt : public model_core::RegisterBlock<RegisterCallback> {
public:
  ClcTotPktCnt(
      int chipNumber, int index_tm_clc_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_clc_pipe_rspec), 8, false, write_callback, read_callback, std::string("ClcTotPktCnt")+":"+boost::lexical_cast<std::string>(index_tm_clc_pipe_rspec))
    {
    }
  ClcTotPktCnt(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "ClcTotPktCnt")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("ClcTotPktCnt") + ":\n";
...
#endif // __REGISTER_INCLUDES_CLC_TOT_PKT_CNT_H__
