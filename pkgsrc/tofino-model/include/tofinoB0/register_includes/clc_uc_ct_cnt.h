...
#ifndef __REGISTER_INCLUDES_CLC_UC_CT_CNT_H__
#define __REGISTER_INCLUDES_CLC_UC_CT_CNT_H__
...
class ClcUcCtCnt : public model_core::RegisterBlock<RegisterCallback> {
public:
  ClcUcCtCnt(
      int chipNumber, int index_tm_clc_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_clc_pipe_rspec), 8, false, write_callback, read_callback, std::string("ClcUcCtCnt")+":"+boost::lexical_cast<std::string>(index_tm_clc_pipe_rspec))
    {
    }
  ClcUcCtCnt(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "ClcUcCtCnt")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("ClcUcCtCnt") + ":\n";
...
#endif // __REGISTER_INCLUDES_CLC_UC_CT_CNT_H__
