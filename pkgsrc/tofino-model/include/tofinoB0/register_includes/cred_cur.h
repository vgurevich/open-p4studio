...
#ifndef __REGISTER_INCLUDES_CRED_CUR_H__
#define __REGISTER_INCLUDES_CRED_CUR_H__
...
class CredCur : public model_core::RegisterBlock<RegisterCallback> {
public:
  CredCur(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_ibp_rspec), 4, false, write_callback, read_callback, std::string("CredCur")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_ibp_rspec))
    {
    }
  CredCur(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "CredCur")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("CredCur") + ":\n";
...
#endif // __REGISTER_INCLUDES_CRED_CUR_H__
