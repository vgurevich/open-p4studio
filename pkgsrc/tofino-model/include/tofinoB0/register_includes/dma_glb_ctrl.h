...
#ifndef __REGISTER_INCLUDES_DMA_GLB_CTRL_H__
#define __REGISTER_INCLUDES_DMA_GLB_CTRL_H__
...
class DmaGlbCtrl : public model_core::RegisterBlock<RegisterCallback> {
public:
  DmaGlbCtrl(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 4, false, write_callback, read_callback, std::string("DmaGlbCtrl"))
    {
    }
  DmaGlbCtrl(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "DmaGlbCtrl")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("DmaGlbCtrl") + ":\n";
...
private:
  static int StartOffset(
    ...
    int offset=0;
    offset += 0x14; // to get to pcie_regs_dma_glb_ctrl
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_DMA_GLB_CTRL_H__
