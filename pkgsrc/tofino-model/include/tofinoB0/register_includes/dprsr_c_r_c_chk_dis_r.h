...
#ifndef __REGISTER_INCLUDES_DPRSR_C_R_C_CHK_DIS_R_H__
#define __REGISTER_INCLUDES_DPRSR_C_R_C_CHK_DIS_R_H__
...
class DprsrCRCChkDisR : public model_core::RegisterBlock<RegisterCallback> {
public:
...
public:
  DprsrCRCChkDisR(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, selector_dprsr_reg_rspec), 12, false, write_callback, read_callback, std::string("DprsrCRCChkDisR")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(selector_dprsr_reg_rspec))
    {
    }
  DprsrCRCChkDisR(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "DprsrCRCChkDisR")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("DprsrCRCChkDisR") + ":\n";
...
#endif // __REGISTER_INCLUDES_DPRSR_C_R_C_CHK_DIS_R_H__
