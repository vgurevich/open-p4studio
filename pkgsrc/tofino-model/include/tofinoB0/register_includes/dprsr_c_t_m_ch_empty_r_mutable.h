...
#ifndef __REGISTER_INCLUDES_DPRSR_C_T_M_CH_EMPTY_R_MUTABLE_H__
#define __REGISTER_INCLUDES_DPRSR_C_T_M_CH_EMPTY_R_MUTABLE_H__
...
class DprsrCTMChEmptyRMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
...
public:
  DprsrCTMChEmptyRMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, selector_dprsr_reg_rspec), 12, true, write_callback, read_callback, std::string("DprsrCTMChEmptyRMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(selector_dprsr_reg_rspec))
    {
    }
  DprsrCTMChEmptyRMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "DprsrCTMChEmptyRMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("DprsrCTMChEmptyRMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_DPRSR_C_T_M_CH_EMPTY_R_MUTABLE_H__
