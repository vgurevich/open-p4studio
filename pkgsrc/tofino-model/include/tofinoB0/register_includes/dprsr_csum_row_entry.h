...
public:
  DprsrCsumRowEntry(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, selector_dprsr_hdr, index_dprsr_tphv_csum_cfg_entry_g, index_dprsr_csum_row_entry), 4, false, write_callback, read_callback, std::string("DprsrCsumRowEntry")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(selector_dprsr_hdr) + "," + boost::lexical_cast<std::string>(index_dprsr_tphv_csum_cfg_entry_g) + "," + boost::lexical_cast<std::string>(index_dprsr_csum_row_entry))
    {
    }
  DprsrCsumRowEntry(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, selector_dprsr_inp, index_dprsr_phv_csum_cfg_entry_g, index_dprsr_csum_row_entry), 4, false, write_callback, read_callback, std::string("DprsrCsumRowEntry")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(selector_dprsr_inp) + "," + boost::lexical_cast<std::string>(index_dprsr_phv_csum_cfg_entry_g) + "," + boost::lexical_cast<std::string>(index_dprsr_csum_row_entry))
    {
    }
  DprsrCsumRowEntry(
