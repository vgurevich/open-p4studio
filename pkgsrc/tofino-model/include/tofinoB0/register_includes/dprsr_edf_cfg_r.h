...
#ifndef __REGISTER_INCLUDES_DPRSR_EDF_CFG_R_H__
#define __REGISTER_INCLUDES_DPRSR_EDF_CFG_R_H__
...
class DprsrEdfCfgR : public model_core::RegisterBlock<RegisterCallback> {
public:
...
public:
  DprsrEdfCfgR(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, selector_dprsr_reg_rspec), 4, false, write_callback, read_callback, std::string("DprsrEdfCfgR")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(selector_dprsr_reg_rspec))
    {
    }
  DprsrEdfCfgR(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "DprsrEdfCfgR")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("DprsrEdfCfgR") + ":\n";
...
#endif // __REGISTER_INCLUDES_DPRSR_EDF_CFG_R_H__
