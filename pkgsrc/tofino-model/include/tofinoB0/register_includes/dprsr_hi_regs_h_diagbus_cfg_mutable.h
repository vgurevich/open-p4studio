...
#ifndef __REGISTER_INCLUDES_DPRSR_HI_REGS_H_DIAGBUS_CFG_MUTABLE_H__
#define __REGISTER_INCLUDES_DPRSR_HI_REGS_H_DIAGBUS_CFG_MUTABLE_H__
...
class DprsrHiRegsHDiagbusCfgMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  DprsrHiRegsHDiagbusCfgMutable(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 4, true, write_callback, read_callback, std::string("DprsrHiRegsHDiagbusCfgMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  DprsrHiRegsHDiagbusCfgMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "DprsrHiRegsHDiagbusCfgMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("DprsrHiRegsHDiagbusCfgMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x4c8; // to get to h_diagbus_cfg
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_DPRSR_HI_REGS_H_DIAGBUS_CFG_MUTABLE_H__
