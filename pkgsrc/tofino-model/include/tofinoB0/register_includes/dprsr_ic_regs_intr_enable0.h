...
#ifndef __REGISTER_INCLUDES_DPRSR_IC_REGS_INTR_ENABLE0_H__
#define __REGISTER_INCLUDES_DPRSR_IC_REGS_INTR_ENABLE0_H__
...
class DprsrIcRegsIntrEnable0 : public model_core::RegisterBlock<RegisterCallback> {
public:
  DprsrIcRegsIntrEnable0(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 4, false, write_callback, read_callback, std::string("DprsrIcRegsIntrEnable0")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  DprsrIcRegsIntrEnable0(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "DprsrIcRegsIntrEnable0")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("DprsrIcRegsIntrEnable0") + ":\n";
...
#endif // __REGISTER_INCLUDES_DPRSR_IC_REGS_INTR_ENABLE0_H__
