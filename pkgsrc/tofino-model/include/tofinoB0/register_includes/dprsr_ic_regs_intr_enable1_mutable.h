...
#ifndef __REGISTER_INCLUDES_DPRSR_IC_REGS_INTR_ENABLE1_MUTABLE_H__
#define __REGISTER_INCLUDES_DPRSR_IC_REGS_INTR_ENABLE1_MUTABLE_H__
...
class DprsrIcRegsIntrEnable1Mutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  DprsrIcRegsIntrEnable1Mutable(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 4, true, write_callback, read_callback, std::string("DprsrIcRegsIntrEnable1Mutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  DprsrIcRegsIntrEnable1Mutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "DprsrIcRegsIntrEnable1Mutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("DprsrIcRegsIntrEnable1Mutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0xc8; // to get to intr_enable1
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_DPRSR_IC_REGS_INTR_ENABLE1_MUTABLE_H__
