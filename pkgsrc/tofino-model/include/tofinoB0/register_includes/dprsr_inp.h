...
#include "dprsr_ie_mem.h"
#include "dprsr_ie_regs.h"
#include "dprsr_ii_mem.h"
#include "dprsr_ii_regs.h"
...
public:
  DprsrInp(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 39424, false, write_callback, read_callback, std::string("DprsrInp")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  DprsrInp(
...
public:
  ...
  DprsrIeMem &iem() { return iem_; }





  DprsrIiRegs &iir() { return iir_; }





  DprsrIeRegs &ier() { return ier_; }
