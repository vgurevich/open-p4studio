...
#ifndef __REGISTER_INCLUDES_DPRSR_OE_CRED_R_ARRAY_MUTABLE_H__
#define __REGISTER_INCLUDES_DPRSR_OE_CRED_R_ARRAY_MUTABLE_H__
...
class DprsrOeCredRArrayMutable : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  DprsrOeCredRArrayMutable(
      int chipNumber, int index_pipe_addrmap, RegisterArrayCallback& write_callback = 0, RegisterArrayCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 4 * ArraySize(index_pipe_addrmap, -1), true, write_callback, read_callback, std::string("DprsrOeCredRArrayMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap)),
...
public:
  uint8_t credits(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    return array[a0].credits();
  }
  void credits(uint32_t a0,const uint8_t &v) 
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    array[a0].credits(v);
  }
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("DprsrOeCredRArrayMutable") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
private:
  std::vector<DprsrOeCredRMutable> array;
  uint32_t size0_;
...
#endif // __REGISTER_INCLUDES_DPRSR_OE_CRED_R_ARRAY_MUTABLE_H__
