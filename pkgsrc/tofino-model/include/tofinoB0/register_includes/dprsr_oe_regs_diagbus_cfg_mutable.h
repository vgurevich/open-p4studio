...
#ifndef __REGISTER_INCLUDES_DPRSR_OE_REGS_DIAGBUS_CFG_MUTABLE_H__
#define __REGISTER_INCLUDES_DPRSR_OE_REGS_DIAGBUS_CFG_MUTABLE_H__
...
class DprsrOeRegsDiagbusCfgMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  DprsrOeRegsDiagbusCfgMutable(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 4, true, write_callback, read_callback, std::string("DprsrOeRegsDiagbusCfgMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  DprsrOeRegsDiagbusCfgMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "DprsrOeRegsDiagbusCfgMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("DprsrOeRegsDiagbusCfgMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x940; // to get to diagbus_cfg
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_DPRSR_OE_REGS_DIAGBUS_CFG_MUTABLE_H__
