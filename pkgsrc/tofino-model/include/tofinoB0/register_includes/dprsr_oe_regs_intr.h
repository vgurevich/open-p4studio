...
#ifndef __REGISTER_INCLUDES_DPRSR_OE_REGS_INTR_H__
#define __REGISTER_INCLUDES_DPRSR_OE_REGS_INTR_H__
...
#include "dprsr_oe_regs_intr_enable0.h"
#include "dprsr_oe_regs_intr_enable1.h"
#include "dprsr_oe_regs_intr_freeze_enable.h"
#include "dprsr_oe_regs_intr_inject.h"
#include "dprsr_oe_regs_intr_status.h"

namespace tofinoB0 {
  namespace register_classes {

class DprsrOeRegsIntr : public model_core::RegisterBlock<RegisterCallback> {
public:
  DprsrOeRegsIntr(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 20, false, write_callback, read_callback, std::string("DprsrOeRegsIntr")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  DprsrOeRegsIntr(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "DprsrOeRegsIntr")
    {
    }
public:
  ...
  DprsrOeRegsIntrStatus &intr_status() { return intr_status_; }
  ...
  DprsrOeRegsIntrEnable0 &intr_enable0() { return intr_enable0_; }
  ...
  DprsrOeRegsIntrEnable1 &intr_enable1() { return intr_enable1_; }
  ...
  DprsrOeRegsIntrInject &intr_inject() { return intr_inject_; }





  DprsrOeRegsIntrFreezeEnable &intr_freeze_enable() { return intr_freeze_enable_; }
...
private:
  DprsrOeRegsIntrStatus intr_status_;
  DprsrOeRegsIntrEnable0 intr_enable0_;
  DprsrOeRegsIntrEnable1 intr_enable1_;
  DprsrOeRegsIntrInject intr_inject_;
  DprsrOeRegsIntrFreezeEnable intr_freeze_enable_;
private:
...
#endif // __REGISTER_INCLUDES_DPRSR_OE_REGS_INTR_H__
