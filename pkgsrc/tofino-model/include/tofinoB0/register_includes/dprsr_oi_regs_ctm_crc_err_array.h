...
#ifndef __REGISTER_INCLUDES_DPRSR_OI_REGS_CTM_CRC_ERR_ARRAY_H__
#define __REGISTER_INCLUDES_DPRSR_OI_REGS_CTM_CRC_ERR_ARRAY_H__
...
class DprsrOiRegsCtmCrcErrArray : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  DprsrOiRegsCtmCrcErrArray(
      int chipNumber, int index_pipe_addrmap, RegisterArrayCallback& write_callback = 0, RegisterArrayCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 4 * ArraySize(index_pipe_addrmap, -1), false, write_callback, read_callback, std::string("DprsrOiRegsCtmCrcErrArray")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap)),
...
public:
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("DprsrOiRegsCtmCrcErrArray") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
private:
  std::vector<DprsrOiRegsCtmCrcErr> array;
  uint32_t size0_;
...
#endif // __REGISTER_INCLUDES_DPRSR_OI_REGS_CTM_CRC_ERR_ARRAY_H__
