...
#ifndef __REGISTER_INCLUDES_DPRSR_OI_REGS_CTM_CRC_ERR_ARRAY_MUTABLE_H__
#define __REGISTER_INCLUDES_DPRSR_OI_REGS_CTM_CRC_ERR_ARRAY_MUTABLE_H__
...
class DprsrOiRegsCtmCrcErrArrayMutable : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  DprsrOiRegsCtmCrcErrArrayMutable(
      int chipNumber, int index_pipe_addrmap, RegisterArrayCallback& write_callback = 0, RegisterArrayCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 4 * ArraySize(index_pipe_addrmap, -1), true, write_callback, read_callback, std::string("DprsrOiRegsCtmCrcErrArrayMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap)),
...
public:
  ...
  uint16_t ctr16(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    return array[a0].ctr16();
  }
  void ctr16(uint32_t a0,const uint16_t &v) 
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    array[a0].ctr16(v);
  }
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("DprsrOiRegsCtmCrcErrArrayMutable") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
private:
  std::vector<DprsrOiRegsCtmCrcErrMutable> array;
  uint32_t size0_;
...
#endif // __REGISTER_INCLUDES_DPRSR_OI_REGS_CTM_CRC_ERR_ARRAY_MUTABLE_H__
