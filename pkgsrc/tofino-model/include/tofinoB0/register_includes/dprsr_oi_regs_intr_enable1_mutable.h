...
#ifndef __REGISTER_INCLUDES_DPRSR_OI_REGS_INTR_ENABLE1_MUTABLE_H__
#define __REGISTER_INCLUDES_DPRSR_OI_REGS_INTR_ENABLE1_MUTABLE_H__
...
class DprsrOiRegsIntrEnable1Mutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  DprsrOiRegsIntrEnable1Mutable(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 4, true, write_callback, read_callback, std::string("DprsrOiRegsIntrEnable1Mutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  DprsrOiRegsIntrEnable1Mutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "DprsrOiRegsIntrEnable1Mutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("DprsrOiRegsIntrEnable1Mutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_DPRSR_OI_REGS_INTR_ENABLE1_MUTABLE_H__
