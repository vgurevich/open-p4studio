...
#ifndef __REGISTER_INCLUDES_DPRSR_OI_REGS_INTR_INJECT_H__
#define __REGISTER_INCLUDES_DPRSR_OI_REGS_INTR_INJECT_H__
...
class DprsrOiRegsIntrInject : public model_core::RegisterBlock<RegisterCallback> {
public:
  DprsrOiRegsIntrInject(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 4, false, write_callback, read_callback, std::string("DprsrOiRegsIntrInject")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  DprsrOiRegsIntrInject(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "DprsrOiRegsIntrInject")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("DprsrOiRegsIntrInject") + ":\n";
...
#endif // __REGISTER_INCLUDES_DPRSR_OI_REGS_INTR_INJECT_H__
