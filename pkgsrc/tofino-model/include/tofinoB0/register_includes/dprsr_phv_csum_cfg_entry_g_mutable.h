...
public:
  DprsrPhvCsumCfgEntryGMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, selector_dprsr_inp, index_dprsr_phv_csum_cfg_entry_g), 2048, true, write_callback, read_callback, std::string("DprsrPhvCsumCfgEntryGMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(selector_dprsr_inp) + "," + boost::lexical_cast<std::string>(index_dprsr_phv_csum_cfg_entry_g))
    {
    }
  DprsrPhvCsumCfgEntryGMutable(
...
private:
  std::array< DprsrCsumRowEntryMutable, 288 > csum_cfg_csum_cfg_entry_;
private:
