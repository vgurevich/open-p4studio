...
#ifndef __REGISTER_INCLUDES_DR_HEAD_PTR_H__
#define __REGISTER_INCLUDES_DR_HEAD_PTR_H__
...
class DrHeadPtr : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum CbcRspecEnum {
    kCbcLqFmDr,
    kCbcLqRxDr,
...
public:
  DrHeadPtr(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_cbc_rspec), 4, false, write_callback, read_callback, std::string("DrHeadPtr")+":"+boost::lexical_cast<std::string>(selector_cbc_rspec))
    {
    }
  DrHeadPtr(
      int chipNumber, MbcRspecEnum selector_mbc_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(selector_mbc_rspec), 4, false, write_callback, read_callback, std::string("DrHeadPtr")+":"+boost::lexical_cast<std::string>(selector_mbc_rspec))
    {
    }
  DrHeadPtr(
      int chipNumber, PbcRspecEnum selector_pbc_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(selector_pbc_rspec), 4, false, write_callback, read_callback, std::string("DrHeadPtr")+":"+boost::lexical_cast<std::string>(selector_pbc_rspec))
    {
    }
  DrHeadPtr(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_pbc_rspec, index_dru_rspec), 4, false, write_callback, read_callback, std::string("DrHeadPtr")+":"+boost::lexical_cast<std::string>(selector_pbc_rspec) + "," + boost::lexical_cast<std::string>(index_dru_rspec))
    {
    }
  DrHeadPtr(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_tbc_rspec, index_dru_rspec), 4, false, write_callback, read_callback, std::string("DrHeadPtr")+":"+boost::lexical_cast<std::string>(selector_tbc_rspec) + "," + boost::lexical_cast<std::string>(index_dru_rspec))
    {
    }
  DrHeadPtr(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "DrHeadPtr")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("DrHeadPtr") + ":\n";
...
#endif // __REGISTER_INCLUDES_DR_HEAD_PTR_H__
