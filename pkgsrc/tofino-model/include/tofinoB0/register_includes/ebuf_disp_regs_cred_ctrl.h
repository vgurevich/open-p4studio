...
#ifndef __REGISTER_INCLUDES_EBUF_DISP_REGS_CRED_CTRL_H__
#define __REGISTER_INCLUDES_EBUF_DISP_REGS_CRED_CTRL_H__
...
class EbufDispRegsCredCtrl : public model_core::RegisterBlock<RegisterCallback> {
public:
  EbufDispRegsCredCtrl(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_egrNx_regs), 4, false, write_callback, read_callback, std::string("EbufDispRegsCredCtrl")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_egrNx_regs))
    {
    }
  EbufDispRegsCredCtrl(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "EbufDispRegsCredCtrl")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("EbufDispRegsCredCtrl") + ":\n";
...
#endif // __REGISTER_INCLUDES_EBUF_DISP_REGS_CRED_CTRL_H__
