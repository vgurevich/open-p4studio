...
#ifndef __REGISTER_INCLUDES_EBUF_FIFO_REGS_INT_STAT_H__
#define __REGISTER_INCLUDES_EBUF_FIFO_REGS_INT_STAT_H__
...
class EbufFifoRegsIntStat : public model_core::RegisterBlock<RegisterCallback> {
public:
  EbufFifoRegsIntStat(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_egrNx_regs), 4, false, write_callback, read_callback, std::string("EbufFifoRegsIntStat")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_egrNx_regs))
    {
    }
  EbufFifoRegsIntStat(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "EbufFifoRegsIntStat")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("EbufFifoRegsIntStat") + ":\n";
...
#endif // __REGISTER_INCLUDES_EBUF_FIFO_REGS_INT_STAT_H__
