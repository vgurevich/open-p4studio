...
#ifndef __REGISTER_INCLUDES_EPB_DPRS_REGS_CRED_CUR_MUTABLE_H__
#define __REGISTER_INCLUDES_EPB_DPRS_REGS_CRED_CUR_MUTABLE_H__
...
class EpbDprsRegsCredCurMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  EpbDprsRegsCredCurMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_egrNx_regs), 4, true, write_callback, read_callback, std::string("EpbDprsRegsCredCurMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_egrNx_regs))
    {
    }
  EpbDprsRegsCredCurMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "EpbDprsRegsCredCurMutable")
    {
    }
public:
  ...
  void fc0_cred(const uint8_t &v) { fc0_cred_=v; }
  ...
  void fc1_cred(const uint8_t &v) { fc1_cred_=v; }
  ...
  void fc2_cred(const uint8_t &v) { fc2_cred_=v; }
  ...
  void fc3_cred(const uint8_t &v) { fc3_cred_=v; }
  ...
  void fc0_mod5(const uint8_t &v) { fc0_mod5_=v; }
  ...
  void fc1_mod5(const uint8_t &v) { fc1_mod5_=v; }
  ...
  void fc2_mod5(const uint8_t &v) { fc2_mod5_=v; }
  ...
  void fc3_mod5(const uint8_t &v) { fc3_mod5_=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("EpbDprsRegsCredCurMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_EPB_DPRS_REGS_CRED_CUR_MUTABLE_H__
