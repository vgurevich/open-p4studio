...
#ifndef __REGISTER_INCLUDES_ETH_REGS_EBUF_CRED_H__
#define __REGISTER_INCLUDES_ETH_REGS_EBUF_CRED_H__
...
class EthRegsEbufCred : public model_core::RegisterBlock<RegisterCallback> {
public:
  EthRegsEbufCred(
      int chipNumber, int index_mac_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_mac_addrmap), 4, false, write_callback, read_callback, std::string("EthRegsEbufCred")+":"+boost::lexical_cast<std::string>(index_mac_addrmap))
    {
    }
  EthRegsEbufCred(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "EthRegsEbufCred")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("EthRegsEbufCred") + ":\n";
...
#endif // __REGISTER_INCLUDES_ETH_REGS_EBUF_CRED_H__
