...
#ifndef __REGISTER_INCLUDES_ETH_REGS_INT_STAT_MUTABLE_H__
#define __REGISTER_INCLUDES_ETH_REGS_INT_STAT_MUTABLE_H__
...
class EthRegsIntStatMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  EthRegsIntStatMutable(
      int chipNumber, int index_mac_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_mac_addrmap), 4, true, write_callback, read_callback, std::string("EthRegsIntStatMutable")+":"+boost::lexical_cast<std::string>(index_mac_addrmap))
    {
    }
  EthRegsIntStatMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "EthRegsIntStatMutable")
    {
    }
public:
  ...
  void ethsds_lane0_dual_err(const uint8_t &v) { ethsds_lane0_dual_err_=v; }
  ...
  void ethsds_lane1_dual_err(const uint8_t &v) { ethsds_lane1_dual_err_=v; }
  ...
  void ethsds_lane2_dual_err(const uint8_t &v) { ethsds_lane2_dual_err_=v; }
  ...
  void ethsds_lane3_dual_err(const uint8_t &v) { ethsds_lane3_dual_err_=v; }
  ...
  void eth_txff_dual_err(const uint8_t &v) { eth_txff_dual_err_=v; }
  ...
  void eth_pfcff_dual_err(const uint8_t &v) { eth_pfcff_dual_err_=v; }
  ...
  void ethsds_lane0_sngl_err(const uint8_t &v) { ethsds_lane0_sngl_err_=v; }
  ...
  void ethsds_lane1_sngl_err(const uint8_t &v) { ethsds_lane1_sngl_err_=v; }
  ...
  void ethsds_lane2_sngl_err(const uint8_t &v) { ethsds_lane2_sngl_err_=v; }
  ...
  void ethsds_lane3_sngl_err(const uint8_t &v) { ethsds_lane3_sngl_err_=v; }
  ...
  void eth_txff_sngl_err(const uint8_t &v) { eth_txff_sngl_err_=v; }
  ...
  void eth_pfcff_sngl_err(const uint8_t &v) { eth_pfcff_sngl_err_=v; }
  ...
  void pfc_ovf0_int(const uint8_t &v) { pfc_ovf0_int_=v; }
  ...
  void pfc_ovf1_int(const uint8_t &v) { pfc_ovf1_int_=v; }
  ...
  void pfc_ovf2_int(const uint8_t &v) { pfc_ovf2_int_=v; }
  ...
  void pfc_ovf3_int(const uint8_t &v) { pfc_ovf3_int_=v; }
  ...
  void crc32err0_int(const uint8_t &v) { crc32err0_int_=v; }
  ...
  void crc32err1_int(const uint8_t &v) { crc32err1_int_=v; }
  ...
  void crc32err2_int(const uint8_t &v) { crc32err2_int_=v; }
  ...
  void crc32err3_int(const uint8_t &v) { crc32err3_int_=v; }
  ...
  void ethmac_glb_int(const uint8_t &v) { ethmac_glb_int_=v; }
  ...
  void txff_ovf0_int(const uint8_t &v) { txff_ovf0_int_=v; }
  ...
  void txff_ovf1_int(const uint8_t &v) { txff_ovf1_int_=v; }
  ...
  void txff_ovf2_int(const uint8_t &v) { txff_ovf2_int_=v; }
  ...
  void txff_ovf3_int(const uint8_t &v) { txff_ovf3_int_=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("EthRegsIntStatMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_ETH_REGS_INT_STAT_MUTABLE_H__
