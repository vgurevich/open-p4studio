...
#ifndef __REGISTER_INCLUDES_ETH_REGS_MUTABLE_H__
#define __REGISTER_INCLUDES_ETH_REGS_MUTABLE_H__
...
#include "eth_regs_ebuf_cred_mutable.h"
#include "eth_regs_eth_clkobs_ctrl_mutable.h"
#include "eth_regs_eth_gpio_ring_mutable.h"
#include "eth_regs_eth_mac_ts_offset_ctrl_mutable.h"
#include "eth_regs_eth_onestep_ets_offset_ctrl_mutable.h"
#include "eth_regs_eth_sel_altclk_mutable.h"
#include "eth_regs_eth_soft_reset_mutable.h"
#include "eth_regs_eth_status_mutable.h"
#include "eth_regs_eth_txff_err_addr_mutable.h"
#include "eth_regs_ethsds_core_cntl_mutable.h"
#include "eth_regs_ethsds_int_ctrl_mutable.h"
#include "eth_regs_ethsds_int_stat_mutable.h"
#include "eth_regs_ethsds_rxsigok_ctrl_mutable.h"
#include "eth_regs_ethsds_status0_mutable.h"
#include "eth_regs_ethsds_status1_mutable.h"
#include "eth_regs_force_pfc_flush_mutable.h"
#include "eth_regs_int_en_mutable.h"
#include "eth_regs_int_freeze_mutable.h"
#include "eth_regs_int_inj_mutable.h"
#include "eth_regs_int_pri_mutable.h"
#include "eth_regs_int_stat_mutable.h"
#include "eth_regs_min_thr_mutable.h"
#include "eth_regs_pfcff_ctrl_ro_mutable.h"
#include "eth_regs_port_alive_lut_mutable.h"
#include "eth_regs_rxpkt_err_hdr0_mutable.h"
#include "eth_regs_rxpkt_err_hdr1_mutable.h"
#include "eth_regs_rxpkt_err_hdr2_mutable.h"
#include "eth_regs_rxpkt_err_hdr3_mutable.h"
#include "eth_regs_rxpkt_err_sts_mutable.h"
#include "eth_regs_trunc_ctrl_mutable.h"
#include "eth_regs_tx_prbs23_mutable.h"
#include "eth_regs_txff_ctrl_mutable.h"
#include "eth_regs_txff_pream0_mutable.h"
#include "eth_regs_txff_pream1_mutable.h"

namespace tofinoB0 {
  namespace register_classes {

class EthRegsMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  EthRegsMutable(
      int chipNumber, int index_mac_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_mac_addrmap), 456, true, write_callback, read_callback, std::string("EthRegsMutable")+":"+boost::lexical_cast<std::string>(index_mac_addrmap))
    {
    }
  EthRegsMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "EthRegsMutable")
    {
    }
public:
  ...
  EthRegsEthSoftResetMutable &eth_soft_reset() { return eth_soft_reset_; }





  EthRegsEthSelAltclkMutable &eth_sel_altclk() { return eth_sel_altclk_; }
  ...
  EthRegsEthsdsIntCtrlMutable &ethsds_int_broadcast() { return ethsds_int_broadcast_; }





  EthRegsEthMacTsOffsetCtrlMutable &eth_mac_ts_offset_ctrl() { return eth_mac_ts_offset_ctrl_; }
  ...
  EthRegsEthsdsIntCtrlMutable &ethsds_int_ctrl(int j0) { return ethsds_int_ctrl_[j0]; }
  ...
  EthRegsEthsdsIntStatMutable &ethsds_int_stat(int j0) { return ethsds_int_stat_[j0]; }
  ...
  EthRegsEthsdsRxsigokCtrlMutable &ethsds_rxsigok_ctrl(int j0) { return ethsds_rxsigok_ctrl_[j0]; }
  ...
  EthRegsEthsdsCoreCntlMutable &ethsds_core_cntl(int j0) { return ethsds_core_cntl_[j0]; }
  ...
  EthRegsEthsdsStatus0Mutable &ethsds_status0(int j0) { return ethsds_status0_[j0]; }
  ...
  EthRegsEthsdsStatus1Mutable &ethsds_status1(int j0) { return ethsds_status1_[j0]; }
  ...
  EthRegsEthOnestepEtsOffsetCtrlMutable &eth_onestep_ets_offset_ctrl(int j0) { return eth_onestep_ets_offset_ctrl_[j0]; }





  EthRegsIntStatMutable &int_stat() { return int_stat_; }





  EthRegsIntEnMutable &int_en() { return int_en_; }





  EthRegsIntPriMutable &int_pri() { return int_pri_; }
  ...
  EthRegsIntInjMutable &int_inj() { return int_inj_; }





  EthRegsTxffCtrlMutable &txff_ctrl() { return txff_ctrl_; }





  EthRegsTxffPream0Mutable &txff_pream0() { return txff_pream0_; }





  EthRegsTxffPream1Mutable &txff_pream1() { return txff_pream1_; }





  EthRegsEthTxffErrAddrMutable &eth_txff_err_addr() { return eth_txff_err_addr_; }





  EthRegsEthStatusMutable &eth_status() { return eth_status_; }
  ...
  EthRegsRxpktErrStsMutable &rxpkt_err_sts(int j0) { return rxpkt_err_sts_[j0]; }
  ...
  EthRegsRxpktErrHdr0Mutable &rxpkt_err_hdr0(int j0) { return rxpkt_err_hdr0_[j0]; }
  ...
  EthRegsRxpktErrHdr1Mutable &rxpkt_err_hdr1(int j0) { return rxpkt_err_hdr1_[j0]; }
  ...
  EthRegsRxpktErrHdr2Mutable &rxpkt_err_hdr2(int j0) { return rxpkt_err_hdr2_[j0]; }
  ...
  EthRegsRxpktErrHdr3Mutable &rxpkt_err_hdr3(int j0) { return rxpkt_err_hdr3_[j0]; }





  EthRegsEthClkobsCtrlMutable &eth_clkobs_ctrl() { return eth_clkobs_ctrl_; }
  ...
  EthRegsEthGpioRingMutable &eth_gpio_ring(int j0) { return eth_gpio_ring_[j0]; }
  ...
  EthRegsPfcffCtrlRoMutable &pfcff_ctrl(int j0) { return pfcff_ctrl_[j0]; }
  ...
  EthRegsTruncCtrlMutable &trunc_ctrl(int j0) { return trunc_ctrl_[j0]; }
  ...
  EthRegsPortAliveLutMutable &port_alive_lut() { return port_alive_lut_; }
  ...
  EthRegsForcePfcFlushMutable &force_pfc_flush(int j0) { return force_pfc_flush_[j0]; }





  EthRegsTxPrbs23Mutable &tx_prbs23() { return tx_prbs23_; }





  EthRegsIntFreezeMutable &int_freeze() { return int_freeze_; }
  ...
  EthRegsEbufCredMutable &ebuf_cred() { return ebuf_cred_; }
  ...
  EthRegsMinThrMutable &min_thr() { return min_thr_; }
...
private:
  EthRegsEthSoftResetMutable eth_soft_reset_;
  EthRegsEthSelAltclkMutable eth_sel_altclk_;
  EthRegsEthsdsIntCtrlMutable ethsds_int_broadcast_;
  EthRegsEthMacTsOffsetCtrlMutable eth_mac_ts_offset_ctrl_;
  std::array< EthRegsEthsdsIntCtrlMutable, 4 > ethsds_int_ctrl_;
  std::array< EthRegsEthsdsIntStatMutable, 4 > ethsds_int_stat_;
  std::array< EthRegsEthsdsRxsigokCtrlMutable, 4 > ethsds_rxsigok_ctrl_;
  std::array< EthRegsEthsdsCoreCntlMutable, 4 > ethsds_core_cntl_;
  std::array< EthRegsEthsdsStatus0Mutable, 4 > ethsds_status0_;
  std::array< EthRegsEthsdsStatus1Mutable, 4 > ethsds_status1_;
  std::array< EthRegsEthOnestepEtsOffsetCtrlMutable, 4 > eth_onestep_ets_offset_ctrl_;
  EthRegsIntStatMutable int_stat_;
  EthRegsIntEnMutable int_en_;
  EthRegsIntPriMutable int_pri_;
  EthRegsIntInjMutable int_inj_;
  EthRegsTxffCtrlMutable txff_ctrl_;
  EthRegsTxffPream0Mutable txff_pream0_;
  EthRegsTxffPream1Mutable txff_pream1_;
  EthRegsEthTxffErrAddrMutable eth_txff_err_addr_;
  EthRegsEthStatusMutable eth_status_;
  std::array< EthRegsRxpktErrStsMutable, 4 > rxpkt_err_sts_;
  std::array< EthRegsRxpktErrHdr0Mutable, 4 > rxpkt_err_hdr0_;
  std::array< EthRegsRxpktErrHdr1Mutable, 4 > rxpkt_err_hdr1_;
  std::array< EthRegsRxpktErrHdr2Mutable, 4 > rxpkt_err_hdr2_;
  std::array< EthRegsRxpktErrHdr3Mutable, 4 > rxpkt_err_hdr3_;
  EthRegsEthClkobsCtrlMutable eth_clkobs_ctrl_;
  std::array< EthRegsEthGpioRingMutable, 4 > eth_gpio_ring_;
  std::array< EthRegsPfcffCtrlRoMutable, 16 > pfcff_ctrl_;
  std::array< EthRegsTruncCtrlMutable, 4 > trunc_ctrl_;
  EthRegsPortAliveLutMutable port_alive_lut_;
  std::array< EthRegsForcePfcFlushMutable, 4 > force_pfc_flush_;
  EthRegsTxPrbs23Mutable tx_prbs23_;
  EthRegsIntFreezeMutable int_freeze_;
  EthRegsEbufCredMutable ebuf_cred_;
  EthRegsMinThrMutable min_thr_;
private:
...
#endif // __REGISTER_INCLUDES_ETH_REGS_MUTABLE_H__
