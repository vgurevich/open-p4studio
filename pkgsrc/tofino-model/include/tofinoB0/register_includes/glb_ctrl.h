...
#ifndef __REGISTER_INCLUDES_GLB_CTRL_H__
#define __REGISTER_INCLUDES_GLB_CTRL_H__
...
class GlbCtrl : public model_core::RegisterBlock<RegisterCallback> {
public:
  GlbCtrl(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_ibp_rspec), 4, false, write_callback, read_callback, std::string("GlbCtrl")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_ibp_rspec))
    {
    }
  GlbCtrl(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "GlbCtrl")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("GlbCtrl") + ":\n";
...
#endif // __REGISTER_INCLUDES_GLB_CTRL_H__
