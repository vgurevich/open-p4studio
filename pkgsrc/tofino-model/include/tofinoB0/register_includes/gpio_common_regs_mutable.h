...
#include "gpio_common_regs_int_en_mutable.h"
#include "gpio_common_regs_int_inj_mutable.h"
#include "gpio_common_regs_int_pri_mutable.h"
#include "gpio_common_regs_int_stat_mutable.h"
#include "gpio_common_regs_refclk_ctrl_mutable.h"
...
public:
  GpioCommonRegsMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_tofino), 380, true, write_callback, read_callback, std::string("GpioCommonRegsMutable")+":"+boost::lexical_cast<std::string>(selector_tofino))
    {
    }
  GpioCommonRegsMutable(
...
public:
  ...
  GpioCommonRegsIntStatMutable &int_stat() { return int_stat_; }





  GpioCommonRegsIntEnMutable &int_en() { return int_en_; }





  GpioCommonRegsIntPriMutable &int_pri() { return int_pri_; }
  ...
  GpioCommonRegsIntInjMutable &int_inj() { return int_inj_; }
  ...
  GpioCommonRegsRefclkCtrlMutable &refclk_ctrl() { return refclk_ctrl_; }
  ...
  GpioCommonRegsRefclkSelectMutable &refclk_select(int j0) { return refclk_select_[j0]; }
...
private:
  ...
  GpioCommonRegsIntStatMutable int_stat_;
  GpioCommonRegsIntEnMutable int_en_;
  GpioCommonRegsIntPriMutable int_pri_;
  GpioCommonRegsIntInjMutable int_inj_;
  GpioCommonRegsShldCtrlMutable shld_ctrl_;
  GpioCommonRegsGpioStatusMutable gpio_status_;
  GpioCommonRegsRefclkCtrlMutable refclk_ctrl_;
  std::array< GpioCommonRegsRefclkSelectMutable, 4 > refclk_select_;
