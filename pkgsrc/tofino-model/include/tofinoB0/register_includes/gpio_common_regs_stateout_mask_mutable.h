...
public:
  GpioCommonRegsStateoutMaskMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_tofino), 4, true, write_callback, read_callback, std::string("GpioCommonRegsStateoutMaskMutable")+":"+boost::lexical_cast<std::string>(selector_tofino))
    {
    }
  GpioCommonRegsStateoutMaskMutable(
