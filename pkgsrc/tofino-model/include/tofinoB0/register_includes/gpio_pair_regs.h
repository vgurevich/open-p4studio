...
public:
  GpioPairRegs(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_tofino, index_gpio_pair_regs), 44, false, write_callback, read_callback, std::string("GpioPairRegs")+":"+boost::lexical_cast<std::string>(selector_tofino) + "," + boost::lexical_cast<std::string>(index_gpio_pair_regs))
    {
    }
  GpioPairRegs(
