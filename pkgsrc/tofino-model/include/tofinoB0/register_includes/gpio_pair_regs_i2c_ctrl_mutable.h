...
public:
  GpioPairRegsI2cCtrlMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_tofino, index_gpio_pair_regs), 4, true, write_callback, read_callback, std::string("GpioPairRegsI2cCtrlMutable")+":"+boost::lexical_cast<std::string>(selector_tofino) + "," + boost::lexical_cast<std::string>(index_gpio_pair_regs))
    {
    }
  GpioPairRegsI2cCtrlMutable(
