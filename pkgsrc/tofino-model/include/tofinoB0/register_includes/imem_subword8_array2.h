...
#ifndef __REGISTER_INCLUDES_IMEM_SUBWORD8_ARRAY2_H__
#define __REGISTER_INCLUDES_IMEM_SUBWORD8_ARRAY2_H__
...
class ImemSubword8Array2 : public model_core::RegisterBlock<RegisterArrayCallback2> {
public:
  ImemSubword8Array2(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap), 4 * ArraySize(index_pipe_addrmap, index_mau_addrmap, -1), false, write_callback, read_callback, std::string("ImemSubword8Array2")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap)),
...
public:
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("ImemSubword8Array2") + "["+boost::lexical_cast<std::string>(a1)+"]"+"["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
#endif // __REGISTER_INCLUDES_IMEM_SUBWORD8_ARRAY2_H__
