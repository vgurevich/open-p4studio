...
#ifndef __REGISTER_INCLUDES_IMMEDIATE_DATA_32B_IXBAR_CTL_ARRAY_MUTABLE_H__
#define __REGISTER_INCLUDES_IMMEDIATE_DATA_32B_IXBAR_CTL_ARRAY_MUTABLE_H__
...
class ImmediateData_32bIxbarCtlArrayMutable : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  ImmediateData_32bIxbarCtlArrayMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap), 4 * ArraySize(index_pipe_addrmap, index_mau_addrmap, -1), true, write_callback, read_callback, std::string("ImmediateData_32bIxbarCtlArrayMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap)),
...
public:
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("ImmediateData_32bIxbarCtlArrayMutable") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
private:
  std::vector<ImmediateData_32bIxbarCtlMutable> array;
  uint32_t size0_;
...
#endif // __REGISTER_INCLUDES_IMMEDIATE_DATA_32B_IXBAR_CTL_ARRAY_MUTABLE_H__
