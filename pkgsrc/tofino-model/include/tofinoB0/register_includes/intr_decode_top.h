...
#ifndef __REGISTER_INCLUDES_INTR_DECODE_TOP_H__
#define __REGISTER_INCLUDES_INTR_DECODE_TOP_H__
...
class IntrDecodeTop : public model_core::RegisterBlock<RegisterCallback> {
public:
  IntrDecodeTop(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap), 4, false, write_callback, read_callback, std::string("IntrDecodeTop")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap))
    {
    }
  IntrDecodeTop(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "IntrDecodeTop")
    {
    }
public:
  ...
  uint8_t &intr_decode_mau_memory_core() { return intr_decode_mau_memory_core_; }
  ...
  bool read(
    ...
    *data |= ((intr_decode_mau_memory_core_ & 0x3) << 2);
    *data |= ((intr_decode_mau_snapshot_ & 0x3) << 4);
    *data |= ((intr_decode_mau_imem_ & 0x3) << 6);
    *data |= ((intr_decode_mau_gfm_hash_ & 0x3) << 8);
    *data |= ((intr_decode_mau_tcam_array_ & 0x3) << 10);
    return true;
  }
  ...
  bool write(
    ...
    intr_decode_mau_memory_core_ = ((data >> 2) & 0x3);
    intr_decode_mau_snapshot_ = ((data >> 4) & 0x3);
    intr_decode_mau_imem_ = ((data >> 6) & 0x3);
    intr_decode_mau_gfm_hash_ = ((data >> 8) & 0x3);
    intr_decode_mau_tcam_array_ = ((data >> 10) & 0x3);
  ...
  void reset(
    ...
    intr_decode_mau_memory_core_ = 0x0;
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("IntrDecodeTop") + ":\n";
    ...
    r += indent_string + "  " + std::string("intr_decode_mau_memory_core") +  ": 0x" + boost::str( boost::format("%x") % static_cast<uint>(intr_decode_mau_memory_core_) ) + "\n";
    all_zeros &= (0 == intr_decode_mau_memory_core_);
...
private:
  ...
  uint8_t intr_decode_mau_memory_core_;
...
private:
  static int StartOffset(
    ...
    offset += 0x120; // to get to intr_decode_top
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_INTR_DECODE_TOP_H__
