...
#ifndef __REGISTER_INCLUDES_INTR_ENABLE0_MAU_SELECTOR_ALU_MUTABLE_H__
#define __REGISTER_INCLUDES_INTR_ENABLE0_MAU_SELECTOR_ALU_MUTABLE_H__
...
class IntrEnable0MauSelectorAluMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  IntrEnable0MauSelectorAluMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap, index_mau_meter_alu_group_addrmap), 4, true, write_callback, read_callback, std::string("IntrEnable0MauSelectorAluMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_meter_alu_group_addrmap))
    {
    }
  IntrEnable0MauSelectorAluMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "IntrEnable0MauSelectorAluMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("IntrEnable0MauSelectorAluMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x18; // to get to intr_enable0_mau_selector_alu
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_INTR_ENABLE0_MAU_SELECTOR_ALU_MUTABLE_H__
