...
#ifndef __REGISTER_INCLUDES_INTR_FREEZE_ENABLE_MAU_CFG_H__
#define __REGISTER_INCLUDES_INTR_FREEZE_ENABLE_MAU_CFG_H__
...
class IntrFreezeEnableMauCfg : public model_core::RegisterBlock<RegisterCallback> {
public:
  IntrFreezeEnableMauCfg(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap), 4, false, write_callback, read_callback, std::string("IntrFreezeEnableMauCfg")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap))
    {
    }
  IntrFreezeEnableMauCfg(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "IntrFreezeEnableMauCfg")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("IntrFreezeEnableMauCfg") + ":\n";
...
#endif // __REGISTER_INCLUDES_INTR_FREEZE_ENABLE_MAU_CFG_H__
