...
#ifndef __REGISTER_INCLUDES_INTR_INJECT_MAU_CFG_H__
#define __REGISTER_INCLUDES_INTR_INJECT_MAU_CFG_H__
...
class IntrInjectMauCfg : public model_core::RegisterBlock<RegisterCallback> {
public:
  IntrInjectMauCfg(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap), 4, false, write_callback, read_callback, std::string("IntrInjectMauCfg")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap))
    {
    }
  IntrInjectMauCfg(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "IntrInjectMauCfg")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("IntrInjectMauCfg") + ":\n";
...
#endif // __REGISTER_INCLUDES_INTR_INJECT_MAU_CFG_H__
