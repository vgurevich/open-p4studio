...
#ifndef __REGISTER_INCLUDES_INTR_STATUS_MAU_AD_H__
#define __REGISTER_INCLUDES_INTR_STATUS_MAU_AD_H__
...
class IntrStatusMauAd : public model_core::RegisterBlock<RegisterCallback> {
public:
  IntrStatusMauAd(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap), 4, false, write_callback, read_callback, std::string("IntrStatusMauAd")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap))
    {
    }
  IntrStatusMauAd(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "IntrStatusMauAd")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("IntrStatusMauAd") + ":\n";
...
#endif // __REGISTER_INCLUDES_INTR_STATUS_MAU_AD_H__
