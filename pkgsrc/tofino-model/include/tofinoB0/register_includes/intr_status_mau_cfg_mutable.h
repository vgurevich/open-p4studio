...
#ifndef __REGISTER_INCLUDES_INTR_STATUS_MAU_CFG_MUTABLE_H__
#define __REGISTER_INCLUDES_INTR_STATUS_MAU_CFG_MUTABLE_H__
...
class IntrStatusMauCfgMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  IntrStatusMauCfgMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap), 4, true, write_callback, read_callback, std::string("IntrStatusMauCfgMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap))
    {
    }
  IntrStatusMauCfgMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "IntrStatusMauCfgMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("IntrStatusMauCfgMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_INTR_STATUS_MAU_CFG_MUTABLE_H__
