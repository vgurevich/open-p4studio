...
#ifndef __REGISTER_INCLUDES_INTR_STATUS_MAU_SELECTOR_ALU_MUTABLE_H__
#define __REGISTER_INCLUDES_INTR_STATUS_MAU_SELECTOR_ALU_MUTABLE_H__
...
class IntrStatusMauSelectorAluMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  IntrStatusMauSelectorAluMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap, index_mau_meter_alu_group_addrmap), 4, true, write_callback, read_callback, std::string("IntrStatusMauSelectorAluMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_meter_alu_group_addrmap))
    {
    }
  IntrStatusMauSelectorAluMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "IntrStatusMauSelectorAluMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("IntrStatusMauSelectorAluMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x14; // to get to intr_status_mau_selector_alu
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_INTR_STATUS_MAU_SELECTOR_ALU_MUTABLE_H__
