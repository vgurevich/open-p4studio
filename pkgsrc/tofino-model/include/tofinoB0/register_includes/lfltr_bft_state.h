...
#ifndef __REGISTER_INCLUDES_LFLTR_BFT_STATE_H__
#define __REGISTER_INCLUDES_LFLTR_BFT_STATE_H__
...
class LfltrBftState : public model_core::RegisterBlock<RegisterCallback> {
public:
...
public:
  LfltrBftState(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_dvsl_addrmap), 4, false, write_callback, read_callback, std::string("LfltrBftState")+":"+boost::lexical_cast<std::string>(selector_dvsl_addrmap))
    {
    }
  LfltrBftState(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "LfltrBftState")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("LfltrBftState") + ":\n";
...
#endif // __REGISTER_INCLUDES_LFLTR_BFT_STATE_H__
