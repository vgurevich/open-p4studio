...
#ifndef __REGISTER_INCLUDES_LFLTR_CTRL_RSPEC_DEBUG_BUS_CTRL_H__
#define __REGISTER_INCLUDES_LFLTR_CTRL_RSPEC_DEBUG_BUS_CTRL_H__
...
class LfltrCtrlRspecDebugBusCtrl : public model_core::RegisterBlock<RegisterCallback> {
public:
...
public:
  LfltrCtrlRspecDebugBusCtrl(
      int chipNumber, DvslAddrmapEnum selector_dvsl_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(selector_dvsl_addrmap), 4, false, write_callback, read_callback, std::string("LfltrCtrlRspecDebugBusCtrl")+":"+boost::lexical_cast<std::string>(selector_dvsl_addrmap))
    {
    }
  LfltrCtrlRspecDebugBusCtrl(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "LfltrCtrlRspecDebugBusCtrl")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("LfltrCtrlRspecDebugBusCtrl") + ":\n";
...
#endif // __REGISTER_INCLUDES_LFLTR_CTRL_RSPEC_DEBUG_BUS_CTRL_H__
