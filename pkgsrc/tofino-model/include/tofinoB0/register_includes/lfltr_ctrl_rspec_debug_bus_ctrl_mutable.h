...
#ifndef __REGISTER_INCLUDES_LFLTR_CTRL_RSPEC_DEBUG_BUS_CTRL_MUTABLE_H__
#define __REGISTER_INCLUDES_LFLTR_CTRL_RSPEC_DEBUG_BUS_CTRL_MUTABLE_H__
...
class LfltrCtrlRspecDebugBusCtrlMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
...
public:
  LfltrCtrlRspecDebugBusCtrlMutable(
      int chipNumber, DvslAddrmapEnum selector_dvsl_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(selector_dvsl_addrmap), 4, true, write_callback, read_callback, std::string("LfltrCtrlRspecDebugBusCtrlMutable")+":"+boost::lexical_cast<std::string>(selector_dvsl_addrmap))
    {
    }
  LfltrCtrlRspecDebugBusCtrlMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "LfltrCtrlRspecDebugBusCtrlMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("LfltrCtrlRspecDebugBusCtrlMutable") + ":\n";
  ...
  static int StartOffset(
    ...
    switch (selector_dvsl_addrmap) {
      case kLfltr0:
        ...
        offset += 0x80; // to get to debug_bus_ctrl
        break;
      case kLfltr1:
...
#endif // __REGISTER_INCLUDES_LFLTR_CTRL_RSPEC_DEBUG_BUS_CTRL_MUTABLE_H__
