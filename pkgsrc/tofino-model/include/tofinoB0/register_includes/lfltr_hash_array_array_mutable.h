...
public:
  LfltrHashArrayArrayMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(selector_dvsl_addrmap, index_lfltr_hash_rspec), 48 * ArraySize(selector_dvsl_addrmap, index_lfltr_hash_rspec, -1), true, write_callback, read_callback, std::string("LfltrHashArrayArrayMutable")+":"+boost::lexical_cast<std::string>(selector_dvsl_addrmap) + "," + boost::lexical_cast<std::string>(index_lfltr_hash_rspec)),
