...
#ifndef __REGISTER_INCLUDES_MAC_ADDRMAP_ARRAY_H__
#define __REGISTER_INCLUDES_MAC_ADDRMAP_ARRAY_H__
...
class MacAddrmapArray : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  MacAddrmapArray(
      int chipNumber, RegisterArrayCallback& write_callback = 0, RegisterArrayCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 131072 * ArraySize(-1), false, write_callback, read_callback, std::string("MacAddrmapArray")),
...
public:
  ...
  ComiraRegs &comira_regs(uint32_t a0)
  {
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("MacAddrmapArray") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
#endif // __REGISTER_INCLUDES_MAC_ADDRMAP_ARRAY_H__
