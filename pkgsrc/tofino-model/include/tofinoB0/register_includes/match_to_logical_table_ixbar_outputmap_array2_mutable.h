...
#ifndef __REGISTER_INCLUDES_MATCH_TO_LOGICAL_TABLE_IXBAR_OUTPUTMAP_ARRAY2_MUTABLE_H__
#define __REGISTER_INCLUDES_MATCH_TO_LOGICAL_TABLE_IXBAR_OUTPUTMAP_ARRAY2_MUTABLE_H__
...
class MatchToLogicalTableIxbarOutputmapArray2Mutable : public model_core::RegisterBlock<RegisterArrayCallback2> {
public:
  MatchToLogicalTableIxbarOutputmapArray2Mutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap), 4 * ArraySize(index_pipe_addrmap, index_mau_addrmap, -1), true, write_callback, read_callback, std::string("MatchToLogicalTableIxbarOutputmapArray2Mutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap)),
...
public:
  ...
  void enabled_4bit_muxctl_select(uint32_t a1,uint32_t a0,const uint8_t &v) 
  {
    CheckArrayBounds(a1,real_size1_,size1_,0,1,false);
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    array[(a1 * real_size0_) + a0].enabled_4bit_muxctl_select(v);
  }
  ...
  void enabled_4bit_muxctl_enable(uint32_t a1,uint32_t a0,const uint8_t &v) 
  {
    CheckArrayBounds(a1,real_size1_,size1_,0,1,false);
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    array[(a1 * real_size0_) + a0].enabled_4bit_muxctl_enable(v);
  }
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("MatchToLogicalTableIxbarOutputmapArray2Mutable") + "["+boost::lexical_cast<std::string>(a1)+"]"+"["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
private:
  std::vector<MatchToLogicalTableIxbarOutputmapMutable> array;
  uint32_t size0_;
...
#endif // __REGISTER_INCLUDES_MATCH_TO_LOGICAL_TABLE_IXBAR_OUTPUTMAP_ARRAY2_MUTABLE_H__
