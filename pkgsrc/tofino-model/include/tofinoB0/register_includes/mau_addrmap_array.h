...
#ifndef __REGISTER_INCLUDES_MAU_ADDRMAP_ARRAY_H__
#define __REGISTER_INCLUDES_MAU_ADDRMAP_ARRAY_H__
...
class MauAddrmapArray : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  MauAddrmapArray(
      int chipNumber, int index_pipe_addrmap, RegisterArrayCallback& write_callback = 0, RegisterArrayCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 524288 * ArraySize(index_pipe_addrmap, -1), false, write_callback, read_callback, std::string("MauAddrmapArray")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap)),
...
public:
  ...
  MauMemoryCoreAddrmap &rams(uint32_t a0)
  {
  ...
  MauCfgRegsAddrmap &cfg_regs(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
  ...
  MauTcamArrayAddrmap &tcams(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
  ...
  MauDatapathAddrmap &dp(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    return array[a0].dp();
  }
...
#endif // __REGISTER_INCLUDES_MAU_ADDRMAP_ARRAY_H__
