...
public:
  MauDatapathAddrmap(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap), 131072, false, write_callback, read_callback, std::string("MauDatapathAddrmap")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap))
    {
    }
  MauDatapathAddrmap(
...
public:
  ...
  PhvIngressThreadAlu &phv_ingress_thread_alu(int j1,int j0) { return phv_ingress_thread_alu_[j1][j0]; }
  ...
  PhvEgressThreadAlu &phv_egress_thread_alu(int j1,int j0) { return phv_egress_thread_alu_[j1][j0]; }
...
private:
  ...
  std::array< std::array< PhvIngressThreadAlu, 14 >, 2 > phv_ingress_thread_alu_;
  std::array< std::array< PhvEgressThreadAlu, 14 >, 2 > phv_egress_thread_alu_;
