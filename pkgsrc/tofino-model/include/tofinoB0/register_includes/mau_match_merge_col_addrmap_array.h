...
#ifndef __REGISTER_INCLUDES_MAU_MATCH_MERGE_COL_ADDRMAP_ARRAY_H__
#define __REGISTER_INCLUDES_MAU_MATCH_MERGE_COL_ADDRMAP_ARRAY_H__
...
class MauMatchMergeColAddrmapArray : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  MauMatchMergeColAddrmapArray(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap), 128 * ArraySize(index_pipe_addrmap, index_mau_addrmap, -1), false, write_callback, read_callback, std::string("MauMatchMergeColAddrmapArray")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap)),
...
public:
  ...
  RowActionNxtableBusDrive &row_action_nxtable_bus_drive(uint32_t a0,int j0)
  {
  ...
  HitmapOutputMap &hitmap_output_map(uint32_t a0,int j0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("MauMatchMergeColAddrmapArray") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
private:
  std::vector<MauMatchMergeColAddrmap> array;
  uint32_t size0_;
...
#endif // __REGISTER_INCLUDES_MAU_MATCH_MERGE_COL_ADDRMAP_ARRAY_H__
