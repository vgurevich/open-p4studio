...
class MauPhysicalToMeterAluIxbarMapArray2 : public model_core::RegisterBlock<RegisterArrayCallback2> {
public:
  MauPhysicalToMeterAluIxbarMapArray2(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap), 4 * ArraySize(index_pipe_addrmap, index_mau_addrmap, -1), false, write_callback, read_callback, std::string("MauPhysicalToMeterAluIxbarMapArray2")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap)),
...
private:
  std::vector<MauPhysicalToMeterAluIxbarMap> array;
  uint32_t size0_;
