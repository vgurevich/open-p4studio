...
public:
  MauSnapshotCaptureHalfAddrmapArray(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap), 1024 * ArraySize(index_pipe_addrmap, index_mau_addrmap, -1), false, write_callback, read_callback, std::string("MauSnapshotCaptureHalfAddrmapArray")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap)),
...
public:
  ...
  MauSnapshotCaptureSubword32bLo &mau_snapshot_capture_subword32b_lo(uint32_t a0,int j0)
  {
  ...
  MauSnapshotCaptureSubword32bHi &mau_snapshot_capture_subword32b_hi(uint32_t a0,int j0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
  ...
  MauSnapshotCaptureSubword8b &mau_snapshot_capture_subword8b(uint32_t a0,int j0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
  ...
  MauSnapshotCaptureSubword16b &mau_snapshot_capture_subword16b(uint32_t a0,int j0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
