...
#ifndef __REGISTER_INCLUDES_MAU_SNAPSHOT_PHYSICAL_EXACT_MATCH_HIT_ADDRESS_ARRAY_MUTABLE_H__
#define __REGISTER_INCLUDES_MAU_SNAPSHOT_PHYSICAL_EXACT_MATCH_HIT_ADDRESS_ARRAY_MUTABLE_H__
...
class MauSnapshotPhysicalExactMatchHitAddressArrayMutable : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  MauSnapshotPhysicalExactMatchHitAddressArrayMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap), 4 * ArraySize(index_pipe_addrmap, index_mau_addrmap, -1), true, write_callback, read_callback, std::string("MauSnapshotPhysicalExactMatchHitAddressArrayMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap)),
...
public:
  uint32_t mau_snapshot_physical_exact_match_hit_address(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    return array[a0].mau_snapshot_physical_exact_match_hit_address();
  }
  void mau_snapshot_physical_exact_match_hit_address(uint32_t a0,const uint32_t &v) 
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    array[a0].mau_snapshot_physical_exact_match_hit_address(v);
  }
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("MauSnapshotPhysicalExactMatchHitAddressArrayMutable") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
private:
  std::vector<MauSnapshotPhysicalExactMatchHitAddressMutable> array;
  uint32_t size0_;
...
#endif // __REGISTER_INCLUDES_MAU_SNAPSHOT_PHYSICAL_EXACT_MATCH_HIT_ADDRESS_ARRAY_MUTABLE_H__
