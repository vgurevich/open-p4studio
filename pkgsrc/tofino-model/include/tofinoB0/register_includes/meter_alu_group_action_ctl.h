...
#ifndef __REGISTER_INCLUDES_METER_ALU_GROUP_ACTION_CTL_H__
#define __REGISTER_INCLUDES_METER_ALU_GROUP_ACTION_CTL_H__
...
class MeterAluGroupActionCtl : public model_core::RegisterBlock<RegisterCallback> {
public:
  MeterAluGroupActionCtl(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap, index_meter_alu_group_action_ctl), 4, false, write_callback, read_callback, std::string("MeterAluGroupActionCtl")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap) + "," + boost::lexical_cast<std::string>(index_meter_alu_group_action_ctl))
    {
    }
  MeterAluGroupActionCtl(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "MeterAluGroupActionCtl")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("MeterAluGroupActionCtl") + ":\n";
...
#endif // __REGISTER_INCLUDES_METER_ALU_GROUP_ACTION_CTL_H__
