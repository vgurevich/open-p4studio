...
#ifndef __REGISTER_INCLUDES_MIR_BUF_DESC_NORM_DESC_GRP_MUTABLE_H__
#define __REGISTER_INCLUDES_MIR_BUF_DESC_NORM_DESC_GRP_MUTABLE_H__
...
#include "mir_buf_desc_dummy_mutable.h"
#include "mir_buf_desc_session_ctrl_mutable.h"
#include "mir_buf_desc_session_meta0_mutable.h"
#include "mir_buf_desc_session_meta1_mutable.h"
#include "mir_buf_desc_session_meta2_mutable.h"
#include "mir_buf_desc_session_meta3_mutable.h"
#include "mir_buf_desc_session_meta4_mutable.h"

namespace tofinoB0 {
  namespace register_classes {

class MirBufDescNormDescGrpMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  MirBufDescNormDescGrpMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mir_buf_desc_norm_desc_grp), 32, true, write_callback, read_callback, std::string("MirBufDescNormDescGrpMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mir_buf_desc_norm_desc_grp))
    {
    }
  MirBufDescNormDescGrpMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "MirBufDescNormDescGrpMutable")
    {
    }
public:
  ...
  MirBufDescSessionMeta0Mutable &norm_desc_grp_session_meta0() { return norm_desc_grp_session_meta0_; }





  MirBufDescSessionMeta1Mutable &norm_desc_grp_session_meta1() { return norm_desc_grp_session_meta1_; }





  MirBufDescSessionMeta2Mutable &norm_desc_grp_session_meta2() { return norm_desc_grp_session_meta2_; }





  MirBufDescSessionMeta3Mutable &norm_desc_grp_session_meta3() { return norm_desc_grp_session_meta3_; }





  MirBufDescSessionMeta4Mutable &norm_desc_grp_session_meta4() { return norm_desc_grp_session_meta4_; }
  ...
  MirBufDescSessionCtrlMutable &norm_desc_grp_session_ctrl() { return norm_desc_grp_session_ctrl_; }





  MirBufDescDummyMutable &norm_desc_grp_dummy1() { return norm_desc_grp_dummy1_; }





  MirBufDescDummyMutable &norm_desc_grp_dummy2() { return norm_desc_grp_dummy2_; }
...
private:
  MirBufDescSessionMeta0Mutable norm_desc_grp_session_meta0_;
  MirBufDescSessionMeta1Mutable norm_desc_grp_session_meta1_;
  MirBufDescSessionMeta2Mutable norm_desc_grp_session_meta2_;
  MirBufDescSessionMeta3Mutable norm_desc_grp_session_meta3_;
  MirBufDescSessionMeta4Mutable norm_desc_grp_session_meta4_;
  MirBufDescSessionCtrlMutable norm_desc_grp_session_ctrl_;
  MirBufDescDummyMutable norm_desc_grp_dummy1_;
  MirBufDescDummyMutable norm_desc_grp_dummy2_;
private:
...
#endif // __REGISTER_INCLUDES_MIR_BUF_DESC_NORM_DESC_GRP_MUTABLE_H__
