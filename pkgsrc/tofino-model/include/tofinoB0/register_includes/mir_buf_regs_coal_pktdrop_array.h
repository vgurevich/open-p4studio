...
#ifndef __REGISTER_INCLUDES_MIR_BUF_REGS_COAL_PKTDROP_ARRAY_H__
#define __REGISTER_INCLUDES_MIR_BUF_REGS_COAL_PKTDROP_ARRAY_H__
...
class MirBufRegsCoalPktdropArray : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  MirBufRegsCoalPktdropArray(
      int chipNumber, int index_pipe_addrmap, RegisterArrayCallback& write_callback = 0, RegisterArrayCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 8 * ArraySize(index_pipe_addrmap, -1), false, write_callback, read_callback, std::string("MirBufRegsCoalPktdropArray")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap)),
...
public:
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("MirBufRegsCoalPktdropArray") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
private:
  std::vector<MirBufRegsCoalPktdrop> array;
  uint32_t size0_;
...
#endif // __REGISTER_INCLUDES_MIR_BUF_REGS_COAL_PKTDROP_ARRAY_H__
