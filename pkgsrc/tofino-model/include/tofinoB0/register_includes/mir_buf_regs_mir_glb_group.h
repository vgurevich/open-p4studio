...
#ifndef __REGISTER_INCLUDES_MIR_BUF_REGS_MIR_GLB_GROUP_H__
#define __REGISTER_INCLUDES_MIR_BUF_REGS_MIR_GLB_GROUP_H__
...
#include "mir_buf_regs_coal_cred_used.h"
#include "mir_buf_regs_coal_pktdrop.h"
#include "mir_buf_regs_coal_pkterr.h"
#include "mir_buf_regs_coalescing_baseid.h"
#include "mir_buf_regs_coalescing_basetime.h"
#include "mir_buf_regs_cred_ini.h"
#include "mir_buf_regs_dbg_ctrl.h"
#include "mir_buf_regs_disable_mir_err.h"
#include "mir_buf_regs_egr_pktdrop.h"
#include "mir_buf_regs_glb_ctrl.h"
#include "mir_buf_regs_ingr_pktdrop.h"
#include "mir_buf_regs_min_bcnt.h"
#include "mir_buf_regs_mir_addr_err_dbuf.h"
#include "mir_buf_regs_mir_addr_err_edesc.h"
#include "mir_buf_regs_mir_addr_err_idesc.h"
#include "mir_buf_regs_mir_addr_err_odesc.h"
#include "mir_buf_regs_mir_addr_err_ptrff.h"
#include "mir_buf_regs_mir_int_dual_inj.h"
#include "mir_buf_regs_mir_int_en.h"
#include "mir_buf_regs_mir_int_freeze.h"
#include "mir_buf_regs_mir_int_pri.h"
#include "mir_buf_regs_mir_int_sngl_inj.h"
#include "mir_buf_regs_mir_int_stat.h"
#include "mir_buf_regs_mir_watermark_drop.h"
#include "mir_buf_regs_neg_mirr_ctrl.h"
#include "mir_buf_regs_neg_mirr_wtmk.h"
#include "mir_buf_regs_neg_pktdrop.h"
#include "mir_buf_regs_negm_cred_used.h"
#include "mir_buf_regs_norm_bank_entries.h"
#include "mir_buf_regs_odesc_init_done.h"
#include "mir_buf_regs_session_fifonum.h"
#include "mir_buf_regs_stall_drop_stat.h"
#include "mir_buf_regs_tot_bank_entries.h"

namespace tofinoB0 {
  namespace register_classes {

class MirBufRegsMirGlbGroup : public model_core::RegisterBlock<RegisterCallback> {
public:
  MirBufRegsMirGlbGroup(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 336, false, write_callback, read_callback, std::string("MirBufRegsMirGlbGroup")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  MirBufRegsMirGlbGroup(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "MirBufRegsMirGlbGroup")
    {
    }
public:
  ...
  MirBufRegsGlbCtrl &mir_glb_group_glb_ctrl() { return mir_glb_group_glb_ctrl_; }





  MirBufRegsMirWatermarkDrop &mir_glb_group_mir_watermark_drop() { return mir_glb_group_mir_watermark_drop_; }





  MirBufRegsNegMirrCtrl &mir_glb_group_neg_mirr_ctrl() { return mir_glb_group_neg_mirr_ctrl_; }





  MirBufRegsNegMirrWtmk &mir_glb_group_neg_mirr_wtmk() { return mir_glb_group_neg_mirr_wtmk_; }





  MirBufRegsCoalescingBasetime &mir_glb_group_coalescing_basetime() { return mir_glb_group_coalescing_basetime_; }





  MirBufRegsCoalescingBaseid &mir_glb_group_coalescing_baseid() { return mir_glb_group_coalescing_baseid_; }
  ...
  MirBufRegsSessionFifonum &mir_glb_group_session_fifonum() { return mir_glb_group_session_fifonum_; }
  ...
  MirBufRegsNormBankEntries &mir_glb_group_norm_bank_entries() { return mir_glb_group_norm_bank_entries_; }
  ...
  MirBufRegsTotBankEntries &mir_glb_group_tot_bank_entries() { return mir_glb_group_tot_bank_entries_; }





  MirBufRegsMirIntStat &mir_glb_group_mir_int_stat() { return mir_glb_group_mir_int_stat_; }





  MirBufRegsMirIntEn &mir_glb_group_mir_int_en() { return mir_glb_group_mir_int_en_; }





  MirBufRegsMirIntPri &mir_glb_group_mir_int_pri() { return mir_glb_group_mir_int_pri_; }
  ...
  MirBufRegsMirIntDualInj &mir_glb_group_mir_int_dual_inj() { return mir_glb_group_mir_int_dual_inj_; }
  ...
  MirBufRegsMirIntSnglInj &mir_glb_group_mir_int_sngl_inj() { return mir_glb_group_mir_int_sngl_inj_; }
  ...
  MirBufRegsMirAddrErrDbuf &mir_glb_group_mir_addr_err_dbuf() { return mir_glb_group_mir_addr_err_dbuf_; }
  ...
  MirBufRegsMirAddrErrIdesc &mir_glb_group_mir_addr_err_idesc() { return mir_glb_group_mir_addr_err_idesc_; }
  ...
  MirBufRegsMirAddrErrEdesc &mir_glb_group_mir_addr_err_edesc() { return mir_glb_group_mir_addr_err_edesc_; }
  ...
  MirBufRegsMirAddrErrOdesc &mir_glb_group_mir_addr_err_odesc() { return mir_glb_group_mir_addr_err_odesc_; }
  ...
  MirBufRegsMirAddrErrPtrff &mir_glb_group_mir_addr_err_ptrff() { return mir_glb_group_mir_addr_err_ptrff_; }





  MirBufRegsDisableMirErr &mir_glb_group_disable_mir_err() { return mir_glb_group_disable_mir_err_; }
  ...
  MirBufRegsStallDropStat &mir_glb_group_stall_drop_stat() { return mir_glb_group_stall_drop_stat_; }





  MirBufRegsIngrPktdrop &mir_glb_group_ingr_pktdrop() { return mir_glb_group_ingr_pktdrop_; }





  MirBufRegsEgrPktdrop &mir_glb_group_egr_pktdrop() { return mir_glb_group_egr_pktdrop_; }





  MirBufRegsNegPktdrop &mir_glb_group_neg_pktdrop() { return mir_glb_group_neg_pktdrop_; }
  ...
  MirBufRegsCoalPktdrop &mir_glb_group_coal_pktdrop(int j0) { return mir_glb_group_coal_pktdrop_[j0]; }
  ...
  MirBufRegsCoalCredUsed &mir_glb_group_coal_cred_used(int j0) { return mir_glb_group_coal_cred_used_[j0]; }





  MirBufRegsNegmCredUsed &mir_glb_group_negm_cred_used() { return mir_glb_group_negm_cred_used_; }





  MirBufRegsMirIntFreeze &mir_glb_group_mir_int_freeze() { return mir_glb_group_mir_int_freeze_; }





  MirBufRegsCredIni &mir_glb_group_cred_ini() { return mir_glb_group_cred_ini_; }
  ...
  MirBufRegsCoalPkterr &mir_glb_group_coal_pkterr(int j0) { return mir_glb_group_coal_pkterr_[j0]; }





  MirBufRegsOdescInitDone &mir_glb_group_odesc_init_done() { return mir_glb_group_odesc_init_done_; }





  MirBufRegsDbgCtrl &mir_glb_group_dbg_ctrl() { return mir_glb_group_dbg_ctrl_; }





  MirBufRegsMinBcnt &mir_glb_group_min_bcnt() { return mir_glb_group_min_bcnt_; }
...
private:
  MirBufRegsGlbCtrl mir_glb_group_glb_ctrl_;
  MirBufRegsMirWatermarkDrop mir_glb_group_mir_watermark_drop_;
  MirBufRegsNegMirrCtrl mir_glb_group_neg_mirr_ctrl_;
  MirBufRegsNegMirrWtmk mir_glb_group_neg_mirr_wtmk_;
  MirBufRegsCoalescingBasetime mir_glb_group_coalescing_basetime_;
  MirBufRegsCoalescingBaseid mir_glb_group_coalescing_baseid_;
  MirBufRegsSessionFifonum mir_glb_group_session_fifonum_;
  MirBufRegsNormBankEntries mir_glb_group_norm_bank_entries_;
  MirBufRegsTotBankEntries mir_glb_group_tot_bank_entries_;
  MirBufRegsMirIntStat mir_glb_group_mir_int_stat_;
  MirBufRegsMirIntEn mir_glb_group_mir_int_en_;
  MirBufRegsMirIntPri mir_glb_group_mir_int_pri_;
  MirBufRegsMirIntDualInj mir_glb_group_mir_int_dual_inj_;
  MirBufRegsMirIntSnglInj mir_glb_group_mir_int_sngl_inj_;
  MirBufRegsMirAddrErrDbuf mir_glb_group_mir_addr_err_dbuf_;
  MirBufRegsMirAddrErrIdesc mir_glb_group_mir_addr_err_idesc_;
  MirBufRegsMirAddrErrEdesc mir_glb_group_mir_addr_err_edesc_;
  MirBufRegsMirAddrErrOdesc mir_glb_group_mir_addr_err_odesc_;
  MirBufRegsMirAddrErrPtrff mir_glb_group_mir_addr_err_ptrff_;
  MirBufRegsDisableMirErr mir_glb_group_disable_mir_err_;
  MirBufRegsStallDropStat mir_glb_group_stall_drop_stat_;
  MirBufRegsIngrPktdrop mir_glb_group_ingr_pktdrop_;
  MirBufRegsEgrPktdrop mir_glb_group_egr_pktdrop_;
  MirBufRegsNegPktdrop mir_glb_group_neg_pktdrop_;
  std::array< MirBufRegsCoalPktdrop, 8 > mir_glb_group_coal_pktdrop_;
  std::array< MirBufRegsCoalCredUsed, 8 > mir_glb_group_coal_cred_used_;
  MirBufRegsNegmCredUsed mir_glb_group_negm_cred_used_;
  MirBufRegsMirIntFreeze mir_glb_group_mir_int_freeze_;
  MirBufRegsCredIni mir_glb_group_cred_ini_;
  std::array< MirBufRegsCoalPkterr, 8 > mir_glb_group_coal_pkterr_;
  MirBufRegsOdescInitDone mir_glb_group_odesc_init_done_;
  MirBufRegsDbgCtrl mir_glb_group_dbg_ctrl_;
  MirBufRegsMinBcnt mir_glb_group_min_bcnt_;
private:
...
#endif // __REGISTER_INCLUDES_MIR_BUF_REGS_MIR_GLB_GROUP_H__
