...
#ifndef __REGISTER_INCLUDES_MIR_BUF_REGS_MIR_INT_DUAL_INJ_H__
#define __REGISTER_INCLUDES_MIR_BUF_REGS_MIR_INT_DUAL_INJ_H__
...
class MirBufRegsMirIntDualInj : public model_core::RegisterBlock<RegisterCallback> {
public:
  MirBufRegsMirIntDualInj(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 4, false, write_callback, read_callback, std::string("MirBufRegsMirIntDualInj")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  MirBufRegsMirIntDualInj(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "MirBufRegsMirIntDualInj")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("MirBufRegsMirIntDualInj") + ":\n";
...
#endif // __REGISTER_INCLUDES_MIR_BUF_REGS_MIR_INT_DUAL_INJ_H__
