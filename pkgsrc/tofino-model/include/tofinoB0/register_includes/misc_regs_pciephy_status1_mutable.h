...
#ifndef __REGISTER_INCLUDES_MISC_REGS_PCIEPHY_STATUS1_MUTABLE_H__
#define __REGISTER_INCLUDES_MISC_REGS_PCIEPHY_STATUS1_MUTABLE_H__
...
class MiscRegsPciephyStatus1Mutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  MiscRegsPciephyStatus1Mutable(
      int chipNumber, int index_misc_regs_pciephy_status1, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_misc_regs_pciephy_status1), 4, true, write_callback, read_callback, std::string("MiscRegsPciephyStatus1Mutable")+":"+boost::lexical_cast<std::string>(index_misc_regs_pciephy_status1))
    {
    }
  MiscRegsPciephyStatus1Mutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "MiscRegsPciephyStatus1Mutable")
    {
    }
public:
  ...
  void pciephy_int_data_out(const uint16_t &v) { pciephy_int_data_out_=v; }
  ...
  void pciephy_analog_to_core(const uint8_t &v) { pciephy_analog_to_core_=v; }
  ...
  void pciephy_local_fs_lf_valid(const uint8_t &v) { pciephy_local_fs_lf_valid_=v; }
  ...
  void pciephy_rx_idle_detect(const uint8_t &v) { pciephy_rx_idle_detect_=v; }
  ...
  void pciephy_link_loopback_en(const uint8_t &v) { pciephy_link_loopback_en_=v; }
  ...
  void pciephy_rx_rdy(const uint8_t &v) { pciephy_rx_rdy_=v; }
  ...
  void pciephy_tx_rdy(const uint8_t &v) { pciephy_tx_rdy_=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("MiscRegsPciephyStatus1Mutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_MISC_REGS_PCIEPHY_STATUS1_MUTABLE_H__
