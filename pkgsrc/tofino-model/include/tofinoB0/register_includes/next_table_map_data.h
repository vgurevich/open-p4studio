...
class NextTableMapData : public model_core::RegisterBlock<RegisterCallback> {
public:
  NextTableMapData(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap, index_next_table_map_data_0, index_next_table_map_data_1), 4, false, write_callback, read_callback, std::string("NextTableMapData")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap) + "," + boost::lexical_cast<std::string>(index_next_table_map_data_0) + "," + boost::lexical_cast<std::string>(index_next_table_map_data_1))
    {
    }
  NextTableMapData(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "NextTableMapData")
    {
    }
public:
