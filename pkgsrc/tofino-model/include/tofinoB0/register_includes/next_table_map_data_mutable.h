...
#ifndef __REGISTER_INCLUDES_NEXT_TABLE_MAP_DATA_MUTABLE_H__
#define __REGISTER_INCLUDES_NEXT_TABLE_MAP_DATA_MUTABLE_H__
...
class NextTableMapDataMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  NextTableMapDataMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap, index_next_table_map_data_0, index_next_table_map_data_1), 4, true, write_callback, read_callback, std::string("NextTableMapDataMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap) + "," + boost::lexical_cast<std::string>(index_next_table_map_data_0) + "," + boost::lexical_cast<std::string>(index_next_table_map_data_1))
    {
    }
  NextTableMapDataMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "NextTableMapDataMutable")
    {
    }
public:
  uint8_t next_table_map_data0() { return next_table_map_data0_; }
  void next_table_map_data0(const uint8_t &v) { next_table_map_data0_=v; }
  uint8_t next_table_map_data1() { return next_table_map_data1_; }
  void next_table_map_data1(const uint8_t &v) { next_table_map_data1_=v; }
  uint8_t next_table_map_data2() { return next_table_map_data2_; }
  void next_table_map_data2(const uint8_t &v) { next_table_map_data2_=v; }
  uint8_t next_table_map_data3() { return next_table_map_data3_; }
  void next_table_map_data3(const uint8_t &v) { next_table_map_data3_=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("NextTableMapDataMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_NEXT_TABLE_MAP_DATA_MUTABLE_H__
