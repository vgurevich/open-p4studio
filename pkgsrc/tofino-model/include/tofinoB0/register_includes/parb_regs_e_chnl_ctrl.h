...
#ifndef __REGISTER_INCLUDES_PARB_REGS_E_CHNL_CTRL_H__
#define __REGISTER_INCLUDES_PARB_REGS_E_CHNL_CTRL_H__
...
class ParbRegsEChnlCtrl : public model_core::RegisterBlock<RegisterCallback> {
public:
  ParbRegsEChnlCtrl(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_parb_regs_e_chnl_ctrl), 4, false, write_callback, read_callback, std::string("ParbRegsEChnlCtrl")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_parb_regs_e_chnl_ctrl))
    {
    }
  ParbRegsEChnlCtrl(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "ParbRegsEChnlCtrl")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("ParbRegsEChnlCtrl") + ":\n";
...
#endif // __REGISTER_INCLUDES_PARB_REGS_E_CHNL_CTRL_H__
