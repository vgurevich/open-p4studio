...
#ifndef __REGISTER_INCLUDES_PARB_REGS_PARB_GROUP_H__
#define __REGISTER_INCLUDES_PARB_REGS_PARB_GROUP_H__
...
#include "parb_regs_bubble_count.h"
#include "parb_regs_cong_phv_count.h"
#include "parb_regs_cong_slot_limiter.h"
#include "parb_regs_dprs_input_fifo_count.h"
#include "parb_regs_dprs_input_fifo_max.h"
#include "parb_regs_e_chnl_ctrl.h"
#include "parb_regs_hipri_phv_count.h"
#include "parb_regs_i_chnl_ctrl.h"
#include "parb_regs_mau_micro_update.h"
#include "parb_regs_output_rate_ctrl.h"
#include "parb_regs_pfc0_phv_count.h"
#include "parb_regs_pfc1_phv_count.h"
#include "parb_regs_pfc2_phv_count.h"
#include "parb_regs_pfc3_phv_count.h"
#include "parb_regs_pfc4_phv_count.h"
#include "parb_regs_pfc5_phv_count.h"
#include "parb_regs_pfc6_phv_count.h"
#include "parb_regs_pfc7_phv_count.h"
#include "parb_regs_phv_count.h"
#include "parb_regs_port_debug.h"

namespace tofinoB0 {
  namespace register_classes {

class ParbRegsParbGroup : public model_core::RegisterBlock<RegisterCallback> {
public:
  ParbRegsParbGroup(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 1608, false, write_callback, read_callback, std::string("ParbRegsParbGroup")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  ParbRegsParbGroup(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "ParbRegsParbGroup")
    {
    }
public:
  ...
  ParbRegsCongSlotLimiter &parb_group_cong_slot_limiter() { return parb_group_cong_slot_limiter_; }





  ParbRegsOutputRateCtrl &parb_group_i_output_rate_ctrl() { return parb_group_i_output_rate_ctrl_; }





  ParbRegsOutputRateCtrl &parb_group_e_output_rate_ctrl() { return parb_group_e_output_rate_ctrl_; }





  ParbRegsHipriPhvCount &parb_group_i_hipri_phv_count() { return parb_group_i_hipri_phv_count_; }





  ParbRegsCongPhvCount &parb_group_i_cong_phv_count() { return parb_group_i_cong_phv_count_; }





  ParbRegsPfc0PhvCount &parb_group_i_pfc0_phv_count() { return parb_group_i_pfc0_phv_count_; }





  ParbRegsPfc1PhvCount &parb_group_i_pfc1_phv_count() { return parb_group_i_pfc1_phv_count_; }





  ParbRegsPfc2PhvCount &parb_group_i_pfc2_phv_count() { return parb_group_i_pfc2_phv_count_; }





  ParbRegsPfc3PhvCount &parb_group_i_pfc3_phv_count() { return parb_group_i_pfc3_phv_count_; }





  ParbRegsPfc4PhvCount &parb_group_i_pfc4_phv_count() { return parb_group_i_pfc4_phv_count_; }





  ParbRegsPfc5PhvCount &parb_group_i_pfc5_phv_count() { return parb_group_i_pfc5_phv_count_; }





  ParbRegsPfc6PhvCount &parb_group_i_pfc6_phv_count() { return parb_group_i_pfc6_phv_count_; }





  ParbRegsPfc7PhvCount &parb_group_i_pfc7_phv_count() { return parb_group_i_pfc7_phv_count_; }





  ParbRegsPfc0PhvCount &parb_group_e_pfc0_phv_count() { return parb_group_e_pfc0_phv_count_; }





  ParbRegsPfc1PhvCount &parb_group_e_pfc1_phv_count() { return parb_group_e_pfc1_phv_count_; }





  ParbRegsPfc2PhvCount &parb_group_e_pfc2_phv_count() { return parb_group_e_pfc2_phv_count_; }





  ParbRegsPfc3PhvCount &parb_group_e_pfc3_phv_count() { return parb_group_e_pfc3_phv_count_; }





  ParbRegsPfc4PhvCount &parb_group_e_pfc4_phv_count() { return parb_group_e_pfc4_phv_count_; }





  ParbRegsPfc5PhvCount &parb_group_e_pfc5_phv_count() { return parb_group_e_pfc5_phv_count_; }





  ParbRegsPfc6PhvCount &parb_group_e_pfc6_phv_count() { return parb_group_e_pfc6_phv_count_; }





  ParbRegsPfc7PhvCount &parb_group_e_pfc7_phv_count() { return parb_group_e_pfc7_phv_count_; }





  ParbRegsHipriPhvCount &parb_group_e_hipri_phv_count() { return parb_group_e_hipri_phv_count_; }





  ParbRegsBubbleCount &parb_group_i_bubble_count() { return parb_group_i_bubble_count_; }





  ParbRegsBubbleCount &parb_group_e_bubble_count() { return parb_group_e_bubble_count_; }





  ParbRegsMauMicroUpdate &parb_group_mau_micro_update() { return parb_group_mau_micro_update_; }





  ParbRegsDprsInputFifoCount &parb_group_dprs_input_fifo_count() { return parb_group_dprs_input_fifo_count_; }





  ParbRegsDprsInputFifoMax &parb_group_dprs_input_fifo_max() { return parb_group_dprs_input_fifo_max_; }





  ParbRegsPhvCount &parb_group_i_phv_count() { return parb_group_i_phv_count_; }





  ParbRegsPhvCount &parb_group_i_eop_count() { return parb_group_i_eop_count_; }





  ParbRegsPhvCount &parb_group_e_phv_count() { return parb_group_e_phv_count_; }





  ParbRegsPhvCount &parb_group_e_eop_count() { return parb_group_e_eop_count_; }





  ParbRegsPhvCount &parb_group_i_norm_phv_count() { return parb_group_i_norm_phv_count_; }





  ParbRegsPhvCount &parb_group_i_norm_eop_count() { return parb_group_i_norm_eop_count_; }





  ParbRegsPhvCount &parb_group_i_resub_phv_count() { return parb_group_i_resub_phv_count_; }





  ParbRegsPhvCount &parb_group_i_resub_eop_count() { return parb_group_i_resub_eop_count_; }
  ...
  ParbRegsIChnlCtrl &parb_group_i_chnl_ctrl(int j0) { return parb_group_i_chnl_ctrl_[j0]; }
  ...
  ParbRegsEChnlCtrl &parb_group_e_chnl_ctrl(int j0) { return parb_group_e_chnl_ctrl_[j0]; }
  ...
  ParbRegsPortDebug &parb_group_i_port_dbg(int j0) { return parb_group_i_port_dbg_[j0]; }
  ...
  ParbRegsPortDebug &parb_group_e_port_dbg(int j0) { return parb_group_e_port_dbg_[j0]; }
...
private:
  ParbRegsCongSlotLimiter parb_group_cong_slot_limiter_;
  ParbRegsOutputRateCtrl parb_group_i_output_rate_ctrl_;
  ParbRegsOutputRateCtrl parb_group_e_output_rate_ctrl_;
  ParbRegsHipriPhvCount parb_group_i_hipri_phv_count_;
  ParbRegsCongPhvCount parb_group_i_cong_phv_count_;
  ParbRegsPfc0PhvCount parb_group_i_pfc0_phv_count_;
  ParbRegsPfc1PhvCount parb_group_i_pfc1_phv_count_;
  ParbRegsPfc2PhvCount parb_group_i_pfc2_phv_count_;
  ParbRegsPfc3PhvCount parb_group_i_pfc3_phv_count_;
  ParbRegsPfc4PhvCount parb_group_i_pfc4_phv_count_;
  ParbRegsPfc5PhvCount parb_group_i_pfc5_phv_count_;
  ParbRegsPfc6PhvCount parb_group_i_pfc6_phv_count_;
  ParbRegsPfc7PhvCount parb_group_i_pfc7_phv_count_;
  ParbRegsPfc0PhvCount parb_group_e_pfc0_phv_count_;
  ParbRegsPfc1PhvCount parb_group_e_pfc1_phv_count_;
  ParbRegsPfc2PhvCount parb_group_e_pfc2_phv_count_;
  ParbRegsPfc3PhvCount parb_group_e_pfc3_phv_count_;
  ParbRegsPfc4PhvCount parb_group_e_pfc4_phv_count_;
  ParbRegsPfc5PhvCount parb_group_e_pfc5_phv_count_;
  ParbRegsPfc6PhvCount parb_group_e_pfc6_phv_count_;
  ParbRegsPfc7PhvCount parb_group_e_pfc7_phv_count_;
  ParbRegsHipriPhvCount parb_group_e_hipri_phv_count_;
  ParbRegsBubbleCount parb_group_i_bubble_count_;
  ParbRegsBubbleCount parb_group_e_bubble_count_;
  ParbRegsMauMicroUpdate parb_group_mau_micro_update_;
  ParbRegsDprsInputFifoCount parb_group_dprs_input_fifo_count_;
  ParbRegsDprsInputFifoMax parb_group_dprs_input_fifo_max_;
  ParbRegsPhvCount parb_group_i_phv_count_;
  ParbRegsPhvCount parb_group_i_eop_count_;
  ParbRegsPhvCount parb_group_e_phv_count_;
  ParbRegsPhvCount parb_group_e_eop_count_;
  ParbRegsPhvCount parb_group_i_norm_phv_count_;
  ParbRegsPhvCount parb_group_i_norm_eop_count_;
  ParbRegsPhvCount parb_group_i_resub_phv_count_;
  ParbRegsPhvCount parb_group_i_resub_eop_count_;
  std::array< ParbRegsIChnlCtrl, 72 > parb_group_i_chnl_ctrl_;
  std::array< ParbRegsEChnlCtrl, 72 > parb_group_e_chnl_ctrl_;
  std::array< ParbRegsPortDebug, 18 > parb_group_i_port_dbg_;
  std::array< ParbRegsPortDebug, 18 > parb_group_e_port_dbg_;
private:
...
#endif // __REGISTER_INCLUDES_PARB_REGS_PARB_GROUP_H__
