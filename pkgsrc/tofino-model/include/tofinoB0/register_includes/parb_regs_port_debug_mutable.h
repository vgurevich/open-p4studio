...
#ifndef __REGISTER_INCLUDES_PARB_REGS_PORT_DEBUG_MUTABLE_H__
#define __REGISTER_INCLUDES_PARB_REGS_PORT_DEBUG_MUTABLE_H__
...
class ParbRegsPortDebugMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
...
public:
  ParbRegsPortDebugMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, selector_parb_regs_parb_group, index_parb_regs_port_debug), 4, true, write_callback, read_callback, std::string("ParbRegsPortDebugMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(selector_parb_regs_parb_group) + "," + boost::lexical_cast<std::string>(index_parb_regs_port_debug))
    {
    }
  ParbRegsPortDebugMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "ParbRegsPortDebugMutable")
    {
    }
public:
  ...
  void chnl0_sts(const uint8_t &v) { chnl0_sts_=v; }
  ...
  void chnl1_sts(const uint8_t &v) { chnl1_sts_=v; }
  ...
  void chnl2_sts(const uint8_t &v) { chnl2_sts_=v; }
  ...
  void chnl3_sts(const uint8_t &v) { chnl3_sts_=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("ParbRegsPortDebugMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_PARB_REGS_PORT_DEBUG_MUTABLE_H__
