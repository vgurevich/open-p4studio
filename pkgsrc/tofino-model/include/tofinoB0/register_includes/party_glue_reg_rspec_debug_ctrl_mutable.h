...
#ifndef __REGISTER_INCLUDES_PARTY_GLUE_REG_RSPEC_DEBUG_CTRL_MUTABLE_H__
#define __REGISTER_INCLUDES_PARTY_GLUE_REG_RSPEC_DEBUG_CTRL_MUTABLE_H__
...
class PartyGlueRegRspecDebugCtrlMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  PartyGlueRegRspecDebugCtrlMutable(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 4, true, write_callback, read_callback, std::string("PartyGlueRegRspecDebugCtrlMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  PartyGlueRegRspecDebugCtrlMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "PartyGlueRegRspecDebugCtrlMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PartyGlueRegRspecDebugCtrlMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_PARTY_GLUE_REG_RSPEC_DEBUG_CTRL_MUTABLE_H__
