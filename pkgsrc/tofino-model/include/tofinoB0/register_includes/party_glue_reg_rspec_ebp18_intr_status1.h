...
#ifndef __REGISTER_INCLUDES_PARTY_GLUE_REG_RSPEC_EBP18_INTR_STATUS1_H__
#define __REGISTER_INCLUDES_PARTY_GLUE_REG_RSPEC_EBP18_INTR_STATUS1_H__
...
class PartyGlueRegRspecEbp18IntrStatus1 : public model_core::RegisterBlock<RegisterCallback> {
public:
  PartyGlueRegRspecEbp18IntrStatus1(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 4, false, write_callback, read_callback, std::string("PartyGlueRegRspecEbp18IntrStatus1")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  PartyGlueRegRspecEbp18IntrStatus1(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "PartyGlueRegRspecEbp18IntrStatus1")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PartyGlueRegRspecEbp18IntrStatus1") + ":\n";
...
#endif // __REGISTER_INCLUDES_PARTY_GLUE_REG_RSPEC_EBP18_INTR_STATUS1_H__
