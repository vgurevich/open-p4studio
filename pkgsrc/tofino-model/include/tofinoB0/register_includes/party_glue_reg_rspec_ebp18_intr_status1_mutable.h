...
#ifndef __REGISTER_INCLUDES_PARTY_GLUE_REG_RSPEC_EBP18_INTR_STATUS1_MUTABLE_H__
#define __REGISTER_INCLUDES_PARTY_GLUE_REG_RSPEC_EBP18_INTR_STATUS1_MUTABLE_H__
...
class PartyGlueRegRspecEbp18IntrStatus1Mutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  PartyGlueRegRspecEbp18IntrStatus1Mutable(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 4, true, write_callback, read_callback, std::string("PartyGlueRegRspecEbp18IntrStatus1Mutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  PartyGlueRegRspecEbp18IntrStatus1Mutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "PartyGlueRegRspecEbp18IntrStatus1Mutable")
    {
    }
public:
  ...
  void ebp0(const uint8_t &v) { ebp0_=v; }
  ...
  void ebp1(const uint8_t &v) { ebp1_=v; }
  ...
  void ebp2(const uint8_t &v) { ebp2_=v; }
  ...
  void ebp3(const uint8_t &v) { ebp3_=v; }
  ...
  void ebp4(const uint8_t &v) { ebp4_=v; }
  ...
  void ebp5(const uint8_t &v) { ebp5_=v; }
  ...
  void ebp6(const uint8_t &v) { ebp6_=v; }
  ...
  void ebp7(const uint8_t &v) { ebp7_=v; }
  ...
  void ebp8(const uint8_t &v) { ebp8_=v; }
  ...
  void ebp9(const uint8_t &v) { ebp9_=v; }
  ...
  void ebp10(const uint8_t &v) { ebp10_=v; }
  ...
  void ebp11(const uint8_t &v) { ebp11_=v; }
  ...
  void ebp12(const uint8_t &v) { ebp12_=v; }
  ...
  void ebp13(const uint8_t &v) { ebp13_=v; }
  ...
  void ebp14(const uint8_t &v) { ebp14_=v; }
  ...
  void ebp15(const uint8_t &v) { ebp15_=v; }
  ...
  void ebp16(const uint8_t &v) { ebp16_=v; }
  ...
  void ebp17(const uint8_t &v) { ebp17_=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PartyGlueRegRspecEbp18IntrStatus1Mutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x1c; // to get to ebp18_intr_status1
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_PARTY_GLUE_REG_RSPEC_EBP18_INTR_STATUS1_MUTABLE_H__
