...
#ifndef __REGISTER_INCLUDES_PARTY_GLUE_REG_RSPEC_EGR18_INTR_STATUS0_H__
#define __REGISTER_INCLUDES_PARTY_GLUE_REG_RSPEC_EGR18_INTR_STATUS0_H__
...
class PartyGlueRegRspecEgr18IntrStatus0 : public model_core::RegisterBlock<RegisterCallback> {
public:
  PartyGlueRegRspecEgr18IntrStatus0(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 4, false, write_callback, read_callback, std::string("PartyGlueRegRspecEgr18IntrStatus0")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  PartyGlueRegRspecEgr18IntrStatus0(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "PartyGlueRegRspecEgr18IntrStatus0")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PartyGlueRegRspecEgr18IntrStatus0") + ":\n";
...
#endif // __REGISTER_INCLUDES_PARTY_GLUE_REG_RSPEC_EGR18_INTR_STATUS0_H__
