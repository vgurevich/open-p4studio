...
#ifndef __REGISTER_INCLUDES_PARTY_PGR_APP_REG_RSPEC_MUTABLE_H__
#define __REGISTER_INCLUDES_PARTY_PGR_APP_REG_RSPEC_MUTABLE_H__
...
#include "pgr_app_event_ibg_mutable.h"
#include "pgr_app_event_ipg_mutable.h"
#include "pgr_app_event_jitter_mask_mutable.h"
#include "pgr_app_event_jitter_value_mutable.h"
...
class PartyPgrAppRegRspecMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  PartyPgrAppRegRspecMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_party_pgr_app_reg_rspec), 512, true, write_callback, read_callback, std::string("PartyPgrAppRegRspecMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_party_pgr_app_reg_rspec))
    {
    }
  PartyPgrAppRegRspecMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "PartyPgrAppRegRspecMutable")
    {
    }
public:
  ...
  PgrAppEventIbgMutable &event_ibg() { return event_ibg_; }





  PgrAppEventJitterValueMutable &event_ibg_jitter_value() { return event_ibg_jitter_value_; }





  PgrAppEventJitterMaskMutable &event_ibg_jitter_mask() { return event_ibg_jitter_mask_; }





  PgrAppEventIpgMutable &event_ipg() { return event_ipg_; }





  PgrAppEventJitterValueMutable &event_ipg_jitter_value() { return event_ipg_jitter_value_; }





  PgrAppEventJitterMaskMutable &event_ipg_jitter_mask() { return event_ipg_jitter_mask_; }
...
private:
  ...
  PgrAppEventIbgMutable event_ibg_;
  PgrAppEventJitterValueMutable event_ibg_jitter_value_;
  PgrAppEventJitterMaskMutable event_ibg_jitter_mask_;
  PgrAppEventIpgMutable event_ipg_;
  PgrAppEventJitterValueMutable event_ipg_jitter_value_;
  PgrAppEventJitterMaskMutable event_ipg_jitter_mask_;
...
#endif // __REGISTER_INCLUDES_PARTY_PGR_APP_REG_RSPEC_MUTABLE_H__
