...
#ifndef __REGISTER_INCLUDES_PBUS_HOST_CREQ_CREDIT_MUTABLE_H__
#define __REGISTER_INCLUDES_PBUS_HOST_CREQ_CREDIT_MUTABLE_H__
...
class PbusHostCreqCreditMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  PbusHostCreqCreditMutable(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 48, true, write_callback, read_callback, std::string("PbusHostCreqCreditMutable"))
    {
    }
  PbusHostCreqCreditMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "PbusHostCreqCreditMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PbusHostCreqCreditMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x140; // to get to host_creq_credit
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_PBUS_HOST_CREQ_CREDIT_MUTABLE_H__
