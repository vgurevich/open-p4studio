...
#ifndef __REGISTER_INCLUDES_PBUS_INT_STAT2_H__
#define __REGISTER_INCLUDES_PBUS_INT_STAT2_H__
...
class PbusIntStat2 : public model_core::RegisterBlock<RegisterCallback> {
public:
  PbusIntStat2(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 4, false, write_callback, read_callback, std::string("PbusIntStat2"))
    {
    }
  PbusIntStat2(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "PbusIntStat2")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PbusIntStat2") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x58; // to get to int_stat2
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_PBUS_INT_STAT2_H__
