...
#ifndef __REGISTER_INCLUDES_PBUS_RB_CREQ_CREDIT_MUTABLE_H__
#define __REGISTER_INCLUDES_PBUS_RB_CREQ_CREDIT_MUTABLE_H__
...
class PbusRbCreqCreditMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  PbusRbCreqCreditMutable(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 48, true, write_callback, read_callback, std::string("PbusRbCreqCreditMutable"))
    {
    }
  PbusRbCreqCreditMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "PbusRbCreqCreditMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PbusRbCreqCreditMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x300; // to get to rb_creq_credit
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_PBUS_RB_CREQ_CREDIT_MUTABLE_H__
