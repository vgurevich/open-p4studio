...
#ifndef __REGISTER_INCLUDES_PBUS_STATION_REGS_INTR_ENABLE1_MUTABLE_H__
#define __REGISTER_INCLUDES_PBUS_STATION_REGS_INTR_ENABLE1_MUTABLE_H__
...
class PbusStationRegsIntrEnable1Mutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  PbusStationRegsIntrEnable1Mutable(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 4, true, write_callback, read_callback, std::string("PbusStationRegsIntrEnable1Mutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  PbusStationRegsIntrEnable1Mutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "PbusStationRegsIntrEnable1Mutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PbusStationRegsIntrEnable1Mutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x8; // to get to intr_enable1
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_PBUS_STATION_REGS_INTR_ENABLE1_MUTABLE_H__
