...
#ifndef __REGISTER_INCLUDES_PBUS_STATION_REGS_INTR_FREEZE_ENABLE_MUTABLE_H__
#define __REGISTER_INCLUDES_PBUS_STATION_REGS_INTR_FREEZE_ENABLE_MUTABLE_H__
...
class PbusStationRegsIntrFreezeEnableMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  PbusStationRegsIntrFreezeEnableMutable(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 4, true, write_callback, read_callback, std::string("PbusStationRegsIntrFreezeEnableMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  PbusStationRegsIntrFreezeEnableMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "PbusStationRegsIntrFreezeEnableMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PbusStationRegsIntrFreezeEnableMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_PBUS_STATION_REGS_INTR_FREEZE_ENABLE_MUTABLE_H__
