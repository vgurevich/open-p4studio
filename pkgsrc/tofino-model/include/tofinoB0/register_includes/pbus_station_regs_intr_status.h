...
#ifndef __REGISTER_INCLUDES_PBUS_STATION_REGS_INTR_STATUS_H__
#define __REGISTER_INCLUDES_PBUS_STATION_REGS_INTR_STATUS_H__
...
class PbusStationRegsIntrStatus : public model_core::RegisterBlock<RegisterCallback> {
public:
  PbusStationRegsIntrStatus(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 4, false, write_callback, read_callback, std::string("PbusStationRegsIntrStatus")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  PbusStationRegsIntrStatus(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "PbusStationRegsIntrStatus")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PbusStationRegsIntrStatus") + ":\n";
...
#endif // __REGISTER_INCLUDES_PBUS_STATION_REGS_INTR_STATUS_H__
