...
#ifndef __REGISTER_INCLUDES_PCIE_INT_STAT_H__
#define __REGISTER_INCLUDES_PCIE_INT_STAT_H__
...
class PcieIntStat : public model_core::RegisterBlock<RegisterCallback> {
public:
  PcieIntStat(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 4, false, write_callback, read_callback, std::string("PcieIntStat"))
    {
    }
  PcieIntStat(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "PcieIntStat")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PcieIntStat") + ":\n";
...
#endif // __REGISTER_INCLUDES_PCIE_INT_STAT_H__
