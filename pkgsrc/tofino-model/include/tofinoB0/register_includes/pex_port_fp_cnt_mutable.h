...
#ifndef __REGISTER_INCLUDES_PEX_PORT_FP_CNT_MUTABLE_H__
#define __REGISTER_INCLUDES_PEX_PORT_FP_CNT_MUTABLE_H__
...
class PexPortFpCntMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  PexPortFpCntMutable(
      int chipNumber, int index_tm_pex_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_pex_pipe_rspec), 8, true, write_callback, read_callback, std::string("PexPortFpCntMutable")+":"+boost::lexical_cast<std::string>(index_tm_pex_pipe_rspec))
    {
    }
  PexPortFpCntMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "PexPortFpCntMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PexPortFpCntMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x5d0; // to get to port_first_cnt
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_PEX_PORT_FP_CNT_MUTABLE_H__
