...
#ifndef __REGISTER_INCLUDES_PEX_PORT_PKT_CNT_MUTABLE_H__
#define __REGISTER_INCLUDES_PEX_PORT_PKT_CNT_MUTABLE_H__
...
class PexPortPktCntMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  PexPortPktCntMutable(
      int chipNumber, int index_tm_pex_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_pex_pipe_rspec), 8, true, write_callback, read_callback, std::string("PexPortPktCntMutable")+":"+boost::lexical_cast<std::string>(index_tm_pex_pipe_rspec))
    {
    }
  PexPortPktCntMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "PexPortPktCntMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PexPortPktCntMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x5e8; // to get to port_pkt_cnt
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_PEX_PORT_PKT_CNT_MUTABLE_H__
