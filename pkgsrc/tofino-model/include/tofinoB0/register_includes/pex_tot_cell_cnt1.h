...
#ifndef __REGISTER_INCLUDES_PEX_TOT_CELL_CNT1_H__
#define __REGISTER_INCLUDES_PEX_TOT_CELL_CNT1_H__
...
class PexTotCellCnt1 : public model_core::RegisterBlock<RegisterCallback> {
public:
  PexTotCellCnt1(
      int chipNumber, int index_tm_pex_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_pex_pipe_rspec), 8, false, write_callback, read_callback, std::string("PexTotCellCnt1")+":"+boost::lexical_cast<std::string>(index_tm_pex_pipe_rspec))
    {
    }
  PexTotCellCnt1(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "PexTotCellCnt1")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PexTotCellCnt1") + ":\n";
...
#endif // __REGISTER_INCLUDES_PEX_TOT_CELL_CNT1_H__
