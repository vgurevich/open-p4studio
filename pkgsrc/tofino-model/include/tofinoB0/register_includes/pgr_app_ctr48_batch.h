...
public:
  PgrAppCtr48Batch(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_party_pgr_app_reg_rspec), 8, false, write_callback, read_callback, std::string("PgrAppCtr48Batch")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_party_pgr_app_reg_rspec))
    {
    }
  PgrAppCtr48Batch(
