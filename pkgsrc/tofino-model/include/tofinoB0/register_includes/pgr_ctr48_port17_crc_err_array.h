...
#ifndef __REGISTER_INCLUDES_PGR_CTR48_PORT17_CRC_ERR_ARRAY_H__
#define __REGISTER_INCLUDES_PGR_CTR48_PORT17_CRC_ERR_ARRAY_H__
...
class PgrCtr48Port17CrcErrArray : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  PgrCtr48Port17CrcErrArray(
      int chipNumber, int index_pipe_addrmap, RegisterArrayCallback& write_callback = 0, RegisterArrayCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 8 * ArraySize(index_pipe_addrmap, -1), false, write_callback, read_callback, std::string("PgrCtr48Port17CrcErrArray")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap)),
...
public:
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("PgrCtr48Port17CrcErrArray") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
private:
  std::vector<PgrCtr48Port17CrcErr> array;
  uint32_t size0_;
...
#endif // __REGISTER_INCLUDES_PGR_CTR48_PORT17_CRC_ERR_ARRAY_H__
