...
#ifndef __REGISTER_INCLUDES_PIPE_ADDRMAP_ARRAY_H__
#define __REGISTER_INCLUDES_PIPE_ADDRMAP_ARRAY_H__
...
class PipeAddrmapArray : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  PipeAddrmapArray(
      int chipNumber, RegisterArrayCallback& write_callback = 0, RegisterArrayCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 8388608 * ArraySize(-1), false, write_callback, read_callback, std::string("PipeAddrmapArray")),
...
public:
  ...
  DprsrRegRspec &deparser(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
...
#endif // __REGISTER_INCLUDES_PIPE_ADDRMAP_ARRAY_H__
