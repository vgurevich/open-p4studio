...
#ifndef __REGISTER_INCLUDES_PIPE_BLOCK_REG_DEBUG_BUS_CTRL_H__
#define __REGISTER_INCLUDES_PIPE_BLOCK_REG_DEBUG_BUS_CTRL_H__
...
class PipeBlockRegDebugBusCtrl : public model_core::RegisterBlock<RegisterCallback> {
public:
  PipeBlockRegDebugBusCtrl(
      int chipNumber, int index_tm_qac_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_qac_pipe_rspec), 4, false, write_callback, read_callback, std::string("PipeBlockRegDebugBusCtrl")+":"+boost::lexical_cast<std::string>(index_tm_qac_pipe_rspec))
    {
    }
  PipeBlockRegDebugBusCtrl(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "PipeBlockRegDebugBusCtrl")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PipeBlockRegDebugBusCtrl") + ":\n";
...
#endif // __REGISTER_INCLUDES_PIPE_BLOCK_REG_DEBUG_BUS_CTRL_H__
