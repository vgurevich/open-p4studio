...
#ifndef __REGISTER_INCLUDES_PIPE_BLOCK_REG_INTR_STATUS_H__
#define __REGISTER_INCLUDES_PIPE_BLOCK_REG_INTR_STATUS_H__
...
class PipeBlockRegIntrStatus : public model_core::RegisterBlock<RegisterCallback> {
public:
  PipeBlockRegIntrStatus(
      int chipNumber, int index_tm_qac_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_qac_pipe_rspec), 4, false, write_callback, read_callback, std::string("PipeBlockRegIntrStatus")+":"+boost::lexical_cast<std::string>(index_tm_qac_pipe_rspec))
    {
    }
  PipeBlockRegIntrStatus(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "PipeBlockRegIntrStatus")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PipeBlockRegIntrStatus") + ":\n";
...
#endif // __REGISTER_INCLUDES_PIPE_BLOCK_REG_INTR_STATUS_H__
