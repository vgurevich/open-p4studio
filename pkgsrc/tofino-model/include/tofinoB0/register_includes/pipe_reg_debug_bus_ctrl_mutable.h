...
#ifndef __REGISTER_INCLUDES_PIPE_REG_DEBUG_BUS_CTRL_MUTABLE_H__
#define __REGISTER_INCLUDES_PIPE_REG_DEBUG_BUS_CTRL_MUTABLE_H__
...
class PipeRegDebugBusCtrlMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  PipeRegDebugBusCtrlMutable(
      int chipNumber, int index_tm_wac_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_wac_pipe_rspec), 4, true, write_callback, read_callback, std::string("PipeRegDebugBusCtrlMutable")+":"+boost::lexical_cast<std::string>(index_tm_wac_pipe_rspec))
    {
    }
  PipeRegDebugBusCtrlMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "PipeRegDebugBusCtrlMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PipeRegDebugBusCtrlMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x1980; // to get to wac_reg_debug_bus_ctrl
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_PIPE_REG_DEBUG_BUS_CTRL_MUTABLE_H__
