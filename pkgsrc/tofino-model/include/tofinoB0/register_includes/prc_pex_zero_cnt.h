...
#ifndef __REGISTER_INCLUDES_PRC_PEX_ZERO_CNT_H__
#define __REGISTER_INCLUDES_PRC_PEX_ZERO_CNT_H__
...
class PrcPexZeroCnt : public model_core::RegisterBlock<RegisterCallback> {
public:
  PrcPexZeroCnt(
      int chipNumber, int index_tm_prc_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_prc_pipe_rspec), 8, false, write_callback, read_callback, std::string("PrcPexZeroCnt")+":"+boost::lexical_cast<std::string>(index_tm_prc_pipe_rspec))
    {
    }
  PrcPexZeroCnt(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "PrcPexZeroCnt")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PrcPexZeroCnt") + ":\n";
...
#endif // __REGISTER_INCLUDES_PRC_PEX_ZERO_CNT_H__
