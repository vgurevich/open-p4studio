...
#ifndef __REGISTER_INCLUDES_PRE_FILTER_CTRL_H__
#define __REGISTER_INCLUDES_PRE_FILTER_CTRL_H__
...
class PreFilterCtrl : public model_core::RegisterBlock<RegisterCallback> {
public:
  PreFilterCtrl(
      int chipNumber, int index_tm_pre_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_pre_pipe_rspec), 12, false, write_callback, read_callback, std::string("PreFilterCtrl")+":"+boost::lexical_cast<std::string>(index_tm_pre_pipe_rspec))
    {
    }
  PreFilterCtrl(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "PreFilterCtrl")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PreFilterCtrl") + ":\n";
...
#endif // __REGISTER_INCLUDES_PRE_FILTER_CTRL_H__
