...
class PreIntInjMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  PreIntInjMutable(
      int chipNumber, int index_tm_pre_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_pre_pipe_rspec), 4, true, write_callback, read_callback, std::string("PreIntInjMutable")+":"+boost::lexical_cast<std::string>(index_tm_pre_pipe_rspec))
    {
    }
  PreIntInjMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "PreIntInjMutable")
    {
    }
public:
  ...
  void err_inj_reserved(const uint16_t &v) { err_inj_reserved_=v; }
  ...
  void fifo_mbe_inj(const uint8_t &v) { fifo_mbe_inj_=v; }
  ...
  void mit_mbe_inj(const uint8_t &v) { mit_mbe_inj_=v; }
  ...
  void lit0_bm_mbe_inj(const uint8_t &v) { lit0_bm_mbe_inj_=v; }
  ...
  void lit1_bm_mbe_inj(const uint8_t &v) { lit1_bm_mbe_inj_=v; }
  ...
  void lit0_np_mbe_inj(const uint8_t &v) { lit0_np_mbe_inj_=v; }
  ...
  void lit1_np_mbe_inj(const uint8_t &v) { lit1_np_mbe_inj_=v; }
  ...
  void pmt0_mbe_inj(const uint8_t &v) { pmt0_mbe_inj_=v; }
  ...
  void pmt1_mbe_inj(const uint8_t &v) { pmt1_mbe_inj_=v; }
  ...
  void rdm_mbe_inj(const uint8_t &v) { rdm_mbe_inj_=v; }
  ...
  void fifo_sbe_inj(const uint8_t &v) { fifo_sbe_inj_=v; }
  ...
  void mit_sbe_inj(const uint8_t &v) { mit_sbe_inj_=v; }
  ...
  void lit0_bm_sbe_inj(const uint8_t &v) { lit0_bm_sbe_inj_=v; }
  ...
  void lit1_bm_sbe_inj(const uint8_t &v) { lit1_bm_sbe_inj_=v; }
  ...
  void lit0_np_sbe_inj(const uint8_t &v) { lit0_np_sbe_inj_=v; }
  ...
  void lit1_np_sbe_inj(const uint8_t &v) { lit1_np_sbe_inj_=v; }
  ...
  void pmt0_sbe_inj(const uint8_t &v) { pmt0_sbe_inj_=v; }
  ...
  void pmt1_sbe_inj(const uint8_t &v) { pmt1_sbe_inj_=v; }
  ...
  void rdm_sbe_inj(const uint8_t &v) { rdm_sbe_inj_=v; }
