...
#ifndef __REGISTER_INCLUDES_PRE_INT_STAT_H__
#define __REGISTER_INCLUDES_PRE_INT_STAT_H__
...
class PreIntStat : public model_core::RegisterBlock<RegisterCallback> {
public:
  PreIntStat(
      int chipNumber, int index_tm_pre_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_pre_pipe_rspec), 4, false, write_callback, read_callback, std::string("PreIntStat")+":"+boost::lexical_cast<std::string>(index_tm_pre_pipe_rspec))
    {
    }
  PreIntStat(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "PreIntStat")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PreIntStat") + ":\n";
...
#endif // __REGISTER_INCLUDES_PRE_INT_STAT_H__
