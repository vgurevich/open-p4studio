...
#ifndef __REGISTER_INCLUDES_PRE_PORT_VECTOR_H__
#define __REGISTER_INCLUDES_PRE_PORT_VECTOR_H__
...
class PrePortVector : public model_core::RegisterBlock<RegisterCallback> {
public:
  PrePortVector(
      int chipNumber, int index_tm_pre_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_pre_pipe_rspec), 12, false, write_callback, read_callback, std::string("PrePortVector")+":"+boost::lexical_cast<std::string>(index_tm_pre_pipe_rspec))
    {
    }
  PrePortVector(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "PrePortVector")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PrePortVector") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0xd0; // to get to filtered_port_vector
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_PRE_PORT_VECTOR_H__
