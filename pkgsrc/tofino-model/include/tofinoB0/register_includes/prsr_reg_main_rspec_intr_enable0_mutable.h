...
#ifndef __REGISTER_INCLUDES_PRSR_REG_MAIN_RSPEC_INTR_ENABLE0_MUTABLE_H__
#define __REGISTER_INCLUDES_PRSR_REG_MAIN_RSPEC_INTR_ENABLE0_MUTABLE_H__
...
class PrsrRegMainRspecIntrEnable0Mutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum PmarbRspecEnum {
    kEbp18Reg,
    kIbp18Reg
...
public:
  PrsrRegMainRspecIntrEnable0Mutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, selector_pmarb_rspec, index_ebp_rspec), 4, true, write_callback, read_callback, std::string("PrsrRegMainRspecIntrEnable0Mutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(selector_pmarb_rspec) + "," + boost::lexical_cast<std::string>(index_ebp_rspec))
    {
    }
  PrsrRegMainRspecIntrEnable0Mutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "PrsrRegMainRspecIntrEnable0Mutable")
    {
    }
public:
  uint8_t no_tcam_match_err() { return no_tcam_match_err_; }
  void no_tcam_match_err(const uint8_t &v) { no_tcam_match_err_=v; }
  uint8_t partial_hdr_err() { return partial_hdr_err_; }
  void partial_hdr_err(const uint8_t &v) { partial_hdr_err_=v; }
  uint8_t ctr_range_err() { return ctr_range_err_; }
  void ctr_range_err(const uint8_t &v) { ctr_range_err_=v; }
  uint8_t timeout_iter_err() { return timeout_iter_err_; }
  void timeout_iter_err(const uint8_t &v) { timeout_iter_err_=v; }
  uint8_t timeout_cycle_err() { return timeout_cycle_err_; }
  void timeout_cycle_err(const uint8_t &v) { timeout_cycle_err_=v; }
  uint8_t src_ext_err() { return src_ext_err_; }
  void src_ext_err(const uint8_t &v) { src_ext_err_=v; }
  uint8_t dst_cont_err() { return dst_cont_err_; }
  void dst_cont_err(const uint8_t &v) { dst_cont_err_=v; }
  uint8_t phv_owner_err() { return phv_owner_err_; }
  void phv_owner_err(const uint8_t &v) { phv_owner_err_=v; }
  uint8_t multi_wr_err() { return multi_wr_err_; }
  void multi_wr_err(const uint8_t &v) { multi_wr_err_=v; }
  uint8_t aram_sbe() { return aram_sbe_; }
  void aram_sbe(const uint8_t &v) { aram_sbe_=v; }
  uint8_t aram_mbe() { return aram_mbe_; }
  void aram_mbe(const uint8_t &v) { aram_mbe_=v; }
  uint8_t fcs_err() { return fcs_err_; }
  void fcs_err(const uint8_t &v) { fcs_err_=v; }
  uint8_t csum_err() { return csum_err_; }
  void csum_err(const uint8_t &v) { csum_err_=v; }
  uint8_t ibuf_oflow_err() { return ibuf_oflow_err_; }
  void ibuf_oflow_err(const uint8_t &v) { ibuf_oflow_err_=v; }
  uint8_t ibuf_uflow_err() { return ibuf_uflow_err_; }
  void ibuf_uflow_err(const uint8_t &v) { ibuf_uflow_err_=v; }
  uint8_t op_fifo_oflow_err() { return op_fifo_oflow_err_; }
  void op_fifo_oflow_err(const uint8_t &v) { op_fifo_oflow_err_=v; }
  uint8_t op_fifo_uflow_err() { return op_fifo_uflow_err_; }
  void op_fifo_uflow_err(const uint8_t &v) { op_fifo_uflow_err_=v; }
  uint8_t tcam_par_err() { return tcam_par_err_; }
  void tcam_par_err(const uint8_t &v) { tcam_par_err_=v; }
  ...
  void reset(
    ...
    no_tcam_match_err_ = 0x1;
    partial_hdr_err_ = 0x1;
    ctr_range_err_ = 0x1;
    timeout_iter_err_ = 0x1;
    timeout_cycle_err_ = 0x1;
    src_ext_err_ = 0x1;
    dst_cont_err_ = 0x1;
    phv_owner_err_ = 0x1;
    multi_wr_err_ = 0x1;
    ...
    ibuf_oflow_err_ = 0x1;
    ibuf_uflow_err_ = 0x1;
    op_fifo_oflow_err_ = 0x1;
    op_fifo_uflow_err_ = 0x1;
    tcam_par_err_ = 0x1;
    if (write_callback_) write_callback_();
  }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PrsrRegMainRspecIntrEnable0Mutable") + ":\n";
    ...
    r += indent_string + "  " + std::string("dst_cont_err") +  ": 0x" + boost::str( boost::format("%x") % static_cast<uint>(dst_cont_err_) ) + "\n";
    all_zeros &= (0 == dst_cont_err_);
  ...
  static int StartOffset(
    ...
    switch (selector_pmarb_rspec) {
      case kEbp18Reg:
        ...
        offset += 0x1a4; // to get to intr_enable0
        break;
      case kIbp18Reg:
        assert(index_ebp_rspec < 18);
...
#endif // __REGISTER_INCLUDES_PRSR_REG_MAIN_RSPEC_INTR_ENABLE0_MUTABLE_H__
