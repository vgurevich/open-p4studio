...
#ifndef __REGISTER_INCLUDES_PRSR_REG_MAIN_RSPEC_INTR_ENABLE1_MUTABLE_H__
#define __REGISTER_INCLUDES_PRSR_REG_MAIN_RSPEC_INTR_ENABLE1_MUTABLE_H__
...
class PrsrRegMainRspecIntrEnable1Mutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum PmarbRspecEnum {
    kEbp18Reg,
    kIbp18Reg
...
public:
  PrsrRegMainRspecIntrEnable1Mutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, selector_pmarb_rspec, index_ebp_rspec), 4, true, write_callback, read_callback, std::string("PrsrRegMainRspecIntrEnable1Mutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(selector_pmarb_rspec) + "," + boost::lexical_cast<std::string>(index_ebp_rspec))
    {
    }
  PrsrRegMainRspecIntrEnable1Mutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "PrsrRegMainRspecIntrEnable1Mutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PrsrRegMainRspecIntrEnable1Mutable") + ":\n";
  ...
  static int StartOffset(
    ...
    switch (selector_pmarb_rspec) {
      case kEbp18Reg:
        ...
        offset += 0x1a8; // to get to intr_enable1
        break;
      case kIbp18Reg:
        assert(index_ebp_rspec < 18);
...
#endif // __REGISTER_INCLUDES_PRSR_REG_MAIN_RSPEC_INTR_ENABLE1_MUTABLE_H__
