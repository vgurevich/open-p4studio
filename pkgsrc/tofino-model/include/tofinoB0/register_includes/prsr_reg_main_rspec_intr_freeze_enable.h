...
#ifndef __REGISTER_INCLUDES_PRSR_REG_MAIN_RSPEC_INTR_FREEZE_ENABLE_H__
#define __REGISTER_INCLUDES_PRSR_REG_MAIN_RSPEC_INTR_FREEZE_ENABLE_H__
...
class PrsrRegMainRspecIntrFreezeEnable : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum PmarbRspecEnum {
    kEbp18Reg,
    kIbp18Reg
...
public:
  PrsrRegMainRspecIntrFreezeEnable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, selector_pmarb_rspec, index_ebp_rspec), 4, false, write_callback, read_callback, std::string("PrsrRegMainRspecIntrFreezeEnable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(selector_pmarb_rspec) + "," + boost::lexical_cast<std::string>(index_ebp_rspec))
    {
    }
  PrsrRegMainRspecIntrFreezeEnable(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "PrsrRegMainRspecIntrFreezeEnable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PrsrRegMainRspecIntrFreezeEnable") + ":\n";
...
#endif // __REGISTER_INCLUDES_PRSR_REG_MAIN_RSPEC_INTR_FREEZE_ENABLE_H__
