...
#ifndef __REGISTER_INCLUDES_PRSR_REG_MAIN_RSPEC_INTR_INJECT_MUTABLE_H__
#define __REGISTER_INCLUDES_PRSR_REG_MAIN_RSPEC_INTR_INJECT_MUTABLE_H__
...
class PrsrRegMainRspecIntrInjectMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum PmarbRspecEnum {
    kEbp18Reg,
    kIbp18Reg
...
public:
  PrsrRegMainRspecIntrInjectMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, selector_pmarb_rspec, index_ebp_rspec), 4, true, write_callback, read_callback, std::string("PrsrRegMainRspecIntrInjectMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(selector_pmarb_rspec) + "," + boost::lexical_cast<std::string>(index_ebp_rspec))
    {
    }
  PrsrRegMainRspecIntrInjectMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "PrsrRegMainRspecIntrInjectMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PrsrRegMainRspecIntrInjectMutable") + ":\n";
  ...
  static int StartOffset(
    ...
    switch (selector_pmarb_rspec) {
      case kEbp18Reg:
        ...
        offset += 0x1ac; // to get to intr_inject
        break;
      case kIbp18Reg:
        assert(index_ebp_rspec < 18);
...
#endif // __REGISTER_INCLUDES_PRSR_REG_MAIN_RSPEC_INTR_INJECT_MUTABLE_H__
