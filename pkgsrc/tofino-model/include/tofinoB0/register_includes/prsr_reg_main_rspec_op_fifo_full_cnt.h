...
#ifndef __REGISTER_INCLUDES_PRSR_REG_MAIN_RSPEC_OP_FIFO_FULL_CNT_H__
#define __REGISTER_INCLUDES_PRSR_REG_MAIN_RSPEC_OP_FIFO_FULL_CNT_H__
...
class PrsrRegMainRspecOpFifoFullCnt : public model_core::RegisterBlock<RegisterCallback> {
public:
  enum PmarbRspecEnum {
    kEbp18Reg,
    kIbp18Reg
...
public:
  PrsrRegMainRspecOpFifoFullCnt(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, selector_pmarb_rspec, index_ebp_rspec), 8, false, write_callback, read_callback, std::string("PrsrRegMainRspecOpFifoFullCnt")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(selector_pmarb_rspec) + "," + boost::lexical_cast<std::string>(index_ebp_rspec))
    {
    }
  PrsrRegMainRspecOpFifoFullCnt(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "PrsrRegMainRspecOpFifoFullCnt")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PrsrRegMainRspecOpFifoFullCnt") + ":\n";
...
#endif // __REGISTER_INCLUDES_PRSR_REG_MAIN_RSPEC_OP_FIFO_FULL_CNT_H__
