...
#ifndef __REGISTER_INCLUDES_PRSR_REG_MERGE_RSPEC_PHV_OWNER_MUTABLE_H__
#define __REGISTER_INCLUDES_PRSR_REG_MERGE_RSPEC_PHV_OWNER_MUTABLE_H__
...
class PrsrRegMergeRspecPhvOwnerMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  PrsrRegMergeRspecPhvOwnerMutable(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 48, true, write_callback, read_callback, std::string("PrsrRegMergeRspecPhvOwnerMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  PrsrRegMergeRspecPhvOwnerMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "PrsrRegMergeRspecPhvOwnerMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PrsrRegMergeRspecPhvOwnerMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_PRSR_REG_MERGE_RSPEC_PHV_OWNER_MUTABLE_H__
