...
#ifndef __REGISTER_INCLUDES_PRSR_REG_MERGE_RSPEC_PHV_VALID_MUTABLE_H__
#define __REGISTER_INCLUDES_PRSR_REG_MERGE_RSPEC_PHV_VALID_MUTABLE_H__
...
class PrsrRegMergeRspecPhvValidMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  PrsrRegMergeRspecPhvValidMutable(
      int chipNumber, int index_pipe_addrmap, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap), 28, true, write_callback, read_callback, std::string("PrsrRegMergeRspecPhvValidMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap))
    {
    }
  PrsrRegMergeRspecPhvValidMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "PrsrRegMergeRspecPhvValidMutable")
    {
    }
public:
  ...
  void vld(int j0,const uint8_t &v) { vld_[j0]=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("PrsrRegMergeRspecPhvValidMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_PRSR_REG_MERGE_RSPEC_PHV_VALID_MUTABLE_H__
