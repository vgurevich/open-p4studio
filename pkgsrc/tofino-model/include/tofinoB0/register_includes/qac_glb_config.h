...
#ifndef __REGISTER_INCLUDES_QAC_GLB_CONFIG_H__
#define __REGISTER_INCLUDES_QAC_GLB_CONFIG_H__
...
class QacGlbConfig : public model_core::RegisterBlock<RegisterCallback> {
public:
  QacGlbConfig(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 4, false, write_callback, read_callback, std::string("QacGlbConfig"))
    {
    }
  QacGlbConfig(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "QacGlbConfig")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("QacGlbConfig") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x8; // to get to qac_common_qac_glb_config
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_QAC_GLB_CONFIG_H__
