...
#ifndef __REGISTER_INCLUDES_QAC_QUEUE_AP_CONFIG_ENTRY_ARRAY_H__
#define __REGISTER_INCLUDES_QAC_QUEUE_AP_CONFIG_ENTRY_ARRAY_H__
...
class QacQueueApConfigEntryArray : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  QacQueueApConfigEntryArray(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_tm_qac_pipe_rspec), 4 * ArraySize(index_tm_qac_pipe_rspec, -1), false, write_callback, read_callback, std::string("QacQueueApConfigEntryArray")+":"+boost::lexical_cast<std::string>(index_tm_qac_pipe_rspec)),
...
#endif // __REGISTER_INCLUDES_QAC_QUEUE_AP_CONFIG_ENTRY_ARRAY_H__
