...
#ifndef __REGISTER_INCLUDES_QAC_QUEUE_COLOR_LIMIT_ENTRY_ARRAY_MUTABLE_H__
#define __REGISTER_INCLUDES_QAC_QUEUE_COLOR_LIMIT_ENTRY_ARRAY_MUTABLE_H__
...
class QacQueueColorLimitEntryArrayMutable : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  QacQueueColorLimitEntryArrayMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_tm_qac_pipe_rspec), 4 * ArraySize(index_tm_qac_pipe_rspec, -1), true, write_callback, read_callback, std::string("QacQueueColorLimitEntryArrayMutable")+":"+boost::lexical_cast<std::string>(index_tm_qac_pipe_rspec)),
...
#endif // __REGISTER_INCLUDES_QAC_QUEUE_COLOR_LIMIT_ENTRY_ARRAY_MUTABLE_H__
