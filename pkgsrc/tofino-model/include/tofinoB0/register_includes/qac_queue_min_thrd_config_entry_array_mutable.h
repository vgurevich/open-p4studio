...
#ifndef __REGISTER_INCLUDES_QAC_QUEUE_MIN_THRD_CONFIG_ENTRY_ARRAY_MUTABLE_H__
#define __REGISTER_INCLUDES_QAC_QUEUE_MIN_THRD_CONFIG_ENTRY_ARRAY_MUTABLE_H__
...
class QacQueueMinThrdConfigEntryArrayMutable : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  QacQueueMinThrdConfigEntryArrayMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_tm_qac_pipe_rspec), 4 * ArraySize(index_tm_qac_pipe_rspec, -1), true, write_callback, read_callback, std::string("QacQueueMinThrdConfigEntryArrayMutable")+":"+boost::lexical_cast<std::string>(index_tm_qac_pipe_rspec)),
...
#endif // __REGISTER_INCLUDES_QAC_QUEUE_MIN_THRD_CONFIG_ENTRY_ARRAY_MUTABLE_H__
