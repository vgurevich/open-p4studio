...
#ifndef __REGISTER_INCLUDES_QAC_QUEUE_SHR_THRD_CONFIG_ENTRY_ARRAY_MUTABLE_H__
#define __REGISTER_INCLUDES_QAC_QUEUE_SHR_THRD_CONFIG_ENTRY_ARRAY_MUTABLE_H__
...
class QacQueueShrThrdConfigEntryArrayMutable : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  QacQueueShrThrdConfigEntryArrayMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_tm_qac_pipe_rspec), 4 * ArraySize(index_tm_qac_pipe_rspec, -1), true, write_callback, read_callback, std::string("QacQueueShrThrdConfigEntryArrayMutable")+":"+boost::lexical_cast<std::string>(index_tm_qac_pipe_rspec)),
...
#endif // __REGISTER_INCLUDES_QAC_QUEUE_SHR_THRD_CONFIG_ENTRY_ARRAY_MUTABLE_H__
