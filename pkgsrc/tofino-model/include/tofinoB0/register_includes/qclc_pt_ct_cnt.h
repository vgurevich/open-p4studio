...
public:
  QclcPtCtCnt(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_qclc_pt_ct_cnt), 4, false, write_callback, read_callback, std::string("QclcPtCtCnt")+":"+boost::lexical_cast<std::string>(index_qclc_pt_ct_cnt))
    {
    }
  QclcPtCtCnt(
