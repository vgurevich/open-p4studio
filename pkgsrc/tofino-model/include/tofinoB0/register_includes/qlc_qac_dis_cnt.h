...
#ifndef __REGISTER_INCLUDES_QLC_QAC_DIS_CNT_H__
#define __REGISTER_INCLUDES_QLC_QAC_DIS_CNT_H__
...
class QlcQacDisCnt : public model_core::RegisterBlock<RegisterCallback> {
public:
  QlcQacDisCnt(
      int chipNumber, int index_tm_qlc_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_qlc_pipe_rspec), 8, false, write_callback, read_callback, std::string("QlcQacDisCnt")+":"+boost::lexical_cast<std::string>(index_tm_qlc_pipe_rspec))
    {
    }
  QlcQacDisCnt(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "QlcQacDisCnt")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("QlcQacDisCnt") + ":\n";
...
#endif // __REGISTER_INCLUDES_QLC_QAC_DIS_CNT_H__
