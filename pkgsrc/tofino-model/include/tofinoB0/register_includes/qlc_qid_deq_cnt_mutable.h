...
#ifndef __REGISTER_INCLUDES_QLC_QID_DEQ_CNT_MUTABLE_H__
#define __REGISTER_INCLUDES_QLC_QID_DEQ_CNT_MUTABLE_H__
...
class QlcQidDeqCntMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  QlcQidDeqCntMutable(
      int chipNumber, int index_tm_qlc_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_qlc_pipe_rspec), 8, true, write_callback, read_callback, std::string("QlcQidDeqCntMutable")+":"+boost::lexical_cast<std::string>(index_tm_qlc_pipe_rspec))
    {
    }
  QlcQidDeqCntMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "QlcQidDeqCntMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("QlcQidDeqCntMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x130; // to get to qid_deq_cnt
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_QLC_QID_DEQ_CNT_MUTABLE_H__
