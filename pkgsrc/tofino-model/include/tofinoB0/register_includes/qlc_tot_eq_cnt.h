...
#ifndef __REGISTER_INCLUDES_QLC_TOT_EQ_CNT_H__
#define __REGISTER_INCLUDES_QLC_TOT_EQ_CNT_H__
...
class QlcTotEqCnt : public model_core::RegisterBlock<RegisterCallback> {
public:
  QlcTotEqCnt(
      int chipNumber, int index_tm_qlc_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_qlc_pipe_rspec), 8, false, write_callback, read_callback, std::string("QlcTotEqCnt")+":"+boost::lexical_cast<std::string>(index_tm_qlc_pipe_rspec))
    {
    }
  QlcTotEqCnt(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "QlcTotEqCnt")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("QlcTotEqCnt") + ":\n";
...
#endif // __REGISTER_INCLUDES_QLC_TOT_EQ_CNT_H__
