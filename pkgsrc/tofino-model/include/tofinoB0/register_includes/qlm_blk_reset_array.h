...
#ifndef __REGISTER_INCLUDES_QLM_BLK_RESET_ARRAY_H__
#define __REGISTER_INCLUDES_QLM_BLK_RESET_ARRAY_H__
...
class QlmBlkResetArray : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  QlmBlkResetArray(
      int chipNumber, RegisterArrayCallback& write_callback = 0, RegisterArrayCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 4 * ArraySize(-1), false, write_callback, read_callback, std::string("QlmBlkResetArray")),
...
public:
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("QlmBlkResetArray") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
#endif // __REGISTER_INCLUDES_QLM_BLK_RESET_ARRAY_H__
