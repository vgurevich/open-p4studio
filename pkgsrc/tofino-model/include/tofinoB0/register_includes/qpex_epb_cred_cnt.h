...
public:
  QpexEpbCredCnt(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_tm_pex_pipe_rspec, index_qpex_epb_cred_cnt), 4, false, write_callback, read_callback, std::string("QpexEpbCredCnt")+":"+boost::lexical_cast<std::string>(index_tm_pex_pipe_rspec) + "," + boost::lexical_cast<std::string>(index_qpex_epb_cred_cnt))
    {
    }
  QpexEpbCredCnt(
