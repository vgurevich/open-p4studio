...
#ifndef __REGISTER_INCLUDES_QPEX_PT_STATE_H__
#define __REGISTER_INCLUDES_QPEX_PT_STATE_H__
...
class QpexPtState : public model_core::RegisterBlock<RegisterCallback> {
public:
  QpexPtState(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_tm_pex_pipe_rspec, index_qpex_pt_state), 4, false, write_callback, read_callback, std::string("QpexPtState")+":"+boost::lexical_cast<std::string>(index_tm_pex_pipe_rspec) + "," + boost::lexical_cast<std::string>(index_qpex_pt_state))
    {
    }
  QpexPtState(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "QpexPtState")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("QpexPtState") + ":\n";
...
#endif // __REGISTER_INCLUDES_QPEX_PT_STATE_H__
