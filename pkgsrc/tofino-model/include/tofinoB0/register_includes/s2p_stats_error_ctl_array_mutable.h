...
public:
  uint8_t s2p_stats_error_ctl(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    return array[a0].s2p_stats_error_ctl();
  }
  void s2p_stats_error_ctl(uint32_t a0,const uint8_t &v) 
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    array[a0].s2p_stats_error_ctl(v);
  }
