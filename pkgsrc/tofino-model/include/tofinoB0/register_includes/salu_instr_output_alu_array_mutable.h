...
#ifndef __REGISTER_INCLUDES_SALU_INSTR_OUTPUT_ALU_ARRAY_MUTABLE_H__
#define __REGISTER_INCLUDES_SALU_INSTR_OUTPUT_ALU_ARRAY_MUTABLE_H__
...
class SaluInstrOutputAluArrayMutable : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  SaluInstrOutputAluArrayMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap, index_mau_meter_alu_group_addrmap), 4 * ArraySize(index_pipe_addrmap, index_mau_addrmap, index_mau_meter_alu_group_addrmap, -1), true, write_callback, read_callback, std::string("SaluInstrOutputAluArrayMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_meter_alu_group_addrmap)),
...
public:
  ...
  uint8_t salu_output_cmpfn(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    return array[a0].salu_output_cmpfn();
  }
  void salu_output_cmpfn(uint32_t a0,const uint8_t &v) 
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    array[a0].salu_output_cmpfn(v);
  }
  ...
  uint8_t salu_output_asrc(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    return array[a0].salu_output_asrc();
  }
  void salu_output_asrc(uint32_t a0,const uint8_t &v) 
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    array[a0].salu_output_asrc(v);
  }
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("SaluInstrOutputAluArrayMutable") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
#endif // __REGISTER_INCLUDES_SALU_INSTR_OUTPUT_ALU_ARRAY_MUTABLE_H__
