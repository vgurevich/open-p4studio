...
#ifndef __REGISTER_INCLUDES_SALU_MATHTABLE_ARRAY_H__
#define __REGISTER_INCLUDES_SALU_MATHTABLE_ARRAY_H__
...
class SaluMathtableArray : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  SaluMathtableArray(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap, index_mau_meter_alu_group_addrmap), 4 * ArraySize(index_pipe_addrmap, index_mau_addrmap, index_mau_meter_alu_group_addrmap, -1), false, write_callback, read_callback, std::string("SaluMathtableArray")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_meter_alu_group_addrmap)),
...
public:
  uint32_t &salu_mathtable(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    return array[a0].salu_mathtable();
  }
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("SaluMathtableArray") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
private:
  std::vector<SaluMathtable> array;
  uint32_t size0_;
...
#endif // __REGISTER_INCLUDES_SALU_MATHTABLE_ARRAY_H__
