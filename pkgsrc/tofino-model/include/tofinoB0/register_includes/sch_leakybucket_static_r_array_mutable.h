...
#ifndef __REGISTER_INCLUDES_SCH_LEAKYBUCKET_STATIC_R_ARRAY_MUTABLE_H__
#define __REGISTER_INCLUDES_SCH_LEAKYBUCKET_STATIC_R_ARRAY_MUTABLE_H__
...
class SchLeakybucketStaticRArrayMutable : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
...
public:
  SchLeakybucketStaticRArrayMutable(
...
public:
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("SchLeakybucketStaticRArrayMutable") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
private:
  std::vector<SchLeakybucketStaticRMutable> array;
  uint32_t size0_;
...
#endif // __REGISTER_INCLUDES_SCH_LEAKYBUCKET_STATIC_R_ARRAY_MUTABLE_H__
