...
public:
  SchPortConfigRMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_tm_sch_pipe_rspec, index_sch_port_config_r), 4, true, write_callback, read_callback, std::string("SchPortConfigRMutable")+":"+boost::lexical_cast<std::string>(index_tm_sch_pipe_rspec) + "," + boost::lexical_cast<std::string>(index_sch_port_config_r))
    {
    }
  SchPortConfigRMutable(
...
public:
  ...
  void maxcr(const uint8_t &v) { maxcr_=v; }
