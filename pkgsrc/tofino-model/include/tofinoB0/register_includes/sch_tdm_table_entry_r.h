...
public:
  SchTdmTableEntryR(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_tm_sch_pipe_rspec, index_sch_tdm_table_entry_r), 4, false, write_callback, read_callback, std::string("SchTdmTableEntryR")+":"+boost::lexical_cast<std::string>(index_tm_sch_pipe_rspec) + "," + boost::lexical_cast<std::string>(index_sch_tdm_table_entry_r))
    {
    }
  SchTdmTableEntryR(
