...
#ifndef __REGISTER_INCLUDES_SERDES_ADDRMAP_ARRAY_H__
#define __REGISTER_INCLUDES_SERDES_ADDRMAP_ARRAY_H__
...
class SerdesAddrmapArray : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  SerdesAddrmapArray(
      int chipNumber, RegisterArrayCallback& write_callback = 0, RegisterArrayCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 4194304 * ArraySize(-1), false, write_callback, read_callback, std::string("SerdesAddrmapArray")),
...
public:
  SerdesAddrmapDummyRegister &dummy_register(uint32_t a0)
  {
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("SerdesAddrmapArray") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
private:
  std::vector<SerdesAddrmap> array;
  uint32_t size0_;
...
#endif // __REGISTER_INCLUDES_SERDES_ADDRMAP_ARRAY_H__
