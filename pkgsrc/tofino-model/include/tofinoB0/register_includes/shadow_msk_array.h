...
#ifndef __REGISTER_INCLUDES_SHADOW_MSK_ARRAY_H__
#define __REGISTER_INCLUDES_SHADOW_MSK_ARRAY_H__
...
class ShadowMskArray : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  ShadowMskArray(
      int chipNumber, RegisterArrayCallback& write_callback = 0, RegisterArrayCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 4 * ArraySize(-1), false, write_callback, read_callback, std::string("ShadowMskArray")),
...
public:
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("ShadowMskArray") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
#endif // __REGISTER_INCLUDES_SHADOW_MSK_ARRAY_H__
