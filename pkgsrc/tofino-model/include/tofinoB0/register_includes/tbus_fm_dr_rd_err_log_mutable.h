...
#ifndef __REGISTER_INCLUDES_TBUS_FM_DR_RD_ERR_LOG_MUTABLE_H__
#define __REGISTER_INCLUDES_TBUS_FM_DR_RD_ERR_LOG_MUTABLE_H__
...
class TbusFmDrRdErrLogMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  TbusFmDrRdErrLogMutable(
      int chipNumber, int index_tbus_fm_dr_rd_err_log, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tbus_fm_dr_rd_err_log), 4, true, write_callback, read_callback, std::string("TbusFmDrRdErrLogMutable")+":"+boost::lexical_cast<std::string>(index_tbus_fm_dr_rd_err_log))
    {
    }
  TbusFmDrRdErrLogMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "TbusFmDrRdErrLogMutable")
    {
    }
public:
  ...
  void fm_dr_rd_err_status(const uint8_t &v) { fm_dr_rd_err_status_=v; }
  ...
  void fm_dr_rd_err_head_ptr(const uint32_t &v) { fm_dr_rd_err_head_ptr_=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("TbusFmDrRdErrLogMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_TBUS_FM_DR_RD_ERR_LOG_MUTABLE_H__
