...
#ifndef __REGISTER_INCLUDES_TCAM_HIT_TO_LOGICAL_TABLE_IXBAR_OUTPUTMAP_ARRAY_H__
#define __REGISTER_INCLUDES_TCAM_HIT_TO_LOGICAL_TABLE_IXBAR_OUTPUTMAP_ARRAY_H__
...
class TcamHitToLogicalTableIxbarOutputmapArray : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  TcamHitToLogicalTableIxbarOutputmapArray(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap), 4 * ArraySize(index_pipe_addrmap, index_mau_addrmap, -1), false, write_callback, read_callback, std::string("TcamHitToLogicalTableIxbarOutputmapArray")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap)),
...
public:
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("TcamHitToLogicalTableIxbarOutputmapArray") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
private:
  std::vector<TcamHitToLogicalTableIxbarOutputmap> array;
  uint32_t size0_;
...
#endif // __REGISTER_INCLUDES_TCAM_HIT_TO_LOGICAL_TABLE_IXBAR_OUTPUTMAP_ARRAY_H__
