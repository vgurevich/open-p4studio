...
#ifndef __REGISTER_INCLUDES_TCAM_TABLE_PROP_ARRAY_MUTABLE_H__
#define __REGISTER_INCLUDES_TCAM_TABLE_PROP_ARRAY_MUTABLE_H__
...
class TcamTablePropArrayMutable : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  TcamTablePropArrayMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_pipe_addrmap, index_mau_addrmap), 4 * ArraySize(index_pipe_addrmap, index_mau_addrmap, -1), true, write_callback, read_callback, std::string("TcamTablePropArrayMutable")+":"+boost::lexical_cast<std::string>(index_pipe_addrmap) + "," + boost::lexical_cast<std::string>(index_mau_addrmap)),
...
public:
  ...
  uint8_t tcam_piped(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    return array[a0].tcam_piped();
  }
  void tcam_piped(uint32_t a0,const uint8_t &v) 
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    array[a0].tcam_piped(v);
  }



  uint8_t thread(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    return array[a0].thread();
  }
  void thread(uint32_t a0,const uint8_t &v) 
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    array[a0].thread(v);
  }
  ...
  uint8_t enabled(uint32_t a0)
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    return array[a0].enabled();
  }
  void enabled(uint32_t a0,const uint8_t &v) 
  {
    CheckArrayBounds(a0,real_size0_,size0_,0,0,false);
    array[a0].enabled(v);
  }
  ...
  std::string to_string(
    ...
    if (! r_s.empty()) {
      r += indent_string + std::string("TcamTablePropArrayMutable") + "["+boost::lexical_cast<std::string>(a0)+"]"+ ":\n" + r_s ;
    }
...
private:
  std::vector<TcamTablePropMutable> array;
  uint32_t size0_;
...
#endif // __REGISTER_INCLUDES_TCAM_TABLE_PROP_ARRAY_MUTABLE_H__
