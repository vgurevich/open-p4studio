...
#ifndef __REGISTER_INCLUDES_TM_CAA_CDM_RSPEC_MUTABLE_H__
#define __REGISTER_INCLUDES_TM_CAA_CDM_RSPEC_MUTABLE_H__
...
#include "caa_cdm_indir_access_addr_r_mutable.h"
#include "caa_cdm_indir_access_data_r_mutable.h"
#include "tm_caa_cdm_rspec_cdm_mbe_errlog_mutable.h"
#include "tm_caa_cdm_rspec_cdm_sbe_errlog_mutable.h"
#include "tm_caa_cdm_rspec_ecc_mutable.h"
#include "tm_caa_cdm_rspec_intr_mutable.h"

namespace tofinoB0 {
  namespace register_classes {

class TmCaaCdmRspecMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  TmCaaCdmRspecMutable(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 32768, true, write_callback, read_callback, std::string("TmCaaCdmRspecMutable"))
    {
    }
  TmCaaCdmRspecMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "TmCaaCdmRspecMutable")
    {
    }
public:
  ...
  TmCaaCdmRspecEccMutable &ecc() { return ecc_; }





  TmCaaCdmRspecCdmSbeErrlogMutable &cdm_sbe_errlog() { return cdm_sbe_errlog_; }





  TmCaaCdmRspecCdmMbeErrlogMutable &cdm_mbe_errlog() { return cdm_mbe_errlog_; }
  ...
  CaaCdmIndirAccessAddrRMutable &cdm_indir_access_addr() { return cdm_indir_access_addr_; }
  ...
  CaaCdmIndirAccessDataRMutable &cdm_indir_access_data() { return cdm_indir_access_data_; }
  TmCaaCdmRspecIntrMutable &intr() { return intr_; }
...
private:
  TmCaaCdmRspecEccMutable ecc_;
  TmCaaCdmRspecCdmSbeErrlogMutable cdm_sbe_errlog_;
  TmCaaCdmRspecCdmMbeErrlogMutable cdm_mbe_errlog_;
  CaaCdmIndirAccessAddrRMutable cdm_indir_access_addr_;
  CaaCdmIndirAccessDataRMutable cdm_indir_access_data_;
  TmCaaCdmRspecIntrMutable intr_;
private:
...
#endif // __REGISTER_INCLUDES_TM_CAA_CDM_RSPEC_MUTABLE_H__
