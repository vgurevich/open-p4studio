...
#ifndef __REGISTER_INCLUDES_TM_CAA_RSPEC_DEBUG_BUS_CTRL_H__
#define __REGISTER_INCLUDES_TM_CAA_RSPEC_DEBUG_BUS_CTRL_H__
...
class TmCaaRspecDebugBusCtrl : public model_core::RegisterBlock<RegisterCallback> {
public:
  TmCaaRspecDebugBusCtrl(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 4, false, write_callback, read_callback, std::string("TmCaaRspecDebugBusCtrl"))
    {
    }
  TmCaaRspecDebugBusCtrl(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "TmCaaRspecDebugBusCtrl")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("TmCaaRspecDebugBusCtrl") + ":\n";
...
#endif // __REGISTER_INCLUDES_TM_CAA_RSPEC_DEBUG_BUS_CTRL_H__
