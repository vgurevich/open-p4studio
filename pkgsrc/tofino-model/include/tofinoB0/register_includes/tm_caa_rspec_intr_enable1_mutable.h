...
#ifndef __REGISTER_INCLUDES_TM_CAA_RSPEC_INTR_ENABLE1_MUTABLE_H__
#define __REGISTER_INCLUDES_TM_CAA_RSPEC_INTR_ENABLE1_MUTABLE_H__
...
class TmCaaRspecIntrEnable1Mutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  TmCaaRspecIntrEnable1Mutable(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 4, true, write_callback, read_callback, std::string("TmCaaRspecIntrEnable1Mutable"))
    {
    }
  TmCaaRspecIntrEnable1Mutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "TmCaaRspecIntrEnable1Mutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("TmCaaRspecIntrEnable1Mutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_TM_CAA_RSPEC_INTR_ENABLE1_MUTABLE_H__
