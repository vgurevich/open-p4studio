...
#ifndef __REGISTER_INCLUDES_TM_CAA_RSPEC_INTR_FREEZE_ENABLE_H__
#define __REGISTER_INCLUDES_TM_CAA_RSPEC_INTR_FREEZE_ENABLE_H__
...
class TmCaaRspecIntrFreezeEnable : public model_core::RegisterBlock<RegisterCallback> {
public:
  TmCaaRspecIntrFreezeEnable(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 4, false, write_callback, read_callback, std::string("TmCaaRspecIntrFreezeEnable"))
    {
    }
  TmCaaRspecIntrFreezeEnable(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "TmCaaRspecIntrFreezeEnable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("TmCaaRspecIntrFreezeEnable") + ":\n";
...
#endif // __REGISTER_INCLUDES_TM_CAA_RSPEC_INTR_FREEZE_ENABLE_H__
