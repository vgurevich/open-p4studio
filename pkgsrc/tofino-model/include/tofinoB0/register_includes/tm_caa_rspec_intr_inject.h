...
#ifndef __REGISTER_INCLUDES_TM_CAA_RSPEC_INTR_INJECT_H__
#define __REGISTER_INCLUDES_TM_CAA_RSPEC_INTR_INJECT_H__
...
class TmCaaRspecIntrInject : public model_core::RegisterBlock<RegisterCallback> {
public:
  TmCaaRspecIntrInject(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 4, false, write_callback, read_callback, std::string("TmCaaRspecIntrInject"))
    {
    }
  TmCaaRspecIntrInject(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "TmCaaRspecIntrInject")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("TmCaaRspecIntrInject") + ":\n";
...
#endif // __REGISTER_INCLUDES_TM_CAA_RSPEC_INTR_INJECT_H__
