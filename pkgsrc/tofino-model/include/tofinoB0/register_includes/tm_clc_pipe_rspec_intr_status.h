...
#ifndef __REGISTER_INCLUDES_TM_CLC_PIPE_RSPEC_INTR_STATUS_H__
#define __REGISTER_INCLUDES_TM_CLC_PIPE_RSPEC_INTR_STATUS_H__
...
class TmClcPipeRspecIntrStatus : public model_core::RegisterBlock<RegisterCallback> {
public:
  TmClcPipeRspecIntrStatus(
      int chipNumber, int index_tm_clc_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_clc_pipe_rspec), 4, false, write_callback, read_callback, std::string("TmClcPipeRspecIntrStatus")+":"+boost::lexical_cast<std::string>(index_tm_clc_pipe_rspec))
    {
    }
  TmClcPipeRspecIntrStatus(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "TmClcPipeRspecIntrStatus")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("TmClcPipeRspecIntrStatus") + ":\n";
...
#endif // __REGISTER_INCLUDES_TM_CLC_PIPE_RSPEC_INTR_STATUS_H__
