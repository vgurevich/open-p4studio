...
#ifndef __REGISTER_INCLUDES_TM_CLC_PIPE_RSPEC_INTR_STATUS_MUTABLE_H__
#define __REGISTER_INCLUDES_TM_CLC_PIPE_RSPEC_INTR_STATUS_MUTABLE_H__
...
class TmClcPipeRspecIntrStatusMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  TmClcPipeRspecIntrStatusMutable(
      int chipNumber, int index_tm_clc_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_clc_pipe_rspec), 4, true, write_callback, read_callback, std::string("TmClcPipeRspecIntrStatusMutable")+":"+boost::lexical_cast<std::string>(index_tm_clc_pipe_rspec))
    {
    }
  TmClcPipeRspecIntrStatusMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "TmClcPipeRspecIntrStatusMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("TmClcPipeRspecIntrStatusMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_TM_CLC_PIPE_RSPEC_INTR_STATUS_MUTABLE_H__
