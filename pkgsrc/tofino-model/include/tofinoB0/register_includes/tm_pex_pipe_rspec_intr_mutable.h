...
#ifndef __REGISTER_INCLUDES_TM_PEX_PIPE_RSPEC_INTR_MUTABLE_H__
#define __REGISTER_INCLUDES_TM_PEX_PIPE_RSPEC_INTR_MUTABLE_H__
...
#include "tm_pex_pipe_rspec_intr_enable0_mutable.h"
#include "tm_pex_pipe_rspec_intr_enable1_mutable.h"
#include "tm_pex_pipe_rspec_intr_freeze_enable_mutable.h"
#include "tm_pex_pipe_rspec_intr_inject_mutable.h"
#include "tm_pex_pipe_rspec_intr_status_mutable.h"

namespace tofinoB0 {
  namespace register_classes {

class TmPexPipeRspecIntrMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  TmPexPipeRspecIntrMutable(
      int chipNumber, int index_tm_pex_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_pex_pipe_rspec), 20, true, write_callback, read_callback, std::string("TmPexPipeRspecIntrMutable")+":"+boost::lexical_cast<std::string>(index_tm_pex_pipe_rspec))
    {
    }
  TmPexPipeRspecIntrMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "TmPexPipeRspecIntrMutable")
    {
    }
public:
  ...
  TmPexPipeRspecIntrStatusMutable &intr_status() { return intr_status_; }
  ...
  TmPexPipeRspecIntrEnable0Mutable &intr_enable0() { return intr_enable0_; }
  ...
  TmPexPipeRspecIntrEnable1Mutable &intr_enable1() { return intr_enable1_; }
  ...
  TmPexPipeRspecIntrInjectMutable &intr_inject() { return intr_inject_; }





  TmPexPipeRspecIntrFreezeEnableMutable &intr_freeze_enable() { return intr_freeze_enable_; }
...
private:
  TmPexPipeRspecIntrStatusMutable intr_status_;
  TmPexPipeRspecIntrEnable0Mutable intr_enable0_;
  TmPexPipeRspecIntrEnable1Mutable intr_enable1_;
  TmPexPipeRspecIntrInjectMutable intr_inject_;
  TmPexPipeRspecIntrFreezeEnableMutable intr_freeze_enable_;
private:
...
#endif // __REGISTER_INCLUDES_TM_PEX_PIPE_RSPEC_INTR_MUTABLE_H__
