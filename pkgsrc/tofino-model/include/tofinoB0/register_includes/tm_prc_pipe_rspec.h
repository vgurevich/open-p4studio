...
#include "prc_ind_addr.h"
#include "prc_ind_data_0.h"
#include "prc_ind_data_1.h"
#include "prc_ind_data_2.h"
#include "prc_pex_cnt.h"
#include "prc_pex_zero_cnt.h"
#include "prc_pipe_control.h"
#include "prc_qac_cnt.h"
#include "prc_qac_zero_cnt.h"
#include "tm_prc_pipe_rspec_cache_mbe_errlog.h"
#include "tm_prc_pipe_rspec_cache_sbe_errlog.h"
#include "tm_prc_pipe_rspec_debug_bus_ctrl.h"
#include "tm_prc_pipe_rspec_ecc.h"
#include "tm_prc_pipe_rspec_intr.h"
#include "tm_prc_pipe_rspec_prm_mbe_errlog.h"
#include "tm_prc_pipe_rspec_prm_sbe_errlog.h"
...
public:
  ...
  TmPrcPipeRspecPrmMbeErrlog &prm_mbe_errlog() { return prm_mbe_errlog_; }





  TmPrcPipeRspecPrmSbeErrlog &prm_sbe_errlog() { return prm_sbe_errlog_; }





  TmPrcPipeRspecCacheMbeErrlog &cache_mbe_errlog() { return cache_mbe_errlog_; }





  TmPrcPipeRspecCacheSbeErrlog &cache_sbe_errlog() { return cache_sbe_errlog_; }
  ...
  PrcIndAddr &ind_addr() { return ind_addr_; }





  PrcIndData_0 &ind_data_0() { return ind_data_0_; }





  PrcIndData_1 &ind_data_1() { return ind_data_1_; }





  PrcIndData_2 &ind_data_2() { return ind_data_2_; }
...
private:
  ...
  TmPrcPipeRspecPrmMbeErrlog prm_mbe_errlog_;
  TmPrcPipeRspecPrmSbeErrlog prm_sbe_errlog_;
  TmPrcPipeRspecCacheMbeErrlog cache_mbe_errlog_;
  TmPrcPipeRspecCacheSbeErrlog cache_sbe_errlog_;
  PrcQacCnt qac_cnt_;
  PrcQacZeroCnt qac_zero_cnt_;
  PrcPexCnt pex_cnt_;
  PrcPexZeroCnt pex_zero_cnt_;
  PrcIndAddr ind_addr_;
  PrcIndData_0 ind_data_0_;
  PrcIndData_1 ind_data_1_;
  PrcIndData_2 ind_data_2_;
