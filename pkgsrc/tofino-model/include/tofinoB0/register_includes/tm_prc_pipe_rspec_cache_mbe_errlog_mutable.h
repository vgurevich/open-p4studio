...
#ifndef __REGISTER_INCLUDES_TM_PRC_PIPE_RSPEC_CACHE_MBE_ERRLOG_MUTABLE_H__
#define __REGISTER_INCLUDES_TM_PRC_PIPE_RSPEC_CACHE_MBE_ERRLOG_MUTABLE_H__
...
public:
  TmPrcPipeRspecCacheMbeErrlogMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_tm_prc_pipe_rspec), 4, true, write_callback, read_callback, std::string("TmPrcPipeRspecCacheMbeErrlogMutable")+":"+boost::lexical_cast<std::string>(index_tm_prc_pipe_rspec))
    {
    }
  TmPrcPipeRspecCacheMbeErrlogMutable(
...
#endif // __REGISTER_INCLUDES_TM_PRC_PIPE_RSPEC_CACHE_MBE_ERRLOG_MUTABLE_H__
