...
#ifndef __REGISTER_INCLUDES_TM_PRC_PIPE_RSPEC_CACHE_SBE_ERRLOG_H__
#define __REGISTER_INCLUDES_TM_PRC_PIPE_RSPEC_CACHE_SBE_ERRLOG_H__
...
public:
  TmPrcPipeRspecCacheSbeErrlog(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_tm_prc_pipe_rspec), 4, false, write_callback, read_callback, std::string("TmPrcPipeRspecCacheSbeErrlog")+":"+boost::lexical_cast<std::string>(index_tm_prc_pipe_rspec))
    {
    }
  TmPrcPipeRspecCacheSbeErrlog(
...
#endif // __REGISTER_INCLUDES_TM_PRC_PIPE_RSPEC_CACHE_SBE_ERRLOG_H__
