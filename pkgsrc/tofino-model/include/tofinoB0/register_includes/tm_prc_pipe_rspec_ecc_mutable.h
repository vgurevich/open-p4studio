...
#ifndef __REGISTER_INCLUDES_TM_PRC_PIPE_RSPEC_ECC_MUTABLE_H__
#define __REGISTER_INCLUDES_TM_PRC_PIPE_RSPEC_ECC_MUTABLE_H__
...
class TmPrcPipeRspecEccMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  TmPrcPipeRspecEccMutable(
      int chipNumber, int index_tm_prc_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_prc_pipe_rspec), 4, true, write_callback, read_callback, std::string("TmPrcPipeRspecEccMutable")+":"+boost::lexical_cast<std::string>(index_tm_prc_pipe_rspec))
    {
    }
  TmPrcPipeRspecEccMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "TmPrcPipeRspecEccMutable")
    {
    }
public:
  ...
  void _p_r_c__p_l_m_disable_check(const uint8_t &v) { _p_r_c__p_l_m_disable_check_=v; }




  uint8_t _p_r_c__p_l_m_inject_sbe() { return _p_r_c__p_l_m_inject_sbe_; }
  void _p_r_c__p_l_m_inject_sbe(const uint8_t &v) { _p_r_c__p_l_m_inject_sbe_=v; }




  uint8_t _p_r_c__p_l_m_inject_mbe() { return _p_r_c__p_l_m_inject_mbe_; }
  void _p_r_c__p_l_m_inject_mbe(const uint8_t &v) { _p_r_c__p_l_m_inject_mbe_=v; }




  uint8_t cache_disable_check() { return cache_disable_check_; }
  void cache_disable_check(const uint8_t &v) { cache_disable_check_=v; }




  uint8_t cache_inject_sbe() { return cache_inject_sbe_; }
  void cache_inject_sbe(const uint8_t &v) { cache_inject_sbe_=v; }




  uint8_t cache_inject_mbe() { return cache_inject_mbe_; }
  void cache_inject_mbe(const uint8_t &v) { cache_inject_mbe_=v; }
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("TmPrcPipeRspecEccMutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_TM_PRC_PIPE_RSPEC_ECC_MUTABLE_H__
