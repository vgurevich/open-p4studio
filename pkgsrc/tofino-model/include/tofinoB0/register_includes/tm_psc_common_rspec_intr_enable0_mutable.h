...
#ifndef __REGISTER_INCLUDES_TM_PSC_COMMON_RSPEC_INTR_ENABLE0_MUTABLE_H__
#define __REGISTER_INCLUDES_TM_PSC_COMMON_RSPEC_INTR_ENABLE0_MUTABLE_H__
...
class TmPscCommonRspecIntrEnable0Mutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  TmPscCommonRspecIntrEnable0Mutable(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 4, true, write_callback, read_callback, std::string("TmPscCommonRspecIntrEnable0Mutable"))
    {
    }
  TmPscCommonRspecIntrEnable0Mutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "TmPscCommonRspecIntrEnable0Mutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("TmPscCommonRspecIntrEnable0Mutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x3044; // to get to intr_enable0
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_TM_PSC_COMMON_RSPEC_INTR_ENABLE0_MUTABLE_H__
