...
#ifndef __REGISTER_INCLUDES_TM_PSC_COMMON_RSPEC_INTR_INJECT_H__
#define __REGISTER_INCLUDES_TM_PSC_COMMON_RSPEC_INTR_INJECT_H__
...
class TmPscCommonRspecIntrInject : public model_core::RegisterBlock<RegisterCallback> {
public:
  TmPscCommonRspecIntrInject(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 4, false, write_callback, read_callback, std::string("TmPscCommonRspecIntrInject"))
    {
    }
  TmPscCommonRspecIntrInject(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "TmPscCommonRspecIntrInject")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("TmPscCommonRspecIntrInject") + ":\n";
...
#endif // __REGISTER_INCLUDES_TM_PSC_COMMON_RSPEC_INTR_INJECT_H__
