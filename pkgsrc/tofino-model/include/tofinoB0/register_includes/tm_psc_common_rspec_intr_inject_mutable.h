...
#ifndef __REGISTER_INCLUDES_TM_PSC_COMMON_RSPEC_INTR_INJECT_MUTABLE_H__
#define __REGISTER_INCLUDES_TM_PSC_COMMON_RSPEC_INTR_INJECT_MUTABLE_H__
...
class TmPscCommonRspecIntrInjectMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  TmPscCommonRspecIntrInjectMutable(
      int chipNumber, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(), 4, true, write_callback, read_callback, std::string("TmPscCommonRspecIntrInjectMutable"))
    {
    }
  TmPscCommonRspecIntrInjectMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "TmPscCommonRspecIntrInjectMutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("TmPscCommonRspecIntrInjectMutable") + ":\n";
...
private:
  static int StartOffset(
    ...
    offset += 0x304c; // to get to intr_inject
    return offset;
  }
...
#endif // __REGISTER_INCLUDES_TM_PSC_COMMON_RSPEC_INTR_INJECT_MUTABLE_H__
