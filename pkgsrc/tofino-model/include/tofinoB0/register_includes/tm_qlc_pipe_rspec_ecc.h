...
#ifndef __REGISTER_INCLUDES_TM_QLC_PIPE_RSPEC_ECC_H__
#define __REGISTER_INCLUDES_TM_QLC_PIPE_RSPEC_ECC_H__
...
class TmQlcPipeRspecEcc : public model_core::RegisterBlock<RegisterCallback> {
public:
  TmQlcPipeRspecEcc(
      int chipNumber, int index_tm_qlc_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_qlc_pipe_rspec), 4, false, write_callback, read_callback, std::string("TmQlcPipeRspecEcc")+":"+boost::lexical_cast<std::string>(index_tm_qlc_pipe_rspec))
    {
    }
  TmQlcPipeRspecEcc(
      
  )
    : RegisterBlock(0, 0, 0, false, 0, 0, "TmQlcPipeRspecEcc")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("TmQlcPipeRspecEcc") + ":\n";
...
#endif // __REGISTER_INCLUDES_TM_QLC_PIPE_RSPEC_ECC_H__
