...
public:
  TmSchPipeRspec(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_tm_sch_pipe_rspec), 65536, false, write_callback, read_callback, std::string("TmSchPipeRspec")+":"+boost::lexical_cast<std::string>(index_tm_sch_pipe_rspec))
    {
    }
  TmSchPipeRspec(
...
public:
  ...
  TmSchPipeRspecTdmTableSbeErrlog &tdm_table_sbe_errlog() { return tdm_table_sbe_errlog_; }





  TmSchPipeRspecTdmTableMbeErrlog &tdm_table_mbe_errlog() { return tdm_table_mbe_errlog_; }





  TmSchPipeRspecQMinrateSbeErrlog &q_minrate_sbe_errlog() { return q_minrate_sbe_errlog_; }





  TmSchPipeRspecQMinrateMbeErrlog &q_minrate_mbe_errlog() { return q_minrate_mbe_errlog_; }





  TmSchPipeRspecQExcrateSbeErrlog &q_excrate_sbe_errlog() { return q_excrate_sbe_errlog_; }





  TmSchPipeRspecQExcrateMbeErrlog &q_excrate_mbe_errlog() { return q_excrate_mbe_errlog_; }





  TmSchPipeRspecQMaxrateSbeErrlog &q_maxrate_sbe_errlog() { return q_maxrate_sbe_errlog_; }





  TmSchPipeRspecQMaxrateMbeErrlog &q_maxrate_mbe_errlog() { return q_maxrate_mbe_errlog_; }





  TmSchPipeRspecPMaxrateSbeErrlog &p_maxrate_sbe_errlog() { return p_maxrate_sbe_errlog_; }





  TmSchPipeRspecPMaxrateMbeErrlog &p_maxrate_mbe_errlog() { return p_maxrate_mbe_errlog_; }
  ...
  TmSchPipeRspecUpdPex0SbeErrlog &upd_pex0_sbe_errlog() { return upd_pex0_sbe_errlog_; }
  ...
  TmSchPipeRspecUpdPex0MbeErrlog &upd_pex0_mbe_errlog() { return upd_pex0_mbe_errlog_; }
  ...
  TmSchPipeRspecUpdPex1SbeErrlog &upd_pex1_sbe_errlog() { return upd_pex1_sbe_errlog_; }
  ...
  TmSchPipeRspecUpdPex1MbeErrlog &upd_pex1_mbe_errlog() { return upd_pex1_mbe_errlog_; }
  ...
  TmSchPipeRspecUpdEdprsrSbeErrlog &upd_edprsr_sbe_errlog() { return upd_edprsr_sbe_errlog_; }
  ...
  TmSchPipeRspecUpdEdprsrMbeErrlog &upd_edprsr_mbe_errlog() { return upd_edprsr_mbe_errlog_; }





  TmSchPipeRspecPexCreditErrlog &pex_credit_errlog() { return pex_credit_errlog_; }
  ...
  SchLeakybucketStaticR &port_max_lb_static_mem(int j0) { return port_max_lb_static_mem_[j0]; }
  ...
  SchLeakybucketDynamicR &port_max_lb_dynamic_mem(int j0) { return port_max_lb_dynamic_mem_[j0]; }
  ...
  SchLeakybucketStaticR &q_min_lb_static_mem(int j0) { return q_min_lb_static_mem_[j0]; }
  ...
  SchLeakybucketDynamicR &q_min_lb_dynamic_mem(int j0) { return q_min_lb_dynamic_mem_[j0]; }
  ...
  SchLeakybucketStaticR &q_max_lb_static_mem(int j0) { return q_max_lb_static_mem_[j0]; }
  ...
  SchLeakybucketDynamicR &q_max_lb_dynamic_mem(int j0) { return q_max_lb_dynamic_mem_[j0]; }
  ...
  SchExcessbucketStaticR &q_exc_static_mem(int j0) { return q_exc_static_mem_[j0]; }
  ...
  SchExcessbucketDynamicR &q_exc_dynamic_mem(int j0) { return q_exc_dynamic_mem_[j0]; }
  ...
  SchQueuePfcStatusR &q_pfc_status_mem(int j0) { return q_pfc_status_mem_[j0]; }
...
private:
  ...
  TmSchPipeRspecTdmTableSbeErrlog tdm_table_sbe_errlog_;
  TmSchPipeRspecTdmTableMbeErrlog tdm_table_mbe_errlog_;
  TmSchPipeRspecQMinrateSbeErrlog q_minrate_sbe_errlog_;
  TmSchPipeRspecQMinrateMbeErrlog q_minrate_mbe_errlog_;
  TmSchPipeRspecQExcrateSbeErrlog q_excrate_sbe_errlog_;
  TmSchPipeRspecQExcrateMbeErrlog q_excrate_mbe_errlog_;
  TmSchPipeRspecQMaxrateSbeErrlog q_maxrate_sbe_errlog_;
  TmSchPipeRspecQMaxrateMbeErrlog q_maxrate_mbe_errlog_;
  TmSchPipeRspecPMaxrateSbeErrlog p_maxrate_sbe_errlog_;
  TmSchPipeRspecPMaxrateMbeErrlog p_maxrate_mbe_errlog_;
  TmSchPipeRspecUpdPex0SbeErrlog upd_pex0_sbe_errlog_;
  TmSchPipeRspecUpdPex0MbeErrlog upd_pex0_mbe_errlog_;
  TmSchPipeRspecUpdPex1SbeErrlog upd_pex1_sbe_errlog_;
  TmSchPipeRspecUpdPex1MbeErrlog upd_pex1_mbe_errlog_;
  TmSchPipeRspecUpdEdprsrSbeErrlog upd_edprsr_sbe_errlog_;
  TmSchPipeRspecUpdEdprsrMbeErrlog upd_edprsr_mbe_errlog_;
  TmSchPipeRspecPexCreditErrlog pex_credit_errlog_;
  SchCtrlR ctrl_;
  SchReadyR ready_;
  ...
  std::array< SchLeakybucketStaticR, 72 > port_max_lb_static_mem_;
  std::array< SchLeakybucketDynamicR, 72 > port_max_lb_dynamic_mem_;
  std::array< SchPortPfcStatusR, 72 > port_pfc_status_mem_;
  std::array< SchPortPexStatusR, 72 > port_pex_status_mem_;
  std::array< SchQueueConfigR, 576 > queue_config_;
  std::array< SchLeakybucketStaticR, 576 > q_min_lb_static_mem_;
  std::array< SchLeakybucketDynamicR, 576 > q_min_lb_dynamic_mem_;
  std::array< SchLeakybucketStaticR, 576 > q_max_lb_static_mem_;
  std::array< SchLeakybucketDynamicR, 576 > q_max_lb_dynamic_mem_;
  std::array< SchExcessbucketStaticR, 576 > q_exc_static_mem_;
  std::array< SchExcessbucketDynamicR, 576 > q_exc_dynamic_mem_;
  std::array< SchQueuePfcStatusR, 576 > q_pfc_status_mem_;
