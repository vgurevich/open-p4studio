...
public:
  TmSchPipeRspecEccMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_tm_sch_pipe_rspec), 12, true, write_callback, read_callback, std::string("TmSchPipeRspecEccMutable")+":"+boost::lexical_cast<std::string>(index_tm_sch_pipe_rspec))
    {
    }
  TmSchPipeRspecEccMutable(
