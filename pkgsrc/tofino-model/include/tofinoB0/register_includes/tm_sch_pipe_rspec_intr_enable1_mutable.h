...
#ifndef __REGISTER_INCLUDES_TM_SCH_PIPE_RSPEC_INTR_ENABLE1_MUTABLE_H__
#define __REGISTER_INCLUDES_TM_SCH_PIPE_RSPEC_INTR_ENABLE1_MUTABLE_H__
...
class TmSchPipeRspecIntrEnable1Mutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  TmSchPipeRspecIntrEnable1Mutable(
      int chipNumber, int index_tm_sch_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_sch_pipe_rspec), 4, true, write_callback, read_callback, std::string("TmSchPipeRspecIntrEnable1Mutable")+":"+boost::lexical_cast<std::string>(index_tm_sch_pipe_rspec))
    {
    }
  TmSchPipeRspecIntrEnable1Mutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "TmSchPipeRspecIntrEnable1Mutable")
    {
    }
public:
  ...
  std::string to_string(
    ...
    std::string r("");
    bool all_zeros=true;
    r += indent_string + std::string("TmSchPipeRspecIntrEnable1Mutable") + ":\n";
...
#endif // __REGISTER_INCLUDES_TM_SCH_PIPE_RSPEC_INTR_ENABLE1_MUTABLE_H__
