...
#include "tm_sch_pipe_rspec_intr_enable0_mutable.h"
#include "tm_sch_pipe_rspec_intr_enable1_mutable.h"
#include "tm_sch_pipe_rspec_intr_freeze_enable_mutable.h"
#include "tm_sch_pipe_rspec_intr_inject_mutable.h"
#include "tm_sch_pipe_rspec_intr_status_mutable.h"
...
public:
  TmSchPipeRspecIntrMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_tm_sch_pipe_rspec), 20, true, write_callback, read_callback, std::string("TmSchPipeRspecIntrMutable")+":"+boost::lexical_cast<std::string>(index_tm_sch_pipe_rspec))
    {
    }
  TmSchPipeRspecIntrMutable(
...
public:
  ...
  TmSchPipeRspecIntrStatusMutable &intr_status() { return intr_status_; }
  ...
  TmSchPipeRspecIntrEnable0Mutable &intr_enable0() { return intr_enable0_; }
  ...
  TmSchPipeRspecIntrEnable1Mutable &intr_enable1() { return intr_enable1_; }
  ...
  TmSchPipeRspecIntrInjectMutable &intr_inject() { return intr_inject_; }
...
private:
  TmSchPipeRspecIntrStatusMutable intr_status_;
  TmSchPipeRspecIntrEnable0Mutable intr_enable0_;
  TmSchPipeRspecIntrEnable1Mutable intr_enable1_;
  TmSchPipeRspecIntrInjectMutable intr_inject_;
