...
#ifndef __REGISTER_INCLUDES_TM_SCH_PIPE_RSPEC_PEX_CREDIT_ERRLOG_MUTABLE_H__
#define __REGISTER_INCLUDES_TM_SCH_PIPE_RSPEC_PEX_CREDIT_ERRLOG_MUTABLE_H__
...
public:
  TmSchPipeRspecPexCreditErrlogMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_tm_sch_pipe_rspec), 4, true, write_callback, read_callback, std::string("TmSchPipeRspecPexCreditErrlogMutable")+":"+boost::lexical_cast<std::string>(index_tm_sch_pipe_rspec))
    {
    }
  TmSchPipeRspecPexCreditErrlogMutable(
...
#endif // __REGISTER_INCLUDES_TM_SCH_PIPE_RSPEC_PEX_CREDIT_ERRLOG_MUTABLE_H__
