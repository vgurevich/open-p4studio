...
#ifndef __REGISTER_INCLUDES_TM_SCH_PIPE_RSPEC_UPD_PEX0_MBE_ERRLOG_H__
#define __REGISTER_INCLUDES_TM_SCH_PIPE_RSPEC_UPD_PEX0_MBE_ERRLOG_H__
...
public:
  TmSchPipeRspecUpdPex0MbeErrlog(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_tm_sch_pipe_rspec), 4, false, write_callback, read_callback, std::string("TmSchPipeRspecUpdPex0MbeErrlog")+":"+boost::lexical_cast<std::string>(index_tm_sch_pipe_rspec))
    {
    }
  TmSchPipeRspecUpdPex0MbeErrlog(
...
#endif // __REGISTER_INCLUDES_TM_SCH_PIPE_RSPEC_UPD_PEX0_MBE_ERRLOG_H__
