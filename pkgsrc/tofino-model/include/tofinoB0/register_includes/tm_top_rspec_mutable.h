...
#include "tm_caa_rspec_mutable.h"
#include "tm_clc_top_rspec_mutable.h"
#include "tm_prc_top_rspec_mutable.h"
#include "tm_pre_reg_top_rspec_mutable.h"
...
public:
  TmTopRspecMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(), 2523136, true, write_callback, read_callback, std::string("TmTopRspecMutable"))
    {
    }
  TmTopRspecMutable(
...
public:
  ...
  TmCaaRspecMutable &tm_caa() { return tm_caa_; }
  ...
  TmSchTopRspecMutable &tm_sch_top() { return tm_sch_top_; }
  ...
  TmPreRegTopRspecMutable &tm_pre_top() { return tm_pre_top_; }
