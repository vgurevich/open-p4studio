...
#ifndef __REGISTER_INCLUDES_TM_WAC_PIPE_RSPEC_MUTABLE_H__
#define __REGISTER_INCLUDES_TM_WAC_PIPE_RSPEC_MUTABLE_H__
...
#include "pipe_reg_mutable.h"
#include "wac_port_cnt_mutable.h"
#include "wac_port_max_lmt_mutable.h"
#include "wac_port_ppg_mapping_mutable.h"
#include "wac_port_wm_cnt_mutable.h"
#include "wac_ppg_hdr_cnt_mutable.h"
#include "wac_ppg_hdr_lmt_mutable.h"
#include "wac_ppg_icos_mapping_mutable.h"
#include "wac_ppg_min_cnt_mutable.h"
#include "wac_ppg_min_lmt_mutable.h"
#include "wac_ppg_resume_mutable.h"
#include "wac_ppg_shr_cnt_mutable.h"
#include "wac_ppg_shr_lmt_mutable.h"
#include "wac_ppg_wm_cnt_mutable.h"

namespace tofinoB0 {
  namespace register_classes {

class TmWacPipeRspecMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  TmWacPipeRspecMutable(
      int chipNumber, int index_tm_wac_pipe_rspec, RegisterCallback& write_callback = 0, RegisterCallback& read_callback = 0
  )
    : RegisterBlock(chipNumber, StartOffset(index_tm_wac_pipe_rspec), 32768, true, write_callback, read_callback, std::string("TmWacPipeRspecMutable")+":"+boost::lexical_cast<std::string>(index_tm_wac_pipe_rspec))
    {
    }
  TmWacPipeRspecMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "TmWacPipeRspecMutable")
    {
    }
public:
  PipeRegMutable &wac_reg() { return wac_reg_; }
  ...
  WacPpgMinLmtMutable &csr_mem_wac_ppg_min_lmt() { return csr_mem_wac_ppg_min_lmt_; }
  ...
  WacPpgHdrLmtMutable &csr_mem_wac_ppg_hdr_lmt() { return csr_mem_wac_ppg_hdr_lmt_; }
  ...
  WacPortMaxLmtMutable &csr_mem_wac_port_max_lmt() { return csr_mem_wac_port_max_lmt_; }
  ...
  WacPpgShrCntMutable &csr_mem_wac_ppg_shr_cnt() { return csr_mem_wac_ppg_shr_cnt_; }
  ...
  WacPpgMinCntMutable &csr_mem_wac_ppg_min_cnt() { return csr_mem_wac_ppg_min_cnt_; }
  ...
  WacPpgHdrCntMutable &csr_mem_wac_ppg_hdr_cnt() { return csr_mem_wac_ppg_hdr_cnt_; }
  ...
  WacPpgResumeMutable &csr_mem_wac_ppg_resume() { return csr_mem_wac_ppg_resume_; }
  ...
  WacPortPpgMappingMutable &csr_mem_wac_port_ppg_mapping() { return csr_mem_wac_port_ppg_mapping_; }
  ...
  WacPpgShrLmtMutable &csr_mem_wac_ppg_shr_lmt() { return csr_mem_wac_ppg_shr_lmt_; }
  ...
  WacPpgWmCntMutable &csr_mem_wac_ppg_wm_cnt() { return csr_mem_wac_ppg_wm_cnt_; }
  ...
  WacPpgIcosMappingMutable &csr_mem_wac_ppg_icos_mapping() { return csr_mem_wac_ppg_icos_mapping_; }
  ...
  WacPortCntMutable &csr_mem_wac_port_cnt() { return csr_mem_wac_port_cnt_; }
  ...
  WacPortWmCntMutable &csr_mem_wac_port_wm_cnt() { return csr_mem_wac_port_wm_cnt_; }
...
private:
  PipeRegMutable wac_reg_;
  WacPpgMinLmtMutable csr_mem_wac_ppg_min_lmt_;
  WacPpgHdrLmtMutable csr_mem_wac_ppg_hdr_lmt_;
  WacPortMaxLmtMutable csr_mem_wac_port_max_lmt_;
  WacPpgShrCntMutable csr_mem_wac_ppg_shr_cnt_;
  WacPpgMinCntMutable csr_mem_wac_ppg_min_cnt_;
  WacPpgHdrCntMutable csr_mem_wac_ppg_hdr_cnt_;
  WacPpgResumeMutable csr_mem_wac_ppg_resume_;
  WacPortPpgMappingMutable csr_mem_wac_port_ppg_mapping_;
  WacPpgShrLmtMutable csr_mem_wac_ppg_shr_lmt_;
  WacPpgWmCntMutable csr_mem_wac_ppg_wm_cnt_;
  WacPpgIcosMappingMutable csr_mem_wac_ppg_icos_mapping_;
  WacPortCntMutable csr_mem_wac_port_cnt_;
  WacPortWmCntMutable csr_mem_wac_port_wm_cnt_;
private:
...
#endif // __REGISTER_INCLUDES_TM_WAC_PIPE_RSPEC_MUTABLE_H__
