...
public:
  WacCommonBlock(
    ...
    : RegisterBlock(chipNumber, StartOffset(), 4096, false, write_callback, read_callback, std::string("WacCommonBlock"))
    {
    }
  WacCommonBlock(
...
public:
  ...
  WacIntrStatus &wac_common_wac_intr_status() { return wac_common_wac_intr_status_; }
  ...
  WacDropCntPreFifo &wac_common_wac_drop_cnt_pre0_fifo(int j0) { return wac_common_wac_drop_cnt_pre0_fifo_[j0]; }
  ...
  WacDropCntPreFifo &wac_common_wac_drop_cnt_pre1_fifo(int j0) { return wac_common_wac_drop_cnt_pre1_fifo_[j0]; }
  ...
  WacDropCntPreFifo &wac_common_wac_drop_cnt_pre2_fifo(int j0) { return wac_common_wac_drop_cnt_pre2_fifo_[j0]; }
  ...
  WacDropCntPreFifo &wac_common_wac_drop_cnt_pre3_fifo(int j0) { return wac_common_wac_drop_cnt_pre3_fifo_[j0]; }
  ...
  WacEgressQidMapping &wac_common_wac_egress_qid_mapping(int j0) { return wac_common_wac_egress_qid_mapping_[j0]; }
...
private:
  WacIntrStatus wac_common_wac_intr_status_;
  ...
  std::array< WacDropCntPreFifo, 4 > wac_common_wac_drop_cnt_pre0_fifo_;
  std::array< WacDropCntPreFifo, 4 > wac_common_wac_drop_cnt_pre1_fifo_;
  std::array< WacDropCntPreFifo, 4 > wac_common_wac_drop_cnt_pre2_fifo_;
  std::array< WacDropCntPreFifo, 4 > wac_common_wac_drop_cnt_pre3_fifo_;
  std::array< WacEgressQidMapping, 512 > wac_common_wac_egress_qid_mapping_;
private:
