...
#ifndef __REGISTER_INCLUDES_WAC_PORT_PPG_MAPPING_ENTRY_ARRAY_MUTABLE_H__
#define __REGISTER_INCLUDES_WAC_PORT_PPG_MAPPING_ENTRY_ARRAY_MUTABLE_H__
...
class WacPortPpgMappingEntryArrayMutable : public model_core::RegisterBlock<RegisterArrayCallback> {
public:
  WacPortPpgMappingEntryArrayMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_tm_wac_pipe_rspec), 4 * ArraySize(index_tm_wac_pipe_rspec, -1), true, write_callback, read_callback, std::string("WacPortPpgMappingEntryArrayMutable")+":"+boost::lexical_cast<std::string>(index_tm_wac_pipe_rspec)),
...
#endif // __REGISTER_INCLUDES_WAC_PORT_PPG_MAPPING_ENTRY_ARRAY_MUTABLE_H__
