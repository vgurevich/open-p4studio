...
#ifndef __REGISTER_INCLUDES_WAC_PORT_PPG_MAPPING_ENTRY_MUTABLE_H__
#define __REGISTER_INCLUDES_WAC_PORT_PPG_MAPPING_ENTRY_MUTABLE_H__
...
class WacPortPpgMappingEntryMutable : public model_core::RegisterBlock<RegisterCallback> {
public:
  WacPortPpgMappingEntryMutable(
    ...
    : RegisterBlock(chipNumber, StartOffset(index_tm_wac_pipe_rspec, index_wac_port_ppg_mapping_entry), 4, true, write_callback, read_callback, std::string("WacPortPpgMappingEntryMutable")+":"+boost::lexical_cast<std::string>(index_tm_wac_pipe_rspec) + "," + boost::lexical_cast<std::string>(index_wac_port_ppg_mapping_entry))
    {
    }
  WacPortPpgMappingEntryMutable(
      
  )
    : RegisterBlock(0, 0, 0, true, 0, 0, "WacPortPpgMappingEntryMutable")
    {
    }
public:
...
#endif // __REGISTER_INCLUDES_WAC_PORT_PPG_MAPPING_ENTRY_MUTABLE_H__
