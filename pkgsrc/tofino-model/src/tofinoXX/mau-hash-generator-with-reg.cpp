...
namespace MODEL_CHIP_NAMESPACE {
  ...
  void MauHashGeneratorWithReg::GaloisFieldMatrixCallback(uint32_t a1,uint32_t a0) {
    ...
    galois_field_matrix_bv_[a0].set_word( galois_field_matrix_.byte1(a1,a0),
                                          ...
                                          8 );
    int bit_start = a1*2;
    galois_field_valid_matrix_bv_[a0].set_word( galois_field_matrix_.valid0(a1,a0),
                                                bit_start,
                                                1 );
    galois_field_valid_matrix_bv_[a0].set_word( galois_field_matrix_.valid1(a1,a0),
                                                bit_start+1,
                                                1 );
  }
}
