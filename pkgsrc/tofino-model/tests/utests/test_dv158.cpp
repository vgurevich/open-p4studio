...
// data_multi_write ERROR -> test_dv158.cpp
// 
//
...
namespace MODEL_CHIP_TEST_NAMESPACE {
  ...
  bool dv158_print = false;

  using namespace std;
  using namespace MODEL_CHIP_NAMESPACE;


TEST(BFN_TEST_NAME(Dv158Test),Packet1) {
    GLOBAL_MODEL->Reset();
    if (dv158_print) RMT_UT_LOG_INFO("test_dv158_packet1()\n");
    ...
    ASSERT_TRUE(tu.read_test_file("extracted_tests/test_dv158.test"));
