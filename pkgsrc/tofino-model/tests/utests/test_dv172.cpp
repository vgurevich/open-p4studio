...
// mau_moveregs1 -> test_dv172.cpp
// RefModel/RTL mismatch after moveregs
//
...
namespace MODEL_CHIP_TEST_NAMESPACE {
  ...
  bool dv172_print = false;

  using namespace std;
  using namespace MODEL_CHIP_NAMESPACE;


TEST(BFN_TEST_NAME(Dv172Test),Packet1) {
    GLOBAL_MODEL->Reset();
    if (dv172_print) RMT_UT_LOG_INFO("test_dv172_packet1()\n");
    ...
    ASSERT_TRUE(tu.read_test_file("extracted_tests/test_dv172.test"));
