...
// XXX/mf -> test_dv178.cpp
// Meter Color Movereg Bring-up
//
...
namespace MODEL_CHIP_TEST_NAMESPACE {
  ...
  bool dv178_print = false;

  using namespace std;
  using namespace MODEL_CHIP_NAMESPACE;


TEST(BFN_TEST_NAME(Dv178Test),Packet1) {
    GLOBAL_MODEL->Reset();
    if (dv178_print) RMT_UT_LOG_INFO("test_dv178_packet1()\n");
    ...
    ASSERT_TRUE(tu.read_test_file("extracted_tests/test_dv178.test"));
