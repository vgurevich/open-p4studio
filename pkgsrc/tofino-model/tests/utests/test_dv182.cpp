...
// XXX -> test_dv182.cpp
// Ref Model does not like MoveReg for configured Meter-color on Idlet and Stats alu.
//
...
namespace MODEL_CHIP_TEST_NAMESPACE {
  ...
  bool dv182_print = false;

  using namespace std;
  using namespace MODEL_CHIP_NAMESPACE;


TEST(BFN_TEST_NAME(Dv182Test),Packet1) {
    GLOBAL_MODEL->Reset();
    if (dv182_print) RMT_UT_LOG_INFO("test_dv182_packet1()\n");
    ...
    ASSERT_TRUE(tu.read_test_file("extracted_tests/test_dv182.test"));
