...
// XXX -> test_dv198.cpp
// Harlyn Incorrect Meter Color Input
...
namespace MODEL_CHIP_TEST_NAMESPACE {
  ...
  bool dv198_print = false;

  using namespace std;
  using namespace MODEL_CHIP_NAMESPACE;


TEST(BFN_TEST_NAME(Dv198Test),Packet1) {
    GLOBAL_MODEL->Reset();
    if (dv198_print) RMT_UT_LOG_INFO("test_dv198_packet1()\n");
    ...
    ASSERT_TRUE(tu.read_test_file("extracted_tests/test_dv198.test"));
