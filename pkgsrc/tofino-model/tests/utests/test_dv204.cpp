...
namespace MODEL_CHIP_TEST_NAMESPACE {
  ...
  bool dv204_print = false;

  using namespace std;
  using namespace MODEL_CHIP_NAMESPACE;


TEST(BFN_TEST_NAME(Dv204Test),Packet1) {
    GLOBAL_MODEL->Reset();
    if (dv204_print) RMT_UT_LOG_INFO("test_dv204_packet1()\n");
    ...
    ASSERT_TRUE(tu.read_test_file("extracted_tests/test_dv204.test"));
