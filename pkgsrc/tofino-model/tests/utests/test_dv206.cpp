...
// XXX/round2 -> test_dv206.cpp
// Harlyn Not Committing Color from S->D in color RAM
...
namespace MODEL_CHIP_TEST_NAMESPACE {
  ...
  bool dv206_print = false;

  using namespace std;
  using namespace MODEL_CHIP_NAMESPACE;


TEST(BFN_TEST_NAME(Dv206Test),Packet1) {
    GLOBAL_MODEL->Reset();
    if (dv206_print) RMT_UT_LOG_INFO("test_dv206_packet1()\n");
    ...
    ASSERT_TRUE(tu.read_test_file("extracted_tests/test_dv206.test"));
