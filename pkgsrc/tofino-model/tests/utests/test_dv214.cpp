...
// intent_counters -> test_dv214.cpp
// Intent Counters not self-consistent 
...
namespace MODEL_CHIP_TEST_NAMESPACE {
  ...
  bool dv214_print = false;

  using namespace std;
  using namespace MODEL_CHIP_NAMESPACE;


TEST(BFN_TEST_NAME(Dv214Test),Packet1) {
    GLOBAL_MODEL->Reset();
    if (dv214_print) RMT_UT_LOG_INFO("test_dv214_packet1()\n");
    ...
    ASSERT_TRUE(tu.read_test_file("extracted_tests/test_dv214.test"));
