...
// XXX/rerun2.parb_next_oPhv.bad.run_dir -> test_dv224.cpp,test_dv224.test
// XXX/rerun3.parb_newer_bad_parbcase.run_dir -> test_dv224.cpp,test_dv224_rerun3_B.test
// Ref Model using undriven iPhv/oPhv in Match/Parb dependency
...
namespace MODEL_CHIP_TEST_NAMESPACE {
  ...
  bool dv224_print = false;

  using namespace std;
  using namespace MODEL_CHIP_NAMESPACE;


TEST(BFN_TEST_NAME(Dv224Test),Packet1) {
    GLOBAL_MODEL->Reset();
    if (dv224_print) RMT_UT_LOG_INFO("test_dv224_packet1()\n");
    ...
    // Set MAU[0] features to zeroise oPhv
    //Mau::kMauFeatures[0] = 0x1;
    
    // PUT GENERATED OutWord/IndirectWrite calls HERE
    ASSERT_TRUE(tu.read_test_file("extracted_tests/test_dv224_rerun3_B.test"));
