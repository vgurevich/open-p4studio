...
namespace MODEL_CHIP_TEST_NAMESPACE {
  ...
  bool dv34_print = false;

  using namespace std;
  using namespace MODEL_CHIP_NAMESPACE;


TEST(BFN_TEST_NAME(Dv34Test),Packet1) {
    GLOBAL_MODEL->Reset();
    if (dv34_print) RMT_UT_LOG_INFO("test_dv34_packet1()\n");
...
// Before regs_31841 fix:     tu.OutWord(&mau_reg_map.dp.xbar_hash.hash.hash_seed[7][1], 0x1f78cd3); /* 0x207003c */
  ...
  act_hv_translator.do_writes(&tu);
    ...
    RMT_UT_LOG_INFO("Dv34Test::InPkt=%p [DA=%04X%08X]\n", p_in,
    ...
    */
    ...
    EXPECT_EQ(0xf4, phv_out2->get(66)); // was 0x23 in input phv
    EXPECT_EQ(0xb4, phv_out2->get(67)); // was 0x40 in input phv
    //EXPECT_EQ(0x52, phv_out2->get(78)); // was 0xc6 in input phv
    //EXPECT_EQ(0xaa, phv_out2->get(79)); // was 0xe8 in input phv
    //EXPECT_EQ(0xf4, phv_out2->get(82)); // was 0xae in input phv
    EXPECT_EQ(0x7a, phv_out2->get(88)); // was 0x68 in input phv
    EXPECT_EQ(0x63, phv_out2->get(90)); // was 0x58 in input phv
    //EXPECT_EQ(0x45, phv_out2->get(91)); // was 0x7f in input phv
