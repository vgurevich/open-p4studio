...
namespace MODEL_CHIP_TEST_NAMESPACE {
  ...
  bool dv71_print = false;

  using namespace std;
  using namespace MODEL_CHIP_NAMESPACE;


TEST(BFN_TEST_NAME(Dv71Test),Packet1) {
    GLOBAL_MODEL->Reset();
    if (dv71_print) RMT_UT_LOG_INFO("test_dv71_packet1()\n");
    ...
    ASSERT_TRUE(tu.read_test_file("extracted_tests/test_dv71.test"));
