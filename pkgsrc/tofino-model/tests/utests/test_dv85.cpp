...
// XXX -> test_dv85.cpp
// Problems with EOPs in the model
//
...
namespace MODEL_CHIP_TEST_NAMESPACE {
  ...
  bool dv85_print = false;

  using namespace std;
  using namespace MODEL_CHIP_NAMESPACE;


TEST(BFN_TEST_NAME(Dv85Test),Packet1) {
    GLOBAL_MODEL->Reset();
    if (dv85_print) RMT_UT_LOG_INFO("test_dv85_packet1()\n");
    ...
    ASSERT_TRUE(tu.read_test_file("extracted_tests/test_dv85.test"));
