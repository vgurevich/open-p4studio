...
// Run all tests in extracted_tests/jbay
...
namespace MODEL_CHIP_TEST_NAMESPACE {
  ...
  bool jbay_extracted_print = false;

  using namespace std;
  using namespace MODEL_CHIP_NAMESPACE;


//TEST(BFN_TEST_NAME(ExtractedTest),DISABLED_Packet1) {
TEST(BFN_TEST_NAME(ExtractedTest),Packet1) {
    GLOBAL_MODEL->Reset();
    if (jbay_extracted_print) RMT_UT_LOG_INFO("test_jbay_extracted_packet1()\n");
    ...
    const char* read_dir="extracted_tests/jbay";
